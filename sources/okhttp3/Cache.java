...
public final class Cache implements Closeable, Flushable {
    ...
    public final File m35395deprecated_directory() {
        return this.cache.getDirectory();
    }
    ...
    @Metadata(mo72582d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0005\n\u0002\u0010\u0002\n\u0000\b\u0004\u0018\u00002\u00020\u0001B\u0011\u0012\n\u0010\u0002\u001a\u00060\u0003R\u00020\u0004¢\u0006\u0002\u0010\u0005J\b\u0010\u000f\u001a\u00020\u0010H\u0016J\b\u0010\u0006\u001a\u00020\u0007H\u0016R\u000e\u0010\u0006\u001a\u00020\u0007X\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0007X\u0004¢\u0006\u0002\n\u0000R\u001a\u0010\t\u001a\u00020\nX\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u000b\u0010\f\"\u0004\b\r\u0010\u000eR\u0012\u0010\u0002\u001a\u00060\u0003R\u00020\u0004X\u0004¢\u0006\u0002\n\u0000¨\u0006\u0011"}, mo72583d2 = {"Lokhttp3/Cache$RealCacheRequest;", "Lokhttp3/internal/cache/CacheRequest;", "editor", "Lokhttp3/internal/cache/DiskLruCache$Editor;", "Lokhttp3/internal/cache/DiskLruCache;", "(Lokhttp3/Cache;Lokhttp3/internal/cache/DiskLruCache$Editor;)V", "body", "Lokio/Sink;", "cacheOut", "done", "", "getDone", "()Z", "setDone", "(Z)V", "abort", "", "okhttp"}, mo72584k = 1, mo72585mv = {1, 6, 0}, mo72587xi = 48)
    /* compiled from: Cache.kt */
    private final class RealCacheRequest implements CacheRequest {
        ...
        public RealCacheRequest(Cache cache, DiskLruCache.Editor editor2) {
            ...
            final Cache cache2 = this.this$0;
    ...
    private static final class Entry {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:42:0x012d, code lost:
            kotlin.p403io.CloseableKt.closeFinally(r0, r10);
         */
        ...
        public Entry(okio.Source r10) throws java.io.IOException {
            /*
                ...
                r1 = r0
                okio.Source r1 = (okio.Source) r1     // Catch:{ all -> 0x012a }
                okio.BufferedSource r10 = okio.Okio.buffer((okio.Source) r10)     // Catch:{ all -> 0x012a }
                java.lang.String r1 = r10.readUtf8LineStrict()     // Catch:{ all -> 0x012a }
                okhttp3.HttpUrl$Companion r2 = okhttp3.HttpUrl.Companion     // Catch:{ all -> 0x012a }
                okhttp3.HttpUrl r2 = r2.parse(r1)     // Catch:{ all -> 0x012a }
                if (r2 == 0) goto L_0x010d
                r9.url = r2     // Catch:{ all -> 0x012a }
                java.lang.String r1 = r10.readUtf8LineStrict()     // Catch:{ all -> 0x012a }
                r9.requestMethod = r1     // Catch:{ all -> 0x012a }
                okhttp3.Headers$Builder r1 = new okhttp3.Headers$Builder     // Catch:{ all -> 0x012a }
                r1.<init>()     // Catch:{ all -> 0x012a }
                okhttp3.Cache$Companion r2 = okhttp3.Cache.Companion     // Catch:{ all -> 0x012a }
                int r2 = r2.readInt$okhttp(r10)     // Catch:{ all -> 0x012a }
                r3 = 0
                r4 = r3
            L_0x0033:
                if (r4 >= r2) goto L_0x003f
                int r4 = r4 + 1
                java.lang.String r5 = r10.readUtf8LineStrict()     // Catch:{ all -> 0x012a }
                r1.addLenient$okhttp(r5)     // Catch:{ all -> 0x012a }
                goto L_0x0033
            L_0x003f:
                okhttp3.Headers r1 = r1.build()     // Catch:{ all -> 0x012a }
                r9.varyHeaders = r1     // Catch:{ all -> 0x012a }
                okhttp3.internal.http.StatusLine$Companion r1 = okhttp3.internal.http.StatusLine.Companion     // Catch:{ all -> 0x012a }
                java.lang.String r2 = r10.readUtf8LineStrict()     // Catch:{ all -> 0x012a }
                okhttp3.internal.http.StatusLine r1 = r1.parse(r2)     // Catch:{ all -> 0x012a }
                okhttp3.Protocol r2 = r1.protocol     // Catch:{ all -> 0x012a }
                r9.protocol = r2     // Catch:{ all -> 0x012a }
                int r2 = r1.code     // Catch:{ all -> 0x012a }
                r9.code = r2     // Catch:{ all -> 0x012a }
                java.lang.String r1 = r1.message     // Catch:{ all -> 0x012a }
                r9.message = r1     // Catch:{ all -> 0x012a }
                okhttp3.Headers$Builder r1 = new okhttp3.Headers$Builder     // Catch:{ all -> 0x012a }
                r1.<init>()     // Catch:{ all -> 0x012a }
                okhttp3.Cache$Companion r2 = okhttp3.Cache.Companion     // Catch:{ all -> 0x012a }
                int r2 = r2.readInt$okhttp(r10)     // Catch:{ all -> 0x012a }
            ...
            L_0x0067:
                ...
                goto L_0x0067
            L_0x0073:
                java.lang.String r2 = SENT_MILLIS     // Catch:{ all -> 0x012a }
                java.lang.String r2 = r1.get(r2)     // Catch:{ all -> 0x012a }
                java.lang.String r4 = RECEIVED_MILLIS     // Catch:{ all -> 0x012a }
                java.lang.String r4 = r1.get(r4)     // Catch:{ all -> 0x012a }
                java.lang.String r5 = SENT_MILLIS     // Catch:{ all -> 0x012a }
                r1.removeAll(r5)     // Catch:{ all -> 0x012a }
                java.lang.String r5 = RECEIVED_MILLIS     // Catch:{ all -> 0x012a }
                r1.removeAll(r5)     // Catch:{ all -> 0x012a }
                r5 = 0
                ...
                goto L_0x0093
            L_0x008f:
                long r7 = java.lang.Long.parseLong(r2)     // Catch:{ all -> 0x012a }
            L_0x0093:
                r9.sentRequestMillis = r7     // Catch:{ all -> 0x012a }
                if (r4 != 0) goto L_0x0098
                goto L_0x009c
            L_0x0098:
                long r5 = java.lang.Long.parseLong(r4)     // Catch:{ all -> 0x012a }
            L_0x009c:
                r9.receivedResponseMillis = r5     // Catch:{ all -> 0x012a }
                okhttp3.Headers r1 = r1.build()     // Catch:{ all -> 0x012a }
                r9.responseHeaders = r1     // Catch:{ all -> 0x012a }
                boolean r1 = r9.isHttps()     // Catch:{ all -> 0x012a }
                r2 = 0
                if (r1 == 0) goto L_0x0105
                java.lang.String r1 = r10.readUtf8LineStrict()     // Catch:{ all -> 0x012a }
                r4 = r1
                java.lang.CharSequence r4 = (java.lang.CharSequence) r4     // Catch:{ all -> 0x012a }
                int r4 = r4.length()     // Catch:{ all -> 0x012a }
                if (r4 <= 0) goto L_0x00b9
                r3 = 1
            L_0x00b9:
                if (r3 != 0) goto L_0x00e9
                java.lang.String r1 = r10.readUtf8LineStrict()     // Catch:{ all -> 0x012a }
                okhttp3.CipherSuite$Companion r3 = okhttp3.CipherSuite.Companion     // Catch:{ all -> 0x012a }
                okhttp3.CipherSuite r1 = r3.forJavaName(r1)     // Catch:{ all -> 0x012a }
                java.util.List r3 = r9.readCertificateList(r10)     // Catch:{ all -> 0x012a }
                java.util.List r4 = r9.readCertificateList(r10)     // Catch:{ all -> 0x012a }
                boolean r5 = r10.exhausted()     // Catch:{ all -> 0x012a }
                if (r5 != 0) goto L_0x00de
                okhttp3.TlsVersion$Companion r5 = okhttp3.TlsVersion.Companion     // Catch:{ all -> 0x012a }
                java.lang.String r10 = r10.readUtf8LineStrict()     // Catch:{ all -> 0x012a }
                okhttp3.TlsVersion r10 = r5.forJavaName(r10)     // Catch:{ all -> 0x012a }
                goto L_0x00e0
            L_0x00de:
                okhttp3.TlsVersion r10 = okhttp3.TlsVersion.SSL_3_0     // Catch:{ all -> 0x012a }
            L_0x00e0:
                okhttp3.Handshake$Companion r5 = okhttp3.Handshake.Companion     // Catch:{ all -> 0x012a }
                okhttp3.Handshake r10 = r5.get(r10, r1, r3, r4)     // Catch:{ all -> 0x012a }
                r9.handshake = r10     // Catch:{ all -> 0x012a }
                goto L_0x0107
            L_0x00e9:
                java.io.IOException r10 = new java.io.IOException     // Catch:{ all -> 0x012a }
                ...
                r2.append(r1)     // Catch:{ all -> 0x012a }
                r1 = 34
                r2.append(r1)     // Catch:{ all -> 0x012a }
                java.lang.String r1 = r2.toString()     // Catch:{ all -> 0x012a }
                r10.<init>(r1)     // Catch:{ all -> 0x012a }
                throw r10     // Catch:{ all -> 0x012a }
            L_0x0105:
                r9.handshake = r2     // Catch:{ all -> 0x012a }
            L_0x0107:
                kotlin.Unit r10 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x012a }
                kotlin.p403io.CloseableKt.closeFinally(r0, r2)
                return
            L_0x010d:
                java.io.IOException r10 = new java.io.IOException     // Catch:{ all -> 0x012a }
                java.lang.String r2 = "Cache corruption for "
                java.lang.String r1 = kotlin.jvm.internal.Intrinsics.stringPlus(r2, r1)     // Catch:{ all -> 0x012a }
                r10.<init>(r1)     // Catch:{ all -> 0x012a }
                okhttp3.internal.platform.Platform$Companion r1 = okhttp3.internal.platform.Platform.Companion     // Catch:{ all -> 0x012a }
                okhttp3.internal.platform.Platform r1 = r1.get()     // Catch:{ all -> 0x012a }
                java.lang.String r2 = "cache corruption"
                r3 = 5
                r4 = r10
                java.lang.Throwable r4 = (java.lang.Throwable) r4     // Catch:{ all -> 0x012a }
                r1.log(r2, r3, r4)     // Catch:{ all -> 0x012a }
                java.lang.Throwable r10 = (java.lang.Throwable) r10     // Catch:{ all -> 0x012a }
                throw r10     // Catch:{ all -> 0x012a }
            L_0x012a:
                r10 = move-exception
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:22:0x0120, code lost:
            kotlin.p403io.CloseableKt.closeFinally(r9, r0);
         */
        ...
        @Metadata(mo72582d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0004¢\u0006\u0002\n\u0000¨\u0006\u0006"}, mo72583d2 = {"Lokhttp3/Cache$Entry$Companion;", "", "()V", "RECEIVED_MILLIS", "", "SENT_MILLIS", "okhttp"}, mo72584k = 1, mo72585mv = {1, 6, 0}, mo72587xi = 48)
        /* compiled from: Cache.kt */
