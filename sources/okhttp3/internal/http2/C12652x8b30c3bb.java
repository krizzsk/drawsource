...
public final class C12652x8b30c3bb extends Task {
    ...
    public C12652x8b30c3bb(String str, boolean z, Http2Connection.ReaderRunnable readerRunnable, boolean z2, Settings settings) {
        super(str, z);
        this.$name = str;
        this.$cancelable = z;
