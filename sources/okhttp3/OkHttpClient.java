...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public static final class Builder {
        ...
        public final Builder dispatcher(Dispatcher dispatcher2) {
            ...
            builder.setDispatcher$okhttp(dispatcher2);
            return builder;
        }
        ...
        public final Builder m35494addInterceptor(Function1<? super Interceptor.Chain, Response> function1) {
        ...
        public final Builder m35495addNetworkInterceptor(Function1<? super Interceptor.Chain, Response> function1) {
            Intrinsics.checkNotNullParameter(function1, "block");
        ...
        public final Builder authenticator(Authenticator authenticator2) {
            ...
            Builder builder = this;
            builder.setAuthenticator$okhttp(authenticator2);
            return builder;
        }
        ...
        public final Builder cookieJar(CookieJar cookieJar2) {
            ...
            Builder builder = this;
            builder.setCookieJar$okhttp(cookieJar2);
            return builder;
        }

        public final Builder cache(Cache cache2) {
            Builder builder = this;
            builder.setCache$okhttp(cache2);
            return builder;
        }
        ...
        public final Builder dns(Dns dns2) {
            ...
            Builder builder = this;
            if (!Intrinsics.areEqual((Object) dns2, (Object) builder.getDns$okhttp())) {
                builder.setRouteDatabase$okhttp((RouteDatabase) null);
            }
            builder.setDns$okhttp(dns2);
            return builder;
        }

        public final Builder proxy(Proxy proxy2) {
            Builder builder = this;
            if (!Intrinsics.areEqual((Object) proxy2, (Object) builder.getProxy$okhttp())) {
                builder.setRouteDatabase$okhttp((RouteDatabase) null);
            }
            builder.setProxy$okhttp(proxy2);
            return builder;
        }
        ...
        public final Builder proxySelector(ProxySelector proxySelector2) {
            ...
            Builder builder = this;
            if (!Intrinsics.areEqual((Object) proxySelector2, (Object) builder.getProxySelector$okhttp())) {
                builder.setRouteDatabase$okhttp((RouteDatabase) null);
            }
            builder.setProxySelector$okhttp(proxySelector2);
            return builder;
        }
        ...
        public final Builder proxyAuthenticator(Authenticator authenticator2) {
            ...
            Builder builder = this;
            if (!Intrinsics.areEqual((Object) authenticator2, (Object) builder.getProxyAuthenticator$okhttp())) {
                builder.setRouteDatabase$okhttp((RouteDatabase) null);
            }
            builder.setProxyAuthenticator$okhttp(authenticator2);
            return builder;
        }
        ...
        public final Builder socketFactory(SocketFactory socketFactory2) {
            ...
            if (!(socketFactory2 instanceof SSLSocketFactory)) {
                if (!Intrinsics.areEqual((Object) socketFactory2, (Object) builder.getSocketFactory$okhttp())) {
                    builder.setRouteDatabase$okhttp((RouteDatabase) null);
                }
                builder.setSocketFactory$okhttp(socketFactory2);
                return builder;
            }
        ...
        public final Builder sslSocketFactory(SSLSocketFactory sSLSocketFactory) {
            ...
            Builder builder = this;
            if (!Intrinsics.areEqual((Object) sSLSocketFactory, (Object) builder.getSslSocketFactoryOrNull$okhttp())) {
                builder.setRouteDatabase$okhttp((RouteDatabase) null);
            }
        ...
        public final Builder connectionSpecs(List<ConnectionSpec> list) {
            ...
            Builder builder = this;
            if (!Intrinsics.areEqual((Object) list, (Object) builder.getConnectionSpecs$okhttp())) {
                builder.setRouteDatabase$okhttp((RouteDatabase) null);
            }
        ...
        public final Builder protocols(List<? extends Protocol> list) {
            ...
            if (mutableList.contains(Protocol.H2_PRIOR_KNOWLEDGE) || mutableList.contains(Protocol.HTTP_1_1)) {
                ...
                if (!z) {
                    ...
                    if (!Intrinsics.areEqual((Object) mutableList, (Object) builder.getProtocols$okhttp())) {
                        builder.setRouteDatabase$okhttp((RouteDatabase) null);
                    }
        ...
        public final Builder hostnameVerifier(HostnameVerifier hostnameVerifier2) {
            ...
            Builder builder = this;
            if (!Intrinsics.areEqual((Object) hostnameVerifier2, (Object) builder.getHostnameVerifier$okhttp())) {
                builder.setRouteDatabase$okhttp((RouteDatabase) null);
            }
            builder.setHostnameVerifier$okhttp(hostnameVerifier2);
            return builder;
        }
        ...
        public final Builder certificatePinner(CertificatePinner certificatePinner2) {
            ...
            Builder builder = this;
            if (!Intrinsics.areEqual((Object) certificatePinner2, (Object) builder.getCertificatePinner$okhttp())) {
                builder.setRouteDatabase$okhttp((RouteDatabase) null);
            }
            builder.setCertificatePinner$okhttp(certificatePinner2);
            return builder;
        }
        ...
        public final Builder callTimeout(long j, TimeUnit timeUnit) {
            ...
            Builder builder = this;
            builder.setCallTimeout$okhttp(Util.checkDuration("timeout", j, timeUnit));
            return builder;
        }
        ...
        public final Builder connectTimeout(long j, TimeUnit timeUnit) {
            Intrinsics.checkNotNullParameter(timeUnit, "unit");
            Builder builder = this;
            builder.setConnectTimeout$okhttp(Util.checkDuration("timeout", j, timeUnit));
            return builder;
        }
        ...
        public final Builder readTimeout(long j, TimeUnit timeUnit) {
            Intrinsics.checkNotNullParameter(timeUnit, "unit");
            Builder builder = this;
            builder.setReadTimeout$okhttp(Util.checkDuration("timeout", j, timeUnit));
            return builder;
        }
        ...
        public final Builder writeTimeout(long j, TimeUnit timeUnit) {
            Intrinsics.checkNotNullParameter(timeUnit, "unit");
            Builder builder = this;
            builder.setWriteTimeout$okhttp(Util.checkDuration("timeout", j, timeUnit));
            return builder;
        }
        ...
        public final Builder pingInterval(long j, TimeUnit timeUnit) {
            Intrinsics.checkNotNullParameter(timeUnit, "unit");
            Builder builder = this;
            builder.setPingInterval$okhttp(Util.checkDuration(TJAdUnitConstants.String.INTERVAL, j, timeUnit));
            return builder;
        }
    ...
    @Metadata(mo72582d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u001a\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004X\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007R\u001a\u0010\b\u001a\b\u0012\u0004\u0012\u00020\t0\u0004X\u0004¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u0007¨\u0006\u000b"}, mo72583d2 = {"Lokhttp3/OkHttpClient$Companion;", "", "()V", "DEFAULT_CONNECTION_SPECS", "", "Lokhttp3/ConnectionSpec;", "getDEFAULT_CONNECTION_SPECS$okhttp", "()Ljava/util/List;", "DEFAULT_PROTOCOLS", "Lokhttp3/Protocol;", "getDEFAULT_PROTOCOLS$okhttp", "okhttp"}, mo72584k = 1, mo72585mv = {1, 6, 0}, mo72587xi = 48)
    /* compiled from: OkHttpClient.kt */
