...
public class pbls implements pblu.pgla {
    ...
    private static class pgla {
        ...
        /* renamed from: a */
        public ZipFile f29890a;

        /* renamed from: b */
        public ZipEntry f29891b;

        public pgla(ZipFile zipFile, ZipEntry zipEntry) {
            this.f29890a = zipFile;
            this.f29891b = zipEntry;
        }
    }

    /* renamed from: a */
    private pgla m33486a(Context context, String[] strArr, String str, pblv pblv) {
        int i;
        ZipFile zipFile;
        String[] strArr2 = strArr;
        String[] a = m33488a(context);
        int length = a.length;
        int i2 = 0;
        int i3 = 0;
        while (i3 < length) {
    ...
    /* renamed from: a */
    private void m33487a(Closeable closeable) {
        if (closeable != null) {
            try {
                closeable.close();
            } catch (IOException unused) {
    ...
    /* renamed from: a */
    private String[] m33488a(Context context) {
        String[] strArr;
    ...
    public void mo74916a(android.content.Context r10, java.lang.String[] r11, java.lang.String r12, java.io.File r13, p405ms.p406bd.p407o.Pgl.pblv r14) {
        /*
            r9 = this;
            r0 = 0
            ms.bd.o.Pgl.pbls$pgla r14 = r9.m33486a(r10, r11, r12, r14)     // Catch:{ all -> 0x00af }
            r1 = 1
            r2 = 0
        ...
        L_0x000a:
            ...
            goto L_0x008a
        L_0x0027:
            java.util.zip.ZipFile r10 = r14.f29890a     // Catch:{ FileNotFoundException | IOException -> 0x0082, all -> 0x0078 }
            java.util.zip.ZipEntry r3 = r14.f29891b     // Catch:{ FileNotFoundException | IOException -> 0x0082, all -> 0x0078 }
        ...
        L_0x003a:
            ...
            goto L_0x0084
        L_0x0054:
            r9.m33487a((java.io.Closeable) r10)     // Catch:{ all -> 0x009c }
            r9.m33487a((java.io.Closeable) r3)     // Catch:{ all -> 0x009c }
            r13.setReadable(r1, r2)     // Catch:{ all -> 0x009c }
            r13.setExecutable(r1, r2)     // Catch:{ all -> 0x009c }
            r13.setWritable(r1)     // Catch:{ all -> 0x009c }
            java.util.zip.ZipFile r10 = r14.f29890a     // Catch:{ IOException -> 0x006c }
        ...
        L_0x007b:
            r9.m33487a((java.io.Closeable) r10)     // Catch:{ all -> 0x009c }
            r9.m33487a((java.io.Closeable) r0)     // Catch:{ all -> 0x009c }
        ...
        L_0x008a:
            ...
            goto L_0x000a
        L_0x008d:
            java.util.zip.ZipFile r10 = r14.f29890a     // Catch:{ IOException -> 0x0096 }
        ...
        L_0x0096:
            return
        L_0x0097:
            java.lang.String[] r10 = r9.m33489a(r10, r12)     // Catch:{ Exception -> 0x009f }
            goto L_0x00a9
        L_0x009c:
            r10 = move-exception
            r0 = r14
        ...
        L_0x00b0:
            ...
            java.util.zip.ZipFile r11 = r0.f29890a     // Catch:{ IOException -> 0x00bb }
        ...
        L_0x00bb:
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: p405ms.p406bd.p407o.Pgl.pbls.mo74916a(android.content.Context, java.lang.String[], java.lang.String, java.io.File, ms.bd.o.Pgl.pblv):void");
    }
}
