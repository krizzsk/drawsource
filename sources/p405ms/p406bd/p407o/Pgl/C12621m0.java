...
public final class C12621m0 implements SensorEventListener {

    /* renamed from: f */
    private static volatile C12621m0 f29870f = null;

    /* renamed from: a */
    private SensorManager f29871a = null;
    ...
    /* renamed from: d */
    private float[] f29874d = new float[3];

    /* renamed from: e */
    private List<JSONArray> f29875e = new ArrayList();

    static {
        new DecimalFormat((String) pblk.m33455a(16777217, 0, 0, "b46093", new byte[]{35, 120, Ascii.NAK}));
    }

    private C12621m0(Context context) {
        Context applicationContext = context.getApplicationContext();
        if (applicationContext != null) {
            this.f29871a = (SensorManager) applicationContext.getSystemService((String) pblk.m33455a(16777217, 0, 0, "e325e0", new byte[]{103, 52, 79, 82, 85, 53}));
        }
    }

    /* renamed from: a */
    public static C12621m0 m33420a(Context context) {
        if (f29870f == null) {
            synchronized (C12621m0.class) {
                if (f29870f == null) {
                    f29870f = new C12621m0(context);
                }
            }
        }
        return f29870f;
    ...
    /* renamed from: c */
    private synchronized void m33421c() {
        try {
            if (this.f29871a != null) {
                int i = this.f29872b - 1;
                this.f29872b = i;
                if (i == 0) {
                    this.f29871a.unregisterListener(this);
                }
            }
        } catch (Exception unused) {
            String str = (String) pblk.m33455a(16777217, 0, 0, "2fe8b7", new byte[]{48, 119, Ascii.NAK, 115, 72});
        }
        return;
    }
    ...
    /*  JADX ERROR: IndexOutOfBoundsException in pass: RegionMakerVisitor
        ...
        */
    /* renamed from: a */
    public synchronized void mo74887a() {
        /*
            r12 = this;
            monitor-enter(r12)
            r0 = 1
            r1 = 0
            android.app.Activity r2 = p405ms.p406bd.p407o.Pgl.pblz.m33510a()     // Catch:{ all -> 0x000d }
        ...
        L_0x0013:
            ...
            r2 = 3
            android.hardware.SensorManager r3 = r12.f29871a     // Catch:{ Exception -> 0x0035, all -> 0x0032 }
            if (r3 == 0) goto L_0x0035
            int r3 = r12.f29872b     // Catch:{ Exception -> 0x0035, all -> 0x0032 }
            if (r3 != 0) goto L_0x002c
            android.hardware.SensorManager r3 = r12.f29871a     // Catch:{ Exception -> 0x0035, all -> 0x0032 }
            android.hardware.Sensor r3 = r3.getDefaultSensor(r0)     // Catch:{ Exception -> 0x0035, all -> 0x0032 }
            android.hardware.SensorManager r4 = r12.f29871a     // Catch:{ Exception -> 0x0035, all -> 0x0032 }
        ...
        L_0x002c:
            int r3 = r12.f29872b     // Catch:{ Exception -> 0x0035, all -> 0x0032 }
            int r3 = r3 + r0
            r12.f29872b = r3     // Catch:{ Exception -> 0x0035, all -> 0x0032 }
            goto L_0x0035
        L_0x0032:
            r0 = move-exception
        ...
        L_0x0035:
            ...
            r5 = r1
        L_0x003a:
            int r6 = r12.f29873c     // Catch:{ all -> 0x008a }
        ...
        L_0x004a:
            ...
            float[] r6 = r12.f29874d     // Catch:{ all -> 0x0158 }
            ...
            float[] r5 = r12.f29874d     // Catch:{ all -> 0x0158 }
            ...
            r2.put(r0)     // Catch:{ all -> 0x0158 }
            r12.m33421c()     // Catch:{ all -> 0x0158 }
        L_0x0086:
            r12.f29873c = r1     // Catch:{ all -> 0x0158 }
            r0 = r2
            goto L_0x00f1
        L_0x008a:
            r5 = move-exception
        ...
        L_0x0090:
            ...
            java.lang.Object r2 = p405ms.p406bd.p407o.Pgl.pblk.m33455a(r5, r6, r7, r9, r10)     // Catch:{ all -> 0x008d }
        ...
        L_0x011a:
            ...
            float[] r7 = r12.f29874d     // Catch:{ all -> 0x0158 }
        ...
        L_0x0158:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p405ms.p406bd.p407o.Pgl.C12621m0.mo74887a():void");
    }
    ...
    public synchronized java.lang.String mo74888b() {
        /*
            r12 = this;
            monitor-enter(r12)
            java.lang.StringBuilder r0 = new java.lang.StringBuilder     // Catch:{ all -> 0x00b8 }
            r0.<init>()     // Catch:{ all -> 0x00b8 }
            java.util.List<org.json.JSONArray> r1 = r12.f29875e     // Catch:{ all -> 0x00b8 }
            ...
            return r0
        L_0x0011:
            java.util.List<org.json.JSONArray> r2 = r12.f29875e     // Catch:{ all -> 0x00b2 }
            int r3 = r1 + -50
            r4 = 0
        ...
        L_0x0038:
            ...
            java.lang.Object r5 = p405ms.p406bd.p407o.Pgl.pblk.m33455a(r6, r7, r8, r10, r11)     // Catch:{ all -> 0x00b2 }
            ...
            java.lang.Object r2 = p405ms.p406bd.p407o.Pgl.pblk.m33455a(r5, r6, r7, r9, r10)     // Catch:{ all -> 0x00b2 }
        ...
        L_0x00b8:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p405ms.p406bd.p407o.Pgl.C12621m0.mo74888b():java.lang.String");
    }
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        this.f29874d = sensorEvent.values;
        this.f29873c = 1;
    }
}
