    ...
    static /* synthetic */ class C11721 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.amazon.device.ads.MraidStateType.C11721.<clinit>():void");
        }
    }

    public String toString() {
        int i = C11721.$SwitchMap$com$amazon$device$ads$MraidStateType[ordinal()];
        if (i == 1) {
            return "loading";
        }
        if (i == 2) {
