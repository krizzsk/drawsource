...
public class DTBInterstitialActivity extends Activity implements DTBMRAIDCloseButtonListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            setContentView(C1173R.layout.mdtb_interstitial_ad);
            ...
            RelativeLayout relativeLayout = (RelativeLayout) findViewById(C1173R.C1175id.inter_container);
            ...
            this.closeIndicatorRegion = (LinearLayout) findViewById(C1173R.C1175id.mraid_close_indicator);
            ...
            if (controller.getDtbOmSdkSessionManager() != null) {
                controller.getDtbOmSdkSessionManager().addFriendlyObstruction(this.closeIndicatorRegion.findViewById(C1173R.C1175id.mraid_close_indicator), FriendlyObstructionPurpose.CLOSE_AD);
            }
            this.closeIndicatorRegion.setVisibility(getUseCustomClose() ? 4 : 0);
            LinearLayout linearLayout = (LinearLayout) findViewById(C1173R.C1175id.mraid_close_indicator);
            ...
            imageView.setImageDrawable(AppCompatResources.getDrawable(this, C1173R.C1174drawable.mraid_close));
