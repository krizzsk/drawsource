    ...
    static /* synthetic */ class C11711 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.amazon.device.ads.MraidPlacementType.C11711.<clinit>():void");
        }
    }

    public String toString() {
        int i = C11711.$SwitchMap$com$amazon$device$ads$MraidPlacementType[ordinal()];
        if (i == 1) {
            return "unknown";
        }
        if (i != 2) {
