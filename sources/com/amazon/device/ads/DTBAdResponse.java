...
public final class DTBAdResponse {
    ...
    private String getAmazonInfo() {
        ...
        int i = C11611.$SwitchMap$com$amazon$device$ads$AdType[dTBAdSize.getDTBAdType().ordinal()];
        if (i == 1) {
            str = "video";
        } else if (i == 2) {
            str = "banner";
    ...
    static /* synthetic */ class C11611 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.amazon.device.ads.DTBAdResponse.C11611.<clinit>():void");
        }
    }
