...
public class AdRegistration {
    ...
    public static class SlotGroup {
        ...
        public DTBAdSize getSizeByBannerType(DTBBannerType dTBBannerType) {
            try {
                int i = C11561.$SwitchMap$com$amazon$device$ads$DTBBannerType[dTBBannerType.ordinal()];
                if (i == 1) {
        ...
        public DTBAdSize getSizeBySlotType(DTBSlotType dTBSlotType) {
            try {
                int i = C11561.$SwitchMap$com$amazon$device$ads$DTBSlotType[dTBSlotType.ordinal()];
                int i2 = 50;
                int i3 = 320;
                if (i == 1) {
                    return getSizeByWidthAndHeight(320, 50);
    ...
    static /* synthetic */ class C11561 {
        ...
        static {
            ...
            L_0x004e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.amazon.device.ads.AdRegistration.C11561.<clinit>():void");
        }
    }
