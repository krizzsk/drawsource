...
final class DtbDeviceData {
    ...
    public JSONObject getParamsJson() {
        try {
            getOrientation();
            placeProperty(this.orientation, TJAdUnitConstants.String.ORIENTATION);
            getScreenSize();
    ...
    private void getUserAgent() {
        try {
            this.f943ua = WebSettings.getDefaultUserAgent(AdRegistration.getContext());
        } catch (Exception unused) {
