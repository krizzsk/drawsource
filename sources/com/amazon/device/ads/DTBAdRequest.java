...
public class DTBAdRequest implements DTBAdLoader {
    ...
    public void defineMraid() {
        ...
        mRaidDefined = true;
        int i = C11601.$SwitchMap$com$amazon$device$ads$MRAIDPolicy[AdRegistration.getMRAIDPolicy().ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i != 3) {
                    if (i == 4) {
    ...
    static /* synthetic */ class C11601 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.amazon.device.ads.DTBAdRequest.C11601.<clinit>():void");
        }
    }
