...
abstract class DTBAdMRAIDController implements DTBActivityListener {
    ...
    static /* synthetic */ class C11592 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.amazon.device.ads.DTBAdMRAIDController.C11592.<clinit>():void");
        }
    }

    private MraidProperty getCurrentStateProperty() {
        int i = C11592.$SwitchMap$com$amazon$device$ads$MraidStateType[this.state.ordinal()];
        if (i == 1) {
    ...
    public void setCloseIndicatorContent(View.OnTouchListener onTouchListener) {
        ...
        this.closeIndicatorRegion.setId(C1173R.C1175id.mraid_close_indicator);
        ImageView imageView = new ImageView(getAdView().getContext());
        imageView.setId(C1173R.C1175id.mraid_close_indicator);
        ...
        if (getDtbOmSdkSessionManager() != null) {
            getDtbOmSdkSessionManager().addFriendlyObstruction(this.closeIndicatorRegion.findViewById(C1173R.C1175id.mraid_close_indicator), FriendlyObstructionPurpose.CLOSE_AD);
        }
        imageView.setImageDrawable(AppCompatResources.getDrawable(getAdView().getContext(), C1173R.C1174drawable.mraid_close));
