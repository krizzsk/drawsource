...
public abstract class CommunicatorMessageImpl extends Intent {
    ...
    /* renamed from: a */
    private final String f2007a = UUID.randomUUID().toString();
    ...
    public String toString() {
        return "AppLovinCommunicatorMessage{publisherId=" + getPublisherId() + ", topic=" + getTopic() + '\'' + ", uniqueId='" + this.f2007a + '\'' + ", data=" + this.data + ", sticky=" + this.sticky + '}';
    }
}
