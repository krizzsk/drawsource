...
public class StringUtils {
    ...
    /* renamed from: a */
    private static final char[] f3977a = "0123456789abcdef".toCharArray();

    /* renamed from: a */
    private static String m4913a(String str, Integer num) {
    ...
    public static String encodeUriString(String str, C1969m mVar) {
        if (TextUtils.isEmpty(str)) {
            return "";
        }
        if (((Boolean) mVar.mo14534a(C1867b.f3323eO)).booleanValue()) {
    ...
    public static String toHexString(byte[] bArr) {
        if (bArr != null) {
            ...
            for (int i = 0; i < bArr.length; i++) {
                ...
                cArr[i2 + 1] = cArr2[bArr[i] & Ascii.f18305SI];
            }
