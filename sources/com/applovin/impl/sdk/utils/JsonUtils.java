...
public class JsonUtils {
    ...
    /* renamed from: a */
    private static Object m4911a(Object obj) throws JSONException {
    ...
    /* renamed from: a */
    private static <T> List<T> m4912a(JSONArray jSONArray, List<T> list) throws JSONException {
        if (jSONArray == null) {
            return list;
        }
        ArrayList arrayList = new ArrayList(jSONArray.length());
        for (int i = 0; i < jSONArray.length(); i++) {
            arrayList.add(m4911a(jSONArray.get(i)));
        }
        return arrayList;
    }
    ...
    public static JSONArray deepCopy(JSONArray jSONArray) {
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            try {
                ...
                if (C2102v.m5104a()) {
                    C2102v.m5109h("JsonUtils", "Failed to copy over item at index " + i + " to JSONArray deep copy");
                }
            }
        }
        return jSONArray2;
    ...
    public static JSONObject deepCopy(JSONObject jSONObject) {
        ...
        while (keys.hasNext()) {
            ...
            try {
                ...
                if (C2102v.m5104a()) {
                    C2102v.m5109h("JsonUtils", "Failed to copy over item for key '" + next + "' to JSONObject deep copy");
                }
            }
        }
        return jSONObject2;
    ...
    public static JSONObject deserialize(String str) {
        ...
        try {
            ...
            if (C2102v.m5104a()) {
                C2102v.m5110i("JsonUtils", "Failed to deserialize into JSON: " + str);
            }
            return null;
        }
    }
    ...
    public static double getDouble(JSONObject jSONObject, String str, double d) {
        ...
        try {
            ...
            C2102v.m5106c("JsonUtils", "Failed to retrieve double property for key = " + str, e);
            return d;
        }
    }
    ...
    public static float getFloat(JSONObject jSONObject, String str, float f) {
        ...
        try {
            ...
            C2102v.m5106c("JsonUtils", "Failed to retrieve float property for key = " + str, e);
            return f;
        }
    }
    ...
    public static int getInt(JSONObject jSONObject, String str, int i) {
        ...
        try {
            ...
            C2102v.m5106c("JsonUtils", "Failed to retrieve int property for key = " + str, e);
            return i;
        }
    }
    ...
    public static JSONArray getJSONArray(JSONObject jSONObject, String str, JSONArray jSONArray) {
        ...
        try {
            ...
            C2102v.m5106c("JsonUtils", "Failed to retrieve JSON array for key = " + str, e);
            return jSONArray;
        }
    }
    ...
    public static JSONObject getJSONObject(JSONArray jSONArray, int i, JSONObject jSONObject) {
        ...
        try {
            ...
            C2102v.m5106c("JsonUtils", "Failed to retrieve JSON object from array for index = " + i, e);
            return jSONObject;
        }
    }
    ...
    public static JSONObject getJSONObject(JSONObject jSONObject, String str, JSONObject jSONObject2) {
        ...
        try {
            ...
            C2102v.m5106c("JsonUtils", "Failed to retrieve JSON property for key = " + str, e);
            return jSONObject2;
        }
    }
    ...
    public static long getLong(JSONObject jSONObject, String str, long j) {
        ...
        try {
            ...
            C2102v.m5106c("JsonUtils", "Failed to retrieve long property for key = " + str, e);
            return j;
        }
    }
    ...
    public static Object getObject(JSONObject jSONObject, String str, Object obj) {
        ...
        try {
            ...
            C2102v.m5106c("JsonUtils", "Failed to retrieve Object for key = " + str, e);
            return obj;
        }
    }
    ...
    public static Object getObjectAtIndex(JSONArray jSONArray, int i, Object obj) {
        ...
        try {
            ...
            C2102v.m5106c("JsonUtils", "Failed to retrieve object at index " + i + " for JSON array", e);
            return obj;
        }
    }
    ...
    public static String getString(JSONObject jSONObject, String str, String str2) {
        ...
        try {
            ...
            C2102v.m5106c("JsonUtils", "Failed to retrieve string property for key = " + str, e);
            return str2;
        }
    }
    ...
    public static JSONObject jsonObjectFromJsonString(String str, JSONObject jSONObject) {
        try {
            ...
            if (C2102v.m5104a()) {
                C2102v.m5106c("JsonUtils", "Failed to convert JSON string '" + str + "' to JSONObject", e);
            }
            return jSONObject;
        }
    }
    ...
    public static void putBoolean(JSONObject jSONObject, String str, boolean z) {
        if (jSONObject != null) {
            try {
                ...
                if (C2102v.m5104a()) {
                    C2102v.m5106c("JsonUtils", "Failed to put boolean property for key = " + str, e);
                }
            }
        }
    }
    ...
    public static void putDouble(JSONObject jSONObject, String str, double d) {
        if (jSONObject != null) {
            try {
                ...
                if (C2102v.m5104a()) {
                    C2102v.m5106c("JsonUtils", "Failed to put double property for key = " + str, e);
                }
            }
        }
    }
    ...
    public static void putInt(JSONObject jSONObject, String str, int i) {
        if (jSONObject != null) {
            try {
                ...
                if (C2102v.m5104a()) {
                    C2102v.m5106c("JsonUtils", "Failed to put int property for key = " + str, e);
                }
            }
        }
    }
    ...
    public static void putJSONObject(JSONObject jSONObject, String str, JSONObject jSONObject2) {
        if (jSONObject != null) {
            try {
                ...
                if (C2102v.m5104a()) {
                    C2102v.m5106c("JsonUtils", "Failed to put JSON property for key = " + str, e);
                }
            }
        }
    }
    ...
    public static void putJsonArray(JSONObject jSONObject, String str, JSONArray jSONArray) {
        if (jSONObject != null) {
            try {
                ...
                if (C2102v.m5104a()) {
                    C2102v.m5106c("JsonUtils", "Failed to put JSONArray property for key = " + str, e);
                }
            }
        }
    }
    ...
    public static void putLong(JSONObject jSONObject, String str, long j) {
        if (jSONObject != null) {
            try {
                ...
                if (C2102v.m5104a()) {
                    C2102v.m5106c("JsonUtils", "Failed to put long property for key = " + str, e);
                }
            }
        }
    }
    ...
    public static void putObject(JSONObject jSONObject, String str, Object obj) {
        if (jSONObject != null) {
            try {
                ...
                if (C2102v.m5104a()) {
                    C2102v.m5106c("JsonUtils", "Failed to put Object property for key = " + str, e);
                }
            }
        }
    }
    ...
    public static void putString(JSONObject jSONObject, String str, String str2) {
        if (jSONObject != null) {
            try {
                ...
                if (C2102v.m5104a()) {
                    C2102v.m5106c("JsonUtils", "Failed to put String property for key = " + str, e);
                }
            }
        }
    }
    ...
    public static JSONObject shallowCopy(JSONObject jSONObject) {
        ...
        while (keys.hasNext()) {
            ...
            try {
                ...
                if (C2102v.m5104a()) {
                    C2102v.m5109h("JsonUtils", "Failed to copy over item for key '" + next + "' to JSONObject copy");
                }
            }
        }
        return jSONObject2;
    ...
    public static <T> List<T> toList(JSONArray jSONArray) throws JSONException {
        return m4912a(jSONArray, new ArrayList());
    }
    ...
    public static Map<String, String> toStringMap(JSONObject jSONObject) throws JSONException {
        ...
        while (keys.hasNext()) {
            String next = keys.next();
            hashMap.put(next, m4911a(jSONObject.get(next)).toString());
        }
        return hashMap;
    }
    ...
    public static Map<String, Object> toStringObjectMap(String str, Map<String, Object> map) {
        try {
            ...
            if (C2102v.m5104a()) {
                C2102v.m5106c("JsonUtils", "Failed to convert json string '" + str + "' to map", e);
            }
            return map;
        }
    }
    ...
    public static Map<String, Object> toStringObjectMap(JSONObject jSONObject) throws JSONException {
        ...
        while (keys.hasNext()) {
            String next = keys.next();
            hashMap.put(next, m4911a(jSONObject.get(next)));
        }
        return hashMap;
    }
