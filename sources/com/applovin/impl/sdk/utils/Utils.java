...
public abstract class Utils {
    ...
    public static List<Uri> checkCachedResourcesExist(boolean z, C1839e eVar, C1969m mVar, Context context) {
        if (eVar instanceof C1411a) {
            return Collections.emptyList();
        }
        ArrayList arrayList = new ArrayList();
        for (Uri uri : new ArrayList(eVar.mo14162A())) {
            if (!(mVar.mo14551aa() != null ? mVar.mo14551aa().mo14865b(uri.getLastPathSegment(), context) : mVar.mo14552ab().mo14857b(uri.getLastPathSegment(), context))) {
                if (C2102v.m5104a()) {
                    C2102v A = mVar.mo14509A();
                    A.mo15016e(TAG, "Cached HTML asset missing: " + uri);
                }
                arrayList.add(uri);
            }
        }
        if (z) {
            Uri h = eVar.mo12853h();
            if (!(mVar.mo14551aa() != null ? mVar.mo14551aa().mo14865b(h.getLastPathSegment(), context) : mVar.mo14552ab().mo14857b(h.getLastPathSegment(), context))) {
                if (C2102v.m5104a()) {
                    C2102v A2 = mVar.mo14509A();
                    A2.mo15016e(TAG, "Cached video missing: " + h);
                }
                arrayList.add(h);
            }
        }
    ...
    public static boolean checkExoPlayerEligibility(C1969m mVar) {
        if (isExoPlayerEligible == null) {
            int tryToGetExoPlayerVersionCode = tryToGetExoPlayerVersionCode();
            int intValue = ((Integer) mVar.mo14534a(C1867b.f3209cE)).intValue();
            isExoPlayerEligible = Boolean.valueOf(checkClassExistence("com.google.android.exoplayer2.ui.PlayerView") && tryToGetExoPlayerVersionCode >= ((Integer) mVar.mo14534a(C1867b.f3208cD)).intValue() && (intValue < 0 || tryToGetExoPlayerVersionCode <= intValue));
        }
        return isExoPlayerEligible.booleanValue();
    }

    public static void close(Closeable closeable, C1969m mVar) {
        if (closeable != null) {
            try {
                closeable.close();
            } catch (Throwable th) {
                if (mVar != null && C2102v.m5104a()) {
                    C2102v A = mVar.mo14509A();
                    A.mo15013b(TAG, "Unable to close stream: " + closeable, th);
                }
            }
        }
    }
    ...
    public static int compare(String str, String str2) {
        ...
        try {
            ...
            if (C2102v.m5104a()) {
                C2102v.m5106c(TAG, "Failed to process version string.", th);
            }
            return 0;
        }
    }

    public static void disconnect(HttpURLConnection httpURLConnection, C1969m mVar) {
        if (httpURLConnection != null) {
            try {
                ...
                if (mVar != null && C2102v.m5104a()) {
                    C2102v A = mVar.mo14509A();
                    A.mo15013b(TAG, "Unable to disconnect connection: " + httpURLConnection, th);
                }
            }
        }
    }
    ...
    private static List<Class> generateClassesList(List<String> list, C1969m mVar) {
        if (list == null) {
            return null;
        }
        ...
        for (String next : list) {
            try {
                ...
                if (C2102v.m5104a()) {
                    C2102v A = mVar.mo14509A();
                    A.mo15016e(TAG, "Failed to create class for name: " + next);
                }
            }
        }
        return arrayList;
    ...
    public static String getAndroidOSInfo() {
        try {
            ...
            C2102v.m5106c(TAG, "Unable to get Android OS info", th);
            return "";
        }
    }
    ...
    public static String getAndroidSdkCodename() {
        try {
            ...
            C2102v.m5106c(TAG, "Unable to get Android SDK codename", th);
            return "";
        }
    }
    ...
    public static String getCurrentAdServeId(Object obj) {
        if (obj instanceof C1583a) {
            return ((C1583a) obj).mo13365f();
        }
        if (C1655c.m3373a(obj)) {
            return ((C1839e) obj).mo14174N();
        }
        return null;
    }
    ...
    public static List<C1875a> getPostbacks(String str, JSONObject jSONObject, String str2, String str3, C1969m mVar) {
        return getPostbacks(str, jSONObject, str2, (Map<String, String>) null, str3, mVar);
    }

    public static List<C1875a> getPostbacks(String str, JSONObject jSONObject, String str2, String str3, Map<String, String> map, C1969m mVar) {
        return getPostbacks(str, jSONObject, str2, Collections.emptyMap(), str3, map, false, mVar);
    }

    public static List<C1875a> getPostbacks(String str, JSONObject jSONObject, String str2, Map<String, String> map, String str3, C1969m mVar) {
        return getPostbacks(str, jSONObject, str2, map, str3, (Map<String, String>) null, false, mVar);
    }

    public static List<C1875a> getPostbacks(String str, JSONObject jSONObject, String str2, Map<String, String> map, String str3, Map<String, String> map2, boolean z, C1969m mVar) {
        if (map == null) {
            map = new HashMap<>(1);
        }
    ...
    public static List<C1875a> getPostbacks(String str, JSONObject jSONObject, Map<String, String> map, String str2, C1969m mVar) {
        return getPostbacks(str, jSONObject, map, str2, (Map<String, String>) null, mVar);
    }

    public static List<C1875a> getPostbacks(String str, JSONObject jSONObject, Map<String, String> map, String str2, Map<String, String> map2, C1969m mVar) {
        return getPostbacks(str, jSONObject, map, str2, map2, false, mVar);
    }

    public static List<C1875a> getPostbacks(String str, JSONObject jSONObject, Map<String, String> map, String str2, Map<String, String> map2, boolean z, C1969m mVar) {
        ...
        if (StringUtils.isValidString(str2)) {
            arrayList.add(new C1875a(str2, (String) null, map2, z));
        }
            ...
            while (keys.hasNext()) {
                try {
                    ...
                    if (!TextUtils.isEmpty(next)) {
                        ...
                        arrayList.add(new C1875a(replace, optString, map2, z));
                    }
                } catch (Throwable th) {
                    if (C2102v.m5104a()) {
                        mVar.mo14509A().mo15013b(TAG, "Failed to create and add postback url.", th);
                    }
                }
            }
        }
    ...
    public static long getServerAdjustedUnixTimestampMillis(C1969m mVar) {
        long longValue = ((Long) mVar.mo14534a(C1867b.f3350er)).longValue();
        long longValue2 = ((Long) mVar.mo14534a(C1867b.f3351es)).longValue();
    ...
    public static C1838d getZone(JSONObject jSONObject, C1969m mVar) {
        return C1838d.m3902a(AppLovinAdSize.fromString(JsonUtils.getString(jSONObject, "ad_size", (String) null)), AppLovinAdType.fromString(JsonUtils.getString(jSONObject, "ad_type", (String) null)), JsonUtils.getString(jSONObject, "zone_id", (String) null));
    }
    ...
    public static boolean hasAndroidCoreJsonLibrary(C1969m mVar) {
        if (!C2049g.m4941c()) {
            return true;
        }
        try {
            ...
            mVar.mo14509A().mo15011a(TAG, "Failed to wrap JSONObject with exception", th);
            return false;
        }
    }

    public static boolean isAppLovinTestEnvironment(Context context) {
        return C2045d.m4928a(context).mo14892a("applovin.sdk.is_test_environment");
    }
    ...
    public static boolean isCurrentProcessInForeground() {
        ...
        try {
            ...
            if (C2102v.m5104a()) {
                C2102v.m5106c(TAG, "Exception thrown while getting memory state.", th);
            }
        }
    ...
    public static boolean isPubInDebugMode(Context context, C1969m mVar) {
        String str = mVar.mo14586p().getExtraParameters().get(SDK_EXTRA_PARAM_RUN_IN_RELEASE_MODE);
    ...
    public static boolean isUserAgentCollectionEnabled(C1969m mVar) {
        String str = mVar.mo14586p().getExtraParameters().get(SDK_EXTRA_PARAM_USER_AGENT_COLLECTION_ENABLED);
    ...
    public static boolean isVPNConnected() {
        ...
        L_0x002e:
            ...
            com.applovin.impl.sdk.C2102v.m5106c(r1, r2, r0)
        L_0x003c:
            r0 = 0
            return r0
        */
    ...
    public static boolean isVerboseLoggingConfigured() {
        Context M = C1969m.m4458M();
        if (M != null) {
            return C2045d.m4928a(M).mo14892a("applovin.sdk.verbose_logging");
        }
        return false;
    }
    ...
    public static boolean isVerboseLoggingEnabled(Context context) {
        if (context == null) {
            context = C1969m.m4458M();
        }
        if (context != null) {
            return C2045d.m4928a(context).mo14893a("applovin.sdk.verbose_logging", false);
        }
        return false;
    }

    public static boolean isVideoMutedInitially(C1969m mVar) {
        return ((Boolean) mVar.mo14534a(C1867b.f3251cu)).booleanValue() ? mVar.mo14586p().isMuted() : ((Boolean) mVar.mo14534a(C1867b.f3249cs)).booleanValue();
    }
    ...
    public static void maybeHandleNoFillResponseForPublisher(String str, MaxAdFormat maxAdFormat, JSONObject jSONObject, C1969m mVar) {
        if (jSONObject.has("no_fill_reason") && C2102v.m5104a()) {
            Object object = JsonUtils.getObject(jSONObject, "no_fill_reason", new Object());
            mVar.mo14509A().mo15016e("AppLovinSdk", "\n**************************************************\nNO FILL received:\n..ID: \"" + str + "\"\n..FORMAT: \"" + maxAdFormat.getLabel() + "\"\n..SDK KEY: \"" + mVar.mo14597z() + "\"\n..PACKAGE NAME: \"" + mVar.mo14520L().getPackageName() + "\"\n..Reason: " + object + "\n**************************************************\n");
        }
    }

    public static void maybeLogCustomDataSizeLimit(String str, String str2) {
        if (str != null && str.length() > kilobytesToByes(8)) {
            C2102v.m5109h(str2, "Provided custom data parameter longer than supported (" + str.length() + " bytes, " + kilobytesToByes(8) + " maximum)");
        }
    }

    public static AppLovinAd maybeRetrieveNonDummyAd(AppLovinAd appLovinAd, C1969m mVar) {
        if (!(appLovinAd instanceof C1845f)) {
            return appLovinAd;
        }
        C1845f fVar = (C1845f) appLovinAd;
        AppLovinAd dequeueAd = mVar.mo14592u().dequeueAd(fVar.getAdZone());
        if (C2102v.m5104a()) {
            C2102v A = mVar.mo14509A();
            A.mo15012b(TAG, "Dequeued ad for dummy ad: " + dequeueAd);
        }
        if (dequeueAd == null) {
            return fVar.mo14243a();
        }
        fVar.mo14244a(dequeueAd);
    ...
    public static boolean objectIsOfType(Object obj, List<String> list, C1969m mVar) {
        if (list == null) {
            return false;
        }
                ...
                if (obj instanceof Map) {
                    for (Map.Entry entry : ((Map) obj).entrySet()) {
                        if (!(entry.getKey() instanceof String)) {
                            if (C2102v.m5104a()) {
                                mVar.mo14509A().mo15012b(TAG, "Invalid key type used. Map keys should be of type String.");
                            }
                            return false;
        ...
        if (C2102v.m5104a()) {
            C2102v A = mVar.mo14509A();
            A.mo15012b(TAG, "Object '" + obj + "' does not match any of the required types '" + list + "'.");
        }
        return false;
    }

    public static boolean openUri(Context context, Uri uri, C1969m mVar) {
        boolean z = false;
        if (uri == null) {
            return false;
        }
        try {
            ...
            mVar.mo14554ad().mo15027c();
            context.startActivity(intent);
            z = true;
        } catch (Throwable th) {
            if (C2102v.m5104a()) {
                C2102v A = mVar.mo14509A();
                A.mo15013b(TAG, "Unable to open \"" + uri + "\".", th);
            }
        }
        if (!z) {
            mVar.mo14554ad().mo15028d();
        }
        return z;
    }
    ...
    public static Activity retrieveParentActivity(View view, C1969m mVar) {
        if (view == null) {
            return null;
        }
        int i = 0;
        while (i < 1000) {
            ...
            try {
                ...
                if (C2102v.m5104a()) {
                    mVar.mo14509A().mo15013b(TAG, "Encountered error while retrieving activity from view", th);
                }
            }
        }
        return null;
    ...
    public static Object sanitizeSuperProperty(Object obj, C1969m mVar) {
        int i;
        if (obj instanceof Map) {
            Map map = (Map) obj;
            ...
            if (obj instanceof String) {
                i = ((Integer) mVar.mo14534a(C1867b.f3184bf)).intValue();
                if (i <= 0 || valueOf.length() <= i) {
                    return valueOf;
                }
            } else if (!(obj instanceof Uri) || (i = ((Integer) mVar.mo14534a(C1867b.f3185bg)).intValue()) <= 0 || valueOf.length() <= i) {
                return valueOf;
            }
    ...
    public static Map<String, String> toUrlSafeMap(Map<String, String> map, C1969m mVar) {
    ...
    public static int toVersionCode(String str) {
        ...
        for (String str2 : str.replaceAll("-beta", ".").split(DnsName.ESCAPED_DOT)) {
            if (str2.length() > 2) {
                if (C2102v.m5104a()) {
                    C2102v.m5110i(TAG, "Version number components cannot be longer than two digits -> " + str);
                }
                return i;
            }
    ...
    public static double tryParseDouble(String str, double d) {
        try {
            ...
            if (C2102v.m5104a()) {
                C2102v.m5106c(TAG, "Failed to parse double from String: " + str, th);
            }
            return d;
        }
    }
    ...
    public static WebView tryToCreateWebView(Context context, String str) {
        try {
            ...
            C2102v.m5106c(TAG, "Failed to initialize WebView for " + str + ".", th);
            return null;
        }
    }
    ...
    public static void validateAdSdkKey(AppLovinAd appLovinAd, C1969m mVar) {
        if (appLovinAd instanceof AppLovinAdBase) {
            String z = mVar.mo14597z();
            String z2 = ((AppLovinAdBase) appLovinAd).getSdk().mo14597z();
            if (!z.equals(z2)) {
                if (C2102v.m5104a()) {
                    C2102v.m5110i("AppLovinAd", "Ad was loaded from sdk with key: " + z2 + ", but is being rendered from sdk with key: " + z);
                }
                mVar.mo14527T().mo14351a(C1881f.f3476l);
            }
        }
    }
}
