...
public class C2045d {
    ...
    /* renamed from: a */
    private static C2045d f3985a;

    /* renamed from: b */
    private static final Object f3986b = new Object();

    /* renamed from: c */
    private final Bundle f3987c;
    ...
    private C2045d(android.content.Context r10) {
        /*
            r9 = this;
        ...
        L_0x001a:
            r2 = move-exception
            boolean r3 = com.applovin.impl.sdk.C2102v.m5104a()     // Catch:{ all -> 0x0017 }
            if (r3 == 0) goto L_0x0026
            java.lang.String r3 = "Failed to get meta data."
            com.applovin.impl.sdk.C2102v.m5106c(r0, r3, r2)     // Catch:{ all -> 0x0017 }
        L_0x0026:
            r9.f3987c = r1
            r1 = 0
        ...
        L_0x008c:
            ...
            r4 = r1
        L_0x008e:
            boolean r2 = com.applovin.impl.sdk.C2102v.m5104a()     // Catch:{ all -> 0x009e }
            if (r2 == 0) goto L_0x0099
            java.lang.String r2 = "Failed to parse AndroidManifest.xml."
            com.applovin.impl.sdk.C2102v.m5106c(r0, r2, r10)     // Catch:{ all -> 0x009e }
        L_0x0099:
            r9.f3988d = r1
        L_0x009b:
            r9.f3989e = r4
        ...
        L_0x00a4:
            ...
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.applovin.impl.sdk.utils.C2045d.<init>(android.content.Context):void");
    }

    /* renamed from: a */
    public static C2045d m4928a(Context context) {
        C2045d dVar;
        synchronized (f3986b) {
            if (f3985a == null) {
                f3985a = new C2045d(context);
            }
            dVar = f3985a;
        }
        return dVar;
    ...
    /* renamed from: a */
    public String mo14890a(String str, String str2) {
        Bundle bundle = this.f3987c;
        return bundle != null ? bundle.getString(str, str2) : str2;
    }

    /* renamed from: a */
    public boolean mo14891a() {
        return this.f3988d != 0;
    }

    /* renamed from: a */
    public boolean mo14892a(String str) {
        Bundle bundle = this.f3987c;
        if (bundle != null) {
    ...
    /* renamed from: a */
    public boolean mo14893a(String str, boolean z) {
        Bundle bundle = this.f3987c;
