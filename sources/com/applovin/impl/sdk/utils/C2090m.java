...
public class C2090m {
    /* renamed from: a */
    public static String m5045a(String str, String str2) {
        return m5048a(str, str2, new byte[]{-83, -98, -53, -112, -29, -118, 55, 117, 59, 8, -12, -15, 73, 110, -67, 57, 117, 4, -26, 97, 66, -12, 125, 91, -119, -103, -30, 114, 123, 54, 51, -77});
    }

    /* renamed from: a */
    public static String m5046a(String str, String str2, long j) {
        return m5047a(str, str2, j, new byte[]{-83, -98, -53, -112, -29, -118, 55, 117, 59, 8, -12, -15, 73, 110, -67, 57, 117, 4, -26, 97, 66, -12, 125, 91, -119, -103, -30, 114, 123, 54, 51, -77});
    }

    /* renamed from: a */
    private static String m5047a(String str, String str2, long j, byte[] bArr) {
        String str3 = str;
        String str4 = str2;
        byte[] bArr2 = bArr;
        if (str4 == null) {
            ...
            if (bArr2.length < 32) {
                ...
                try {
                    ...
                    byte[] a = m5051a(substring2, bArr2);
                    ...
                    String b = m5053b(byteArrayOutputStream.toByteArray());
                    return "1:" + m5049a(bArr) + CertificateUtil.DELIMITER + substring + CertificateUtil.DELIMITER + b;
    ...
    /* renamed from: a */
    private static String m5048a(String str, String str2, byte[] bArr) {
        String str3 = str;
        String str4 = str2;
        byte[] bArr2 = bArr;
        if (str4 == null) {
            ...
            if (bArr2.length < 32) {
                ...
                try {
                    ...
                    String str5 = split[1];
                    String str6 = split[2];
                    byte[] a = m5050a(split[3]);
                    if (!str4.endsWith(str6)) {
                        return null;
                    }
                    if (!m5049a(bArr).equals(str5)) {
                        return null;
                    }
                    byte[] a2 = m5051a(str4.substring(0, 32), bArr2);
    ...
    /* renamed from: a */
    private static String m5049a(byte[] bArr) {
        try {
    ...
    /* renamed from: a */
    private static byte[] m5050a(String str) {
        return Base64.decode(m5052b(str), 0);
    }

    /* renamed from: a */
    private static byte[] m5051a(String str, byte[] bArr) {
        try {
    ...
    /* renamed from: b */
    private static String m5052b(String str) {
        return str.replace('-', '+').replace('_', '/').replace('*', '=');
    }

    /* renamed from: b */
    private static String m5053b(byte[] bArr) throws UnsupportedEncodingException {
        return m5054c(Base64.encode(bArr, 2));
    }

    /* renamed from: c */
    private static String m5054c(byte[] bArr) throws UnsupportedEncodingException {
