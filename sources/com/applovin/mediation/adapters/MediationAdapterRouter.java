...
public abstract class MediationAdapterRouter {
    ...
    protected MediationAdapterRouter() {
        for (AppLovinSdk next : AppLovinSdk.m5176a()) {
            if ("max".equalsIgnoreCase(next.getMediationProvider())) {
                this.mSdk = next.coreSdk;
            }
        }
        if (C2102v.m5104a() && this.mSdk == null) {
            C2102v.m5110i(this.mTag, "Invalid mediation provider detected. Please set AppLovin SDK mediation provider to MAX via AppLovinSdk.getInstance(context).setMediationProvider( AppLovinMediationProvider.MAX )");
        }
    }
    ...
    public void log(String str) {
        C1969m mVar;
        if (C2102v.m5104a() && (mVar = this.mSdk) != null) {
            mVar.mo14509A().mo15014c(this.mTag, str);
        }
    }

    /* access modifiers changed from: protected */
    public void log(String str, Throwable th) {
        if (this.mSdk != null && C2102v.m5104a()) {
            this.mSdk.mo14509A().mo15013b(this.mTag, str, th);
        }
    }
