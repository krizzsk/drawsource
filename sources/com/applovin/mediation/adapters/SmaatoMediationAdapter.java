...
import com.smaato.sdk.banner.p379ad.AutoReloadInterval;
...
public class SmaatoMediationAdapter extends MediationAdapterBase implements MaxSignalProvider, MaxAdViewAdapter, MaxInterstitialAdapter, MaxRewardedAdapter {
    ...
    public void loadNativeAd(MaxAdapterResponseParameters maxAdapterResponseParameters, Activity activity, MaxNativeAdAdapterListener maxNativeAdAdapterListener) {
        ...
        updateAgeRestrictedUser(maxAdapterResponseParameters);
        updateLocationCollectionEnabled(maxAdapterResponseParameters);
        NativeAd.loadAd(Lifecycling.m30605of(activity), NativeAdRequest.builder().adSpaceId(thirdPartyAdPlacementId).shouldReturnUrlsForImageAssets(false).build(), (NativeAd.Listener) new NativeAdListener(maxAdapterResponseParameters, getContext(activity), maxNativeAdAdapterListener));
    }
    ...
    public static MaxAdapterError toMaxError(BannerError bannerError) {
        ...
        switch (C21692.$SwitchMap$com$smaato$sdk$banner$widget$BannerError[bannerError.ordinal()]) {
            case 1:
    ...
    public static MaxAdapterError toMaxError(NativeAdError nativeAdError) {
        MaxAdapterError maxAdapterError = MaxAdapterError.UNSPECIFIED;
        int i = C21692.$SwitchMap$com$smaato$sdk$nativead$NativeAdError[nativeAdError.ordinal()];
        if (i == 1) {
            maxAdapterError = MaxAdapterError.NO_FILL;
        } else if (i == 2) {
            maxAdapterError = MaxAdapterError.INVALID_CONFIGURATION;
            ...
            AppLovinSdkUtils.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    L_0x00e6:
                        ...
                        return
                    */
                    throw new UnsupportedOperationException("Method not decompiled: com.applovin.mediation.adapters.SmaatoMediationAdapter.NativeAdListener.C21701.run():void");
                }
            });
        }
    ...
    private class MaxSmaatoNativeAd extends MaxNativeAd {
        ...
        public void prepareViewForInteraction(MaxNativeAdView maxNativeAdView) {
            NativeAdRenderer access$300 = SmaatoMediationAdapter.this.nativeAdRenderer;
            if (access$300 == null) {
                SmaatoMediationAdapter.this.mo15240e("Failed to register native ad view for interaction. Native ad renderer is null");
                return;
            }
            access$300.registerForImpression(maxNativeAdView);
            access$300.registerForClicks(maxNativeAdView);
        }
    }
    ...
    private static class SmaatoMediationAdapterRouter extends MediationAdapterRouter implements EventListener, com.smaato.sdk.rewarded.EventListener {
        ...
        private static MaxAdapterError toMaxError(InterstitialError interstitialError) {
            MaxAdapterError maxAdapterError = MaxAdapterError.UNSPECIFIED;
            switch (C21692.$SwitchMap$com$smaato$sdk$interstitial$InterstitialError[interstitialError.ordinal()]) {
                case 1:
                    maxAdapterError = MaxAdapterError.NO_FILL;
                    break;
                case 2:
        ...
        private static MaxAdapterError toMaxError(RewardedError rewardedError) {
            MaxAdapterError maxAdapterError = MaxAdapterError.UNSPECIFIED;
            switch (C21692.$SwitchMap$com$smaato$sdk$rewarded$RewardedError[rewardedError.ordinal()]) {
                case 1:
                    maxAdapterError = MaxAdapterError.NO_FILL;
                    break;
                case 2:
    ...
    static /* synthetic */ class C21692 {
        ...
        static {
            ...
            L_0x011d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.applovin.mediation.adapters.SmaatoMediationAdapter.C21692.<clinit>():void");
        }
    }
}
