...
public class GoogleMediationAdapter extends MediationAdapterBase implements MaxSignalProvider, MaxInterstitialAdapter, MaxRewardedInterstitialAdapter, MaxRewardedAdapter, MaxAdViewAdapter {
    ...
    public void onDestroy() {
        ...
        if (appOpenAd2 != null) {
            appOpenAd2.setFullScreenContentCallback((FullScreenContentCallback) null);
            this.appOpenAd = null;
    ...
    public void loadAppOpenAd(MaxAdapterResponseParameters maxAdapterResponseParameters, Activity activity, final MaxAppOpenAdapterListener maxAppOpenAdapterListener) {
        ...
        updateMuteState(maxAdapterResponseParameters);
        setRequestConfiguration(maxAdapterResponseParameters);
        AdRequest createAdRequestWithParameters = createAdRequestWithParameters(isValidString, MaxAdFormat.APP_OPEN, maxAdapterResponseParameters, activity);
        Context context = getContext(activity);
        AppOpenAd.load(context, thirdPartyAdPlacementId, createAdRequestWithParameters, AppLovinSdkUtils.getOrientation(context), (AppOpenAd.AppOpenAdLoadCallback) new AppOpenAd.AppOpenAdLoadCallback() {
            public void onAdLoaded(AppOpenAd appOpenAd) {
                GoogleMediationAdapter googleMediationAdapter = GoogleMediationAdapter.this;
                googleMediationAdapter.log("App open ad loaded: " + thirdPartyAdPlacementId + APSSharedUtil.TRUNCATE_SEPARATOR);
                AppOpenAd unused = GoogleMediationAdapter.this.appOpenAd = appOpenAd;
                AppOpenAdListener unused2 = GoogleMediationAdapter.this.appOpenAdListener = new AppOpenAdListener(thirdPartyAdPlacementId, maxAppOpenAdapterListener);
            ...
            public void onAdFailedToLoad(LoadAdError loadAdError) {
                MaxAdapterError access$200 = GoogleMediationAdapter.toMaxError(loadAdError);
                GoogleMediationAdapter googleMediationAdapter = GoogleMediationAdapter.this;
                googleMediationAdapter.log("App open ad (" + thirdPartyAdPlacementId + ") failed to load with error: " + access$200);
                maxAppOpenAdapterListener.onAppOpenAdLoadFailed(access$200);
            }
        });
    }
    ...
    public void showAppOpenAd(MaxAdapterResponseParameters maxAdapterResponseParameters, Activity activity, MaxAppOpenAdapterListener maxAppOpenAdapterListener) {
        ...
        maxAppOpenAdapterListener.onAppOpenAdDisplayFailed(new MaxAdapterError((int) MaxAdapterError.ERROR_CODE_AD_DISPLAY_FAILED, "Ad Display Failed"));
    }
        ...
        if (AppLovinSdk.VERSION_CODE >= 11000000) {
            ...
            if (obj4 instanceof List) {
                try {
                    ...
                    mo15241e("Neighbouring content URL strings extra param needs to be of type List<String>.", th);
                }
            }
        }
    ...
    private class RewardedInterstitialAdListener extends FullScreenContentCallback {
        ...
        public void onAdImpression() {
            GoogleMediationAdapter googleMediationAdapter = GoogleMediationAdapter.this;
            googleMediationAdapter.log("Rewarded interstitial ad impression recorded: " + this.placementId);
    ...
    private class NativeAdViewListener extends AdListener implements NativeAd.OnNativeAdLoadedListener {
        ...
        public void onNativeAdLoaded(NativeAd nativeAd) {
            ...
            final Context access$1400 = GoogleMediationAdapter.this.getContext(activity);
            final MediaView mediaView = new MediaView(access$1400);
            ...
            AppLovinSdkUtils.runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    if (AppLovinSdk.VERSION_CODE < 9140000) {
                        ...
                        maxNativeAdView = new MaxNativeAdView(build, string, access$1400);
                    } else {
                        maxNativeAdView = new MaxNativeAdView(build, string, activity);
                    }
                    NativeAdView unused = GoogleMediationAdapter.this.nativeAdView = new NativeAdView(access$1400);
    ...
    private class NativeAdListener extends AdListener implements NativeAd.OnNativeAdLoadedListener {
        ...
        public void onNativeAdLoaded(final NativeAd nativeAd) {
            ...
            GoogleMediationAdapter googleMediationAdapter2 = GoogleMediationAdapter.this;
            googleMediationAdapter2.mo15240e("Native ad (" + nativeAd + ") does not have required assets.");
    ...
    private class MaxGoogleNativeAd extends MaxNativeAd {
        ...
        public void prepareViewForInteraction(MaxNativeAdView maxNativeAdView) {
            NativeAd access$1300 = GoogleMediationAdapter.this.nativeAd;
            if (access$1300 == null) {
                GoogleMediationAdapter.this.mo15240e("Failed to register native ad views: native ad is null.");
                return;
            }
            ...
            GoogleMediationAdapter.this.nativeAdView.setNativeAd(access$1300);
        }
    }
}
