...
public class InMobiMediationAdapter extends MediationAdapterBase implements MaxAdViewAdapter, MaxInterstitialAdapter, MaxRewardedAdapter, MaxSignalProvider {
    ...
    public static MaxAdapterError toMaxError(InMobiAdRequestStatus inMobiAdRequestStatus) {
        ...
        switch (C21452.$SwitchMap$com$inmobi$ads$InMobiAdRequestStatus$StatusCode[statusCode.ordinal()]) {
            case 1:
    ...
    static /* synthetic */ class C21452 {
        ...
        static {
            ...
            L_0x00fc:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.applovin.mediation.adapters.InMobiMediationAdapter.C21452.<clinit>():void");
        }
    }
    ...
    private class NativeAdListener extends NativeAdEventListener {
        ...
        public void onAdLoadSucceeded(final InMobiNative inMobiNative, final AdMetaInfo adMetaInfo) {
            if (InMobiMediationAdapter.this.nativeAd == null || InMobiMediationAdapter.this.nativeAd != inMobiNative) {
                    ...
                    public void run() {
                        ...
                        if (AppLovinSdkUtils.isValidString(inMobiNative.getAdIconUrl())) {
                            ...
                            try {
                                ...
                                inMobiMediationAdapter2.mo15241e("Failed to fetch icon image from URL: " + inMobiNative.getAdIconUrl(), th);
                            }
                ...
                InMobiMediationAdapter inMobiMediationAdapter2 = InMobiMediationAdapter.this;
                inMobiMediationAdapter2.mo15240e("Native ad (" + InMobiMediationAdapter.this.nativeAd + ") does not have required assets.");
    ...
    private class MaxInMobiNativeAd extends MaxNativeAd {
        ...
        public void prepareViewForInteraction(final MaxNativeAdView maxNativeAdView) {
            final InMobiNative access$200 = InMobiMediationAdapter.this.nativeAd;
            if (access$200 == null) {
                InMobiMediationAdapter.this.mo15240e("Failed to register native ad views: native ad is null.");
                return;
            }
            ...
            frameLayout.post(new Runnable() {
                public void run() {
                    InMobiNative inMobiNative = access$200;
                    Context context = frameLayout.getContext();
                    FrameLayout frameLayout = frameLayout;
                    View primaryViewOfWidth = inMobiNative.getPrimaryViewOfWidth(context, (View) null, frameLayout, frameLayout.getWidth());
                    if (primaryViewOfWidth != null) {
                        frameLayout.addView(primaryViewOfWidth);
                    }
                }
            });
            final C21472 r1 = new View.OnClickListener() {
                public void onClick(View view) {
                    InMobiMediationAdapter.this.log("Native ad clicked from click listener");
                    access$200.reportAdClickAndOpenLandingPage();
            ...
            AppLovinSdkUtils.runOnUiThread(new Runnable() {
                public void run() {
                    if (maxNativeAdView.getTitleTextView() != null) {
                        maxNativeAdView.getTitleTextView().setOnClickListener(r1);
                    }
                    if (maxNativeAdView.getAdvertiserTextView() != null) {
                        maxNativeAdView.getAdvertiserTextView().setOnClickListener(r1);
                    }
                    if (maxNativeAdView.getBodyTextView() != null) {
                        maxNativeAdView.getBodyTextView().setOnClickListener(r1);
                    }
                    if (maxNativeAdView.getIconImageView() != null) {
                        maxNativeAdView.getIconImageView().setOnClickListener(r1);
                    }
                    if (maxNativeAdView.getCallToActionButton() != null) {
                        maxNativeAdView.getCallToActionButton().setOnClickListener(r1);
                    }
                }
            });
        }
