...
public class MintegralMediationAdapter extends MediationAdapterBase implements MaxInterstitialAdapter, MaxRewardedAdapter, MaxAdViewAdapter, MaxSignalProvider {
    ...
    public void initialize(MaxAdapterInitializationParameters maxAdapterInitializationParameters, Activity activity, MaxAdapter.OnCompletionListener onCompletionListener) {
        ...
        if (initialized.compareAndSet(false, true)) {
            ...
            C9196a mBridgeSDK = MBridgeSDKFactory.getMBridgeSDK();
    ...
    public void onDestroy() {
        ...
        if (mBRewardVideoHandler != null) {
            mBRewardVideoHandler.setRewardVideoListener((C9310g) null);
            this.mbRewardVideoHandler = null;
        }
        MBBidRewardVideoHandler mBBidRewardVideoHandler = this.mbBidRewardVideoHandler;
        if (mBBidRewardVideoHandler != null) {
            mBBidRewardVideoHandler.setRewardVideoListener((C9310g) null);
    ...
    private class MaxMintegralNativeAd extends MaxNativeAd {
        ...
        public void prepareViewForInteraction(MaxNativeAdView maxNativeAdView) {
            Campaign access$600 = MintegralMediationAdapter.this.nativeAdCampaign;
            if (access$600 == null) {
                MintegralMediationAdapter.this.mo15240e("Failed to register native ad views: native ad is null.");
                return;
            }
            ...
            MintegralMediationAdapter.this.mbBidNativeHandler.registerView(maxNativeAdView, arrayList, access$600);
