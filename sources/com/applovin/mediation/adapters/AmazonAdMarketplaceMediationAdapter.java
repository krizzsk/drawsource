...
public class AmazonAdMarketplaceMediationAdapter extends MediationAdapterBase implements MaxSignalProvider, MaxAdViewAdapter, MaxInterstitialAdapter, MaxRewardedAdapter {
    ...
    private void loadSubsequentSignal(DTBAdLoader dTBAdLoader, final MaxAdapterSignalCollectionParameters maxAdapterSignalCollectionParameters, final MaxAdFormat maxAdFormat, final MaxSignalCollectionListener maxSignalCollectionListener) {
        mo15239d("Found existing ad loader (" + dTBAdLoader + ") for format: " + maxAdFormat + " - loading...");
        dTBAdLoader.loadAd(new DTBAdCallback() {
            public void onSuccess(DTBAdResponse dTBAdResponse) {
                ...
                amazonAdMarketplaceMediationAdapter.mo15239d("Signal collected for ad loader: " + dTBAdResponse.getAdLoader());
            ...
            public void onFailure(AdError adError) {
                ...
                AmazonAdMarketplaceMediationAdapter amazonAdMarketplaceMediationAdapter = AmazonAdMarketplaceMediationAdapter.this;
                amazonAdMarketplaceMediationAdapter.mo15239d("Signal failed to collect for ad loader: " + adError.getAdLoader());
    ...
    public void processAdResponse(MaxAdapterSignalCollectionParameters maxAdapterSignalCollectionParameters, DTBAdResponse dTBAdResponse, MaxSignalCollectionListener maxSignalCollectionListener) {
        mo15239d("Processing ad response...");
        ...
        if (AppLovinSdkUtils.isValidString(pricePoint)) {
            ...
            mo15239d("Successfully loaded encoded bid id: " + pricePoint);
    ...
    public void loadAdViewAd(MaxAdapterResponseParameters maxAdapterResponseParameters, MaxAdFormat maxAdFormat, Activity activity, MaxAdViewAdapterListener maxAdViewAdapterListener) {
        ...
        mo15239d("Loading " + maxAdFormat.getLabel() + " ad view ad for encoded bid id: " + string + APSSharedUtil.TRUNCATE_SEPARATOR);
        ...
        mo15240e("Unable to find mediation hints");
        maxAdViewAdapterListener.onAdViewAdLoadFailed(MaxAdapterError.INVALID_LOAD_STATE);
    }

    public void loadInterstitialAd(MaxAdapterResponseParameters maxAdapterResponseParameters, Activity activity, MaxInterstitialAdapterListener maxInterstitialAdapterListener) {
        String string = maxAdapterResponseParameters.getServerParameters().getString("encoded_bid_id");
        mo15239d("Loading interstitial ad for encoded bid id: " + string + APSSharedUtil.TRUNCATE_SEPARATOR);
        if (TextUtils.isEmpty(string)) {
    ...
    public void showInterstitialAd(MaxAdapterResponseParameters maxAdapterResponseParameters, Activity activity, MaxInterstitialAdapterListener maxInterstitialAdapterListener) {
        ...
        mo15240e("Interstitial ad is null");
    ...
    public void loadRewardedAd(MaxAdapterResponseParameters maxAdapterResponseParameters, Activity activity, MaxRewardedAdapterListener maxRewardedAdapterListener) {
        String string = maxAdapterResponseParameters.getServerParameters().getString("encoded_bid_id");
        mo15239d("Loading rewarded ad for encoded bid id: " + string + APSSharedUtil.TRUNCATE_SEPARATOR);
        if (TextUtils.isEmpty(string)) {
    ...
    private boolean loadFullscreenAd(String str, DTBAdInterstitial dTBAdInterstitial) {
        MediationHints mediationHints;
        synchronized (mediationHintsCacheLock) {
            mediationHints = mediationHintsCache.get(str);
            mediationHintsCache.remove(str);
        }
        if (mediationHints == null) {
            mo15240e("Unable to find mediation hints");
            return false;
    ...
    private class AdViewListener implements DTBAdBannerListener {
        ...
        public void onAdLoaded(View view) {
            AmazonAdMarketplaceMediationAdapter.this.mo15239d("AdView ad loaded");
            this.listener.onAdViewAdLoaded(view);
        }

        public void onAdFailed(View view) {
            AmazonAdMarketplaceMediationAdapter.this.mo15240e("AdView failed to load");
            this.listener.onAdViewAdLoadFailed(MaxAdapterError.UNSPECIFIED);
        }

        public void onAdClicked(View view) {
            AmazonAdMarketplaceMediationAdapter.this.mo15239d("AdView clicked");
            this.listener.onAdViewAdClicked();
        }

        public void onImpressionFired(View view) {
            AmazonAdMarketplaceMediationAdapter.this.mo15239d("AdView impression fired");
            this.listener.onAdViewAdDisplayed();
        }

        public void onAdOpen(View view) {
            AmazonAdMarketplaceMediationAdapter.this.mo15239d("AdView expanded");
            this.listener.onAdViewAdExpanded();
        }

        public void onAdClosed(View view) {
            AmazonAdMarketplaceMediationAdapter.this.mo15239d("AdView collapsed");
            this.listener.onAdViewAdCollapsed();
        }

        public void onAdLeftApplication(View view) {
            AmazonAdMarketplaceMediationAdapter.this.mo15239d("AdView left application");
        }
    }
    ...
    private class InterstitialListener implements DTBAdInterstitialListener {
        ...
        public void onAdLoaded(View view) {
            AmazonAdMarketplaceMediationAdapter.this.mo15239d("Interstitial loaded");
            this.listener.onInterstitialAdLoaded();
        }

        public void onAdFailed(View view) {
            AmazonAdMarketplaceMediationAdapter.this.mo15240e("Interstitial failed to load");
            this.listener.onInterstitialAdLoadFailed(MaxAdapterError.NO_FILL);
        }

        public void onImpressionFired(View view) {
            AmazonAdMarketplaceMediationAdapter.this.mo15239d("Interstitial did fire impression");
            this.listener.onInterstitialAdDisplayed();
        }

        public void onAdOpen(View view) {
            AmazonAdMarketplaceMediationAdapter.this.mo15239d("Interstitial did open");
        }

        public void onAdClicked(View view) {
            AmazonAdMarketplaceMediationAdapter.this.mo15239d("Interstitial clicked");
            this.listener.onInterstitialAdClicked();
        }

        public void onVideoCompleted(View view) {
            AmazonAdMarketplaceMediationAdapter.this.mo15239d("Interstitial video completed");
        }

        public void onAdClosed(View view) {
            AmazonAdMarketplaceMediationAdapter.this.mo15239d("Interstitial closed");
            this.listener.onInterstitialAdHidden();
        }

        public void onAdLeftApplication(View view) {
            AmazonAdMarketplaceMediationAdapter.this.mo15239d("Interstitial will leave application");
        }
    }
    ...
    private class RewardedAdListener implements DTBAdInterstitialListener {
        ...
        public void onAdLoaded(View view) {
            AmazonAdMarketplaceMediationAdapter.this.mo15239d("Rewarded ad loaded");
            this.listener.onRewardedAdLoaded();
        }

        public void onAdFailed(View view) {
            AmazonAdMarketplaceMediationAdapter.this.mo15240e("Rewarded ad failed to load");
            this.listener.onRewardedAdLoadFailed(MaxAdapterError.NO_FILL);
        }

        public void onImpressionFired(View view) {
            AmazonAdMarketplaceMediationAdapter.this.mo15239d("Rewarded ad did fire impression");
            this.listener.onRewardedAdDisplayed();
        }

        public void onAdOpen(View view) {
            AmazonAdMarketplaceMediationAdapter.this.mo15239d("Rewarded ad did open");
            this.listener.onRewardedAdVideoStarted();
        }

        public void onAdClicked(View view) {
            AmazonAdMarketplaceMediationAdapter.this.mo15239d("Rewarded ad clicked");
            this.listener.onRewardedAdClicked();
        }

        public void onVideoCompleted(View view) {
            AmazonAdMarketplaceMediationAdapter.this.mo15239d("Rewarded ad video completed");
            this.hasGrantedReward = true;
            this.listener.onRewardedAdVideoCompleted();
        }

        public void onAdClosed(View view) {
            AmazonAdMarketplaceMediationAdapter.this.mo15239d("Rewarded ad closed");
            if (this.hasGrantedReward || AmazonAdMarketplaceMediationAdapter.this.shouldAlwaysRewardUser()) {
                ...
                AmazonAdMarketplaceMediationAdapter amazonAdMarketplaceMediationAdapter = AmazonAdMarketplaceMediationAdapter.this;
                amazonAdMarketplaceMediationAdapter.mo15239d("Rewarded user with reward: " + reward);
        ...
        public void onAdLeftApplication(View view) {
            AmazonAdMarketplaceMediationAdapter.this.mo15239d("Rewarded ad will leave application");
        }
    }
    ...
    private static class MediationHints {
        ...
        private MediationHints(String str) {
            this.f4158id = UUID.randomUUID().toString().toLowerCase(Locale.US);
            this.value = str;
        }
        ...
        public boolean equals(Object obj) {
            ...
            String str = this.f4158id;
            if (str == null ? mediationHints.f4158id != null : !str.equals(mediationHints.f4158id)) {
                return false;
            }
        ...
        public String toString() {
            return "MediationHints{id=" + this.f4158id + ", value=" + this.value + '}';
        }
    }
    ...
    private static class CleanupMediationHintsTask implements Runnable {
        ...
        public void run() {
            synchronized (AmazonAdMarketplaceMediationAdapter.mediationHintsCacheLock) {
                ...
                if (mediationHints2 != null && mediationHints2.f4158id.equals(this.mediationHints.f4158id)) {
