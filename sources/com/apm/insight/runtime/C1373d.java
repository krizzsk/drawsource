...
public class C1373d {
    ...
    /* renamed from: b */
    private ICommonParams f1446b;

    /* renamed from: c */
    private ICommonParams f1447c;

    public C1373d(Context context, ICommonParams iCommonParams) {
        this(context, iCommonParams, (C1373d) null);
    }

    public C1373d(Context context, ICommonParams iCommonParams, C1373d dVar) {
        this.f1445a = context;
        this.f1446b = iCommonParams;
        this.f1447c = dVar == null ? null : dVar.f1446b;
    }

    /* renamed from: a */
    public static String m2225a(Map<String, Object> map, String str) {
        Object obj;
    ...
    /* renamed from: a */
    public static boolean m2226a(Map<String, Object> map) {
    ...
    /* renamed from: a */
    public Map<String, Object> mo12712a() {
        Map<String, Object> b = mo12713b();
        if (m2225a(b, "aid") == null) {
            b.put("aid", 4444);
        }
        return b;
    }
    ...
    public java.util.Map<java.lang.String, java.lang.Object> mo12713b() {
        /*
            r9 = this;
            ...
            r3 = 0
            com.apm.insight.ICommonParams r4 = r9.f1447c     // Catch:{ all -> 0x0027 }
        ...
        L_0x0017:
            com.apm.insight.ICommonParams r5 = r9.f1446b     // Catch:{ all -> 0x0022 }
        ...
        L_0x002c:
            ...
            java.lang.String r5 = com.apm.insight.p026l.C1326v.m1960a((java.lang.Throwable) r5)     // Catch:{ all -> 0x003f }
            r4.put(r6, r5)     // Catch:{ all -> 0x003f }
        L_0x003f:
            boolean r5 = m2226a(r4)
            r6 = 128(0x80, float:1.794E-43)
            if (r5 == 0) goto L_0x00a9
            android.content.Context r5 = r9.f1445a     // Catch:{ all -> 0x0085 }
            android.content.pm.PackageManager r5 = r5.getPackageManager()     // Catch:{ all -> 0x0085 }
            android.content.Context r7 = r9.f1445a     // Catch:{ all -> 0x0085 }
        ...
        L_0x0081:
            ...
            goto L_0x00ef
        L_0x0085:
            android.content.Context r3 = r9.f1445a
            java.lang.String r3 = com.apm.insight.p026l.C1295a.m1783d(r3)
            r4.put(r0, r3)
            android.content.Context r0 = r9.f1445a
            int r0 = com.apm.insight.p026l.C1295a.m1784e(r0)
            ...
            goto L_0x00ef
        L_0x00a9:
            android.content.Context r0 = r9.f1445a     // Catch:{ all -> 0x00ef }
            android.content.pm.PackageManager r0 = r0.getPackageManager()     // Catch:{ all -> 0x00ef }
            android.content.Context r1 = r9.f1445a     // Catch:{ all -> 0x00ef }
            ...
            android.content.Context r2 = r9.f1445a     // Catch:{ all -> 0x00ef }
        ...
        L_0x00ef:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.apm.insight.runtime.C1373d.mo12713b():java.util.Map");
    }

    /* renamed from: c */
    public ICommonParams mo12714c() {
        return this.f1446b;
    }

    /* renamed from: d */
    public String mo12715d() {
        try {
            return this.f1446b.getDeviceId();
    ...
    /* renamed from: e */
    public String mo12716e() {
        try {
            return String.valueOf(this.f1446b.getCommonParams().get("aid"));
        } catch (Throwable unused) {
            return "4444";
        }
    }
    ...
    /* renamed from: f */
    public long mo12717f() {
        try {
            return this.f1446b.getUserId();
        } catch (Throwable unused) {
            return 0;
        }
    }
