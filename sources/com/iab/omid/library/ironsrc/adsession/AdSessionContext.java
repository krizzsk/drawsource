...
public final class AdSessionContext {
    ...
    public static AdSessionContext createHtmlAdSessionContext(Partner partner2, WebView webView2, String str, String str2) {
        C7896e.m22237a((Object) partner2, "Partner is null");
        C7896e.m22237a((Object) webView2, "WebView is null");
        if (str2 != null) {
            C7896e.m22238a(str2, 256, "CustomReferenceData is greater than 256 characters");
        }
    ...
    public static AdSessionContext createNativeAdSessionContext(Partner partner2, String str, List<VerificationScriptResource> list, String str2, String str3) {
        C7896e.m22237a((Object) partner2, "Partner is null");
        C7896e.m22237a((Object) str, "OM SDK JS script content is null");
        C7896e.m22237a((Object) list, "VerificationScriptResources is null");
        if (str3 != null) {
            C7896e.m22238a(str3, 256, "CustomReferenceData is greater than 256 characters");
        }
