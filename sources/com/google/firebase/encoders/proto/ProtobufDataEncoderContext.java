...
final class ProtobufDataEncoderContext implements ObjectEncoderContext {
    ...
    static /* synthetic */ class C74581 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f18386x531607dd     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f18386x531607dd     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.encoders.proto.ProtobufDataEncoderContext.C74581.<clinit>():void");
        }
    }
    ...
    public ProtobufDataEncoderContext add(FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        ...
        int i2 = C74581.f18386x531607dd[protobuf.intEncoding().ordinal()];
        if (i2 == 1) {
    ...
    public ProtobufDataEncoderContext add(FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        ...
        Protobuf protobuf = getProtobuf(fieldDescriptor);
        int i = C74581.f18386x531607dd[protobuf.intEncoding().ordinal()];
        if (i == 1) {
            writeVarInt32(protobuf.tag() << 3);
            writeVarInt64(j);
        } else if (i == 2) {
    ...
    public ObjectEncoderContext nested(String str) throws IOException {
        return nested(FieldDescriptor.m20971of(str));
    }
