...
public class FirebaseApp {
    ...
    protected FirebaseApp(Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        this.componentRuntime = ComponentRuntime.builder(UI_EXECUTOR).addLazyComponentRegistrars(ComponentDiscovery.forContext(context, ComponentDiscoveryService.class).discoverLazy()).addComponentRegistrar(new FirebaseCommonRegistrar()).addComponent(Component.m20958of(context, Context.class, new Class[0])).addComponent(Component.m20958of(this, FirebaseApp.class, new Class[0])).addComponent(Component.m20958of(firebaseOptions, FirebaseOptions.class, new Class[0])).build();
