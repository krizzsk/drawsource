...
public class FirebaseCrashlytics {
    ...
    static FirebaseCrashlytics init(FirebaseApp firebaseApp, FirebaseInstallationsApi firebaseInstallationsApi, Deferred<CrashlyticsNativeComponent> deferred, Deferred<AnalyticsConnector> deferred2) {
        ...
        logger.mo52105i("Initializing Firebase Crashlytics " + CrashlyticsCore.getVersion() + " for " + packageName);
        ...
        logger2.mo52101d("Mapping file ID is: " + mappingFileId);
        try {
            ...
            logger3.mo52109v("Installer package name is: " + create.installerPackageName);
            ...
            create2.loadSettingsData(buildSingleThreadExecutorService).continueWith(buildSingleThreadExecutorService, new Continuation<Void, Object>() {
                public Object then(Task<Void> task) throws Exception {
                    ...
                    Logger.getLogger().mo52104e("Error fetching settings.", task.getException());
                    return null;
                }
            });
            ...
            Logger.getLogger().mo52104e("Error retrieving app package info.", e);
            return null;
        }
    }
    ...
    public void recordException(Throwable th) {
        if (th == null) {
            Logger.getLogger().mo52111w("A null value was passed to recordException. Ignoring.");
        } else {
