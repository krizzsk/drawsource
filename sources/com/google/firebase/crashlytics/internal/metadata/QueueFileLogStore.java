...
class QueueFileLogStore implements FileLogStore {
    ...
    private LogBytes getLogBytes() {
        ...
        try {
            ...
            Logger.getLogger().mo52104e("A problem occurred while reading the Crashlytics log file.", e);
        }
    ...
    private void openLogFile() {
        if (this.logFile == null) {
            try {
                ...
                logger.mo52104e("Could not open log file: " + this.workingFile, e);
            }
        }
    }
    ...
    private void doWriteToLog(long j, String str) {
        if (this.logFile != null) {
            ...
            try {
                ...
                Logger.getLogger().mo52104e("There was a problem writing to the Crashlytics log.", e);
            }
        }
    }
}
