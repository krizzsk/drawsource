...
class MetaDataStore {
    ...
    public void writeUserData(String str, String str2) {
        ...
        try {
            ...
            try {
                ...
                try {
                    Logger.getLogger().mo52112w("Error serializing user metadata.", e);
    ...
    public String readUserId(String str) {
        ...
        if (!userDataFileForSession.exists() || userDataFileForSession.length() == 0) {
            Logger.getLogger().mo52101d("No userId set for session " + str);
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger().mo52101d("Loaded userId " + jsonToUserId + " for session " + str);
                CommonUtils.closeOrLog(fileInputStream, "Failed to close user metadata file.");
                return jsonToUserId;
            } catch (Exception e) {
                e = e;
                try {
                    Logger.getLogger().mo52112w("Error deserializing user metadata.", e);
                    safeDeleteCorruptFile(userDataFileForSession);
                    CommonUtils.closeOrLog(fileInputStream, "Failed to close user metadata file.");
                    return null;
                } catch (Throwable th) {
    ...
    public void writeKeyData(String str, Map<String, String> map, boolean z) {
        ...
        try {
            ...
            try {
                ...
                bufferedWriter = bufferedWriter2;
                try {
                    Logger.getLogger().mo52112w("Error serializing key/value metadata.", e);
    ...
    private static void safeDeleteCorruptFile(File file) {
        if (file.exists() && file.delete()) {
            ...
            logger.mo52105i("Deleted corrupt file: " + file.getAbsolutePath());
        }
    }
}
