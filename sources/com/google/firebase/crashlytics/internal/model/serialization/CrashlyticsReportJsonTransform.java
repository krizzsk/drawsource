...
public class CrashlyticsReportJsonTransform {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (c) {
                ...
                case 8:
                    ...
                    break;
                case 9:
                    builder.setEvents(parseArray(jsonReader, C7440xfa2562a4.INSTANCE));
                    break;
                case 10:
    ...
    private static CrashlyticsReport.FilesPayload parseNdkPayload(JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (c == 0) {
                builder.setFiles(parseArray(jsonReader, C7443xa6122bf8.INSTANCE));
            } else if (c != 1) {
                jsonReader.skipValue();
            } else {
    ...
    private static CrashlyticsReport.Session.Event.Application parseEventApp(JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (c == 0) {
                ...
                builder.setCustomAttributes(parseArray(jsonReader, C7442xe56090fb.INSTANCE));
            } else if (c != 4) {
                jsonReader.skipValue();
            } else {
                builder.setInternalKeys(parseArray(jsonReader, C7442xe56090fb.INSTANCE));
            }
        }
        jsonReader.endObject();
        return builder.build();
    ...
    private static CrashlyticsReport.Session.Event.Application.Execution parseEventExecution(JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (c == 0) {
                builder.setThreads(parseArray(jsonReader, C7441x303c6f4.INSTANCE));
            } else if (c == 1) {
                builder.setException(parseEventExecutionException(jsonReader));
            } else if (c == 2) {
                builder.setSignal(parseEventSignal(jsonReader));
            } else if (c == 3) {
                builder.setBinaries(parseArray(jsonReader, C7439xb2ecca79.INSTANCE));
            } else if (c != 4) {
                jsonReader.skipValue();
            } else {
    ...
    private static CrashlyticsReport.Session.Event.Application.Execution.Exception parseEventExecutionException(JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            if (c == 0) {
                ...
                builder.setFrames(parseArray(jsonReader, C7444x5393f15e.INSTANCE));
            } else if (c == 2) {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                ...
                case -1455558134:
                    ...
                    break;
                case -1439500848:
                    if (nextName.equals(TJAdUnitConstants.String.ORIENTATION)) {
                        c = 4;
                        break;
                    }
                    break;
