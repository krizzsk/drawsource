...
public final class AutoCrashlyticsReportEncoder implements Configurator {
    ...
    public void configure(EncoderConfig<?> encoderConfig) {
        ...
        encoderConfig.registerEncoder((Class<U>) C7431x7e3e3ebd.class, (ObjectEncoder<? super U>) CrashlyticsReportSessionEventApplicationExecutionThreadEncoder.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame.class, (ObjectEncoder<? super U>) C7412xc3999712.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) C7433xce3d994b.class, (ObjectEncoder<? super U>) C7412xc3999712.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) CrashlyticsReport.Session.Event.Application.Execution.Exception.class, (ObjectEncoder<? super U>) C7411x55689506.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) C7427xc2f5febc.class, (ObjectEncoder<? super U>) C7411x55689506.INSTANCE);
        ...
        encoderConfig.registerEncoder((Class<U>) C7429x7c929f5b.class, (ObjectEncoder<? super U>) CrashlyticsReportSessionEventApplicationExecutionSignalEncoder.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) CrashlyticsReport.Session.Event.Application.Execution.BinaryImage.class, (ObjectEncoder<? super U>) C7410x99c932db.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) C7425xfe724d07.class, (ObjectEncoder<? super U>) C7410x99c932db.INSTANCE);
    ...
    private static final class CrashlyticsReportEncoder implements ObjectEncoder<CrashlyticsReport> {
        private static final FieldDescriptor BUILDVERSION_DESCRIPTOR = FieldDescriptor.m20971of("buildVersion");
        private static final FieldDescriptor DISPLAYVERSION_DESCRIPTOR = FieldDescriptor.m20971of("displayVersion");
        private static final FieldDescriptor GMPAPPID_DESCRIPTOR = FieldDescriptor.m20971of("gmpAppId");
        private static final FieldDescriptor INSTALLATIONUUID_DESCRIPTOR = FieldDescriptor.m20971of("installationUuid");
        static final CrashlyticsReportEncoder INSTANCE = new CrashlyticsReportEncoder();
        private static final FieldDescriptor NDKPAYLOAD_DESCRIPTOR = FieldDescriptor.m20971of("ndkPayload");
        private static final FieldDescriptor PLATFORM_DESCRIPTOR = FieldDescriptor.m20971of(TapjoyConstants.TJC_PLATFORM);
        private static final FieldDescriptor SDKVERSION_DESCRIPTOR = FieldDescriptor.m20971of(SmaatoSdk.KEY_SDK_VERSION);
        private static final FieldDescriptor SESSION_DESCRIPTOR = FieldDescriptor.m20971of("session");
    ...
    private static final class CrashlyticsReportSessionEncoder implements ObjectEncoder<CrashlyticsReport.Session> {
        private static final FieldDescriptor APP_DESCRIPTOR = FieldDescriptor.m20971of(TapjoyConstants.TJC_APP_PLACEMENT);
        private static final FieldDescriptor CRASHED_DESCRIPTOR = FieldDescriptor.m20971of("crashed");
        private static final FieldDescriptor DEVICE_DESCRIPTOR = FieldDescriptor.m20971of("device");
        private static final FieldDescriptor ENDEDAT_DESCRIPTOR = FieldDescriptor.m20971of("endedAt");
        private static final FieldDescriptor EVENTS_DESCRIPTOR = FieldDescriptor.m20971of("events");
        private static final FieldDescriptor GENERATORTYPE_DESCRIPTOR = FieldDescriptor.m20971of("generatorType");
        private static final FieldDescriptor GENERATOR_DESCRIPTOR = FieldDescriptor.m20971of("generator");
        private static final FieldDescriptor IDENTIFIER_DESCRIPTOR = FieldDescriptor.m20971of("identifier");
        static final CrashlyticsReportSessionEncoder INSTANCE = new CrashlyticsReportSessionEncoder();
        private static final FieldDescriptor OS_DESCRIPTOR = FieldDescriptor.m20971of("os");
        private static final FieldDescriptor STARTEDAT_DESCRIPTOR = FieldDescriptor.m20971of("startedAt");
        private static final FieldDescriptor USER_DESCRIPTOR = FieldDescriptor.m20971of("user");
    ...
    private static final class CrashlyticsReportSessionApplicationEncoder implements ObjectEncoder<CrashlyticsReport.Session.Application> {
        private static final FieldDescriptor DEVELOPMENTPLATFORMVERSION_DESCRIPTOR = FieldDescriptor.m20971of("developmentPlatformVersion");
        private static final FieldDescriptor DEVELOPMENTPLATFORM_DESCRIPTOR = FieldDescriptor.m20971of("developmentPlatform");
        private static final FieldDescriptor DISPLAYVERSION_DESCRIPTOR = FieldDescriptor.m20971of("displayVersion");
        private static final FieldDescriptor IDENTIFIER_DESCRIPTOR = FieldDescriptor.m20971of("identifier");
        private static final FieldDescriptor INSTALLATIONUUID_DESCRIPTOR = FieldDescriptor.m20971of("installationUuid");
        static final CrashlyticsReportSessionApplicationEncoder INSTANCE = new CrashlyticsReportSessionApplicationEncoder();
        private static final FieldDescriptor ORGANIZATION_DESCRIPTOR = FieldDescriptor.m20971of("organization");
        private static final FieldDescriptor VERSION_DESCRIPTOR = FieldDescriptor.m20971of("version");
    ...
    private static final class CrashlyticsReportSessionApplicationOrganizationEncoder implements ObjectEncoder<CrashlyticsReport.Session.Application.Organization> {
        private static final FieldDescriptor CLSID_DESCRIPTOR = FieldDescriptor.m20971of("clsId");
    ...
    private static final class CrashlyticsReportSessionOperatingSystemEncoder implements ObjectEncoder<CrashlyticsReport.Session.OperatingSystem> {
        ...
        private static final FieldDescriptor JAILBROKEN_DESCRIPTOR = FieldDescriptor.m20971of("jailbroken");
        private static final FieldDescriptor PLATFORM_DESCRIPTOR = FieldDescriptor.m20971of(TapjoyConstants.TJC_PLATFORM);
        private static final FieldDescriptor VERSION_DESCRIPTOR = FieldDescriptor.m20971of("version");
    ...
    private static final class CrashlyticsReportSessionDeviceEncoder implements ObjectEncoder<CrashlyticsReport.Session.Device> {
        private static final FieldDescriptor ARCH_DESCRIPTOR = FieldDescriptor.m20971of("arch");
        private static final FieldDescriptor CORES_DESCRIPTOR = FieldDescriptor.m20971of("cores");
        private static final FieldDescriptor DISKSPACE_DESCRIPTOR = FieldDescriptor.m20971of("diskSpace");
        static final CrashlyticsReportSessionDeviceEncoder INSTANCE = new CrashlyticsReportSessionDeviceEncoder();
        private static final FieldDescriptor MANUFACTURER_DESCRIPTOR = FieldDescriptor.m20971of("manufacturer");
        private static final FieldDescriptor MODELCLASS_DESCRIPTOR = FieldDescriptor.m20971of("modelClass");
        private static final FieldDescriptor MODEL_DESCRIPTOR = FieldDescriptor.m20971of(DeviceRequestsHelper.DEVICE_INFO_MODEL);
        private static final FieldDescriptor RAM_DESCRIPTOR = FieldDescriptor.m20971of("ram");
        private static final FieldDescriptor SIMULATOR_DESCRIPTOR = FieldDescriptor.m20971of("simulator");
        private static final FieldDescriptor STATE_DESCRIPTOR = FieldDescriptor.m20971of("state");
    ...
    private static final class CrashlyticsReportSessionEventEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event> {
        ...
        private static final FieldDescriptor LOG_DESCRIPTOR = FieldDescriptor.m20971of("log");
        private static final FieldDescriptor TIMESTAMP_DESCRIPTOR = FieldDescriptor.m20971of("timestamp");
        private static final FieldDescriptor TYPE_DESCRIPTOR = FieldDescriptor.m20971of("type");
    ...
    private static final class CrashlyticsReportSessionEventApplicationEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application> {
        private static final FieldDescriptor BACKGROUND_DESCRIPTOR = FieldDescriptor.m20971of("background");
        private static final FieldDescriptor CUSTOMATTRIBUTES_DESCRIPTOR = FieldDescriptor.m20971of("customAttributes");
        private static final FieldDescriptor EXECUTION_DESCRIPTOR = FieldDescriptor.m20971of("execution");
        static final CrashlyticsReportSessionEventApplicationEncoder INSTANCE = new CrashlyticsReportSessionEventApplicationEncoder();
        private static final FieldDescriptor INTERNALKEYS_DESCRIPTOR = FieldDescriptor.m20971of("internalKeys");
        private static final FieldDescriptor UIORIENTATION_DESCRIPTOR = FieldDescriptor.m20971of("uiOrientation");
    ...
    private static final class CrashlyticsReportSessionEventApplicationExecutionEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution> {
        private static final FieldDescriptor APPEXITINFO_DESCRIPTOR = FieldDescriptor.m20971of("appExitInfo");
        private static final FieldDescriptor BINARIES_DESCRIPTOR = FieldDescriptor.m20971of("binaries");
        private static final FieldDescriptor EXCEPTION_DESCRIPTOR = FieldDescriptor.m20971of("exception");
        static final CrashlyticsReportSessionEventApplicationExecutionEncoder INSTANCE = new CrashlyticsReportSessionEventApplicationExecutionEncoder();
        private static final FieldDescriptor SIGNAL_DESCRIPTOR = FieldDescriptor.m20971of("signal");
        private static final FieldDescriptor THREADS_DESCRIPTOR = FieldDescriptor.m20971of("threads");
    ...
    private static final class CrashlyticsReportSessionEventApplicationExecutionThreadEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Thread> {
        private static final FieldDescriptor FRAMES_DESCRIPTOR = FieldDescriptor.m20971of(CampaignUnit.JSON_KEY_FRAME_ADS);
        private static final FieldDescriptor IMPORTANCE_DESCRIPTOR = FieldDescriptor.m20971of("importance");
        static final CrashlyticsReportSessionEventApplicationExecutionThreadEncoder INSTANCE = new CrashlyticsReportSessionEventApplicationExecutionThreadEncoder();
        private static final FieldDescriptor NAME_DESCRIPTOR = FieldDescriptor.m20971of("name");
    ...
    private static final class C7412xc3999712 implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame> {
        private static final FieldDescriptor FILE_DESCRIPTOR = FieldDescriptor.m20971of(ShareInternalUtility.STAGING_PARAM);
        private static final FieldDescriptor IMPORTANCE_DESCRIPTOR = FieldDescriptor.m20971of("importance");
        static final C7412xc3999712 INSTANCE = new C7412xc3999712();
        private static final FieldDescriptor OFFSET_DESCRIPTOR = FieldDescriptor.m20971of("offset");
        private static final FieldDescriptor PC_DESCRIPTOR = FieldDescriptor.m20971of("pc");
        private static final FieldDescriptor SYMBOL_DESCRIPTOR = FieldDescriptor.m20971of("symbol");

        private C7412xc3999712() {
        }
    ...
    private static final class C7411x55689506 implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Exception> {
        private static final FieldDescriptor CAUSEDBY_DESCRIPTOR = FieldDescriptor.m20971of("causedBy");
        private static final FieldDescriptor FRAMES_DESCRIPTOR = FieldDescriptor.m20971of(CampaignUnit.JSON_KEY_FRAME_ADS);
        static final C7411x55689506 INSTANCE = new C7411x55689506();
        private static final FieldDescriptor OVERFLOWCOUNT_DESCRIPTOR = FieldDescriptor.m20971of("overflowCount");
        private static final FieldDescriptor REASON_DESCRIPTOR = FieldDescriptor.m20971of(IronSourceConstants.EVENTS_ERROR_REASON);
        private static final FieldDescriptor TYPE_DESCRIPTOR = FieldDescriptor.m20971of("type");

        private C7411x55689506() {
        }
    ...
    private static final class CrashlyticsReportApplicationExitInfoEncoder implements ObjectEncoder<CrashlyticsReport.ApplicationExitInfo> {
        ...
        private static final FieldDescriptor PID_DESCRIPTOR = FieldDescriptor.m20971of("pid");
        private static final FieldDescriptor PROCESSNAME_DESCRIPTOR = FieldDescriptor.m20971of("processName");
        private static final FieldDescriptor PSS_DESCRIPTOR = FieldDescriptor.m20971of("pss");
        private static final FieldDescriptor REASONCODE_DESCRIPTOR = FieldDescriptor.m20971of("reasonCode");
        private static final FieldDescriptor RSS_DESCRIPTOR = FieldDescriptor.m20971of("rss");
        private static final FieldDescriptor TIMESTAMP_DESCRIPTOR = FieldDescriptor.m20971of("timestamp");
        private static final FieldDescriptor TRACEFILE_DESCRIPTOR = FieldDescriptor.m20971of("traceFile");
    ...
    private static final class CrashlyticsReportSessionEventApplicationExecutionSignalEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Signal> {
        private static final FieldDescriptor ADDRESS_DESCRIPTOR = FieldDescriptor.m20971of(IntegrityManager.INTEGRITY_TYPE_ADDRESS);
        private static final FieldDescriptor CODE_DESCRIPTOR = FieldDescriptor.m20971of("code");
    ...
    private static final class C7410x99c932db implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.BinaryImage> {
        private static final FieldDescriptor BASEADDRESS_DESCRIPTOR = FieldDescriptor.m20971of("baseAddress");
        static final C7410x99c932db INSTANCE = new C7410x99c932db();
        private static final FieldDescriptor NAME_DESCRIPTOR = FieldDescriptor.m20971of("name");
        private static final FieldDescriptor SIZE_DESCRIPTOR = FieldDescriptor.m20971of("size");
        private static final FieldDescriptor UUID_DESCRIPTOR = FieldDescriptor.m20971of("uuid");

        private C7410x99c932db() {
        }
    ...
    private static final class CrashlyticsReportCustomAttributeEncoder implements ObjectEncoder<CrashlyticsReport.CustomAttribute> {
        ...
        private static final FieldDescriptor KEY_DESCRIPTOR = FieldDescriptor.m20971of(SDKConstants.PARAM_KEY);
        private static final FieldDescriptor VALUE_DESCRIPTOR = FieldDescriptor.m20971of("value");
    ...
    private static final class CrashlyticsReportSessionEventDeviceEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Device> {
        private static final FieldDescriptor BATTERYLEVEL_DESCRIPTOR = FieldDescriptor.m20971of("batteryLevel");
        private static final FieldDescriptor BATTERYVELOCITY_DESCRIPTOR = FieldDescriptor.m20971of("batteryVelocity");
        private static final FieldDescriptor DISKUSED_DESCRIPTOR = FieldDescriptor.m20971of("diskUsed");
        static final CrashlyticsReportSessionEventDeviceEncoder INSTANCE = new CrashlyticsReportSessionEventDeviceEncoder();
        private static final FieldDescriptor ORIENTATION_DESCRIPTOR = FieldDescriptor.m20971of(TJAdUnitConstants.String.ORIENTATION);
        private static final FieldDescriptor PROXIMITYON_DESCRIPTOR = FieldDescriptor.m20971of("proximityOn");
        private static final FieldDescriptor RAMUSED_DESCRIPTOR = FieldDescriptor.m20971of("ramUsed");
    ...
    private static final class CrashlyticsReportSessionEventLogEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Log> {
        private static final FieldDescriptor CONTENT_DESCRIPTOR = FieldDescriptor.m20971of("content");
    ...
    private static final class CrashlyticsReportFilesPayloadEncoder implements ObjectEncoder<CrashlyticsReport.FilesPayload> {
        private static final FieldDescriptor FILES_DESCRIPTOR = FieldDescriptor.m20971of("files");
        static final CrashlyticsReportFilesPayloadEncoder INSTANCE = new CrashlyticsReportFilesPayloadEncoder();
        private static final FieldDescriptor ORGID_DESCRIPTOR = FieldDescriptor.m20971of("orgId");
    ...
    private static final class CrashlyticsReportFilesPayloadFileEncoder implements ObjectEncoder<CrashlyticsReport.FilesPayload.File> {
        private static final FieldDescriptor CONTENTS_DESCRIPTOR = FieldDescriptor.m20971of("contents");
        private static final FieldDescriptor FILENAME_DESCRIPTOR = FieldDescriptor.m20971of("filename");
