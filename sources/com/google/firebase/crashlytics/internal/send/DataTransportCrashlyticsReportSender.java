...
public class DataTransportCrashlyticsReportSender {
    ...
    private static final Transformer<CrashlyticsReport, byte[]> DEFAULT_TRANSFORM = C7449xe05ceaa1.INSTANCE;
    ...
    public static DataTransportCrashlyticsReportSender create(Context context, SettingsProvider settingsProvider, OnDemandCounter onDemandCounter) {
        ...
        return new DataTransportCrashlyticsReportSender(new ReportQueue(TransportRuntime.getInstance().newFactory((Destination) new CCTDestination(CRASHLYTICS_ENDPOINT, CRASHLYTICS_API_KEY)).getTransport(CRASHLYTICS_TRANSPORT_NAME, CrashlyticsReport.class, Encoding.m16657of("json"), DEFAULT_TRANSFORM), settingsProvider.getSettingsSync(), onDemandCounter), DEFAULT_TRANSFORM);
    }
