...
public class DataCollectionArbiter {
    ...
    private void logDataCollectionState(boolean z) {
        ...
        Logger.getLogger().mo52101d(String.format("Crashlytics automatic data collection %s by %s.", new Object[]{str2, str}));
    }
    ...
    private static Boolean readCrashlyticsDataCollectionEnabledFromManifest(Context context) {
        ...
        try {
            ...
            Logger.getLogger().mo52104e("Could not read data collection permission from manifest", e);
            return null;
        }
    }
