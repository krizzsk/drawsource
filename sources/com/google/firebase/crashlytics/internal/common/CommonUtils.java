...
public class CommonUtils {
    ...
    public static java.lang.String extractFieldFromSystemFile(java.io.File r6, java.lang.String r7) {
        ...
        L_0x0040:
            ...
            r3.mo52104e(r6, r7)     // Catch:{ all -> 0x0059 }
            goto L_0x0036
        L_0x0059:
            r6 = move-exception
            r2 = r1
    ...
    enum Architecture {
        ...
        static Architecture getValue() {
            ...
            if (TextUtils.isEmpty(str)) {
                Logger.getLogger().mo52109v("Architecture#getValue()::Build.CPU_ABI returned null or empty");
                return UNKNOWN;
            }
                ...
                if (!TextUtils.isEmpty(extractFieldFromSystemFile)) {
                    ...
                    try {
                        if (upperCase.endsWith("KB")) {
                            ...
                            logger.mo52111w("Unexpected meminfo format while computing RAM: " + upperCase);
                        }
                    } catch (NumberFormatException e) {
                        Logger logger2 = Logger.getLogger();
                        logger2.mo52104e("Unexpected meminfo format while computing RAM: " + upperCase, e);
                    }
                }
                totalRamInBytes = j2;
            }
    ...
    private static String hash(byte[] bArr, String str) {
        try {
            ...
            Logger logger = Logger.getLogger();
            logger.mo52104e("Could not create hashing algorithm: " + str + ", returning empty string.", e);
            return "";
        }
    }
    ...
    public static String hexify(byte[] bArr) {
        ...
        for (int i = 0; i < bArr.length; i++) {
            ...
            cArr[i2] = cArr2[b >>> 4];
            cArr[i2 + 1] = cArr2[b & Ascii.f18305SI];
        }
    ...
    public static void closeOrLog(Closeable closeable, String str) {
        if (closeable != null) {
            try {
                ...
                Logger.getLogger().mo52104e(str, e);
            }
        }
    }
