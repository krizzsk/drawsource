...
public class SettingsController implements SettingsProvider {
                ...
                if (parseSettingsJson != null) {
                    ...
                    if (!SettingsCacheBehavior.IGNORE_CACHE_EXPIRATION.equals(settingsCacheBehavior)) {
                        if (parseSettingsJson.isExpired(currentTimeMillis)) {
                            Logger.getLogger().mo52109v("Cached settings have expired.");
                            return null;
                        }
                    }
                    try {
                        Logger.getLogger().mo52109v("Returning cached settings.");
                        return parseSettingsJson;
                    } catch (Exception e) {
                        e = e;
                        settings2 = parseSettingsJson;
                        Logger.getLogger().mo52104e("Failed to get cached settings", e);
                        return settings2;
                    }
                } else {
                    Logger.getLogger().mo52104e("Failed to parse cached settings data.", (Throwable) null);
                    return null;
                }
            } else {
                Logger.getLogger().mo52101d("No cached settings data found.");
                return null;
            }
        } catch (Exception e2) {
            e = e2;
    ...
    public void logSettings(JSONObject jSONObject, String str) throws JSONException {
        ...
        logger.mo52101d(str + jSONObject.toString());
    }
