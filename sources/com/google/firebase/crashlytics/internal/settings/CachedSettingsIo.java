...
public class CachedSettingsIo {
    ...
    public JSONObject readCachedSettings() {
        ...
        Logger.getLogger().mo52101d("Checking for cached settings...");
        ...
        try {
            ...
            if (settingsFile.exists()) {
                ...
                try {
                    ...
                    e = e;
                    try {
                        Logger.getLogger().mo52104e("Failed to fetch cached settings", e);
                ...
                Logger.getLogger().mo52109v("Settings file does not exist.");
                jSONObject = null;
            }
    ...
    public void writeCachedSettings(long j, JSONObject jSONObject) {
        Logger.getLogger().mo52109v("Writing settings to cache file...");
        if (jSONObject != null) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        Logger.getLogger().mo52104e("Failed to cache settings", e);
