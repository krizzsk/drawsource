...
final class DecodedBitStreamParser {
    ...
    /* renamed from: FS */
    private static final char f18400FS = '\u001c';

    /* renamed from: GS */
    private static final char f18401GS = '\u001d';
    private static final char LATCHA = '￷';
    private static final char LATCHB = '￸';
    private static final char LOCK = '￹';

    /* renamed from: NS */
    private static final char f18402NS = '￻';
    private static final char PAD = '￼';

    /* renamed from: RS */
    private static final char f18403RS = '\u001e';
    ...
    static DecoderResult decode(byte[] bArr, int i) {
        ...
        if (i == 2 || i == 3) {
            ...
            if (sb.toString().startsWith("[)>\u001e01\u001d")) {
                sb.insert(9, str + f18401GS + format + f18401GS + format2 + f18401GS);
            } else {
                sb.insert(0, str + f18401GS + format + f18401GS + format2 + f18401GS);
            }
        } else if (i == 4) {
    ...
    private static int getPostCode2Length(byte[] bArr) {
        return getInt(bArr, new byte[]{39, 40, 41, 42, Ascii.f18308US, 32});
    }

    private static int getPostCode2(byte[] bArr) {
        return getInt(bArr, new byte[]{33, 34, 35, 36, Ascii.f18297EM, Ascii.SUB, Ascii.ESC, Ascii.f18299FS, Ascii.f18300GS, Ascii.f18304RS, 19, Ascii.DC4, Ascii.NAK, Ascii.SYN, Ascii.ETB, Ascii.CAN, Ascii.f18296CR, Ascii.f18306SO, Ascii.f18305SI, Ascii.DLE, 17, Ascii.DC2, 7, 8, 9, 10, Ascii.f18309VT, Ascii.f18298FF, 1, 2});
    }

    private static String getPostCode3(byte[] bArr) {
        return String.valueOf(new char[]{SETS[0].charAt(getInt(bArr, new byte[]{39, 40, 41, 42, Ascii.f18308US, 32})), SETS[0].charAt(getInt(bArr, new byte[]{33, 34, 35, 36, Ascii.f18297EM, Ascii.SUB})), SETS[0].charAt(getInt(bArr, new byte[]{Ascii.ESC, Ascii.f18299FS, Ascii.f18300GS, Ascii.f18304RS, 19, Ascii.DC4})), SETS[0].charAt(getInt(bArr, new byte[]{Ascii.NAK, Ascii.SYN, Ascii.ETB, Ascii.CAN, Ascii.f18296CR, Ascii.f18306SO})), SETS[0].charAt(getInt(bArr, new byte[]{Ascii.f18305SI, Ascii.DLE, 17, Ascii.DC2, 7, 8})), SETS[0].charAt(getInt(bArr, new byte[]{9, 10, Ascii.f18309VT, Ascii.f18298FF, 1, 2}))});
    }
