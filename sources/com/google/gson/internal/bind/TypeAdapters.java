...
public final class TypeAdapters {
    ...
    public static final TypeAdapterFactory ENUM_FACTORY = new TypeAdapterFactory() {
        ...
        public <T> com.google.gson.TypeAdapter<T> create(com.google.gson.Gson r1, com.google.gson.reflect.TypeToken<T> r2) {
            ...
            L_0x0021:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C757429.create(com.google.gson.Gson, com.google.gson.reflect.TypeToken):com.google.gson.TypeAdapter");
        }
    };
    ...
    static {
        ...
        TypeAdapter<BitSet> nullSafe2 = new TypeAdapter<BitSet>() {
            public BitSet read(JsonReader jsonReader) throws IOException {
                ...
                while (peek != JsonToken.END_ARRAY) {
                    int i2 = C758235.$SwitchMap$com$google$gson$stream$JsonToken[peek.ordinal()];
                    boolean z = true;
                    if (i2 == 1 || i2 == 2) {
                        int nextInt = jsonReader.nextInt();
                        if (nextInt == 0) {
        ...
        C756319 r0 = new TypeAdapter<StringBuilder>() {
        ...
        C756520 r02 = new TypeAdapter<StringBuffer>() {
        ...
        C756621 r03 = new TypeAdapter<URL>() {
        ...
        C756722 r04 = new TypeAdapter<URI>() {
        ...
        C756823 r05 = new TypeAdapter<InetAddress>() {
        ...
        C756924 r06 = new TypeAdapter<UUID>() {
        ...
        C757126 r07 = new TypeAdapter<Calendar>() {
        ...
        C757227 r08 = new TypeAdapter<Locale>() {
        ...
        C757328 r09 = new TypeAdapter<JsonElement>() {
            private JsonElement tryBeginNesting(JsonReader jsonReader, JsonToken jsonToken) throws IOException {
                int i = C758235.$SwitchMap$com$google$gson$stream$JsonToken[jsonToken.ordinal()];
                if (i == 4) {
                    jsonReader.beginArray();
    ...
    static /* synthetic */ class C758235 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C758235.<clinit>():void");
        }
    }
