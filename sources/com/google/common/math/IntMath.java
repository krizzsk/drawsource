...
public final class IntMath {
    ...
    static /* synthetic */ class C72381 {
        ...
        static {
            ...
            L_0x0060:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.math.IntMath.C72381.<clinit>():void");
        }
    }

    public static int log2(int i, RoundingMode roundingMode) {
        MathPreconditions.checkPositive("x", i);
        switch (C72381.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
    ...
    public static int log10(int r3, java.math.RoundingMode r4) {
        /*
            ...
            int[] r1 = powersOf10
            r1 = r1[r0]
            int[] r2 = com.google.common.math.IntMath.C72381.$SwitchMap$java$math$RoundingMode
            int r4 = r4.ordinal()
            r4 = r2[r4]
            switch(r4) {
    ...
    public static int sqrt(int r2, java.math.RoundingMode r3) {
        /*
            ...
            int r0 = sqrtFloor(r2)
            int[] r1 = com.google.common.math.IntMath.C72381.$SwitchMap$java$math$RoundingMode
            int r3 = r3.ordinal()
            r3 = r1[r3]
            switch(r3) {
    ...
    public static int divide(int r5, int r6, java.math.RoundingMode r7) {
        ...
        L_0x000e:
            ...
            r2 = 1
            r5 = r5 | r2
            int[] r3 = com.google.common.math.IntMath.C72381.$SwitchMap$java$math$RoundingMode
            int r4 = r7.ordinal()
            r3 = r3[r4]
            r4 = 0
            switch(r3) {
