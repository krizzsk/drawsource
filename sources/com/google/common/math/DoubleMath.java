...
public final class DoubleMath {
    ...
    static double roundIntermediate(double d, RoundingMode roundingMode) {
        if (DoubleUtils.isFinite(d)) {
            switch (C72371.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
                case 1:
    ...
    static /* synthetic */ class C72371 {
        ...
        static {
            ...
            L_0x0060:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.math.DoubleMath.C72371.<clinit>():void");
        }
    }
