...
public final class LongMath {
    ...
    static final byte[] maxLog10ForLeadingZeros = {19, Ascii.DC2, Ascii.DC2, Ascii.DC2, Ascii.DC2, 17, 17, 17, Ascii.DLE, Ascii.DLE, Ascii.DLE, Ascii.f18305SI, Ascii.f18305SI, Ascii.f18305SI, Ascii.f18305SI, Ascii.f18306SO, Ascii.f18306SO, Ascii.f18306SO, Ascii.f18296CR, Ascii.f18296CR, Ascii.f18296CR, Ascii.f18298FF, Ascii.f18298FF, Ascii.f18298FF, Ascii.f18298FF, Ascii.f18309VT, Ascii.f18309VT, Ascii.f18309VT, 10, 10, 10, 9, 9, 9, 9, 8, 8, 8, 7, 7, 7, 6, 6, 6, 6, 5, 5, 5, 4, 4, 4, 3, 3, 3, 3, 2, 2, 2, 1, 1, 1, 0, 0, 0};
    ...
    static /* synthetic */ class C72401 {
        ...
        static {
            ...
            L_0x0060:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.math.LongMath.C72401.<clinit>():void");
        }
    }

    public static int log2(long j, RoundingMode roundingMode) {
        MathPreconditions.checkPositive("x", j);
        switch (C72401.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
    ...
    public static int log10(long r4, java.math.RoundingMode r6) {
        /*
            ...
            long[] r1 = powersOf10
            r2 = r1[r0]
            int[] r1 = com.google.common.math.LongMath.C72401.$SwitchMap$java$math$RoundingMode
            int r6 = r6.ordinal()
            r6 = r1[r6]
            switch(r6) {
    ...
    public static long divide(long r9, long r11, java.math.RoundingMode r13) {
        ...
        L_0x0010:
            ...
            r10 = 1
            r9 = r9 | r10
            int[] r7 = com.google.common.math.LongMath.C72401.$SwitchMap$java$math$RoundingMode
            int r8 = r13.ordinal()
            r7 = r7[r8]
            r8 = 0
            switch(r7) {
