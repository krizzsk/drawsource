...
public final class MediaType {
    ...
    private static final Joiner.MapJoiner PARAMETER_JOINER = Joiner.m20785on("; ").withKeyValueSeparator("=");
    ...
    private static final ImmutableListMultimap<String, String> UTF_8_CONSTANT_PARAMETERS = ImmutableListMultimap.m20829of(CHARSET_ATTRIBUTE, Ascii.toLowerCase(Charsets.UTF_8.name()));
    ...
    private static MediaType createConstant(String str, String str2) {
        MediaType addKnownType = addKnownType(new MediaType(str, str2, ImmutableListMultimap.m20828of()));
    ...
    private static MediaType createConstantUtf8(String str, String str2) {
        ...
        addKnownType.parsedCharset = Optional.m20786of(Charsets.UTF_8);
        return addKnownType;
    }
    ...
    public Optional<Charset> charset() {
        ...
        if (optional == null) {
            ...
            while (it.hasNext()) {
                ...
                if (str == null) {
                    optional = Optional.m20786of(Charset.forName(str2));
                    str = str2;
    ...
    public MediaType withParameter(String str, String str2) {
        return withParameters(str, ImmutableSet.m20858of(str2));
    }

    public MediaType withCharset(Charset charset) {
        Preconditions.checkNotNull(charset);
        MediaType withParameter = withParameter(CHARSET_ATTRIBUTE, charset.name());
        withParameter.parsedCharset = Optional.m20786of(charset);
    ...
    /* renamed from: is */
    public boolean mo50905is(MediaType mediaType) {
    ...
    public static MediaType create(String str, String str2) {
        MediaType create = create(str, str2, ImmutableListMultimap.m20828of());
