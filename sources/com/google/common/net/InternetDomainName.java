...
public final class InternetDomainName {
    ...
    private static final Joiner DOT_JOINER = Joiner.m20784on('.');
    private static final Splitter DOT_SPLITTER = Splitter.m20797on('.');
    private static final int MAX_DOMAIN_PART_LENGTH = 63;
    private static final int MAX_LENGTH = 253;
    private static final int MAX_PARTS = 127;
    private static final int NO_SUFFIX_FOUND = -1;
    private static final CharMatcher PART_CHAR_MATCHER = CharMatcher.javaLetterOrDigit().mo47297or(DASH_MATCHER);
    ...
    InternetDomainName(String str) {
        ...
        this.registrySuffixIndex = findSuffixOfType(Optional.m20786of(PublicSuffixType.REGISTRY));
    }
