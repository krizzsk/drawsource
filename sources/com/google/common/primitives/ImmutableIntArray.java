...
public final class ImmutableIntArray implements Serializable {
    ...
    /* renamed from: of */
    public static ImmutableIntArray m20936of() {
        return EMPTY;
    }

    /* renamed from: of */
    public static ImmutableIntArray m20937of(int i) {
        return new ImmutableIntArray(new int[]{i});
    }

    /* renamed from: of */
    public static ImmutableIntArray m20938of(int i, int i2) {
        return new ImmutableIntArray(new int[]{i, i2});
    }

    /* renamed from: of */
    public static ImmutableIntArray m20939of(int i, int i2, int i3) {
        return new ImmutableIntArray(new int[]{i, i2, i3});
    }

    /* renamed from: of */
    public static ImmutableIntArray m20940of(int i, int i2, int i3, int i4) {
        return new ImmutableIntArray(new int[]{i, i2, i3, i4});
    }

    /* renamed from: of */
    public static ImmutableIntArray m20941of(int i, int i2, int i3, int i4, int i5) {
        return new ImmutableIntArray(new int[]{i, i2, i3, i4, i5});
    }

    /* renamed from: of */
    public static ImmutableIntArray m20942of(int i, int i2, int i3, int i4, int i5, int i6) {
        return new ImmutableIntArray(new int[]{i, i2, i3, i4, i5, i6});
    }

    /* renamed from: of */
    public static ImmutableIntArray m20943of(int i, int... iArr) {
