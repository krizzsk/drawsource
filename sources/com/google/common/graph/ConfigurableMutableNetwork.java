...
final class ConfigurableMutableNetwork<N, E> extends ConfigurableNetwork<N, E> implements MutableNetwork<N, E> {
    ...
    public boolean addEdge(N n, N n2, E e) {
        ...
        if (containsEdge(e)) {
            ...
            EndpointPair of = EndpointPair.m20915of((Network<?, ?>) this, n, n2);
    ...
    private NetworkConnections<N, E> newConnections() {
        if (isDirected()) {
            if (allowsParallelEdges()) {
                return DirectedMultiNetworkConnections.m20912of();
            }
            return DirectedNetworkConnections.m20913of();
        } else if (allowsParallelEdges()) {
            return UndirectedMultiNetworkConnections.m20918of();
        } else {
            return UndirectedNetworkConnections.m20919of();
        }
    }
}
