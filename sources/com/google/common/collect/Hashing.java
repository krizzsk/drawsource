...
final class Hashing {
    ...
    /* renamed from: C1 */
    private static final long f18333C1 = -862048943;

    /* renamed from: C2 */
    private static final long f18334C2 = 461845907;
    ...
    static int smear(int i) {
        return (int) (((long) Integer.rotateLeft((int) (((long) i) * f18333C1), 15)) * f18334C2);
    }
