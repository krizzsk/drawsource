...
public final class Collections2 {
    ...
    private static class PermutationIterator<E> extends AbstractIterator<List<E>> {
        ...
        PermutationIterator(List<E> list2) {
            ...
            this.f18330c = iArr;
            this.f18332o = new int[size];
            Arrays.fill(iArr, 0);
            Arrays.fill(this.f18332o, 1);
        }
        ...
        public void calculateNextPermutation() {
            ...
            if (size != -1) {
                ...
                while (true) {
                    ...
                    int i2 = this.f18331j;
                    int i3 = iArr[i2] + this.f18332o[i2];
                    if (i3 < 0) {
                        switchDirection();
                    } else if (i3 != i2 + 1) {
                        Collections.swap(this.list, (i2 - iArr[i2]) + i, (i2 - i3) + i);
                        this.f18330c[this.f18331j] = i3;
                        return;
                    } else if (i2 != 0) {
                        i++;
                        switchDirection();
