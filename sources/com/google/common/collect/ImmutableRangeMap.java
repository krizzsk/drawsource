...
public class ImmutableRangeMap<K extends Comparable<?>, V> implements RangeMap<K, V>, Serializable {
    private static final ImmutableRangeMap<Comparable<?>, Object> EMPTY = new ImmutableRangeMap<>(ImmutableList.m20815of(), ImmutableList.m20815of());
    ...
    /* renamed from: of */
    public static <K extends Comparable<?>, V> ImmutableRangeMap<K, V> m20853of() {
        return EMPTY;
    }

    /* renamed from: of */
    public static <K extends Comparable<?>, V> ImmutableRangeMap<K, V> m20854of(Range<K> range, V v) {
        return new ImmutableRangeMap<>(ImmutableList.m20816of(range), ImmutableList.m20816of(v));
    }
    ...
    public ImmutableRangeMap<K, V> subRangeMap(final Range<K> range) {
        ...
        return new ImmutableRangeMap<K, V>(new ImmutableList<Range<K>>() {
            ...
            public ImmutableRangeMap<K, V> subRangeMap(Range<K> range) {
                ...
                return ImmutableRangeMap.m20853of();
            }
        };
    }
