...
public class EventBus {
    ...
    public EventBus() {
        this(CoreLightModuleInterface.NAME_DEFAULT_HTTP_HANDLER);
    }
    ...
    public EventBus(SubscriberExceptionHandler subscriberExceptionHandler) {
        this(CoreLightModuleInterface.NAME_DEFAULT_HTTP_HANDLER, MoreExecutors.directExecutor(), Dispatcher.perThreadDispatchQueue(), subscriberExceptionHandler);
    }
