...
import com.google.common.p222io.ByteSource;
import com.google.common.p222io.CharSource;
import com.google.common.p222io.Resources;
import java.io.File;
...
public final class ClassPath {
    ...
    public static final Splitter CLASS_PATH_ATTRIBUTE_SEPARATOR = Splitter.m20800on(" ").omitEmptyStrings();
    ...
    public static class ResourceInfo {
        ...
        /* renamed from: of */
        static ResourceInfo m20952of(String str, ClassLoader classLoader) {
    ...
    static abstract class Scanner {
        ...
        static com.google.common.collect.ImmutableList<java.net.URL> parseJavaClassPath() {
            /*
                ...
                com.google.common.base.Splitter r1 = com.google.common.base.Splitter.m20800on((java.lang.String) r1)
    ...
    static final class DefaultScanner extends Scanner {
        ...
        public ImmutableSet<ResourceInfo> getResources() {
            ...
            for (Map.Entry next : this.resources.entries()) {
                builder.add((Object) ResourceInfo.m20952of((String) next.getValue(), (ClassLoader) next.getKey()));
            }
            return builder.build();
        }
