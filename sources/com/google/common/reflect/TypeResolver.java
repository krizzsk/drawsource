...
public final class TypeResolver {
    ...
    private static class TypeTable {
        ...
        TypeTable() {
            this.map = ImmutableMap.m20834of();
        }
    ...
    private static class WildcardCapturer {
        ...
        /* renamed from: id */
        private final AtomicInteger f18380id;
        ...
        public TypeVariable<?> captureAsTypeVariable(Type[] typeArr) {
            return Types.newArtificialTypeVariable(WildcardCapturer.class, "capture#" + this.f18380id.incrementAndGet() + "-of ? extends " + Joiner.m20784on((char) Typography.amp).join((Object[]) typeArr), typeArr);
        }

        private WildcardCapturer forTypeVariable(final TypeVariable<?> typeVariable) {
            return new WildcardCapturer(this.f18380id) {
                /* access modifiers changed from: package-private */
                public TypeVariable<?> captureAsTypeVariable(Type[] typeArr) {
