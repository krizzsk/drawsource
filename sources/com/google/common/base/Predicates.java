...
public final class Predicates {
    ...
    /* renamed from: or */
    public static <T> Predicate<T> m20792or(Iterable<? extends Predicate<? super T>> iterable) {
        return new OrPredicate(defensiveCopy(iterable));
    }

    @SafeVarargs
    /* renamed from: or */
    public static <T> Predicate<T> m20793or(Predicate<? super T>... predicateArr) {
        return new OrPredicate(defensiveCopy((T[]) predicateArr));
    }

    /* renamed from: or */
    public static <T> Predicate<T> m20791or(Predicate<? super T> predicate, Predicate<? super T> predicate2) {
    ...
    /* renamed from: in */
    public static <T> Predicate<T> m20790in(Collection<? extends T> collection) {
    ...
    private static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
        ...
        /* renamed from: f */
        final Function<A, ? extends B> f18312f;

        /* renamed from: p */
        final Predicate<B> f18313p;

        private CompositionPredicate(Predicate<B> predicate, Function<A, ? extends B> function) {
            this.f18313p = (Predicate) Preconditions.checkNotNull(predicate);
            this.f18312f = (Function) Preconditions.checkNotNull(function);
        }

        public boolean apply(@NullableDecl A a) {
            return this.f18313p.apply(this.f18312f.apply(a));
        }
        ...
        public boolean equals(@NullableDecl Object obj) {
            ...
            if (!this.f18312f.equals(compositionPredicate.f18312f) || !this.f18313p.equals(compositionPredicate.f18313p)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return this.f18312f.hashCode() ^ this.f18313p.hashCode();
        }

        public String toString() {
            return this.f18313p + "(" + this.f18312f + ")";
        }
    }
