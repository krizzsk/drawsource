...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    /* renamed from: is */
    public static CharMatcher m20778is(char c) {
        return new C6865Is(c);
    }
    ...
    public static CharMatcher anyOf(CharSequence charSequence) {
        ...
        if (length == 1) {
            return m20778is(charSequence.charAt(0));
        }
        if (length != 2) {
    ...
    /* renamed from: or */
    public CharMatcher mo47297or(CharMatcher charMatcher) {
        return new C6866Or(this, charMatcher);
    }
    ...
    private static CharMatcher precomputedPositive(int i, BitSet bitSet, String str) {
        ...
        if (i == 1) {
            return m20778is((char) bitSet.nextSetBit(0));
        }
        if (i == 2) {
    ...
    private static final class C6866Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C6866Or(CharMatcher charMatcher, CharMatcher charMatcher2) {
            this.first = (CharMatcher) Preconditions.checkNotNull(charMatcher);
            this.second = (CharMatcher) Preconditions.checkNotNull(charMatcher2);
        }
    ...
    private static final class C6865Is extends FastMatcher {
        ...
        /* renamed from: or */
        public CharMatcher mo47297or(CharMatcher charMatcher) {
            return charMatcher.matches(this.match) ? charMatcher : super.mo47297or(charMatcher);
        }
