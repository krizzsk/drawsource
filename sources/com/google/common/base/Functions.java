...
public final class Functions {
    ...
    private static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
        ...
        /* renamed from: f */
        private final Function<A, ? extends B> f18310f;

        /* renamed from: g */
        private final Function<B, C> f18311g;

        public FunctionComposition(Function<B, C> function, Function<A, ? extends B> function2) {
            this.f18311g = (Function) Preconditions.checkNotNull(function);
            this.f18310f = (Function) Preconditions.checkNotNull(function2);
        }

        public C apply(@NullableDecl A a) {
            return this.f18311g.apply(this.f18310f.apply(a));
        }
        ...
        public boolean equals(@NullableDecl Object obj) {
            ...
            if (!this.f18310f.equals(functionComposition.f18310f) || !this.f18311g.equals(functionComposition.f18311g)) {
                return false;
            }
            return true;
        }
