...
public final class Splitter {
    ...
    /* renamed from: on */
    public static Splitter m20797on(char c) {
        return m20798on(CharMatcher.m20778is(c));
    }

    /* renamed from: on */
    public static Splitter m20798on(final CharMatcher charMatcher) {
    ...
    /* renamed from: on */
    public static Splitter m20800on(final String str) {
        Preconditions.checkArgument(str.length() != 0, "The separator may not be the empty string.");
        if (str.length() == 1) {
            return m20797on(str.charAt(0));
        }
        return new Splitter(new Strategy() {
            public SplittingIterator iterator(Splitter splitter, CharSequence charSequence) {
                return new SplittingIterator(splitter, charSequence) {
    ...
    /* renamed from: on */
    public static Splitter m20801on(Pattern pattern) {
        return m20799on((CommonPattern) new JdkPattern(pattern));
    }

    /* renamed from: on */
    private static Splitter m20799on(final CommonPattern commonPattern) {
    ...
    public static Splitter onPattern(String str) {
        return m20799on(Platform.compilePattern(str));
    }
    ...
    public MapSplitter withKeyValueSeparator(String str) {
        return withKeyValueSeparator(m20800on(str));
    }

    public MapSplitter withKeyValueSeparator(char c) {
        return withKeyValueSeparator(m20797on(c));
    }
