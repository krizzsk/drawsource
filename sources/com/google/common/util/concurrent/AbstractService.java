...
public abstract class AbstractService implements Service {
    ...
    public final Service stopAsync() {
        if (this.monitor.enterIf(this.isStoppable)) {
            try {
                ...
                switch (C73016.$SwitchMap$com$google$common$util$concurrent$Service$State[state.ordinal()]) {
                    case 1:
    ...
    static /* synthetic */ class C73016 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.util.concurrent.AbstractService.C73016.<clinit>():void");
        }
    }
    ...
    public final void notifyFailed(Throwable th) {
        ...
        try {
            Service.State state = state();
            int i = C73016.$SwitchMap$com$google$common$util$concurrent$Service$State[state.ordinal()];
            if (i != 1) {
                if (i == 2 || i == 3 || i == 4) {
