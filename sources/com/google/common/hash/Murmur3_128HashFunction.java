...
final class Murmur3_128HashFunction extends AbstractHashFunction implements Serializable {
    ...
    private static final class Murmur3_128Hasher extends AbstractStreamingHasher {
        ...
        /* renamed from: C1 */
        private static final long f18341C1 = -8663945395140668459L;

        /* renamed from: C2 */
        private static final long f18342C2 = 5545529020109919103L;
        private static final int CHUNK_SIZE = 16;

        /* renamed from: h1 */
        private long f18343h1;

        /* renamed from: h2 */
        private long f18344h2;
        ...
        private void bmix64(long j, long j2) {
            long mixK1 = mixK1(j) ^ this.f18343h1;
            this.f18343h1 = mixK1;
            long rotateLeft = Long.rotateLeft(mixK1, 27);
            this.f18343h1 = rotateLeft;
            long j3 = this.f18344h2;
            long j4 = rotateLeft + j3;
            this.f18343h1 = j4;
            this.f18343h1 = (j4 * 5) + 1390208809;
            long mixK2 = mixK2(j2) ^ j3;
            this.f18344h2 = mixK2;
            long rotateLeft2 = Long.rotateLeft(mixK2, 31);
            this.f18344h2 = rotateLeft2;
            long j5 = rotateLeft2 + this.f18343h1;
            this.f18344h2 = j5;
            this.f18344h2 = (j5 * 5) + 944331445;
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:32:0x00f6, code lost:
            r11.f18343h1 ^= mixK1(r2);
            r11.f18344h2 ^= mixK2(r6);
         */
        ...
        public void processRemaining(java.nio.ByteBuffer r12) {
            ...
            L_0x00eb:
                ...
                long r2 = r2 ^ r0
            L_0x00f6:
                long r0 = r11.f18343h1
                long r2 = mixK1(r2)
                long r0 = r0 ^ r2
                r11.f18343h1 = r0
                long r0 = r11.f18344h2
                long r2 = mixK2(r6)
                long r0 = r0 ^ r2
                r11.f18344h2 = r0
                return
        ...
        public HashCode makeHash() {
            long j = this.f18343h1;
            int i = this.length;
            long j2 = j ^ ((long) i);
            this.f18343h1 = j2;
            long j3 = this.f18344h2 ^ ((long) i);
            this.f18344h2 = j3;
            long j4 = j2 + j3;
            this.f18343h1 = j4;
            this.f18344h2 = j3 + j4;
            this.f18343h1 = fmix64(j4);
            long fmix64 = fmix64(this.f18344h2);
            this.f18344h2 = fmix64;
            long j5 = this.f18343h1 + fmix64;
            this.f18343h1 = j5;
            this.f18344h2 = fmix64 + j5;
            return HashCode.fromBytesNoCopy(ByteBuffer.wrap(new byte[16]).order(ByteOrder.LITTLE_ENDIAN).putLong(this.f18343h1).putLong(this.f18344h2).array());
        }

        private static long mixK1(long j) {
            return Long.rotateLeft(j * f18341C1, 31) * f18342C2;
        }

        private static long mixK2(long j) {
            return Long.rotateLeft(j * f18342C2, 33) * f18341C1;
        }
    }
}
