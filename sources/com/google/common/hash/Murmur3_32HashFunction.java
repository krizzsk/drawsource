...
final class Murmur3_32HashFunction extends AbstractHashFunction implements Serializable {
    ...
    /* renamed from: C1 */
    private static final int f18345C1 = -862048943;

    /* renamed from: C2 */
    private static final int f18346C2 = 461845907;
    ...
    public static int mixK1(int i) {
        return Integer.rotateLeft(i * f18345C1, 15) * f18346C2;
    }
    ...
    private static final class Murmur3_32Hasher extends AbstractHasher {
        ...
        private void update(int i, long j) {
            ...
            this.length += i;
            if (i3 >= 32) {
                this.f18347h1 = Murmur3_32HashFunction.mixH1(this.f18347h1, Murmur3_32HashFunction.mixK1((int) j3));
                this.buffer >>>= 32;
                this.shift -= 32;
            }
        }
        ...
        public HashCode hash() {
            ...
            this.isDone = true;
            int access$000 = this.f18347h1 ^ Murmur3_32HashFunction.mixK1((int) this.buffer);
            this.f18347h1 = access$000;
