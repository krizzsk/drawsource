...
final class AudioTrackPositionTracker {
    ...
    public long getCurrentPositionUs(boolean z) {
        ...
        if (!this.notifiedPositionIncreasing) {
            ...
            if (j > j4) {
                ...
                this.listener.onPositionAdvancing(System.currentTimeMillis() - C5429C.usToMs(Util.getPlayoutDurationForMediaDuration(C5429C.usToMs(j - j4), this.audioTrackPlaybackSpeed)));
            }
        }
    ...
    public boolean mayHandleBuffer(long j) {
        ...
        if (z && !hasPendingData && playState != 1) {
            this.listener.onUnderrun(this.bufferSize, C5429C.usToMs(this.bufferSizeUs));
        }
        return true;
    }
    ...
    public long getPendingBufferDurationMs(long j) {
        return C5429C.usToMs(framesToDurationUs(j - getPlaybackHeadPosition()));
    }
