...
import com.google.android.exoplayer2.p194ui.StyledPlayerControlView;
import com.google.android.exoplayer2.p194ui.TimeBar;
...
public class StyledPlayerControlView extends FrameLayout {
    ...
    public StyledPlayerControlView(Context context, AttributeSet attributeSet, int i, AttributeSet attributeSet2) {
        ...
        int i2 = C5643R.layout.exo_styled_player_control_view;
        this.showTimeoutMs = 5000;
        this.repeatToggleModes = 0;
        this.timeBarMinUpdateIntervalMs = 200;
        if (attributeSet3 != null) {
            TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet3, C5643R.styleable.StyledPlayerControlView, i, 0);
            try {
                i2 = obtainStyledAttributes.getResourceId(C5643R.styleable.StyledPlayerControlView_controller_layout_id, i2);
                this.showTimeoutMs = obtainStyledAttributes.getInt(C5643R.styleable.StyledPlayerControlView_show_timeout, this.showTimeoutMs);
                this.repeatToggleModes = getRepeatToggleModes(obtainStyledAttributes, this.repeatToggleModes);
                boolean z12 = obtainStyledAttributes.getBoolean(C5643R.styleable.StyledPlayerControlView_show_rewind_button, true);
                boolean z13 = obtainStyledAttributes.getBoolean(C5643R.styleable.StyledPlayerControlView_show_fastforward_button, true);
                boolean z14 = obtainStyledAttributes.getBoolean(C5643R.styleable.StyledPlayerControlView_show_previous_button, true);
                boolean z15 = obtainStyledAttributes.getBoolean(C5643R.styleable.StyledPlayerControlView_show_next_button, true);
                boolean z16 = obtainStyledAttributes.getBoolean(C5643R.styleable.StyledPlayerControlView_show_shuffle_button, false);
                boolean z17 = obtainStyledAttributes.getBoolean(C5643R.styleable.StyledPlayerControlView_show_subtitle_button, false);
                boolean z18 = obtainStyledAttributes.getBoolean(C5643R.styleable.StyledPlayerControlView_show_vr_button, false);
                setTimeBarMinUpdateInterval(obtainStyledAttributes.getInt(C5643R.styleable.StyledPlayerControlView_time_bar_min_update_interval, this.timeBarMinUpdateIntervalMs));
                boolean z19 = obtainStyledAttributes.getBoolean(C5643R.styleable.StyledPlayerControlView_animation_enabled, true);
        ...
        this.durationView = (TextView) findViewById(C5643R.C5645id.exo_duration);
        this.positionView = (TextView) findViewById(C5643R.C5645id.exo_position);
        ImageView imageView = (ImageView) findViewById(C5643R.C5645id.exo_subtitle);
        this.subtitleButton = imageView;
        if (imageView != null) {
            imageView.setOnClickListener(this.componentListener);
        }
        ImageView imageView2 = (ImageView) findViewById(C5643R.C5645id.exo_fullscreen);
        ...
        ImageView imageView3 = (ImageView) findViewById(C5643R.C5645id.exo_minimal_fullscreen);
        ...
        View findViewById = findViewById(C5643R.C5645id.exo_settings);
        this.settingsButton = findViewById;
        if (findViewById != null) {
            findViewById.setOnClickListener(this.componentListener);
        }
        View findViewById2 = findViewById(C5643R.C5645id.exo_playback_speed);
        this.playbackSpeedButton = findViewById2;
        if (findViewById2 != null) {
            findViewById2.setOnClickListener(this.componentListener);
        }
        View findViewById3 = findViewById(C5643R.C5645id.exo_audio_track);
        this.audioTrackButton = findViewById3;
        if (findViewById3 != null) {
            findViewById3.setOnClickListener(this.componentListener);
        }
        TimeBar timeBar2 = (TimeBar) findViewById(C5643R.C5645id.exo_progress);
        View findViewById4 = findViewById(C5643R.C5645id.exo_progress_placeholder);
        if (timeBar2 != null) {
            ...
            z9 = z8;
            z10 = z7;
            DefaultTimeBar defaultTimeBar2 = new DefaultTimeBar(context, (AttributeSet) null, 0, attributeSet2, C5643R.style.ExoStyledControls_TimeBar);
            defaultTimeBar.setId(C5643R.C5645id.exo_progress);
        ...
        View findViewById5 = findViewById(C5643R.C5645id.exo_play_pause);
        this.playPauseButton = findViewById5;
        if (findViewById5 != null) {
            findViewById5.setOnClickListener(this.componentListener);
        }
        View findViewById6 = findViewById(C5643R.C5645id.exo_prev);
        this.previousButton = findViewById6;
        if (findViewById6 != null) {
            findViewById6.setOnClickListener(this.componentListener);
        }
        View findViewById7 = findViewById(C5643R.C5645id.exo_next);
        this.nextButton = findViewById7;
        if (findViewById7 != null) {
            findViewById7.setOnClickListener(this.componentListener);
        }
        Typeface font = ResourcesCompat.getFont(context, C5643R.font.roboto_medium_numbers);
        View findViewById8 = findViewById(C5643R.C5645id.exo_rew);
        TextView textView = findViewById8 == null ? (TextView) findViewById(C5643R.C5645id.exo_rew_with_amount) : r8;
        ...
        View findViewById9 = findViewById(C5643R.C5645id.exo_ffwd);
        TextView textView2 = findViewById9 == null ? (TextView) findViewById(C5643R.C5645id.exo_ffwd_with_amount) : r8;
        ...
        ImageView imageView4 = (ImageView) findViewById(C5643R.C5645id.exo_repeat_toggle);
        this.repeatToggleButton = imageView4;
        if (imageView4 != null) {
            imageView4.setOnClickListener(this.componentListener);
        }
        ImageView imageView5 = (ImageView) findViewById(C5643R.C5645id.exo_shuffle);
        ...
        this.buttonAlphaEnabled = ((float) resources2.getInteger(C5643R.integer.exo_media_button_opacity_percentage_enabled)) / 100.0f;
        this.buttonAlphaDisabled = ((float) this.resources.getInteger(C5643R.integer.exo_media_button_opacity_percentage_disabled)) / 100.0f;
        View findViewById10 = findViewById(C5643R.C5645id.exo_vr);
        ...
        this.settingsAdapter = new SettingsAdapter(new String[]{this.resources.getString(C5643R.string.exo_controls_playback_speed), this.resources.getString(C5643R.string.exo_track_selection_title_audio)}, new Drawable[]{this.resources.getDrawable(C5643R.C5644drawable.exo_styled_controls_speed), this.resources.getDrawable(C5643R.C5644drawable.exo_styled_controls_audiotrack)});
        this.settingsWindowMargin = this.resources.getDimensionPixelSize(C5643R.dimen.exo_settings_offset);
        RecyclerView recyclerView = (RecyclerView) LayoutInflater.from(context).inflate(C5643R.layout.exo_styled_settings_list, r8);
        ...
        this.subtitleOnButtonDrawable = this.resources.getDrawable(C5643R.C5644drawable.exo_styled_controls_subtitle_on);
        this.subtitleOffButtonDrawable = this.resources.getDrawable(C5643R.C5644drawable.exo_styled_controls_subtitle_off);
        this.subtitleOnContentDescription = this.resources.getString(C5643R.string.exo_controls_cc_enabled_description);
        this.subtitleOffContentDescription = this.resources.getString(C5643R.string.exo_controls_cc_disabled_description);
        ...
        this.playbackSpeedAdapter = new PlaybackSpeedAdapter(this.resources.getStringArray(C5643R.array.exo_playback_speeds), this.resources.getIntArray(C5643R.array.exo_speed_multiplied_by_100));
        this.fullScreenExitDrawable = this.resources.getDrawable(C5643R.C5644drawable.exo_styled_controls_fullscreen_exit);
        this.fullScreenEnterDrawable = this.resources.getDrawable(C5643R.C5644drawable.exo_styled_controls_fullscreen_enter);
        this.repeatOffButtonDrawable = this.resources.getDrawable(C5643R.C5644drawable.exo_styled_controls_repeat_off);
        this.repeatOneButtonDrawable = this.resources.getDrawable(C5643R.C5644drawable.exo_styled_controls_repeat_one);
        this.repeatAllButtonDrawable = this.resources.getDrawable(C5643R.C5644drawable.exo_styled_controls_repeat_all);
        this.shuffleOnButtonDrawable = this.resources.getDrawable(C5643R.C5644drawable.exo_styled_controls_shuffle_on);
        this.shuffleOffButtonDrawable = this.resources.getDrawable(C5643R.C5644drawable.exo_styled_controls_shuffle_off);
        this.fullScreenExitContentDescription = this.resources.getString(C5643R.string.exo_controls_fullscreen_exit_description);
        this.fullScreenEnterContentDescription = this.resources.getString(C5643R.string.exo_controls_fullscreen_enter_description);
        this.repeatOffButtonContentDescription = this.resources.getString(C5643R.string.exo_controls_repeat_off_description);
        this.repeatOneButtonContentDescription = this.resources.getString(C5643R.string.exo_controls_repeat_one_description);
        this.repeatAllButtonContentDescription = this.resources.getString(C5643R.string.exo_controls_repeat_all_description);
        this.shuffleOnContentDescription = this.resources.getString(C5643R.string.exo_controls_shuffle_on_description);
        this.shuffleOffContentDescription = this.resources.getString(C5643R.string.exo_controls_shuffle_off_description);
        this.controlViewLayoutManager.setShowButton((ViewGroup) findViewById(C5643R.C5645id.exo_bottom_bar), true);
    ...
    public void updatePlayPauseButton() {
        if (isVisible() && this.isAttachedToWindow && this.playPauseButton != null) {
            if (shouldShowPauseButton()) {
                ((ImageView) this.playPauseButton).setImageDrawable(this.resources.getDrawable(C5643R.C5644drawable.exo_styled_controls_pause));
                this.playPauseButton.setContentDescription(this.resources.getString(C5643R.string.exo_controls_pause_description));
                return;
            }
            ((ImageView) this.playPauseButton).setImageDrawable(this.resources.getDrawable(C5643R.C5644drawable.exo_styled_controls_play));
            this.playPauseButton.setContentDescription(this.resources.getString(C5643R.string.exo_controls_play_description));
        }
    }
    ...
    private void updateRewindButton() {
        ...
        L_0x0022:
            ...
            int r3 = com.google.android.exoplayer2.p194ui.C5643R.plurals.exo_controls_rewind_by_amount_description
            r4 = 1
        ...
        L_0x003b:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.p194ui.StyledPlayerControlView.updateRewindButton():void");
    }
    ...
    private void updateFastForwardButton() {
        ...
        L_0x0022:
            ...
            if (r1 == 0) goto L_0x003b
            android.content.res.Resources r2 = r7.resources
            int r3 = com.google.android.exoplayer2.p194ui.C5643R.plurals.exo_controls_fastforward_by_amount_description
            r4 = 1
            java.lang.Object[] r4 = new java.lang.Object[r4]
            r5 = 0
            java.lang.Integer r6 = java.lang.Integer.valueOf(r0)
        ...
        L_0x003b:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.p194ui.StyledPlayerControlView.updateFastForwardButton():void");
    }
            ...
            if (!currentTimeline.isEmpty()) {
                ...
                while (true) {
                    ...
                    if (i2 == currentWindowIndex) {
                        this.currentWindowOffset = C5429C.usToMs(j2);
                    }
                    ...
                    for (int i3 = this.window.firstPeriodIndex; i3 <= this.window.lastPeriodIndex; i3++) {
                        ...
                        for (int removedAdGroupCount = this.period.getRemovedAdGroupCount(); removedAdGroupCount < adGroupCount; removedAdGroupCount++) {
                            ...
                            if (positionInWindowUs >= 0) {
                                ...
                                this.adGroupTimesMs[i] = C5429C.usToMs(j2 + positionInWindowUs);
    ...
    private static int getRepeatToggleModes(TypedArray typedArray, int i) {
        return typedArray.getInt(C5643R.styleable.StyledPlayerControlView_repeat_toggle_modes, i);
    }
    ...
    private class SettingsAdapter extends RecyclerView.Adapter<SettingViewHolder> {
        ...
        public SettingViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            return new SettingViewHolder(LayoutInflater.from(StyledPlayerControlView.this.getContext()).inflate(C5643R.layout.exo_styled_settings_list_item, viewGroup, false));
        }
    ...
    private final class SettingViewHolder extends RecyclerView.ViewHolder {
        ...
        public SettingViewHolder(View view) {
            ...
            this.mainTextView = (TextView) view.findViewById(C5643R.C5645id.exo_main_text);
            this.subTextView = (TextView) view.findViewById(C5643R.C5645id.exo_sub_text);
            this.iconView = (ImageView) view.findViewById(C5643R.C5645id.exo_icon);
    ...
    private final class PlaybackSpeedAdapter extends RecyclerView.Adapter<SubSettingViewHolder> {
        ...
        public SubSettingViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            return new SubSettingViewHolder(LayoutInflater.from(StyledPlayerControlView.this.getContext()).inflate(C5643R.layout.exo_styled_sub_settings_list_item, viewGroup, false));
        }
        ...
        public void onBindViewHolder(SubSettingViewHolder subSettingViewHolder, int i) {
            ...
            subSettingViewHolder.itemView.setOnClickListener(new View.OnClickListener(i) {
                ...
                public final void onClick(View view) {
                    StyledPlayerControlView.PlaybackSpeedAdapter.this.mo30852x3c510e87(this.f$1, view);
                }
            });
        }

        /* renamed from: lambda$onBindViewHolder$0$StyledPlayerControlView$PlaybackSpeedAdapter */
        public /* synthetic */ void mo30852x3c510e87(int i, View view) {
    ...
    private final class TextTrackSelectionAdapter extends TrackSelectionAdapter {
        ...
        public void onBindViewHolderAtZeroPosition(SubSettingViewHolder subSettingViewHolder) {
            boolean z;
            subSettingViewHolder.textView.setText(C5643R.string.exo_track_selection_none);
            int i = 0;
            int i2 = 0;
            while (true) {
            ...
            subSettingViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                public final void onClick(View view) {
                    StyledPlayerControlView.TextTrackSelectionAdapter.this.mo30859xa0565781(view);
                }
            });
        }

        /* renamed from: lambda$onBindViewHolderAtZeroPosition$0$StyledPlayerControlView$TextTrackSelectionAdapter */
        public /* synthetic */ void mo30859xa0565781(View view) {
    ...
    private final class AudioTrackSelectionAdapter extends TrackSelectionAdapter {
        ...
        public void onBindViewHolderAtZeroPosition(SubSettingViewHolder subSettingViewHolder) {
            boolean z;
            subSettingViewHolder.textView.setText(C5643R.string.exo_track_selection_auto);
            ...
            subSettingViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                public final void onClick(View view) {
                    StyledPlayerControlView.AudioTrackSelectionAdapter.this.mo30845x13da8238(view);
                }
            });
        }

        /* renamed from: lambda$onBindViewHolderAtZeroPosition$0$StyledPlayerControlView$AudioTrackSelectionAdapter */
        public /* synthetic */ void mo30845x13da8238(View view) {
            if (StyledPlayerControlView.this.trackSelector != null) {
                DefaultTrackSelector.ParametersBuilder buildUpon = StyledPlayerControlView.this.trackSelector.getParameters().buildUpon();
                for (int i = 0; i < this.rendererIndices.size(); i++) {
            ...
            StyledPlayerControlView.this.settingsAdapter.setSubTextAtPosition(1, StyledPlayerControlView.this.getResources().getString(C5643R.string.exo_track_selection_auto));
            StyledPlayerControlView.this.settingsWindow.dismiss();
        }
        ...
        public void init(List<Integer> list, List<TrackInfo> list2, MappingTrackSelector.MappedTrackInfo mappedTrackInfo) {
            ...
            if (!list2.isEmpty()) {
                ...
                StyledPlayerControlView.this.settingsAdapter.setSubTextAtPosition(1, StyledPlayerControlView.this.getResources().getString(C5643R.string.exo_track_selection_none));
            }
            this.rendererIndices = list;
            this.tracks = list2;
            this.mappedTrackInfo = mappedTrackInfo;
    ...
    private abstract class TrackSelectionAdapter extends RecyclerView.Adapter<SubSettingViewHolder> {
        ...
        public void onBindViewHolder(SubSettingViewHolder subSettingViewHolder, int i) {
            if (StyledPlayerControlView.this.trackSelector != null && this.mappedTrackInfo != null) {
                ...
                subSettingViewHolder.itemView.setOnClickListener(new View.OnClickListener(trackInfo) {
                    ...
                    public final void onClick(View view) {
                        StyledPlayerControlView.TrackSelectionAdapter.this.mo30862x751be44a(this.f$1, view);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo30862x751be44a(TrackInfo trackInfo, View view) {
    ...
    private static class SubSettingViewHolder extends RecyclerView.ViewHolder {
        ...
        public SubSettingViewHolder(View view) {
            ...
            this.textView = (TextView) view.findViewById(C5643R.C5645id.exo_text);
            this.checkView = view.findViewById(C5643R.C5645id.exo_check);
        }
    }
}
