...
final class SpannedToHtmlConverter {
    ...
    public static HtmlAndCss convert(CharSequence charSequence, float f) {
        if (charSequence == null) {
            return new HtmlAndCss("", ImmutableMap.m20834of());
        }
        if (!(charSequence instanceof Spanned)) {
            return new HtmlAndCss(escapeHtml(charSequence), ImmutableMap.m20834of());
        }
    ...
    private static final class SpanInfo {
        /* access modifiers changed from: private */
        public static final Comparator<SpanInfo> FOR_CLOSING_TAGS = C5619xa592bab1.INSTANCE;
        /* access modifiers changed from: private */
        public static final Comparator<SpanInfo> FOR_OPENING_TAGS = C5618xe0dd8b9f.INSTANCE;
