...
public class PlayerNotificationManager {
    ...
    public static class Builder {
        ...
        public Builder(Context context2, int i, String str) {
            ...
            this.smallIconResourceId = C5643R.C5644drawable.exo_notification_small_icon;
            this.playActionIconResourceId = C5643R.C5644drawable.exo_notification_play;
            this.pauseActionIconResourceId = C5643R.C5644drawable.exo_notification_pause;
            this.stopActionIconResourceId = C5643R.C5644drawable.exo_notification_stop;
            this.rewindActionIconResourceId = C5643R.C5644drawable.exo_notification_rewind;
            this.fastForwardActionIconResourceId = C5643R.C5644drawable.exo_notification_fastforward;
            this.previousActionIconResourceId = C5643R.C5644drawable.exo_notification_previous;
            this.nextActionIconResourceId = C5643R.C5644drawable.exo_notification_next;
        }
    ...
    public int[] getActionIndicesForCompactView(java.util.List<java.lang.String> r7, com.google.android.exoplayer2.Player r8) {
        ...
        L_0x0062:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.p194ui.PlayerNotificationManager.getActionIndicesForCompactView(java.util.List, com.google.android.exoplayer2.Player):int[]");
    }
    ...
    private static Map<String, NotificationCompat.Action> createPlaybackActions(Context context2, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        ...
        hashMap.put(ACTION_PLAY, new NotificationCompat.Action(i2, (CharSequence) context2.getString(C5643R.string.exo_controls_play_description), createBroadcastIntent(ACTION_PLAY, context2, i)));
        hashMap.put(ACTION_PAUSE, new NotificationCompat.Action(i3, (CharSequence) context2.getString(C5643R.string.exo_controls_pause_description), createBroadcastIntent(ACTION_PAUSE, context2, i)));
        hashMap.put(ACTION_STOP, new NotificationCompat.Action(i4, (CharSequence) context2.getString(C5643R.string.exo_controls_stop_description), createBroadcastIntent(ACTION_STOP, context2, i)));
        hashMap.put(ACTION_REWIND, new NotificationCompat.Action(i5, (CharSequence) context2.getString(C5643R.string.exo_controls_rewind_description), createBroadcastIntent(ACTION_REWIND, context2, i)));
        hashMap.put(ACTION_FAST_FORWARD, new NotificationCompat.Action(i6, (CharSequence) context2.getString(C5643R.string.exo_controls_fastforward_description), createBroadcastIntent(ACTION_FAST_FORWARD, context2, i)));
        hashMap.put(ACTION_PREVIOUS, new NotificationCompat.Action(i7, (CharSequence) context2.getString(C5643R.string.exo_controls_previous_description), createBroadcastIntent(ACTION_PREVIOUS, context2, i)));
        hashMap.put(ACTION_NEXT, new NotificationCompat.Action(i8, (CharSequence) context2.getString(C5643R.string.exo_controls_next_description), createBroadcastIntent(ACTION_NEXT, context2, i)));
        return hashMap;
    }
