...
final class StyledPlayerControlViewLayoutManager {
    ...
    public StyledPlayerControlViewLayoutManager(final StyledPlayerControlView styledPlayerControlView2) {
        ...
        this.controlsBackground = styledPlayerControlView2.findViewById(C5643R.C5645id.exo_controls_background);
        this.centerControls = (ViewGroup) styledPlayerControlView2.findViewById(C5643R.C5645id.exo_center_controls);
        this.minimalControls = (ViewGroup) styledPlayerControlView2.findViewById(C5643R.C5645id.exo_minimal_controls);
        this.bottomBar = (ViewGroup) styledPlayerControlView2.findViewById(C5643R.C5645id.exo_bottom_bar);
        this.timeView = (ViewGroup) styledPlayerControlView2.findViewById(C5643R.C5645id.exo_time);
        this.timeBar = styledPlayerControlView2.findViewById(C5643R.C5645id.exo_progress);
        this.basicControls = (ViewGroup) styledPlayerControlView2.findViewById(C5643R.C5645id.exo_basic_controls);
        this.extraControls = (ViewGroup) styledPlayerControlView2.findViewById(C5643R.C5645id.exo_extra_controls);
        this.extraControlsScrollView = (ViewGroup) styledPlayerControlView2.findViewById(C5643R.C5645id.exo_extra_controls_scroll_view);
        this.overflowShowButton = styledPlayerControlView2.findViewById(C5643R.C5645id.exo_overflow_show);
        View findViewById = styledPlayerControlView2.findViewById(C5643R.C5645id.exo_overflow_hide);
        ...
        float dimension = resources.getDimension(C5643R.dimen.exo_styled_bottom_bar_height) - resources.getDimension(C5643R.dimen.exo_styled_progress_bar_height);
        float dimension2 = resources.getDimension(C5643R.dimen.exo_styled_bottom_bar_height);
    ...
    public void onOverflowButtonClick(View view) {
        resetHideCallbacks();
        if (view.getId() == C5643R.C5645id.exo_overflow_show) {
            this.overflowShowAnimator.start();
        } else if (view.getId() == C5643R.C5645id.exo_overflow_hide) {
    ...
    public void updateLayoutForSizeChange() {
        ...
        if (view != null) {
            ...
            int dimensionPixelSize = this.styledPlayerControlView.getResources().getDimensionPixelSize(C5643R.dimen.exo_styled_progress_margin_bottom);
    ...
    private boolean shouldHideInMinimalMode(View view) {
        int id = view.getId();
        return id == C5643R.C5645id.exo_bottom_bar || id == C5643R.C5645id.exo_prev || id == C5643R.C5645id.exo_next || id == C5643R.C5645id.exo_rew || id == C5643R.C5645id.exo_rew_with_amount || id == C5643R.C5645id.exo_ffwd || id == C5643R.C5645id.exo_ffwd_with_amount;
    }
