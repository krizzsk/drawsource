...
import com.google.android.exoplayer2.p194ui.TrackSelectionView;
...
public final class TrackSelectionDialogBuilder {
    ...
    private Dialog buildForPlatform() {
        ...
        View inflate = LayoutInflater.from(builder.getContext()).inflate(C5643R.layout.exo_track_selection_dialog, (ViewGroup) null);
    ...
    private Dialog buildForAndroidX() {
        try {
            ...
            View inflate = LayoutInflater.from((Context) cls.getMethod("getContext", new Class[0]).invoke(newInstance, new Object[0])).inflate(C5643R.layout.exo_track_selection_dialog, (ViewGroup) null);
    ...
    private DialogInterface.OnClickListener setUpDialogView(View view) {
        TrackSelectionView trackSelectionView = (TrackSelectionView) view.findViewById(C5643R.C5645id.exo_track_selection_view);
