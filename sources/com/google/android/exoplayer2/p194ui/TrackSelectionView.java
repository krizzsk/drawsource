...
public class TrackSelectionView extends LinearLayout {
    ...
    public TrackSelectionView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.disableView.setText(C5643R.string.exo_track_selection_none);
        ...
        addView(this.inflater.inflate(C5643R.layout.exo_list_divider, this, false));
        ...
        this.defaultView.setText(C5643R.string.exo_track_selection_auto);
