...
public final class DownloadNotificationHelper {
    ...
    public android.app.Notification buildProgressNotification(android.content.Context r21, int r22, android.app.PendingIntent r23, java.lang.String r24, java.util.List<com.google.android.exoplayer2.offline.Download> r25) {
        ...
        L_0x0049:
            ...
            int r3 = com.google.android.exoplayer2.p194ui.C5643R.string.exo_download_downloading
        L_0x004d:
            r14 = r3
            goto L_0x0055
        L_0x004f:
            if (r5 == 0) goto L_0x0054
            int r3 = com.google.android.exoplayer2.p194ui.C5643R.string.exo_download_removing
            goto L_0x004d
        L_0x0054:
            r14 = r1
        L_0x0055:
        ...
        L_0x0069:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.p194ui.DownloadNotificationHelper.buildProgressNotification(android.content.Context, int, android.app.PendingIntent, java.lang.String, java.util.List):android.app.Notification");
    }

    public Notification buildDownloadCompletedNotification(Context context, int i, PendingIntent pendingIntent, String str) {
        return buildEndStateNotification(context, i, pendingIntent, str, C5643R.string.exo_download_completed);
    }

    public Notification buildDownloadFailedNotification(Context context, int i, PendingIntent pendingIntent, String str) {
        return buildEndStateNotification(context, i, pendingIntent, str, C5643R.string.exo_download_failed);
    }
