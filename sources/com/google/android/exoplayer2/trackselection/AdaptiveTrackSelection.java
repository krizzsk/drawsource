...
public class AdaptiveTrackSelection extends BaseTrackSelection {
    ...
    public AdaptiveTrackSelection(TrackGroup trackGroup, int[] iArr, BandwidthMeter bandwidthMeter2) {
        this(trackGroup, iArr, 0, bandwidthMeter2, 10000, 25000, 25000, 0.7f, 0.75f, ImmutableList.m20815of(), Clock.DEFAULT);
    }
    ...
    protected AdaptiveTrackSelection(TrackGroup trackGroup, int[] iArr, int i, BandwidthMeter bandwidthMeter2, long j, long j2, long j3, float f, float f2, List<AdaptationCheckpoint> list, Clock clock2) {
        ...
        if (j3 < j) {
            Log.m16696w(TAG, "Adjusting minDurationToRetainAfterDiscardMs to be at least minDurationForQualityIncreaseMs");
            j3 = j;
        }
    ...
    public static ImmutableList<ImmutableList<AdaptationCheckpoint>> getAdaptationCheckpoints(ExoTrackSelection.Definition[] definitionArr) {
        ...
        for (int i6 = 0; i6 < arrayList.size(); i6++) {
            ...
            builder2.add((Object) builder3 == null ? ImmutableList.m20815of() : builder3.build());
        }
