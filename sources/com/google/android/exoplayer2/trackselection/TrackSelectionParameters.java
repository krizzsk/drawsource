...
public class TrackSelectionParameters implements Parcelable {
    ...
    public static class Builder {
        ...
        public Builder() {
            ...
            this.preferredVideoMimeTypes = ImmutableList.m20815of();
            this.preferredAudioLanguages = ImmutableList.m20815of();
            this.preferredAudioRoleFlags = 0;
            this.maxAudioChannelCount = Integer.MAX_VALUE;
            this.maxAudioBitrate = Integer.MAX_VALUE;
            this.preferredAudioMimeTypes = ImmutableList.m20815of();
            this.preferredTextLanguages = ImmutableList.m20815of();
        ...
        private void m16685x58dbf263(Context context) {
            CaptioningManager captioningManager;
            if ((Util.SDK_INT >= 23 || Looper.myLooper() != null) && (captioningManager = (CaptioningManager) context.getSystemService("captioning")) != null && captioningManager.isEnabled()) {
                this.preferredTextRoleFlags = 1088;
                Locale locale = captioningManager.getLocale();
                if (locale != null) {
                    this.preferredTextLanguages = ImmutableList.m20816of(Util.getLocaleLanguageTag(locale));
                }
            }
        }
    }
