        ...
        while (true) {
            ...
            if (readLine == null) {
                ...
                try {
                    ...
                    if (readLine2 == null) {
                        Log.m16696w(TAG, "Unexpected end");
                        break;
                    }
                    ...
                    if (matcher.matches()) {
                        ...
                        Log.m16696w(TAG, valueOf.length() != 0 ? "Skipping invalid timing: ".concat(valueOf) : new String("Skipping invalid timing: "));
                    }
                } catch (NumberFormatException unused) {
                    String valueOf2 = String.valueOf(readLine);
                    Log.m16696w(TAG, valueOf2.length() != 0 ? "Skipping invalid index: ".concat(valueOf2) : new String("Skipping invalid index: "));
                }
            }
        }
