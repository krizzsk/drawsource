...
public final class WebvttCueParser {
    ...
    private static WebvttCueInfo parseCue(String str, Matcher matcher, ParsableByteArray parsableByteArray, List<WebvttCssStyle> list) {
        ...
        try {
            ...
            Log.m16696w(TAG, valueOf.length() != 0 ? "Skipping cue with bad header: ".concat(valueOf) : new String("Skipping cue with bad header: "));
            return null;
        }
    }
    ...
    private static void parseCueSettingsList(String str, WebvttCueInfoBuilder webvttCueInfoBuilder) {
        ...
        while (matcher.find()) {
            ...
            try {
                ...
                String valueOf = String.valueOf(matcher.group());
                Log.m16696w(TAG, valueOf.length() != 0 ? "Skipping bad cue setting: ".concat(valueOf) : new String("Skipping bad cue setting: "));
            }
        }
    }
    ...
    private static int parseLineAnchor(java.lang.String r5) {
        ...
        L_0x0053:
            ...
            com.google.android.exoplayer2.util.Log.m16696w(r0, r5)
    ...
    private static int parsePositionAnchor(java.lang.String r7) {
        ...
        L_0x006d:
            java.lang.String r0 = "WebvttCueParser"
            com.google.android.exoplayer2.util.Log.m16696w(r0, r7)
    ...
    private static int parseVerticalAttribute(java.lang.String r3) {
        ...
        L_0x003d:
            java.lang.String r0 = "WebvttCueParser"
            com.google.android.exoplayer2.util.Log.m16696w(r0, r3)
    ...
    private static int parseTextAlignment(java.lang.String r6) {
        ...
        L_0x006c:
            java.lang.String r0 = "WebvttCueParser"
            com.google.android.exoplayer2.util.Log.m16696w(r0, r6)
            return r5
        L_0x0072:
            return r1
        L_0x0073:
    ...
    private static void applyEntity(java.lang.String r5, android.text.SpannableStringBuilder r6) {
        ...
        L_0x0043:
            ...
            com.google.android.exoplayer2.util.Log.m16696w(r6, r5)
            goto L_0x0088
        L_0x0071:
            r5 = 38
            r6.append(r5)
                ...
                if (i != 3) {
                    if (i != 4) {
                        if (i != 5) {
                            ...
                            sb.append(i);
                            Log.m16696w(WebvttCueParser.TAG, sb.toString());
                            return null;
                        }
                    }
                }
