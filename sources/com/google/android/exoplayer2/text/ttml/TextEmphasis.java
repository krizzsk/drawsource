...
final class TextEmphasis {
    private static final ImmutableSet<String> MARK_FILL_VALUES = ImmutableSet.m20859of(TtmlNode.TEXT_EMPHASIS_MARK_FILLED, "open");
    public static final int MARK_SHAPE_AUTO = -1;
    private static final ImmutableSet<String> MARK_SHAPE_VALUES = ImmutableSet.m20860of(TtmlNode.TEXT_EMPHASIS_MARK_DOT, TtmlNode.TEXT_EMPHASIS_MARK_SESAME, TtmlNode.TEXT_EMPHASIS_MARK_CIRCLE);
    public static final int POSITION_OUTSIDE = -2;
    private static final ImmutableSet<String> POSITION_VALUES = ImmutableSet.m20860of(TtmlNode.ANNOTATION_POSITION_AFTER, TtmlNode.ANNOTATION_POSITION_BEFORE, TtmlNode.ANNOTATION_POSITION_OUTSIDE);
    private static final ImmutableSet<String> SINGLE_STYLE_VALUES = ImmutableSet.m20859of("auto", "none");
