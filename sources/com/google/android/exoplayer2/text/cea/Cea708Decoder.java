...
public final class Cea708Decoder extends CeaDecoder {
            ...
            if ((i == 2 || i == 3) && z2) {
                if (i == 3) {
                    ...
                    if (dtvCcPacket3 == null) {
                        Log.m16692e(TAG, "Encountered DTVCC_PACKET_DATA before DTVCC_PACKET_START");
                    } else {
    ...
    private void handleG2Character(int i) {
        if (i == 32) {
            ...
            this.currentCueInfoBuilder.append(Typography.f29837tm);
        } else if (i == 58) {
    ...
    private static final class Cea708CueInfo {
        ...
        public static final Comparator<Cea708CueInfo> LEAST_IMPORTANT_FIRST = C5606xde5f1e35.INSTANCE;
