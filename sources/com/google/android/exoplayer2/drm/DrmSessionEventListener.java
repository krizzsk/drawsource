...
public interface DrmSessionEventListener {
    ...
    public static class EventDispatcher {
            ...
            while (it.hasNext()) {
                ...
                Util.postOrRun(next.handler, new Runnable(next.listener, i) {
                    ...
                    public final void run() {
                        DrmSessionEventListener.EventDispatcher.this.mo28481xb124957e(this.f$1, this.f$2);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo28481xb124957e(DrmSessionEventListener drmSessionEventListener, int i) {
        ...
        public void drmSessionManagerError(Exception exc) {
            ...
            while (it.hasNext()) {
                ...
                Util.postOrRun(next.handler, new Runnable(next.listener, exc) {
                    ...
                    public final void run() {
                        DrmSessionEventListener.EventDispatcher.this.mo28482xf6fa3d4d(this.f$1, this.f$2);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo28482xf6fa3d4d(DrmSessionEventListener drmSessionEventListener, Exception exc) {
        ...
        public void drmSessionReleased() {
            ...
            while (it.hasNext()) {
                ...
                Util.postOrRun(next.handler, new Runnable(next.listener) {
                    ...
                    public final void run() {
                        DrmSessionEventListener.EventDispatcher.this.mo28483xd1e970b2(this.f$1);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo28483xd1e970b2(DrmSessionEventListener drmSessionEventListener) {
