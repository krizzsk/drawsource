...
public final class HttpMediaDrmCallback implements MediaDrmCallback {
    ...
    public byte[] executeKeyRequest(UUID uuid, ExoMediaDrm.KeyRequest keyRequest) throws MediaDrmCallbackException {
        ...
        if (!TextUtils.isEmpty(licenseServerUrl)) {
            ...
            if (C5429C.PLAYREADY_UUID.equals(uuid)) {
                str = "text/xml";
            } else {
                str = C5429C.CLEARKEY_UUID.equals(uuid) ? "application/json" : "application/octet-stream";
            }
        ...
        throw new MediaDrmCallbackException(new DataSpec.Builder().setUri(Uri.EMPTY).build(), Uri.EMPTY, ImmutableMap.m20834of(), 0, new IllegalStateException("No license URL"));
    }
