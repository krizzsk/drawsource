...
final class WavHeaderReader {
    ...
    public static WavHeader peek(ExtractorInput extractorInput) throws IOException {
        ...
        if (ChunkHeader.peek(extractorInput, parsableByteArray).f14264id != 1380533830) {
            return null;
        }
        ...
        while (peek.f14264id != 1718449184) {
    ...
    public static Pair<Long, Long> skipToData(ExtractorInput extractorInput) throws IOException {
        ...
        ChunkHeader peek = ChunkHeader.peek(extractorInput, parsableByteArray);
        while (peek.f14264id != 1684108385) {
            if (!(peek.f14264id == 1380533830 || peek.f14264id == 1718449184)) {
                int i = peek.f14264id;
