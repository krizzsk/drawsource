...
public class FragmentedMp4Extractor implements Extractor {
    ...
    private void onMoovContainerAtomRead(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        if (this.trackBundles.size() == 0) {
            while (i < size2) {
                ...
                this.trackBundles.put(track.f14263id, new TrackBundle(this.extractorOutput.track(i, track.type), trackSampleTable, getDefaultSampleValues(sparseArray, track.f14263id)));
        ...
        while (i < size2) {
            ...
            this.trackBundles.get(track2.f14263id).reset(trackSampleTable2, getDefaultSampleValues(sparseArray, track2.f14263id));
            i++;
        }
    }
    ...
    private void onEmsgLeafAtomRead(com.google.android.exoplayer2.util.ParsableByteArray r27) {
        ...
        L_0x000a:
            ...
            com.google.android.exoplayer2.util.Log.m16696w(r2, r1)
            return
        L_0x003a:
    ...
    private boolean readSample(com.google.android.exoplayer2.extractor.ExtractorInput r17) throws java.io.IOException {
        ...
        L_0x002a:
            ...
            com.google.android.exoplayer2.util.Log.m16696w(r5, r6)
            r5 = r4
        L_0x003e:
            r1.skipFully(r5)
    ...
    private static DrmInitData getDrmInitDataFromAtoms(List<Atom.LeafAtom> list) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (leafAtom.type == 1886614376) {
                ...
                if (parseUuid == null) {
                    Log.m16696w(TAG, "Skipped pssh atom (failed to extract uuid)");
                } else {
