...
final class AtomParsers {
    ...
    private static Track parseTrak(Atom.ContainerAtom containerAtom, Atom.LeafAtom leafAtom, long j, DrmInitData drmInitData, boolean z, boolean z2) throws ParserException {
        ...
        StsdData parseStsd = parseStsd(((Atom.LeafAtom) Assertions.checkNotNull(((Atom.ContainerAtom) Assertions.checkNotNull(((Atom.ContainerAtom) Assertions.checkNotNull(containerAtom3.getContainerAtomOfType(Atom.TYPE_minf))).getContainerAtomOfType(Atom.TYPE_stbl))).getLeafAtomOfType(Atom.TYPE_stsd))).data, parseTkhd.f14262id, parseTkhd.rotationDegrees, (String) parseMdhd.second, drmInitData, z2);
        ...
        return new Track(parseTkhd.f14262id, trackTypeForHdlr, ((Long) parseMdhd.first).longValue(), parseMvhd, j4, parseStsd.format, parseStsd.requiredSampleTransformation, parseStsd.trackEncryptionBoxes, parseStsd.nalUnitLengthFieldLength, jArr2, jArr);
    }
    ...
    private static com.google.android.exoplayer2.extractor.mp4.TrackSampleTable parseStbl(com.google.android.exoplayer2.extractor.mp4.Track r37, com.google.android.exoplayer2.extractor.mp4.Atom.ContainerAtom r38, com.google.android.exoplayer2.extractor.GaplessInfoHolder r39) throws com.google.android.exoplayer2.ParserException {
        ...
        L_0x0180:
            ...
            com.google.android.exoplayer2.util.Log.m16696w(r10, r2)
        ...
        L_0x025e:
            ...
            com.google.android.exoplayer2.util.Log.m16696w(r10, r0)
        L_0x02a9:
            r2 = r4
            r3 = r6
            r14 = r8
    ...
    private static void parseTextSampleEntry(ParsableByteArray parsableByteArray, int i, int i2, int i3, int i4, String str, StsdData stsdData) {
        ...
        if (i != 1414810956) {
            if (i == 1954034535) {
                ...
                immutableList = ImmutableList.m20816of(bArr);
    ...
    private static void parseVideoSampleEntry(com.google.android.exoplayer2.util.ParsableByteArray r20, int r21, int r22, int r23, int r24, int r25, com.google.android.exoplayer2.drm.DrmInitData r26, com.google.android.exoplayer2.extractor.mp4.AtomParsers.StsdData r27, int r28) throws com.google.android.exoplayer2.ParserException {
        ...
        L_0x0143:
            ...
            com.google.common.collect.ImmutableList r15 = com.google.common.collect.ImmutableList.m20816of(r1)
        L_0x0158:
            r9 = r3
            goto L_0x00e9
        L_0x015a:
        ...
        L_0x01d0:
            ...
            com.google.android.exoplayer2.util.Log.m16696w(r3, r1)
            goto L_0x00e9
        L_0x01d7:
    ...
    private static void parseAudioSampleEntry(com.google.android.exoplayer2.util.ParsableByteArray r20, int r21, int r22, int r23, int r24, java.lang.String r25, boolean r26, com.google.android.exoplayer2.drm.DrmInitData r27, com.google.android.exoplayer2.extractor.mp4.AtomParsers.StsdData r28, int r29) throws com.google.android.exoplayer2.ParserException {
        ...
        L_0x015b:
            ...
            com.google.common.collect.ImmutableList r1 = com.google.common.collect.ImmutableList.m20816of(r12)
        L_0x017a:
            r19 = r1
        ...
        L_0x0226:
            ...
            r12 = 4
            r0.readBytes(r9, r12, r1)
            com.google.common.collect.ImmutableList r1 = com.google.common.collect.ImmutableList.m20816of(r9)
            r19 = r1
            r12 = 1634492771(0x616c6163, float:2.7252807E20)
            r17 = 0
            goto L_0x02d1
        L_0x025e:
            ...
            int r1 = r1.intValue()
            com.google.common.collect.ImmutableList r7 = com.google.common.collect.ImmutableList.m20816of(r7)
            r19 = r7
            r7 = r8
            r17 = r9
            r8 = r1
        ...
        L_0x02a8:
            ...
            r8 = r9
        L_0x02cd:
            com.google.common.collect.ImmutableList r19 = com.google.common.collect.ImmutableList.m20816of(r1)
        L_0x02d1:
            int r10 = r10 + r13
            r1 = r22
            r12 = r16
        ...
        public StszSampleSizeBox(Atom.LeafAtom leafAtom, Format format) {
            ...
            if ("audio/raw".equals(format.sampleMimeType)) {
                ...
                if (readUnsignedIntToInt == 0 || readUnsignedIntToInt % pcmFrameSize != 0) {
                    ...
                    Log.m16696w(AtomParsers.TAG, sb.toString());
