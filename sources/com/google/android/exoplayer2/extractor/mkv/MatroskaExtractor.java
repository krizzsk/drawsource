        ...
        if (i != ID_BLOCK_GROUP) {
            if (i == ID_TRACK_ENTRY) {
                ...
                if (this.currentTrack.cryptoData != null) {
                    this.currentTrack.drmInitData = new DrmInitData(new DrmInitData.SchemeData(C5429C.UUID_NIL, "video/webm", this.currentTrack.cryptoData.encryptionKey));
                    return;
                }
        ...
        if (track.trueHdSampleRechunker != null) {
            ...
            if (CODEC_ID_SUBRIP.equals(track.codecId) || CODEC_ID_ASS.equals(track.codecId)) {
                if (this.blockSampleCount > 1) {
                    Log.m16696w(TAG, "Skipping subtitle sample in laced block.");
                } else if (this.blockDurationUs == -9223372036854775807L) {
                    Log.m16696w(TAG, "Skipping subtitle sample with no duration.");
                } else {
    ...
    private static final class Track {
        ...
        public void initializeOutput(com.google.android.exoplayer2.extractor.ExtractorOutput r19, int r20) throws com.google.android.exoplayer2.ParserException {
            ...
            L_0x019f:
                ...
                com.google.common.collect.ImmutableList r1 = com.google.common.collect.ImmutableList.m20816of(r1)
                r16 = r2
                goto L_0x037f
            L_0x01b2:
                r1 = r10
            ...
            L_0x01c7:
                ...
                java.lang.String r3 = r0.codecId
                byte[] r3 = r0.getCodecPrivate(r3)
                com.google.common.collect.ImmutableList r1 = com.google.common.collect.ImmutableList.m20817of(r1, r3)
                r3 = r10
                r16 = r13
                goto L_0x03d6
            L_0x01da:
            ...
            L_0x01e8:
                ...
                com.google.android.exoplayer2.util.Log.m16696w(r5, r1)
                goto L_0x025f
            L_0x0209:
                int r1 = r0.audioBitDepth
        ...
        private static Pair<String, List<byte[]>> parseFourCcPrivate(ParsableByteArray parsableByteArray) throws ParserException {
            try {
                ...
                Log.m16696w(MatroskaExtractor.TAG, "Unknown FourCC. Setting mimeType to video/x-unknown");
