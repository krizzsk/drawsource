...
public abstract class Timeline implements Bundleable {
    ...
    public static final class Window implements Bundleable {
        ...
        public long getDefaultPositionMs() {
            return C5429C.usToMs(this.defaultPositionUs);
        }
        ...
        public long getDurationMs() {
            return C5429C.usToMs(this.durationUs);
        }
        ...
        public long getPositionInFirstPeriodMs() {
            return C5429C.usToMs(this.positionInFirstPeriodUs);
        }
    ...
    public static final class Period implements Bundleable {
        ...
        public long getPositionInWindowMs() {
            return C5429C.usToMs(this.positionInWindowUs);
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (Util.areEqual(this.f14260id, period.f14260id) && Util.areEqual(this.uid, period.uid) && this.windowIndex == period.windowIndex && this.durationUs == period.durationUs && this.positionInWindowUs == period.positionInWindowUs && this.isPlaceholder == period.isPlaceholder && Util.areEqual(this.adPlaybackState, period.adPlaybackState)) {
                return true;
            }
            return false;
        }
    ...
    public static final class RemotableTimeline extends Timeline {
        ...
        public Period getPeriod(int i, Period period, boolean z) {
            ...
            period.set(period2.f14260id, period2.uid, period2.windowIndex, period2.durationUs, period2.positionInWindowUs, period2.adPlaybackState, period2.isPlaceholder);
            return period;
        }
