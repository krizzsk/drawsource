...
public final class DefaultLivePlaybackSpeedControl implements LivePlaybackSpeedControl {
    ...
    public static final class Builder {
        ...
        private long maxLiveOffsetErrorUsForUnitSpeed = C5429C.msToUs(20);
        ...
        private long targetLiveOffsetIncrementOnRebufferUs = C5429C.msToUs(500);
        ...
        public Builder setMaxLiveOffsetErrorMsForUnitSpeed(long j) {
            Assertions.checkArgument(j > 0);
            this.maxLiveOffsetErrorUsForUnitSpeed = C5429C.msToUs(j);
            return this;
        }

        public Builder setTargetLiveOffsetIncrementOnRebufferMs(long j) {
            Assertions.checkArgument(j >= 0);
            this.targetLiveOffsetIncrementOnRebufferUs = C5429C.msToUs(j);
            return this;
        }
    ...
    public void setLiveConfiguration(MediaItem.LiveConfiguration liveConfiguration) {
        float f;
        float f2;
        this.mediaConfigurationTargetLiveOffsetUs = C5429C.msToUs(liveConfiguration.targetOffsetMs);
        this.minTargetLiveOffsetUs = C5429C.msToUs(liveConfiguration.minOffsetMs);
        this.maxTargetLiveOffsetUs = C5429C.msToUs(liveConfiguration.maxOffsetMs);
    ...
    private void adjustTargetLiveOffsetUs(long j) {
        ...
        if (this.currentTargetLiveOffsetUs > j2) {
            float msToUs = (float) C5429C.msToUs(this.minUpdateIntervalMs);
