...
final class ExoPlayerImpl extends BasePlayer implements ExoPlayer {
    ...
    public ExoPlayerImpl(com.google.android.exoplayer2.Renderer[] r19, com.google.android.exoplayer2.trackselection.TrackSelector r20, com.google.android.exoplayer2.source.MediaSourceFactory r21, com.google.android.exoplayer2.LoadControl r22, com.google.android.exoplayer2.upstream.BandwidthMeter r23, com.google.android.exoplayer2.analytics.AnalyticsCollector r24, boolean r25, com.google.android.exoplayer2.SeekParameters r26, long r27, long r29, com.google.android.exoplayer2.LivePlaybackSpeedControl r31, long r32, boolean r34, com.google.android.exoplayer2.util.Clock r35, android.os.Looper r36, com.google.android.exoplayer2.Player r37, com.google.android.exoplayer2.Player.Commands r38) {
        /*
            ...
            com.google.android.exoplayer2.util.Log.m16694i(r3, r1)
            int r1 = r2.length
            r3 = 0
    ...
    public void seekTo(int i, long j) {
        ...
        this.pendingOperationAcks++;
        if (isPlayingAd()) {
            Log.m16696w(TAG, "seekTo ignored because an ad is playing");
        ...
        this.internalPlayer.seekTo(timeline, i, C5429C.msToUs(j));
    ...
    public long getDuration() {
        ...
        return C5429C.usToMs(this.period.getAdDurationUs(mediaPeriodId.adGroupIndex, mediaPeriodId.adIndexInAdGroup));
    }

    public long getCurrentPosition() {
        return C5429C.usToMs(getCurrentPositionUsInternal(this.playbackInfo));
    }
    ...
    public long getBufferedPosition() {
        ...
        if (this.playbackInfo.loadingMediaPeriodId.equals(this.playbackInfo.periodId)) {
            return C5429C.usToMs(this.playbackInfo.bufferedPositionUs);
        }
        return getDuration();
    }

    public long getTotalBufferedDuration() {
        return C5429C.usToMs(this.playbackInfo.totalBufferedDurationUs);
    }
    ...
    public long getContentPosition() {
        ...
        return this.period.getPositionInWindowMs() + C5429C.usToMs(this.playbackInfo.requestedContentPositionUs);
    }
    ...
    public long getContentBufferedPosition() {
        ...
        return C5429C.usToMs(periodPositionUsToWindowPositionUs(this.playbackInfo.timeline, this.playbackInfo.loadingMediaPeriodId, j));
    }
    ...
    private long getCurrentPositionUsInternal(PlaybackInfo playbackInfo2) {
        if (playbackInfo2.timeline.isEmpty()) {
            return C5429C.msToUs(this.maskingWindowPositionMs);
        }
    ...
    private Player.PositionInfo getPreviousPositionInfo(int i, PlaybackInfo playbackInfo2, int i2) {
        ...
        if (i == 0) {
            ...
            if (playbackInfo3.periodId.isAd()) {
                ...
                return new Player.PositionInfo(obj2, i4, obj, i3, C5429C.usToMs(j), C5429C.usToMs(j2), playbackInfo3.periodId.adGroupIndex, playbackInfo3.periodId.adIndexInAdGroup);
    ...
    private Player.PositionInfo getPositionInfo(long j) {
        ...
        return new Player.PositionInfo(obj2, currentWindowIndex, obj, i, usToMs, this.playbackInfo.periodId.isAd() ? C5429C.usToMs(getRequestedContentPositionUs(this.playbackInfo)) : usToMs, this.playbackInfo.periodId.adGroupIndex, this.playbackInfo.periodId.adIndexInAdGroup);
    }
    ...
    private void setMediaSourcesInternal(List<MediaSource> list, int i, long j, boolean z) {
        ...
        if (createMaskingTimeline.isEmpty() || i3 < createMaskingTimeline.getWindowCount()) {
            ...
            this.internalPlayer.setMediaSources(addMediaSourceHolders, i2, C5429C.msToUs(j2), this.shuffleOrder);
    ...
    private PlaybackInfo maskTimelineAndPosition(PlaybackInfo playbackInfo2, Timeline timeline, Pair<Object, Long> pair) {
        ...
        if (timeline.isEmpty()) {
            ...
            long msToUs = C5429C.msToUs(this.maskingWindowPositionMs);
            PlaybackInfo copyWithLoadingMediaPeriodId = copyWithTimeline.copyWithNewPosition(dummyPeriodForEmptyTimeline, msToUs, msToUs, msToUs, 0, TrackGroupArray.EMPTY, this.emptyTrackSelectorResult, ImmutableList.m20815of()).copyWithLoadingMediaPeriodId(dummyPeriodForEmptyTimeline);
            copyWithLoadingMediaPeriodId.bufferedPositionUs = copyWithLoadingMediaPeriodId.positionUs;
        ...
        long msToUs2 = C5429C.msToUs(getContentPosition());
    ...
    private Pair<Object, Long> getPeriodPositionAfterTimelineChanged(Timeline timeline, Timeline timeline2) {
        ...
        Pair<Object, Long> periodPosition = timeline.getPeriodPosition(this.window, this.period, getCurrentWindowIndex(), C5429C.msToUs(contentPosition));
    ...
    private Pair<Object, Long> getPeriodPositionOrMaskWindowPosition(Timeline timeline, int i, long j) {
        ...
        return timeline.getPeriodPosition(this.window, this.period, i, C5429C.msToUs(j));
    }
