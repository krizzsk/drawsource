...
public class DefaultLoadControl implements LoadControl {
    ...
    protected DefaultLoadControl(DefaultAllocator defaultAllocator, int i, int i2, int i3, int i4, int i5, boolean z, int i6, boolean z2) {
        ...
        this.allocator = defaultAllocator;
        this.minBufferUs = C5429C.msToUs((long) i);
        this.maxBufferUs = C5429C.msToUs((long) i2);
        this.bufferForPlaybackUs = C5429C.msToUs((long) i3);
        this.bufferForPlaybackAfterRebufferUs = C5429C.msToUs((long) i4);
        this.targetBufferBytesOverwrite = i5;
        this.targetBufferBytes = i5 == -1 ? 13107200 : i5;
        this.prioritizeTimeOverSizeThresholds = z;
        this.backBufferDurationUs = C5429C.msToUs((long) i6);
    ...
    public boolean shouldContinueLoading(long j, long j2, float f) {
        ...
        if (j2 < Math.max(j3, 500000)) {
            ...
            this.isLoading = z;
            if (!z && j2 < 500000) {
                Log.m16696w("DefaultLoadControl", "Target buffer size reached with less than 500ms of buffered media data.");
            }
