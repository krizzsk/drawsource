...
final class ExoPlayerImplInternal implements Handler.Callback, MediaPeriod.Callback, TrackSelector.InvalidationListener, MediaSourceList.MediaSourceListInfoRefreshListener, DefaultMediaClock.PlaybackParametersListener, PlayerMessage.Sender {
    ...
    public synchronized void sendMessage(PlayerMessage playerMessage) {
        ...
        Log.m16696w(TAG, "Ignoring messages sent after release.");
    ...
    public boolean handleMessage(Message message) {
        ...
        try {
            ...
            if (e.type == 1 && (readingPeriod = this.queue.getReadingPeriod()) != null) {
                e = e.copyWithMediaPeriodId(readingPeriod.info.f14258id);
            }
            if (!e.isRecoverable || this.pendingRecoverableRendererError != null) {
                ...
                Log.m16693e(TAG, "Playback error", e);
                stopInternal(true, false);
                this.playbackInfo = this.playbackInfo.copyWithPlaybackError(e);
            } else {
                Log.m16697w(TAG, "Recoverable renderer error", e);
            ...
            Log.m16693e(TAG, "Playback error", createForUnexpected);
            stopInternal(true, false);
    ...
    private void handleIoException(IOException iOException, int i) {
        ...
        if (playingPeriod != null) {
            createForSource = createForSource.copyWithMediaPeriodId(playingPeriod.info.f14258id);
        }
        Log.m16693e(TAG, "Playback error", createForSource);
    ...
    private void seekToCurrentPosition(boolean z) throws ExoPlaybackException {
        MediaSource.MediaPeriodId mediaPeriodId = this.queue.getPlayingPeriod().info.f14258id;
    ...
    private long getLiveOffsetUs(Timeline timeline, Object obj, long j) {
        ...
        return C5429C.msToUs(this.window.getCurrentUnixTimeMs() - this.window.windowStartTimeMs) - (j + this.period.getPositionInWindowUs());
    }
    ...
    private void seekToInternal(com.google.android.exoplayer2.ExoPlayerImplInternal.SeekPosition r19) throws com.google.android.exoplayer2.ExoPlaybackException {
        ...
        L_0x00e4:
            r1 = r4
        L_0x00e5:
            long r14 = com.google.android.exoplayer2.C5429C.usToMs(r1)     // Catch:{ all -> 0x0153 }
            com.google.android.exoplayer2.PlaybackInfo r3 = r11.playbackInfo     // Catch:{ all -> 0x0153 }
            long r6 = r3.positionUs     // Catch:{ all -> 0x0153 }
            long r6 = com.google.android.exoplayer2.C5429C.usToMs(r6)     // Catch:{ all -> 0x0153 }
    ...
    private long seekToPeriodPosition(MediaSource.MediaPeriodId mediaPeriodId, long j, boolean z, boolean z2) throws ExoPlaybackException {
        ...
        while (mediaPeriodHolder != null && !mediaPeriodId.equals(mediaPeriodHolder.info.f14258id)) {
    ...
    private void resetInternal(boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        for (Renderer disableRenderer : this.renderers) {
            try {
                ...
                Log.m16693e(TAG, "Disable failed.", e);
            }
        }
        if (z) {
            for (Renderer reset : this.renderers) {
                try {
                    ...
                    Log.m16693e(TAG, "Reset failed.", e2);
                }
            }
        }
    ...
    private void sendMessageToTargetThread(PlayerMessage playerMessage) {
        ...
        if (!looper.getThread().isAlive()) {
            Log.m16696w("TAG", "Trying to send message on a dead thread.");
            playerMessage.markAsProcessed(false);
            return;
        }
    ...
    public /* synthetic */ void lambda$sendMessageToTargetThread$1$ExoPlayerImplInternal(PlayerMessage playerMessage) {
        try {
            ...
            Log.m16693e(TAG, "Unexpected error delivering message on external thread.", e);
    ...
    private boolean shouldTransitionToReadyState(boolean z) {
        ...
        long targetLiveOffsetUs = shouldUseLivePlaybackSpeedControl(this.playbackInfo.timeline, this.queue.getPlayingPeriod().info.f14258id) ? this.livePlaybackSpeedControl.getTargetLiveOffsetUs() : -9223372036854775807L;
        MediaPeriodHolder loadingPeriod = this.queue.getLoadingPeriod();
        boolean z2 = loadingPeriod.isFullyBuffered() && loadingPeriod.info.isFinal;
        boolean z3 = loadingPeriod.info.f14258id.isAd() && !loadingPeriod.prepared;
    ...
    private void handleMediaSourceListInfoRefreshed(com.google.android.exoplayer2.Timeline r25, boolean r26) throws com.google.android.exoplayer2.ExoPlaybackException {
        ...
        L_0x0084:
            ...
            com.google.android.exoplayer2.source.MediaSource$MediaPeriodId r2 = r2.f14258id     // Catch:{ all -> 0x0128 }
    ...
    private void maybeUpdatePlayingPeriod() throws ExoPlaybackException {
        ...
        while (shouldAdvancePlayingPeriod()) {
            ...
            PlaybackInfo handlePositionDiscontinuity = handlePositionDiscontinuity(advancePlayingPeriod.info.f14258id, advancePlayingPeriod.info.startPositionUs, advancePlayingPeriod.info.requestedContentPositionUs, advancePlayingPeriod.info.startPositionUs, true, 0);
            this.playbackInfo = handlePositionDiscontinuity;
            updateLivePlaybackSpeedControl(handlePositionDiscontinuity.timeline, advancePlayingPeriod.info.f14258id, this.playbackInfo.timeline, playingPeriod.info.f14258id, -9223372036854775807L);
            resetPendingPauseAtEndOfPeriod();
            updatePlaybackPositions();
            z = true;
        }
    ...
    private ImmutableList<Metadata> extractMetadataFromTrackSelectionArray(ExoTrackSelection[] exoTrackSelectionArr) {
        ...
        return z ? builder.build() : ImmutableList.m20815of();
    }
    ...
    private void handleLoadingMediaPeriodChanged(boolean z) {
        long j;
        MediaPeriodHolder loadingPeriod = this.queue.getLoadingPeriod();
        MediaSource.MediaPeriodId mediaPeriodId = loadingPeriod == null ? this.playbackInfo.periodId : loadingPeriod.info.f14258id;
    ...
    private static boolean resolvePendingMessagePosition(PendingMessageInfo pendingMessageInfo, Timeline timeline, Timeline timeline2, int i, boolean z, Timeline.Window window2, Timeline.Period period2) {
        ...
        if (pendingMessageInfo2.resolvedPeriodUid == null) {
            if (pendingMessageInfo2.message.getPositionMs() == Long.MIN_VALUE) {
                ...
                j = C5429C.msToUs(pendingMessageInfo2.message.getPositionMs());
            }
