...
public final class DownloadRequest implements Parcelable {
    ...
    DownloadRequest(Parcel parcel) {
        this.f14275id = (String) Util.castNonNull(parcel.readString());
    ...
    public DownloadRequest copyWithKeySetId(byte[] bArr) {
        return new DownloadRequest(this.f14275id, this.uri, this.mimeType, this.streamKeys, bArr, this.customCacheKey, this.data);
    }

    public DownloadRequest copyWithMergedRequest(DownloadRequest downloadRequest) {
        List list;
        Assertions.checkArgument(this.f14275id.equals(downloadRequest.f14275id));
        ...
        return new DownloadRequest(this.f14275id, downloadRequest.uri, downloadRequest.mimeType, list, downloadRequest.keySetId, downloadRequest.customCacheKey, downloadRequest.data);
    }

    public MediaItem toMediaItem() {
        return new MediaItem.Builder().setMediaId(this.f14275id).setUri(this.uri).setCustomCacheKey(this.customCacheKey).setMimeType(this.mimeType).setStreamKeys(this.streamKeys).setDrmKeySetId(this.keySetId).build();
    }
    ...
    public final int hashCode() {
        int hashCode = ((this.f14275id.hashCode() * 31 * 31) + this.uri.hashCode()) * 31;
        String str = this.mimeType;
        int i = 0;
    ...
    public void writeToParcel(Parcel parcel, int i) {
        parcel.writeString(this.f14275id);
