        ...
        switch (c) {
            ...
            case 2:
                ...
                if (downloadRequest != null) {
                    ...
                    Log.m16692e(TAG, "Ignored ADD_DOWNLOAD: Missing download_request extra");
                    break;
                }
            case 3:
                if (str != null) {
                    ...
                    Log.m16692e(TAG, "Ignored REMOVE_DOWNLOAD: Missing content_id extra");
                    break;
                }
            case 4:
            ...
            case 7:
                if (((Intent) Assertions.checkNotNull(intent)).hasExtra(KEY_STOP_REASON)) {
                    ...
                    Log.m16692e(TAG, "Ignored SET_STOP_REASON: Missing stop_reason extra");
                    break;
                }
            case 8:
                ...
                if (requirements != null) {
                    ...
                    Log.m16692e(TAG, "Ignored SET_REQUIREMENTS: Missing requirements extra");
                    break;
                }
            default:
    ...
    private static final class DownloadManagerHelper implements DownloadManager.Listener {
        ...
        public void onDownloadChanged(DownloadManager downloadManager2, Download download, Exception exc) {
            ...
            if (serviceMayNeedRestart() && DownloadService.needsStartedService(download.state)) {
                Log.m16696w(DownloadService.TAG, "DownloadService wasn't running. Restarting.");
                restartService();
            }
        }
        ...
        private void restartService() {
            ...
            try {
                ...
                Log.m16696w(DownloadService.TAG, "Failed to restart DownloadService (process is idle).");
            }
        }
            ...
            if (this.scheduler != null) {
                if (this.downloadManager.isWaitingForRequirements()) {
                    ...
                    if (!this.scheduler.schedule(this.downloadManager.getRequirements(), packageName, DownloadService.ACTION_RESTART)) {
                        Log.m16692e(DownloadService.TAG, "Scheduling downloads failed.");
                        return;
                    }
                    return;
                }
