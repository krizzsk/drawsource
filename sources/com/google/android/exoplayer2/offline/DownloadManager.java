    ...
    private static final class InternalHandler extends Handler {
        ...
        private void initialize(int i) {
            ...
            try {
                ...
                Log.m16693e(DownloadManager.TAG, "Failed to load index.", e);
        ...
        private void setStopReason(String str, int i) {
            if (str == null) {
                ...
                try {
                    ...
                    Log.m16693e(DownloadManager.TAG, "Failed to set manual stop reason", e);
                }
            } else {
                ...
                if (download != null) {
                    ...
                    try {
                        ...
                        Log.m16693e(DownloadManager.TAG, valueOf.length() != 0 ? "Failed to set manual stop reason: ".concat(valueOf) : new String("Failed to set manual stop reason: "), e2);
                    }
                }
            }
            syncTasks();
        ...
        private void addDownload(DownloadRequest downloadRequest, int i) {
            int i2 = 1;
            Download download = getDownload(downloadRequest.f14275id, true);
        ...
        private void removeDownload(String str) {
            ...
            if (download == null) {
                String valueOf = String.valueOf(str);
                Log.m16692e(DownloadManager.TAG, valueOf.length() != 0 ? "Failed to remove nonexistent download: ".concat(valueOf) : new String("Failed to remove nonexistent download: "));
                return;
            }
        ...
        private void removeAllDownloads() {
            ...
            try {
                ...
                Log.m16692e(DownloadManager.TAG, "Failed to load downloads.");
            } catch (Throwable th) {
                th.addSuppressed(th);
            }
            ...
            Collections.sort(this.downloads, C5535x7c64c816.INSTANCE);
            try {
                this.downloadIndex.setStatesToRemoving();
            } catch (IOException e) {
                Log.m16693e(DownloadManager.TAG, "Failed to update index.", e);
            }
        ...
        private void syncTasks() {
            ...
            for (int i2 = 0; i2 < this.downloads.size(); i2++) {
                ...
                Task task = this.activeTasks.get(download.request.f14275id);
        ...
        private Task syncQueuedDownload(Task task, Download download) {
            if (task != null) {
                ...
                this.activeTasks.put(putDownloadWithState.request.f14275id, task2);
        ...
        private void syncRemovingDownload(Task task, Download download) {
            if (task == null) {
                ...
                this.activeTasks.put(download.request.f14275id, task2);
                task2.start();
        ...
        private void onContentLengthChanged(Task task, long j) {
            Download download = (Download) Assertions.checkNotNull(getDownload(task.request.f14275id, false));
        ...
        private void onTaskStopped(Task task) {
            String str = task.request.f14275id;
            ...
            if (access$400 != null) {
                ...
                Log.m16693e(DownloadManager.TAG, sb.toString(), access$400);
            }
        ...
        private void onDownloadTaskStopped(Download download, Exception exc) {
            ...
            this.downloads.remove(getDownloadIndex(download3.request.f14275id));
            try {
        ...
        private void onRemoveTaskStopped(Download download) {
            ...
            this.downloads.remove(getDownloadIndex(download.request.f14275id));
            try {
                this.downloadIndex.removeDownload(download.request.f14275id);
            } catch (IOException unused) {
                Log.m16692e(DownloadManager.TAG, "Failed to remove from database");
            }
        ...
        private Download putDownload(Download download) {
            ...
            int downloadIndex2 = getDownloadIndex(download.request.f14275id);
            if (downloadIndex2 == -1) {
        ...
        private Download getDownload(String str, boolean z) {
            ...
            try {
                ...
                String valueOf = String.valueOf(str);
                Log.m16693e(DownloadManager.TAG, valueOf.length() != 0 ? "Failed to load download: ".concat(valueOf) : new String("Failed to load download: "), e);
                return null;
            }
        }
        ...
        private int getDownloadIndex(String str) {
            for (int i = 0; i < this.downloads.size(); i++) {
                if (this.downloads.get(i).request.f14275id.equals(str)) {
                    return i;
                }
            }
            return -1;
