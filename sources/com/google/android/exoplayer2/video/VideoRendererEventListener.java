...
public interface VideoRendererEventListener {
    ...
    public static final class EventDispatcher {
        ...
        public void decoderInitialized(String str, long j, long j2) {
            ...
            if (handler2 != null) {
                handler2.post(new Runnable(str, j, j2) {
                    ...
                    public final void run() {
                        VideoRendererEventListener.EventDispatcher.this.mo31562x9a08f997(this.f$1, this.f$2, this.f$3);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo31562x9a08f997(String str, long j, long j2) {
        ...
        public void inputFormatChanged(Format format, DecoderReuseEvaluation decoderReuseEvaluation) {
            ...
            if (handler2 != null) {
                handler2.post(new Runnable(format, decoderReuseEvaluation) {
                    ...
                    public final void run() {
                        VideoRendererEventListener.EventDispatcher.this.mo31567xe7570b3(this.f$1, this.f$2);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo31567xe7570b3(Format format, DecoderReuseEvaluation decoderReuseEvaluation) {
        ...
        public void droppedFrames(int i, long j) {
            ...
            if (handler2 != null) {
                handler2.post(new Runnable(i, j) {
                    ...
                    public final void run() {
                        VideoRendererEventListener.EventDispatcher.this.mo31565xf7e95759(this.f$1, this.f$2);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo31565xf7e95759(int i, long j) {
        ...
        public void reportVideoFrameProcessingOffset(long j, int i) {
            ...
            if (handler2 != null) {
                handler2.post(new Runnable(j, i) {
                    ...
                    public final void run() {
                        VideoRendererEventListener.EventDispatcher.this.mo31569xac275638(this.f$1, this.f$2);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo31569xac275638(long j, int i) {
        ...
        public void videoSizeChanged(VideoSize videoSize) {
            ...
            if (handler2 != null) {
                handler2.post(new Runnable(videoSize) {
                    ...
                    public final void run() {
                        VideoRendererEventListener.EventDispatcher.this.mo31571x32e5b8cb(this.f$1);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo31571x32e5b8cb(VideoSize videoSize) {
        ...
        public void renderedFirstFrame(Object obj) {
            if (this.handler != null) {
                this.handler.post(new Runnable(obj, SystemClock.elapsedRealtime()) {
                    ...
                    public final void run() {
                        VideoRendererEventListener.EventDispatcher.this.mo31568x7a7e870(this.f$1, this.f$2);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo31568x7a7e870(Object obj, long j) {
        ...
        public void decoderReleased(String str) {
            ...
            if (handler2 != null) {
                handler2.post(new Runnable(str) {
                    ...
                    public final void run() {
                        VideoRendererEventListener.EventDispatcher.this.mo31563xa2bde45a(this.f$1);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo31563xa2bde45a(String str) {
        ...
        public void videoCodecError(Exception exc) {
            ...
            if (handler2 != null) {
                handler2.post(new Runnable(exc) {
                    ...
                    public final void run() {
                        VideoRendererEventListener.EventDispatcher.this.mo31570x15635cc(this.f$1);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo31570x15635cc(Exception exc) {
