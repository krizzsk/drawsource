...
public final class Id3Decoder extends SimpleMetadataDecoder {
    ...
    private static Id3Header decodeHeader(ParsableByteArray parsableByteArray) {
        if (parsableByteArray.bytesLeft() < 10) {
            Log.m16696w(TAG, "Data too short to be an ID3 tag");
            return null;
        }
        ...
        if (readUnsignedInt24 != 4801587) {
            ...
            Log.m16696w(TAG, valueOf.length() != 0 ? "Unexpected first three bytes of ID3 tag header: 0x".concat(valueOf) : new String("Unexpected first three bytes of ID3 tag header: 0x"));
            return null;
        }
        ...
        if (readUnsignedByte == 2) {
            if ((readUnsignedByte2 & 64) != 0) {
                Log.m16696w(TAG, "Skipped ID3 tag with majorVersion=2 and undefined compression scheme");
                return null;
            }
    ...
    private static com.google.android.exoplayer2.metadata.id3.Id3Frame decodeFrame(int r19, com.google.android.exoplayer2.util.ParsableByteArray r20, boolean r21, int r22, com.google.android.exoplayer2.metadata.id3.Id3Decoder.FramePredicate r23) {
        ...
        L_0x0067:
            ...
            com.google.android.exoplayer2.util.Log.m16696w(r4, r0)
            int r0 = r20.limit()
            r7.setPosition(r0)
            return r16
        L_0x0082:
        ...
        L_0x01f2:
            ...
            com.google.android.exoplayer2.util.Log.m16696w(r12, r0)     // Catch:{ UnsupportedEncodingException -> 0x0222 }
        L_0x021e:
            r7.setPosition(r14)
            return r1
        L_0x0222:
            java.lang.String r0 = "Unsupported character encoding"
            com.google.android.exoplayer2.util.Log.m16696w(r12, r0)     // Catch:{ all -> 0x012e }
            r7.setPosition(r14)
            return r16
        L_0x022b:
            r7.setPosition(r14)
        ...
        L_0x022f:
            ...
            com.google.android.exoplayer2.util.Log.m16696w(r12, r0)
            r7.setPosition(r14)
            return r16
        */
    ...
    private static UrlLinkFrame decodeWxxxFrame(ParsableByteArray parsableByteArray, int i) throws UnsupportedEncodingException {
        ...
        String str = new String(bArr, 0, indexOfEos, charsetName);
        int delimiterLength = indexOfEos + delimiterLength(readUnsignedByte);
        return new UrlLinkFrame("WXXX", str, decodeStringIfValid(bArr, delimiterLength, indexOfZeroByte(bArr, delimiterLength), C5429C.ISO88591_NAME));
    }
    ...
    private static UrlLinkFrame decodeUrlLinkFrame(ParsableByteArray parsableByteArray, int i, String str) throws UnsupportedEncodingException {
        ...
        return new UrlLinkFrame(str, (String) null, new String(bArr, 0, indexOfZeroByte(bArr, 0), C5429C.ISO88591_NAME));
    }
    ...
    private static PrivFrame decodePrivFrame(ParsableByteArray parsableByteArray, int i) throws UnsupportedEncodingException {
        ...
        return new PrivFrame(new String(bArr, 0, indexOfZeroByte, C5429C.ISO88591_NAME), copyOfRangeIfValid(bArr, indexOfZeroByte + 1, i));
    }
    ...
    private static GeobFrame decodeGeobFrame(ParsableByteArray parsableByteArray, int i) throws UnsupportedEncodingException {
        ...
        parsableByteArray.readBytes(bArr, 0, i2);
        int indexOfZeroByte = indexOfZeroByte(bArr, 0);
        String str = new String(bArr, 0, indexOfZeroByte, C5429C.ISO88591_NAME);
    ...
    private static ApicFrame decodeApicFrame(ParsableByteArray parsableByteArray, int i, int i2) throws UnsupportedEncodingException {
        ...
        if (i2 == 2) {
            String valueOf = String.valueOf(Ascii.toLowerCase(new String(bArr, 0, 3, C5429C.ISO88591_NAME)));
            ...
            String lowerCase = Ascii.toLowerCase(new String(bArr, 0, i3, C5429C.ISO88591_NAME));
    ...
    private static ChapterFrame decodeChapterFrame(ParsableByteArray parsableByteArray, int i, int i2, boolean z, int i3, FramePredicate framePredicate2) throws UnsupportedEncodingException {
        ...
        String str = new String(parsableByteArray.getData(), position, indexOfZeroByte - position, C5429C.ISO88591_NAME);
    ...
    private static ChapterTocFrame decodeChapterTOCFrame(ParsableByteArray parsableByteArray, int i, int i2, boolean z, int i3, FramePredicate framePredicate2) throws UnsupportedEncodingException {
        ...
        for (int i4 = 0; i4 < readUnsignedByte2; i4++) {
            ...
            strArr[i4] = new String(parsableByteArray.getData(), position2, indexOfZeroByte2 - position2, C5429C.ISO88591_NAME);
