...
public final class TextInformationFrame extends Id3Frame {
    ...
    public void populateMediaMetadata(com.google.android.exoplayer2.MediaMetadata.Builder r8) {
        /*
            r7 = this;
            java.lang.String r0 = r7.f14271id
            int r1 = r0.hashCode()
            r2 = 4
            r3 = 3
            r4 = 0
    ...
    public boolean equals(Object obj) {
        ...
        if (!Util.areEqual(this.f14271id, textInformationFrame.f14271id) || !Util.areEqual(this.description, textInformationFrame.description) || !Util.areEqual(this.value, textInformationFrame.value)) {
            return false;
        }
        return true;
    }
