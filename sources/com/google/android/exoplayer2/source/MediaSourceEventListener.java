...
public interface MediaSourceEventListener {
    ...
    public static class EventDispatcher {
        ...
        public void upstreamDiscarded(MediaLoadData mediaLoadData) {
            ...
            while (it.hasNext()) {
                ...
                Util.postOrRun(next.handler, new Runnable(next.listener, mediaPeriodId2, mediaLoadData) {
                    ...
                    public final void run() {
                        MediaSourceEventListener.EventDispatcher.this.mo29420xf69ef2bb(this.f$1, this.f$2, this.f$3);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo29420xf69ef2bb(MediaSourceEventListener mediaSourceEventListener, MediaSource.MediaPeriodId mediaPeriodId2, MediaLoadData mediaLoadData) {
        ...
        public void downstreamFormatChanged(MediaLoadData mediaLoadData) {
            ...
            while (it.hasNext()) {
                ...
                Util.postOrRun(next.handler, new Runnable(next.listener, mediaLoadData) {
                    ...
                    public final void run() {
                        MediaSourceEventListener.EventDispatcher.this.mo29415x83d27b61(this.f$1, this.f$2);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo29415x83d27b61(MediaSourceEventListener mediaSourceEventListener, MediaLoadData mediaLoadData) {
