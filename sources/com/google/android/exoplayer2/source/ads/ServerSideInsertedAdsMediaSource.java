...
public final class ServerSideInsertedAdsMediaSource extends BaseMediaSource implements MediaSource.MediaSourceCaller, MediaSourceEventListener, DrmSessionEventListener {
    ...
    private static final class SharedMediaPeriod implements MediaPeriod.Callback {
        ...
        public MediaPeriodImpl getMediaPeriodForEvent(MediaLoadData mediaLoadData) {
            ...
            for (int i = 0; i < this.mediaPeriods.size(); i++) {
                ...
                long mediaPeriodPositionUs = ServerSideInsertedAdsUtil.getMediaPeriodPositionUs(C5429C.msToUs(mediaLoadData.mediaStartTimeMs), mediaPeriodImpl.mediaPeriodId, this.adPlaybackState);
            ...
            while (true) {
                ...
                if (exoTrackSelectionArr[i] != null) {
                    ...
                    for (int i2 = 0; i2 < trackGroup.length; i2++) {
                        ...
                        if (format.equals(mediaLoadData.trackFormat) || (z && format.f14256id != null && format.f14256id.equals(mediaLoadData.trackFormat.f14256id))) {
                            return i;
                        }
                    }
                    continue;
    ...
    private static final class ServerSideInsertedAdsTimeline extends ForwardingTimeline {
        ...
        public Timeline.Period getPeriod(int i, Timeline.Period period, boolean z) {
            ...
            period2.set(period.f14260id, period.uid, period.windowIndex, j, -ServerSideInsertedAdsUtil.getMediaPeriodPositionUsForContent(-period.getPositionInWindowUs(), -1, this.adPlaybackState), this.adPlaybackState, period.isPlaceholder);
            return period;
        }
    }
