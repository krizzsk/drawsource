...
public final class AdsMediaSource extends CompositeMediaSource<MediaSource.MediaPeriodId> {
    ...
    public void releasePeriod(MediaPeriod mediaPeriod) {
        ...
        MediaSource.MediaPeriodId mediaPeriodId = maskingMediaPeriod.f14278id;
    ...
    private final class AdMediaSourceHolder {
        ...
        /* renamed from: id */
        private final MediaSource.MediaPeriodId f14280id;
        private Timeline timeline;

        public AdMediaSourceHolder(MediaSource.MediaPeriodId mediaPeriodId) {
            this.f14280id = mediaPeriodId;
        }
        ...
        public void initializeWithMediaSource(MediaSource mediaSource, Uri uri) {
            ...
            AdsMediaSource.this.prepareChildSource(this.f14280id, mediaSource);
        }
        ...
        public void handleSourceInfoRefresh(Timeline timeline2) {
            ...
            if (this.timeline == null) {
                ...
                for (int i = 0; i < this.activeMediaPeriods.size(); i++) {
                    MaskingMediaPeriod maskingMediaPeriod = this.activeMediaPeriods.get(i);
                    maskingMediaPeriod.createPeriod(new MediaSource.MediaPeriodId(uidOfPeriod, maskingMediaPeriod.f14278id.windowSequenceNumber));
                }
            }
        ...
        public void release() {
            if (hasMediaSource()) {
                AdsMediaSource.this.releaseChildSource(this.f14280id);
            }
        }
