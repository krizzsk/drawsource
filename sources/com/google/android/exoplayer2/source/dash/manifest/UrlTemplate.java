            ...
            if (indexOf == -1) {
                ...
                if (substring.equals(REPRESENTATION)) {
                    ...
                    if (indexOf3 != -1) {
                        ...
                        if (!str2.endsWith(DownloadCommon.DOWNLOAD_REPORT_FIND_FILE_RESULT_VALUE_D) && !str2.endsWith("x")) {
                            str2 = String.valueOf(str2).concat(DownloadCommon.DOWNLOAD_REPORT_FIND_FILE_RESULT_VALUE_D);
                        }
