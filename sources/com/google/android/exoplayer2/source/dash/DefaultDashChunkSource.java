...
public class DefaultDashChunkSource implements DashChunkSource {
    ...
    public void getNextChunk(long j, long j2, List<? extends MediaChunk> list, ChunkHolder chunkHolder) {
        ...
        if (defaultDashChunkSource.fatalError == null) {
            long j5 = j2 - j4;
            long msToUs = C5429C.msToUs(defaultDashChunkSource.manifest.availabilityStartTimeMs) + C5429C.msToUs(defaultDashChunkSource.manifest.getPeriod(defaultDashChunkSource.periodIndex).startMs) + j2;
            ...
            if (playerTrackEmsgHandler2 == null || !playerTrackEmsgHandler2.maybeRefreshManifestBeforeLoadingNextChunk(msToUs)) {
                long msToUs2 = C5429C.msToUs(Util.getNowUnixTimeMs(defaultDashChunkSource.elapsedRealtimeOffsetMs));
    ...
    private long getNowPeriodTimeUs(long j) {
        ...
        return j - C5429C.msToUs(this.manifest.availabilityStartTimeMs + this.manifest.getPeriod(this.periodIndex).startMs);
    }
