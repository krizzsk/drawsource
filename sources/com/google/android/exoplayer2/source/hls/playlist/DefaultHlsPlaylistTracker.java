...
public final class DefaultHlsPlaylistTracker implements HlsPlaylistTracker, Loader.Callback<ParsingLoadable<HlsPlaylist>> {
    ...
    private final class MediaPlaylistBundle implements Loader.Callback<ParsingLoadable<HlsPlaylist>> {
        ...
        public boolean isSnapshotValid() {
            ...
            long elapsedRealtime = SystemClock.elapsedRealtime();
            long max = Math.max(30000, C5429C.usToMs(this.playlistSnapshot.durationUs));
                ...
                if (elapsedRealtime < this.earliestNextLoadTimeMs) {
                    ...
                    DefaultHlsPlaylistTracker.this.playlistRefreshHandler.postDelayed(new Runnable(uri) {
                        ...
                        public final void run() {
                            DefaultHlsPlaylistTracker.MediaPlaylistBundle.this.mo30008xca8f1aa6(this.f$1);
                        }
        ...
        public /* synthetic */ void mo30008xca8f1aa6(Uri uri) {
        ...
        public void processLoadedPlaylist(HlsMediaPlaylist hlsMediaPlaylist, LoadEventInfo loadEventInfo) {
            ...
            if (access$1400 != hlsMediaPlaylist2) {
                ...
                if (hlsMediaPlaylist.mediaSequence + ((long) hlsMediaPlaylist.segments.size()) < this.playlistSnapshot.mediaSequence) {
                    ...
                    if (((double) (elapsedRealtime - this.lastSnapshotChangeMs)) > ((double) C5429C.usToMs(this.playlistSnapshot.targetDurationUs)) * DefaultHlsPlaylistTracker.this.playlistStuckTargetDurationCoefficient) {
            ...
            this.earliestNextLoadTimeMs = elapsedRealtime + C5429C.usToMs(j);
