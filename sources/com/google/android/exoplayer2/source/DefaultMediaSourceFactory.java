...
import com.google.android.exoplayer2.p194ui.AdViewProvider;
...
public final class DefaultMediaSourceFactory implements MediaSourceFactory {
    ...
    private static MediaSource maybeClipMediaSource(MediaItem mediaItem, MediaSource mediaSource) {
        ...
        return new ClippingMediaSource(mediaSource, C5429C.msToUs(mediaItem.clippingProperties.startPositionMs), C5429C.msToUs(mediaItem.clippingProperties.endPositionMs), !mediaItem.clippingProperties.startsAtKeyFrame, mediaItem.clippingProperties.relativeToLiveWindow, mediaItem.clippingProperties.relativeToDefaultPosition);
    }
    ...
    private MediaSource maybeWrapWithAdsMediaSource(MediaItem mediaItem, MediaSource mediaSource) {
        ...
        if (adsLoaderProvider2 == null || adViewProvider2 == null) {
            Log.m16696w(TAG, "Playing media without ads. Configure ad support by calling setAdsLoaderProvider and setAdViewProvider.");
            return mediaSource;
        }
        AdsLoader adsLoader = adsLoaderProvider2.getAdsLoader(adsConfiguration);
        if (adsLoader == null) {
            Log.m16696w(TAG, "Playing media without ads, as no AdsLoader was provided.");
            return mediaSource;
        }
        ...
        if (adsConfiguration.adsId != null) {
            ...
            obj = ImmutableList.m20818of(mediaItem.mediaId, mediaItem.playbackProperties.uri, adsConfiguration.adTagUri);
        }
