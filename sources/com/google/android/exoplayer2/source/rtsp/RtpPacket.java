...
public final class RtpPacket {
    ...
    public int writeToBuffer(byte[] bArr, int i, int i2) {
        ...
        ByteBuffer.wrap(bArr, i, i2).put((byte) (((this.padding ? 1 : 0) << true) | 128 | ((this.extension ? 1 : 0) << true) | (this.csrcCount & Ascii.f18305SI))).put((byte) (((this.marker ? 1 : 0) << true) | (this.payloadType & Byte.MAX_VALUE))).putShort((short) this.sequenceNumber).putInt((int) this.timestamp).putInt(this.ssrc).put(this.csrc).put(this.payloadData);
        return length;
    }
