    ...
    private final class LoadTask<T extends Loadable> extends Handler implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                if (!this.released) {
                    Log.m16693e(TAG, "Unexpected exception loading stream", e2);
                    obtainMessage(2, new UnexpectedLoaderException(e2)).sendToTarget();
                }
            } catch (OutOfMemoryError e3) {
                if (!this.released) {
                    Log.m16693e(TAG, "OutOfMemory error loading stream", e3);
                    obtainMessage(2, new UnexpectedLoaderException(e3)).sendToTarget();
                }
            } catch (Error e4) {
                if (!this.released) {
                    Log.m16693e(TAG, "Unexpected error loading stream", e4);
                ...
                if (message.what == 0) {
                    ...
                    if (i == 1) {
                        try {
                            ...
                            Log.m16693e(TAG, "Unexpected exception handling load completed", e);
