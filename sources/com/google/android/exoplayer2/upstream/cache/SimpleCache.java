...
public final class SimpleCache implements Cache {
    ...
    public synchronized void release() {
        if (!this.released) {
            ...
            try {
                ...
                try {
                    Log.m16693e(TAG, "Storing index file failed", e);
                    unlockFolder(this.cacheDir);
                } catch (Throwable th) {
                    unlockFolder(this.cacheDir);
                    this.released = true;
    ...
    public synchronized File startFile(String str, long j, long j2) throws Cache.CacheException {
        ...
        return SimpleCacheSpan.getCacheFile(file, cachedContent.f14294id, j, System.currentTimeMillis());
    }
    ...
    public void initialize() {
        ...
        try {
            ...
            try {
                ...
                Log.m16693e(TAG, "Storing index file failed", e3);
            }
    ...
    private SimpleCacheSpan touchSpan(String str, SimpleCacheSpan simpleCacheSpan) {
        ...
        if (cacheFileMetadataIndex != null) {
            try {
                ...
                Log.m16696w(TAG, "Failed to update index with new touch timestamp.");
            }
        } else {
            z = true;
        }
        ...
        if (cachedContent != null && cachedContent.removeSpan(cacheSpan)) {
            ...
            if (this.fileIndex != null) {
                ...
                try {
                    ...
                    Log.m16696w(TAG, valueOf.length() != 0 ? "Failed to remove file index entry for: ".concat(valueOf) : new String("Failed to remove file index entry for: "));
                }
            }
            this.contentIndex.maybeRemove(cachedContent.key);
