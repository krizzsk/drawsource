...
public final class Format implements Parcelable {
    ...
    public static final class Builder {
        ...
        public Builder setId(int i) {
            this.f14257id = Integer.toString(i);
            return this;
        }
    ...
    private Format(Builder builder) {
        this.f14256id = builder.f14257id;
    ...
    Format(Parcel parcel) {
        this.f14256id = parcel.readString();
    ...
    public static String toLogString(Format format) {
        ...
        if (format.drmInitData != null) {
            ...
            for (int i = 0; i < format.drmInitData.schemeDataCount; i++) {
                ...
                if (uuid.equals(C5429C.COMMON_PSSH_UUID)) {
                    linkedHashSet.add("cenc");
                } else if (uuid.equals(C5429C.CLEARKEY_UUID)) {
                    linkedHashSet.add("clearkey");
                } else if (uuid.equals(C5429C.PLAYREADY_UUID)) {
                    linkedHashSet.add("playready");
                } else if (uuid.equals(C5429C.WIDEVINE_UUID)) {
                    linkedHashSet.add("widevine");
                } else if (uuid.equals(C5429C.UUID_NIL)) {
            ...
            sb.append(", drm=[");
            sb.append(Joiner.m20784on(',').join((Iterable<?>) linkedHashSet));
            sb.append(']');
        }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        parcel.writeString(this.f14256id);
