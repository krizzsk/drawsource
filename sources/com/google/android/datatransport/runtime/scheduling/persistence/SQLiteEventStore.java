...
public class SQLiteEventStore implements EventStore, SynchronizationGuard, ClientHealthMetricsStore {
    ...
    private static final Encoding PROTOBUF_ENCODING = Encoding.m16657of("proto");
    ...
    public PersistedEvent persist(TransportContext transportContext, EventInternal eventInternal) {
        Logging.m16662d(LOG_TAG, "Storing event with priority=%s, name=%s for destination %s", transportContext.getPriority(), eventInternal.getTransportName(), transportContext.getBackendName());
    ...
    private LogEventDropped.Reason convertToReason(int i) {
        ...
        Logging.m16660d(LOG_TAG, "%n is not valid. No matched LogEventDropped-Reason found. Treated it as REASON_UNKNOWN", (Object) Integer.valueOf(i));
        return LogEventDropped.Reason.REASON_UNKNOWN;
    }
