...
public final class NativeAdView extends FrameLayout {
    ...
    private final void zzf(String str, View view) {
        zzblf zzblf = this.zzb;
        if (zzblf != null) {
            try {
                zzblf.zzbw(str, ObjectWrapper.wrap(view));
    ...
    public final boolean dispatchTouchEvent(MotionEvent motionEvent) {
        zzblf zzblf;
        if (((Boolean) zzay.zzc().zzb(zzbhz.zzcD)).booleanValue() && (zzblf = this.zzb) != null) {
            try {
                zzblf.zzd(ObjectWrapper.wrap(motionEvent));
            } catch (RemoteException e) {
    ...
    public final void onVisibilityChanged(View view, int i) {
        ...
        if (zzblf != null) {
            try {
                zzblf.zze(ObjectWrapper.wrap(view), i);
            } catch (RemoteException e) {
    ...
    public final void setClickConfirmingView(View view) {
        ...
        if (zzblf != null) {
            try {
                zzblf.zzbx(ObjectWrapper.wrap(view));
            } catch (RemoteException e) {
    ...
    public final View zza(String str) {
        ...
        if (zzblf != null) {
            try {
                IObjectWrapper zzb2 = zzblf.zzb(str);
                if (zzb2 != null) {
        ...
        if (zzblf != null) {
            try {
                if (mediaContent instanceof zzej) {
                    zzblf.zzby(((zzej) mediaContent).zza());
                } else if (mediaContent == null) {
                    zzblf.zzby((zzbky) null);
                } else {
    ...
    public final /* synthetic */ void zzc(ImageView.ScaleType scaleType) {
        zzblf zzblf = this.zzb;
        if (zzblf != null && scaleType != null) {
            try {
                zzblf.zzbz(ObjectWrapper.wrap(scaleType));
            } catch (RemoteException e) {
