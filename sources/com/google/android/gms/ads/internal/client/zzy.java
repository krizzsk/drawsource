...
import com.google.android.gms.ads.C5686R;
...
public final class zzy {
    ...
    public zzy(Context context, AttributeSet attributeSet) {
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C5686R.styleable.AdsAttrs);
        String string = obtainAttributes.getString(C5686R.styleable.AdsAttrs_adSize);
        String string2 = obtainAttributes.getString(C5686R.styleable.AdsAttrs_adSizes);
        ...
        this.zzb = obtainAttributes.getString(C5686R.styleable.AdsAttrs_adUnitId);
        obtainAttributes.recycle();
