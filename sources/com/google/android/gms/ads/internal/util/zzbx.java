...
public final class zzbx {
    ...
    public static WindowManager.LayoutParams zzb() {
        ...
        layoutParams.flags = ((Integer) zzay.zzc().zzb(zzbhz.zzgJ)).intValue();
        layoutParams.type = 2;
            ...
            if (view2 != null) {
                ...
                try {
                    ...
                    try {
                        ...
                        if (((Boolean) zzay.zzc().zzb(zzbhz.zzgG)).booleanValue() && ((String) entry2.getKey()).equals("3010")) {
    ...
    public static JSONObject zzf(View view) {
        ...
        try {
            boolean z = false;
            if (((Boolean) zzay.zzc().zzb(zzbhz.zzgF)).booleanValue()) {
                zzt.zzp();
    ...
    public static org.json.JSONObject zzg(android.content.Context r16, android.view.View r17) {
        ...
        L_0x0102:
            com.google.android.gms.internal.ads.zzbhr r0 = com.google.android.gms.internal.ads.zzbhz.zzfi
    ...
    public static boolean zzh(Context context, zzfbl zzfbl) {
        if (!zzfbl.zzO) {
            return false;
        }
        if (((Boolean) zzay.zzc().zzb(zzbhz.zzgH)).booleanValue()) {
            return ((Boolean) zzay.zzc().zzb(zzbhz.zzgK)).booleanValue();
        }
        String str = (String) zzay.zzc().zzb(zzbhz.zzgI);
        if (!str.isEmpty() && context != null) {
            String packageName = context.getPackageName();
            for (String equals : zzfpg.zzc(zzfoh.zzc(';')).zzd(str)) {
    ...
    public static boolean zzi(int i) {
        ...
        return ((Boolean) zzay.zzc().zzb(zzbhz.zzcE)).booleanValue() || i <= 15299999;
    }
