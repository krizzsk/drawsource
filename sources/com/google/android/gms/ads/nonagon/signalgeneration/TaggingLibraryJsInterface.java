...
final class TaggingLibraryJsInterface {
    ...
    private final int zzd = ((Integer) zzay.zzc().zzb(zzbhz.zzhQ)).intValue();
    private final zzdwm zze;
    private final boolean zzf = ((Boolean) zzay.zzc().zzb(zzbhz.zzhR)).booleanValue();

    TaggingLibraryJsInterface(WebView webView, zzaoc zzaoc, zzdwm zzdwm) {
        this.zzb = webView;
    ...
    public String getClickSignals(String str) {
        try {
            ...
            if (this.zzf) {
                ...
                zzf.zzc(this.zze, (zzdwc) null, "csg", new Pair("clat", String.valueOf(currentTimeMillis2)));
            }
            return zze2;
    ...
    public String getClickSignalsWithTimeout(String str, int i) {
        ...
        try {
            return (String) zzcfv.zza.zzb(new zzao(this, str)).get((long) min, TimeUnit.MILLISECONDS);
    ...
    public String getViewSignals() {
        try {
            ...
            if (this.zzf) {
                long currentTimeMillis2 = zzt.zzA().currentTimeMillis() - currentTimeMillis;
                zzf.zzc(this.zze, (zzdwc) null, "vsg", new Pair("vlat", String.valueOf(currentTimeMillis2)));
            }
            return zzh;
        } catch (RuntimeException e) {
    ...
    public String getViewSignalsWithTimeout(int i) {
        ...
        int min = Math.min(i, this.zzd);
        try {
            return (String) zzcfv.zza.zzb(new zzan(this)).get((long) min, TimeUnit.MILLISECONDS);
        } catch (InterruptedException | ExecutionException | TimeoutException e) {
