...
public final class zzf {
    ...
    public static void zzc(zzdwm zzdwm, zzdwc zzdwc, String str, Pair... pairArr) {
        if (((Boolean) zzay.zzc().zzb(zzbhz.zzfX)).booleanValue()) {
            zzcfv.zza.execute(new zze(zzdwm, zzdwc, str, pairArr));
        }
    }

    public static int zzd(zzfcd zzfcd) {
        if (zzfcd.zzq) {
            return 2;
        }
        zzl zzl = zzfcd.zzd;
