...
public final class zzdyn implements SensorEventListener {
    ...
    public final void onSensorChanged(SensorEvent sensorEvent) {
        if (((Boolean) zzay.zzc().zzb(zzbhz.zzhE)).booleanValue()) {
            ...
            if (this.zze + ((long) ((Integer) zzay.zzc().zzb(zzbhz.zzhG)).intValue()) < currentTimeMillis) {
                this.zzf = 0;
            ...
            this.zzd = valueOf;
            if (valueOf.floatValue() > this.zzc + ((Float) zzay.zzc().zzb(zzbhz.zzhF)).floatValue()) {
                this.zzc = this.zzd.floatValue();
                this.zzh = true;
            } else {
                if (this.zzd.floatValue() < this.zzc - ((Float) zzay.zzc().zzb(zzbhz.zzhF)).floatValue()) {
                    this.zzc = this.zzd.floatValue();
                    this.zzg = true;
                }
            }
            ...
            if (this.zzg && this.zzh) {
                ...
                this.zzg = false;
                this.zzh = false;
                zzdym zzdym = this.zzi;
                if (zzdym != null) {
                    if (i == ((Integer) zzay.zzc().zzb(zzbhz.zzhH)).intValue()) {
                        zzdzb zzdzb = (zzdzb) zzdym;
                        zzdzb.zzg(new zzdyz(zzdzb), zzdza.GESTURE);
                    }
                }
            }
        }
    ...
    public final void zzb() {
        /*
            r3 = this;
            monitor-enter(r3)
            com.google.android.gms.internal.ads.zzbhr r0 = com.google.android.gms.internal.ads.zzbhz.zzhE     // Catch:{ all -> 0x003e }
            com.google.android.gms.internal.ads.zzbhx r1 = com.google.android.gms.ads.internal.client.zzay.zzc()     // Catch:{ all -> 0x003e }
        ...
        L_0x003e:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzdyn.zzb():void");
    }

    public final void zzc(zzdym zzdym) {
        this.zzi = zzdym;
    }
}
