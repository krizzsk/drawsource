...
public final class zzetd implements zzetg {
    ...
    zzetd(zzfvm zzfvm, Context context) {
        this.zza = zzfvm;
        this.zzb = context;
    }
    ...
    public final zzfvl zzb() {
        return this.zza.zzb(new zzetb(this));
    }

    /* access modifiers changed from: package-private */
    public final /* synthetic */ zzetf zzd() throws Exception {
        String str = (String) zzay.zzc().zzb(zzbhz.zzfc);
        if (TextUtils.isEmpty(str)) {
            return null;
        }
        try {
            return new zzetc(zzc(this.zzb, new JSONArray(str)));
