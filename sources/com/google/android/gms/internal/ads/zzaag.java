...
public final class zzaag implements zzyr {
    ...
    private final int zze(com.google.android.gms.internal.ads.zzys r12) throws java.io.IOException {
        /*
            ...
            r4 = r12
            com.google.android.gms.internal.ads.zzyl r4 = (com.google.android.gms.internal.ads.zzyl) r4     // Catch:{ EOFException -> 0x0090 }
    ...
    private static boolean zzf(zzys zzys, byte[] bArr) throws IOException {
        zzys.zzj();
        int length = bArr.length;
        byte[] bArr2 = new byte[length];
        ((zzyl) zzys).zzm(bArr2, 0, length, false);
        return Arrays.equals(bArr2, bArr);
    }

    private final boolean zzg(zzys zzys) throws IOException {
        if (zzf(zzys, zzd)) {
            this.zzh = false;
            ((zzyl) zzys).zzo(zzd.length, false);
            return true;
        } else if (!zzf(zzys, zze)) {
            return false;
        } else {
            this.zzh = true;
            ((zzyl) zzys).zzo(zze.length, false);
            return true;
        }
    }
    ...
    public final int zza(zzys zzys, zzzr zzzr) throws IOException {
        ...
        if (zzys.zzf() != 0 || zzg(zzys)) {
            ...
            zzzt zzzt = new zzzt(-9223372036854775807L, 0);
            this.zzr = zzzt;
            this.zzp.zzL(zzzt);
            this.zzl = true;
            return zze2;
