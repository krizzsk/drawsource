...
public final class zzdpq {
    ...
    public zzdpq(zzbo zzbo, Clock clock, Executor executor) {
        this.zza = zzbo;
        this.zzb = clock;
        this.zzc = executor;
    }
    ...
    public final /* synthetic */ Bitmap zza(double d, boolean z, zzaix zzaix) {
        ...
        if (((Boolean) zzay.zzc().zzb(zzbhz.zzfd)).booleanValue()) {
            ...
            if (i > 0) {
                options.inSampleSize = 1 << ((33 - Integer.numberOfLeadingZeros((i - 1) / ((Integer) zzay.zzc().zzb(zzbhz.zzfe)).intValue())) / 2);
            }
        }
        return zzc(bArr, options);
    }

    public final zzfvl zzb(String str, double d, boolean z) {
        return zzfvc.zzm(this.zza.zza(str), new zzdpp(this, d, z), this.zzc);
    }
}
