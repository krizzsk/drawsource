...
final class zzazs extends HandlerThread implements SurfaceTexture.OnFrameAvailableListener, Handler.Callback {
    ...
    public final boolean handleMessage(Message message) {
        ...
        if (i == 1) {
            try {
                ...
                zzayz.zzf(EGL14.eglChooseConfig(eglGetDisplay, new int[]{12352, 4, 12324, 8, 12323, 8, 12322, 8, 12321, 8, 12325, 0, 12327, 12344, 12339, 4, 12344}, 0, eGLConfigArr, 0, 1, iArr2, 0) && iArr2[0] > 0 && eGLConfigArr2[0] != null, "eglChooseConfig failed");
                ...
                this.zzf = new zzazu(this, this.zzc, z, (zzazt) null);
                synchronized (this) {
                    notify();
                }
