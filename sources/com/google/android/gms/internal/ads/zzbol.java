...
public final class zzbol {
    ...
    public static zzbom zza(zzdjg zzdjg) {
        return new zzbnu(zzdjg);
    }

    public static zzfvl zzb(zzcli zzcli, String str) {
        ...
        return zzfvc.zzf(zzfvc.zzm(zzfvc.zzf(zzfut.zzv(zzcli.zzT()), Throwable.class, zzbnr.zza, zzcfv.zzf), new zzbns(zzb2), zzcfv.zzf), Throwable.class, new zzbnt(zzb2), zzcfv.zzf);
    }
    ...
    public static void zzd(Map map, zzdjg zzdjg) {
        if (((Boolean) zzay.zzc().zzb(zzbhz.zzii)).booleanValue() && map.containsKey("sc") && ((String) map.get("sc")).equals("1") && zzdjg != null) {
            zzdjg.zzq();
        }
    }
}
