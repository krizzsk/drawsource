...
public final class zzaae {
    ...
    public static zzaab zzc(zzdy zzdy, boolean z, boolean z2) throws zzbp {
        if (z) {
            zzd(3, zzdy, false);
        }
        String zzx = zzdy.zzx((int) zzdy.zzq(), zzfoi.zzc);
        long zzq = zzdy.zzq();
        String[] strArr = new String[((int) zzq)];
        int length = zzx.length() + 15;
        for (int i = 0; ((long) i) < zzq; i++) {
            String zzx2 = zzdy.zzx((int) zzdy.zzq(), zzfoi.zzc);
            strArr[i] = zzx2;
