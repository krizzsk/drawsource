...
final class zzaat extends zzaas {
    private final zzdy zzb = new zzdy(zzzo.zza);
    ...
    public zzaat(zzzy zzzy) {
        super(zzzy);
    }

    /* access modifiers changed from: protected */
    public final boolean zza(zzdy zzdy) throws zzaar {
        int zzk = zzdy.zzk();
        int i = zzk >> 4;
        int i2 = zzk & 15;
        if (i2 == 7) {
        ...
        throw new zzaar("Video format not supported: " + i2);
    }
    ...
    public final boolean zzb(zzdy zzdy, long j) throws zzbp {
        ...
        if (zzk == 0) {
            ...
            this.zza.zzs(zzf2, i, i3, 0, (zzzx) null);
            this.zzf = true;
            return true;
        }
        return false;
