    ...
    public zzcel(String str, long j) {
        ...
        if (!TextUtils.isEmpty(str)) {
            try {
                    ...
                    for (int i = 0; i < optJSONArray2.length(); i++) {
                        ...
                        if (!TextUtils.isEmpty(optString)) {
                            if (!TextUtils.isEmpty(optString2)) {
                                ...
                                } else if ((VideoType.REWARDED.equalsIgnoreCase(optString) || "rewarded_interstitial".equals(optString)) && (optJSONObject2 = jSONObject2.optJSONObject("mediation_config")) != null) {
                                    this.zzc.put(optString2, new zzbtv(optJSONObject2));
                                }
                            }
                        }
                    }
                ...
                if (((Boolean) zzay.zzc().zzb(zzbhz.zzfm)).booleanValue() && (optJSONObject = this.zzg.optJSONObject("common_settings")) != null) {
