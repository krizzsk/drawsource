...
public final /* synthetic */ class zzdov implements ViewTreeObserver.OnScrollChangedListener {
    ...
    public /* synthetic */ zzdov(View view, zzcli zzcli, String str, WindowManager.LayoutParams layoutParams, int i, WindowManager windowManager) {
        this.zza = view;
        this.zzb = zzcli;
        this.zzc = str;
