...
public abstract class zzase {
    ...
    public abstract zzasc zzd(int i, zzasc zzasc, boolean z);

    public abstract zzasd zze(int i, zzasd zzasd, boolean z, long j);
    ...
    public final zzasd zzg(int i, zzasd zzasd, boolean z) {
        return zze(i, zzasd, false, 0);
    }
