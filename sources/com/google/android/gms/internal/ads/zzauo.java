...
public final class zzauo implements zzatw {
    ...
    private final long zzn(long j) throws zzarw {
        ...
        if (j2 != -9223372036854775807L) {
            return zzazo.zzj(j, j2, 1000);
        }
        throw new zzarw("Can't scale timecode prior to timecodeScale being set.");
    }

    private final void zzo(zzaun zzaun, long j) {
        byte[] bArr;
        if ("S_TEXT/UTF8".equals(zzaun.zza)) {
            ...
            if (j2 == -9223372036854775807L) {
                ...
                bArr = zzazo.zzq(String.format(Locale.US, "%02d:%02d:%02d,%03d", new Object[]{Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3), Integer.valueOf((int) ((j4 - ((long) (i3 * 1000000))) / 1000))}));
            }
            System.arraycopy(bArr, 0, bArr2, 19, 12);
            zzauf zzauf = zzaun.zzN;
            zzazh zzazh = this.zzn;
            zzauf.zzb(zzazh, zzazh.zzd());
            this.zzY += this.zzn.zzd();
        }
        zzaun.zzN.zzc(j, this.zzP, this.zzY, 0, zzaun.zzg);
        this.zzZ = true;
        zzp();
    }
    ...
    private final int zzr(zzatv zzatv, zzauf zzauf, int i) throws IOException, InterruptedException {
        int i2;
        int zza2 = this.zzm.zza();
        if (zza2 > 0) {
            i2 = Math.min(i, zza2);
            zzauf.zzb(this.zzm, i2);
        } else {
            i2 = zzauf.zzd(zzatv, i, false);
        }
        this.zzQ += i2;
        this.zzY += i2;
        return i2;
    ...
    private final void zzs(zzatv zzatv, int i) throws IOException, InterruptedException {
        if (this.zzj.zzd() < i) {
            if (this.zzj.zzb() < i) {
                zzazh zzazh = this.zzj;
                byte[] bArr = zzazh.zza;
                int length = bArr.length;
                zzazh.zzt(Arrays.copyOf(bArr, Math.max(length + length, i)), this.zzj.zzd());
            }
            zzazh zzazh2 = this.zzj;
            zzatv.zzh(zzazh2.zza, zzazh2.zzd(), i - this.zzj.zzd(), false);
            this.zzj.zzu(i);
        }
    }

    private final void zzt(zzatv zzatv, zzaun zzaun, int i) throws IOException, InterruptedException {
        int i2;
        if ("S_TEXT/UTF8".equals(zzaun.zza)) {
            int i3 = i + 32;
            if (this.zzn.zzb() < i3) {
            ...
            zzatv.zzh(this.zzn.zza, 32, i, false);
            this.zzn.zzv(0);
            this.zzn.zzu(i3);
            return;
        }
        ...
        if (!this.zzR) {
            if (zzaun.zze) {
                ...
                int i4 = 128;
                if (!this.zzS) {
                    zzatv.zzh(this.zzj.zza, 0, 1, false);
                    this.zzQ++;
                ...
                if ((b2 & 1) == 1) {
                    ...
                    this.zzP |= 1073741824;
                    if (!this.zzT) {
                        zzatv.zzh(this.zzo.zza, 0, 8, false);
                        this.zzQ += 8;
                        this.zzT = true;
                        zzazh zzazh = this.zzj;
                        byte[] bArr = zzazh.zza;
                        ...
                        bArr[0] = (byte) (i4 | 8);
                        zzazh.zzv(0);
                        zzauf.zzb(this.zzj, 1);
                        this.zzY++;
                        this.zzo.zzv(0);
                        zzauf.zzb(this.zzo, 8);
                        this.zzY += 8;
                    }
                    if (b3 == 2) {
                        if (!this.zzU) {
                        ...
                        int i5 = this.zzW * 4;
                        this.zzj.zzs(i5);
                        zzatv.zzh(this.zzj.zza, 0, i5, false);
                        this.zzQ += i5;
                        int i6 = (this.zzW >> 1) + 1;
                        int i7 = (i6 * 6) + 2;
                        ...
                        zzauf.zzb(this.zzp, i7);
                        this.zzY += i7;
                    }
                }
            } else {
                byte[] bArr2 = zzaun.zzf;
                if (bArr2 != null) {
        ...
        if (!"V_MPEG4/ISO/AVC".equals(zzaun.zza) && !"V_MPEGH/ISO/HEVC".equals(zzaun.zza)) {
            while (true) {
                int i11 = this.zzQ;
                if (i11 >= zzd2) {
                    break;
                }
                zzr(zzatv, zzauf, zzd2 - i11);
            }
        } else {
            ...
            while (this.zzQ < zzd2) {
                ...
                if (i14 == 0) {
                    ...
                    zzatv.zzh(bArr3, i13 + min, i12 - min, false);
                    if (min > 0) {
                    ...
                    this.zzh.zzv(0);
                    zzauf.zzb(this.zzh, 4);
                    this.zzY += 4;
                } else {
                    this.zzX = i14 - zzr(zzatv, zzauf, i14);
                }
            }
        }
        if ("A_VORBIS".equals(zzaun.zza)) {
            this.zzk.zzv(0);
            zzauf.zzb(this.zzk, 4);
            this.zzY += 4;
        }
    }
    ...
    public zzauo(int i) {
        ...
        this.zzD = -9223372036854775807L;
        this.zzac = zzaui;
        zzaui.zzb(new zzaul(this, (zzauk) null));
        this.zzg = true;
        this.zze = new zzauq();
    ...
    public final void zzk(int r19, int r20, com.google.android.gms.internal.ads.zzatv r21) throws java.io.IOException, java.lang.InterruptedException {
        /*
            ...
            com.google.android.gms.internal.ads.zzaun r1 = r0.zzw
            byte[] r4 = new byte[r2]
            r1.zzo = r4
            byte[] r1 = r1.zzo
            r3.zzh(r1, r7, r2, r7)
            return
        L_0x0032:
            com.google.android.gms.internal.ads.zzarw r2 = new com.google.android.gms.internal.ads.zzarw
        ...
        L_0x0049:
            ...
            return
        L_0x0055:
            com.google.android.gms.internal.ads.zzazh r1 = r0.zzl
            byte[] r1 = r1.zza
        ...
        L_0x0074:
            byte[] r1 = new byte[r2]
            r3.zzh(r1, r7, r2, r7)
            com.google.android.gms.internal.ads.zzaun r2 = r0.zzw
            com.google.android.gms.internal.ads.zzaue r3 = new com.google.android.gms.internal.ads.zzaue
            r3.<init>(r6, r1)
            r2.zzg = r3
            return
        L_0x0083:
        ...
        L_0x008f:
            ...
            com.google.android.gms.internal.ads.zzauq r4 = r0.zze
            ...
            r0.zzJ = r9
            r0.zzH = r6
            com.google.android.gms.internal.ads.zzazh r4 = r0.zzj
            r4.zzr()
        L_0x00b4:
            android.util.SparseArray r4 = r0.zzf
            int r9 = r0.zzN
            java.lang.Object r4 = r4.get(r9)
            com.google.android.gms.internal.ads.zzaun r4 = (com.google.android.gms.internal.ads.zzaun) r4
        ...
        L_0x00ca:
            ...
            r9 = 3
            r0.zzs(r3, r9)
            com.google.android.gms.internal.ads.zzazh r10 = r0.zzj
            byte[] r10 = r10.zza
            r11 = 2
            byte r10 = r10[r11]
            r10 = r10 & 6
        ...
        L_0x00f3:
            ...
            r13 = 4
            r0.zzs(r3, r13)
            com.google.android.gms.internal.ads.zzazh r14 = r0.zzj
            byte[] r14 = r14.zza
            byte r14 = r14[r9]
            r14 = r14 & r12
            int r14 = r14 + r6
        ...
        L_0x0153:
            ...
            r0.zzs(r3, r13)
            int r14 = r13 + -1
            com.google.android.gms.internal.ads.zzazh r15 = r0.zzj
            byte[] r15 = r15.zza
            byte r15 = r15[r14]
        ...
        L_0x016d:
            ...
            int r16 = 7 - r15
            int r5 = r6 << r16
            com.google.android.gms.internal.ads.zzazh r11 = r0.zzj
            byte[] r11 = r11.zza
            byte r11 = r11[r14]
            r11 = r11 & r5
            ...
            r0.zzs(r3, r13)
            int r11 = r14 + 1
            com.google.android.gms.internal.ads.zzazh r6 = r0.zzj
            byte[] r6 = r6.zza
            byte r6 = r6[r14]
            r6 = r6 & r12
            int r5 = ~r5
        ...
        L_0x018c:
            ...
            int r14 = r11 + 1
            long r5 = r5 << r8
            com.google.android.gms.internal.ads.zzazh r8 = r0.zzj
            byte[] r8 = r8.zza
            byte r8 = r8[r11]
            r8 = r8 & r12
            r17 = r13
        ...
        L_0x01fa:
            ...
            r5[r14] = r2
        L_0x0203:
            com.google.android.gms.internal.ads.zzazh r2 = r0.zzj
            byte[] r2 = r2.zza
            byte r5 = r2[r7]
            r6 = 1
            byte r2 = r2[r6]
        ...
        if (i != 160) {
            if (i == 174) {
                ...
                if ("V_VP8".equals(str) || "V_VP9".equals(str) || "V_MPEG2".equals(str) || "V_MPEG4/ISO/SP".equals(str) || "V_MPEG4/ISO/ASP".equals(str) || "V_MPEG4/ISO/AP".equals(str) || "V_MPEG4/ISO/AVC".equals(str) || "V_MPEGH/ISO/HEVC".equals(str) || "V_MS/VFW/FOURCC".equals(str) || "V_THEORA".equals(str) || "A_OPUS".equals(str) || "A_VORBIS".equals(str) || "A_AAC".equals(str) || "A_MPEG/L2".equals(str) || "A_MPEG/L3".equals(str) || "A_AC3".equals(str) || "A_EAC3".equals(str) || "A_TRUEHD".equals(str) || "A_DTS".equals(str) || "A_DTS/EXPRESS".equals(str) || "A_DTS/LOSSLESS".equals(str) || "A_FLAC".equals(str) || "A_MS/ACM".equals(str) || "A_PCM/INT/LIT".equals(str) || "S_TEXT/UTF8".equals(str) || "S_VOBSUB".equals(str) || "S_HDMV/PGS".equals(str) || "S_DVBSUB".equals(str)) {
                    zzaun zzaun = this.zzw;
                    zzaun.zzb(this.zzab, zzaun.zzb);
                    SparseArray sparseArray = this.zzf;
                    zzaun zzaun2 = this.zzw;
                    sparseArray.put(zzaun2.zzb, zzaun2);
                }
                this.zzw = null;
            } else if (i == 19899) {
                int i4 = this.zzy;
                ...
                if (zzaun3.zzg != null) {
                    zzaun3.zzi = new zzats(new zzatr(zzare.zzb, "video/webm", this.zzw.zzg.zzb, false));
                    return;
                }
                throw new zzarw("Encrypted Track found but ContentEncKeyID was not found");
            } else if (i == 28032) {
                zzaun zzaun4 = this.zzw;
                if (zzaun4.zze && zzaun4.zzf != null) {
                ...
                if (i == 475249515 && !this.zzx) {
                    zzatx zzatx = this.zzab;
                    if (this.zzs == -1 || this.zzv == -9223372036854775807L || (zzazc = this.zzE) == null || zzazc.zza() == 0 || (zzazc2 = this.zzF) == null || zzazc2.zza() != zzazc.zza()) {
                        this.zzE = null;
                        this.zzF = null;
                        zzaud = new zzauc(this.zzv);
                    } else {
                        int zza2 = zzazc.zza();
                        ...
                        this.zzE = null;
                        this.zzF = null;
                        zzaud = new zzatu(iArr, jArr, jArr2, jArr3);
                    }
                    zzatx.zzc(zzaud);
                    this.zzx = true;
                }
