...
public final class zzesw implements zzetf {
    ...
    public final /* bridge */ /* synthetic */ void zzf(Object obj) {
        ...
        bundle.putString("extra_caps", (String) zzay.zzc().zzb(zzbhz.zzcL));
        bundle.putInt("target_api", this.zze);
        bundle.putInt("dv", this.zzf);
        bundle.putInt("lv", this.zzg);
        Bundle zza2 = zzfco.zza(bundle, "sdk_env");
        zza2.putBoolean("mf", ((Boolean) zzbjp.zza.zze()).booleanValue());
        ...
        Bundle zza3 = zzfco.zza(zza2, "build_meta");
        zza3.putString("cl", "458339781");
