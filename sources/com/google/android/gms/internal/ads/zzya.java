...
public final class zzya {
    ...
    private zzya(List list, int i, int i2, int i3, float f, String str) {
        this.zza = list;
        this.zzb = i;
        this.zzc = i2;
        this.zzd = i3;
    ...
    public static zzya zza(zzdy zzdy) throws zzbp {
        String str;
        float f;
        int i;
        int i2;
        try {
            ...
            if (zzk != 3) {
                ...
                if (zzk2 > 0) {
                    zzzn zzd2 = zzzo.zzd((byte[]) arrayList.get(0), zzk + 1, ((byte[]) arrayList.get(0)).length);
                    int i5 = zzd2.zze;
                    int i6 = zzd2.zzf;
                    float f2 = zzd2.zzg;
                ...
                return new zzya(arrayList, zzk, i2, i, f, str);
            }
