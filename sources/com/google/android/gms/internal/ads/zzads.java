...
final class zzads implements zzadq {
    ...
    private zzads(long j, int i, long j2, long j3, long[] jArr) {
        this.zza = j;
        this.zzb = i;
        this.zzc = j2;
        this.zzf = jArr;
    ...
    public static zzads zza(long j, long j2, zzzk zzzk, zzdy zzdy) {
        int zzn;
        long j3 = j;
        zzzk zzzk2 = zzzk;
        int i = zzzk2.zzg;
        ...
        if ((zze2 & 6) != 6) {
            return new zzads(j2, zzzk2.zzc, zzw, -1, (long[]) null);
        }
        long zzs = zzdy.zzs();
        ...
        return new zzads(j2, zzzk2.zzc, zzw, zzs, jArr);
    }
    ...
    public final zzzs zzg(long j) {
        double d;
        if (!zzh()) {
            zzzv zzzv = new zzzv(0, this.zza + ((long) this.zzb));
        ...
        zzzv zzzv2 = new zzzv(zzr, this.zza + zzeg.zzr(Math.round((d3 / 256.0d) * ((double) this.zzd)), (long) this.zzb, this.zzd - 1));
