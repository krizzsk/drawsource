...
public final class zzadg implements zzyr {
    ...
    private final int zzp(zzys zzys, zzadf zzadf, int i, boolean z) throws IOException {
        int i2;
        if ("S_TEXT/UTF8".equals(zzadf.zzb)) {
            zzx(zzys, zzb, i);
            int i3 = this.zzaa;
            zzw();
            return i3;
        } else if ("S_TEXT/ASS".equals(zzadf.zzb)) {
            zzx(zzys, zzd, i);
            int i4 = this.zzaa;
            zzw();
            return i4;
        } else if ("S_TEXT/WEBVTT".equals(zzadf.zzb)) {
            zzx(zzys, zze, i);
            int i5 = this.zzaa;
            zzw();
            return i5;
            ...
            if (!this.zzac) {
                if (zzadf.zzg) {
                    ...
                    int i6 = 128;
                    if (!this.zzad) {
                        ((zzyl) zzys).zzn(this.zzn.zzH(), 0, 1, false);
                        this.zzZ++;
                    ...
                    if ((b & 1) == 1) {
                        ...
                        this.zzV |= 1073741824;
                        if (!this.zzah) {
                            ((zzyl) zzys).zzn(this.zzs.zzH(), 0, 8, false);
                            this.zzZ += 8;
                            this.zzah = true;
                            ...
                            zzH2[0] = (byte) (i6 | 8);
                            this.zzn.zzF(0);
                            zzzy.zzr(this.zzn, 1, 1);
                            this.zzaa++;
                            this.zzs.zzF(0);
                            zzzy.zzr(this.zzs, 8, 1);
                            this.zzaa += 8;
                        }
                        if (b2 == 2) {
                            if (!this.zzae) {
                            ...
                            int i7 = this.zzaf * 4;
                            this.zzn.zzC(i7);
                            ((zzyl) zzys).zzn(this.zzn.zzH(), 0, i7, false);
                            this.zzZ += i7;
                ...
                if (!"A_OPUS".equals(zzadf.zzb) ? zzadf.zzf > 0 : z) {
                    this.zzV |= 268435456;
                    this.zzu.zzC(0);
                    ...
                    zzzy.zzr(this.zzn, 4, 2);
                    this.zzaa += 4;
                }
                this.zzac = true;
            }
            int zzd3 = i + this.zzq.zzd();
            if (!"V_MPEG4/ISO/AVC".equals(zzadf.zzb) && !"V_MPEGH/ISO/HEVC".equals(zzadf.zzb)) {
                if (zzadf.zzS != null) {
                    if (this.zzq.zzd() != 0) {
                        z2 = false;
                    }
                ...
                while (true) {
                    ...
                    int zzq2 = zzq(zzys, zzzy, zzd3 - i13);
                    this.zzZ += zzq2;
                    this.zzaa += zzq2;
                }
            } else {
                ...
                while (this.zzZ < zzd3) {
                    ...
                    if (i16 == 0) {
                        ...
                        ((zzyl) zzys).zzn(zzH3, i15 + min, i14 - min, false);
                        if (min > 0) {
                        ...
                        this.zzl.zzF(0);
                        zzzw.zzb(zzzy, this.zzl, 4);
                        this.zzaa += 4;
                    } else {
                        int zzq3 = zzq(zzys, zzzy, i16);
                        this.zzZ += zzq3;
                        this.zzaa += zzq3;
                        this.zzab -= zzq3;
                    }
            ...
            if ("A_VORBIS".equals(zzadf.zzb)) {
                this.zzo.zzF(0);
                zzzw.zzb(zzzy, this.zzo, 4);
                this.zzaa += 4;
            }
            int i17 = this.zzaa;
            zzw();
    ...
    private final int zzq(zzys zzys, zzzy zzzy, int i) throws IOException {
        int zza2 = this.zzq.zza();
        if (zza2 <= 0) {
            return zzzw.zza(zzzy, zzys, i, false);
        }
        int min = Math.min(i, zza2);
        zzzw.zzb(zzzy, this.zzq, min);
        return min;
    }
    ...
    private final void zzu(com.google.android.gms.internal.ads.zzadf r18, long r19, int r21, int r22, int r23) {
        /*
            ...
            r0 = r17
            r1 = r18
            com.google.android.gms.internal.ads.zzzz r2 = r1.zzS
            r9 = 1
            if (r2 == 0) goto L_0x001c
            com.google.android.gms.internal.ads.zzzy r3 = r1.zzV
            com.google.android.gms.internal.ads.zzzx r8 = r1.zzi
            r1 = r2
            r2 = r3
            r3 = r19
            r5 = r21
        ...
        L_0x00dd:
            ...
            goto L_0x00c5
        L_0x00e0:
            com.google.android.gms.internal.ads.zzzy r2 = r1.zzV
            com.google.android.gms.internal.ads.zzdy r3 = r0.zzr
            int r4 = r3.zzd()
            com.google.android.gms.internal.ads.zzzw.zzb(r2, r3, r4)
            com.google.android.gms.internal.ads.zzdy r2 = r0.zzr
            int r2 = r2.zzd()
            int r2 = r22 + r2
        L_0x00f3:
        ...
        L_0x0103:
            com.google.android.gms.internal.ads.zzdy r3 = r0.zzu
            int r3 = r3.zzd()
            com.google.android.gms.internal.ads.zzzy r4 = r1.zzV
            com.google.android.gms.internal.ads.zzdy r5 = r0.zzu
            r4.zzr(r5, r3, r7)
            int r2 = r2 + r3
        L_0x0111:
            r14 = r2
            com.google.android.gms.internal.ads.zzzy r10 = r1.zzV
            com.google.android.gms.internal.ads.zzzx r1 = r1.zzi
            r11 = r19
            r13 = r21
            r15 = r23
            r16 = r1
    ...
    private final void zzv(zzys zzys, int i) throws IOException {
        if (this.zzn.zzd() < i) {
            if (this.zzn.zzb() < i) {
                zzdy zzdy = this.zzn;
                int zzb2 = zzdy.zzb();
            ...
            ((zzyl) zzys).zzn(this.zzn.zzH(), this.zzn.zzd(), i - this.zzn.zzd(), false);
            this.zzn.zzE(i);
        }
    }
    ...
    private final void zzx(zzys zzys, byte[] bArr, int i) throws IOException {
        ...
        ((zzyl) zzys).zzn(this.zzr.zzH(), length, i, false);
        this.zzr.zzF(0);
        this.zzr.zzE(i2);
    }
        ...
        while (!this.zzM) {
            if (this.zzh.zzc(zzys)) {
                ...
                for (int i = 0; i < this.zzj.size(); i++) {
                    zzadf zzadf = (zzadf) this.zzj.valueAt(i);
                    zzadf.zzd(zzadf);
                    zzzz zzzz = zzadf.zzS;
                    if (zzzz != null) {
                        zzzz.zza(zzadf.zzV, zzadf.zzi);
                    }
                }
                return -1;
            }
    ...
    public final void zzc(long j, long j2) {
        ...
        zzw();
        for (int i = 0; i < this.zzj.size(); i++) {
            zzzz zzzz = ((zzadf) this.zzj.valueAt(i)).zzS;
            if (zzzz != null) {
                zzzz.zzb();
            }
        }
    ...
    public final void zzh(int r22) throws com.google.android.gms.internal.ads.zzbp {
        /*
            ...
            r7 = r21
            r0 = r22
            com.google.android.gms.internal.ads.zzyu r1 = r7.zzai
        ...
        L_0x003d:
            ...
            com.google.android.gms.internal.ads.zzyu r0 = r7.zzai
        ...
        L_0x00e2:
            ...
            goto L_0x00ef
        L_0x00e8:
            com.google.android.gms.internal.ads.zzzt r1 = new com.google.android.gms.internal.ads.zzzt
            long r2 = r7.zzA
            r1.<init>(r2, r5)
        L_0x00ef:
            r0.zzL(r1)
        ...
        L_0x0129:
            r21.zzt(r22)
            com.google.android.gms.internal.ads.zzadf r0 = r7.zzB
            boolean r1 = r0.zzg
        ...
        L_0x013f:
            ...
            boolean r1 = r0.zzg
            if (r1 == 0) goto L_0x0181
            com.google.android.gms.internal.ads.zzzx r1 = r0.zzi
            ...
            com.google.android.gms.internal.ads.zzadf r5 = r7.zzB
            com.google.android.gms.internal.ads.zzzx r5 = r5.zzi
            byte[] r5 = r5.zzb
        ...
        L_0x0339:
            ...
            r8 = r0
            com.google.android.gms.internal.ads.zzadf r8 = (com.google.android.gms.internal.ads.zzadf) r8
            com.google.android.gms.internal.ads.zzadf.zzd(r8)
            long r0 = r7.zzY
    ...
    public final void zzk(int i, long j, long j2) throws zzbp {
        ...
        if (i == 160) {
            ...
            if (!this.zzk || this.zzG == -1) {
                this.zzai.zzL(new zzzt(this.zzA, 0));
                this.zzC = true;
                return;
            }
            this.zzF = true;
    ...
    public zzadg(int i) {
        ...
        this.zzI = -9223372036854775807L;
        this.zzh = zzacz;
        zzacz.zza(new zzade(this, (zzadd) null));
        this.zzk = true;
        this.zzi = new zzadi();
    ...
    public final void zzg(int r19, int r20, com.google.android.gms.internal.ads.zzys r21) throws java.io.IOException {
        ...
        L_0x00d0:
            r0 = r8
            com.google.android.gms.internal.ads.zzyl r0 = (com.google.android.gms.internal.ads.zzyl) r0
            r0.zzo(r1, r10)
            return
        L_0x00d7:
            byte[] r2 = new byte[r1]
        ...
        L_0x011a:
            ...
            com.google.android.gms.internal.ads.zzadi r2 = r7.zzi
        ...
        L_0x013f:
            ...
            r12 = r2
            com.google.android.gms.internal.ads.zzadf r12 = (com.google.android.gms.internal.ads.zzadf) r12
            ...
            return
        L_0x0159:
            com.google.android.gms.internal.ads.zzadf.zzd(r12)
            int r2 = r7.zzN
