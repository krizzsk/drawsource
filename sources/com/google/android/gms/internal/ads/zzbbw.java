...
public final class zzbbw {
    ...
    public static void zzc(String[] strArr, int i, int i2, PriorityQueue priorityQueue) {
        ...
        while (true) {
            ...
            if (i3 < length2 - 5) {
                zze = ((((((zze + 1073807359) - ((((((long) zzbbs.zza(strArr2[i3 - 1])) + 2147483647L) % 1073807359) * zza) % 1073807359)) % 1073807359) * 16785407) % 1073807359) + ((((long) zzbbs.zza(strArr2[i3 + 5])) + 2147483647L) % 1073807359)) % 1073807359;
