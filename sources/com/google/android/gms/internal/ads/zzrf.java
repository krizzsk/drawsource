...
public final class zzrf implements zzry, zzrx {
    ...
    public zzrf(zzry zzry, boolean z, long j, long j2) {
        this.zza = zzry;
        this.zzb = j2;
    }
    ...
    public final long zza(long j, zzjw zzjw) {
        ...
        long zzr = zzeg.zzr(zzjw.zzf, 0, j);
        long j2 = zzjw.zzg;
        long j3 = this.zzb;
        long zzr2 = zzeg.zzr(j2, 0, j3 == Long.MIN_VALUE ? Long.MAX_VALUE : j3 - j);
        if (!(zzr == zzjw.zzf && zzr2 == zzjw.zzg)) {
            zzjw = new zzjw(zzr, zzr2);
        }
        return this.zza.zza(j, zzjw);
    }
