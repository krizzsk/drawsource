...
public final class zzghp {
    ...
    public final com.google.android.gms.internal.ads.zzgho zza(java.lang.String r17, byte[] r18, byte[] r19, int r20, int r21) throws java.security.GeneralSecurityException {
        /*
            r16 = this;
            r1 = r16
            r0 = r17
            ...
            java.security.KeyPair r4 = com.google.android.gms.internal.ads.zzghq.zzb(r4)
            ...
            java.security.spec.ECParameterSpec r7 = r6.getParams()     // Catch:{ IllegalArgumentException -> 0x034c, NullPointerException -> 0x034a }
            java.security.spec.ECParameterSpec r8 = r4.getParams()     // Catch:{ IllegalArgumentException -> 0x034c, NullPointerException -> 0x034a }
            java.security.spec.EllipticCurve r9 = r7.getCurve()     // Catch:{ IllegalArgumentException -> 0x034c, NullPointerException -> 0x034a }
            java.security.spec.EllipticCurve r10 = r8.getCurve()     // Catch:{ IllegalArgumentException -> 0x034c, NullPointerException -> 0x034a }
            boolean r9 = r9.equals(r10)     // Catch:{ IllegalArgumentException -> 0x034c, NullPointerException -> 0x034a }
            if (r9 == 0) goto L_0x0342
            java.security.spec.ECPoint r9 = r7.getGenerator()     // Catch:{ IllegalArgumentException -> 0x034c, NullPointerException -> 0x034a }
            java.security.spec.ECPoint r10 = r8.getGenerator()     // Catch:{ IllegalArgumentException -> 0x034c, NullPointerException -> 0x034a }
            boolean r9 = r9.equals(r10)     // Catch:{ IllegalArgumentException -> 0x034c, NullPointerException -> 0x034a }
            if (r9 == 0) goto L_0x0342
            java.math.BigInteger r9 = r7.getOrder()     // Catch:{ IllegalArgumentException -> 0x034c, NullPointerException -> 0x034a }
            java.math.BigInteger r10 = r8.getOrder()     // Catch:{ IllegalArgumentException -> 0x034c, NullPointerException -> 0x034a }
            boolean r9 = r9.equals(r10)     // Catch:{ IllegalArgumentException -> 0x034c, NullPointerException -> 0x034a }
            if (r9 == 0) goto L_0x0342
            int r7 = r7.getCofactor()     // Catch:{ IllegalArgumentException -> 0x034c, NullPointerException -> 0x034a }
            int r8 = r8.getCofactor()     // Catch:{ IllegalArgumentException -> 0x034c, NullPointerException -> 0x034a }
            ...
            com.google.android.gms.internal.ads.zzghq.zzc(r6, r7)
            java.security.spec.ECParameterSpec r7 = r4.getParams()
            java.security.spec.ECPublicKeySpec r8 = new java.security.spec.ECPublicKeySpec
            r8.<init>(r6, r7)
            com.google.android.gms.internal.ads.zzghs r6 = com.google.android.gms.internal.ads.zzghs.zzg
            ...
            com.google.android.gms.internal.ads.zzghs r7 = com.google.android.gms.internal.ads.zzghs.zze
            ...
            java.math.BigInteger r9 = com.google.android.gms.internal.ads.zzghq.zza(r4)     // Catch:{ IllegalStateException -> 0x033b }
        ...
        L_0x020c:
            ...
            com.google.android.gms.internal.ads.zzghq.zzc(r5, r4)
            java.math.BigInteger r4 = com.google.android.gms.internal.ads.zzghq.zza(r4)
        ...
        L_0x02b2:
            ...
            r4[r11] = r9
            r4[r8] = r6
            byte[] r4 = com.google.android.gms.internal.ads.zzghh.zzc(r4)
            com.google.android.gms.internal.ads.zzghs r5 = com.google.android.gms.internal.ads.zzghs.zzb
        ...
        L_0x0318:
            ...
            com.google.android.gms.internal.ads.zzgho r0 = new com.google.android.gms.internal.ads.zzgho
            r0.<init>(r9, r4)
            return r0
        L_0x0323:
        ...
        L_0x033b:
            ...
            throw r2
        L_0x0342:
            java.security.GeneralSecurityException r0 = new java.security.GeneralSecurityException     // Catch:{ IllegalArgumentException -> 0x034c, NullPointerException -> 0x034a }
            java.lang.String r2 = "invalid public key spec"
            r0.<init>(r2)     // Catch:{ IllegalArgumentException -> 0x034c, NullPointerException -> 0x034a }
            throw r0     // Catch:{ IllegalArgumentException -> 0x034c, NullPointerException -> 0x034a }
        L_0x034a:
            r0 = move-exception
            goto L_0x034d
        L_0x034c:
        ...
        L_0x034d:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzghp.zza(java.lang.String, byte[], byte[], int, int):com.google.android.gms.internal.ads.zzgho");
    }
}
