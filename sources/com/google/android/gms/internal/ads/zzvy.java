...
public final class zzvy implements zzvu, zzfs {
    ...
    public static final zzfrj zze = zzfrj.zzs(7500000L, 5200000L, 3700000L, Long.valueOf(TapjoyConstants.SESSION_ID_INACTIVITY_TIME), 1100000L);
    ...
    public final synchronized void zzk(int r9) {
        ...
        L_0x0031:
            ...
            com.google.android.gms.internal.ads.zzwo r9 = r8.zzj     // Catch:{ all -> 0x004d }
    ...
    private static boolean zzl(zzev zzev, boolean z) {
        return z && !zzev.zzb(8);
    }
    ...
    public final synchronized void zza(zzeq zzeq, zzev zzev, boolean z, int i) {
        if (zzl(zzev, z)) {
            this.zzo += (long) i;
        }
    }

    public final synchronized void zzb(zzeq zzeq, zzev zzev, boolean z) {
        if (zzl(zzev, z)) {
            zzcw.zzf(this.zzm > 0);
    ...
    public final synchronized void zzd(zzeq zzeq, zzev zzev, boolean z) {
        if (zzl(zzev, z)) {
            if (this.zzm == 0) {
    ...
    public final void zzf(zzvt zzvt) {
        this.zzi.zzc(zzvt);
    }
    ...
    public static synchronized zzvy zzg(Context context) {
        ...
        synchronized (zzvy.class) {
            if (zzg == null) {
                ...
                zzg = new zzvy(context2, hashMap, 2000, zzcx.zza, true, (zzvx) null);
            }
            zzvy = zzg;
        }
        return zzvy;
    ...
    public final void zze(Handler handler, zzvt zzvt) {
        if (zzvt != null) {
            this.zzi.zza(handler, zzvt);
            return;
        }
        throw null;
    }

    /* synthetic */ zzvy(Context context, Map map, int i, zzcx zzcx, boolean z, zzvx zzvx) {
