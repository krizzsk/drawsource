...
interface zzgml {
    ...
    @Deprecated
    void zzC(List list, zzgmt zzgmt, zzgkc zzgkc) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzgmt zzgmt, zzgkc zzgkc) throws IOException;
    ...
    zzgji zzp() throws IOException;

    @Deprecated
    Object zzr(zzgmt zzgmt, zzgkc zzgkc) throws IOException;

    Object zzs(zzgmt zzgmt, zzgkc zzgkc) throws IOException;
