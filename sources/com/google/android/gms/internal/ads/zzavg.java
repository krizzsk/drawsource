...
final class zzavg {
    ...
    public static com.google.android.gms.internal.ads.zzawd zza(com.google.android.gms.internal.ads.zzazh r13) {
        ...
        L_0x0033:
            ...
            com.google.android.gms.internal.ads.zzawm r2 = new com.google.android.gms.internal.ads.zzawm     // Catch:{ all -> 0x01d2 }
        ...
        L_0x0045:
            ...
            com.google.android.gms.internal.ads.zzawm r1 = zzd(r1, r2, r13)     // Catch:{ all -> 0x01d2 }
            r13.zzv(r0)
            return r1
        L_0x0053:
        ...
        L_0x0061:
            ...
            com.google.android.gms.internal.ads.zzawk r1 = zzc(r1, r2, r13, r4, r8)     // Catch:{ all -> 0x01d2 }
            r13.zzv(r0)
            return r1
        L_0x0071:
            ...
            com.google.android.gms.internal.ads.zzawk r1 = zzc(r1, r2, r13, r4, r4)     // Catch:{ all -> 0x01d2 }
            r13.zzv(r0)
            return r1
        L_0x007f:
            ...
            int r3 = com.google.android.gms.internal.ads.zzaut.zzaH     // Catch:{ all -> 0x01d2 }
            if (r2 != r3) goto L_0x00d1
            int r2 = r13.zze()     // Catch:{ all -> 0x01d2 }
            int r2 = com.google.android.gms.internal.ads.zzaut.zze(r2)     // Catch:{ all -> 0x01d2 }
            r3 = 13
            r4 = 14
        ...
        L_0x00bf:
            ...
            com.google.android.gms.internal.ads.zzawg r1 = new com.google.android.gms.internal.ads.zzawg     // Catch:{ all -> 0x01d2 }
            r4 = 3
        ...
        L_0x00da:
            ...
            com.google.android.gms.internal.ads.zzawm r1 = zze(r1, r2, r13)     // Catch:{ all -> 0x01d2 }
            r13.zzv(r0)
            return r1
        L_0x00e8:
        ...
        L_0x012e:
            ...
            com.google.android.gms.internal.ads.zzawk r1 = zzc(r1, r2, r13, r8, r8)     // Catch:{ all -> 0x01d2 }
            r13.zzv(r0)
            return r1
        L_0x013c:
            ...
            com.google.android.gms.internal.ads.zzawk r1 = zzc(r1, r2, r13, r8, r4)     // Catch:{ all -> 0x01d2 }
            r13.zzv(r0)
            return r1
        L_0x014a:
        ...
        L_0x016e:
            ...
            r13.zzw(r9)     // Catch:{ all -> 0x01d2 }
            int r12 = com.google.android.gms.internal.ads.zzaut.zzaF     // Catch:{ all -> 0x01d2 }
            if (r11 != r12) goto L_0x018e
            int r10 = r10 + -12
            java.lang.String r1 = r13.zzo(r10)     // Catch:{ all -> 0x01d2 }
            goto L_0x016e
        L_0x018e:
            int r12 = com.google.android.gms.internal.ads.zzaut.zzaG     // Catch:{ all -> 0x01d2 }
            if (r11 != r12) goto L_0x0199
            int r10 = r10 + -12
            java.lang.String r2 = r13.zzo(r10)     // Catch:{ all -> 0x01d2 }
            goto L_0x016e
        L_0x0199:
            int r12 = com.google.android.gms.internal.ads.zzaut.zzaH     // Catch:{ all -> 0x01d2 }
        ...
        L_0x01bb:
            ...
            com.google.android.gms.internal.ads.zzawi r6 = new com.google.android.gms.internal.ads.zzawi     // Catch:{ all -> 0x01d2 }
        ...
        L_0x01d5:
            ...
            int r7 = com.google.android.gms.internal.ads.zzaut.zzaH     // Catch:{ all -> 0x01d2 }
            ...
            goto L_0x0207
        L_0x01fa:
            java.lang.String r1 = com.google.android.gms.internal.ads.zzaut.zzg(r1)     // Catch:{ all -> 0x01d2 }
        ...
        L_0x0265:
            ...
            com.google.android.gms.internal.ads.zzawm r1 = zze(r1, r4, r13)     // Catch:{ all -> 0x01d2 }
            r13.zzv(r0)
            return r1
        L_0x0271:
    ...
    private static int zzb(zzazh zzazh) {
        zzazh.zzw(4);
        if (zzazh.zze() == zzaut.zzaH) {
            zzazh.zzw(8);
            return zzazh.zzg();
        }
    ...
    private static zzawk zzc(int i, String str, zzazh zzazh, boolean z, boolean z2) {
        int zzb2 = zzb(zzazh);
        if (z2) {
            zzb2 = Math.min(1, zzb2);
        }
        if (zzb2 < 0) {
            Log.w("MetadataUtil", "Failed to parse uint8 attribute: ".concat(zzaut.zzg(i)));
            return null;
        } else if (z) {
            return new zzawm(str, (String) null, Integer.toString(zzb2));
        } else {
            return new zzawi("und", str, Integer.toString(zzb2));
        }
    }

    private static zzawm zzd(int i, String str, zzazh zzazh) {
        int zze2 = zzazh.zze();
        if (zzazh.zze() == zzaut.zzaH && zze2 >= 22) {
            zzazh.zzw(10);
            int zzj2 = zzazh.zzj();
            if (zzj2 > 0) {
                ...
                return new zzawm(str, (String) null, sb2);
            }
        }
        Log.w("MetadataUtil", "Failed to parse index/count attribute: ".concat(zzaut.zzg(i)));
        return null;
    }

    private static zzawm zze(int i, String str, zzazh zzazh) {
        int zze2 = zzazh.zze();
        if (zzazh.zze() == zzaut.zzaH) {
            zzazh.zzw(8);
            return new zzawm(str, (String) null, zzazh.zzo(zze2 - 16));
        }
        Log.w("MetadataUtil", "Failed to parse text attribute: ".concat(zzaut.zzg(i)));
        return null;
    }
}
