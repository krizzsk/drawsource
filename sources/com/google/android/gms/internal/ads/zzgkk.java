...
abstract class zzgkk {
    ...
    static zzgkc zzb(Class cls) {
        String str;
        Class<zzgkk> cls2 = zzgkk.class;
        ...
        try {
            return (zzgkc) cls.cast(((zzgkk) Class.forName(str, true, classLoader).getConstructor(new Class[0]).newInstance(new Object[0])).zza());
            ...
            try {
                return (zzgkc) cls.getMethod("combine", new Class[]{Collection.class}).invoke((Object) null, new Object[]{arrayList});
