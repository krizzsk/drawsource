...
final class zzadl implements zzadq {
    ...
    public static zzadl zza(long j, zzacf zzacf, long j2) {
        int length = zzacf.zzd.length;
        int i = length + 1;
        ...
        for (int i2 = 1; i2 <= length; i2++) {
            int i3 = i2 - 1;
            j += (long) (zzacf.zzb + zzacf.zzd[i3]);
            j3 += (long) (zzacf.zzc + zzacf.zze[i3]);
            jArr[i2] = j;
            jArr2[i2] = j3;
        }
    ...
    public final zzzs zzg(long j) {
        ...
        zzzv zzzv = new zzzv(zzeg.zzv(longValue), ((Long) zzd.second).longValue());
