...
public final class zzze {
    ...
    private zzze(int i, int i2, int i3, int i4, int i5, int i6, int i7, long j, zzzd zzzd, zzbl zzbl) {
        this.zza = i;
        this.zzb = i2;
        this.zzc = i3;
        this.zzd = i4;
    ...
    public final zzze zzf(zzzd zzzd) {
        return new zzze(this.zza, this.zzb, this.zzc, this.zzd, this.zze, this.zzg, this.zzh, this.zzj, zzzd, this.zzl);
    }
