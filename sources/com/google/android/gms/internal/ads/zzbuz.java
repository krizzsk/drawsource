...
public final class zzbuz extends zzbuc {
    ...
    public final void zzA(zzl zzl, String str, String str2) throws RemoteException {
        ...
        if (obj instanceof Adapter) {
            zzz(this.zzd, zzl, str, new zzbvc((Adapter) obj, this.zzc));
            return;
        }
    ...
    public final void zzB(IObjectWrapper iObjectWrapper, zzl zzl, String str, zzbug zzbug) throws RemoteException {
        ...
        if (this.zza instanceof Adapter) {
            ...
            try {
                zzbuy zzbuy = new zzbuy(this, zzbug);
                ...
                ((Adapter) this.zza).loadRewardedInterstitialAd(mediationRewardedAdConfiguration, zzbuy);
            } catch (Exception e) {
                zzcfi.zzh("", e);
                throw new RemoteException();
            }
    ...
    public final zzblv zzi() {
        zzbvb zzbvb = this.zzb;
        if (zzbvb == null) {
            return null;
        }
        NativeCustomTemplateAd zza2 = zzbvb.zza();
        if (zza2 instanceof zzblw) {
            return ((zzblw) zza2).zza();
        }
        return null;
    }
    ...
    public final zzbup zzk() {
        ...
        if (obj instanceof MediationNativeAdapter) {
            zzbvb zzbvb = this.zzb;
            if (zzbvb == null || (zzb2 = zzbvb.zzb()) == null) {
                return null;
            }
            return new zzbve(zzb2);
    ...
    public final void zzp(IObjectWrapper iObjectWrapper, zzl zzl, String str, zzcaw zzcaw, String str2) throws RemoteException {
        ...
        if (obj instanceof Adapter) {
            ...
            this.zzc = zzcaw;
            zzcaw.zzl(ObjectWrapper.wrap(obj));
            return;
        }
        String canonicalName = Adapter.class.getCanonicalName();
        String canonicalName2 = this.zza.getClass().getCanonicalName();
    ...
    public final void zzq(com.google.android.gms.dynamic.IObjectWrapper r9, com.google.android.gms.internal.ads.zzbqk r10, java.util.List r11) throws android.os.RemoteException {
        /*
            r8 = this;
        ...
        L_0x0014:
            ...
            com.google.android.gms.internal.ads.zzbqq r1 = (com.google.android.gms.internal.ads.zzbqq) r1
        ...
        L_0x0096:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzbuz.zzq(com.google.android.gms.dynamic.IObjectWrapper, com.google.android.gms.internal.ads.zzbqk, java.util.List):void");
    }
    ...
    public final void zzt(IObjectWrapper iObjectWrapper, zzq zzq, zzl zzl, String str, zzbug zzbug) throws RemoteException {
        zzu(iObjectWrapper, zzq, zzl, str, (String) null, zzbug);
    }
        ...
        if ((obj instanceof MediationBannerAdapter) || (obj instanceof Adapter)) {
            ...
            if (obj2 instanceof MediationBannerAdapter) {
                try {
                    ...
                    zzbus zzbus = new zzbus(date, zzl2.zzd, hashSet, zzl2.zzk, zzT(zzl), zzl2.zzg, zzl2.zzr, zzl2.zzt, zzU(str3, zzl2));
                    Bundle bundle = zzl2.zzm;
                    mediationBannerAdapter.requestBannerAd((Context) ObjectWrapper.unwrap(iObjectWrapper), new zzbvb(zzbug2), zzS(str3, zzl2, str4), adSize2, zzbus, bundle != null ? bundle.getBundle(mediationBannerAdapter.getClass().getName()) : null);
                } catch (Throwable th) {
                    zzcfi.zzh("", th);
                    throw new RemoteException();
                }
                ...
                try {
                    zzbuv zzbuv = new zzbuv(this, zzbug2);
                    ...
                    ((Adapter) obj2).loadBannerAd(mediationBannerAdConfiguration, zzbuv);
                } catch (Throwable th2) {
                    zzcfi.zzh("", th2);
                    throw new RemoteException();
                }
    ...
    public final void zzv(IObjectWrapper iObjectWrapper, zzq zzq, zzl zzl, String str, String str2, zzbug zzbug) throws RemoteException {
        ...
        if (this.zza instanceof Adapter) {
            ...
            try {
                ...
                zzbut zzbut = new zzbut(this, zzbug, adapter);
                ...
                adapter.loadInterscrollerAd(mediationBannerAdConfiguration, zzbut);
            } catch (Exception e) {
                zzcfi.zzh("", e);
                throw new RemoteException();
            }
    ...
    public final void zzw(IObjectWrapper iObjectWrapper, zzl zzl, String str, zzbug zzbug) throws RemoteException {
        zzx(iObjectWrapper, zzl, str, (String) null, zzbug);
    }
        ...
        if ((obj instanceof MediationInterstitialAdapter) || (obj instanceof Adapter)) {
            ...
            if (obj2 instanceof MediationInterstitialAdapter) {
                try {
                    ...
                    zzbus zzbus = new zzbus(date, zzl2.zzd, hashSet, zzl2.zzk, zzT(zzl), zzl2.zzg, zzl2.zzr, zzl2.zzt, zzU(str3, zzl2));
                    Bundle bundle = zzl2.zzm;
                    mediationInterstitialAdapter.requestInterstitialAd((Context) ObjectWrapper.unwrap(iObjectWrapper), new zzbvb(zzbug2), zzS(str3, zzl2, str4), zzbus, bundle != null ? bundle.getBundle(mediationInterstitialAdapter.getClass().getName()) : null);
                } catch (Throwable th) {
                    zzcfi.zzh("", th);
                    throw new RemoteException();
                }
                ...
                try {
                    ((Adapter) obj2).loadInterstitialAd(new MediationInterstitialAdConfiguration((Context) ObjectWrapper.unwrap(iObjectWrapper), "", zzS(str3, zzl2, str4), zzR(zzl2), zzT(zzl), zzl2.zzk, zzl2.zzg, zzl2.zzt, zzU(str3, zzl2), this.zzj), new zzbuw(this, zzbug2));
                } catch (Throwable th2) {
                    zzcfi.zzh("", th2);
                    throw new RemoteException();
                }
        ...
        if ((obj instanceof MediationNativeAdapter) || (obj instanceof Adapter)) {
            ...
            if (obj2 instanceof MediationNativeAdapter) {
                try {
                    ...
                    zzbvd zzbvd = new zzbvd(date, zzl2.zzd, hashSet, zzl2.zzk, zzT(zzl), zzl2.zzg, zzbkp, list, zzl2.zzr, zzl2.zzt, zzU(str3, zzl2));
                    Bundle bundle = zzl2.zzm;
                    Bundle bundle2 = bundle != null ? bundle.getBundle(mediationNativeAdapter.getClass().getName()) : null;
                    this.zzb = new zzbvb(zzbug2);
                    mediationNativeAdapter.requestNativeAd((Context) ObjectWrapper.unwrap(iObjectWrapper), this.zzb, zzS(str3, zzl2, str4), zzbvd, bundle2);
                } catch (Throwable th) {
                    zzcfi.zzh("", th);
                    throw new RemoteException();
                }
                ...
                try {
                    ((Adapter) obj2).loadNativeAd(new MediationNativeAdConfiguration((Context) ObjectWrapper.unwrap(iObjectWrapper), "", zzS(str3, zzl2, str4), zzR(zzl2), zzT(zzl), zzl2.zzk, zzl2.zzg, zzl2.zzt, zzU(str3, zzl2), this.zzj, zzbkp), new zzbux(this, zzbug2));
                } catch (Throwable th2) {
                    zzcfi.zzh("", th2);
                    throw new RemoteException();
                }
    ...
    public final void zzz(IObjectWrapper iObjectWrapper, zzl zzl, String str, zzbug zzbug) throws RemoteException {
        ...
        if (this.zza instanceof Adapter) {
            ...
            try {
                ...
                MediationRewardedAdConfiguration mediationRewardedAdConfiguration = r5;
                MediationRewardedAdConfiguration mediationRewardedAdConfiguration2 = new MediationRewardedAdConfiguration((Context) ObjectWrapper.unwrap(iObjectWrapper), "", zzS, zzR, zzT, location, i, i2, zzU, "");
                ((Adapter) this.zza).loadRewardedAd(mediationRewardedAdConfiguration, zzbuy);
            } catch (Exception e) {
                zzcfi.zzh("", e);
                throw new RemoteException();
            }
