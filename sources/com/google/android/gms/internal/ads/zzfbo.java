    ...
    zzfbo(JsonReader jsonReader) throws IllegalStateException, IOException, JSONException, NumberFormatException {
        ...
        while (jsonReader.hasNext()) {
            ...
            if ("nofill_urls".equals(nextName)) {
                ...
                if (((Boolean) zzay.zzc().zzb(zzbhz.zzgW)).booleanValue() && "public_error".equals(nextName) && jsonReader.peek() == JsonToken.BEGIN_OBJECT) {
                    zzfbn = new zzfbn(jsonReader);
                } else if ("bidding_data".equals(nextName)) {
                    str = jsonReader.nextString();
                } else if ("response_info_extras".equals(nextName)) {
                    if (((Boolean) zzay.zzc().zzb(zzbhz.zzfN)).booleanValue()) {
                        try {
