...
final class zzgnz {
    ...
    static String zzg(ByteBuffer byteBuffer, int i, int i2) throws zzglc {
        zzgnw zzgnw = zza;
        if (byteBuffer.hasArray()) {
            return zzgnw.zzb(byteBuffer.array(), byteBuffer.arrayOffset() + i, i2);
        } else if (byteBuffer.isDirect()) {
            return zzgnx.zzd(byteBuffer, i, i2);
        } else {
            return zzgnw.zzd(byteBuffer, i, i2);
        }
    }

    static String zzh(byte[] bArr, int i, int i2) throws zzglc {
