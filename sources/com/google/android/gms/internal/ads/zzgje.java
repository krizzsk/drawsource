...
class zzgje extends zzgjd {
    ...
    public final boolean equals(Object obj) {
        ...
        zzgje zzgje = (zzgje) obj;
        int zzr = zzr();
        int zzr2 = zzgje.zzr();
        if (zzr == 0 || zzr2 == 0 || zzr == zzr2) {
            return zzg(zzgje, 0, zzd());
        }
        return false;
    }
    ...
    /* access modifiers changed from: package-private */
    public final boolean zzg(zzgji zzgji, int i, int i2) {
        if (i2 <= zzgji.zzd()) {
            int i3 = i + i2;
            if (i3 > zzgji.zzd()) {
                int zzd = zzgji.zzd();
                throw new IllegalArgumentException("Ran off end of other: " + i + ", " + i2 + ", " + zzd);
            } else if (!(zzgji instanceof zzgje)) {
                return zzgji.zzk(i, i3).equals(zzk(0, i2));
            } else {
                zzgje zzgje = (zzgje) zzgji;
                byte[] bArr = this.zza;
                byte[] bArr2 = zzgje.zza;
                int zzc = zzc() + i2;
                int zzc2 = zzc();
                int zzc3 = zzgje.zzc() + i;
                while (zzc2 < zzc) {
    ...
    public final zzgji zzk(int i, int i2) {
        ...
        return new zzgjb(this.zza, zzc() + i, zzq);
    }
