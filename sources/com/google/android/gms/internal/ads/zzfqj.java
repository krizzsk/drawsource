...
class zzfqj extends AbstractCollection {
    final Collection zza;
    final zzfov zzb;

    zzfqj(Collection collection, zzfov zzfov) {
        this.zza = collection;
        this.zzb = zzfov;
    }
