...
public final class zztp implements zzzy {
    ...
    protected zztp(zzvv zzvv, zzpi zzpi, zzpc zzpc, byte[] bArr) {
        this.zzd = zzpi;
        this.zze = zzpc;
        this.zza = new zztj(zzvv, (byte[]) null);
    }
    ...
    private final synchronized int zzB(com.google.android.gms.internal.ads.zziz r6, com.google.android.gms.internal.ads.zzgb r7, boolean r8, boolean r9, com.google.android.gms.internal.ads.zztl r10) {
        /*
            r5 = this;
            monitor-enter(r5)
            r0 = 0
        ...
        L_0x0025:
            ...
            return r3
        L_0x002b:
            com.google.android.gms.internal.ads.zztw r9 = r5.zzc     // Catch:{ all -> 0x0083 }
            int r0 = r5.zzp     // Catch:{ all -> 0x0083 }
            int r4 = r5.zzr     // Catch:{ all -> 0x0083 }
            int r0 = r0 + r4
            java.lang.Object r9 = r9.zza(r0)     // Catch:{ all -> 0x0083 }
            com.google.android.gms.internal.ads.zztn r9 = (com.google.android.gms.internal.ads.zztn) r9     // Catch:{ all -> 0x0083 }
        ...
        L_0x006a:
            ...
            com.google.android.gms.internal.ads.zzzx[] r7 = r5.zzn     // Catch:{ all -> 0x0083 }
        ...
        L_0x0083:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zztp.zzB(com.google.android.gms.internal.ads.zziz, com.google.android.gms.internal.ads.zzgb, boolean, boolean, com.google.android.gms.internal.ads.zztl):int");
    }
    ...
    private final synchronized long zzC(long r10, boolean r12, boolean r13) {
        ...
        L_0x002f:
            ...
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zztp.zzC(long, boolean, boolean):long");
    }
    ...
    private final synchronized void zzF(long j, int i, long j2, int i2, zzzx zzzx) {
        int i3 = this.zzo;
        if (i3 > 0) {
            int zzA2 = zzA(i3 - 1);
        ...
        if (this.zzc.zzf() || !((zztn) this.zzc.zzb()).zza.equals(this.zzz)) {
            ...
            zzad zzad = this.zzz;
            if (zzad != null) {
                zztw.zzc(i4, new zztn(zzad, zzph, (zztm) null));
            } else {
                throw null;
            }
        }
        ...
        if (i5 == i6) {
            ...
            System.arraycopy(this.zzn, this.zzq, zzzxArr, 0, i9);
            ...
            System.arraycopy(this.zzn, 0, zzzxArr, i9, i10);
    ...
    private final synchronized boolean zzL(zzad zzad) {
        ...
        if (this.zzc.zzf() || !((zztn) this.zzc.zzb()).zza.equals(zzad)) {
            this.zzz = zzad;
        } else {
    ...
    static /* synthetic */ void zzl(zztn zztn) {
        zzph zzph = zztn.zzb;
        int i = zzpg.zza;
    }
    ...
    public final synchronized int zzb(long r9, boolean r11) {
        ...
        L_0x0038:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zztp.zzb(long, boolean):int");
    }
    ...
    public final /* synthetic */ int zze(zzp zzp2, int i, boolean z) {
        return zzzw.zza(this, zzp2, i, true);
    }
    ...
    public final void zzs(long j, int i, int i2, int i3, zzzx zzzx) {
        int i4 = i & 1;
        if (this.zzw) {
            if (i4 != 0) {
                this.zzw = false;
        ...
        zzF(j, i, (this.zza.zzb() - ((long) i2)) - ((long) i3), i2, zzzx);
    }
    ...
    public final void zzu(zzto zzto) {
        this.zzf = zzto;
    }
    ...
    public final synchronized boolean zzx(boolean r4) {
        ...
        L_0x001b:
            ...
            return r1
        L_0x001d:
            com.google.android.gms.internal.ads.zztw r4 = r3.zzc     // Catch:{ all -> 0x003e }
            int r0 = r3.zzp     // Catch:{ all -> 0x003e }
            int r2 = r3.zzr     // Catch:{ all -> 0x003e }
            int r0 = r0 + r2
            java.lang.Object r4 = r4.zza(r0)     // Catch:{ all -> 0x003e }
            com.google.android.gms.internal.ads.zztn r4 = (com.google.android.gms.internal.ads.zztn) r4     // Catch:{ all -> 0x003e }
        ...
        L_0x003e:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zztp.zzx(boolean):boolean");
    }
    ...
    public final synchronized boolean zzy(long r9, boolean r11) {
        ...
        L_0x003d:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zztp.zzy(long, boolean):boolean");
    }

    private final void zzG(zzad zzad, zziz zziz) {
        zzv zzv2;
        zzad zzad2 = this.zzg;
        zzpj zzpj = null;
        if (zzad2 == null) {
        ...
        this.zzg = zzad;
        zzv zzv3 = zzad.zzp;
        zziz.zza = zzad.zzc(this.zzd.zza(zzad));
        zziz.zzb = this.zzC;
        if (zzad2 == null || !zzeg.zzS(zzv2, zzv3)) {
            if (zzad.zzp != null) {
                zzpj = new zzpj(new zzpa(new zzpl(1), 6001));
            }
            this.zzC = zzpj;
            zziz.zzb = zzpj;
        }
