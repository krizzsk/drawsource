...
public final class zzccl implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private final void zzb(String str, int i) {
        Context context;
        boolean z = false;
        if (!((Boolean) zzay.zzc().zzb(zzbhz.zzat)).booleanValue() ? str.isEmpty() || str.charAt(0) != '1' : i == 0 || str.isEmpty() || (str.charAt(0) != '1' && !str.equals("-1"))) {
            z = true;
        }
        if (((Boolean) zzay.zzc().zzb(zzbhz.zzar)).booleanValue()) {
            this.zzc.zzH(z);
            if (((Boolean) zzay.zzc().zzb(zzbhz.zzfg)).booleanValue() && z && (context = this.zza) != null) {
    ...
    public final void onSharedPreferenceChanged(android.content.SharedPreferences r9, java.lang.String r10) {
        /*
            r8 = this;
            com.google.android.gms.internal.ads.zzbhr r0 = com.google.android.gms.internal.ads.zzbhz.zzav
            ...
            com.google.android.gms.internal.ads.zzbhr r10 = com.google.android.gms.internal.ads.zzbhz.zzat
