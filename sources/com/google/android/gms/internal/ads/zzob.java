...
final class zzob {
    ...
    public zzob(zzad zzad, int i, int i2, int i3, int i4, int i5, int i6, int i7, zzmy[] zzmyArr) {
        this.zza = zzad;
        this.zzb = i;
        this.zzc = i2;
        this.zzd = i3;
    ...
    public final AudioTrack zzb(boolean z, zzi zzi2, int i) throws zznm {
        ...
        try {
            ...
            throw new zznm(state, this.zze, this.zzf, this.zzh, this.zza, zzc(), (Exception) null);
        } catch (IllegalArgumentException | UnsupportedOperationException e) {
            throw new zznm(0, this.zze, this.zzf, this.zzh, this.zza, zzc(), e);
        }
    }
