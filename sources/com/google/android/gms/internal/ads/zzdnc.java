...
public final class zzdnc extends zzcxx {
    ...
    public zzdnc(zzcxw zzcxw, Executor executor, zzdnh zzdnh, zzdnp zzdnp, zzdoh zzdoh, zzdnm zzdnm, zzdns zzdns, zzgqo zzgqo, zzgqo zzgqo2, zzgqo zzgqo3, zzgqo zzgqo4, zzgqo zzgqo5, zzccv zzccv, zzaoc zzaoc, zzcfo zzcfo, Context context, zzdne zzdne, zzemk zzemk, zzbap zzbap) {
        super(zzcxw);
        this.zzd = executor;
        this.zze = zzdnh;
        this.zzf = zzdnp;
    ...
    public static boolean zzP(View view) {
        ...
        if (view.isShown() && view.getGlobalVisibleRect(new Rect(), (Point) null)) {
            if (zzt2 >= ((long) ((Integer) zzay.zzc().zzb(zzbhz.zzic)).intValue())) {
                return true;
            }
        }
        return false;
    ...
    private final synchronized View zzR(Map map) {
        ...
        int i = 0;
        while (i < size) {
            WeakReference weakReference = (WeakReference) map.get((String) zzfrj.get(i));
            i++;
    ...
    /* access modifiers changed from: private */
    /* renamed from: zzT */
    public final synchronized void zzt(zzdpc zzdpc) {
        View view;
        zzany zzc2;
        if (!this.zzp) {
            this.zzo = zzdpc;
            this.zzg.zze(zzdpc);
            this.zzf.zzx(zzdpc.zzf(), zzdpc.zzm(), zzdpc.zzn(), zzdpc, zzdpc);
            if (((Boolean) zzay.zzc().zzb(zzbhz.zzcf)).booleanValue() && (zzc2 = this.zzt.zzc()) != null) {
                zzc2.zzn(zzdpc.zzf());
            }
            if (((Boolean) zzay.zzc().zzb(zzbhz.zzbw)).booleanValue()) {
                zzfbl zzfbl = this.zzb;
                if (zzfbl.zzam) {
                    Iterator<String> keys = zzfbl.zzal.keys();
                    if (keys != null) {
                        while (keys.hasNext()) {
                            ...
                            if (!(weakReference == null || (view = (View) weakReference.get()) == null)) {
                                zzbao zzbao = new zzbao(this.zzv, view);
                                this.zzz.add(zzbao);
                                zzbao.zzc(new zzdnb(this, next));
                            }
                        }
                    }
                }
    ...
    /* access modifiers changed from: private */
    /* renamed from: zzU */
    public final void zzu(zzdpc zzdpc) {
        this.zzf.zzy(zzdpc.zzf(), zzdpc.zzl());
        if (zzdpc.zzh() != null) {
            zzdpc.zzh().setClickable(false);
            zzdpc.zzh().removeAllViews();
        }
        if (zzdpc.zzi() != null) {
            zzdpc.zzi().zze(this.zzs);
        }
        this.zzo = null;
    }

    public final synchronized void zzA() {
        zzdpc zzdpc = this.zzo;
        if (zzdpc == null) {
            zze.zze("Ad should be associated with an ad view before calling recordCustomClickGesture()");
        } else {
            this.zzd.execute(new zzdmy(this, zzdpc instanceof zzdob));
        }
    }
    ...
    public final void zzC(View view) {
        zzdnh zzdnh = this.zze;
        IObjectWrapper zzu2 = zzdnh.zzu();
        zzcli zzq2 = zzdnh.zzq();
    ...
    public final synchronized void zzJ(zzbmv zzbmv) {
        this.zzf.zzw(zzbmv);
    }

    public final synchronized void zzK(zzdpc zzdpc) {
        if (((Boolean) zzay.zzc().zzb(zzbhz.zzbu)).booleanValue()) {
            zzs.zza.post(new zzdmz(this, zzdpc));
        } else {
            zzt(zzdpc);
        }
    }

    public final synchronized void zzL(zzdpc zzdpc) {
        if (((Boolean) zzay.zzc().zzb(zzbhz.zzbu)).booleanValue()) {
            zzs.zza.post(new zzdmv(this, zzdpc));
        } else {
            zzu(zzdpc);
        }
    }
    ...
    public final synchronized void zzV() {
        this.zzp = true;
        this.zzd.execute(new zzdna(this));
        super.zzV();
    }

    public final void zzW() {
        this.zzd.execute(new zzdmw(this));
        if (this.zze.zzc() != 7) {
            Executor executor = this.zzd;
            zzdnp zzdnp = this.zzf;
            zzdnp.getClass();
            executor.execute(new zzdmx(zzdnp));
        }
        super.zzW();
    }
    ...
    public final void zzq(String str, boolean z) {
        ...
        if (this.zzh.zzd() && !TextUtils.isEmpty(str)) {
            ...
            if (z4) {
                ...
                zzbxq = zzbxq.NATIVE_DISPLAY;
                if (this.zze.zzc() == 3) {
                    zzbxr = zzbxr.UNSPECIFIED;
                } else {
                    zzbxr = zzbxr.ONE_PIXEL;
                }
            }
            IObjectWrapper zzb2 = zzt.zzh().zzb(str4, zzq2.zzI(), "", "javascript", str3, str, zzbxr, zzbxq, this.zzb.zzan);
            if (zzb2 == null) {
    ...
    public final synchronized void zzv(android.view.View r4, java.util.Map r5, java.util.Map r6, boolean r7) {
        /*
            ...
            return
        L_0x0007:
            com.google.android.gms.internal.ads.zzbhr r0 = com.google.android.gms.internal.ads.zzbhz.zzbw     // Catch:{ all -> 0x00f2 }
            com.google.android.gms.internal.ads.zzbhx r1 = com.google.android.gms.ads.internal.client.zzay.zzc()     // Catch:{ all -> 0x00f2 }
            ...
            com.google.android.gms.internal.ads.zzfbl r0 = r3.zzb     // Catch:{ all -> 0x00f2 }
        ...
        L_0x0045:
            ...
            com.google.android.gms.internal.ads.zzbhr r7 = com.google.android.gms.internal.ads.zzbhz.zzcV     // Catch:{ all -> 0x00f2 }
            com.google.android.gms.internal.ads.zzbhx r0 = com.google.android.gms.ads.internal.client.zzay.zzc()     // Catch:{ all -> 0x00f2 }
        ...
        L_0x008a:
            ...
            return
        L_0x0095:
            com.google.android.gms.internal.ads.zzbhr r0 = com.google.android.gms.internal.ads.zzbhz.zzcW     // Catch:{ all -> 0x00f2 }
            com.google.android.gms.internal.ads.zzbhx r1 = com.google.android.gms.ads.internal.client.zzay.zzc()     // Catch:{ all -> 0x00f2 }
            java.lang.Object r0 = r1.zzb(r0)     // Catch:{ all -> 0x00f2 }
            java.lang.Boolean r0 = (java.lang.Boolean) r0     // Catch:{ all -> 0x00f2 }
            boolean r0 = r0.booleanValue()     // Catch:{ all -> 0x00f2 }
        ...
        L_0x00b2:
            ...
            return
        L_0x00b4:
            com.google.android.gms.internal.ads.zzbhr r0 = com.google.android.gms.internal.ads.zzbhz.zzcX     // Catch:{ all -> 0x00f2 }
            com.google.android.gms.internal.ads.zzbhx r1 = com.google.android.gms.ads.internal.client.zzay.zzc()     // Catch:{ all -> 0x00f2 }
            java.lang.Object r0 = r1.zzb(r0)     // Catch:{ all -> 0x00f2 }
            java.lang.Boolean r0 = (java.lang.Boolean) r0     // Catch:{ all -> 0x00f2 }
            boolean r0 = r0.booleanValue()     // Catch:{ all -> 0x00f2 }
        ...
        L_0x00f2:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzdnc.zzv(android.view.View, java.util.Map, java.util.Map, boolean):void");
    }
    ...
    public final synchronized void zzx(android.view.View r9, android.view.View r10, java.util.Map r11, java.util.Map r12, boolean r13) {
        /*
            r8 = this;
            monitor-enter(r8)
            com.google.android.gms.internal.ads.zzdoh r0 = r8.zzg     // Catch:{ all -> 0x0031 }
            com.google.android.gms.internal.ads.zzdpc r1 = r8.zzo     // Catch:{ all -> 0x0031 }
            r0.zzc(r1)     // Catch:{ all -> 0x0031 }
            com.google.android.gms.internal.ads.zzdnp r2 = r8.zzf     // Catch:{ all -> 0x0031 }
            r3 = r9
            r4 = r10
            r5 = r11
            r6 = r12
            ...
            com.google.android.gms.internal.ads.zzdnh r9 = r8.zze     // Catch:{ all -> 0x0031 }
        ...
        L_0x0031:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzdnc.zzx(android.view.View, android.view.View, java.util.Map, java.util.Map, boolean):void");
    }
    ...
    public static /* synthetic */ void zzh(zzdnc zzdnc) {
        try {
            zzdnh zzdnh = zzdnc.zze;
            int zzc2 = zzdnh.zzc();
            if (zzc2 != 1) {
                if (zzc2 != 2) {
                    if (zzc2 != 3) {
                        if (zzc2 != 6) {
                            ...
                            zzdns zzdns = zzdnc.zzi;
                            if (zzdns.zzg() != null) {
                                zzdns.zzg().zzg((zzbqv) zzdnc.zzm.zzb());
                            }
                        } else if (zzdnc.zzi.zzf() != null) {
                            zzdnc.zzq("Google", true);
                            zzdnc.zzi.zzf().zze((zzbmy) zzdnc.zzl.zzb());
                        }
                    } else if (zzdnc.zzi.zzd(zzdnh.zzy()) != null) {
                        if (zzdnc.zze.zzr() != null) {
                            zzdnc.zzq("Google", true);
                        }
                        zzdnc.zzi.zzd(zzdnc.zze.zzy()).zze((zzblv) zzdnc.zzn.zzb());
                    }
                } else if (zzdnc.zzi.zza() != null) {
                    zzdnc.zzq("Google", true);
                    zzdnc.zzi.zza().zze((zzblq) zzdnc.zzk.zzb());
                }
            } else if (zzdnc.zzi.zzb() != null) {
                zzdnc.zzq("Google", true);
                zzdnc.zzi.zzb().zze((zzbls) zzdnc.zzj.zzb());
            }
