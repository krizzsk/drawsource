...
final class zzgjo extends zzgjq {
    ...
    /* synthetic */ zzgjo(InputStream inputStream, int i, zzgjn zzgjn) {
        super((zzgjp) null);
    ...
    public final zzgji zzw() throws IOException {
        ...
        int i2 = this.zzi;
        if (zzj2 <= i - i2 && zzj2 > 0) {
            zzgji zzw = zzgji.zzw(this.zzf, i2, zzj2);
            this.zzi += zzj2;
            return zzw;
        } else if (zzj2 == 0) {
            return zzgji.zzb;
    ...
    public final String zzx() throws IOException {
        ...
        if (zzj2 > 0) {
            ...
            int i2 = this.zzi;
            if (zzj2 <= i - i2) {
                String str = new String(this.zzf, i2, zzj2, zzgla.zzb);
                this.zzi += zzj2;
                return str;
            }
        }
        ...
        if (zzj2 > this.zzg) {
            return new String(zzN(zzj2, false), zzgla.zzb);
        }
        zzL(zzj2);
        String str2 = new String(this.zzf, this.zzi, zzj2, zzgla.zzb);
        this.zzi += zzj2;
        return str2;
    }
