...
public final class zzefa extends zzbxk {
    ...
    public zzefa(Context context, zzees zzees, zzcfn zzcfn, zzdwh zzdwh, zzfgp zzfgp) {
        this.zza = context;
        this.zzb = zzdwh;
        this.zzc = zzcfn;
        this.zzd = zzees;
    ...
    public static void zzc(Context context, zzdwh zzdwh, zzfgp zzfgp, zzees zzees, String str, String str2) {
        zzd(context, zzdwh, zzfgp, zzees, str, str2, new HashMap());
    }

    public static void zzd(Context context, zzdwh zzdwh, zzfgp zzfgp, zzees zzees, String str, String str2, Map map) {
        String str3;
        String str4 = "offline";
        if (((Boolean) zzay.zzc().zzb(zzbhz.zzhj)).booleanValue()) {
            zzfgo zzb2 = zzfgo.zzb(str2);
            zzb2.zza("gqi", str);
        ...
        zzees.zzd(new zzeeu(zzt.zzA().currentTimeMillis(), str, str3, 2));
    }

    public static void zzh(Activity activity, zzl zzl, zzbr zzbr, zzees zzees, zzdwh zzdwh, zzfgp zzfgp, String str, String str2) {
        String str3;
        String str4;
        String str5;
        String str6;
        ...
        if (zzd2 == null) {
            ...
            str3 = zzd2.getString(C5687R.string.offline_opt_in_title);
        }
        AlertDialog.Builder title = builder.setTitle(str3);
        if (zzd2 == null) {
            str4 = "We'll send you a notification with a link to the advertiser site.";
        } else {
            str4 = zzd2.getString(C5687R.string.offline_opt_in_message);
        }
        AlertDialog.Builder message = title.setMessage(str4);
        if (zzd2 == null) {
            str5 = "OK";
        } else {
            str5 = zzd2.getString(C5687R.string.offline_opt_in_confirm);
        }
        AlertDialog.Builder positiveButton = message.setPositiveButton(str5, new zzeew(zzdwh, activity, zzfgp, zzees, str, zzbr, str2, zzd2, zzl));
        if (zzd2 == null) {
            str6 = "No thanks";
        } else {
            str6 = zzd2.getString(C5687R.string.offline_opt_in_decline);
        }
        zzees zzees2 = zzees;
        String str7 = str;
        zzdwh zzdwh2 = zzdwh;
        ...
        zzfgp zzfgp2 = zzfgp;
        zzl zzl2 = zzl;
        positiveButton.setNegativeButton(str6, new zzeex(zzees2, str7, zzdwh2, activity2, zzfgp2, zzl2)).setOnCancelListener(new zzeey(zzees2, str7, zzdwh2, activity2, zzfgp2, zzl2));
        builder.create().show();
    }
    ...
    public final void zzf() {
        this.zzd.zze(new zzeeo(this.zzc));
    }
    ...
    public final void zzg(IObjectWrapper iObjectWrapper, String str, String str2) {
        ...
        PendingIntent zza2 = zzfoa.zza(context, 0, intent, zzfoa.zza | 1073741824, 0);
        Intent intent2 = new Intent();
        intent2.setClass(context, AdService.class);
        intent2.setAction("offline_notification_dismissed");
        intent2.putExtra("offline_notification_action", "offline_notification_dismissed");
        intent2.putExtra("gws_query_id", str2);
        PendingIntent zza3 = zzfoa.zza(context, 0, intent2, zzfoa.zza | 1073741824, 0);
        Resources zzd2 = zzt.zzo().zzd();
        ...
        if (zzd2 == null) {
            ...
            str3 = zzd2.getString(C5687R.string.offline_notification_title);
        }
        NotificationCompat.Builder contentTitle = builder.setContentTitle(str3);
        if (zzd2 == null) {
            str4 = "Tap to open ad";
        } else {
            str4 = zzd2.getString(C5687R.string.offline_notification_text);
        }
