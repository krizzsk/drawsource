...
public final class zzbwn extends zzbwv {
    ...
    public zzbwn(zzcli zzcli, Map map) {
    ...
    public final void zzc() {
        ...
        builder.setTitle(zzd2 != null ? zzd2.getString(C5687R.string.f14301s5) : "Create calendar event");
        builder.setMessage(zzd2 != null ? zzd2.getString(C5687R.string.f14302s6) : "Allow Ad to create a calendar event?");
        builder.setPositiveButton(zzd2 != null ? zzd2.getString(C5687R.string.f14299s3) : "Accept", new zzbwl(this));
        builder.setNegativeButton(zzd2 != null ? zzd2.getString(C5687R.string.f14300s4) : "Decline", new zzbwm(this));
        builder.create().show();
    }
}
