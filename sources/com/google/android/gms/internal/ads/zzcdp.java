...
public final class zzcdp {
    ...
    public static String zzb(Uri uri, Context context) {
        ...
        String str = (String) zzay.zzc().zzb(zzbhz.zzac);
        String uri2 = uri.toString();
        if (((Boolean) zzay.zzc().zzb(zzbhz.zzab)).booleanValue() && uri2.contains(str)) {
    ...
    public static String zzc(String str, Context context, boolean z) {
        String zza;
        if ((((Boolean) zzay.zzc().zzb(zzbhz.zzaj)).booleanValue() && !z) || !zzt.zzn().zzu(context) || TextUtils.isEmpty(str) || (zza = zzt.zzn().zza(context)) == null) {
            return str;
        }
        String str2 = (String) zzay.zzc().zzb(zzbhz.zzac);
        if (!((Boolean) zzay.zzc().zzb(zzbhz.zzab)).booleanValue() || !str.contains(str2)) {
