...
public final class zzbix {
    ...
    public final void zzb(Activity activity) {
        String zza2;
        if (this.zzb == null && (zza2 = zzgri.zza(activity)) != null) {
            zzgrj zzgrj = new zzgrj(this, (byte[]) null);
            this.zzc = zzgrj;
            CustomTabsClient.bindCustomTabsService(activity, zza2, zzgrj);
        }
    }
    ...
    public final void zze(zzbiv zzbiv) {
        this.zzd = zzbiv;
    }
