...
public final class zzgqn {
    ...
    public zzgqn(double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9) {
        this.zze = d5;
        this.zzf = d6;
        this.zzg = d7;
        this.zzh = d;
    ...
    public final boolean equals(Object obj) {
        ...
        return Double.compare(zzgqn.zzh, this.zzh) == 0 && Double.compare(zzgqn.zzi, this.zzi) == 0 && Double.compare(zzgqn.zzj, this.zzj) == 0 && Double.compare(zzgqn.zzk, this.zzk) == 0 && Double.compare(zzgqn.zzl, this.zzl) == 0 && Double.compare(zzgqn.zzm, this.zzm) == 0 && Double.compare(zzgqn.zze, this.zze) == 0 && Double.compare(zzgqn.zzf, this.zzf) == 0 && Double.compare(zzgqn.zzg, this.zzg) == 0;
    }
