...
public final class zzghd implements zzfwf {
    private static final ThreadLocal zza = new zzghb();
    private static final ThreadLocal zzb = new zzghc();
    private final byte[] zzc;
    private final byte[] zzd;
    private final SecretKeySpec zze;
    private final int zzf;

    public zzghd(byte[] bArr, int i) throws GeneralSecurityException {
        if (!zzfze.zza(1)) {
