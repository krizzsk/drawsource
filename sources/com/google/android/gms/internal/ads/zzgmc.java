...
final class zzgmc {
    static String zza(zzgma zzgma, String str) {
    ...
    private static void zzd(zzgma zzgma, StringBuilder sb, int i) {
        boolean z;
        HashMap hashMap = new HashMap();
        HashMap hashMap2 = new HashMap();
        TreeSet<String> treeSet = new TreeSet<>();
        for (Method method : zzgma.getClass().getDeclaredMethods()) {
        ...
        for (String str : treeSet) {
            ...
            if (substring.endsWith("List") && !substring.endsWith("OrBuilderList") && !substring.equals("List")) {
                ...
                if (method2 != null && method2.getReturnType().equals(List.class)) {
                    zzb(sb, i, zzc(concat), zzgkq.zzaN(method2, zzgma, new Object[0]));
                }
            }
            if (substring.endsWith("Map") && !substring.equals("Map")) {
                ...
                if (method3 != null && method3.getReturnType().equals(Map.class) && !method3.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method3.getModifiers())) {
                    zzb(sb, i, zzc(concat2), zzgkq.zzaN(method3, zzgma, new Object[0]));
                }
            }
            if (((Method) hashMap2.get("set".concat(String.valueOf(substring)))) != null && (!substring.endsWith("Bytes") || !hashMap.containsKey("get".concat(String.valueOf(substring.substring(0, substring.length() - 5)))))) {
                ...
                if (method4 != null) {
                    Object zzaN = zzgkq.zzaN(method4, zzgma, new Object[0]);
                    if (method5 == null) {
                        if (zzaN instanceof Boolean) {
                            ...
                            if (zzaN instanceof String) {
                                ...
                                z = zzaN.equals(zzgji.zzb);
                            } else if (zzaN instanceof zzgma) {
                                if (zzaN == ((zzgma) zzaN).zzbh()) {
                                }
                            } else if ((zzaN instanceof Enum) && ((Enum) zzaN).ordinal() == 0) {
                            }
                            if (z) {
                            }
                        } else if (Double.doubleToRawLongBits(((Double) zzaN).doubleValue()) == 0) {
                        }
                    } else if (!((Boolean) zzgkq.zzaN(method5, zzgma, new Object[0])).booleanValue()) {
                    }
                    zzb(sb, i, zzc(concat3), zzaN);
                }
            }
        }
        if (!(zzgma instanceof zzgkn)) {
            zzgnl zzgnl = ((zzgkq) zzgma).zzc;
            if (zzgnl != null) {
                zzgnl.zzg(sb, i);
                return;
            }
