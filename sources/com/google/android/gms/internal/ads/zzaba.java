                        ...
                        while (i2 < 4) {
                            ...
                            if (zza2 == null) {
                                ...
                                while (true) {
                                    ...
                                    if (zza4 != null) {
                                        zzo = zzfrj.zzq(new zzaav(MimeTypes.IMAGE_JPEG, "Primary", 0, 0), new zzaav("video/mp4", "MotionPhoto", Long.parseLong(zza4), 0));
                                        break;
                                    }
                                    i++;
                                }
    ...
    private static zzfrj zzb(XmlPullParser xmlPullParser, String str, String str2) throws XmlPullParserException, IOException {
        ...
        do {
            ...
            if (zzeh.zzc(xmlPullParser, concat)) {
                ...
                zzi.zze(new zzaav(zza2, zza3, zza4 != null ? Long.parseLong(zza4) : 0, zza5 != null ? Long.parseLong(zza5) : 0));
            }
