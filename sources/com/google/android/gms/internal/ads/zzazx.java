...
public final class zzazx extends zzavr {
    ...
    public zzazx(Context context, zzavt zzavt, long j, Handler handler, zzbai zzbai, int i) {
        super(2, zzavt, (zzatt) null, false);
        boolean z = false;
        this.zzb = context.getApplicationContext();
        this.zzc = new zzazz(context);
        this.zzd = new zzbah(handler, zzbai);
    ...
    private static int zzN(zzart zzart) {
        int i = zzart.zzm;
        if (i == -1) {
            return 0;
        }
    ...
    private final boolean zzag(boolean z) {
        if (zzazo.zza < 23 || (z && !zzazu.zzb(this.zzb))) {
            return false;
        }
        return true;
    }
    ...
    public final int zzH(zzavt zzavt, zzart zzart) throws zzavw {
        ...
        zzats zzats = zzart.zzi;
        if (zzats != null) {
            z = false;
            for (int i2 = 0; i2 < zzats.zza; i2++) {
                z |= zzats.zza(i2).zzc;
            }
        } else {
            z = false;
        }
        zzavp zzc2 = zzawb.zzc(str, z);
        if (zzc2 == null) {
            return 1;
        }
        boolean zze2 = zzc2.zze(zzart.zzc);
        if (zze2 && zzart.zzj > 0 && zzart.zzk > 0) {
            if (zzazo.zza >= 21) {
                zze2 = zzc2.zzf(zzart.zzj, zzart.zzk, (double) zzart.zzl);
            } else {
                zze2 = zzart.zzj * zzart.zzk <= zzawb.zza();
                if (!zze2) {
                    Log.d("MediaCodecVideoRenderer", "FalseCheck [legacyFrameSize, " + zzart.zzj + "x" + zzart.zzk + "] [" + zzazo.zze + "]");
                }
            }
        }
    ...
    public final void zzO(com.google.android.gms.internal.ads.zzavp r12, android.media.MediaCodec r13, com.google.android.gms.internal.ads.zzart r14, android.media.MediaCrypto r15) throws com.google.android.gms.internal.ads.zzavw {
        /*
            r11 = this;
            com.google.android.gms.internal.ads.zzart[] r15 = r11.zzg
            int r0 = r14.zzj
            int r1 = r14.zzk
            int r2 = r14.zzg
            r3 = 0
        ...
        L_0x006b:
            ...
            goto L_0x008a
        L_0x006e:
            java.lang.String r2 = com.google.android.gms.internal.ads.zzazo.zzd
        ...
        L_0x0079:
            r2 = 16
            int r5 = com.google.android.gms.internal.ads.zzazo.zzd(r0, r2)
            int r2 = com.google.android.gms.internal.ads.zzazo.zzd(r1, r2)
            int r5 = r5 * r2
            int r2 = r5 * 256
            goto L_0x0089
        L_0x0087:
        ...
        L_0x008f:
            int r15 = r15.length
            com.google.android.gms.internal.ads.zzazw r15 = new com.google.android.gms.internal.ads.zzazw
            r15.<init>(r0, r1, r2)
            r11.zzh = r15
            boolean r0 = r11.zze
        ...
        L_0x00bb:
            ...
            com.google.android.gms.internal.ads.zzayz.zze(r15)
            android.view.Surface r15 = r11.zzj
            if (r15 != 0) goto L_0x00d6
            android.content.Context r15 = r11.zzb
            boolean r12 = r12.zzd
            com.google.android.gms.internal.ads.zzazu r12 = com.google.android.gms.internal.ads.zzazu.zza(r15, r12)
            r11.zzj = r12
        L_0x00d6:
        ...
        L_0x00da:
            ...
            int r12 = com.google.android.gms.internal.ads.zzazo.zza
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzazx.zzO(com.google.android.gms.internal.ads.zzavp, android.media.MediaCodec, com.google.android.gms.internal.ads.zzart, android.media.MediaCrypto):void");
    }
    ...
    public final boolean zzT(long j, long j2, MediaCodec mediaCodec, ByteBuffer byteBuffer, int i, int i2, long j3, boolean z) {
        ...
        if (this.zzi == this.zzj) {
            ...
            if (zzaf(j8)) {
                ...
                zzazm.zzb();
                zzatn zzatn = this.zza;
                zzatn.zzf++;
                this.zzn++;
                int i6 = this.zzo + 1;
                this.zzo = i6;
                zzatn.zzg = Math.max(i6, zzatn.zzg);
                if (this.zzn == -1) {
                    zzac();
                }
                return true;
    ...
    /* access modifiers changed from: protected */
    public final void zzX(zzato zzato) {
        int i = zzazo.zza;
    }
    ...
    /* access modifiers changed from: protected */
    public final boolean zzZ(MediaCodec mediaCodec, boolean z, zzart zzart, zzart zzart2) {
        if (!zzart.zzf.equals(zzart2.zzf) || zzN(zzart) != zzN(zzart2)) {
            return false;
        }
        if (!z && (zzart.zzj != zzart2.zzj || zzart.zzk != zzart2.zzk)) {
            return false;
        }
        int i = zzart2.zzj;
        zzazw zzazw = this.zzh;
        return i <= zzazw.zza && zzart2.zzk <= zzazw.zzb && zzart2.zzg <= zzazw.zzc;
    }

    /* access modifiers changed from: protected */
    public final boolean zzaa(zzavp zzavp) {
        return this.zzi != null || zzag(zzavp.zzd);
    }
    ...
    /* access modifiers changed from: protected */
    public final void zzs(zzart[] zzartArr, long j) throws zzarf {
        this.zzg = zzartArr;
