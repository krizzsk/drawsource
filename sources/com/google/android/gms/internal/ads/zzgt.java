...
public final class zzgt extends zzbr {
    ...
    public static zzgt zzb(Throwable th, String str, int i, zzad zzad, int i2, boolean z, int i3) {
        return new zzgt(1, th, (String) null, i3, str, i, zzad, zzad == null ? 4 : i2, z);
    }
    ...
    public final zzgt zza(zzbi zzbi) {
        String message = getMessage();
        int i = zzeg.zza;
        return new zzgt(message, getCause(), this.zzb, this.zze, this.zzf, this.zzg, this.zzh, this.zzi, zzbi, this.zzc, this.zzk);
    }
    ...
    private zzgt(String str, Throwable th, int i, int i2, String str2, int i3, zzad zzad, int i4, zzbi zzbi, long j, boolean z) {
        super(str, th, i, j);
        boolean z2;
        int i5;
        boolean z3 = z;
