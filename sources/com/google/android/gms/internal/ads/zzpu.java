...
final class zzpu {
    ...
    /*  JADX ERROR: IndexOutOfBoundsException in pass: RegionMakerVisitor
        ...
        */
    static /* bridge */ /* synthetic */ void zza(com.google.android.gms.internal.ads.zzpu r9, android.os.Message r10) {
        /*
            int r0 = r10.what
            r1 = 0
    ...
    private static zzpt zzg() {
        synchronized (zza) {
            ...
            zzpt zzpt2 = (zzpt) zza.removeFirst();
            return zzpt2;
        }
    }
    ...
    public final void zzd(int i, int i2, zzfy zzfy, long j, int i3) {
        zzh();
        zzpt zzg2 = zzg();
        zzg2.zza(i, 0, 0, j, 0);
        MediaCodec.CryptoInfo cryptoInfo = zzg2.zzd;
        cryptoInfo.numSubSamples = zzfy.zzf;
        cryptoInfo.numBytesOfClearData = zzj(zzfy.zzd, cryptoInfo.numBytesOfClearData);
        cryptoInfo.numBytesOfEncryptedData = zzj(zzfy.zze, cryptoInfo.numBytesOfEncryptedData);
        byte[] zzi = zzi(zzfy.zzb, cryptoInfo.key);
        if (zzi != null) {
            cryptoInfo.key = zzi;
            byte[] zzi2 = zzi(zzfy.zza, cryptoInfo.iv);
            if (zzi2 != null) {
                cryptoInfo.iv = zzi2;
                cryptoInfo.mode = zzfy.zzc;
                if (zzeg.zza >= 24) {
                    cryptoInfo.setPattern(new MediaCodec.CryptoInfo.Pattern(zzfy.zzg, zzfy.zzh));
                }
