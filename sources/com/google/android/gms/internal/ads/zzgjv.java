...
final class zzgjv extends zzgjs {
    private final OutputStream zzf;

    zzgjv(OutputStream outputStream, int i) {
        super(i);
    ...
    public final void zzv(String str) throws IOException {
        ...
        try {
            ...
            if (zzE2 == zzE) {
                int i5 = i + zzE2;
                this.zzc = i5;
                int zzd2 = zzgnz.zzd(str, this.zza, i5, this.zzb - i5);
                this.zzc = i;
                i2 = (zzd2 - i) - zzE2;
                zzf(i2);
                this.zzc = zzd2;
                ...
                i2 = zzgnz.zze(str);
                zzf(i2);
                this.zzc = zzgnz.zzd(str, this.zza, this.zzc, i2);
            }
            this.zzd += i2;
        } catch (zzgny e) {
            this.zzd -= this.zzc - i;
