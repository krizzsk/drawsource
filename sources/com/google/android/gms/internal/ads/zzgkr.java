...
final class zzgkr extends zzgis implements RandomAccess, zzgkv, zzgmh {
    ...
    static {
        zzgkr zzgkr = new zzgkr(new int[0], 0);
        zza = zzgkr;
        zzgkr.zzb();
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzgkr.zzb, 0, this.zzb, this.zzc, zzgkr.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        zzgkr zzgkr = (zzgkr) obj;
        if (this.zzc != zzgkr.zzc) {
            return false;
        }
        int[] iArr = zzgkr.zzb;
