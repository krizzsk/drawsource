...
final class zzaht implements zzahs {
    ...
    public zzaht(zzyu zzyu, zzzy zzzy, zzahv zzahv, String str, int i) throws zzbp {
        this.zza = zzyu;
        this.zzb = zzzy;
        this.zzc = zzahv;
    ...
    public final boolean zzc(zzys zzys, long j) throws IOException {
        ...
        while (true) {
            ...
            if (i <= 0 || (i2 = this.zzg) >= (i3 = this.zze)) {
                ...
                int zza2 = zzzw.zza(this.zzb, zzys, (int) Math.min((long) (i3 - i2), j2), true);
                if (zza2 == -1) {
                    j2 = 0;
                } else {
                    this.zzg += zza2;
        ...
        if (i52 > 0) {
            ...
            int i6 = i52 * i42;
            int i7 = this.zzg - i6;
            this.zzb.zzs(j3 + zzw, 1, i6, i7, (zzzx) null);
            this.zzh += (long) i52;
            this.zzg = i7;
        }
        if (i <= 0) {
