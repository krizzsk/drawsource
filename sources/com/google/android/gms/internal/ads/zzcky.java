...
final class zzcky extends zzek implements zzfn {
    ...
    private final zzfm zzf = new zzfm();
    private zzev zzg;
    ...
    zzcky(String str, zzfs zzfs, int i, int i2, long j, long j2) {
        super(true);
        zzcw.zzc(str);
        this.zze = str;
        this.zzc = i;
    ...
    public final long zzb(zzev zzev) throws zzfj {
        long j;
        this.zzg = zzev;
        this.zzn = 0;
        long j2 = zzev.zzf;
        ...
        throw new zzckw(headerField, zzev);
    }
