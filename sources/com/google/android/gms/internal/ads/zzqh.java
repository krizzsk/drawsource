...
public final class zzqh extends Exception {
    ...
    static /* bridge */ /* synthetic */ zzqh zza(zzqh zzqh, zzqh zzqh2) {
        return new zzqh(zzqh.getMessage(), zzqh.getCause(), zzqh.zza, false, zzqh.zzc, zzqh.zzd, zzqh2);
    }
    ...
    private zzqh(String str, Throwable th, String str2, boolean z, zzqf zzqf, String str3, zzqh zzqh) {
        super(str, th);
        this.zza = str2;
        this.zzb = false;
        this.zzc = zzqf;
