...
final class zzfmh implements zzfkx {
    private final Object zza;
    private final zzfmi zzb;
    private final zzfmt zzc;
    private final zzfku zzd;

    zzfmh(Object obj, zzfmi zzfmi, zzfmt zzfmt, zzfku zzfku) {
        this.zza = obj;
        this.zzb = zzfmi;
        this.zzc = zzfmt;
        this.zzd = zzfku;
    ...
    private static String zzi(byte[] bArr) {
        ...
        zza2.zzc(5);
        zza2.zza(zzgji.zzv(bArr));
        return Base64.encodeToString(((zzaml) zza2.zzal()).zzaw(), 11);
    }
    ...
    public final synchronized void zzd(String str, MotionEvent motionEvent) throws zzfmr {
        try {
            ...
            throw new zzfmr(2005, (Throwable) e);
        }
    }
    ...
    public final synchronized int zze() throws zzfmr {
        try {
            ...
            throw new zzfmr(2006, (Throwable) e);
        }
    ...
    public final synchronized void zzg() throws zzfmr {
        try {
            ...
            throw new zzfmr(2003, (Throwable) e);
        }
    }
    ...
    public final synchronized boolean zzh() throws zzfmr {
        try {
            ...
            throw new zzfmr(2001, (Throwable) e);
        }
