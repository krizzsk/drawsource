...
final class zzgjt extends zzgjx {
    private final byte[] zza;
    private final int zzb;
    private int zzc;

    zzgjt(byte[] bArr, int i, int i2) {
        super((zzgjw) null);
        if (bArr != null) {
    ...
    public final void zzQ(int i, zzgji zzgji) throws IOException {
        zzs((i << 3) | 2);
        zzs(zzgji.zzd());
        zzgji.zzo(this);
    }
    ...
    public final void zzi(int i) throws IOException {
        try {
            ...
            throw new zzgju(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zzc), Integer.valueOf(this.zzb), 1}), e);
        }
    }
    ...
    public final void zzn(int i, zzgma zzgma, zzgmt zzgmt) throws IOException {
        zzs((i << 3) | 2);
    ...
    public final void zze(byte[] bArr, int i, int i2) throws IOException {
        try {
            ...
            throw new zzgju(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zzc), Integer.valueOf(this.zzb), Integer.valueOf(i2)}), e);
        }
    }
    ...
    public final void zzu(long j) throws IOException {
        if (!zzgjx.zzb || this.zzb - this.zzc < 10) {
            while ((j & -128) != 0) {
                byte[] bArr = this.zza;
                int i = this.zzc;
                this.zzc = i + 1;
            ...
            while ((j & -128) != 0) {
                ...
                int i3 = this.zzc;
                this.zzc = i3 + 1;
                zzgnu.zzq(bArr3, (long) i3, (byte) ((((int) j) & 127) | 128));
                j >>>= 7;
            }
            byte[] bArr4 = this.zza;
            int i4 = this.zzc;
            this.zzc = i4 + 1;
            zzgnu.zzq(bArr4, (long) i4, (byte) ((int) j));
        }
    }
}
