...
public final class zzbpa implements zzbom {
        ...
        synchronized (this.zza) {
            ...
            if (zzboz == null) {
                ...
                try {
                    ...
                    zzboz.zzb(jSONObject);
                } catch (JSONException e) {
                    zzboz.zza(e.getMessage());
                }
            }
        }
    }

    public final zzfvl zzb(zzbrq zzbrq, String str, JSONObject jSONObject) {
        zzcga zzcga = new zzcga();
        zzt.zzp();
        String uuid = UUID.randomUUID().toString();
        zzc(uuid, new zzboy(this, zzcga));
        try {
            JSONObject jSONObject2 = new JSONObject();
            jSONObject2.put("id", uuid);
            jSONObject2.put("args", jSONObject);
            zzbrq.zzl(str, jSONObject2);
        } catch (Exception e) {
            zzcga.zze(e);
        }
        return zzcga;
    ...
    public final void zzc(String str, zzboz zzboz) {
        synchronized (this.zza) {
            this.zzb.put(str, zzboz);
        }
    }
}
