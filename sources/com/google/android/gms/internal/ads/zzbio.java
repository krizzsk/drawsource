...
public final class zzbio {
    ...
    public static final zzbil zzf() {
        return new zzbil(zzt.zzA().elapsedRealtime(), (String) null, (zzbil) null);
    }

    public final zzbin zza() {
        zzbin zzbin;
        boolean booleanValue = ((Boolean) zzay.zzc().zzb(zzbhz.zzbB)).booleanValue();
        StringBuilder sb = new StringBuilder();
        HashMap hashMap = new HashMap();
        synchronized (this.zzc) {
            for (zzbil zzbil : this.zza) {
                long zza2 = zzbil.zza();
                String zzc2 = zzbil.zzc();
                zzbil zzb2 = zzbil.zzb();
                if (zzb2 != null && zza2 > 0) {
                    sb.append(zzc2);
                    sb.append('.');
            ...
            zzbin = new zzbin(sb.toString(), str);
        }
        return zzbin;
    }
    ...
    public final void zzc(zzbio zzbio) {
        synchronized (this.zzc) {
        }
    }
    ...
    public final boolean zze(zzbil zzbil, long j, String... strArr) {
        synchronized (this.zzc) {
            for (int i = 0; i <= 0; i++) {
                this.zza.add(new zzbil(j, strArr[i], zzbil));
            }
        }
        return true;
    }
