...
public final class zzbwu extends zzbwv implements zzbom {
    ...
    public zzbwu(zzcli zzcli, Context context, zzbhj zzbhj) {
        super(zzcli, "");
        this.zzh = zzcli;
        this.zzi = context;
        this.zzk = zzbhj;
    ...
    public final /* synthetic */ void zza(Object obj, Map map) {
        ...
        zzbwt zzbwt = new zzbwt();
        zzbhj zzbhj = this.zzk;
        Intent intent = new Intent("android.intent.action.DIAL");
        intent.setData(Uri.parse("tel:"));
        zzbwt.zze(zzbhj.zza(intent));
        zzbhj zzbhj2 = this.zzk;
        Intent intent2 = new Intent("android.intent.action.VIEW");
        intent2.setData(Uri.parse("sms:"));
        zzbwt.zzc(zzbhj2.zza(intent2));
        zzbwt.zza(this.zzk.zzb());
        zzbwt.zzd(this.zzk.zzc());
        zzbwt.zzb(true);
        boolean zzh2 = zzbwt.zza;
        boolean zzj2 = zzbwt.zzb;
        boolean zzf2 = zzbwt.zzc;
        boolean zzi2 = zzbwt.zzd;
        boolean zzg2 = zzbwt.zze;
