...
public final class zzduh {
    ...
    public final synchronized void zzf() {
        ...
        if (zzh != null) {
            ...
            if (zzf != null) {
                this.zzb = ((Boolean) zzay.zzc().zzb(zzbhz.zzdc)).booleanValue() ? zzf.optJSONObject("common_settings") : null;
    ...
    public final JSONObject zzb(String str, String str2) {
        if (!((Boolean) zzay.zzc().zzb(zzbhz.zzdb)).booleanValue() || str == null || str2 == null) {
            return null;
        }
        if (!this.zzd) {
            zzf();
        ...
        String zza2 = zzduj.zza(this.zze, str, str2);
        if (zza2 == null) {
            return null;
        }
    ...
    public final /* synthetic */ void zze() {
        this.zzc.execute(new zzdug(this));
    }
}
