...
public final class zzdmh implements zzdnp {
    ...
    /* access modifiers changed from: private */
    public final zzdbr zzh;
    /* access modifiers changed from: private */
    public final zzdje zzi;
    ...
    public zzdmh(Context context, zzdns zzdns, JSONObject jSONObject, zzdse zzdse, zzdnh zzdnh, zzaoc zzaoc, zzdcl zzdcl, zzdbr zzdbr, zzdje zzdje, zzfbl zzfbl, zzcfo zzcfo, zzfcd zzfcd, zzcud zzcud, zzdok zzdok, Clock clock, zzdjb zzdjb, zzfii zzfii, zzfhs zzfhs) {
        this.zza = context;
        this.zzb = zzdns;
        this.zzc = jSONObject;
        this.zzd = zzdse;
    ...
    private final boolean zzE(JSONObject jSONObject, JSONObject jSONObject2, JSONObject jSONObject3, JSONObject jSONObject4, String str, JSONObject jSONObject5, boolean z) {
        ...
        try {
            ...
            if (((Boolean) zzay.zzc().zzb(zzbhz.zzhd)).booleanValue()) {
                this.zzd.zzi("/clickRecorded", new zzdme(this, (zzdmd) null));
            } else {
                this.zzd.zzi("/logScionEvent", new zzdmc(this, (zzdmb) null));
            }
            this.zzd.zzi("/nativeImpression", new zzdmg(this, (zzdmf) null));
    ...
    public final void zzj(View view, View view2, Map map, Map map2, boolean z) {
        ...
        zzm(true == ((Boolean) zzay.zzc().zzb(zzbhz.zzcG)).booleanValue() ? view3 : view4, zzg2, zzd2, zzf2, zze2, zzB, zzbx.zzc(zzB, this.zza, this.zzx, this.zzw), (JSONObject) null, z, false);
    }
    ...
    public final void zzm(View view, JSONObject jSONObject, JSONObject jSONObject2, JSONObject jSONObject3, JSONObject jSONObject4, String str, JSONObject jSONObject5, JSONObject jSONObject6, boolean z, boolean z2) {
        ...
        try {
            ...
            zzbkp zzbkp = this.zzl.zzi;
            jSONObject8.put("custom_mute_requested", zzbkp != null && zzbkp.zzg);
            ...
            if (((Boolean) zzay.zzc().zzb(zzbhz.zzhh)).booleanValue() && PlatformVersion.isAtLeastR()) {
                jSONObject8.put("try_fallback_for_deep_link", true);
            }
            if (((Boolean) zzay.zzc().zzb(zzbhz.zzhi)).booleanValue() && PlatformVersion.isAtLeastR()) {
    ...
    public final void zzt(View view) {
        ...
        zzdok zzdok = this.zzn;
        if (view != null) {
            view.setOnClickListener(zzdok);
            view.setClickable(true);
            zzdok.zzc = new WeakReference(view);
        }
    }
        ...
        try {
            if (!this.zzu) {
                if (zzcu == null) {
                    ...
                    if (zzdnh.zzk() != null) {
                        this.zzu = true;
                        this.zzq.zzc(zzdnh.zzk().zzf(), this.zzr);
                        zzf();
                        return;
                    }
                }
