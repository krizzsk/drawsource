...
public final class zzbym {
    ...
    public zzbym(Context context, AdFormat adFormat, zzdr zzdr) {
        this.zzb = context;
        this.zzc = adFormat;
        this.zzd = zzdr;
    }
    ...
    public static zzcdz zza(Context context) {
        ...
        synchronized (zzbym.class) {
            if (zza == null) {
                zza = zzaw.zza().zzq(context, new zzbtx());
            }
            zzcdz = zza;
        }
        return zzcdz;
    ...
    public final void zzb(QueryInfoGenerationCallback queryInfoGenerationCallback) {
        ...
        try {
            zza2.zze(wrap, new zzced((String) null, this.zzc.name(), (zzq) null, zzl), new zzbyl(this, queryInfoGenerationCallback));
