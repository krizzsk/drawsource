...
final class zzauq {
    ...
    public final long zze(zzatv zzatv, boolean z, boolean z2, int i) throws IOException, InterruptedException {
        if (this.zzc == 0) {
            if (!zzatv.zzh(this.zzb, 0, 1, z)) {
                return -1;
            }
        ...
        if (i2 != 1) {
            zzatv.zzh(this.zzb, 1, i2 - 1, false);
        }
        this.zzc = 0;
