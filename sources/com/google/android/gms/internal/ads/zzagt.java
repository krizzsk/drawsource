...
final class zzagt implements zzyg {
    ...
    public final zzyf zza(zzys zzys, long j) throws IOException {
        ...
        long j2;
        long zzf = zzys.zzf();
        int min = (int) Math.min(SilenceSkippingAudioProcessor.DEFAULT_PADDING_SILENCE_US, zzys.zzd() - zzf);
        this.zzb.zzC(min);
        ...
        return j3 != -9223372036854775807L ? zzyf.zzf(j3, zzf + ((long) i)) : zzyf.zza;
    }
