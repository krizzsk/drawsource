...
public final class zzfku {
    ...
    zzfku(Context context, Executor executor, Task task, boolean z) {
        this.zzb = context;
        this.zzc = executor;
        this.zzd = task;
        this.zze = z;
    ...
    public static zzfku zza(Context context, Executor executor, boolean z) {
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        if (z) {
            executor.execute(new zzfkq(context, taskCompletionSource));
        } else {
            executor.execute(new zzfkr(taskCompletionSource));
        }
    ...
    private final Task zzh(int i, long j, Exception exc, String str, Map map, String str2) {
        ...
        return this.zzd.continueWith(this.zzc, new zzfkt(zza2, i));
    }
