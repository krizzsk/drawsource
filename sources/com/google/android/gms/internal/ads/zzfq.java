...
public final class zzfq extends zzek {
    ...
    public final int zza(byte[] bArr, int i, int i2) throws zzfp {
        ...
        if (j != -1) {
            try {
                ...
                throw new zzfp((String) null, e, 2000);
            }
        }
    ...
    public final long zzb(com.google.android.gms.internal.ads.zzev r16) throws com.google.android.gms.internal.ads.zzfp {
        /*
            r15 = this;
            r1 = r15
            r0 = r16
        ...
        L_0x00a2:
            ...
            long r13 = r0.zzf     // Catch:{ zzfp -> 0x014f, IOException -> 0x0147 }
            int r13 = (r13 > r8 ? 1 : (r13 == r8 ? 0 : -1))
            if (r13 > 0) goto L_0x00cf
            goto L_0x00d5
        L_0x00cf:
            com.google.android.gms.internal.ads.zzfp r0 = new com.google.android.gms.internal.ads.zzfp     // Catch:{ zzfp -> 0x014f, IOException -> 0x0147 }
            r0.<init>(r7, r7, r12)     // Catch:{ zzfp -> 0x014f, IOException -> 0x0147 }
            throw r0     // Catch:{ zzfp -> 0x014f, IOException -> 0x0147 }
        L_0x00d5:
            long r13 = r3.getStartOffset()     // Catch:{ zzfp -> 0x014f, IOException -> 0x0147 }
            long r6 = r0.zzf     // Catch:{ zzfp -> 0x014f, IOException -> 0x0147 }
            long r6 = r6 + r13
            long r6 = r2.skip(r6)     // Catch:{ zzfp -> 0x014f, IOException -> 0x0147 }
            long r6 = r6 - r13
            long r13 = r0.zzf     // Catch:{ zzfp -> 0x014f, IOException -> 0x0147 }
            ...
            java.nio.channels.FileChannel r2 = r2.getChannel()     // Catch:{ zzfp -> 0x014f, IOException -> 0x0147 }
            long r5 = r2.size()     // Catch:{ zzfp -> 0x014f, IOException -> 0x0147 }
            int r5 = (r5 > r13 ? 1 : (r5 == r13 ? 0 : -1))
            if (r5 != 0) goto L_0x00fb
            r1.zzf = r10     // Catch:{ zzfp -> 0x014f, IOException -> 0x0147 }
            r5 = r10
            goto L_0x011a
        L_0x00fb:
            long r5 = r2.size()     // Catch:{ zzfp -> 0x014f, IOException -> 0x0147 }
            long r7 = r2.position()     // Catch:{ zzfp -> 0x014f, IOException -> 0x0147 }
            long r5 = r5 - r7
            r1.zzf = r5     // Catch:{ zzfp -> 0x014f, IOException -> 0x0147 }
        ...
        L_0x010b:
            com.google.android.gms.internal.ads.zzfp r0 = new com.google.android.gms.internal.ads.zzfp     // Catch:{ zzfp -> 0x014f, IOException -> 0x0147 }
            r2 = 0
            r0.<init>(r2, r2, r12)     // Catch:{ zzfp -> 0x014f, IOException -> 0x0147 }
            throw r0     // Catch:{ zzfp -> 0x014f, IOException -> 0x0147 }
        L_0x0112:
            long r5 = r8 - r6
            r1.zzf = r5     // Catch:{ zzfp -> 0x014f, IOException -> 0x0147 }
        ...
        L_0x0137:
            ...
            return r2
        L_0x013a:
            com.google.android.gms.internal.ads.zzer r0 = new com.google.android.gms.internal.ads.zzer     // Catch:{ zzfp -> 0x014f, IOException -> 0x0147 }
            r0.<init>(r12)     // Catch:{ zzfp -> 0x014f, IOException -> 0x0147 }
            throw r0     // Catch:{ zzfp -> 0x014f, IOException -> 0x0147 }
        L_0x0140:
            com.google.android.gms.internal.ads.zzfp r0 = new com.google.android.gms.internal.ads.zzfp     // Catch:{ zzfp -> 0x014f, IOException -> 0x0147 }
            r2 = 0
    ...
    public final void zzd() throws zzfp {
        ...
        try {
            ...
            throw new zzfp((String) null, e2, 2000);
        } catch (Throwable th2) {
            this.zze = null;
            try {
                ...
                throw new zzfp((String) null, e3, 2000);
            } catch (Throwable th3) {
                this.zzd = null;
                if (this.zzg) {
                    this.zzg = false;
