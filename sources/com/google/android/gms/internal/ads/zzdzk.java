...
public final class zzdzk implements SensorEventListener {
    ...
    public final void onSensorChanged(SensorEvent sensorEvent) {
        if (((Boolean) zzay.zzc().zzb(zzbhz.zzhz)).booleanValue()) {
            ...
            if (((float) Math.sqrt((double) ((f * f) + (f2 * f2) + (f3 * f3)))) >= ((Float) zzay.zzc().zzb(zzbhz.zzhA)).floatValue()) {
                long currentTimeMillis = zzt.zzA().currentTimeMillis();
                if (this.zzd + ((long) ((Integer) zzay.zzc().zzb(zzbhz.zzhB)).intValue()) <= currentTimeMillis) {
                    if (this.zzd + ((long) ((Integer) zzay.zzc().zzb(zzbhz.zzhC)).intValue()) < currentTimeMillis) {
                        this.zze = 0;
                    }
                    ...
                    int i = this.zze + 1;
                    this.zze = i;
                    zzdzj zzdzj = this.zzf;
                    if (zzdzj != null) {
                        if (i == ((Integer) zzay.zzc().zzb(zzbhz.zzhD)).intValue()) {
                            zzdzb zzdzb = (zzdzb) zzdzj;
                            zzdzb.zzg(new zzdyy(zzdzb), zzdza.GESTURE);
                        }
                    }
                }
            }
    ...
    public final void zzb() {
        /*
            r6 = this;
            monitor-enter(r6)
            com.google.android.gms.internal.ads.zzbhr r0 = com.google.android.gms.internal.ads.zzbhz.zzhz     // Catch:{ all -> 0x006a }
            com.google.android.gms.internal.ads.zzbhx r1 = com.google.android.gms.ads.internal.client.zzay.zzc()     // Catch:{ all -> 0x006a }
        ...
        L_0x0035:
            ...
            com.google.android.gms.internal.ads.zzbhr r0 = com.google.android.gms.internal.ads.zzbhz.zzhB     // Catch:{ all -> 0x006a }
            com.google.android.gms.internal.ads.zzbhx r4 = com.google.android.gms.ads.internal.client.zzay.zzc()     // Catch:{ all -> 0x006a }
        ...
        L_0x006a:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzdzk.zzb():void");
    }

    public final void zzc(zzdzj zzdzj) {
        this.zzf = zzdzj;
    }
}
