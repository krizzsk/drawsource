...
public final class zzbvd implements NativeMediationAdRequest {
    ...
    public zzbvd(Date date, int i, Set set, Location location, boolean z, int i2, zzbkp zzbkp, List list, boolean z2, int i3, String str) {
        this.zza = date;
        this.zzb = i;
        this.zzc = set;
        this.zze = location;
    ...
    public final NativeAdOptions getNativeAdOptions() {
        ...
        if (i != 2) {
            if (i != 3) {
                ...
                builder.setImageOrientation(zzbkp.zzc);
