...
final class zzfpv extends zzfpy implements NavigableMap {
    final /* synthetic */ zzfqe zzc;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    zzfpv(zzfqe zzfqe, NavigableMap navigableMap) {
    ...
    public final NavigableMap descendingMap() {
        return new zzfpv(this.zzc, ((NavigableMap) ((SortedMap) this.zza)).descendingMap());
    }
    ...
    public final NavigableSet zzg() {
        return new zzfpw(this.zzc, (NavigableMap) ((SortedMap) this.zza));
    }
    ...
    public final NavigableMap headMap(Object obj, boolean z) {
        return new zzfpv(this.zzc, ((NavigableMap) ((SortedMap) this.zza)).headMap(obj, z));
    }

    public final NavigableMap subMap(Object obj, boolean z, Object obj2, boolean z2) {
        return new zzfpv(this.zzc, ((NavigableMap) ((SortedMap) this.zza)).subMap(obj, z, obj2, z2));
    }

    public final NavigableMap tailMap(Object obj, boolean z) {
        return new zzfpv(this.zzc, ((NavigableMap) ((SortedMap) this.zza)).tailMap(obj, z));
    }
}
