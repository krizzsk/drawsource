...
final class zzcjd implements zzays {
    private static final Pattern zzb = Pattern.compile("^bytes (\\d+)-(\\d+)/(\\d+)$");
    private final int zzc;
    private final int zzd;
    private final String zze;
    private final zzayr zzf = new zzayr();
    ...
    zzcjd(String str, zzayy zzayy, int i, int i2, long j, long j2) {
        zzayz.zzb(str);
        this.zze = str;
        this.zzg = zzayy;
        this.zzc = i;
    ...
    public final long zzb(zzayl zzayl) throws zzayp {
        long j;
        this.zzh = zzayl;
        this.zzn = 0;
        long j2 = zzayl.zzc;
        ...
        throw new zzcjb(headerField, zzayl);
    }
}
