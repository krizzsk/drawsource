...
import com.google.android.gms.base.C5692R;
...
public final class zac {
    ...
    public static String zab(Context context) {
        return context.getResources().getString(C5692R.string.common_google_play_services_notification_channel_name);
    }

    public static String zac(Context context, int i) {
        Resources resources = context.getResources();
        if (i == 1) {
            return resources.getString(C5692R.string.common_google_play_services_install_button);
        }
        if (i == 2) {
            return resources.getString(C5692R.string.common_google_play_services_update_button);
        }
        if (i != 3) {
            return resources.getString(17039370);
        }
        return resources.getString(C5692R.string.common_google_play_services_enable_button);
    }
    ...
    public static String zad(Context context, int i) {
        ...
        if (i == 1) {
            return resources.getString(C5692R.string.common_google_play_services_install_text, new Object[]{zaa2});
        } else if (i != 2) {
            if (i == 3) {
                return resources.getString(C5692R.string.common_google_play_services_enable_text, new Object[]{zaa2});
            } else if (i == 5) {
                ...
                if (i == 9) {
                    return resources.getString(C5692R.string.common_google_play_services_unsupported_text, new Object[]{zaa2});
                } else if (i == 20) {
                    ...
                    switch (i) {
                        ...
                        case 18:
                            return resources.getString(C5692R.string.common_google_play_services_updating_text, new Object[]{zaa2});
                        default:
                            return resources.getString(C5696R.string.common_google_play_services_unknown_issue, new Object[]{zaa2});
                    }
                }
            }
        } else if (DeviceProperties.isWearableWithoutPlayStore(context)) {
            return resources.getString(C5692R.string.common_google_play_services_wear_update_text);
        } else {
            return resources.getString(C5692R.string.common_google_play_services_update_text, new Object[]{zaa2});
        }
    }
    ...
    public static String zaf(Context context, int i) {
        ...
        return str == null ? context.getResources().getString(C5692R.string.common_google_play_services_notification_ticker) : str;
    }
    ...
    public static String zag(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return resources.getString(C5692R.string.common_google_play_services_install_title);
            case 2:
                return resources.getString(C5692R.string.common_google_play_services_update_title);
            case 3:
                return resources.getString(C5692R.string.common_google_play_services_enable_title);
            case 4:
            case 6:
            case 18:
                return null;
    ...
    private static String zah(Context context, String str, String str2) {
        ...
        if (zai == null) {
            zai = resources.getString(C5696R.string.common_google_play_services_unknown_issue);
        }
