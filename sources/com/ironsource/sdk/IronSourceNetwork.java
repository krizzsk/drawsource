...
public class IronSourceNetwork {
    ...
    /* renamed from: a */
    private static C8282e f19607a;

    /* renamed from: b */
    private static C8317d f19608b;

    /* renamed from: c */
    private static JSONObject f19609c;

    /* renamed from: a */
    private static synchronized void m23153a() {
    ...
    public static synchronized void applyConsentInfo(JSONObject jSONObject) {
        synchronized (IronSourceNetwork.class) {
            if (f19607a != null) {
                if (jSONObject != null) {
                    f19607a.mo56678a(jSONObject);
                }
            }
        }
    }

    public static C8317d getInitListener() {
        return f19608b;
    }

    public static synchronized void getOfferWallCredits(C8318e eVar) {
        synchronized (IronSourceNetwork.class) {
            m23153a();
            f19607a.mo56668a(eVar);
        }
    }
    ...
    public static synchronized JSONObject getRawToken(Context context) {
        JSONObject b;
        synchronized (IronSourceNetwork.class) {
            b = C8338d.m23726a().mo56785b(context);
        }
        return b;
    }
    ...
    public static synchronized String getToken(Context context) {
        String a;
        synchronized (IronSourceNetwork.class) {
            a = C8338d.m23726a().mo56780a(context);
        }
        return a;
    }
    ...
    public static synchronized void initOfferWall(Map<String, String> map, C8318e eVar) {
        synchronized (IronSourceNetwork.class) {
            m23153a();
            f19607a.mo56677a(map, eVar);
        }
    }
    ...
    public static synchronized void initSDK(android.content.Context r6, java.lang.String r7, java.lang.String r8, java.util.Map<java.lang.String, java.lang.String> r9) {
        /*
            ...
            com.ironsource.sdk.utils.Logger.m23747e(r6, r7)     // Catch:{ all -> 0x00be }
            monitor-exit(r0)
            return
        L_0x0012:
            com.ironsource.sdk.e r1 = f19607a     // Catch:{ all -> 0x00be }
            ...
            r3.<init>(r4, r5)     // Catch:{ Exception -> 0x0099 }
            r1.add(r3)     // Catch:{ Exception -> 0x0099 }
            java.util.ArrayList<android.util.Pair<java.lang.String, java.lang.String>> r3 = r2.f16060f     // Catch:{ Exception -> 0x0099 }
            r3.addAll(r1)     // Catch:{ Exception -> 0x0099 }
            r1 = 0
            r2.f16059e = r1     // Catch:{ Exception -> 0x0099 }
            com.ironsource.a.a r3 = new com.ironsource.a.a     // Catch:{ Exception -> 0x0099 }
            r3.<init>(r2)     // Catch:{ Exception -> 0x0099 }
            boolean r2 = r3.f16050b     // Catch:{ Exception -> 0x0099 }
            ...
            r2.f19615a = r9     // Catch:{ Exception -> 0x0099 }
        L_0x008a:
            r2.f19617c = r6     // Catch:{ Exception -> 0x0099 }
            r2.f19618d = r8     // Catch:{ Exception -> 0x0099 }
            r2.f19616b = r7     // Catch:{ Exception -> 0x0099 }
            com.ironsource.sdk.a.b r9 = new com.ironsource.sdk.a.b     // Catch:{ Exception -> 0x0099 }
            r9.<init>(r2, r1)     // Catch:{ Exception -> 0x0099 }
            com.ironsource.sdk.p278a.C8104d.m23159a((com.ironsource.p196a.C6339a) r3, (com.ironsource.sdk.p278a.C8101b) r9)     // Catch:{ Exception -> 0x0099 }
            goto L_0x00b1
        L_0x0099:
            r9 = move-exception
            ...
            com.ironsource.sdk.utils.Logger.m23747e(r1, r9)     // Catch:{ all -> 0x00be }
        L_0x00b1:
            com.ironsource.sdk.e r6 = com.ironsource.sdk.p281d.C8265b.m23540a((java.lang.String) r7, (java.lang.String) r8, (android.content.Context) r6)     // Catch:{ all -> 0x00be }
            f19607a = r6     // Catch:{ all -> 0x00be }
            org.json.JSONObject r6 = f19609c     // Catch:{ all -> 0x00be }
    ...
    public static synchronized boolean isAdAvailableForInstance(C8108b bVar) {
        synchronized (IronSourceNetwork.class) {
            if (f19607a == null) {
                return false;
            }
            boolean a = f19607a.mo56679a(bVar);
            return a;
        }
    }

    public static synchronized void loadAd(Activity activity, C8108b bVar, Map<String, String> map) {
        synchronized (IronSourceNetwork.class) {
            m23153a();
            f19607a.mo56661a(activity, bVar, map);
        }
    }
    ...
    public static synchronized void setInitListener(C8317d dVar) {
        synchronized (IronSourceNetwork.class) {
            f19608b = dVar;
        }
    }

    public static synchronized void showAd(C8108b bVar, Map<String, String> map) {
        synchronized (IronSourceNetwork.class) {
            m23153a();
            f19607a.mo56663a(bVar, map);
        }
    }
    ...
    public static synchronized void updateMetadata(JSONObject jSONObject) {
        synchronized (IronSourceNetwork.class) {
            ...
            while (keys.hasNext()) {
                ...
                a.mo56783a("metadata_" + next, jSONObject.opt(next));
            }
        }
    }
}
