...
import com.ironsource.environment.p203d.C6379b;
...
public class ServerURL {
    ...
    public static String getCPVProvidersURL(Context context, String str, String str2, String str3, String str4, boolean z, Vector<Pair<String, String>> vector, boolean z2) {
        ...
        String c = C6372c.m19033c(context, context.getPackageName());
        ...
        ConcurrentHashMap<String, List<String>> d = C6356a.m18973a().mo35850d();
        ...
        String r = C6393h.m19136r();
        if (r.length() != 0) {
            vector2.add(new Pair(BROWSER_USER_AGENT, r));
        }
        String str5 = null;
        try {
            str5 = C6393h.m19097a(context) + "-" + C6393h.m19101b(context);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        if (context != null) {
            ...
            sb3.append(C6363a.C63641.m19014c(context));
            vector2.add(new Pair(MOBILE_COUNTRY_CODE, sb3.toString()));
            StringBuilder sb4 = new StringBuilder();
            sb4.append(C6363a.C63641.m19017d(context));
        ...
        C6379b bVar = new C6379b();
        JSONObject a = bVar.f16150b.mo36834a(bVar.f16149a);
        ...
        return getBaseUrl(IronSourceUtils.getSDKVersion()) + URLEncoder.encode(IronSourceAES.encode(C6741g.m20413a().mo36969b(), createURLParams(vector2)), "UTF-8");
    }
