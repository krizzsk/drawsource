...
public class HttpFunctions {
    ...
    /* renamed from: a */
    private static final ExecutorService f17532a = Executors.newSingleThreadExecutor();

    public static String getStringFromURL(String str) {
        return getStringFromURL(str, (C6459L.C6461a) null);
    }
    ...
    public static java.lang.String getStringFromURL(java.lang.String r4, com.ironsource.mediationsdk.C6459L.C6461a r5) {
        /*
            r0 = 0
            ...
            r5.mo36161a(r1)     // Catch:{ Exception -> 0x0079, all -> 0x0074 }
        L_0x002f:
    ...
    public static void sendPostRequest(String str, String str2, C6728a aVar) {
        sendPostRequestWithAutho(str, str2, (String) null, (String) null, aVar);
    }

    public static void sendPostRequestWithAutho(String str, String str2, String str3, String str4, C6728a aVar) {
        final String str5 = str;
        final String str6 = str3;
        final String str7 = str4;
        final String str8 = str2;
        final C6728a aVar2 = aVar;
        f17532a.submit(new Runnable() {
            ...
            public final void run() {
                ...
                L_0x0077:
                    ...
                    r4.mo36684a(r3)     // Catch:{ Exception -> 0x008c }
                ...
                L_0x0094:
                    ...
                    r3.mo36684a(r0)     // Catch:{ all -> 0x00c3 }
                ...
                L_0x00d3:
                    throw r0
                */
                throw new UnsupportedOperationException("Method not decompiled: com.ironsource.mediationsdk.server.HttpFunctions.C67271.run():void");
            }
        });
    }
}
