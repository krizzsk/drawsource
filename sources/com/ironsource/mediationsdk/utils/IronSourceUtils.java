...
import com.ironsource.mediationsdk.C6448H;
...
public class IronSourceUtils {
    ...
    private static final String SDK_VERSION = "7.2.4";
    ...
    public static String getDeviceType(Context context) {
        return C6393h.m19105c(context) ? "Tablet" : "Phone";
    }

    public static boolean getFirstSession(Context context) {
        if (mFirstSession == null) {
            mFirstSession = Boolean.valueOf(!C6448H.m19237b(context));
        }
    ...
    public static C6458K getIronSourceAdvId(Context context) {
        String str;
        if (context == null) {
            return null;
        }
        C6459L.m19304a();
        String a = C6459L.m19307a(context);
    ...
    public static String getMediationUserId() {
        return C6697e.m20344a().mo36912a(DataKeys.USER_ID);
    }

    public static JSONObject getProviderAdditionalData(C6611b bVar) {
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put(PROVIDER_PRIORITY, bVar.f17129n);
            jSONObject.put(IronSourceConstants.EVENTS_SUB_PROVIDER_ID, bVar.f17121f);
            jSONObject.put(IronSourceConstants.EVENTS_PROVIDER, !TextUtils.isEmpty(bVar.f17122g) ? bVar.f17122g : bVar.mo36622j());
            jSONObject.put(IronSourceConstants.EVENTS_PROVIDER_SDK_VERSION, bVar.f17117b.getCoreSDKVersion());
            jSONObject.put(IronSourceConstants.EVENTS_PROVIDER_ADAPTER_VERSION, bVar.f17117b.getVersion());
        } catch (Exception e) {
            IronSourceLoggerManager logger = IronSourceLoggerManager.getLogger();
            IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.NATIVE;
            logger.logException(ironSourceTag, "IronSourceUtils:getProviderAdditionalData(adapter: " + bVar.mo36622j() + ")", e);
        }
        return jSONObject;
    }

    public static JSONObject getProviderAdditionalData(C6686q qVar) {
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put(IronSourceConstants.EVENTS_SUB_PROVIDER_ID, qVar.f17468b.getSubProviderId());
            jSONObject.put(IronSourceConstants.EVENTS_PROVIDER, !TextUtils.isEmpty(qVar.f17468b.getAdSourceNameForEvents()) ? qVar.f17468b.getAdSourceNameForEvents() : qVar.mo36828a());
            jSONObject.put(IronSourceConstants.EVENTS_PROVIDER_SDK_VERSION, qVar.f17467a.getCoreSDKVersion());
            jSONObject.put(IronSourceConstants.EVENTS_PROVIDER_ADAPTER_VERSION, qVar.f17467a.getVersion());
            jSONObject.put(PROVIDER_PRIORITY, qVar.f17472f);
        } catch (Exception e) {
            IronSourceLoggerManager logger = IronSourceLoggerManager.getLogger();
            IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.NATIVE;
            logger.logException(ironSourceTag, "IronSourceUtils:getProviderAdditionalData(adapter: " + qVar.mo36828a() + ")", e);
        }
        return jSONObject;
    }
    ...
    public static String getTransId(long j, String str) {
        return getSHA256(String.format("%s%s%s", new Object[]{Long.valueOf(j), C6459L.m19304a().f16420j, str}));
    }

    public static String getUserIdForNetworks() {
        String a = C6697e.m20344a().mo36912a("userIdType");
        String a2 = C6697e.m20344a().mo36912a(DataKeys.USER_ID);
