...
public class IntegrationHelper {
    ...
    private static boolean m20200a(android.app.Activity r8, java.lang.String r9) {
        /*
        ...
        L_0x0063:
            ...
            r2.append(r3)     // Catch:{ Exception -> 0x015a }
            java.lang.String r2 = r2.toString()     // Catch:{ Exception -> 0x015a }
            com.ironsource.mediationsdk.IntegrationData r3 = m20204b((android.app.Activity) r8, (java.lang.String) r2)     // Catch:{ Exception -> 0x015a }
        ...
        L_0x0111:
            ...
            boolean r2 = m20205b((android.app.Activity) r8, (java.lang.String[]) r2)     // Catch:{ Exception -> 0x015a }
            java.util.ArrayList<android.util.Pair<java.lang.String, java.lang.String>> r4 = r3.externalLibs     // Catch:{ Exception -> 0x015a }
            boolean r4 = m20203a(r4)     // Catch:{ Exception -> 0x015a }
            if (r4 != 0) goto L_0x0120
            r2 = r1
        L_0x0120:
            java.lang.String[] r4 = r3.services     // Catch:{ Exception -> 0x015a }
            boolean r4 = m20201a((android.app.Activity) r8, (java.lang.String[]) r4)     // Catch:{ Exception -> 0x015a }
            if (r4 != 0) goto L_0x0129
            r2 = r1
        L_0x0129:
            java.lang.String[] r4 = r3.providers     // Catch:{ Exception -> 0x015a }
            boolean r4 = m20202a((android.content.Context) r8, (java.lang.String[]) r4)     // Catch:{ Exception -> 0x015a }
        ...
        L_0x015a:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ironsource.mediationsdk.integration.IntegrationHelper.m20200a(android.app.Activity, java.lang.String):boolean");
    }

    /* renamed from: a */
    private static boolean m20201a(Activity activity, String[] strArr) {
        boolean z = true;
        if (strArr == null) {
            return true;
        }
    ...
    /* renamed from: a */
    private static boolean m20202a(Context context, String[] strArr) {
        String str;
        boolean z;
    ...
    /* renamed from: a */
    private static boolean m20203a(ArrayList<Pair<String, String>> arrayList) {
        boolean z = true;
        if (arrayList == null) {
            return true;
        }
    ...
    /* renamed from: b */
    private static IntegrationData m20204b(Activity activity, String str) {
        String str2;
        try {
    ...
    /* renamed from: b */
    private static boolean m20205b(Activity activity, String[] strArr) {
        boolean z = true;
        if (strArr == null) {
            return true;
        }
    ...
    public static void validateIntegration(android.app.Activity r22) {
        ...
        L_0x006b:
            ...
            r5 = r2[r4]
            boolean r6 = m20200a((android.app.Activity) r0, (java.lang.String) r5)
            java.lang.String r7 = ">>>> "
