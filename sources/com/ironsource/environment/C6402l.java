...
public final class C6402l {
    ...
    /* renamed from: a */
    public static final ArrayList<String> f16200a = new ArrayList<>(Arrays.asList(new String[]{"applicationUserAgeGroup", "uAge", "advId", "appKey", "mCar", "medV", "connT", "dWidth", "dHeight", "dModel", "cTime", "sDepRV", "sDepIS", "sId", "plType", "dOSV", "dOSVF", "dOS", "dMake", "dAPI", "bId", "appV", "usId", "bat", "root", "diskFS", "dLang", "MD", "uGen", "advType", "isLAT", "dVol", "consent", "dHeight", "dWidth", "dScrenScle", "auid", "UA", "asid"}));

    /* renamed from: b */
    public static final HashMap<String, String> f16201b = new HashMap<String, String>() {
        {
