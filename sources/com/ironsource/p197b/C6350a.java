...
public final class C6350a extends SQLiteOpenHelper {

    /* renamed from: a */
    private static C6350a f16067a;

    /* renamed from: b */
    private final int f16068b = 4;

    /* renamed from: c */
    private final int f16069c = 400;

    /* renamed from: d */
    private final String f16070d = "DROP TABLE IF EXISTS events";

    /* renamed from: e */
    private final String f16071e = "CREATE TABLE events (_id INTEGER PRIMARY KEY,eventid INTEGER,timestamp INTEGER,type TEXT,data TEXT )";

    private C6350a(Context context, String str, int i) {
        super(context, str, (SQLiteDatabase.CursorFactory) null, i);
    }

    /* renamed from: a */
    private synchronized SQLiteDatabase m18966a(boolean z) {
        int i = 0;
        while (true) {
            if (z) {
                try {
    ...
    /* renamed from: a */
    public static synchronized C6350a m18967a(Context context, String str, int i) {
        C6350a aVar;
        synchronized (C6350a.class) {
            if (f16067a == null) {
                f16067a = new C6350a(context, str, 5);
            }
            aVar = f16067a;
        }
        return aVar;
    ...
    public final synchronized java.util.ArrayList<com.ironsource.mediationsdk.p206a.C6517c> mo35838a(java.lang.String r13) {
        /*
            r12 = this;
            monitor-enter(r12)
            ...
            r1 = 0
            r2 = 0
            android.database.sqlite.SQLiteDatabase r11 = r12.m18966a((boolean) r1)     // Catch:{ all -> 0x0079 }
        ...
        L_0x00b0:
            ...
            throw r13
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ironsource.p197b.C6350a.mo35838a(java.lang.String):java.util.ArrayList");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized void mo35839a(java.util.List<com.ironsource.mediationsdk.p206a.C6517c> r8, java.lang.String r9) {
        /*
            r7 = this;
            monitor-enter(r7)
        ...
        L_0x000b:
            r0 = 1
            r1 = 0
            android.database.sqlite.SQLiteDatabase r0 = r7.m18966a((boolean) r0)     // Catch:{ all -> 0x006d }
        ...
        L_0x0094:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ironsource.p197b.C6350a.mo35839a(java.util.List, java.lang.String):void");
    }

    /* renamed from: b */
    public final synchronized void mo35840b(String str) {
        SQLiteDatabase sQLiteDatabase = null;
        String[] strArr = {str};
        try {
            sQLiteDatabase = m18966a(true);
