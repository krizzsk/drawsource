...
import com.ironsource.sdk.C8115c;
...
public class IronSourceAdapter extends AbstractAdapter implements ContextProvider.C6361a, C6724j, C8318e {
    ...
    private static final String VERSION = "7.2.4";
    ...
    private com.ironsource.sdk.C8099a convertBannerSize(android.app.Activity r10, com.ironsource.mediationsdk.ISBannerSize r11) {
        /*
            r9 = this;
    ...
    private C8108b createBannerAdInstance(String str, C8099a aVar, JSONObject jSONObject) {
        ...
        C8115c cVar = new C8115c(str, ironSourceBannerListener);
        cVar.f19673d = getInitParams();
        cVar.f19671b = z;
        cVar.f19674e = optBoolean;
        cVar.f19672c = aVar;
        return cVar.mo56326a();
    }
    ...
    private HashMap<String, String> createBannerLoadParams(JSONObject jSONObject, String str) {
        ...
        if (str != null) {
            C6625f.m20163a();
            hashMap.put("adm", C6625f.m20173c(str));
            hashMap.put("isOneFlow", String.valueOf(jSONObject.optBoolean("isOneFlow")));
            C6625f.m20163a();
            hashMap.putAll(C6625f.m20171b(str));
        }
        return hashMap;
    }

    private C8108b getAdInstance(String str, boolean z, boolean z2, boolean z3) {
        C8115c cVar;
        C8108b bVar = (z3 ? this.mDemandSourceToRvAd : this.mDemandSourceToISAd).get(str);
        if (bVar == null) {
            IronLog ironLog = IronLog.ADAPTER_API;
            ...
            if (z3) {
                ...
                cVar = new C8115c(str, new IronSourceInterstitialListener(this.mDemandSourceToISSmash.get(str), str));
                cVar.f19673d = getInitParams();
            }
            cVar.f19671b = z2;
            bVar = cVar.mo56326a();
    ...
    private HashMap<String, String> getInitParams() {
        ...
        if (!TextUtils.isEmpty(C6459L.m19304a().f16426p)) {
            hashMap.put("sessionid", C6459L.m19304a().f16426p);
        }
        return hashMap;
    }
    ...
    private void initSDK(String str, JSONObject jSONObject) {
        if (mDidInitSdk.compareAndSet(false, true)) {
            ...
            HashMap<String, String> initParams = getInitParams();
            String str2 = C6459L.m19304a().f16420j;
            IronLog ironLog4 = IronLog.ADAPTER_API;
            ironLog4.verbose("with appKey=" + str2 + " userId=" + mediationUserId + " parameters " + initParams);
            IronSourceNetwork.setInitListener(new C8317d() {
                public void onFail(C8299e eVar) {
                    IronLog ironLog = IronLog.ADAPTER_API;
                    ironLog.verbose("OnNetworkSDKInitListener fail - code:" + eVar.f20258b + " message:" + eVar.f20257a);
                }
    ...
    private void loadAdInternal(String str, String str2, boolean z, boolean z2, boolean z3) {
        ...
        if (str2 != null) {
            C6625f.m20163a();
            hashMap.put("adm", C6625f.m20173c(str2));
            C6625f.m20163a();
            hashMap.putAll(C6625f.m20171b(str2));
        }
        C8108b adInstance = getAdInstance(str, z, z2, z3);
        printInstanceExtraParams(hashMap);
        IronLog ironLog = IronLog.ADAPTER_API;
        ironLog.verbose("demandSourceName=" + adInstance.f19647c);
    ...
    private void loadBannerInternal(ISBannerSize iSBannerSize, JSONObject jSONObject, BannerSmashListener bannerSmashListener, String str) {
        ...
        try {
            C8099a convertBannerSize = convertBannerSize(ContextProvider.getInstance().getCurrentActiveActivity(), iSBannerSize);
    ...
    private void showAdInternal(C8108b bVar, int i) {
        int b = C6753o.m20481a().mo36990b(i);
        HashMap hashMap = new HashMap();
        hashMap.put(IronSourceConstants.KEY_SESSION_DEPTH, String.valueOf(b));
        IronLog ironLog = IronLog.ADAPTER_API;
        ironLog.verbose("demandSourceName=" + bVar.f19647c + " showParams=" + hashMap);
    ...
    public void destroyBanner(JSONObject jSONObject) {
        ...
        C8116a aVar = this.mBannerAdContainer;
        if (aVar != null) {
            try {
                if (aVar.f19677a == null || aVar.f19677a.f19687d == null) {
        ...
        postOnUIThread(new Runnable() {
            public void run() {
                try {
                    ...
                    C6698f access$100 = IronSourceAdapter.this.mOfferwallListener;
                    access$100.mo36242a(false, ErrorBuilder.buildInitFailedError("Adapter initialization failure - " + IronSourceAdapter.this.getProviderName() + " - " + e.getMessage(), IronSourceConstants.OFFERWALL_AD_UNIT));
                }
            }
        });
    }
    ...
    public boolean isInterstitialReady(JSONObject jSONObject) {
        C8108b bVar = this.mDemandSourceToISAd.get(getDemandSourceName(jSONObject));
    ...
    public boolean isRewardedVideoAvailable(JSONObject jSONObject) {
        C8108b bVar = this.mDemandSourceToRvAd.get(getDemandSourceName(jSONObject));
        return bVar != null && IronSourceNetwork.isAdAvailableForInstance(bVar);
    }
    ...
    public void onOWAdClosed() {
        IronLog.ADAPTER_CALLBACK.verbose(getProviderName());
        C6698f fVar = this.mOfferwallListener;
        if (fVar != null) {
    ...
    public void onOfferwallInitFail(String str) {
        IronLog.ADAPTER_CALLBACK.verbose(getProviderName());
        if (this.mOfferwallListener != null) {
            this.mOfferwallListener.mo36242a(false, ErrorBuilder.buildGenericError(str));
        }
    }
    ...
    public void setInternalOfferwallListener(C6698f fVar) {
