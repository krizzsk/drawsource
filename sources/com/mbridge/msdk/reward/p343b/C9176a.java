package com.mbridge.msdk.reward.p343b;
...
public class C9176a {
    ...
    /* renamed from: a */
    public static final String f22508a = C9176a.class.getName();

    /* renamed from: b */
    private static String f22509b = "";

    /* renamed from: a */
    public static void m26118a(Context context, String str) {
        if (context != null) {
            try {
                ...
                if (!TextUtils.isEmpty(str) && a != null && a.mo57055a() > 0) {
                    ...
                    List<C8468m> a4 = a.mo57057a("2000039");
                    List<C8468m> a5 = a.mo57057a("2000043");
                    List<C8468m> a6 = a.mo57057a("2000045");
                    List<C8468m> a7 = a.mo57057a("2000044");
                    String a8 = C8468m.m24195a(a3);
                    String b = C8468m.m24197b(a2);
                    String f = C8468m.m24205f(a4);
                    String c = C8468m.m24199c(a5);
                    String d = C8468m.m24201d(a6);
                    String e = C8468m.m24203e(a7);
                    ...
                    if (!TextUtils.isEmpty(sb.toString())) {
                        ...
                        if (context != null && !TextUtils.isEmpty(sb2) && !TextUtils.isEmpty(str)) {
                            try {
                                ...
                                C8550d a9 = C8598e.m24661a(sb2, context, str);
                                a9.mo57981a("r_stid", C9638b.m27377a().mo63556b().mo63532a());
                                aVar.mo57978c(0, C8543d.m24463a().f20952a, a9, new C8597b() {
                                    /* renamed from: a */
                                    public final void mo37053a(String str) {
                                        C8672v.m24878d(C9176a.f22508a, str);
                                    }
                                ...
                                e2.printStackTrace();
                                C8672v.m24878d(f22508a, e2.getMessage());
                            }
                        }
                    }
                }
    ...
    /* renamed from: a */
    private static void m26119a(final Context context, final String str, String str2) {
        if (context != null && !TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2)) {
            try {
                ...
                e.printStackTrace();
                C8672v.m24878d(f22508a, e.getMessage());
            }
        }
    }

    /* renamed from: b */
    private static void m26123b(final Context context, final String str) {
        if (context != null && !TextUtils.isEmpty(str)) {
            try {
                C8596a aVar = new C8596a(context);
                C8550d a = C8598e.m24660a(str, context);
                a.mo57981a("r_stid", C9638b.m27377a().mo63556b().mo63532a());
                aVar.mo57978c(0, C8543d.m24463a().f20952a, a, new C8597b() {
                    /* renamed from: a */
                    public final void mo37053a(String str) {
    ...
    /* renamed from: a */
    public static void m26120a(Context context, List<CampaignEx> list, String str, long j) {
        C8672v.m24874a("test_load_time", "time: " + j);
        if (context != null && list != null) {
            try {
                if (!TextUtils.isEmpty(str)) {
                    if (list.size() > 0) {
                        String requestId = list.get(0).getRequestId();
                        if (TextUtils.isEmpty(f22509b) || !requestId.equals(f22509b)) {
                            f22509b = requestId;
                        } else {
                            return;
                        }
                    ...
                    if (list != null && list.size() > 0) {
                        ...
                        if (!(campaignEx2 == null || campaignEx2.getRewardTemplateMode() == null)) {
                            ...
                            try {
                                int l = C8677z.m24955l(campaignEx2.getRewardTemplateMode().mo57576e());
                                if (l != -1) {
                        ...
                        if (C8574b.m24577a().mo58054c()) {
                            ...
                            m26119a(context, stringBuffer.toString(), str);
                        }
                    }
                }
            } catch (Exception e) {
    ...
    /* renamed from: a */
    public static void m26121a(CampaignEx campaignEx, Context context, String str, String str2, boolean z, String str3, String str4) {
        if (context != null) {
            try {
                if (!TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2)) {
                    ...
                    if (!TextUtils.isEmpty(str2)) {
                        String str5 = C8388a.f20464c.get(str2);
                        StringBuilder sb = new StringBuilder();
                        sb.append("u_stid=");
                        if (str5 == null) {
                            str5 = "";
                    ...
                    if (!(campaignEx == null || campaignEx.getRewardTemplateMode() == null)) {
                        try {
                            int l = C8677z.m24955l(campaignEx.getRewardTemplateMode().mo57576e());
                            if (l != -1) {
                                stringBuffer.append("&view=");
                                stringBuffer.append(l);
                            }
                    ...
                    if (C8574b.m24577a().mo58054c()) {
                        ...
                        m26123b(context, stringBuffer.toString());
                    }
                }
            } catch (Throwable th) {
                th.printStackTrace();
    ...
    public static void m26117a(android.content.Context r4, com.mbridge.msdk.foundation.entity.CampaignEx r5, java.lang.String r6) {
        /*
        ...
        L_0x0033:
            ...
            r2.append(r3)     // Catch:{ all -> 0x0118 }
            int r3 = com.mbridge.msdk.foundation.tools.C8660r.m24840o(r4)     // Catch:{ all -> 0x0118 }
            r2.append(r3)     // Catch:{ all -> 0x0118 }
            r2.append(r1)     // Catch:{ all -> 0x0118 }
            java.lang.String r2 = r2.toString()     // Catch:{ all -> 0x0118 }
            r0.append(r2)     // Catch:{ all -> 0x0118 }
            ...
            java.lang.String r2 = r2.toString()     // Catch:{ all -> 0x0118 }
            r0.append(r2)     // Catch:{ all -> 0x0118 }
            boolean r2 = com.mbridge.msdk.foundation.tools.C8677z.m24930b((com.mbridge.msdk.foundation.entity.CampaignEx) r5)     // Catch:{ all -> 0x0118 }
        ...
        L_0x00db:
            ...
            java.lang.String r5 = r5.mo57576e()     // Catch:{ Exception -> 0x00fa }
            int r5 = com.mbridge.msdk.foundation.tools.C8677z.m24955l((java.lang.String) r5)     // Catch:{ Exception -> 0x00fa }
            r1 = -1
        ...
        L_0x00fa:
            com.mbridge.msdk.foundation.same.report.b r5 = com.mbridge.msdk.foundation.same.report.C8574b.m24577a()     // Catch:{ all -> 0x0118 }
            boolean r5 = r5.mo58054c()     // Catch:{ all -> 0x0118 }
            if (r5 == 0) goto L_0x0110
            com.mbridge.msdk.foundation.same.report.b r4 = com.mbridge.msdk.foundation.same.report.C8574b.m24577a()     // Catch:{ all -> 0x0118 }
            java.lang.String r5 = r0.toString()     // Catch:{ all -> 0x0118 }
            r4.mo58052a((java.lang.String) r5)     // Catch:{ all -> 0x0118 }
            goto L_0x011c
        L_0x0110:
            java.lang.String r5 = r0.toString()     // Catch:{ all -> 0x0118 }
            m26119a((android.content.Context) r4, (java.lang.String) r5, (java.lang.String) r6)     // Catch:{ all -> 0x0118 }
            goto L_0x011c
        L_0x0118:
            r4 = move-exception
            r4.printStackTrace()
        L_0x011c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.reward.p343b.C9176a.m26117a(android.content.Context, com.mbridge.msdk.foundation.entity.CampaignEx, java.lang.String):void");
    }
    ...
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static void m26124b(com.mbridge.msdk.foundation.entity.CampaignEx r4, android.content.Context r5, java.lang.String r6, java.lang.String r7, boolean r8, java.lang.String r9, java.lang.String r10) {
        /*
            java.lang.String r0 = "&"
            ...
            int r3 = com.mbridge.msdk.foundation.tools.C8660r.m24840o(r5)     // Catch:{ all -> 0x0138 }
            r2.append(r3)     // Catch:{ all -> 0x0138 }
            ...
            java.util.HashMap<java.lang.String, java.lang.String> r2 = com.mbridge.msdk.foundation.controller.C8388a.f20464c     // Catch:{ all -> 0x0138 }
        ...
        L_0x0076:
            java.lang.String r7 = com.mbridge.msdk.foundation.same.C8469a.f20750k     // Catch:{ all -> 0x0138 }
            ...
            java.lang.String r2 = com.mbridge.msdk.foundation.same.C8469a.f20750k     // Catch:{ all -> 0x0138 }
            r7.append(r2)     // Catch:{ all -> 0x0138 }
            r7.append(r0)     // Catch:{ all -> 0x0138 }
            java.lang.String r7 = r7.toString()     // Catch:{ all -> 0x0138 }
            r1.append(r7)     // Catch:{ all -> 0x0138 }
        L_0x0097:
            java.lang.String r7 = com.mbridge.msdk.foundation.same.C8469a.f20751l     // Catch:{ all -> 0x0138 }
            boolean r7 = android.text.TextUtils.isEmpty(r7)     // Catch:{ all -> 0x0138 }
            ...
            r7.append(r2)     // Catch:{ all -> 0x0138 }
            java.lang.String r2 = com.mbridge.msdk.foundation.same.C8469a.f20751l     // Catch:{ all -> 0x0138 }
            r7.append(r2)     // Catch:{ all -> 0x0138 }
            r7.append(r0)     // Catch:{ all -> 0x0138 }
            java.lang.String r7 = r7.toString()     // Catch:{ all -> 0x0138 }
            r1.append(r7)     // Catch:{ all -> 0x0138 }
        ...
        L_0x00e7:
            ...
            java.lang.String r4 = r4.mo57576e()     // Catch:{ Exception -> 0x011a }
            int r4 = com.mbridge.msdk.foundation.tools.C8677z.m24955l((java.lang.String) r4)     // Catch:{ Exception -> 0x011a }
            r6 = -1
        ...
        L_0x011a:
            com.mbridge.msdk.foundation.same.report.b r4 = com.mbridge.msdk.foundation.same.report.C8574b.m24577a()     // Catch:{ all -> 0x0138 }
            boolean r4 = r4.mo58054c()     // Catch:{ all -> 0x0138 }
            if (r4 == 0) goto L_0x0130
            com.mbridge.msdk.foundation.same.report.b r4 = com.mbridge.msdk.foundation.same.report.C8574b.m24577a()     // Catch:{ all -> 0x0138 }
            java.lang.String r5 = r1.toString()     // Catch:{ all -> 0x0138 }
            r4.mo58052a((java.lang.String) r5)     // Catch:{ all -> 0x0138 }
            goto L_0x013c
        L_0x0130:
            java.lang.String r4 = r1.toString()     // Catch:{ all -> 0x0138 }
            m26123b(r5, r4)     // Catch:{ all -> 0x0138 }
            goto L_0x013c
        L_0x0138:
            r4 = move-exception
            r4.printStackTrace()
        L_0x013c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.reward.p343b.C9176a.m26124b(com.mbridge.msdk.foundation.entity.CampaignEx, android.content.Context, java.lang.String, java.lang.String, boolean, java.lang.String, java.lang.String):void");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static void m26122a(com.mbridge.msdk.foundation.entity.CampaignEx r4, android.content.Context r5, java.lang.String r6, java.lang.String r7, boolean r8, java.lang.String r9, java.lang.String r10, long r11) {
        /*
            java.lang.String r0 = "&"
            ...
            int r3 = com.mbridge.msdk.foundation.tools.C8660r.m24840o(r5)     // Catch:{ all -> 0x0174 }
            r2.append(r3)     // Catch:{ all -> 0x0174 }
            ...
            if (r2 != 0) goto L_0x0076
            java.util.HashMap<java.lang.String, java.lang.String> r2 = com.mbridge.msdk.foundation.controller.C8388a.f20464c     // Catch:{ all -> 0x0174 }
        ...
        L_0x0076:
            java.lang.String r7 = com.mbridge.msdk.foundation.same.C8469a.f20750k     // Catch:{ all -> 0x0174 }
            ...
            java.lang.String r2 = com.mbridge.msdk.foundation.same.C8469a.f20750k     // Catch:{ all -> 0x0174 }
            r7.append(r2)     // Catch:{ all -> 0x0174 }
            r7.append(r0)     // Catch:{ all -> 0x0174 }
            java.lang.String r7 = r7.toString()     // Catch:{ all -> 0x0174 }
            r1.append(r7)     // Catch:{ all -> 0x0174 }
        L_0x0097:
            java.lang.String r7 = com.mbridge.msdk.foundation.same.C8469a.f20751l     // Catch:{ all -> 0x0174 }
            boolean r7 = android.text.TextUtils.isEmpty(r7)     // Catch:{ all -> 0x0174 }
            if (r7 != 0) goto L_0x00b8
            java.lang.StringBuilder r7 = new java.lang.StringBuilder     // Catch:{ all -> 0x0174 }
            r7.<init>()     // Catch:{ all -> 0x0174 }
            java.lang.String r2 = "c="
            r7.append(r2)     // Catch:{ all -> 0x0174 }
            java.lang.String r2 = com.mbridge.msdk.foundation.same.C8469a.f20751l     // Catch:{ all -> 0x0174 }
            r7.append(r2)     // Catch:{ all -> 0x0174 }
            r7.append(r0)     // Catch:{ all -> 0x0174 }
            java.lang.String r7 = r7.toString()     // Catch:{ all -> 0x0174 }
            r1.append(r7)     // Catch:{ all -> 0x0174 }
        ...
        L_0x011b:
            ...
            java.lang.String r4 = r4.mo57576e()     // Catch:{ Exception -> 0x0156 }
            int r4 = com.mbridge.msdk.foundation.tools.C8677z.m24955l((java.lang.String) r4)     // Catch:{ Exception -> 0x0156 }
            r6 = -1
        ...
        L_0x0156:
            com.mbridge.msdk.foundation.same.report.b r4 = com.mbridge.msdk.foundation.same.report.C8574b.m24577a()     // Catch:{ all -> 0x0174 }
            boolean r4 = r4.mo58054c()     // Catch:{ all -> 0x0174 }
            if (r4 == 0) goto L_0x016c
            com.mbridge.msdk.foundation.same.report.b r4 = com.mbridge.msdk.foundation.same.report.C8574b.m24577a()     // Catch:{ all -> 0x0174 }
            java.lang.String r5 = r1.toString()     // Catch:{ all -> 0x0174 }
            r4.mo58052a((java.lang.String) r5)     // Catch:{ all -> 0x0174 }
            goto L_0x0178
        L_0x016c:
            java.lang.String r4 = r1.toString()     // Catch:{ all -> 0x0174 }
            m26123b(r5, r4)     // Catch:{ all -> 0x0174 }
            goto L_0x0178
        L_0x0174:
            r4 = move-exception
            r4.printStackTrace()
        L_0x0178:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.reward.p343b.C9176a.m26122a(com.mbridge.msdk.foundation.entity.CampaignEx, android.content.Context, java.lang.String, java.lang.String, boolean, java.lang.String, java.lang.String, long):void");
    }
}
