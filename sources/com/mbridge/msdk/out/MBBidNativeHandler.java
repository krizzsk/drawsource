        ...
        if (TextUtils.isEmpty(str) && (aVar = this.adListener) != null) {
            ...
            if (list != null && list.size() > 0) {
                try {
                    ...
                    C8672v.m24877c("com.mbridge.msdk", "MBSDK set template error");
                }
            }
            try {
                this.properties.put(MBridgeConstans.PROPERTIES_HANDLER_CONTROLLER, this);
                if (this.nativeProvider == null) {
                    C8840a aVar2 = new C8840a(this.adListener, this.trackingListener);
                    this.nativeProvider = aVar2;
                    aVar2.mo58541a(this.context, (Resources) null, (Map<String, Object>) this.properties);
                }
                this.nativeProvider.mo58546a(str);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
