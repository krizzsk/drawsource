...
public class LoadingActivity extends Activity {
    ...
    private C8484c cipl = new C8484c() {
    ...
    private View initView() {
        if (this.rlayout_main == null) {
            ...
            int b = C8677z.m24924b((Context) this, 15.0f);
            ...
            this.rlayout.addView(new TextView(this), new RelativeLayout.LayoutParams(C8677z.m24924b((Context) this, 140.0f), C8677z.m24924b((Context) this, 31.5f)));
            MBImageView mBImageView = new MBImageView(this);
            this.img_icon = mBImageView;
            mBImageView.setId(C8677z.m24905a());
            this.img_icon.setTag(this.icon_url);
            if (!TextUtils.isEmpty(this.icon_url)) {
                C8481b.m24310a(getApplicationContext()).mo57883a(this.icon_url, this.cipl);
            }
            int b2 = C8677z.m24924b((Context) this, 64.0f);
