...
public class SameMD5 implements NoProGuard {
    ...
    public static byte[] getQftJSMD5Bytes(String str) throws UnsupportedEncodingException {
        ...
        byte[] bytes = str.getBytes(C5429C.UTF16LE_NAME);
        C8672v.m24876b("----", "b = " + ByteArrayToHexString(bytes));
        ...
        C8672v.m24876b("----", "source = " + ByteArrayToHexString(bArr));
        return bArr;
    }
    ...
    private static String HexEncode(byte[] bArr) {
        ...
        for (byte b : bArr) {
            ...
            sb.append(Integer.toHexString(b & Ascii.f18305SI));
        }
