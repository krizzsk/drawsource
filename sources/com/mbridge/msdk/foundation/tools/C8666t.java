...
import com.mbridge.msdk.foundation.same.p302c.C8488e;
...
public final class C8666t extends C8636f {
    ...
    private static long m24866c(java.io.File r4) throws java.lang.Exception {
        /*
            r0 = 0
            r2 = 0
        ...
        L_0x001b:
            ...
            com.mbridge.msdk.foundation.tools.C8672v.m24878d(r4, r3)     // Catch:{ Exception -> 0x0032 }
        L_0x0025:
        ...
        L_0x0046:
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.tools.C8666t.m24866c(java.io.File):long");
    }

    /* renamed from: d */
    private static long m24868d(File file) throws Exception {
        long j;
        ...
        if (listFiles != null) {
            for (int i = 0; i < listFiles.length; i++) {
                if (listFiles[i].isDirectory()) {
                    j = m24868d(listFiles[i]);
                } else {
                    j = m24866c(listFiles[i]);
                }
                j2 += j;
            }
        }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.lang.String m24856a(java.io.File r4) {
        /*
            r0 = 0
        ...
        L_0x0051:
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.tools.C8666t.m24856a(java.io.File):java.lang.String");
    }

    /* renamed from: a */
    public static boolean m24861a(String str) {
        if (C8488e.m24342a(str)) {
            return false;
        }
    ...
    /* renamed from: b */
    public static File[] m24865b(String str) {
        try {
            File file = new File(str);
            if (file.exists()) {
    ...
    /* renamed from: a */
    public static void m24858a() {
        new Thread(new Runnable() {
            public final void run() {
                try {
                    if (C8388a.m23845e().mo56913g() != null) {
                        String b = C8478e.m24306b(C8476c.MBRIDGE_VC);
                        try {
                            File file = new File(b);
                            if (file.exists() && file.isDirectory()) {
                                for (File file2 : C8666t.m24865b(b)) {
    ...
    /* renamed from: c */
    public static void m24867c(String str) {
        try {
            if (!TextUtils.isEmpty(str)) {
                ...
                long currentTimeMillis = System.currentTimeMillis() - ((long) (b.mo16157L() * 1000));
                File file = new File(str);
                if (file.exists() && file.isDirectory()) {
    ...
    /* renamed from: b */
    public static void m24864b() {
        C86682 r0 = new Runnable() {
            public final void run() {
                try {
                    C2440a b = C2445b.m6020a().mo16286b(C8388a.m23845e().mo56914h());
                    if (b == null) {
                    ...
                    C8666t.m24860a(C8478e.m24306b(C8476c.MBRIDGE_RES_MANAGER_DIR), b.mo16218d());
                    C8666t.m24859a(System.currentTimeMillis() - ((long) (b.mo16157L() * 1000)));
                } catch (Exception e) {
                    if (MBridgeConstans.DEBUG) {
                        e.printStackTrace();
                    }
    ...
    /* renamed from: b */
    public static String m24863b(File file) {
        try {
            if (file.isFile()) {
                file.delete();
                return "";
    ...
    /* renamed from: e */
    private static ArrayList<File> m24870e(File file) {
        ...
        for (File file2 : file.listFiles(new FileFilter() {
            ...
            if (!file2.isDirectory()) {
                ...
                arrayList.addAll(m24870e(file2));
            }
        }
        return arrayList;
    }
    ...
    /* renamed from: d */
    private static void m24869d(String str) {
        try {
            ArrayList<File> e = m24870e(new File(str));
            ...
            C8672v.m24878d("SameFileTool", "del memory failed");
        }
    }

    /* renamed from: a */
    public static void m24859a(long j) {
        try {
            Iterator<File> it = m24870e(new File(C8478e.m24306b(C8476c.MBRIDGE_RES_MANAGER_DIR))).iterator();
            while (it.hasNext()) {
                File next = it.next();
            ...
            C8672v.m24875a("SameFileTool", th.getMessage(), th);
        }
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static boolean m24862a(byte[] r2, java.io.File r3) {
        /*
            r0 = 0
        ...
        L_0x0048:
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.tools.C8666t.m24862a(byte[], java.io.File):boolean");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.lang.String m24857a(java.lang.String r8, java.lang.String r9) {
        /*
        ...
        L_0x0124:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.tools.C8666t.m24857a(java.lang.String, java.lang.String):java.lang.String");
    }

    /* renamed from: a */
    static /* synthetic */ void m24860a(String str, int i) {
        try {
            if (m24868d(new File(str)) > ((long) (i * 1048576))) {
                m24869d(str);
            }
        } catch (Exception e) {
            e.printStackTrace();
        } catch (Throwable unused) {
            C8672v.m24878d("SameFileTool", "clean memory failed");
        }
    }
}
