...
public final class C8675y extends C8637g {

    /* renamed from: a */
    public static boolean f21253a = false;

    /* renamed from: b */
    public static char[] f21254b = {'a', 'n', 'd', 'r', 'o', 'i', 'd', 'c', 'o', 'n', 't', 'e', 'n', 't', 'p', 'm', 'g', 'e', 't', 'C', 'o', 'n', 't', 'e', 'x', 't'};

    /* renamed from: com.mbridge.msdk.foundation.tools.y$a */
    /* compiled from: SameSDKTool */
    public static class C8676a {
        /* renamed from: a */
        private static Intent m24898a(Context context) {
            return new Intent("android.intent.action.VIEW", Uri.parse("market://details?id=com.package.name"));
        }

        /* renamed from: b */
        private static List<ResolveInfo> m24901b(Context context) {
            try {
                return context.getPackageManager().queryIntentActivities(m24898a(context), 0);
            } catch (Exception e) {
                e.printStackTrace();
                return null;
            }
        ...
        /* renamed from: a */
        public static boolean m24900a(String str) {
            return m24902b(str) || m24903c(str);
        }

        /* renamed from: b */
        public static boolean m24902b(String str) {
            try {
                ...
                C8672v.m24878d("SDKUtil", Log.getStackTraceString(th));
                return false;
            }
        }

        /* renamed from: c */
        private static boolean m24903c(String str) {
            Uri parse;
            try {
        ...
        /* renamed from: a */
        public static boolean m24899a(Context context, String str, NativeListener.NativeTrackingListener nativeTrackingListener) {
            try {
                List<ResolveInfo> b = m24901b(context);
                if (b != null) {
                    if (b.size() > 0) {
                        if (!m24902b(str)) {
                            if (m24903c(str)) {
                        ...
                        C8675y.m24896a(nativeTrackingListener);
                        return true;
                    }
                }
                return false;
    ...
    /* renamed from: a */
    public static void m24896a(NativeListener.NativeTrackingListener nativeTrackingListener) {
    ...
    public static void m24895a(android.content.Context r8, java.lang.String r9, com.mbridge.msdk.out.NativeListener.NativeTrackingListener r10) {
        /*
        ...
        L_0x0022:
            ...
            m24897b(r8, r9, r10)     // Catch:{ Exception -> 0x00a5 }
            goto L_0x00af
        L_0x0049:
        ...
        L_0x0068:
            ...
            m24896a((com.mbridge.msdk.out.NativeListener.NativeTrackingListener) r10)     // Catch:{ Exception -> 0x006f }
            goto L_0x00af
        L_0x006f:
            java.lang.String r9 = r9.replace(r7, r6)     // Catch:{ Exception -> 0x00a5 }
            java.lang.StringBuilder r0 = new java.lang.StringBuilder     // Catch:{ Exception -> 0x00a5 }
        ...
        L_0x0086:
            ...
            r0.append(r9)     // Catch:{ Exception -> 0x00a5 }
            java.lang.String r9 = r0.toString()     // Catch:{ Exception -> 0x00a5 }
            m24895a(r8, r9, r10)     // Catch:{ Exception -> 0x00a5 }
            goto L_0x00af
        L_0x00a5:
            r8 = move-exception
            java.lang.String r8 = r8.getMessage()
            java.lang.String r9 = "SDKUtil"
            com.mbridge.msdk.foundation.tools.C8672v.m24878d(r9, r8)
        L_0x00af:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.tools.C8675y.m24895a(android.content.Context, java.lang.String, com.mbridge.msdk.out.NativeListener$NativeTrackingListener):void");
    }

    /* renamed from: a */
    public static void m24894a(Context context, String str, CampaignEx campaignEx, NativeListener.NativeTrackingListener nativeTrackingListener) {
        if (context != null) {
            if (f21253a) {
                m24897b(context, str, nativeTrackingListener);
                return;
            }
            try {
                ...
                if (!TextUtils.isEmpty(str)) {
                    if (C8676a.m24902b(str)) {
                        str = "https://play.google.com/store/apps/details?id=" + str.replace("market://details?id=", "");
                    }
                    intent.putExtra("url", str);
                    C8672v.m24876b("url", "webview url = " + str);
    ...
    /* renamed from: b */
    public static void m24897b(Context context, String str, NativeListener.NativeTrackingListener nativeTrackingListener) {
        if (str != null && context != null) {
            try {
                ...
                context.startActivity(intent);
                m24896a(nativeTrackingListener);
            } catch (Exception e) {
                e.printStackTrace();
                try {
    ...
    /* renamed from: a */
    public static String m24893a(String str) {
        if (TextUtils.isEmpty(str)) {
            return null;
        }
        File a = C8478e.m24303a(C8476c.MBRIDGE_700_IMG);
        String str2 = "";
        if (!TextUtils.isEmpty(str)) {
