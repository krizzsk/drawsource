...
public class CampaignUnit implements NoProGuard, Serializable {
    ...
    public String assembCParams() {
        ...
        try {
            ...
            if (C8395a.m23879a().mo56941a(MBridgeConstans.AUTHORITY_GENERAL_DATA)) {
                str2 = String.valueOf(C8660r.m24840o(C8388a.m23845e().mo56913g()));
                str = C8660r.m24829i(C8388a.m23845e().mo56913g()) + "x" + C8660r.m24831j(C8388a.m23845e().mo56913g());
            } else {
                str2 = "";
                str = str2;
            }
            ...
            stringBuffer2.append("|");
            stringBuffer2.append(nullToEmpty(C8660r.m24814c()));
            stringBuffer2.append("|");
            stringBuffer2.append(nullToEmpty(str));
            stringBuffer2.append("|");
            stringBuffer2.append(nullToEmpty(Integer.valueOf(C8660r.m24819e(C8388a.m23845e().mo56913g()))));
            stringBuffer2.append("|");
            stringBuffer2.append(nullToEmpty(C8660r.m24817d(C8388a.m23845e().mo56913g())));
            stringBuffer2.append("|");
            ...
            stringBuffer2.append("|");
            stringBuffer2.append(nullToEmpty(C8660r.m24820e()));
            stringBuffer2.append("|");
            stringBuffer2.append(nullToEmpty(""));
            stringBuffer2.append("|");
            stringBuffer2.append("");
            ...
            stringBuffer2.append(nullToEmpty(""));
            stringBuffer2.append("|");
            stringBuffer2.append(nullToEmpty(C8469a.f20750k + "," + C8469a.f20751l));
            stringBuffer2.append("|");
    ...
    private static void getSysIDAndBKUPID(org.json.JSONObject r9) {
        /*
            ...
            com.mbridge.msdk.foundation.same.b.c r3 = com.mbridge.msdk.foundation.same.p301b.C8476c.MBRIDGE_700_CONFIG     // Catch:{ Exception -> 0x0020 }
            java.lang.String r3 = com.mbridge.msdk.foundation.same.p301b.C8478e.m24306b(r3)     // Catch:{ Exception -> 0x0020 }
            java.lang.String r4 = com.mbridge.msdk.foundation.tools.C8659q.m24802b(r2)     // Catch:{ Exception -> 0x0020 }
        ...
        L_0x0020:
            ...
            com.mbridge.msdk.foundation.controller.a r2 = com.mbridge.msdk.foundation.controller.C8388a.m23845e()     // Catch:{ Exception -> 0x0084 }
            android.content.Context r2 = r2.mo56913g()     // Catch:{ Exception -> 0x0084 }
            ...
            java.lang.String r6 = com.mbridge.msdk.foundation.same.C8469a.f20750k     // Catch:{ Exception -> 0x0084 }
            boolean r6 = android.text.TextUtils.equals(r6, r2)     // Catch:{ Exception -> 0x0084 }
            if (r6 != 0) goto L_0x005c
            com.mbridge.msdk.foundation.same.C8469a.f20750k = r2     // Catch:{ Exception -> 0x0084 }
            com.mbridge.msdk.foundation.a.a.a r2 = com.mbridge.msdk.foundation.p083a.p084a.C2461a.m6124a()     // Catch:{ Exception -> 0x0084 }
            java.lang.String r6 = com.mbridge.msdk.foundation.same.C8469a.f20750k     // Catch:{ Exception -> 0x0084 }
            r2.mo16388a((java.lang.String) r5, (java.lang.String) r6)     // Catch:{ Exception -> 0x0084 }
            java.lang.String r2 = com.mbridge.msdk.foundation.tools.C8659q.m24802b(r3)     // Catch:{ Exception -> 0x005c }
            java.lang.String r3 = com.mbridge.msdk.foundation.same.C8469a.f20750k     // Catch:{ Exception -> 0x005c }
        ...
        L_0x005c:
            ...
            if (r2 != 0) goto L_0x010a
            java.lang.String r2 = com.mbridge.msdk.foundation.same.C8469a.f20751l     // Catch:{ Exception -> 0x0084 }
            boolean r2 = android.text.TextUtils.equals(r2, r9)     // Catch:{ Exception -> 0x0084 }
            if (r2 != 0) goto L_0x010a
            com.mbridge.msdk.foundation.same.C8469a.f20751l = r9     // Catch:{ Exception -> 0x0084 }
            com.mbridge.msdk.foundation.a.a.a r9 = com.mbridge.msdk.foundation.p083a.p084a.C2461a.m6124a()     // Catch:{ Exception -> 0x0084 }
            java.lang.String r2 = com.mbridge.msdk.foundation.same.C8469a.f20751l     // Catch:{ Exception -> 0x0084 }
            r9.mo16388a((java.lang.String) r4, (java.lang.String) r2)     // Catch:{ Exception -> 0x0084 }
            java.lang.String r9 = com.mbridge.msdk.foundation.tools.C8659q.m24802b(r0)     // Catch:{ Exception -> 0x010a }
            java.lang.String r0 = com.mbridge.msdk.foundation.same.C8469a.f20751l     // Catch:{ Exception -> 0x010a }
        ...
        L_0x0084:
            ...
            goto L_0x010a
        L_0x008a:
            com.mbridge.msdk.foundation.controller.a r1 = com.mbridge.msdk.foundation.controller.C8388a.m23845e()     // Catch:{ Exception -> 0x0106 }
            android.content.Context r1 = r1.mo56913g()     // Catch:{ Exception -> 0x0106 }
            if (r9 == 0) goto L_0x010a
            ...
            java.lang.String r7 = com.mbridge.msdk.foundation.same.C8469a.f20750k     // Catch:{ Exception -> 0x0106 }
            boolean r7 = android.text.TextUtils.equals(r7, r6)     // Catch:{ Exception -> 0x0106 }
            if (r7 != 0) goto L_0x00ce
            com.mbridge.msdk.foundation.same.C8469a.f20750k = r6     // Catch:{ Exception -> 0x0106 }
            com.mbridge.msdk.foundation.a.a.a r6 = com.mbridge.msdk.foundation.p083a.p084a.C2461a.m6124a()     // Catch:{ Exception -> 0x0106 }
            java.lang.String r7 = com.mbridge.msdk.foundation.same.C8469a.f20750k     // Catch:{ Exception -> 0x0106 }
            r6.mo16388a((java.lang.String) r5, (java.lang.String) r7)     // Catch:{ Exception -> 0x0106 }
            java.lang.String r5 = com.mbridge.msdk.foundation.tools.C8659q.m24802b(r2)     // Catch:{ Exception -> 0x0106 }
            ...
            java.lang.String r3 = com.mbridge.msdk.foundation.tools.C8659q.m24802b(r3)     // Catch:{ Exception -> 0x0106 }
            java.lang.String r6 = com.mbridge.msdk.foundation.same.C8469a.f20750k     // Catch:{ Exception -> 0x0106 }
        ...
        L_0x00ce:
            ...
            java.lang.String r3 = com.mbridge.msdk.foundation.same.C8469a.f20751l     // Catch:{ Exception -> 0x0106 }
            boolean r3 = android.text.TextUtils.equals(r3, r9)     // Catch:{ Exception -> 0x0106 }
            if (r3 != 0) goto L_0x010a
            com.mbridge.msdk.foundation.same.C8469a.f20751l = r9     // Catch:{ Exception -> 0x0106 }
            com.mbridge.msdk.foundation.a.a.a r9 = com.mbridge.msdk.foundation.p083a.p084a.C2461a.m6124a()     // Catch:{ Exception -> 0x0106 }
            java.lang.String r3 = com.mbridge.msdk.foundation.same.C8469a.f20751l     // Catch:{ Exception -> 0x0106 }
            r9.mo16388a((java.lang.String) r4, (java.lang.String) r3)     // Catch:{ Exception -> 0x0106 }
            java.lang.String r9 = com.mbridge.msdk.foundation.tools.C8659q.m24802b(r2)     // Catch:{ Exception -> 0x0106 }
            ...
            java.lang.String r0 = com.mbridge.msdk.foundation.tools.C8659q.m24802b(r0)     // Catch:{ Exception -> 0x0106 }
            java.lang.String r1 = com.mbridge.msdk.foundation.same.C8469a.f20751l     // Catch:{ Exception -> 0x0106 }
    ...
    public static com.mbridge.msdk.foundation.entity.CampaignUnit parseCampaignUnit(org.json.JSONObject r37, java.lang.String r38) {
        ...
        L_0x00be:
            ...
            org.json.JSONObject r9 = r0.optJSONObject(r9)     // Catch:{ Exception -> 0x0393 }
            com.mbridge.msdk.foundation.db.a.a r11 = com.mbridge.msdk.foundation.p298db.p299a.C8404a.m23901a()     // Catch:{ Exception -> 0x0393 }
            r12 = 1
            r11.mo56964a(r9, r12)     // Catch:{ Exception -> 0x0393 }
