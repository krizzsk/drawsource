...
public class CampaignEx extends DomainCampaignEx implements NoProGuard, Serializable {
    ...
    private C8453b mediaViewHolder;
    private String mof_template_url;
    private int mof_tplid;

    /* renamed from: mp */
    private String f20570mp;
    private String mraid;
    private C8464i nativeVideoTracking;
    ...
    private C8454c rewardTemplateMode;
    ...
    public static final class C8453b implements Serializable {

        /* renamed from: a */
        public boolean f20585a = false;
        ...
        /* renamed from: f */
        public boolean f20590f = false;

        /* renamed from: g */
        public boolean f20591g = false;

        /* renamed from: h */
        public boolean f20592h = false;

        /* renamed from: i */
        public boolean f20593i = false;

        /* renamed from: j */
        public boolean f20594j = false;

        /* renamed from: k */
        public boolean f20595k = false;

        /* renamed from: l */
        public Map<Integer, String> f20596l;
    }
    ...
    public void setAdZip(String str) {
        this.adZip = str;
        boolean h = C8677z.m24948h(str);
        int l = C8677z.m24955l(str);
        if (h) {
            setDynamicView(true);
    ...
    public void setDynamicTempCode(int i) {
        this.dynamicTempCode = C8677z.m24923b(i);
    }
    ...
    public C8452a getAdchoice() {
        return this.adchoice;
    }

    public void setAdchoice(C8452a aVar) {
        this.adchoice = aVar;
    }
    ...
    public void setendcard_url(String str) {
        ...
        if (TextUtils.isEmpty(this.mof_template_url) && (((cVar = this.rewardTemplateMode) == null || TextUtils.isEmpty(cVar.f20601e)) && !TextUtils.isEmpty(str) && str.contains(KEY_IS_CMPT_ENTRY))) {
            setCMPTEntryUrl(str);
        }
        setCanStartMoreOfferAnim(C8677z.m24954k(str));
    }
    ...
    public C8464i getNativeVideoTracking() {
        return this.nativeVideoTracking;
    }

    public void setNativeVideoTracking(C8464i iVar) {
    ...
    public C8453b getMediaViewHolder() {
        return this.mediaViewHolder;
    }

    public void setMediaViewHolder(C8453b bVar) {
        this.mediaViewHolder = bVar;
    }

    public C8454c getRewardTemplateMode() {
        return this.rewardTemplateMode;
    }

    public void setRewardTemplateMode(C8454c cVar) {
        this.rewardTemplateMode = cVar;
        if (cVar != null && !TextUtils.isEmpty(cVar.mo57576e())) {
            if (TextUtils.isEmpty(this.mof_template_url) && cVar.mo57576e().contains(KEY_IS_CMPT_ENTRY)) {
                setCMPTEntryUrl(cVar.mo57576e());
            }
            boolean h = C8677z.m24948h(cVar.mo57576e());
            int l = C8677z.m24955l(cVar.mo57576e());
            if (h) {
                setDynamicView(true);
                setDynamicTempCode(l);
            }
    ...
    private static boolean isBreakCampainOrSetItByEndCard(CampaignEx campaignEx, String str) {
        ...
        if (C8388a.m23845e().mo56917k() == 2 && "1".equals(Uri.parse(str).getQueryParameter("dpwgl"))) {
            return true;
        }
    ...
    public static CampaignEx parseCampaignWithBackData(JSONObject jSONObject) {
        ...
        if (jSONObject != null) {
            ...
            try {
                ...
                campaignEx.setRewardTemplateMode(C8454c.m24038a(jSONObject.optJSONObject(JSON_KEY_REWARD_TEMPLATE)));
                ...
                campaignEx.setAdchoice(C8452a.m24027a(jSONObject.optString(KEY_ADCHOICE, "")));
                campaignEx.setPlct(jSONObject.optLong(JSON_KEY_PLCT));
                campaignEx.setPlctb(jSONObject.optLong(JSON_KEY_PLCTB));
    ...
    private static JSONObject dealV5Temp(JSONObject jSONObject) {
        ...
        try {
            ...
            for (int i = 0; i < optJSONArray.length(); i++) {
                JSONObject a = C8404a.m23901a().mo56963a(optJSONArray.getString(i));
                if (a != null) {
            ...
            try {
                ...
                if (!TextUtils.isEmpty(optString2)) {
                    if (z) {
                        ...
                        campaignEx2.setVideoUrlEncode(C8659q.m24802b(optString2));
                    }
                }
                ...
                campaignEx2.setRewardTemplateMode(C8454c.m24038a(dealV5Temp.optJSONObject(JSON_KEY_REWARD_TEMPLATE)));
                ...
                campaignEx2.setAdchoice(C8452a.m24027a(dealV5Temp.optString(KEY_ADCHOICE, "")));
                ...
                try {
                    parseCampaign.setImpressionURL(C8677z.m24910a(C8388a.m23845e().mo56913g(), parseCampaign.getPackageName(), parseCampaign.getImpressionURL()));
                } catch (Exception e) {
                    try {
                        C8672v.m24878d("campaign", e.getMessage());
                    } catch (Exception e2) {
                        e = e2;
    ...
    public static C8464i TrackingStr2Object(String str) {
        try {
            if (!TextUtils.isEmpty(str)) {
                JSONObject jSONObject = new JSONObject(str);
                C8464i iVar = new C8464i();
                iVar.mo57780o(processNativeVideoTrackingArray(jSONObject.optJSONArray("impression")));
                iVar.mo57758d(processNativeVideoTrackingArray(jSONObject.optJSONArray("start")));
                iVar.mo57760e(processNativeVideoTrackingArray(jSONObject.optJSONArray(JSON_NATIVE_VIDEO_FIRST_QUARTILE)));
                iVar.mo57762f(processNativeVideoTrackingArray(jSONObject.optJSONArray("midpoint")));
                iVar.mo57764g(processNativeVideoTrackingArray(jSONObject.optJSONArray(JSON_NATIVE_VIDEO_THIRD_QUARTILE)));
                iVar.mo57766h(processNativeVideoTrackingArray(jSONObject.optJSONArray("complete")));
                iVar.mo57751a(parsePlayCentage(jSONObject.optJSONArray(JSON_NATIVE_VIDEO_PLAY_PERCENTAGE)));
                iVar.mo57768i(processNativeVideoTrackingArray(jSONObject.optJSONArray("mute")));
                iVar.mo57770j(processNativeVideoTrackingArray(jSONObject.optJSONArray("unmute")));
                iVar.mo57772k(processNativeVideoTrackingArray(jSONObject.optJSONArray("click")));
                iVar.mo57774l(processNativeVideoTrackingArray(jSONObject.optJSONArray(JSON_NATIVE_VIDEO_PAUSE)));
                iVar.mo57776m(processNativeVideoTrackingArray(jSONObject.optJSONArray(JSON_NATIVE_VIDEO_RESUME)));
                iVar.mo57778n(processNativeVideoTrackingArray(jSONObject.optJSONArray("error")));
                iVar.mo57782p(processNativeVideoTrackingArray(jSONObject.optJSONArray(JSON_NATIVE_VIDEO_ENDCARD)));
                iVar.mo57784r(processNativeVideoTrackingArray(jSONObject.optJSONArray("close")));
                iVar.mo57783q(processNativeVideoTrackingArray(jSONObject.optJSONArray(JSON_NATIVE_VIDEO_ENDCARD_SHOW)));
                iVar.mo57785s(processNativeVideoTrackingArray(jSONObject.optJSONArray("video_click")));
                iVar.mo57756c(processNativeVideoTrackingArray(jSONObject.optJSONArray(JSON_KEY_AD_TRACKING_IMPRESSION_T2)));
                iVar.mo57752a(processNativeVideoTrackingArray(jSONObject.optJSONArray(JSON_KEY_AD_TRACKING_DROPOUT_TRACK)));
                iVar.mo57755b(processNativeVideoTrackingArray(jSONObject.optJSONArray(JSON_KEY_AD_TRACKING_PLYCMPT_TRACK)));
    ...
    public static JSONObject campaignToJsonObject(CampaignEx campaignEx) throws JSONException {
        ...
        if (C8616ad.m24718b(campaignEx.getNativeVideoTrackingString())) {
        ...
        if (!(campaignEx == null || campaignEx.getRewardTemplateMode() == null || !C8616ad.m24718b(campaignEx.getRewardTemplateMode().mo57572a()))) {
            jSONObject.put(JSON_KEY_REWARD_TEMPLATE, new JSONObject(campaignEx.getRewardTemplateMode().mo57572a()));
        }
        ...
        C8452a adchoice2 = campaignEx.getAdchoice();
        if (adchoice2 != null) {
            jSONObject.put(KEY_ADCHOICE, new JSONObject(adchoice2.mo57568c()));
        }
        ...
        try {
            jSONObject.put("misk_spt", C8677z.m24939e());
            jSONObject.put("misk_spt_det", C8677z.m24943f());
        } catch (JSONException unused) {
        }
    ...
    public void setMof_template_url(String str) {
        ...
        if (!TextUtils.isEmpty(str)) {
            ...
            setCanStart2C1Anim(C8677z.m24954k(str));
        }
    }
    ...
    public static final class C8454c implements Serializable {
        ...
        /* renamed from: f */
        private List<C8455a> f20602f;

        /* renamed from: com.mbridge.msdk.foundation.entity.CampaignEx$c$a */
        public static final class C8455a implements Serializable {

            /* renamed from: a */
            public String f20603a;

            /* renamed from: b */
            public List<String> f20604b = new ArrayList();
        }

        private C8454c(String str) {
            this.f20597a = str;
        }

        /* renamed from: a */
        public final String mo57572a() {
            return this.f20597a;
        }

        /* renamed from: b */
        public final int mo57573b() {
            return this.f20598b;
        }

        /* renamed from: c */
        public final int mo57574c() {
            return this.f20599c;
        }

        /* renamed from: d */
        public final String mo57575d() {
            return this.f20600d;
        }

        /* renamed from: e */
        public final String mo57576e() {
            return this.f20601e;
        }

        /* renamed from: f */
        public final List<C8455a> mo57577f() {
            return this.f20602f;
        }

        /* renamed from: a */
        public static C8454c m24037a(String str) {
            try {
                if (C8616ad.m24718b(str)) {
                    return m24038a(new JSONObject(str));
                }
                return null;
            } catch (Throwable unused) {
                return null;
        ...
        /* renamed from: a */
        public static C8454c m24038a(JSONObject jSONObject) {
            if (jSONObject == null) {
                return null;
            }
            try {
                if (!C8616ad.m24718b(jSONObject.toString())) {
                    return null;
                }
                C8454c cVar = new C8454c(jSONObject.toString());
                cVar.f20598b = jSONObject.optInt("video_template", 1);
                cVar.f20601e = jSONObject.optString(AdvertisementDBAdapter.AdvertisementColumns.COLUMN_TEMPLATE_URL);
                cVar.f20599c = jSONObject.optInt(TJAdUnitConstants.String.ORIENTATION);
                cVar.f20600d = jSONObject.optString("paused_url");
                ...
                if (optJSONObject != null) {
                    ...
                    while (keys != null && keys.hasNext()) {
                        String next = keys.next();
                        List<String> b = C8677z.m24927b(optJSONObject.optJSONArray(next));
                        if (b != null && b.size() > 0) {
                            C8455a aVar = new C8455a();
                            aVar.f20603a = next;
                            aVar.f20604b.addAll(b);
                            arrayList.add(aVar);
                        }
                    }
                    cVar.f20602f = arrayList;
                }
                return cVar;
            } catch (Throwable unused) {
                return null;
    ...
    public static final class C8452a implements Serializable {
        ...
        /* renamed from: i */
        private int f20582i = 0;

        /* renamed from: j */
        private int f20583j = 0;

        /* renamed from: k */
        private String f20584k = "";

        /* renamed from: a */
        public final int mo57566a() {
            return this.f20582i;
        }

        /* renamed from: b */
        public final int mo57567b() {
            return this.f20583j;
        }

        /* renamed from: c */
        public final String mo57568c() {
            return this.f20584k;
        }

        /* renamed from: d */
        public final String mo57569d() {
            return this.f20575b;
        }

        /* renamed from: e */
        public final String mo57570e() {
            return this.f20576c;
        }

        /* renamed from: f */
        public final String mo57571f() {
            return this.f20577d;
        }

        /* renamed from: a */
        public static C8452a m24027a(String str) {
            try {
                if (TextUtils.isEmpty(str)) {
                    return null;
                }
                return m24028a(new JSONObject(str));
            } catch (Exception e) {
        ...
        private static com.mbridge.msdk.foundation.entity.CampaignEx.C8452a m24028a(org.json.JSONObject r3) {
            /*
                r0 = 0
                ...
                r1.f20576c = r0     // Catch:{ Exception -> 0x005f, all -> 0x005c }
                java.lang.String r0 = "adchoice_link"
                java.lang.String r0 = r3.optString(r0)     // Catch:{ Exception -> 0x005f, all -> 0x005c }
                r1.f20575b = r0     // Catch:{ Exception -> 0x005f, all -> 0x005c }
                java.lang.String r0 = "adchoice_size"
                java.lang.String r0 = r3.optString(r0)     // Catch:{ Exception -> 0x005f, all -> 0x005c }
                r1.f20577d = r0     // Catch:{ Exception -> 0x005f, all -> 0x005c }
                java.lang.String r2 = "ad_logo_link"
                java.lang.String r2 = r3.optString(r2)     // Catch:{ Exception -> 0x005f, all -> 0x005c }
                r1.f20574a = r2     // Catch:{ Exception -> 0x005f, all -> 0x005c }
                java.lang.String r2 = "adv_logo"
                java.lang.String r2 = r3.optString(r2)     // Catch:{ Exception -> 0x005f, all -> 0x005c }
                r1.f20581h = r2     // Catch:{ Exception -> 0x005f, all -> 0x005c }
                java.lang.String r2 = "adv_name"
                java.lang.String r2 = r3.optString(r2)     // Catch:{ Exception -> 0x005f, all -> 0x005c }
                r1.f20580g = r2     // Catch:{ Exception -> 0x005f, all -> 0x005c }
                java.lang.String r2 = "platform_logo"
                java.lang.String r2 = r3.optString(r2)     // Catch:{ Exception -> 0x005f, all -> 0x005c }
                r1.f20579f = r2     // Catch:{ Exception -> 0x005f, all -> 0x005c }
                java.lang.String r2 = "platform_name"
                java.lang.String r2 = r3.optString(r2)     // Catch:{ Exception -> 0x005f, all -> 0x005c }
                r1.f20578e = r2     // Catch:{ Exception -> 0x005f, all -> 0x005c }
                int r2 = m24029b(r0)     // Catch:{ Exception -> 0x005f, all -> 0x005c }
                r1.f20583j = r2     // Catch:{ Exception -> 0x005f, all -> 0x005c }
                int r0 = m24030c(r0)     // Catch:{ Exception -> 0x005f, all -> 0x005c }
                r1.f20582i = r0     // Catch:{ Exception -> 0x005f, all -> 0x005c }
                java.lang.String r3 = r3.toString()     // Catch:{ Exception -> 0x005f, all -> 0x005c }
                r1.f20584k = r3     // Catch:{ Exception -> 0x005f, all -> 0x005c }
                r0 = r1
                goto L_0x0073
            L_0x005c:
                r3 = move-exception
            ...
            L_0x0073:
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.entity.CampaignEx.C8452a.m24028a(org.json.JSONObject):com.mbridge.msdk.foundation.entity.CampaignEx$a");
        }

        /* renamed from: b */
        private static int m24029b(String str) {
            String[] split;
            if (TextUtils.isEmpty(str)) {
                return 0;
            }
        ...
        /* renamed from: c */
        private static int m24030c(String str) {
            String[] split;
            if (TextUtils.isEmpty(str)) {
                return 0;
            }
