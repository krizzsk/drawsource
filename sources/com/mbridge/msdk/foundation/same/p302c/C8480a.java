...
public final class C8480a {
    /* renamed from: a */
    public static Bitmap m24308a(String str) {
        Bitmap bitmap = null;
        if (!C8666t.m24861a(str)) {
            return null;
        }
    ...
    public static java.io.InputStream m24309a(android.graphics.Bitmap r4) {
        /*
            r0 = 0
        ...
        L_0x0050:
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.same.p302c.C8480a.m24309a(android.graphics.Bitmap):java.io.InputStream");
    }
}
