...
public final class C8470a implements C8472c<String, Bitmap> {

    /* renamed from: a */
    private final LinkedHashMap<String, Bitmap> f20766a;
    ...
    public final /* synthetic */ void mo37076a(Object obj) {
        ...
        if (str != null) {
            synchronized (this) {
                Bitmap bitmap = (Bitmap) this.f20766a.remove(str);
                if (bitmap != null) {
                    this.f20768c -= m24258b(str, bitmap);
                }
            }
            return;
        }
    ...
    public C8470a(int i) {
        if (i > 0) {
            this.f20767b = i;
            this.f20766a = new LinkedHashMap<>(0, 0.75f, true);
            return;
        }
    ...
    public android.graphics.Bitmap mo37079b(java.lang.String r2) {
        /*
            r1 = this;
            if (r2 == 0) goto L_0x001b
            monitor-enter(r1)
            java.util.LinkedHashMap<java.lang.String, android.graphics.Bitmap> r0 = r1.f20766a     // Catch:{ all -> 0x0018 }
        ...
        L_0x001b:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.same.p300a.C8470a.mo37079b(java.lang.String):android.graphics.Bitmap");
    }

    /* access modifiers changed from: private */
    /* renamed from: a */
    public boolean mo37077a(String str, Bitmap bitmap) {
        if (str == null || bitmap == null) {
            throw new NullPointerException("key == null || value == null");
        }
        synchronized (this) {
            this.f20768c += m24258b(str, bitmap);
            Bitmap bitmap2 = (Bitmap) this.f20766a.put(str, bitmap);
            if (bitmap2 != null) {
                this.f20768c -= m24258b(str, bitmap2);
            }
        }
        m24256a(this.f20767b);
        return true;
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void m24256a(int r4) {
        /*
            r3 = this;
        L_0x0000:
            monitor-enter(r3)
            int r0 = r3.f20768c     // Catch:{ all -> 0x0075 }
            if (r0 < 0) goto L_0x0056
            java.util.LinkedHashMap<java.lang.String, android.graphics.Bitmap> r0 = r3.f20766a     // Catch:{ all -> 0x0075 }
        ...
        L_0x0032:
            ...
            int r0 = r3.m24258b(r1, r0)     // Catch:{ all -> 0x0052 }
            java.util.LinkedHashMap<java.lang.String, android.graphics.Bitmap> r2 = r3.f20766a     // Catch:{ all -> 0x0052 }
            ...
            int r1 = r3.f20768c     // Catch:{ all -> 0x0052 }
            int r1 = r1 - r0
            r3.f20768c = r1     // Catch:{ all -> 0x0052 }
        L_0x0052:
            monitor-exit(r3)     // Catch:{ all -> 0x0075 }
            goto L_0x0000
        L_0x0054:
        ...
        L_0x0075:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.same.p300a.C8470a.m24256a(int):void");
    }
    ...
    public final Collection<String> mo37075a() {
        HashSet hashSet;
        synchronized (this) {
            hashSet = new HashSet(this.f20766a.keySet());
        }
        return hashSet;
    }
    ...
    /* renamed from: b */
    private int m24258b(String str, Bitmap bitmap) {
        return bitmap.getRowBytes() * bitmap.getHeight();
    }

    public final synchronized String toString() {
        return String.format("LruCache[maxSize=%d]", new Object[]{Integer.valueOf(this.f20767b)});
    }
}
