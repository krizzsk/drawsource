...
public class C8410e extends C8403a<Campaign> {

    /* renamed from: a */
    private static final String f20531a = C8410e.class.getName();

    /* renamed from: b */
    private static C8410e f20532b = null;

    /* renamed from: c */
    private final String f20533c = "rid";

    /* renamed from: d */
    private final String f20534d = BidResponsedEx.KEY_CID;

    /* renamed from: e */
    private final String f20535e = CampaignEx.JSON_KEY_PLCT;

    /* renamed from: f */
    private final String f20536f = CampaignEx.JSON_KEY_PLCTB;

    /* renamed from: g */
    private final String f20537g = "timestamp";

    /* renamed from: h */
    private final String f20538h = "ridCount";

    /* renamed from: i */
    private final String f20539i = " WHERE ";

    /* renamed from: j */
    private final String f20540j = " AND ";

    /* renamed from: k */
    private final String f20541k = "SELECT ";

    /* renamed from: l */
    private final String f20542l = "*";

    /* renamed from: m */
    private final String f20543m = " FROM ";

    /* renamed from: n */
    private final String f20544n = " AND readyState = '0'";

    /* renamed from: o */
    private final String f20545o = " AND is_bid_campaign = 1";

    /* renamed from: p */
    private final String f20546p = " order by ts ASC";

    /* renamed from: q */
    private final String f20547q = " group by request_id";

    /* renamed from: r */
    private final String f20548r = " group by bid_token";

    private C8410e(C8412f fVar) {
        super(fVar);
    }

    /* renamed from: a */
    public static synchronized C8410e m23925a(C8412f fVar) {
        C8410e eVar;
        synchronized (C8410e.class) {
            if (f20532b == null) {
                f20532b = new C8410e(fVar);
            }
            eVar = f20532b;
        }
        return eVar;
    ...
    /* renamed from: a */
    public final synchronized void mo56987a(String str, int i, int i2) {
        try {
            ...
            C8672v.m24878d("CampaignDao", e.getLocalizedMessage());
        }
        return;
    }

    /* renamed from: a */
    public final synchronized void mo56988a(String str, int i, int i2, boolean z) {
        try {
            String str2 = "unitid = " + str + " AND " + "level" + " = " + i + " AND " + "adSource" + " = " + i2;
    ...
    /* renamed from: a */
    public final synchronized void mo56993a(String str, List<CampaignEx> list) {
        if (list != null) {
            if (list.size() > 0) {
    ...
    /* renamed from: a */
    public final synchronized void mo56996a(String str, List<CampaignEx> list, boolean z) {
        if (list != null) {
            if (list.size() > 0) {
                for (CampaignEx next : list) {
                    try {
    ...
    public final synchronized void mo56994a(java.lang.String r6, java.util.List<com.mbridge.msdk.foundation.entity.CampaignEx> r7, java.lang.String r8, int r9) {
        /*
            r5 = this;
            monitor-enter(r5)
        ...
        L_0x0088:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p298db.C8410e.mo56994a(java.lang.String, java.util.List, java.lang.String, int):void");
    }

    /* renamed from: a */
    public final synchronized void mo56995a(String str, List<CampaignEx> list, List<CampaignEx> list2, boolean z) {
        String str2;
        if (getWritableDatabase() != null) {
            if (list != null) {
                try {
                    ...
                    try {
                        C8672v.m24878d("CampaignDao", e2.getLocalizedMessage());
                        return;
                    } catch (Throwable th) {
                        throw th;
                    }
            ...
            if (list2 != null && list2.size() > 0) {
                for (CampaignEx next2 : list2) {
                    try {
                        ...
                        C8672v.m24878d("CampaignDao", e3.getLocalizedMessage());
                    }
                }
            }
        } else {
    ...
    /* renamed from: b */
    public final synchronized void mo57005b(String str, List<CampaignEx> list) {
        if (list != null) {
            if (list.size() > 0) {
                for (CampaignEx next : list) {
                    try {
    ...
    /* renamed from: a */
    public final synchronized void mo56990a(String str, String str2) {
        try {
    ...
    /* renamed from: a */
    public final synchronized void mo56986a(String str) {
    ...
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized java.util.List<com.mbridge.msdk.foundation.entity.CampaignEx> mo57000b(java.lang.String r4) {
        /*
            r3 = this;
            monitor-enter(r3)
            r0 = 0
        ...
        L_0x004c:
            ...
            com.mbridge.msdk.foundation.entity.CampaignEx r2 = r3.m23926a((android.database.Cursor) r4)     // Catch:{ Exception -> 0x006a, all -> 0x0068 }
        ...
        L_0x006a:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p298db.C8410e.mo57000b(java.lang.String):java.util.List");
    }

    /* renamed from: a */
    public final synchronized void mo56997a(List<CampaignEx> list, String str) {
        if (list != null) {
            if (list.size() > 0) {
                for (CampaignEx next : list) {
                    try {
    ...
    /* renamed from: a */
    public final synchronized void mo56992a(String str, String str2, boolean z, String str3) {
        try {
            StringBuilder sb = new StringBuilder();
            sb.append("id = '");
            sb.append(str);
    ...
    /* renamed from: b */
    public final synchronized void mo57004b(String str, String str2) {
        try {
            if (getWritableDatabase() != null) {
    ...
    /* renamed from: a */
    public final synchronized void mo56991a(String str, String str2, int i, int i2, boolean z) {
        String str3;
        try {
    ...
    /* renamed from: c */
    public final synchronized void mo57008c(String str) {
        try {
    ...
    /* renamed from: a */
    public final synchronized void mo56989a(String str, int i, boolean z) {
        String str2;
        if (z) {
            try {
    ...
    /* renamed from: a */
    public final synchronized void mo56984a() {
        try {
    ...
    /* renamed from: a */
    public final synchronized void mo56985a(long j, String str) {
        try {
            ...
            C8672v.m24878d(f20531a, e.getMessage());
        }
        return;
    }

    /* renamed from: b */
    public final synchronized void mo57003b(long j, String str) {
        try {
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized void mo56998a(java.util.List<com.mbridge.msdk.foundation.entity.CampaignEx> r2, java.lang.String r3, java.lang.String r4, int r5) {
        /*
            r1 = this;
            monitor-enter(r1)
        ...
        L_0x0016:
            ...
            r1.m23924a((com.mbridge.msdk.foundation.entity.CampaignEx) r0, (java.lang.String) r3, (java.lang.String) r4, (int) r5)     // Catch:{ all -> 0x0028 }
            goto L_0x0016
        L_0x0026:
            monitor-exit(r1)
            return
        ...
        L_0x002b:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p298db.C8410e.mo56998a(java.util.List, java.lang.String, java.lang.String, int):void");
    }

    /* renamed from: a */
    private synchronized long m23924a(CampaignEx campaignEx, String str, String str2, int i) {
        if (campaignEx == null) {
            return 0;
        }
        try {
            ...
            if (campaignEx.getRewardTemplateMode() != null) {
                contentValues.put("reward_teamplate", campaignEx.getRewardTemplateMode().mo57572a());
            }
            ...
            CampaignEx.C8452a adchoice = campaignEx.getAdchoice();
            if (adchoice != null) {
                contentValues.put(CampaignEx.KEY_ADCHOICE, adchoice.mo57568c());
                contentValues.put("adchoice_size_height", Integer.valueOf(adchoice.mo57567b()));
                contentValues.put("adchoice_size_width", Integer.valueOf(adchoice.mo57566a()));
            }
    ...
    /* renamed from: a */
    public final synchronized long mo56980a(CampaignEx campaignEx, String str, int i) {
        String str2;
        if (campaignEx == null) {
            return 0;
        }
        try {
            ...
            contentValues.put(CampaignEx.JSON_KEY_TP_OFFER, Integer.valueOf(campaignEx.getTpOffer()));
            contentValues.put(CampaignEx.JSON_KEY_FAC, Integer.valueOf(campaignEx.getFac()));
            if (mo56999a(campaignEx.getId(), campaignEx.getTab(), str, i, campaignEx.getType(), campaignEx.isBidCampaign())) {
    ...
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized void mo57006b(final java.util.List<com.mbridge.msdk.foundation.entity.CampaignEx> r3, final java.lang.String r4) {
        /*
            r2 = this;
            monitor-enter(r2)
        ...
        L_0x001c:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p298db.C8410e.mo57006b(java.util.List, java.lang.String):void");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized int mo56979a(java.lang.String r10, long r11) {
        /*
            r9 = this;
            monitor-enter(r9)
            r0 = 0
            com.mbridge.msdk.c.b r1 = com.mbridge.msdk.p078c.C2445b.m6020a()     // Catch:{ Exception -> 0x005a, all -> 0x0057 }
            com.mbridge.msdk.foundation.controller.a r2 = com.mbridge.msdk.foundation.controller.C8388a.m23845e()     // Catch:{ Exception -> 0x005a, all -> 0x0057 }
            java.lang.String r2 = r2.mo56914h()     // Catch:{ Exception -> 0x005a, all -> 0x0057 }
            com.mbridge.msdk.c.a r1 = r1.mo16286b(r2)     // Catch:{ Exception -> 0x005a, all -> 0x0057 }
            if (r1 != 0) goto L_0x001c
            com.mbridge.msdk.c.b r1 = com.mbridge.msdk.p078c.C2445b.m6020a()     // Catch:{ Exception -> 0x005a, all -> 0x0057 }
            com.mbridge.msdk.c.a r1 = r1.mo16285b()     // Catch:{ Exception -> 0x005a, all -> 0x0057 }
        L_0x001c:
            long r1 = r1.mo16156K()     // Catch:{ Exception -> 0x005a, all -> 0x0057 }
            r3 = 1000(0x3e8, double:4.94E-321)
            long r1 = r1 * r3
            r9.mo56985a((long) r1, (java.lang.String) r10)     // Catch:{ Exception -> 0x005a, all -> 0x0057 }
            r5 = 0
            r6 = 0
            r7 = 1
            r8 = 0
            r3 = r9
            r4 = r10
            java.util.List r10 = r3.mo56983a((java.lang.String) r4, (int) r5, (int) r6, (int) r7, (boolean) r8)     // Catch:{ Exception -> 0x005a, all -> 0x0057 }
        ...
        L_0x005a:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p298db.C8410e.mo56979a(java.lang.String, long):int");
    }

    /* renamed from: a */
    public final synchronized boolean mo56999a(String str, int i, String str2, int i2, int i3, boolean z) {
        String str3;
        if (z) {
    ...
    /* renamed from: a */
    public final List<CampaignEx> mo56981a(String str, int i, int i2, int i3) {
        String str2;
        ...
        return m23927f("SELECT * FROM campaign" + str3 + str2);
    }

    /* renamed from: a */
    public final synchronized List<CampaignEx> mo56983a(String str, int i, int i2, int i3, boolean z) {
        String str2;
        String str3;
        ...
        return m23927f("SELECT * FROM campaign" + str2 + str3);
    }

    /* renamed from: a */
    public final synchronized List<CampaignEx> mo56982a(String str, int i, int i2, int i3, String str2) {
        String str3;
        String str4;
        ...
        return m23927f("SELECT * FROM campaign" + (str3 + " order by ts ASC") + str4);
    }

    /* renamed from: b */
    public final synchronized List<CampaignEx> mo57001b(String str, int i, int i2, int i3) {
        String str2;
        String str3;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:33:0x05ee, code lost:
        return r1;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:35:0x05f1, code lost:
        if (r10 != null) goto L_0x05f3;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:37:?, code lost:
        r10.close();
     */
    /* JADX WARNING: Code restructure failed: missing block: B:45:0x0607, code lost:
        if (r10 != null) goto L_0x05f3;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:47:0x060b, code lost:
        return null;
     */
    /* JADX WARNING: Removed duplicated region for block: B:50:0x060f A[SYNTHETIC, Splitter:B:50:0x060f] */
    /* renamed from: f */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private synchronized java.util.List<com.mbridge.msdk.foundation.entity.CampaignEx> m23927f(java.lang.String r10) {
        /*
            r9 = this;
            monitor-enter(r9)
            r0 = 0
            android.database.sqlite.SQLiteDatabase r1 = r9.getReadableDatabase()     // Catch:{ Exception -> 0x05fc, all -> 0x05f7 }
            android.database.Cursor r10 = r1.rawQuery(r10, r0)     // Catch:{ Exception -> 0x05fc, all -> 0x05f7 }
            if (r10 == 0) goto L_0x05f1
            int r1 = r10.getCount()     // Catch:{ Exception -> 0x05ef }
            if (r1 <= 0) goto L_0x05f1
            java.util.ArrayList r1 = new java.util.ArrayList     // Catch:{ Exception -> 0x05ef }
            r1.<init>()     // Catch:{ Exception -> 0x05ef }
        L_0x0017:
            boolean r2 = r10.moveToNext()     // Catch:{ Exception -> 0x05ef }
            if (r2 == 0) goto L_0x05e8
            com.mbridge.msdk.foundation.entity.CampaignEx r2 = new com.mbridge.msdk.foundation.entity.CampaignEx     // Catch:{ Exception -> 0x05ef }
            r2.<init>()     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "pv_urls"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            boolean r4 = android.text.TextUtils.isEmpty(r3)     // Catch:{ Exception -> 0x05ef }
            r5 = 0
            if (r4 != 0) goto L_0x0051
            org.json.JSONArray r4 = new org.json.JSONArray     // Catch:{ Exception -> 0x05ef }
            r4.<init>(r3)     // Catch:{ Exception -> 0x05ef }
            java.util.ArrayList r3 = new java.util.ArrayList     // Catch:{ Exception -> 0x05ef }
            r3.<init>()     // Catch:{ Exception -> 0x05ef }
            r6 = r5
        L_0x003e:
            int r7 = r4.length()     // Catch:{ Exception -> 0x05ef }
            if (r6 >= r7) goto L_0x004e
            java.lang.String r7 = r4.getString(r6)     // Catch:{ Exception -> 0x05ef }
            r3.add(r7)     // Catch:{ Exception -> 0x05ef }
            int r6 = r6 + 1
            goto L_0x003e
        L_0x004e:
            r2.setPv_urls(r3)     // Catch:{ Exception -> 0x05ef }
        L_0x0051:
            java.lang.String r3 = "id"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setId(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "tab"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setTab(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "package_name"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setPackageName(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "app_name"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setAppName(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "app_desc"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setAppDesc(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "app_size"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setSize(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "image_size"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setImageSize(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "icon_url"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setIconUrl(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "image_url"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setImageUrl(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "impression_url"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setImpressionURL(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "notice_url"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setNoticeUrl(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "download_url"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setClickURL(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "wtick"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setWtick(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "deeplink_url"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setDeepLinkUrl(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "user_activation"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            boolean r3 = java.lang.Boolean.parseBoolean(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setUserActivation(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "only_impression"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setOnlyImpressionURL(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "template"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setTemplate(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "landing_type"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setLandingType(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "link_type"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setLinkType(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "click_mode"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setClick_mode(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "star"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            double r3 = java.lang.Double.parseDouble(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setRating(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "number_rating"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setNumberRating(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "cti"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setClickInterval(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "ts"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            long r3 = r10.getLong(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setTimestamp(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "level"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setCacheLevel(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "adSource"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setType(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "ad_call"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setAdCall(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "fc_a"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setFca(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "fc_b"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setFcb(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "ad_url_list"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setAd_url_list(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "video_length"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setVideoLength(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "video_size"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setVideoSize(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "video_resolution"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setVideoResolution(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "endcard_click_result"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setEndcard_click_result(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "video_url"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setVideoUrlEncode(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "watch_mile"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setWatchMile(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "t_imp"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setTImp(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "bty"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setBty(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "advImp"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setAdvImp(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "offer_type"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setOfferType(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "guidelines"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setGuidelines(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "html_url"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setHtmlUrl(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "end_screen_url"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setEndScreenUrl(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "reward_name"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setRewardName(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "reward_amount"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setRewardAmount(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "reward_play_status"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setRewardPlayStatus(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "retarget"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setRetarget_offer(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "unitid"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setCampaignUnitId(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "native_ad_tracking"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            com.mbridge.msdk.foundation.entity.i r3 = com.mbridge.msdk.foundation.entity.CampaignEx.TrackingStr2Object(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setNativeVideoTracking(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "native_ad_tracking"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setNativeVideoTrackingString(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "video_end_type"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setVideo_end_type(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "endcard_url"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setendcard_url(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "playable_ads_without_video"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setPlayable_ads_without_video(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "reward_teamplate"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            com.mbridge.msdk.foundation.entity.CampaignEx$c r3 = com.mbridge.msdk.foundation.entity.CampaignEx.C8454c.m24037a((java.lang.String) r3)     // Catch:{ Exception -> 0x05ef }
            r2.setRewardTemplateMode(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "md5_file"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setVideoMD5Value(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "gif_url"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setGifUrl(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "nv_t2"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setNvT2(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "c_coi"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setClickTimeOutInterval(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "c_ua"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setcUA(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "imp_ua"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setImpUA(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "oc_time"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setOc_time(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "oc_type"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setOc_type(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "t_list"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setT_list(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "gh_id"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setGhId(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "gh_path"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setGhPath(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "bind_id"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setBindId(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "adchoice"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            boolean r4 = android.text.TextUtils.isEmpty(r3)     // Catch:{ Exception -> 0x05ef }
            if (r4 != 0) goto L_0x03d2
            com.mbridge.msdk.foundation.entity.CampaignEx$a r3 = com.mbridge.msdk.foundation.entity.CampaignEx.C8452a.m24027a((java.lang.String) r3)     // Catch:{ Exception -> 0x05ef }
            r2.setAdchoice(r3)     // Catch:{ Exception -> 0x05ef }
        L_0x03d2:
            java.lang.String r3 = "adchoice_size_height"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setAdchoiceSizeHeight(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "adchoice_size_width"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setAdchoiceSizeWidth(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "plct"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            long r3 = r10.getLong(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setPlct(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "plctb"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            long r3 = r10.getLong(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setPlctb(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "ad_zip"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setAdZip(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "ad_html"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setAdHtml(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "banner_url"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setBannerUrl(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "banner_html"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setBannerHtml(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "creative_id"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            long r3 = r10.getLong(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setCreativeId(r3)     // Catch:{ Exception -> 0x05ef }
        ...
        L_0x0456:
            r3 = r5
        L_0x0457:
            r2.setIsBidCampaign(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "bid_token"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setBidToken(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "ad_type"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setAdType(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "fac"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setFac(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "tp_offer"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setTpOffer(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "mraid"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setMraid(r3)     // Catch:{ Exception -> 0x05ef }
            ...
            r5 = r4
        L_0x04a8:
            r2.setIsMraid(r5)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "omid"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setOmid(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "ready_rate"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setReady_rate(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "ext_data"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setExt_data(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "nscpt"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setNscpt(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "mof_template_url"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setMof_template_url(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "mof_tplid"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setMof_tplid(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "req_ext_data"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setReq_ext_data(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "readyState"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setReadyState(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "load_timeout"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setLoadTimeoutState(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "placement_id"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setPlacementId(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "maitve"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setMaitve(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "maitve_src"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setMaitve_src(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "flb"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setFlb(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "flb_skiptime"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setFlbSkipTime(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "cbd"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setCbd(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "vst"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setVst(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "adspace_t"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setAdSpaceT(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "vcn"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setVcn(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "token_r"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setTokenRule(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "encrypt_p"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setEncryptPrice(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "vck_t"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setVideoCheckType(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "vctn_t"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setVideoCtnType(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "rs_ignc_r"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = r10.getString(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setRsIgnoreCheckRuleByString(r3)     // Catch:{ Exception -> 0x05ef }
            java.lang.String r3 = "view_com_time"
            int r3 = r10.getColumnIndex(r3)     // Catch:{ Exception -> 0x05ef }
            int r3 = r10.getInt(r3)     // Catch:{ Exception -> 0x05ef }
            r2.setVideoCompleteTime(r3)     // Catch:{ Exception -> 0x05ef }
            r1.add(r2)     // Catch:{ Exception -> 0x05ef }
            goto L_0x0017
        L_0x05e8:
        ...
        L_0x05fe:
            ...
            java.lang.String r1 = r1.getLocalizedMessage()     // Catch:{ all -> 0x060c }
            com.mbridge.msdk.foundation.tools.C8672v.m24878d(r2, r1)     // Catch:{ all -> 0x060c }
            if (r10 == 0) goto L_0x060a
            goto L_0x05f3
        L_0x060a:
            monitor-exit(r9)
        ...
        L_0x0613:
            ...
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p298db.C8410e.m23927f(java.lang.String):java.util.List");
    }
    ...
    /* renamed from: d */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final java.util.List<com.mbridge.msdk.foundation.entity.C8457b> mo57009d(java.lang.String r10) {
        /*
            r9 = this;
        ...
        L_0x00d1:
            ...
            r10.mo57678b((java.lang.String) r2)     // Catch:{ Exception -> 0x0127 }
            r10.mo57680c((int) r4)     // Catch:{ Exception -> 0x0127 }
            r10.mo57681c((long) r6)     // Catch:{ Exception -> 0x0127 }
            r10.mo57671a((int) r5)     // Catch:{ Exception -> 0x0127 }
            r10.mo57676b((int) r8)     // Catch:{ Exception -> 0x0127 }
            boolean r2 = android.text.TextUtils.isEmpty(r3)     // Catch:{ Exception -> 0x0127 }
            if (r2 != 0) goto L_0x011b
            r10.mo57673a((java.lang.String) r3)     // Catch:{ Exception -> 0x0127 }
        L_0x011b:
        ...
        L_0x0127:
            ...
            com.mbridge.msdk.foundation.tools.C8672v.m24878d(r2, r10)     // Catch:{ all -> 0x0125 }
            if (r1 == 0) goto L_0x0136
        L_0x0133:
            r1.close()
        L_0x0136:
        ...
        L_0x013c:
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p298db.C8410e.mo57009d(java.lang.String):java.util.List");
    }

    /* renamed from: c */
    public final int mo57007c(String str, String str2) {
        String str3;
        if (!TextUtils.isEmpty(str)) {
    ...
    /* renamed from: e */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final java.util.concurrent.ConcurrentHashMap<java.lang.String, com.mbridge.msdk.foundation.entity.C8457b> mo57011e(java.lang.String r11) {
        /*
            r10 = this;
        ...
        L_0x008c:
            ...
            com.mbridge.msdk.foundation.entity.b r9 = (com.mbridge.msdk.foundation.entity.C8457b) r9     // Catch:{ Exception -> 0x0114 }
            if (r9 == 0) goto L_0x008c
            r9.mo57678b((java.lang.String) r11)     // Catch:{ Exception -> 0x0114 }
            r9.mo57672a((long) r3)     // Catch:{ Exception -> 0x0114 }
            r9.mo57677b((long) r5)     // Catch:{ Exception -> 0x0114 }
            r9.mo57681c((long) r7)     // Catch:{ Exception -> 0x0114 }
            java.util.List r11 = r9.mo57679c()     // Catch:{ Exception -> 0x0114 }
        ...
        L_0x00ec:
            ...
            r9.mo57674a((java.util.List<java.lang.String>) r3)     // Catch:{ Exception -> 0x0114 }
        ...
        L_0x0114:
            ...
            com.mbridge.msdk.foundation.tools.C8672v.m24878d(r2, r11)     // Catch:{ all -> 0x0112 }
            if (r1 == 0) goto L_0x0123
        L_0x0120:
            r1.close()
        L_0x0123:
        ...
        L_0x0129:
            throw r11
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p298db.C8410e.mo57011e(java.lang.String):java.util.concurrent.ConcurrentHashMap");
    }

    /* renamed from: a */
    private CampaignEx m23926a(Cursor cursor) {
        ...
        campaignEx.setRewardTemplateMode(CampaignEx.C8454c.m24037a(cursor.getString(cursor.getColumnIndex("reward_teamplate"))));
        ...
        if (!TextUtils.isEmpty(string2)) {
            campaignEx.setAdchoice(CampaignEx.C8452a.m24027a(string2));
        }
    ...
    /* renamed from: d */
    public final synchronized void mo57010d(String str, String str2) {
        try {
            if (!TextUtils.isEmpty(str)) {
    ...
    /* renamed from: e */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized void mo57012e(java.lang.String r4, java.lang.String r5) {
        /*
            r3 = this;
            monitor-enter(r3)
        ...
        L_0x005e:
            ...
            com.mbridge.msdk.foundation.tools.C8672v.m24878d(r5, r4)     // Catch:{ all -> 0x005c }
        L_0x0068:
            monitor-exit(r3)
            return
        L_0x006a:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p298db.C8410e.mo57012e(java.lang.String, java.lang.String):void");
    }
    ...
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final java.util.List<com.mbridge.msdk.foundation.entity.CampaignEx> mo57002b(java.lang.String r4, int r5, boolean r6) {
        /*
            r3 = this;
            r0 = 0
        ...
        L_0x005e:
            ...
            com.mbridge.msdk.foundation.entity.CampaignEx r6 = r3.m23926a((android.database.Cursor) r4)     // Catch:{ Exception -> 0x006e, all -> 0x0072 }
        ...
        L_0x0084:
            ...
            com.mbridge.msdk.foundation.tools.C8672v.m24878d(r6, r4)     // Catch:{ all -> 0x0094 }
        ...
        L_0x009a:
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p298db.C8410e.mo57002b(java.lang.String, int, boolean):java.util.List");
    }
}
