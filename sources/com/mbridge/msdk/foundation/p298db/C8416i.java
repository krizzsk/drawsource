...
public final class C8416i extends C8403a<C8460e> {

    /* renamed from: a */
    private static C8416i f20557a;

    private C8416i(C8412f fVar) {
        super(fVar);
    }

    /* renamed from: a */
    public static synchronized C8416i m23982a(C8412f fVar) {
        C8416i iVar;
        synchronized (C8416i.class) {
            if (f20557a == null) {
                f20557a = new C8416i(fVar);
            }
            iVar = f20557a;
        }
        return iVar;
    ...
    /* renamed from: a */
    public final synchronized void mo57026a(C8460e eVar) {
        try {
            if (getWritableDatabase() != null) {
                if (eVar != null) {
                    ContentValues contentValues = new ContentValues();
                    contentValues.put("id", eVar.mo57713a());
                    contentValues.put("time", Long.valueOf(eVar.mo57720d()));
                    contentValues.put("unitId", eVar.mo57717b());
                    contentValues.put("type", Integer.valueOf(eVar.mo57719c()));
                    if (m23983a(eVar.mo57717b(), eVar.mo57713a())) {
                        getWritableDatabase().update("fq_info", contentValues, "id = " + eVar.mo57713a() + " AND " + "unitId" + " = " + eVar.mo57717b(), (String[]) null);
                    } else {
    ...
    private synchronized boolean m23983a(java.lang.String r4, java.lang.String r5) {
        /*
            r3 = this;
            monitor-enter(r3)
            r0 = 0
        ...
        L_0x0050:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p298db.C8416i.m23983a(java.lang.String, java.lang.String):boolean");
    }

    /* JADX WARNING: Exception block dominator not found, dom blocks: [] */
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized void mo57027a(java.lang.String r5) {
        /*
            r4 = this;
            monitor-enter(r4)
        ...
        L_0x0042:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p298db.C8416i.mo57027a(java.lang.String):void");
    }
}
