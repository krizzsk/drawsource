...
public class C8407b extends C8403a {

    /* renamed from: a */
    private static volatile C8407b f20527a;

    private C8407b(C8412f fVar) {
        super(fVar);
    }

    /* renamed from: a */
    public static C8407b m23908a(Context context) {
        if (f20527a == null) {
            synchronized (C8407b.class) {
                if (f20527a == null) {
                    f20527a = new C8407b(C8414g.m23969a(context));
                }
            }
        }
        return f20527a;
    ...
    /* renamed from: a */
    public final void mo56971a(String str, List<CampaignEx> list) {
    ...
    /* renamed from: a */
    public final int mo56969a(String str, String str2) {
    ...
    /* renamed from: a */
    public final int mo56970a(String str, String str2, String str3) {
    ...
    public final java.util.List<com.mbridge.msdk.foundation.entity.C8458c> mo56972b(java.lang.String r9, java.lang.String r10) {
        /*
            r8 = this;
        ...
        L_0x005d:
            ...
            r10.mo57686a((java.lang.String) r1)     // Catch:{ Exception -> 0x00cf }
            r10.mo57689b((java.lang.String) r2)     // Catch:{ Exception -> 0x00cf }
            r10.mo57691c(r3)     // Catch:{ Exception -> 0x00cf }
            r10.mo57693d(r4)     // Catch:{ Exception -> 0x00cf }
            r10.mo57694e(r5)     // Catch:{ Exception -> 0x00cf }
            r10.mo57685a((int) r6)     // Catch:{ Exception -> 0x00cf }
            r10.mo57688b((int) r7)     // Catch:{ Exception -> 0x00cf }
        ...
        L_0x00cf:
            ...
            com.mbridge.msdk.foundation.tools.C8672v.m24878d(r1, r10)     // Catch:{ all -> 0x00cd }
            if (r9 == 0) goto L_0x00de
        L_0x00db:
            r9.close()
        L_0x00de:
        ...
        L_0x00e4:
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p298db.C8407b.mo56972b(java.lang.String, java.lang.String):java.util.List");
    }

    /* renamed from: a */
    public final int mo56968a(String str) {
        try {
            ...
            C8672v.m24878d("BidReplaceCampaignDao", e.getLocalizedMessage());
            return 0;
        }
    }

    /* renamed from: a */
    public final int mo56967a() {
        try {
            SQLiteDatabase writableDatabase = getWritableDatabase();
            if (writableDatabase == null) {
                return 0;
