...
public class C8408c extends C8403a<CommonJumpLoader.JumpLoaderResult> {

    /* renamed from: a */
    public static final String f20528a = C8408c.class.getSimpleName();

    /* renamed from: b */
    private static C8408c f20529b;

    private C8408c(C8412f fVar) {
        super(fVar);
    }

    /* renamed from: a */
    public static synchronized C8408c m23915a(C8412f fVar) {
        C8408c cVar;
        synchronized (C8408c.class) {
            if (f20529b == null) {
                f20529b = new C8408c(fVar);
            }
            cVar = f20529b;
        }
        return cVar;
    ...
    public final synchronized long mo56973a(com.mbridge.msdk.foundation.entity.CampaignEx r8, java.lang.String r9) {
        /*
            r7 = this;
            monitor-enter(r7)
        ...
        L_0x0007:
            ...
            java.lang.String r2 = com.mbridge.msdk.foundation.tools.C8613aa.m24711a((java.lang.Object) r2)     // Catch:{ Exception -> 0x00e2, all -> 0x00df }
            ...
            r3.put(r2, r4)     // Catch:{ Exception -> 0x00e2, all -> 0x00df }
            com.mbridge.msdk.c.b r2 = com.mbridge.msdk.p078c.C2445b.m6020a()     // Catch:{ Exception -> 0x00e2, all -> 0x00df }
            com.mbridge.msdk.foundation.controller.a r4 = com.mbridge.msdk.foundation.controller.C8388a.m23845e()     // Catch:{ Exception -> 0x00e2, all -> 0x00df }
            java.lang.String r4 = r4.mo56914h()     // Catch:{ Exception -> 0x00e2, all -> 0x00df }
            com.mbridge.msdk.c.a r2 = r2.mo16286b(r4)     // Catch:{ Exception -> 0x00e2, all -> 0x00df }
            ...
            int r4 = r2.mo16167V()     // Catch:{ Exception -> 0x00e2, all -> 0x00df }
            if (r4 <= 0) goto L_0x0075
            java.lang.String r4 = "cpei"
            int r5 = r2.mo16167V()     // Catch:{ Exception -> 0x00e2, all -> 0x00df }
            int r5 = r5 * 1000
            java.lang.Integer r5 = java.lang.Integer.valueOf(r5)     // Catch:{ Exception -> 0x00e2, all -> 0x00df }
            r3.put(r4, r5)     // Catch:{ Exception -> 0x00e2, all -> 0x00df }
        L_0x0075:
            if (r2 == 0) goto L_0x008c
            int r4 = r2.mo16168W()     // Catch:{ Exception -> 0x00e2, all -> 0x00df }
            if (r4 <= 0) goto L_0x008c
            java.lang.String r4 = "cpoci"
            int r2 = r2.mo16168W()     // Catch:{ Exception -> 0x00e2, all -> 0x00df }
            int r2 = r2 * 1000
        ...
        L_0x008c:
            ...
            boolean r2 = r7.m23916c(r2, r9)     // Catch:{ Exception -> 0x00e2, all -> 0x00df }
            r4 = 0
        ...
        L_0x00e2:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p298db.C8408c.mo56973a(com.mbridge.msdk.foundation.entity.CampaignEx, java.lang.String):long");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized boolean mo56975a(java.lang.String r4, java.lang.String r5) {
        /*
            r3 = this;
            monitor-enter(r3)
            r0 = 0
        ...
        L_0x0065:
            r4 = move-exception
            java.lang.String r5 = f20528a     // Catch:{ all -> 0x0063 }
            java.lang.String r4 = r4.getMessage()     // Catch:{ all -> 0x0063 }
            com.mbridge.msdk.foundation.tools.C8672v.m24878d(r5, r4)     // Catch:{ all -> 0x0063 }
            monitor-exit(r3)
            return r0
        L_0x0071:
            monitor-exit(r3)
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p298db.C8408c.mo56975a(java.lang.String, java.lang.String):boolean");
    }
    ...
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized com.mbridge.msdk.click.CommonJumpLoader.JumpLoaderResult mo56976b(java.lang.String r11, java.lang.String r12) {
        /*
            r10 = this;
            monitor-enter(r10)
            r0 = 0
            ...
            java.lang.Object r12 = com.mbridge.msdk.foundation.tools.C8613aa.m24710a((java.lang.String) r12)     // Catch:{ Exception -> 0x0047 }
        ...
        L_0x0063:
            ...
            throw r11
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p298db.C8408c.mo56976b(java.lang.String, java.lang.String):com.mbridge.msdk.click.CommonJumpLoader$JumpLoaderResult");
    }

    /* renamed from: c */
    private synchronized boolean m23916c(String str, String str2) {
