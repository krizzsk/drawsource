...
public final class C8419l extends C8403a {

    /* renamed from: a */
    private static String f20560a = "ReplaceTempDao";

    /* renamed from: b */
    private static C8419l f20561b;

    private C8419l(C8412f fVar) {
        super(fVar);
    }

    /* renamed from: a */
    public static C8419l m23997a(C8412f fVar) {
        if (f20561b == null) {
            synchronized (C8410e.class) {
                if (f20561b == null) {
                    f20561b = new C8419l(fVar);
                }
            }
        }
        return f20561b;
    ...
    public final org.json.JSONObject mo57037a(java.lang.String r4) {
        /*
            r3 = this;
        ...
        L_0x004d:
            ...
            goto L_0x0069
        L_0x0053:
            java.lang.String r2 = f20560a     // Catch:{ all -> 0x0062 }
            java.lang.String r0 = r0.getMessage()     // Catch:{ all -> 0x0062 }
            com.mbridge.msdk.foundation.tools.C8672v.m24878d(r2, r0)     // Catch:{ all -> 0x0062 }
        ...
        L_0x006c:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p298db.C8419l.mo57037a(java.lang.String):org.json.JSONObject");
    }

    /* renamed from: a */
    public final void mo57038a(String str, JSONObject jSONObject) {
        boolean z;
        try {
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final org.json.JSONObject mo57036a() {
        /*
            r8 = this;
        ...
        L_0x006e:
            ...
            goto L_0x008a
        L_0x0074:
            java.lang.String r3 = f20560a     // Catch:{ all -> 0x0083 }
            java.lang.String r2 = r2.getMessage()     // Catch:{ all -> 0x0083 }
            com.mbridge.msdk.foundation.tools.C8672v.m24878d(r3, r2)     // Catch:{ all -> 0x0083 }
        ...
        L_0x0090:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p298db.C8419l.mo57036a():org.json.JSONObject");
    }
}
