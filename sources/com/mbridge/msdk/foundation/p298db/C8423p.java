...
public class C8423p extends C8403a<C8468m> {

    /* renamed from: a */
    private static final String f20565a = C8423p.class.getName();

    /* renamed from: b */
    private static C8423p f20566b = null;

    private C8423p(C8412f fVar) {
        super(fVar);
    }

    /* renamed from: a */
    public static synchronized C8423p m24023a(C8412f fVar) {
        C8423p pVar;
        synchronized (C8423p.class) {
            if (f20566b == null) {
                f20566b = new C8423p(fVar);
            }
            pVar = f20566b;
        }
        return pVar;
    ...
    public final synchronized java.util.List<com.mbridge.msdk.foundation.entity.C8468m> mo57057a(java.lang.String r26) {
        /*
            r25 = this;
            r0 = r26
            monitor-enter(r25)
        ...
        L_0x002c:
            ...
            r11.mo57846n(r9)     // Catch:{ Exception -> 0x012f }
            r11.mo57828e((java.lang.String) r1)     // Catch:{ Exception -> 0x012f }
            r11.mo57840k(r12)     // Catch:{ Exception -> 0x012f }
            r11.mo57842l(r10)     // Catch:{ Exception -> 0x012f }
            r11.mo57844m(r15)     // Catch:{ Exception -> 0x012f }
            r7 = r13
            r24 = r14
            goto L_0x02d3
        L_0x012f:
        ...
        L_0x0132:
            ...
            r11.mo57846n(r9)     // Catch:{ Exception -> 0x012f }
            r11.mo57828e((java.lang.String) r1)     // Catch:{ Exception -> 0x012f }
            r11.mo57840k(r2)     // Catch:{ Exception -> 0x012f }
            r11.mo57842l(r10)     // Catch:{ Exception -> 0x012f }
            r11.mo57844m(r14)     // Catch:{ Exception -> 0x012f }
            r11.mo57850p(r8)     // Catch:{ Exception -> 0x012f }
            r11.mo57834h((java.lang.String) r12)     // Catch:{ Exception -> 0x012f }
            goto L_0x0184
        L_0x0168:
            r24 = r14
            r14 = r16
        ...
        L_0x01af:
            ...
            r11.mo57840k(r13)     // Catch:{ Exception -> 0x0217, all -> 0x0215 }
            r11.mo57842l(r10)     // Catch:{ Exception -> 0x0217, all -> 0x0215 }
            boolean r1 = android.text.TextUtils.isEmpty(r14)     // Catch:{ Exception -> 0x0217, all -> 0x0215 }
            if (r1 != 0) goto L_0x01fa
            r11.mo57846n(r14)     // Catch:{ Exception -> 0x0217, all -> 0x0215 }
        L_0x01fa:
            r11.mo57819b((int) r0)     // Catch:{ Exception -> 0x0217, all -> 0x0215 }
            r11.mo57834h((java.lang.String) r12)     // Catch:{ Exception -> 0x0217, all -> 0x0215 }
            r1 = r18
            r11.mo57817a((java.lang.String) r1)     // Catch:{ Exception -> 0x0217, all -> 0x0215 }
            r2 = r17
            r11.mo57820b((java.lang.String) r2)     // Catch:{ Exception -> 0x0217, all -> 0x0215 }
            r3 = r19
            r11.mo57823c((java.lang.String) r3)     // Catch:{ Exception -> 0x0217, all -> 0x0215 }
            r0 = r26
            r7 = r16
            goto L_0x02d3
        L_0x0215:
        ...
        L_0x0228:
            ...
            r11.mo57848o(r0)     // Catch:{ Exception -> 0x0318, all -> 0x0314 }
            r11.mo57822c((int) r4)     // Catch:{ Exception -> 0x0318, all -> 0x0314 }
            r11.mo57825d((int) r6)     // Catch:{ Exception -> 0x0318, all -> 0x0314 }
            r11.mo57846n(r5)     // Catch:{ Exception -> 0x0318, all -> 0x0314 }
            ...
            r11.mo57836i(r1)     // Catch:{ Exception -> 0x0311, all -> 0x030f }
            r11.mo57850p(r8)     // Catch:{ Exception -> 0x0311, all -> 0x030f }
            r11.mo57840k(r13)     // Catch:{ Exception -> 0x0311, all -> 0x030f }
            r11.mo57842l(r10)     // Catch:{ Exception -> 0x0311, all -> 0x030f }
            r11.mo57844m(r14)     // Catch:{ Exception -> 0x0311, all -> 0x030f }
            goto L_0x02d3
        L_0x026b:
            r7 = r16
            ...
            r11.mo57848o(r0)     // Catch:{ Exception -> 0x0311, all -> 0x030f }
            r11.mo57822c((int) r4)     // Catch:{ Exception -> 0x0311, all -> 0x030f }
            r11.mo57846n(r5)     // Catch:{ Exception -> 0x0311, all -> 0x030f }
            java.lang.String r1 = "image_url"
            int r1 = r7.getColumnIndex(r1)     // Catch:{ Exception -> 0x0311, all -> 0x030f }
            java.lang.String r1 = r7.getString(r1)     // Catch:{ Exception -> 0x0311, all -> 0x030f }
            r11.mo57826d((java.lang.String) r1)     // Catch:{ Exception -> 0x0311, all -> 0x030f }
            r11.mo57850p(r8)     // Catch:{ Exception -> 0x0311, all -> 0x030f }
            r11.mo57840k(r13)     // Catch:{ Exception -> 0x0311, all -> 0x030f }
            r11.mo57842l(r10)     // Catch:{ Exception -> 0x0311, all -> 0x030f }
            r11.mo57844m(r14)     // Catch:{ Exception -> 0x0311, all -> 0x030f }
        ...
        L_0x029d:
            ...
            r11.<init>()     // Catch:{ Exception -> 0x0311, all -> 0x030f }
            r11.mo57848o(r0)     // Catch:{ Exception -> 0x0311, all -> 0x030f }
            r11.mo57817a((java.lang.String) r1)     // Catch:{ Exception -> 0x0311, all -> 0x030f }
            r11.mo57844m(r14)     // Catch:{ Exception -> 0x0311, all -> 0x030f }
            r11.mo57820b((java.lang.String) r2)     // Catch:{ Exception -> 0x0311, all -> 0x030f }
            r11.mo57834h((java.lang.String) r12)     // Catch:{ Exception -> 0x0311, all -> 0x030f }
            r11.mo57846n(r5)     // Catch:{ Exception -> 0x0311, all -> 0x030f }
            r11.mo57840k(r13)     // Catch:{ Exception -> 0x0311, all -> 0x030f }
            r11.mo57842l(r10)     // Catch:{ Exception -> 0x0311, all -> 0x030f }
            r11.mo57825d((int) r6)     // Catch:{ Exception -> 0x0311, all -> 0x030f }
            r11.mo57850p(r8)     // Catch:{ Exception -> 0x0311, all -> 0x030f }
            r11.mo57822c((int) r4)     // Catch:{ Exception -> 0x0311, all -> 0x030f }
            r11.mo57823c((java.lang.String) r3)     // Catch:{ Exception -> 0x0311, all -> 0x030f }
            r11.mo57819b((int) r9)     // Catch:{ Exception -> 0x0311, all -> 0x030f }
            goto L_0x02d3
        L_0x02d2:
            r11 = 0
        L_0x02d3:
        ...
        L_0x0338:
            ...
            java.lang.String r1 = f20565a     // Catch:{ all -> 0x034a }
            java.lang.String r0 = r0.getMessage()     // Catch:{ all -> 0x034a }
            com.mbridge.msdk.foundation.tools.C8672v.m24878d(r1, r0)     // Catch:{ all -> 0x034a }
        ...
        L_0x0355:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p298db.C8423p.mo57057a(java.lang.String):java.util.List");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized int mo57055a() {
        /*
            r4 = this;
            monitor-enter(r4)
            r0 = 0
        ...
        L_0x0030:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p298db.C8423p.mo57055a():int");
    }

    /* renamed from: a */
    public final synchronized long mo57056a(C8468m mVar) {
        if (mVar != null) {
            try {
                ContentValues contentValues = new ContentValues();
                contentValues.put(SDKConstants.PARAM_KEY, mVar.mo57847o());
                contentValues.put("networkType", Integer.valueOf(mVar.mo57859v()));
                contentValues.put("network_str", mVar.mo57860w());
                contentValues.put("isCompleteView", Integer.valueOf(mVar.mo57861x()));
                contentValues.put("watchedMillis", Integer.valueOf(mVar.mo57849p()));
                contentValues.put("videoLength", Integer.valueOf(mVar.mo57851q()));
                if (!TextUtils.isEmpty(mVar.mo57853r())) {
                    contentValues.put("offerUrl", mVar.mo57853r());
                }
                if (!TextUtils.isEmpty(mVar.mo57855s())) {
                    contentValues.put(IronSourceConstants.EVENTS_ERROR_REASON, URLEncoder.encode(mVar.mo57855s(), "utf-8"));
                }
                contentValues.put(IronSourceConstants.EVENTS_RESULT, Integer.valueOf(mVar.mo57862y()));
                contentValues.put("duration", mVar.mo57856t());
                contentValues.put("videoSize", Long.valueOf(mVar.mo57858u()));
                contentValues.put("type", mVar.mo57831g());
                String f = mVar.mo57829f();
                if (!TextUtils.isEmpty(f)) {
                    contentValues.put(CampaignEx.ENDCARD_URL, f);
                }
                String e = mVar.mo57827e();
                if (!TextUtils.isEmpty(e)) {
                    contentValues.put("video_url", e);
                }
                String k = mVar.mo57839k();
                if (!TextUtils.isEmpty(k)) {
                    contentValues.put("rid", k);
                }
                String l = mVar.mo57841l();
                if (!TextUtils.isEmpty(l)) {
                    contentValues.put("rid_n", l);
                }
                String i = mVar.mo57835i();
                if (!TextUtils.isEmpty(i)) {
                    contentValues.put(AdvertisementDBAdapter.AdvertisementColumns.COLUMN_TEMPLATE_URL, i);
                }
                String d = mVar.mo57824d();
                if (!TextUtils.isEmpty(d)) {
                    contentValues.put(CampaignEx.JSON_KEY_IMAGE_URL, d);
                }
                String h = mVar.mo57833h();
                if (!TextUtils.isEmpty(h)) {
                    contentValues.put("ad_type", URLEncoder.encode(h, "utf-8"));
                }
                contentValues.put("unitId", mVar.mo57843m());
                contentValues.put("campaignId", mVar.mo57845n());
                if ("2000039".equals(mVar.mo57847o())) {
                    String f2 = C8468m.m24204f(mVar);
                    if (C8616ad.m24718b(f2)) {
                        contentValues.put("h5_click_data", f2);
                    }
                }
                String a = mVar.mo57815a();
                if (!TextUtils.isEmpty(a)) {
                    contentValues.put("resource_type", URLEncoder.encode(a, "utf-8"));
                }
                String b = mVar.mo57818b();
                if (!TextUtils.isEmpty(b)) {
                    contentValues.put("device_id", URLEncoder.encode(b, "utf-8"));
                }
                String c = mVar.mo57821c();
                if (!TextUtils.isEmpty(c)) {
                    contentValues.put(VisionDataDBAdapter.VisionDataColumns.COLUMN_CREATIVE, URLEncoder.encode(c, "utf-8"));
                }
                contentValues.put(CampaignEx.JSON_KEY_NEW_INTERSTITIAL_AD_SPACE_T, Integer.valueOf(mVar.mo57837j()));
                return getWritableDatabase().insert("reward_report", (String) null, contentValues);
            } catch (Exception e2) {
                e2.printStackTrace();
                C8672v.m24878d(f20565a, e2.getMessage());
            }
        }
        return -1;
    }
