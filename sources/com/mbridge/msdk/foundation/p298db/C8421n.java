...
public final class C8421n extends C8403a<C8462g> {

    /* renamed from: a */
    private static C8421n f20563a;

    private C8421n(C8412f fVar) {
        super(fVar);
    }

    /* renamed from: a */
    public static synchronized C8421n m24010a(C8412f fVar) {
        C8421n nVar;
        synchronized (C8421n.class) {
            if (f20563a == null) {
                f20563a = new C8421n(fVar);
            }
            nVar = f20563a;
        }
        return nVar;
    ...
    public final synchronized java.util.List<com.mbridge.msdk.foundation.entity.C8463h> mo57045a(int r6) {
        /*
            r5 = this;
            monitor-enter(r5)
        ...
        L_0x0075:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p298db.C8421n.mo57045a(int):java.util.List");
    }

    /* renamed from: a */
    public final synchronized void mo57046a(String str) {
    ...
    /* renamed from: a */
    public final synchronized void mo57047a(String str, String str2, int i) {
        if (getWritableDatabase() != null) {
