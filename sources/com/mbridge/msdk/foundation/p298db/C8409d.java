...
public final class C8409d extends C8403a<C8459d> {

    /* renamed from: a */
    private static C8409d f20530a;

    private C8409d(C8412f fVar) {
        super(fVar);
    }

    /* renamed from: a */
    public static synchronized C8409d m23921a(C8412f fVar) {
        C8409d dVar;
        synchronized (C8409d.class) {
            if (f20530a == null) {
                f20530a = new C8409d(fVar);
            }
            dVar = f20530a;
        }
        return dVar;
    ...
    public final synchronized java.util.List<com.mbridge.msdk.foundation.entity.C8459d> mo56978a(int r28) {
        /*
            r27 = this;
            r0 = r28
            monitor-enter(r27)
        ...
        L_0x014d:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p298db.C8409d.mo56978a(int):java.util.List");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized int mo56977a() {
        /*
            r4 = this;
            monitor-enter(r4)
            r0 = 0
        ...
        L_0x0030:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p298db.C8409d.mo56977a():int");
    }
}
