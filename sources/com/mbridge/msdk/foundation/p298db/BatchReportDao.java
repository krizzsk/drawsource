...
public class BatchReportDao extends C8403a<BatchReportMessage> implements NoProGuard, Serializable {
    private static volatile BatchReportDao instance;

    protected BatchReportDao(C8412f fVar) {
        super(fVar);
    }

    public static BatchReportDao getInstance(C8412f fVar) {
        if (instance == null) {
    ...
    public static BatchReportDao getInstance(Context context) {
        if (instance == null) {
            synchronized (BatchReportDao.class) {
                if (instance == null) {
                    instance = new BatchReportDao(C8414g.m23969a(context));
                }
            }
        }
        return instance;
    ...
    public java.util.ArrayList<com.mbridge.msdk.foundation.same.report.BatchReportMessage> getBatchReportMessages(long r13) {
        ...
        L_0x00ad:
            throw r13
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p298db.BatchReportDao.getBatchReportMessages(long):java.util.ArrayList");
    }
