        ...
        this.handler.post(new Runnable() {
            ...
            public void run() {
                ...
                L_0x00a1:
                    throw r2
                */
                throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.download.database.DatabaseHelper.C84401.run():void");
            }
        });
    }
        ...
        this.handler.post(new Runnable() {
            ...
            public void run() {
                ...
                L_0x0089:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.download.database.DatabaseHelper.C84412.run():void");
            }
        });
    }
            ...
            public void run() {
                ...
                try {
                    ...
                    try {
                        ...
                        C8672v.m24878d(IDatabaseHelper.TAG, th.getMessage());
                    }
                } catch (Throwable th2) {
                    C8672v.m24878d(IDatabaseHelper.TAG, th2.getMessage());
                    return;
                }
                throw th;
            }
