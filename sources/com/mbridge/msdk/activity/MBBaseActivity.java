...
public abstract class MBBaseActivity extends Activity {
    ...
    /* renamed from: a */
    public OrientationEventListener f4940a;
    /* access modifiers changed from: private */

    /* renamed from: b */
    public Display f4941b;
    /* access modifiers changed from: private */
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            C8672v.m24878d("MBBaseActivity", e.getMessage());
        }
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        OrientationEventListener orientationEventListener = this.f4940a;
        ...
        getWindow().getDecorView().postDelayed(new Runnable() {
            ...
            public final void run() {
                /*
                    ...
                    com.mbridge.msdk.foundation.tools.C8672v.m24878d(r0, r7)     // Catch:{ Exception -> 0x00e3 }
                    com.mbridge.msdk.activity.MBBaseActivity r7 = com.mbridge.msdk.activity.MBBaseActivity.this     // Catch:{ Exception -> 0x00e3 }
                    android.view.Display r7 = r7.f4941b     // Catch:{ Exception -> 0x00e3 }
                ...
                L_0x0098:
                    r12 = r2
                L_0x0099:
                    int unused = r8.f4942c = r12     // Catch:{ Exception -> 0x00e3 }
                    ...
                    int r12 = r12.f4942c     // Catch:{ Exception -> 0x00e3 }
                    r8.append(r12)     // Catch:{ Exception -> 0x00e3 }
                    java.lang.String r12 = ""
                    r8.append(r12)     // Catch:{ Exception -> 0x00e3 }
                    java.lang.String r8 = r8.toString()     // Catch:{ Exception -> 0x00e3 }
                    com.mbridge.msdk.foundation.tools.C8672v.m24878d(r0, r8)     // Catch:{ Exception -> 0x00e3 }
                L_0x00b6:
                ...
                L_0x00d0:
                    ...
                    com.mbridge.msdk.activity.MBBaseActivity r1 = com.mbridge.msdk.activity.MBBaseActivity.this     // Catch:{ Exception -> 0x00e3 }
                    android.view.OrientationEventListener r1 = r1.f4940a     // Catch:{ Exception -> 0x00e3 }
                    if (r1 != 0) goto L_0x00eb
                    com.mbridge.msdk.activity.MBBaseActivity r1 = com.mbridge.msdk.activity.MBBaseActivity.this     // Catch:{ Exception -> 0x00e3 }
                    com.mbridge.msdk.activity.MBBaseActivity.m5879e(r1)     // Catch:{ Exception -> 0x00e3 }
                    goto L_0x00eb
                L_0x00e3:
                    r1 = move-exception
                    java.lang.String r1 = r1.getMessage()
                    com.mbridge.msdk.foundation.tools.C8672v.m24878d(r0, r1)
                L_0x00eb:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.activity.MBBaseActivity.C24331.run():void");
            }
        }, 500);
    }
    ...
    public int m5872a() {
        if (this.f4941b == null) {
            if (Build.VERSION.SDK_INT >= 30) {
                this.f4941b = getDisplay();
            } else {
                this.f4941b = ((WindowManager) getSystemService("window")).getDefaultDisplay();
            }
        }
        Display display = this.f4941b;
        if (display != null) {
    ...
    private void m5876b() {
        try {
            ...
            C8672v.m24878d("MBBaseActivity", th.getMessage());
        }
    }

    /* renamed from: e */
    static /* synthetic */ void m5879e(MBBaseActivity mBBaseActivity) {
        C24342 r0 = new OrientationEventListener(mBBaseActivity, 1) {
            public final void onOrientationChanged(int i) {
                int rotation = MBBaseActivity.this.f4941b != null ? MBBaseActivity.this.f4941b.getRotation() : 0;
                if (rotation == 1 && MBBaseActivity.this.f4942c != 1) {
                    int unused = MBBaseActivity.this.f4942c = 1;
                    MBBaseActivity.this.getNotchParams();
                    C8672v.m24878d("MBBaseActivity", "Orientation Left");
                } else if (rotation == 3 && MBBaseActivity.this.f4942c != 2) {
                    int unused2 = MBBaseActivity.this.f4942c = 2;
                    MBBaseActivity.this.getNotchParams();
                    C8672v.m24878d("MBBaseActivity", "Orientation Right");
                } else if (rotation == 0 && MBBaseActivity.this.f4942c != 3) {
                    int unused3 = MBBaseActivity.this.f4942c = 3;
                    MBBaseActivity.this.getNotchParams();
                    C8672v.m24878d("MBBaseActivity", "Orientation Top");
                } else if (rotation == 2 && MBBaseActivity.this.f4942c != 4) {
                    int unused4 = MBBaseActivity.this.f4942c = 4;
                    MBBaseActivity.this.getNotchParams();
                    C8672v.m24878d("MBBaseActivity", "Orientation Bottom");
                }
            }
        };
        mBBaseActivity.f4940a = r0;
        if (r0.canDetectOrientation()) {
            mBBaseActivity.f4940a.enable();
            return;
        }
        mBBaseActivity.f4940a.disable();
        mBBaseActivity.f4940a = null;
    }
}
