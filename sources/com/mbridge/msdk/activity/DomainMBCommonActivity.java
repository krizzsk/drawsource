...
public class DomainMBCommonActivity extends Activity {
    ...
    /* renamed from: b */
    private CampaignEx f4936b;

    /* renamed from: c */
    private BrowserView f4937c;

    /* renamed from: d */
    private BrowserView.C8684a f4938d = new BrowserView.C8684a() {
        /* renamed from: a */
        ...
        public final boolean mo16133a(WebView webView, String str) {
            C8672v.m24878d("MBCommonActivity", "shouldOverrideUrlLoading  " + str);
            if (C8675y.C8676a.m24900a(str) && C8675y.C8676a.m24899a(DomainMBCommonActivity.this, str, (NativeListener.NativeTrackingListener) null)) {
                DomainMBCommonActivity.this.finish();
            }
            return DomainMBCommonActivity.this.m5867a(webView, str);
        }
    };
    ...
    public void onCreate(Bundle bundle) {
        ...
        try {
            ...
            C8672v.m24878d("MBCommonActivity", th.getMessage());
        }
        if (C8388a.m23845e().mo56913g() == null) {
            C8388a.m23845e().mo56905b(getApplicationContext());
        }
        C8388a.m23845e().mo56898a((Context) this);
        String stringExtra = getIntent().getStringExtra("url");
        this.f4935a = stringExtra;
        if (!TextUtils.isEmpty(stringExtra)) {
            this.f4936b = (CampaignEx) getIntent().getSerializableExtra("mvcommon");
            BrowserView browserView = new BrowserView((Context) this, this.f4936b);
            this.f4937c = browserView;
            browserView.setListener(this.f4938d);
            this.f4937c.loadUrl(this.f4935a);
            BrowserView browserView2 = this.f4937c;
    ...
    public void onDestroy() {
        super.onDestroy();
        BrowserView browserView = this.f4937c;
        if (browserView != null) {
            browserView.destroy();
        }
    }
    ...
    public boolean m5867a(android.webkit.WebView r9, java.lang.String r10) {
        /*
            r8 = this;
        ...
        L_0x005e:
            ...
            com.mbridge.msdk.foundation.tools.C8672v.m24878d(r1, r4)     // Catch:{ all -> 0x00ae }
        L_0x0066:
        ...
        L_0x0096:
            ...
            com.mbridge.msdk.foundation.tools.C8672v.m24878d(r1, r9)     // Catch:{ all -> 0x00ae }
        L_0x009e:
            boolean r9 = com.mbridge.msdk.click.C6779b.m20649d(r8, r10)     // Catch:{ all -> 0x00ae }
        ...
        L_0x00ae:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.activity.DomainMBCommonActivity.m5867a(android.webkit.WebView, java.lang.String):boolean");
    }
}
