...
public final class Format implements Parcelable {
    ...
    Format(Parcel parcel) {
        this.f22101id = parcel.readString();
    ...
    public final String toString() {
        return "Format(" + this.f22101id + ", " + this.containerMimeType + ", " + this.sampleMimeType + ", " + this.bitrate + ", " + this.language + ", [" + this.width + ", " + this.height + ", " + this.frameRate + "], [" + this.channelCount + ", " + this.sampleRate + "])";
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        parcel.writeString(this.f22101id);
