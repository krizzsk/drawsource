...
public final class DownloadManager {
    ...
    public final int handleAction(DownloadAction downloadAction) {
        ...
        return addTaskForAction.f22117id;
    }
    ...
    private static final class Task implements Runnable {
        ...
        public final TaskState getDownloadState() {
            return new TaskState(this.f22117id, this.action, getExternalState(), getDownloadPercentage(), getDownloadedBytes(), this.error);
        }
