...
final class MediaPeriodQueue {
    ...
    public final MediaPeriodHolder advancePlayingPeriod() {
        ...
        if (mediaPeriodHolder != null) {
            ...
            if (i == 0) {
                ...
                this.oldFrontPeriodWindowSequenceNumber = this.playing.info.f22102id.windowSequenceNumber;
            }
    ...
    public final void clear(boolean z) {
        ...
        if (frontPeriod != null) {
            ...
            this.oldFrontPeriodWindowSequenceNumber = frontPeriod.info.f22102id.windowSequenceNumber;
            frontPeriod.release();
    ...
    public final MediaPeriodInfo getUpdatedMediaPeriodInfo(MediaPeriodInfo mediaPeriodInfo, int i) {
        return getUpdatedMediaPeriodInfo(mediaPeriodInfo, mediaPeriodInfo.f22102id.copyWithPeriodIndex(i));
    }
    ...
    private long resolvePeriodIndexToWindowSequenceNumber(int i) {
        ...
        for (MediaPeriodHolder frontPeriod = getFrontPeriod(); frontPeriod != null; frontPeriod = frontPeriod.next) {
            if (frontPeriod.uid.equals(obj)) {
                return frontPeriod.info.f22102id.windowSequenceNumber;
            }
        }
        for (MediaPeriodHolder frontPeriod2 = getFrontPeriod(); frontPeriod2 != null; frontPeriod2 = frontPeriod2.next) {
            ...
            if (indexOfPeriod2 != -1 && this.timeline.getPeriod(indexOfPeriod2, this.period).windowIndex == i2) {
                return frontPeriod2.info.f22102id.windowSequenceNumber;
            }
        }
    ...
    private boolean canKeepMediaPeriodHolder(MediaPeriodHolder mediaPeriodHolder, MediaPeriodInfo mediaPeriodInfo) {
        ...
        return mediaPeriodInfo2.startPositionUs == mediaPeriodInfo.startPositionUs && mediaPeriodInfo2.endPositionUs == mediaPeriodInfo.endPositionUs && mediaPeriodInfo2.f22102id.equals(mediaPeriodInfo.f22102id);
    }
    ...
    private boolean updateForPlaybackModeChange() {
        ...
        while (true) {
            int nextPeriodIndex = this.timeline.getNextPeriodIndex(frontPeriod.info.f22102id.periodIndex, this.period, this.window, this.repeatMode, this.shuffleModeEnabled);
            while (frontPeriod.next != null && !frontPeriod.info.isLastInTimelinePeriod) {
                frontPeriod = frontPeriod.next;
            }
            if (nextPeriodIndex == -1 || frontPeriod.next == null || frontPeriod.next.info.f22102id.periodIndex != nextPeriodIndex) {
                boolean removeAfter = removeAfter(frontPeriod);
                frontPeriod.info = getUpdatedMediaPeriodInfo(frontPeriod.info, frontPeriod.info.f22102id);
            } else {
                frontPeriod = frontPeriod.next;
            }
        }
    ...
    private MediaPeriodInfo getFollowingMediaPeriodInfo(MediaPeriodHolder mediaPeriodHolder, long j) {
        ...
        if (mediaPeriodInfo.isLastInTimelinePeriod) {
            int nextPeriodIndex = this.timeline.getNextPeriodIndex(mediaPeriodInfo.f22102id.periodIndex, this.period, this.window, this.repeatMode, this.shuffleModeEnabled);
            if (nextPeriodIndex == -1) {
                return null;
            }
            int i2 = this.timeline.getPeriod(nextPeriodIndex, this.period, true).windowIndex;
            Object obj = this.period.uid;
            long j4 = mediaPeriodInfo.f22102id.windowSequenceNumber;
            long j5 = 0;
            if (this.timeline.getWindow(i2, this.window).firstPeriodIndex == nextPeriodIndex) {
                ...
                if (mediaPeriodHolder2.next == null || !mediaPeriodHolder2.next.uid.equals(obj)) {
                    ...
                    j3 = mediaPeriodHolder2.next.info.f22102id.windowSequenceNumber;
                }
                j5 = longValue;
                j2 = j3;
                i = intValue;
        ...
        MediaSource.MediaPeriodId mediaPeriodId = mediaPeriodInfo.f22102id;
