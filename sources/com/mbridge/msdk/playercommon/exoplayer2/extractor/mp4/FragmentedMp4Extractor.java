...
public final class FragmentedMp4Extractor implements Extractor {
    ...
    private void onMoovContainerAtomRead(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        while (i5 < size2) {
            ...
            if (containerAtom3.type == Atom.TYPE_trak) {
                ...
                if (parseTrak != null) {
                    sparseArray2.put(parseTrak.f22106id, parseTrak);
                }
            } else {
                i = i5;
                i2 = size2;
        ...
        if (this.trackBundles.size() == 0) {
            while (i3 < size3) {
                ...
                trackBundle.init(track, getDefaultSampleValues(sparseArray, track.f22106id));
                this.trackBundles.put(track.f22106id, trackBundle);
        ...
        while (i3 < size3) {
            ...
            this.trackBundles.get(track2.f22106id).init(track2, getDefaultSampleValues(sparseArray, track2.f22106id));
            i3++;
        }
    }
    ...
    private static int parseTrun(TrackBundle trackBundle, int i, long j, int i2, ParsableByteArray parsableByteArray, int i3) {
        ...
        while (i10 < i9) {
            ...
            iArr[i10] = i5;
            zArr2[i10] = (((i6 >> 16) & 1) != 0 || (z12 && i10 != 0)) ? z6 : true;
            i10++;
            j5 += (long) i4;
            j3 = j3;
            z8 = z;
