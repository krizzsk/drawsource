            ...
            case 17:
                ...
                if (readBits2 == subtitleService2.subtitlePageId && pageComposition2 != null) {
                    ...
                    if (pageComposition2.state == 0) {
                        parseRegionComposition.mergeFrom(subtitleService2.regions.get(parseRegionComposition.f22123id));
                    }
                    subtitleService2.regions.put(parseRegionComposition.f22123id, parseRegionComposition);
                    break;
                }
            case 18:
                if (readBits2 != subtitleService2.subtitlePageId) {
                    if (readBits2 == subtitleService2.ancillaryPageId) {
                        ...
                        subtitleService2.ancillaryCluts.put(parseClutDefinition.f22121id, parseClutDefinition);
                        break;
                    }
                } else {
                    ClutDefinition parseClutDefinition2 = parseClutDefinition(parsableBitArray, readBits3);
                    subtitleService2.cluts.put(parseClutDefinition2.f22121id, parseClutDefinition2);
                    break;
                }
                break;
            case 19:
                if (readBits2 != subtitleService2.subtitlePageId) {
                    if (readBits2 == subtitleService2.ancillaryPageId) {
                        ...
                        subtitleService2.ancillaryObjects.put(parseObjectData.f22122id, parseObjectData);
                        break;
                    }
                } else {
                    ObjectData parseObjectData2 = parseObjectData(parsableBitArray);
                    subtitleService2.objects.put(parseObjectData2.f22122id, parseObjectData2);
                    break;
                }
                break;
            case 20:
