...
public final class EventMessage implements Metadata.Entry {
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.presentationTimeUs != eventMessage.presentationTimeUs || this.durationMs != eventMessage.durationMs || this.f22108id != eventMessage.f22108id || !Util.areEqual(this.schemeIdUri, eventMessage.schemeIdUri) || !Util.areEqual(this.value, eventMessage.value) || !Arrays.equals(this.messageData, eventMessage.messageData)) {
            return false;
        }
        return true;
    }
    ...
    public final String toString() {
        return "EMSG: scheme=" + this.schemeIdUri + ", id=" + this.f22108id + ", value=" + this.value;
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeLong(this.f22108id);
