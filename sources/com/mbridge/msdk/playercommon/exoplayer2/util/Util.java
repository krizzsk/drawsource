...
public final class Util {
    ...
    public static java.util.UUID getDrmUuid(java.lang.String r5) {
        ...
        L_0x0044:
            ...
            return r5
        L_0x0046:
            java.util.UUID r5 = com.mbridge.msdk.playercommon.exoplayer2.C8975C.CLEARKEY_UUID
            return r5
        L_0x0049:
            java.util.UUID r5 = com.mbridge.msdk.playercommon.exoplayer2.C8975C.PLAYREADY_UUID
            return r5
        L_0x004c:
            java.util.UUID r5 = com.mbridge.msdk.playercommon.exoplayer2.C8975C.WIDEVINE_UUID
            return r5
        */
    ...
    public static int getDefaultBufferSize(int i) {
        ...
        if (i == 1) {
            return C8975C.DEFAULT_AUDIO_BUFFER_SIZE;
        }
        if (i == 2) {
            return 13107200;
        }
