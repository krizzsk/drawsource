...
public final class DtsUtil {
    ...
    public static Format parseDtsFormat(byte[] bArr, String str, String str2, DrmInitData drmInitData) {
        ...
        return Format.createAudioSampleFormat(str, "audio/vnd.dts", (String) null, i4, -1, i2 + (normalizedFrameHeader.readBits(2) > 0 ? 1 : 0), i3, (List<byte[]>) null, drmInitData, 0, str2);
    }
