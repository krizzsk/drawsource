...
final class ExoPlayerImpl implements ExoPlayer {
    ...
    public final void seekTo(int i, long j) {
        ...
        if (timeline.isEmpty()) {
            ...
            long defaultPositionUs = j == -9223372036854775807L ? timeline.getWindow(i, this.window).getDefaultPositionUs() : C8975C.msToUs(j);
            Pair<Integer, Long> periodPosition = timeline.getPeriodPosition(this.window, this.period, i, defaultPositionUs);
            this.maskingWindowPositionMs = C8975C.usToMs(defaultPositionUs);
            this.maskingPeriodIndex = ((Integer) periodPosition.first).intValue();
        }
        this.internalPlayer.seekTo(timeline, i, C8975C.msToUs(j));
        Iterator<Player.EventListener> it = this.listeners.iterator();
        while (it.hasNext()) {
    ...
    public final long getDuration() {
        ...
        return C8975C.usToMs(this.period.getAdDurationUs(mediaPeriodId.adGroupIndex, mediaPeriodId.adIndexInAdGroup));
    }
    ...
    public final long getContentPosition() {
        ...
        return this.period.getPositionInWindowMs() + C8975C.usToMs(this.playbackInfo.contentPositionUs);
    }
