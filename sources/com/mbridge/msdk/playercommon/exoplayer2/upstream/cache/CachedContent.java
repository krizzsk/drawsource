...
final class CachedContent {
    ...
    public final void writeToStream(DataOutputStream dataOutputStream) throws IOException {
        dataOutputStream.writeInt(this.f22128id);
    ...
    public final SimpleCacheSpan touch(SimpleCacheSpan simpleCacheSpan) throws Cache.CacheException {
        ...
        SimpleCacheSpan copyWithUpdatedLastAccessTime = simpleCacheSpan.copyWithUpdatedLastAccessTime(this.f22128id);
    ...
    public final int headerHashCode(int i) {
        int i2;
        int i3;
        int hashCode = (this.f22128id * 31) + this.key.hashCode();
        if (i < 2) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.f22128id != cachedContent.f22128id || !this.key.equals(cachedContent.key) || !this.cachedSpans.equals(cachedContent.cachedSpans) || !this.metadata.equals(cachedContent.metadata)) {
            return false;
        }
        return true;
    }
