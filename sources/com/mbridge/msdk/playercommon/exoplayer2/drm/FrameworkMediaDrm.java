...
public final class FrameworkMediaDrm implements ExoMediaDrm<FrameworkMediaCrypto> {
    ...
    private FrameworkMediaDrm(UUID uuid2) throws UnsupportedSchemeException {
        ...
        Assertions.checkArgument(!C8975C.COMMON_PSSH_UUID.equals(uuid2), "Use C.CLEARKEY_UUID instead");
        if (Util.SDK_INT < 27 && C8975C.CLEARKEY_UUID.equals(uuid2)) {
            uuid2 = C8975C.COMMON_PSSH_UUID;
        }
        this.uuid = uuid2;
        this.mediaDrm = new MediaDrm(uuid2);
        if (C8975C.WIDEVINE_UUID.equals(uuid2) && needsForceL3Workaround()) {
    ...
    public final com.mbridge.msdk.playercommon.exoplayer2.drm.ExoMediaDrm.KeyRequest getKeyRequest(byte[] r8, byte[] r9, java.lang.String r10, int r11, java.util.HashMap<java.lang.String, java.lang.String> r12) throws android.media.NotProvisionedException {
        /*
            ...
            java.util.UUID r0 = com.mbridge.msdk.playercommon.exoplayer2.C8975C.WIDEVINE_UUID
            java.util.UUID r1 = r7.uuid
            boolean r0 = r0.equals(r1)
            if (r0 != 0) goto L_0x0042
        L_0x0010:
            java.util.UUID r0 = com.mbridge.msdk.playercommon.exoplayer2.C8975C.PLAYREADY_UUID
            java.util.UUID r1 = r7.uuid
            boolean r0 = r0.equals(r1)
        ...
        L_0x004e:
            ...
            java.util.UUID r9 = com.mbridge.msdk.playercommon.exoplayer2.C8975C.CLEARKEY_UUID
            java.util.UUID r0 = r7.uuid
        ...
        L_0x0070:
            ...
            byte[] r9 = r8.getData()
            java.util.UUID r10 = com.mbridge.msdk.playercommon.exoplayer2.C8975C.CLEARKEY_UUID
    ...
    public final byte[] provideKeyResponse(byte[] bArr, byte[] bArr2) throws NotProvisionedException, DeniedByServerException {
        if (C8975C.CLEARKEY_UUID.equals(this.uuid)) {
    ...
    public final FrameworkMediaCrypto createMediaCrypto(byte[] bArr) throws MediaCryptoException {
        return new FrameworkMediaCrypto(new MediaCrypto(this.uuid, bArr), Util.SDK_INT < 21 && C8975C.WIDEVINE_UUID.equals(this.uuid) && "L3".equals(getPropertyString("securityLevel")));
    }
