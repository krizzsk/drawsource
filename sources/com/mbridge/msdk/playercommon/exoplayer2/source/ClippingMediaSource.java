...
public final class ClippingMediaSource extends CompositeMediaSource<Void> {
    ...
    public final long getMediaTimeForChildMediaTime(Void voidR, long j) {
        ...
        long usToMs = C8975C.usToMs(this.startUs);
        long max = Math.max(0, j - usToMs);
        long j2 = this.endUs;
        return j2 != Long.MIN_VALUE ? Math.min(C8975C.usToMs(j2) - usToMs, max) : max;
    }
    ...
    private static final class ClippingTimeline extends ForwardingTimeline {
        ...
        public final Timeline.Period getPeriod(int i, Timeline.Period period, boolean z) {
            ...
            return period.set(period.f22103id, period.uid, 0, j == -9223372036854775807L ? -9223372036854775807L : j - positionInWindowUs, positionInWindowUs);
        }
    }
}
