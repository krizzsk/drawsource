...
public abstract class CompositeMediaSource<T> extends BaseMediaSource {
    ...
    public final void prepareChildSource(final T t, MediaSource mediaSource) {
        ...
        C90571 r0 = new MediaSource.SourceInfoRefreshListener() {
    ...
    private final class ForwardingEventListener implements MediaSourceEventListener {
        ...
        private boolean maybeUpdateEventDispatcher(int i, MediaSource.MediaPeriodId mediaPeriodId) {
            ...
            if (mediaPeriodId != null) {
                mediaPeriodId2 = CompositeMediaSource.this.getMediaPeriodIdForChildMediaPeriodId(this.f22118id, mediaPeriodId);
            ...
            int windowIndexForChildWindowIndex = CompositeMediaSource.this.getWindowIndexForChildWindowIndex(this.f22118id, i);
        ...
        private MediaSourceEventListener.MediaLoadData maybeUpdateMediaLoadData(MediaSourceEventListener.MediaLoadData mediaLoadData) {
            long mediaTimeForChildMediaTime = CompositeMediaSource.this.getMediaTimeForChildMediaTime(this.f22118id, mediaLoadData.mediaStartTimeMs);
            long mediaTimeForChildMediaTime2 = CompositeMediaSource.this.getMediaTimeForChildMediaTime(this.f22118id, mediaLoadData.mediaEndTimeMs);
