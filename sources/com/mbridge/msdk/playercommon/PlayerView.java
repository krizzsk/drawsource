...
public class PlayerView extends LinearLayout {
    ...
    public void addSurfaceView() {
        try {
            C8672v.m24876b(TAG, "addSurfaceView");
    ...
    public void removeSurface() {
        try {
            C8672v.m24876b(TAG, "removeSurface");
    ...
    private void initView() {
        View inflate = LayoutInflater.from(getContext()).inflate(C8658p.m24799a(getContext(), "mbridge_playercommon_player_view", "layout"), (ViewGroup) null);
        if (inflate != null) {
            this.mLlSurContainer = (LinearLayout) inflate.findViewById(C8658p.m24799a(getContext(), "mbridge_playercommon_ll_sur_container", "id"));
            this.mLoadingView = (LinearLayout) inflate.findViewById(C8658p.m24799a(getContext(), "mbridge_playercommon_ll_loading", "id"));
            addSurfaceView();
            addView(inflate, -1, -1);
        }
    }
    ...
    private class MySurfaceHoldeCallback implements SurfaceHolder.Callback {
        ...
        public void surfaceCreated(SurfaceHolder surfaceHolder) {
            try {
                ...
                C8672v.m24878d(PlayerView.TAG, e.getMessage());
            }
        }
        ...
        public void surfaceChanged(SurfaceHolder surfaceHolder, int i, int i2, int i3) {
            try {
                if (PlayerView.this.mIsSurfaceHolderDestoryed && !PlayerView.this.mIsCovered && !PlayerView.this.isComplete() && !PlayerView.this.isBTVideo && !C2470b.f5205c) {
