...
public class VideoFeedsPlayer implements Player.EventListener {
    ...
    private Runnable playProgressRunnable = new Runnable() {
        public void run() {
            ...
            try {
                ...
                C8672v.m24878d(VideoFeedsPlayer.TAG, e.getMessage());
            }
        }
    };
    ...
    public boolean initPlayer(Context context, View view, String str, VideoPlayerStatusListener videoPlayerStatusListener) {
        if (view == null) {
            try {
                C8672v.m24876b(TAG, "loadingView is NULL");
    ...
    public void onPrepared() {
        try {
            if (!this.mIsFrontDesk) {
                C8672v.m24878d(TAG, "At background, Do not process");
                ...
                if (this.exoPlayer != null) {
                    ...
                    if (!this.isStart) {
                        ...
                        C8672v.m24876b(TAG, "onPlayStarted()，getCurrentPosition:" + this.exoPlayer.getCurrentPosition());
                        this.isStart = true;
                    }
                }
                postOnBufferinEndOnMainThread();
                startPlayProgressTimer();
                C8672v.m24876b(TAG, "onPrepare mCurrentPosition:" + this.mCurrentPosition + " onPrepare mHasPrepare：" + this.mHasPrepare);
            }
        } catch (Throwable th) {
            C8672v.m24878d(TAG, th.getMessage());
        }
                    ...
                    public void run() {
                        ...
                        if (VideoFeedsPlayer.this.mInnerVFPLisener != null) {
                            try {
                                ...
                                C8672v.m24878d(VideoFeedsPlayer.TAG, e2.getMessage());
                            }
                        }
                    }
                });
    ...
    private void postOnPlayErrorOnMainThread(final String str) {
        try {
            ...
            C8598e.m24665a(94, this.mPlayUrl, str);
        } catch (Exception e) {
            C8672v.m24878d(TAG, e.getMessage());
        }
    }
    ...
    public void pause() {
        try {
            if (this.mHasPrepare && this.exoPlayer != null && exoPlayerIsPlaying()) {
                C8672v.m24876b(TAG, "pause isPalying:" + exoPlayerIsPlaying() + " mIsPlaying:" + this.mIsPlaying);
                hideLoading();
    ...
    public boolean onError(int i, String str) {
        try {
            hideLoading();
            if (!this.mIsFrontDesk && "MIX 3".equalsIgnoreCase(C8660r.m24814c()) && C8660r.m24820e().equalsIgnoreCase("Xiaomi")) {
                return true;
            }
            this.mHasPrepare = false;
    ...
    public void onPlayerStateChanged(boolean z, int i) {
        C8672v.m24878d(TAG, "onPlaybackStateChanged : " + i);
        if (i == 1) {
            C8672v.m24878d(TAG, "onPlaybackStateChanged : IDLE");
        } else if (i == 2) {
            C8672v.m24878d(TAG, "onPlaybackStateChanged : Buffering");
            this.mIsBuffering = true;
            showLoading();
            startBufferIngTimer(PlayerErrorConstant.PLAYERING_TIMEOUT);
        } else if (i == 3) {
            C8672v.m24878d(TAG, "onPlaybackStateChanged : READY");
            this.mIsBuffering = false;
            hideLoading();
            postOnBufferinEndOnMainThread();
            onPrepared();
        } else if (i == 4) {
            C8672v.m24878d(TAG, "onPlaybackStateChanged : Ended : PLAY ENDED");
            cancelPlayProgressTimer();
            onCompletion();
        }
    }
    ...
    public void onPlayerError(ExoPlaybackException exoPlaybackException) {
        ...
        if (exoPlaybackException != null) {
            ...
            C8672v.m24878d(TAG, "onPlayerError : " + str);
    ...
    public void onPlaybackParametersChanged(PlaybackParameters playbackParameters) {
        C8672v.m24878d(TAG, "onPlaybackParametersChanged : " + playbackParameters.speed);
    }
}
