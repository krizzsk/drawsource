...
public class VideoNativePlayer implements Player.EventListener {
    ...
    private Runnable playProgressMSRunnable = new Runnable() {
        public void run() {
            try {
                ...
                C8672v.m24878d(VideoNativePlayer.TAG, e.getMessage());
            }
        }
    };
    ...
    private void postOnPlayErrorOnMainThread(final String str) {
        try {
            ...
            C8598e.m24665a(42, this.mPlayUrl, str);
        } catch (Exception e) {
            C8672v.m24878d(TAG, e.getMessage());
        }
    }
    ...
    public void setDataSource(android.content.Context r7) {
        ...
        L_0x0018:
            ...
            com.mbridge.msdk.foundation.tools.C8672v.m24878d(r0, r2)     // Catch:{ Exception -> 0x00b0 }
        L_0x0020:
        ...
        L_0x00b0:
            ...
            com.mbridge.msdk.foundation.tools.C8672v.m24878d(r0, r2)
            r6.hideLoading()
    ...
    public void onPositionDiscontinuity(int i) {
        C8672v.m24878d(TAG, "onPositionDiscontinuity : " + i);
        if (i == 0) {
            onCompletion();
        }
    }
