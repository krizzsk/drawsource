...
public class RollingPagerListenrt implements ViewPager.OnPageChangeListener {
    ...
    private C8582d reportController;
    ...
    public void setCampList(List<Frame> list2, Context context, String str) {
        this.frames = list2;
        this.reportController = new C8582d(context, 2);
        this.unit_id = str;
        this.list.clear();
        reportRollBC(0);
    }
    ...
    public void reportRollBC(int i) {
        ...
        if (!this.list.contains(Integer.valueOf(i))) {
            ...
            if (campaigns != null && !campaigns.isEmpty()) {
                ...
                String a = C8598e.m24664a("2000005", (Map<String, Object>) hashMap);
                if (C8574b.m24577a().mo58054c()) {
                    C8574b.m24577a().mo58052a(a);
                } else {
                    this.reportController.mo58068a("native_rollbc", a, this.unit_id, frame);
                }
            }
        }
    }
