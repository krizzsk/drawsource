...
public class RollingAdapter extends PagerAdapter {
    ...
    private MBNativeRollView.C8926a mvinterface;

    public boolean isViewFromObject(View view, Object obj) {
        return view == obj;
    }

    public MBNativeRollView.C8926a getMvinterface() {
        return this.mvinterface;
    }

    public void setMvinterface(MBNativeRollView.C8926a aVar) {
    ...
    public Object instantiateItem(ViewGroup viewGroup, int i) {
        List<Frame> list2;
        View a;
        if (this.mvinterface == null || (list2 = this.list) == null || list2.size() <= 0 || (a = this.mvinterface.mo58780a(this.list.get(i), i)) == null) {
            return null;
        }
        this.listview.add(a);
        viewGroup.addView(a);
