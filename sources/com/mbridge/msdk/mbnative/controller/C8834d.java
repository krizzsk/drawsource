...
public final class C8834d {
    ...
    private static android.view.View m25503a(android.view.View r2) {
        /*
            r0 = 0
        ...
        L_0x0019:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.mbnative.controller.C8834d.m25503a(android.view.View):android.view.View");
    }

    /* renamed from: a */
    public static View m25502a(Context context, View view) {
        View view2 = null;
        if (context != null && (context instanceof Activity)) {
            view2 = ((Activity) context).getWindow().getDecorView().findViewById(16908290);
        }
        return view2 != null ? view2 : m25503a(view);
    }
}
