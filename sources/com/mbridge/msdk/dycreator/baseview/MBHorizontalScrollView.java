...
public class MBHorizontalScrollView extends HorizontalScrollView implements InterBase {
    ...
    /* renamed from: a */
    private Map<String, String> f18092a;

    /* renamed from: b */
    private Map<String, Boolean> f18093b;
    ...
    public MBHorizontalScrollView(Context context, AttributeSet attributeSet) {
        super(context);
        try {
            this.f18092a = C8371b.m23819a(context, attributeSet);
            setAttributeSet(attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            C8371b.m23821a(this.f18092a, (View) this);
        } catch (Exception e) {
            C8672v.m24878d("MBHorizontalScrollView", e.getMessage());
        }
    }
    ...
    public void setAttributeSet(AttributeSet attributeSet) {
        ...
        for (int i = 0; i < attributeCount; i++) {
            ...
            if (cVar != null) {
                int i2 = C68191.f18095a[cVar.ordinal()];
                if (i2 == 1) {
    ...
    public void onAttachedToWindow() {
        ...
        Map<String, Boolean> map = this.f18093b;
        if (map != null && map.containsKey("attached") && this.f18093b.get("attached").booleanValue()) {
            new C8603f.C8605a("attached").mo58073a().mo58072a(this.f18094c);
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f18093b;
        if (map != null && map.containsKey("detached") && this.f18093b.get("detached").booleanValue()) {
            new C8603f.C8605a("detached").mo58073a().mo58072a(this.f18094c);
        }
    }

    public String getBindDataDes() {
        Map<String, String> map = this.f18092a;
        return (map == null || !map.containsKey("mbridgeData")) ? "" : this.f18092a.get("mbridgeData");
    }

    public String getActionDes() {
        Map<String, String> map = this.f18092a;
        return (map == null || !map.containsKey("mbridgeAction")) ? "" : this.f18092a.get("mbridgeAction");
    }

    public String getStrategyDes() {
        Map<String, String> map = this.f18092a;
        return (map == null || !map.containsKey("mbridgeStrategy")) ? "" : this.f18092a.get("mbridgeStrategy");
    }

    public String getEffectDes() {
        Map<String, String> map = this.f18092a;
        return (map == null || !map.containsKey("mbridgeEffect")) ? "" : this.f18092a.get("mbridgeEffect");
    }

    public String getReportDes() {
        Map<String, String> map = this.f18092a;
        return (map == null || !map.containsKey("mbridgeReport")) ? "" : this.f18092a.get("mbridgeReport");
    }

    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f18093b = C8371b.m23820a(str);
        if (campaignEx != null) {
            this.f18094c = campaignEx.getCampaignUnitId();
        }
    }
}
