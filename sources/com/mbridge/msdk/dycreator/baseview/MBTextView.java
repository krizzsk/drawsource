...
public class MBTextView extends TextView implements InterBase, InterEffect {
    ...
    /* renamed from: b */
    private Animator f18174b;

    /* renamed from: c */
    private Map<String, String> f18175c;

    /* renamed from: d */
    private Map<String, Boolean> f18176d;
    ...
    public MBTextView(Context context, AttributeSet attributeSet) {
        ...
        try {
            this.f18175c = C8371b.m23819a(context, attributeSet);
            setAttributeSet(attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            C8371b.m23821a(this.f18175c, (View) this);
        } catch (Exception e) {
            C8672v.m24878d("TextView", e.getMessage());
        }
    }
    ...
    public void onAttachedToWindow() {
        ...
        Animator animator = this.f18174b;
        if (animator != null) {
            try {
                animator.start();
            } catch (Exception e) {
        ...
        Map<String, Boolean> map = this.f18176d;
        if (map != null && map.containsKey("attached") && this.f18176d.get("attached").booleanValue()) {
            new C8603f.C8605a("attached").mo58073a().mo58072a(this.f18177e);
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f18176d;
        if (map != null && map.containsKey("detached") && this.f18176d.get("detached").booleanValue()) {
            new C8603f.C8605a("detached").mo58073a().mo58072a(this.f18177e);
        }
    }
    ...
    public void setAttributeSet(AttributeSet attributeSet) {
        ...
        for (int i5 = 0; i5 < attributeCount; i5++) {
            ...
            if (cVar != null) {
                switch (C68331.f18178a[cVar.ordinal()]) {
                    case 1:
    ...
    static /* synthetic */ class C68331 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f18178a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f18178a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f18178a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f18178a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f18178a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f18178a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                int[] r0 = f18178a     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f18178a     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x006c:
                int[] r0 = f18178a     // Catch:{ NoSuchFieldError -> 0x0078 }
            ...
            L_0x0078:
                int[] r0 = f18178a     // Catch:{ NoSuchFieldError -> 0x0084 }
            ...
            L_0x0084:
                int[] r0 = f18178a     // Catch:{ NoSuchFieldError -> 0x0090 }
            ...
            L_0x0090:
                int[] r0 = f18178a     // Catch:{ NoSuchFieldError -> 0x009c }
            ...
            L_0x009c:
                int[] r0 = f18178a     // Catch:{ NoSuchFieldError -> 0x00a8 }
            ...
            L_0x00a8:
                int[] r0 = f18178a     // Catch:{ NoSuchFieldError -> 0x00b4 }
            ...
            L_0x00b4:
                int[] r0 = f18178a     // Catch:{ NoSuchFieldError -> 0x00c0 }
            ...
            L_0x00c0:
                int[] r0 = f18178a     // Catch:{ NoSuchFieldError -> 0x00cc }
            ...
            L_0x00cc:
                int[] r0 = f18178a     // Catch:{ NoSuchFieldError -> 0x00d8 }
            ...
            L_0x00d8:
                int[] r0 = f18178a     // Catch:{ NoSuchFieldError -> 0x00e4 }
            ...
            L_0x00e4:
                int[] r0 = f18178a     // Catch:{ NoSuchFieldError -> 0x00f0 }
            ...
            L_0x00f0:
                int[] r0 = f18178a     // Catch:{ NoSuchFieldError -> 0x00fc }
            ...
            L_0x00fc:
                int[] r0 = f18178a     // Catch:{ NoSuchFieldError -> 0x0108 }
            ...
            L_0x0108:
                int[] r0 = f18178a     // Catch:{ NoSuchFieldError -> 0x0114 }
            ...
            L_0x0114:
                int[] r0 = f18178a     // Catch:{ NoSuchFieldError -> 0x0120 }
            ...
            L_0x0120:
                int[] r0 = f18178a     // Catch:{ NoSuchFieldError -> 0x012c }
            ...
            L_0x012c:
                int[] r0 = f18178a     // Catch:{ NoSuchFieldError -> 0x0138 }
            ...
            L_0x0138:
                int[] r0 = f18178a     // Catch:{ NoSuchFieldError -> 0x0144 }
            ...
            L_0x0144:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.dycreator.baseview.MBTextView.C68331.<clinit>():void");
        }
    }
    ...
    public ViewGroup.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i = 0; i < attributeCount; i++) {
            ...
            if (cVar != null) {
                int i2 = C68331.f18178a[cVar.ordinal()];
                if (i2 == 26) {
    ...
    public String getBindDataDes() {
        Map<String, String> map = this.f18175c;
        return (map == null || !map.containsKey("mbridgeData")) ? "" : this.f18175c.get("mbridgeData");
    }

    public String getActionDes() {
        Map<String, String> map = this.f18175c;
        return (map == null || !map.containsKey("mbridgeAction")) ? "" : this.f18175c.get("mbridgeAction");
    }

    public String getStrategyDes() {
        Map<String, String> map = this.f18175c;
        return (map == null || !map.containsKey("mbridgeStrategy")) ? "" : this.f18175c.get("mbridgeStrategy");
    }

    public String getEffectDes() {
        Map<String, String> map = this.f18175c;
        return (map == null || !map.containsKey("mbridgeEffect")) ? "" : this.f18175c.get("mbridgeEffect");
    }

    public String getReportDes() {
        Map<String, String> map = this.f18175c;
        return (map == null || !map.containsKey("mbridgeReport")) ? "" : this.f18175c.get("mbridgeReport");
    }

    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f18176d = C8371b.m23820a(str);
        if (campaignEx != null) {
            this.f18177e = campaignEx.getCampaignUnitId();
        }
    }

    public void setAnimator(Animator animator) {
        this.f18174b = animator;
    }
}
