...
public class MBExtMBridgeImageView extends MBridgeImageView implements InterBase {
    ...
    /* renamed from: a */
    private Map<String, String> f18265a;

    /* renamed from: b */
    private Map<String, Boolean> f18266b;
    ...
    public MBExtMBridgeImageView(Context context, AttributeSet attributeSet) {
        super(context);
        try {
            this.f18265a = C8371b.m23819a(context, attributeSet);
            setAttributeSet(attributeSet);
            setLayoutParams(generateLayoutParams(context, attributeSet));
            C8371b.m23821a(this.f18265a, (View) this);
        } catch (Exception e) {
            C8672v.m24878d("MBExtMBridgeImageView", e.getMessage());
        }
    }
    ...
    public void setAttributeSet(AttributeSet attributeSet) {
        ...
        for (int i = 0; i < attributeCount; i++) {
            ...
            if (cVar != null) {
                switch (C68401.f18272a[cVar.ordinal()]) {
                    case 1:
                    ...
                    case 9:
                        ...
                        this.f18269e = b2;
                        setPadding(this.f18268d, b2, this.f18270f, this.f18271g);
                        break;
                    case 10:
                        int b3 = C6811b.m20739a().mo37131b(attributeSet.getAttributeValue(i));
                        this.f18271g = b3;
                        setPadding(this.f18268d, this.f18269e, this.f18270f, b3);
                        break;
                    case 11:
                        int b4 = C6811b.m20739a().mo37131b(attributeSet.getAttributeValue(i));
                        this.f18268d = b4;
                        setPadding(b4, this.f18269e, this.f18270f, this.f18271g);
                        break;
                    case 12:
                        int b5 = C6811b.m20739a().mo37131b(attributeSet.getAttributeValue(i));
                        this.f18270f = b5;
                        setPadding(this.f18268d, this.f18269e, b5, this.f18271g);
                        break;
                }
            }
        }
    ...
    /* renamed from: com.mbridge.msdk.dycreator.baseview.extview.MBExtMBridgeImageView$1 */
    static /* synthetic */ class C68401 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f18272a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f18272a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f18272a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f18272a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f18272a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f18272a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                int[] r0 = f18272a     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f18272a     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x006c:
                int[] r0 = f18272a     // Catch:{ NoSuchFieldError -> 0x0078 }
            ...
            L_0x0078:
                int[] r0 = f18272a     // Catch:{ NoSuchFieldError -> 0x0084 }
            ...
            L_0x0084:
                int[] r0 = f18272a     // Catch:{ NoSuchFieldError -> 0x0090 }
            ...
            L_0x0090:
                int[] r0 = f18272a     // Catch:{ NoSuchFieldError -> 0x009c }
            ...
            L_0x009c:
                int[] r0 = f18272a     // Catch:{ NoSuchFieldError -> 0x00a8 }
            ...
            L_0x00a8:
                int[] r0 = f18272a     // Catch:{ NoSuchFieldError -> 0x00b4 }
            ...
            L_0x00b4:
                int[] r0 = f18272a     // Catch:{ NoSuchFieldError -> 0x00c0 }
            ...
            L_0x00c0:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.dycreator.baseview.extview.MBExtMBridgeImageView.C68401.<clinit>():void");
        }
    }
    ...
    public ViewGroup.LayoutParams generateLayoutParams(Context context, AttributeSet attributeSet) {
        ...
        for (int i = 0; i < attributeCount; i++) {
            C6812c cVar = c.get(attributeSet.getAttributeName(i));
            if (cVar != null) {
                int i2 = C68401.f18272a[cVar.ordinal()];
                if (i2 == 6) {
                    String attributeValue = attributeSet.getAttributeValue(i);
    ...
    public void onAttachedToWindow() {
        ...
        Map<String, Boolean> map = this.f18266b;
        if (map != null && map.containsKey("attached") && this.f18266b.get("attached").booleanValue()) {
            new C8603f.C8605a("attached").mo58073a().mo58072a(this.f18267c);
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f18266b;
        if (map != null && map.containsKey("detached") && this.f18266b.get("detached").booleanValue()) {
            new C8603f.C8605a("detached").mo58073a().mo58072a(this.f18267c);
        }
    }

    public String getBindDataDes() {
        Map<String, String> map = this.f18265a;
        return (map == null || !map.containsKey("mbridgeData")) ? "" : this.f18265a.get("mbridgeData");
    }

    public String getActionDes() {
        Map<String, String> map = this.f18265a;
        return (map == null || !map.containsKey("mbridgeAction")) ? "" : this.f18265a.get("mbridgeAction");
    }

    public String getStrategyDes() {
        Map<String, String> map = this.f18265a;
        return (map == null || !map.containsKey("mbridgeStrategy")) ? "" : this.f18265a.get("mbridgeStrategy");
    }

    public String getEffectDes() {
        Map<String, String> map = this.f18265a;
        return (map == null || !map.containsKey("mbridgeEffect")) ? "" : this.f18265a.get("mbridgeEffect");
    }

    public String getReportDes() {
        Map<String, String> map = this.f18265a;
        return (map == null || !map.containsKey("mbridgeReport")) ? "" : this.f18265a.get("mbridgeReport");
    }

    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f18266b = C8371b.m23820a(str);
        if (campaignEx != null) {
            this.f18267c = campaignEx.getCampaignUnitId();
        }
    }
}
