...
public class MBExtMBRotationView extends MBRotationView implements InterBase {
    ...
    /* renamed from: b */
    private Map<String, String> f18261b;

    /* renamed from: c */
    private Map<String, Boolean> f18262c;
    ...
    public MBExtMBRotationView(Context context, AttributeSet attributeSet) {
        super(context);
        try {
            this.f18261b = C8371b.m23819a(context, attributeSet);
            setAttributeSet(attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            C8371b.m23821a(this.f18261b, (View) this);
        } catch (Exception e) {
            C8672v.m24878d("MBExtMBRotationView", e.getMessage());
        }
    }
    ...
    public void setAttributeSet(AttributeSet attributeSet) {
        ...
        for (int i = 0; i < attributeCount; i++) {
            ...
            if (cVar != null) {
                int i2 = C68391.f18264a[cVar.ordinal()];
                if (i2 == 1) {
    ...
    public void onAttachedToWindow() {
        ...
        Map<String, Boolean> map = this.f18262c;
        if (map != null && map.containsKey("attached") && this.f18262c.get("attached").booleanValue()) {
            new C8603f.C8605a("attached").mo58073a().mo58072a(this.f18263d);
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f18262c;
        if (map != null && map.containsKey("detached") && this.f18262c.get("detached").booleanValue()) {
            new C8603f.C8605a("detached").mo58073a().mo58072a(this.f18263d);
        }
    }

    public String getBindDataDes() {
        Map<String, String> map = this.f18261b;
        return (map == null || !map.containsKey("mbridgeData")) ? "" : this.f18261b.get("mbridgeData");
    }

    public String getActionDes() {
        Map<String, String> map = this.f18261b;
        return (map == null || !map.containsKey("mbridgeAction")) ? "" : this.f18261b.get("mbridgeAction");
    }

    public String getStrategyDes() {
        Map<String, String> map = this.f18261b;
        return (map == null || !map.containsKey("mbridgeStrategy")) ? "" : this.f18261b.get("mbridgeStrategy");
    }

    public String getEffectDes() {
        Map<String, String> map = this.f18261b;
        return (map == null || !map.containsKey("mbridgeEffect")) ? "" : this.f18261b.get("mbridgeEffect");
    }

    public String getReportDes() {
        Map<String, String> map = this.f18261b;
        return (map == null || !map.containsKey("mbridgeReport")) ? "" : this.f18261b.get("mbridgeReport");
    }

    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f18262c = C8371b.m23820a(str);
        if (campaignEx != null) {
            this.f18263d = campaignEx.getCampaignUnitId();
        }
    }
}
