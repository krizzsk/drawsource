...
public class MBExtMBridgeTextView extends MBridgeTextView implements InterBase {
    ...
    /* renamed from: a */
    private Map<String, String> f18277a;

    /* renamed from: b */
    private Map<String, Boolean> f18278b;
    ...
    public MBExtMBridgeTextView(Context context, AttributeSet attributeSet) {
        super(context);
        try {
            this.f18277a = C8371b.m23819a(context, attributeSet);
            setAttributeSet(attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            C8371b.m23821a(this.f18277a, (View) this);
        } catch (Exception e) {
            C8672v.m24878d("MBExtMBridgeTextView", e.getMessage());
        }
    }
    ...
    public void setAttributeSet(AttributeSet attributeSet) {
        ...
        for (int i5 = 0; i5 < attributeCount; i5++) {
            C6812c cVar = c.get(attributeSet2.getAttributeName(i5));
            if (cVar != null) {
                Log.d("setupview", cVar.toString());
                switch (C68421.f18280a[cVar.ordinal()]) {
                    case 1:
                    ...
                    case 2:
                        ...
                        if (!TextUtils.isEmpty(attributeValue2)) {
                            if (!attributeValue2.startsWith("@string/")) {
                                ...
                                setText(C6811b.m20739a().mo37136e(attributeSet2.getAttributeValue(i5)));
                                break;
                            }
                        } else {
                            break;
                    ...
                    case 7:
                        setCompoundDrawablePadding(C6811b.m20739a().mo37131b(attributeSet2.getAttributeValue(i5)));
                        break;
                    case 8:
                    ...
                    case 9:
                        ...
                        break;
                    case 10:
                        setTextColor(C6811b.m20739a().mo37126a(attributeSet2.getAttributeValue(i5)));
                        break;
                    case 11:
                    ...
                    case 13:
                        ...
                        if (!attributeValue7.startsWith("#")) {
                            ...
                            if (strArr != null && strArr.length <= 2) {
                                setBackgroundColor(C6811b.m20739a().mo37126a(attributeSet2.getAttributeValue(i5)));
                                break;
                            } else {
                    ...
                    case 18:
                        setGravity(C6811b.m20739a().mo37133c(attributeSet2.getAttributeValue(i5)));
                        break;
                    case 19:
                        int b = C6811b.m20739a().mo37131b(attributeSet2.getAttributeValue(i5));
                        setPadding(b, b, b, b);
                        break;
                    case 20:
                        i4 = C6811b.m20739a().mo37131b(attributeSet2.getAttributeValue(i5));
                        setPadding(i, i4, i2, i3);
                        break;
                    case 21:
                        i3 = C6811b.m20739a().mo37131b(attributeSet2.getAttributeValue(i5));
                        setPadding(i, i4, i2, i3);
                        break;
                    case 22:
                        i = C6811b.m20739a().mo37131b(attributeSet2.getAttributeValue(i5));
                        setPadding(i, i4, i2, i3);
                        break;
                    case 23:
                        i2 = C6811b.m20739a().mo37131b(attributeSet2.getAttributeValue(i5));
                        setPadding(i, i4, i2, i3);
                        break;
                    case 24:
                        setPadding(C6811b.m20739a().mo37131b(attributeSet2.getAttributeValue(i5)), i4, i2, i3);
                        break;
                    case 25:
                        setPadding(i, i4, C6811b.m20739a().mo37131b(attributeSet2.getAttributeValue(i5)), i3);
                        break;
                    case 26:
                        setFilters(new InputFilter[]{new InputFilter.LengthFilter(C6811b.m20739a().mo37131b(attributeSet2.getAttributeValue(i5)))});
                        break;
                }
            }
        }
    ...
    /* renamed from: com.mbridge.msdk.dycreator.baseview.extview.MBExtMBridgeTextView$1 */
    static /* synthetic */ class C68421 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f18280a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f18280a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f18280a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f18280a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f18280a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f18280a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                int[] r0 = f18280a     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f18280a     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x006c:
                int[] r0 = f18280a     // Catch:{ NoSuchFieldError -> 0x0078 }
            ...
            L_0x0078:
                int[] r0 = f18280a     // Catch:{ NoSuchFieldError -> 0x0084 }
            ...
            L_0x0084:
                int[] r0 = f18280a     // Catch:{ NoSuchFieldError -> 0x0090 }
            ...
            L_0x0090:
                int[] r0 = f18280a     // Catch:{ NoSuchFieldError -> 0x009c }
            ...
            L_0x009c:
                int[] r0 = f18280a     // Catch:{ NoSuchFieldError -> 0x00a8 }
            ...
            L_0x00a8:
                int[] r0 = f18280a     // Catch:{ NoSuchFieldError -> 0x00b4 }
            ...
            L_0x00b4:
                int[] r0 = f18280a     // Catch:{ NoSuchFieldError -> 0x00c0 }
            ...
            L_0x00c0:
                int[] r0 = f18280a     // Catch:{ NoSuchFieldError -> 0x00cc }
            ...
            L_0x00cc:
                int[] r0 = f18280a     // Catch:{ NoSuchFieldError -> 0x00d8 }
            ...
            L_0x00d8:
                int[] r0 = f18280a     // Catch:{ NoSuchFieldError -> 0x00e4 }
            ...
            L_0x00e4:
                int[] r0 = f18280a     // Catch:{ NoSuchFieldError -> 0x00f0 }
            ...
            L_0x00f0:
                int[] r0 = f18280a     // Catch:{ NoSuchFieldError -> 0x00fc }
            ...
            L_0x00fc:
                int[] r0 = f18280a     // Catch:{ NoSuchFieldError -> 0x0108 }
            ...
            L_0x0108:
                int[] r0 = f18280a     // Catch:{ NoSuchFieldError -> 0x0114 }
            ...
            L_0x0114:
                int[] r0 = f18280a     // Catch:{ NoSuchFieldError -> 0x0120 }
            ...
            L_0x0120:
                int[] r0 = f18280a     // Catch:{ NoSuchFieldError -> 0x012c }
            ...
            L_0x012c:
                int[] r0 = f18280a     // Catch:{ NoSuchFieldError -> 0x0138 }
                com.mbridge.msdk.dycreator.a.c r1 = com.mbridge.msdk.dycreator.p220a.C6812c.maxLength     // Catch:{ NoSuchFieldError -> 0x0138 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0138 }
                r2 = 26
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0138 }
            L_0x0138:
                int[] r0 = f18280a     // Catch:{ NoSuchFieldError -> 0x0144 }
                com.mbridge.msdk.dycreator.a.c r1 = com.mbridge.msdk.dycreator.p220a.C6812c.layout_width     // Catch:{ NoSuchFieldError -> 0x0144 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0144 }
                r2 = 27
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0144 }
            L_0x0144:
                int[] r0 = f18280a     // Catch:{ NoSuchFieldError -> 0x0150 }
                com.mbridge.msdk.dycreator.a.c r1 = com.mbridge.msdk.dycreator.p220a.C6812c.layout_height     // Catch:{ NoSuchFieldError -> 0x0150 }
            ...
            L_0x0150:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.dycreator.baseview.extview.MBExtMBridgeTextView.C68421.<clinit>():void");
        }
    }
    ...
    public ViewGroup.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i = 0; i < attributeCount; i++) {
            ...
            if (cVar != null) {
                int i2 = C68421.f18280a[cVar.ordinal()];
                if (i2 == 27) {
    ...
    public void onAttachedToWindow() {
        ...
        Map<String, Boolean> map = this.f18278b;
        if (map != null && map.containsKey("attached") && this.f18278b.get("attached").booleanValue()) {
            new C8603f.C8605a("attached").mo58073a().mo58072a(this.f18279c);
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f18278b;
        if (map != null && map.containsKey("detached") && this.f18278b.get("detached").booleanValue()) {
            new C8603f.C8605a("detached").mo58073a().mo58072a(this.f18279c);
        }
    }

    public String getBindDataDes() {
        Map<String, String> map = this.f18277a;
        return (map == null || !map.containsKey("mbridgeData")) ? "" : this.f18277a.get("mbridgeData");
    }

    public String getActionDes() {
        Map<String, String> map = this.f18277a;
        return (map == null || !map.containsKey("mbridgeAction")) ? "" : this.f18277a.get("mbridgeAction");
    }

    public String getStrategyDes() {
        Map<String, String> map = this.f18277a;
        return (map == null || !map.containsKey("mbridgeStrategy")) ? "" : this.f18277a.get("mbridgeStrategy");
    }

    public String getEffectDes() {
        Map<String, String> map = this.f18277a;
        return (map == null || !map.containsKey("mbridgeEffect")) ? "" : this.f18277a.get("mbridgeEffect");
    }

    public String getReportDes() {
        Map<String, String> map = this.f18277a;
        return (map == null || !map.containsKey("mbridgeReport")) ? "" : this.f18277a.get("mbridgeReport");
    }

    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f18278b = C8371b.m23820a(str);
        if (campaignEx != null) {
            this.f18279c = campaignEx.getCampaignUnitId();
        }
    }
}
