...
public class MBExtSoundImageView extends SoundImageView {
    ...
    public MBExtSoundImageView(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            C8672v.m24878d("MBExtSoundImageView", e.getMessage());
        }
    }
    ...
    public void setAttributeSet(AttributeSet attributeSet) {
        ...
        for (int i = 0; i < attributeCount; i++) {
            ...
            if (cVar != null) {
                switch (C68431.f18285a[cVar.ordinal()]) {
                    case 1:
                    ...
                    case 9:
                        ...
                        this.f18282b = b2;
                        setPadding(this.f18281a, b2, this.f18283c, this.f18284d);
                        break;
                    case 10:
                        int b3 = C6811b.m20739a().mo37131b(attributeSet.getAttributeValue(i));
                        this.f18284d = b3;
                        setPadding(this.f18281a, this.f18282b, this.f18283c, b3);
                        break;
                    case 11:
                        int b4 = C6811b.m20739a().mo37131b(attributeSet.getAttributeValue(i));
                        this.f18281a = b4;
                        setPadding(b4, this.f18282b, this.f18283c, this.f18284d);
                        break;
                    case 12:
                        int b5 = C6811b.m20739a().mo37131b(attributeSet.getAttributeValue(i));
                        this.f18283c = b5;
                        setPadding(this.f18281a, this.f18282b, b5, this.f18284d);
                        break;
                }
            }
        }
    ...
    static /* synthetic */ class C68431 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f18285a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f18285a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f18285a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f18285a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f18285a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f18285a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                int[] r0 = f18285a     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f18285a     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x006c:
                int[] r0 = f18285a     // Catch:{ NoSuchFieldError -> 0x0078 }
            ...
            L_0x0078:
                int[] r0 = f18285a     // Catch:{ NoSuchFieldError -> 0x0084 }
            ...
            L_0x0084:
                int[] r0 = f18285a     // Catch:{ NoSuchFieldError -> 0x0090 }
            ...
            L_0x0090:
                int[] r0 = f18285a     // Catch:{ NoSuchFieldError -> 0x009c }
            ...
            L_0x009c:
                int[] r0 = f18285a     // Catch:{ NoSuchFieldError -> 0x00a8 }
            ...
            L_0x00a8:
                int[] r0 = f18285a     // Catch:{ NoSuchFieldError -> 0x00b4 }
            ...
            L_0x00b4:
                int[] r0 = f18285a     // Catch:{ NoSuchFieldError -> 0x00c0 }
            ...
            L_0x00c0:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.dycreator.baseview.extview.MBExtSoundImageView.C68431.<clinit>():void");
        }
    }
    ...
    public ViewGroup.LayoutParams generateLayoutParams(Context context, AttributeSet attributeSet) {
        ...
        for (int i = 0; i < attributeCount; i++) {
            C6812c cVar = c.get(attributeSet.getAttributeName(i));
            if (cVar != null) {
                int i2 = C68431.f18285a[cVar.ordinal()];
                if (i2 == 6) {
                    String attributeValue = attributeSet.getAttributeValue(i);
