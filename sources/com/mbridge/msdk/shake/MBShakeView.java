...
public class MBShakeView extends LinearLayout {
    ...
    public void initView(String str, boolean z) {
        ...
        float f = 60.0f;
        int b = C8677z.m24924b(getContext(), z ? 60.0f : 80.0f);
        Context context = getContext();
        if (!z) {
            f = 80.0f;
        }
        imageView.setLayoutParams(new LinearLayout.LayoutParams(b, C8677z.m24924b(context, f)));
        int parseColor = Color.parseColor("#80000000");
        GradientDrawable gradientDrawable = new GradientDrawable();
        gradientDrawable.setColor(parseColor);
        gradientDrawable.setCornerRadius((float) 200);
        imageView.setBackground(gradientDrawable);
        this.f22571a = new ImageView(getContext());
        float f2 = 40.0f;
        float f3 = 20.0f;
        int b2 = C8677z.m24924b(getContext(), z ? 20.0f : 40.0f);
        Context context2 = getContext();
        if (z) {
            f2 = 20.0f;
        }
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(b2, C8677z.m24924b(context2, f2));
        layoutParams.gravity = 17;
        this.f22571a.setLayoutParams(layoutParams);
        this.f22571a.setImageResource(getResources().getIdentifier("mbridge_splash_btn_shake", "drawable", C8388a.m23845e().mo56903b()));
        FrameLayout frameLayout = new FrameLayout(getContext());
        frameLayout.setLayoutParams(new LinearLayout.LayoutParams(-2, -2));
        frameLayout.addView(imageView);
        frameLayout.addView(this.f22571a);
        TextView textView = new TextView(getContext());
        LinearLayout.LayoutParams layoutParams2 = new LinearLayout.LayoutParams(-2, -2);
        layoutParams2.topMargin = C8677z.m24924b(getContext(), 10.0f);
        ...
        layoutParams3.topMargin = C8677z.m24924b(getContext(), 5.0f);
    ...
    public void onAttachedToWindow() {
        ...
        this.f22572b = rotateAnimation;
        rotateAnimation.setDuration(100);
        this.f22572b.setRepeatMode(2);
        this.f22572b.setRepeatCount(-1);
        this.f22571a.startAnimation(this.f22572b);
    }
}
