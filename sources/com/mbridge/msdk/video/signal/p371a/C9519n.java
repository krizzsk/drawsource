...
public final class C9519n extends C9511g {

    /* renamed from: a */
    private MBridgeVideoView f23582a;

    public C9519n(MBridgeVideoView mBridgeVideoView) {
        this.f23582a = mBridgeVideoView;
    }
    ...
    public final void showVideoLocation(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
        ...
        MBridgeVideoView mBridgeVideoView = this.f23582a;
