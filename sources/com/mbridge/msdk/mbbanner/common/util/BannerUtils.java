...
public class BannerUtils {
    ...
    public static String getCloseIds(String str) {
        List list;
        try {
            if (C8473d.f20773b == null) {
                return "";
            }
            Map<String, List<C8489a>> map = C8473d.f20773b;
            ...
            for (int i = 0; i < list.size(); i++) {
                ...
                C8489a aVar = (C8489a) list.get(i);
                jSONObject.put(BidResponsedEx.KEY_CID, aVar.mo57897a());
                jSONObject.put("crid", aVar.mo57899c());
    ...
    private static synchronized List<C8489a> fillIdInList(List<C8489a> list, List<CampaignEx> list2) {
            ...
            if (list2 != null) {
                if (list2.size() > 0) {
                    ...
                    for (CampaignEx next : list2) {
                        if (next != null) {
                            C8489a aVar = new C8489a(next.getId(), next.getCreativeId());
                            if (list.size() >= 20) {
                                list.remove(0);
                            }
                            list.add(aVar);
    ...
    public static void uisList(Context context, List<CampaignEx> list) {
        if (context != null && list != null && list.size() != 0) {
            C8417j a = C8417j.m23986a((C8412f) C8414g.m23969a(context));
            for (int i = 0; i < list.size(); i++) {
                CampaignEx campaignEx = list.get(i);
                if (a != null && !a.mo57029a(campaignEx.getId())) {
    ...
    public static com.mbridge.msdk.foundation.entity.CampaignEx managerCampaignEX(java.lang.String r7, com.mbridge.msdk.foundation.entity.CampaignEx r8) {
        ...
        L_0x003d:
            ...
            java.lang.String r7 = com.mbridge.msdk.foundation.same.C8469a.f20746g     // Catch:{ JSONException -> 0x0147 }
            org.json.JSONObject r7 = r0.optJSONObject(r7)     // Catch:{ JSONException -> 0x0147 }
            java.lang.String r0 = "-999"
            if (r7 == 0) goto L_0x008b
            com.mbridge.msdk.foundation.controller.a r0 = com.mbridge.msdk.foundation.controller.C8388a.m23845e()     // Catch:{ JSONException -> 0x0147 }
            android.content.Context r0 = r0.mo56913g()     // Catch:{ JSONException -> 0x0147 }
            java.lang.String r2 = com.mbridge.msdk.foundation.same.C8469a.f20744e     // Catch:{ JSONException -> 0x0147 }
            ...
            int r0 = com.mbridge.msdk.foundation.tools.C8677z.m24924b((android.content.Context) r0, (float) r2)     // Catch:{ JSONException -> 0x0147 }
            java.lang.String r0 = java.lang.String.valueOf(r0)     // Catch:{ JSONException -> 0x0147 }
            com.mbridge.msdk.foundation.controller.a r2 = com.mbridge.msdk.foundation.controller.C8388a.m23845e()     // Catch:{ JSONException -> 0x0147 }
            android.content.Context r2 = r2.mo56913g()     // Catch:{ JSONException -> 0x0147 }
            java.lang.String r3 = com.mbridge.msdk.foundation.same.C8469a.f20745f     // Catch:{ JSONException -> 0x0147 }
            ...
            int r2 = com.mbridge.msdk.foundation.tools.C8677z.m24924b((android.content.Context) r2, (float) r3)     // Catch:{ JSONException -> 0x0147 }
        ...
        L_0x008c:
            ...
            java.lang.String r0 = com.mbridge.msdk.click.C6779b.m20642a((java.lang.String) r3, (java.lang.String) r0, (java.lang.String) r2)     // Catch:{ JSONException -> 0x0147 }
        ...
        L_0x00a6:
            ...
            java.lang.String r6 = com.mbridge.msdk.foundation.same.C8469a.f20744e     // Catch:{ JSONException -> 0x0147 }
            boolean r6 = r6.equals(r4)     // Catch:{ JSONException -> 0x0147 }
            if (r6 != 0) goto L_0x00cb
            java.lang.String r6 = com.mbridge.msdk.foundation.same.C8469a.f20745f     // Catch:{ JSONException -> 0x0147 }
            boolean r6 = r6.equals(r4)     // Catch:{ JSONException -> 0x0147 }
            if (r6 == 0) goto L_0x00e4
        L_0x00cb:
            com.mbridge.msdk.foundation.controller.a r6 = com.mbridge.msdk.foundation.controller.C8388a.m23845e()     // Catch:{ JSONException -> 0x0147 }
            android.content.Context r6 = r6.mo56913g()     // Catch:{ JSONException -> 0x0147 }
            ...
            int r5 = com.mbridge.msdk.foundation.tools.C8677z.m24924b((android.content.Context) r6, (float) r5)     // Catch:{ JSONException -> 0x0147 }
