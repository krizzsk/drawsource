package com.mbridge.msdk.p078c.p080b;
...
public class C2446a {
    ...
    /* renamed from: a */
    public final void mo16296a(Context context, final String str) {
        if (context != null) {
            String b = C2461a.m6124a().mo16390b("MraidJSController");
            if (TextUtils.isEmpty(b) || !b.equals(str)) {
                try {
                    new C2443a(context).mo57975a(0, str, (C8550d) null, (C8532e) new C8510a() {
                        /* renamed from: b */
                        ...
                        public final void mo16125a(String str) {
                            if (!TextUtils.isEmpty(str)) {
                                String unused = C2446a.this.f5059c = str;
                                new Thread(new Runnable(str) {
                                    public final void run() {
                                        try {
                                            File file = new File(C8478e.m24306b(C8476c.MBRIDGE_OTHER), "mraid_js.txt");
                                            if (file.exists()) {
                                                file.delete();
                                            }
                                            C8666t.m24862a(r3.getBytes(), file);
                                        } catch (Exception e) {
                                            C8672v.m24874a("MraidJSController", e.getMessage());
                                        }
                                    }
                                }).start();
                                C2461a.m6124a().mo16388a("MraidJSController", str);
                            }
                        }
                    });
                } catch (Exception e) {
                    C8672v.m24878d("MraidJSController", e.getMessage());
                }
            }
        }
    }
    ...
    public final String mo16297b() {
        try {
            ...
            if (b != null && !TextUtils.isEmpty(b.mo16203au())) {
                mo16296a(C8388a.m23845e().mo56913g(), b.mo16203au());
            }
            return f5057a;
