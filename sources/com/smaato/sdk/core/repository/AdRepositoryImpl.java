...
import com.smaato.sdk.core.p382ub.AdMarkup;
import com.smaato.sdk.core.p382ub.UbCache;
import com.smaato.sdk.core.p382ub.UbId;
...
final class AdRepositoryImpl implements AdRepository {
    ...
    AdRepositoryImpl(com.smaato.sdk.core.log.Logger r1, com.smaato.sdk.core.p382ub.UbCache r2, com.smaato.sdk.core.repository.AdLoadersRegistry r3, com.smaato.sdk.core.util.p384fi.Supplier<com.smaato.sdk.core.p380ad.AdLoader> r4, com.smaato.sdk.core.flow.Schedulers r5, com.smaato.sdk.core.gdpr.SomaGdprDataSource r6, com.smaato.sdk.core.lgpd.SomaLgpdDataSource r7, com.smaato.sdk.core.UbErrorReporting r8, com.smaato.sdk.core.api.ExpirationTimestampFactory r9) {
        /*
            ...
            com.smaato.sdk.core.ub.UbCache r1 = (com.smaato.sdk.core.p382ub.UbCache) r1
            r0.ubCache = r1
            ...
            com.smaato.sdk.core.util.fi.Supplier r1 = (com.smaato.sdk.core.util.p384fi.Supplier) r1
    ...
    public Flow<AdPresenter> loadAd(AdTypeStrategy adTypeStrategy, AdRequest adRequest, Map<String, Object> map) {
        ...
        }).subscribeOn(this.executors.mo66432io()).observeOn(this.executors.main());
    }
    ...
    public /* synthetic */ void lambda$ubPipeline$5$AdRepositoryImpl(UbId ubId, AdRequest adRequest, AdTypeStrategy adTypeStrategy, Emitter emitter) throws Throwable {
        ...
        if (adMarkup != null) {
            ApiAdResponse build = ApiAdResponse.builder().adFormat(createAdFormat(adMarkup.adFormat())).body(adMarkup.markup().getBytes()).expiration(adMarkup.expiresAt()).sessionId(adMarkup.sessionId()).impressionCountingType(adMarkup.impressionCountingType() != null ? adMarkup.impressionCountingType() : ImpressionCountingType.STANDARD).build();
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private com.smaato.sdk.core.p380ad.AdFormat createAdFormat(java.lang.String r5) {
        /*
            r4 = this;
            r5.hashCode()
            int r0 = r5.hashCode()
        ...
        L_0x003b:
            ...
            com.smaato.sdk.core.ad.AdFormat r5 = com.smaato.sdk.core.p380ad.AdFormat.valueOf(r5)
            return r5
        L_0x0048:
            com.smaato.sdk.core.ad.AdFormat r5 = com.smaato.sdk.core.p380ad.AdFormat.RICH_MEDIA
            return r5
        L_0x004b:
            com.smaato.sdk.core.ad.AdFormat r5 = com.smaato.sdk.core.p380ad.AdFormat.VIDEO
            return r5
        L_0x004e:
            com.smaato.sdk.core.ad.AdFormat r5 = com.smaato.sdk.core.p380ad.AdFormat.STATIC_IMAGE
            return r5
        L_0x0051:
            com.smaato.sdk.core.ad.AdFormat r5 = com.smaato.sdk.core.p380ad.AdFormat.NATIVE
            return r5
        */
