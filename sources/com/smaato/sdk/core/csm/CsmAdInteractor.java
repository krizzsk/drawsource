...
public final class CsmAdInteractor extends AdInteractor<CsmAdObject> {
    ...
    public /* synthetic */ void lambda$new$0$CsmAdInteractor(ImpressionDetector impressionDetector, Logger logger2, BeaconTracker beaconTracker2, CsmAdObject csmAdObject) {
        if (this.impressionCountingType.equals(ImpressionCountingType.STANDARD)) {
            ...
            logger2.debug(LogDomain.CORE, "Going to send impression beacons", new Object[0]);
    ...
    static /* synthetic */ class C108121 {
        ...
        static {
            /*
                ...
                com.smaato.sdk.core.ad.AdStateMachine$State r1 = com.smaato.sdk.core.p380ad.AdStateMachine.State.CREATED     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = $SwitchMap$com$smaato$sdk$core$ad$AdStateMachine$State     // Catch:{ NoSuchFieldError -> 0x001d }
                com.smaato.sdk.core.ad.AdStateMachine$State r1 = com.smaato.sdk.core.p380ad.AdStateMachine.State.ON_SCREEN     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x0033:
                ...
                com.smaato.sdk.core.ad.AdStateMachine$State r1 = com.smaato.sdk.core.p380ad.AdStateMachine.State.TO_BE_DELETED     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.smaato.sdk.core.csm.CsmAdInteractor.C108121.<clinit>():void");
        }
    }

    /* access modifiers changed from: private */
    public void stateChanged(AdStateMachine.State state, AdStateMachine.State state2, Metadata metadata) {
        switch (C108121.$SwitchMap$com$smaato$sdk$core$ad$AdStateMachine$State[state2.ordinal()]) {
            case 1:
            case 2:
            case 4:
            case 5:
            ...
            case 3:
                if (this.impressionCountingType.equals(ImpressionCountingType.VIEWABLE)) {
                    this.logger.debug(LogDomain.CORE, "Going to send impression beacons", new Object[0]);
                ...
                return;
            case 6:
                this.logger.debug(LogDomain.CORE, "event %s: going to send click beacons", state2);
                this.beaconTracker.trackBeaconUrl(((CsmAdObject) getAdObject()).getNetwork().getClickUrl());
                return;
            default:
                this.logger.error(LogDomain.CORE, "Unexpected type of new state: %s", state2);
                return;
        }
    }
