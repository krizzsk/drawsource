...
public abstract class CsmAdPresenterBuilderImpl<Presenter extends AdPresenter> implements CsmAdPresenterBuilder {
    ...
    public CsmAdPresenterBuilderImpl(com.smaato.sdk.core.log.Logger r2, com.smaato.sdk.core.csm.CsmAdResponseParser r3, com.smaato.sdk.core.util.p384fi.Function<com.smaato.sdk.core.csm.CsmAdObject, com.smaato.sdk.core.csm.CsmAdInteractor> r4, com.smaato.sdk.core.util.p384fi.Function<com.smaato.sdk.core.csm.CsmAdInteractor, Presenter> r5) {
        /*
            r1 = this;
            r1.<init>()
            ...
            com.smaato.sdk.core.util.fi.Function r2 = (com.smaato.sdk.core.util.p384fi.Function) r2
    ...
    public void buildAdPresenter(SomaApiContext somaApiContext, CsmAdResponse csmAdResponse, AdPresenterBuilder.Listener listener) {
        ...
        if (createCsmAdObject != null) {
            this.logger.info(LogDomain.CORE, "parsed CsmAdObject = %s", createCsmAdObject);
            Activity currentActivity = ActivityProvider.get().getCurrentActivity();
            if (currentActivity == null) {
                this.logger.error(LogDomain.CORE, "Could not get current activity context, calling passbackUrl", new Object[0]);
    ...
    private CsmAdResponse createCsmAdResponse(SomaApiContext somaApiContext, AdPresenterBuilder.Listener listener) {
        ...
        try {
            try {
                ...
                this.logger.error(LogDomain.CORE, e, "Invalid AdResponse: %s", apiAdResponse);
                listener.onAdPresenterBuildError(this, new AdPresenterBuilderException(AdPresenterBuilder.Error.INVALID_RESPONSE, e));
                return null;
            }
        } catch (UnsupportedEncodingException e2) {
            this.logger.error(LogDomain.CORE, e2, "Invalid AdResponse: %s. Cannot parse AdResponse with provided charset: %s", apiAdResponse, apiAdResponse.getCharset());
    ...
    private CsmAdObject createCsmAdObject(SomaApiContext somaApiContext, CsmAdResponse csmAdResponse, AdPresenterBuilder.Listener listener) {
        try {
            ...
            this.logger.error(LogDomain.CORE, e, "Failed to build CsmAdObject", new Object[0]);
            listener.onAdPresenterBuildError(this, new AdPresenterBuilderException(AdPresenterBuilder.Error.INVALID_RESPONSE, e));
            return null;
        }
    }
