...
public final class SomaGdprV2Utils implements SomaGdprUtils {
    ...
    static /* synthetic */ class C108261 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.smaato.sdk.core.gdpr.SomaGdprV2Utils.C108261.<clinit>():void");
        }
    }

    private boolean isConsentGivenToPurposes(CmpV2Data cmpV2Data, PiiParam piiParam) {
        int i = C108261.$SwitchMap$com$smaato$sdk$core$gdpr$SubjectToGdpr[cmpV2Data.getSubjectToGdpr().ordinal()];
        if (i == 1) {
    ...
    private boolean canAccessPrivateDataWhenConsentStringValid(CmpV2Data cmpV2Data, PiiParam piiParam) {
        ...
        boolean isConsentGiven = isConsentGiven(purposesString, CmpV2Purpose.INFORMATION_STORAGE_AND_ACCESS.f26394id);
        CmpV2Purpose cmpV2Purpose = CmpV2Purpose.SELECT_BASIS_ADS;
        boolean isConsentGiven2 = isConsentGiven(purposesString, cmpV2Purpose.f26394id);
        boolean isConsentGiven3 = isConsentGiven(purposeLegitimateInterests, cmpV2Purpose.f26394id);
    ...
    private boolean ifAdRequestAllowed(CmpV2Data cmpV2Data) {
        return isBitString(cmpV2Data.getPurposesString()) || isConsentGiven(cmpV2Data.getPurposesString(), CmpV2Purpose.INFORMATION_STORAGE_AND_ACCESS.f26394id) || isConsentGiven(cmpV2Data.getPurposesString(), CmpV2Purpose.SELECT_BASIS_ADS.f26394id);
    }
