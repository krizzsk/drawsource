...
final class DnsMessage {
    ...
    DnsMessage(byte[] bArr) throws IOException, IllegalArgumentException {
        ...
        this.f26387id = dataInputStream.readUnsignedShort();
        int readUnsignedShort = dataInputStream.readUnsignedShort();
        boolean z = true;
        this.f26388qr = ((readUnsignedShort >> 15) & 1) == 1;
    ...
    private byte[] serialize() {
        ...
        try {
            dataOutputStream.writeShort((short) this.f26387id);
    ...
    private int calculateHeaderBitmap() {
        int i = this.f26388qr ? 32768 : 0;
        Opcode opcode2 = this.opcode;
        if (opcode2 != null) {
            i += opcode2.getValue() << Ascii.f18309VT;
        }
