...
public final class DiDns {
    private static final Set<InetAddress> DNS_SERVERS = Sets.m30612of(InetAddressUtil.ipv4From("8.8.8.8"), InetAddressUtil.ipv6From("[2001:4860:4860::8888]"));

    private DiDns() {
    }

    public static DiRegistry createRegistry() {
        return DiRegistry.m30601of($$Lambda$DiDns$SQRorG2POSefiIAcTz1wwseJjA.INSTANCE);
    }
