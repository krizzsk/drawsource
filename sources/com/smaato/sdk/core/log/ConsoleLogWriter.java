...
class ConsoleLogWriter extends LogWriter {
    ...
    static /* synthetic */ class C108661 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.smaato.sdk.core.log.ConsoleLogWriter.C108661.<clinit>():void");
        }
    }

    private int mapToAndroidLogLevel(LogLevel logLevel) {
        int i = C108661.$SwitchMap$com$smaato$sdk$core$log$LogLevel[logLevel.ordinal()];
        if (i == 1) {
            return 3;
        }
        if (i == 2) {
