...
final class ErrorMappingUtil {
    ...
    static ApiConnectorException mapSomaExceptionToApiConnectorLayerException(Exception exc) {
        ...
        if (exc instanceof SomaException) {
            int i = C107951.$SwitchMap$com$smaato$sdk$core$network$SomaException$Type[((SomaException) exc).getType().ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C107951 {
        ...
        static {
            ...
            L_0x0012:
                r0 = 2
                int[] r2 = f26386x137c019c     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                r2 = 3
                int[] r3 = f26386x137c019c     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                r3 = 4
                int[] r4 = f26386x137c019c     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r4 = f26386x137c019c     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r4 = f26386x137c019c     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r4 = f26386x137c019c     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                int[] r4 = f26386x137c019c     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r4 = f26386x137c019c     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x006c:
                int[] r4 = f26386x137c019c     // Catch:{ NoSuchFieldError -> 0x0078 }
            ...
            L_0x0078:
                int[] r4 = f26386x137c019c     // Catch:{ NoSuchFieldError -> 0x0084 }
            ...
            L_0x00b3:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.smaato.sdk.core.api.ErrorMappingUtil.C107951.<clinit>():void");
        }
    }
    ...
    static ApiConnectorException mapApiResponseMapperErrorToApiConnectorException(ApiResponseMapper.MappingException mappingException) {
        ApiConnector.Error error;
        if (C107951.f26386x137c019c[mappingException.type.ordinal()] != 1) {
