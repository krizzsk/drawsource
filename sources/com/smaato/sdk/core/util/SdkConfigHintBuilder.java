...
public class SdkConfigHintBuilder {
    ...
    static /* synthetic */ class C108811 {
        ...
        static {
            /*
                ...
                com.smaato.sdk.core.ad.AdFormat r1 = com.smaato.sdk.core.p380ad.AdFormat.RICH_MEDIA     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = $SwitchMap$com$smaato$sdk$core$ad$AdFormat     // Catch:{ NoSuchFieldError -> 0x001d }
                com.smaato.sdk.core.ad.AdFormat r1 = com.smaato.sdk.core.p380ad.AdFormat.VIDEO     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.smaato.sdk.core.util.SdkConfigHintBuilder.C108811.<clinit>():void");
        }
    }
    ...
    public String buildSdkModuleMissedHintForAdFormat(AdFormat adFormat) {
        String str;
        String str2;
        int i = C108811.$SwitchMap$com$smaato$sdk$core$ad$AdFormat[adFormat.ordinal()];
        if (i == 1) {
            str = "Rich Media";
