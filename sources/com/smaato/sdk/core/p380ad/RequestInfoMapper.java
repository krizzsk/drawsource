...
public final class RequestInfoMapper {
    public Integer mapToApiValue(GeoType geoType) {
        int i = C107901.$SwitchMap$com$smaato$sdk$core$ad$GeoType[geoType.ordinal()];
        if (i == 1) {
            return 1;
        }
        if (i == 2) {
    ...
    static /* synthetic */ class C107901 {
        ...
        static {
            ...
            L_0x0033:
                com.smaato.sdk.core.ad.GeoType[] r3 = com.smaato.sdk.core.p380ad.GeoType.values()
                int r3 = r3.length
                int[] r3 = new int[r3]
                $SwitchMap$com$smaato$sdk$core$ad$GeoType = r3
                com.smaato.sdk.core.ad.GeoType r4 = com.smaato.sdk.core.p380ad.GeoType.GPS     // Catch:{ NoSuchFieldError -> 0x0044 }
            ...
            L_0x0044:
                ...
                com.smaato.sdk.core.ad.GeoType r3 = com.smaato.sdk.core.p380ad.GeoType.IP_ADDRESS     // Catch:{ NoSuchFieldError -> 0x004e }
            ...
            L_0x004e:
                ...
                com.smaato.sdk.core.ad.GeoType r1 = com.smaato.sdk.core.p380ad.GeoType.USER_PROVIDED     // Catch:{ NoSuchFieldError -> 0x0058 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0058 }
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0058 }
            L_0x0058:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.smaato.sdk.core.p380ad.RequestInfoMapper.C107901.<clinit>():void");
        }
    }

    public String mapToApiValue(AdContentRating adContentRating) {
        int i = C107901.$SwitchMap$com$smaato$sdk$core$AdContentRating[adContentRating.ordinal()];
        if (i == 1) {
            return "G";
        }
        if (i == 2) {
