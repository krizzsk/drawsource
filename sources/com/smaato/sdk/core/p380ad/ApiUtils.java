...
public final class ApiUtils {
    ...
    static /* synthetic */ class C107881 {
        ...
        static {
            /*
                com.smaato.sdk.core.ad.AdFormat[] r0 = com.smaato.sdk.core.p380ad.AdFormat.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                $SwitchMap$com$smaato$sdk$core$ad$AdFormat = r0
                com.smaato.sdk.core.ad.AdFormat r1 = com.smaato.sdk.core.p380ad.AdFormat.DISPLAY     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = $SwitchMap$com$smaato$sdk$core$ad$AdFormat     // Catch:{ NoSuchFieldError -> 0x001d }
                com.smaato.sdk.core.ad.AdFormat r1 = com.smaato.sdk.core.p380ad.AdFormat.STATIC_IMAGE     // Catch:{ NoSuchFieldError -> 0x001d }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                int[] r0 = $SwitchMap$com$smaato$sdk$core$ad$AdFormat     // Catch:{ NoSuchFieldError -> 0x0028 }
                com.smaato.sdk.core.ad.AdFormat r1 = com.smaato.sdk.core.p380ad.AdFormat.RICH_MEDIA     // Catch:{ NoSuchFieldError -> 0x0028 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0028 }
                r2 = 3
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0028 }
            L_0x0028:
                int[] r0 = $SwitchMap$com$smaato$sdk$core$ad$AdFormat     // Catch:{ NoSuchFieldError -> 0x0033 }
                com.smaato.sdk.core.ad.AdFormat r1 = com.smaato.sdk.core.p380ad.AdFormat.VIDEO     // Catch:{ NoSuchFieldError -> 0x0033 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0033 }
                r2 = 4
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0033 }
            L_0x0033:
                int[] r0 = $SwitchMap$com$smaato$sdk$core$ad$AdFormat     // Catch:{ NoSuchFieldError -> 0x003e }
                com.smaato.sdk.core.ad.AdFormat r1 = com.smaato.sdk.core.p380ad.AdFormat.NATIVE     // Catch:{ NoSuchFieldError -> 0x003e }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x003e }
                r2 = 5
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x003e }
            L_0x003e:
                int[] r0 = $SwitchMap$com$smaato$sdk$core$ad$AdFormat     // Catch:{ NoSuchFieldError -> 0x0049 }
                com.smaato.sdk.core.ad.AdFormat r1 = com.smaato.sdk.core.p380ad.AdFormat.INTERSTITIAL     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.smaato.sdk.core.p380ad.ApiUtils.C107881.<clinit>():void");
        }
    }

    public static String adFormatToApiValue(AdFormat adFormat) {
        switch (C107881.$SwitchMap$com$smaato$sdk$core$ad$AdFormat[adFormat.ordinal()]) {
            case 1:
                return "display";
            case 2:
                return "img";
