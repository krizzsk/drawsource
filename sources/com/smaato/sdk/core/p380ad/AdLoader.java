...
import com.smaato.sdk.core.p380ad.AdRequestMapper;
...
public class AdLoader {
    ...
    public void handleApiConnectorException(ApiConnectorException apiConnectorException) {
        Error error;
        switch (C107832.$SwitchMap$com$smaato$sdk$core$api$ApiConnector$Error[apiConnectorException.getErrorType().ordinal()]) {
            case 1:
                error = Error.NO_AD;
                break;
            case 2:
    ...
    private final class AdPresenterBuilderListener implements AdPresenterBuilder.Listener {
        ...
        public void onAdPresenterBuildSuccess(AdPresenterBuilder adPresenterBuilder, AdPresenter adPresenter) {
            ...
            Objects.onNotNull(AdLoader.this.listener, new Consumer(adPresenter) {
                ...
                public final void accept(Object obj) {
                    AdLoader.AdPresenterBuilderListener.this.mo65874x5954ce3e(this.f$1, (AdLoader.Listener) obj);
                }
            });
        }

        /* renamed from: lambda$onAdPresenterBuildSuccess$0$AdLoader$AdPresenterBuilderListener */
        public /* synthetic */ void mo65874x5954ce3e(AdPresenter adPresenter, Listener listener) {
        ...
        public void onAdPresenterBuildError(AdPresenterBuilder adPresenterBuilder, AdPresenterBuilderException adPresenterBuilderException) {
            ...
            Objects.onNotNull(AdLoader.this.listener, new Consumer(handleAdPresenterBuilderException(adPresenterBuilderException), adPresenterBuilderException) {
                ...
                public final void accept(Object obj) {
                    AdLoader.AdPresenterBuilderListener.this.mo65873x963e2c4(this.f$1, this.f$2, (AdLoader.Listener) obj);
                }
            });
        }

        /* renamed from: lambda$onAdPresenterBuildError$1$AdLoader$AdPresenterBuilderListener */
        public /* synthetic */ void mo65873x963e2c4(Error error, AdPresenterBuilderException adPresenterBuilderException, Listener listener) {
        ...
        private Error handleAdPresenterBuilderException(AdPresenterBuilderException adPresenterBuilderException) {
            switch (C107832.$SwitchMap$com$smaato$sdk$core$ad$AdPresenterBuilder$Error[adPresenterBuilderException.getErrorType().ordinal()]) {
                case 1:
    ...
    static /* synthetic */ class C107832 {
        ...
        static {
            /*
                com.smaato.sdk.core.ad.AdPresenterBuilder$Error[] r0 = com.smaato.sdk.core.p380ad.AdPresenterBuilder.Error.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                $SwitchMap$com$smaato$sdk$core$ad$AdPresenterBuilder$Error = r0
                r1 = 1
                com.smaato.sdk.core.ad.AdPresenterBuilder$Error r2 = com.smaato.sdk.core.p380ad.AdPresenterBuilder.Error.CANCELLED     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r2 = r2.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r0[r2] = r1     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                r0 = 2
                int[] r2 = $SwitchMap$com$smaato$sdk$core$ad$AdPresenterBuilder$Error     // Catch:{ NoSuchFieldError -> 0x001d }
                com.smaato.sdk.core.ad.AdPresenterBuilder$Error r3 = com.smaato.sdk.core.p380ad.AdPresenterBuilder.Error.INVALID_RESPONSE     // Catch:{ NoSuchFieldError -> 0x001d }
                int r3 = r3.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
                r2[r3] = r0     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                r2 = 3
                int[] r3 = $SwitchMap$com$smaato$sdk$core$ad$AdPresenterBuilder$Error     // Catch:{ NoSuchFieldError -> 0x0028 }
                com.smaato.sdk.core.ad.AdPresenterBuilder$Error r4 = com.smaato.sdk.core.p380ad.AdPresenterBuilder.Error.RESOURCE_EXPIRED     // Catch:{ NoSuchFieldError -> 0x0028 }
                int r4 = r4.ordinal()     // Catch:{ NoSuchFieldError -> 0x0028 }
                r3[r4] = r2     // Catch:{ NoSuchFieldError -> 0x0028 }
            L_0x0028:
                r3 = 4
                int[] r4 = $SwitchMap$com$smaato$sdk$core$ad$AdPresenterBuilder$Error     // Catch:{ NoSuchFieldError -> 0x0033 }
                com.smaato.sdk.core.ad.AdPresenterBuilder$Error r5 = com.smaato.sdk.core.p380ad.AdPresenterBuilder.Error.TRANSPORT_NO_NETWORK_CONNECTION     // Catch:{ NoSuchFieldError -> 0x0033 }
                int r5 = r5.ordinal()     // Catch:{ NoSuchFieldError -> 0x0033 }
                r4[r5] = r3     // Catch:{ NoSuchFieldError -> 0x0033 }
            L_0x0033:
                r4 = 5
                int[] r5 = $SwitchMap$com$smaato$sdk$core$ad$AdPresenterBuilder$Error     // Catch:{ NoSuchFieldError -> 0x003e }
                com.smaato.sdk.core.ad.AdPresenterBuilder$Error r6 = com.smaato.sdk.core.p380ad.AdPresenterBuilder.Error.TRANSPORT_TIMEOUT     // Catch:{ NoSuchFieldError -> 0x003e }
                int r6 = r6.ordinal()     // Catch:{ NoSuchFieldError -> 0x003e }
                r5[r6] = r4     // Catch:{ NoSuchFieldError -> 0x003e }
            L_0x003e:
                r5 = 6
                int[] r6 = $SwitchMap$com$smaato$sdk$core$ad$AdPresenterBuilder$Error     // Catch:{ NoSuchFieldError -> 0x0049 }
                com.smaato.sdk.core.ad.AdPresenterBuilder$Error r7 = com.smaato.sdk.core.p380ad.AdPresenterBuilder.Error.TRANSPORT_IO_ERROR     // Catch:{ NoSuchFieldError -> 0x0049 }
                int r7 = r7.ordinal()     // Catch:{ NoSuchFieldError -> 0x0049 }
                r6[r7] = r5     // Catch:{ NoSuchFieldError -> 0x0049 }
            L_0x0049:
                r6 = 7
                int[] r7 = $SwitchMap$com$smaato$sdk$core$ad$AdPresenterBuilder$Error     // Catch:{ NoSuchFieldError -> 0x0054 }
                com.smaato.sdk.core.ad.AdPresenterBuilder$Error r8 = com.smaato.sdk.core.p380ad.AdPresenterBuilder.Error.TRANSPORT_IO_TOO_MANY_REDIRECTS     // Catch:{ NoSuchFieldError -> 0x0054 }
                int r8 = r8.ordinal()     // Catch:{ NoSuchFieldError -> 0x0054 }
                r7[r8] = r6     // Catch:{ NoSuchFieldError -> 0x0054 }
            L_0x0054:
                int[] r7 = $SwitchMap$com$smaato$sdk$core$ad$AdPresenterBuilder$Error     // Catch:{ NoSuchFieldError -> 0x0060 }
                com.smaato.sdk.core.ad.AdPresenterBuilder$Error r8 = com.smaato.sdk.core.p380ad.AdPresenterBuilder.Error.TRANSPORT_GENERIC     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                ...
                com.smaato.sdk.core.ad.AdPresenterBuilder$Error r8 = com.smaato.sdk.core.p380ad.AdPresenterBuilder.Error.GENERIC     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x00b9:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.smaato.sdk.core.p380ad.AdLoader.C107832.<clinit>():void");
        }
    }
}
