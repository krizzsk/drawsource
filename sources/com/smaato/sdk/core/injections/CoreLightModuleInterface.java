...
public class CoreLightModuleInterface implements SimpleModuleInterface {
    ...
    public DiRegistry moduleDiRegistry() {
        return DiRegistry.m30601of($$Lambda$CoreLightModuleInterface$m3o_o1oF5GPI0rRhxWcpn4pIX8.INSTANCE);
    }
    ...
    static /* synthetic */ void lambda$moduleDiRegistry$13(DiRegistry diRegistry) {
        ...
        diRegistry.registerSingletonFactory(NAME_DEFAULT_HTTP_HANDLER, HttpClient.class, $$Lambda$CoreLightModuleInterface$4N4fEZkHgnTZbNgBmzD7kOFJ5s.INSTANCE);
    ...
    static /* synthetic */ SimpleHttpClient lambda$moduleDiRegistry$0(DiConstructor diConstructor) {
        return new SimpleHttpClient((HttpClient) diConstructor.get(NAME_DEFAULT_HTTP_HANDLER, HttpClient.class), (Logger) diConstructor.get(Logger.class));
    }
    ...
    static /* synthetic */ LinkHandler lambda$moduleDiRegistry$7(DiConstructor diConstructor) {
        return new LinkHandler((Application) diConstructor.get(Application.class), (HttpClient) diConstructor.get(NAME_DEFAULT_HTTP_HANDLER, HttpClient.class), (SimpleHttpClient) diConstructor.get(SimpleHttpClient.class), (IntentLauncher) diConstructor.get(IntentLauncher.class), (ActivityQueries) diConstructor.get(ActivityQueries.class));
    }
