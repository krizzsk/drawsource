...
public final class ClosableView extends FrameLayout {
    ...
    private FrameLayout container = ((FrameLayout) findViewById(C11026R.C11028id.container));
    ...
    public ClosableView(Context context) {
        super(context);
        LayoutInflater.from(getContext()).inflate(C11026R.layout.smaato_sdk_richmedia_layout_closable, this, true);
        ImageButton imageButton = (ImageButton) findViewById(C11026R.C11028id.close);
