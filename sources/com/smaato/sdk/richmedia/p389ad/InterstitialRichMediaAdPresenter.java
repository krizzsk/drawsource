...
import com.smaato.sdk.core.p380ad.BaseAdPresenter;
...
import com.smaato.sdk.richmedia.p389ad.InterstitialRichMediaAdPresenter;
import com.smaato.sdk.richmedia.p389ad.RichMediaAdInteractor;
import com.smaato.sdk.richmedia.p389ad.tracker.RichMediaVisibilityTracker;
import com.smaato.sdk.richmedia.p389ad.tracker.RichMediaVisibilityTrackerCreator;
import com.smaato.sdk.richmedia.p389ad.tracker.VisibilityTrackerListener;
...
class InterstitialRichMediaAdPresenter extends BaseAdPresenter implements InterstitialAdPresenter {
    ...
    InterstitialRichMediaAdPresenter(Logger logger2, RichMediaAdInteractor richMediaAdInteractor, RichMediaVisibilityTrackerCreator richMediaVisibilityTrackerCreator2, Timer timer, AppBackgroundDetector appBackgroundDetector2, MraidConfigurator mraidConfigurator2, OMWebViewViewabilityTracker oMWebViewViewabilityTracker) {
        ...
        C11060xbbfd39a5 r5 = new StateMachine.Listener(richMediaAdInteractor, logger2) {
    ...
    static /* synthetic */ class C110803 {
        ...
        static {
            /*
                com.smaato.sdk.core.ad.AdStateMachine$State[] r0 = com.smaato.sdk.core.p380ad.AdStateMachine.State.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                $SwitchMap$com$smaato$sdk$core$ad$AdStateMachine$State = r0
                com.smaato.sdk.core.ad.AdStateMachine$State r1 = com.smaato.sdk.core.p380ad.AdStateMachine.State.INIT     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = $SwitchMap$com$smaato$sdk$core$ad$AdStateMachine$State     // Catch:{ NoSuchFieldError -> 0x001d }
                com.smaato.sdk.core.ad.AdStateMachine$State r1 = com.smaato.sdk.core.p380ad.AdStateMachine.State.CREATED     // Catch:{ NoSuchFieldError -> 0x001d }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                int[] r0 = $SwitchMap$com$smaato$sdk$core$ad$AdStateMachine$State     // Catch:{ NoSuchFieldError -> 0x0028 }
                com.smaato.sdk.core.ad.AdStateMachine$State r1 = com.smaato.sdk.core.p380ad.AdStateMachine.State.IMPRESSED     // Catch:{ NoSuchFieldError -> 0x0028 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0028 }
                r2 = 3
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0028 }
            L_0x0028:
                int[] r0 = $SwitchMap$com$smaato$sdk$core$ad$AdStateMachine$State     // Catch:{ NoSuchFieldError -> 0x0033 }
                com.smaato.sdk.core.ad.AdStateMachine$State r1 = com.smaato.sdk.core.p380ad.AdStateMachine.State.COMPLETE     // Catch:{ NoSuchFieldError -> 0x0033 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0033 }
                r2 = 4
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0033 }
            L_0x0033:
                int[] r0 = $SwitchMap$com$smaato$sdk$core$ad$AdStateMachine$State     // Catch:{ NoSuchFieldError -> 0x003e }
                com.smaato.sdk.core.ad.AdStateMachine$State r1 = com.smaato.sdk.core.p380ad.AdStateMachine.State.ON_SCREEN     // Catch:{ NoSuchFieldError -> 0x003e }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x003e }
                r2 = 5
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x003e }
            L_0x003e:
                int[] r0 = $SwitchMap$com$smaato$sdk$core$ad$AdStateMachine$State     // Catch:{ NoSuchFieldError -> 0x0049 }
                com.smaato.sdk.core.ad.AdStateMachine$State r1 = com.smaato.sdk.core.p380ad.AdStateMachine.State.CLICKED     // Catch:{ NoSuchFieldError -> 0x0049 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0049 }
                r2 = 6
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0049 }
            L_0x0049:
                int[] r0 = $SwitchMap$com$smaato$sdk$core$ad$AdStateMachine$State     // Catch:{ NoSuchFieldError -> 0x0054 }
                com.smaato.sdk.core.ad.AdStateMachine$State r1 = com.smaato.sdk.core.p380ad.AdStateMachine.State.TO_BE_DELETED     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.smaato.sdk.richmedia.p389ad.InterstitialRichMediaAdPresenter.C110803.<clinit>():void");
        }
    }
    ...
    public /* synthetic */ void lambda$new$2$InterstitialRichMediaAdPresenter(RichMediaAdInteractor richMediaAdInteractor, Logger logger2, AdStateMachine.State state, AdStateMachine.State state2, Metadata metadata) {
        switch (C110803.$SwitchMap$com$smaato$sdk$core$ad$AdStateMachine$State[state2.ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
        ...
        createViewForInterstitial.addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() {
            ...
            public void onViewDetachedFromWindow(View view) {
                ...
                Objects.onNotNull((RichMediaVisibilityTracker) InterstitialRichMediaAdPresenter.this.visibilityTrackerReference.get(), new Consumer() {
                    public final void accept(Object obj) {
                        InterstitialRichMediaAdPresenter.C110781.this.mo67859x3865df61((RichMediaVisibilityTracker) obj);
                    }
                });
                Objects.onNotNull((RichMediaAdContentView) InterstitialRichMediaAdPresenter.this.contentViewRef.get(), new Consumer() {
                    public final void accept(Object obj) {
                        InterstitialRichMediaAdPresenter.C110781.this.mo67860xaca517c0((RichMediaAdContentView) obj);
                    }
                });
            }

            /* renamed from: lambda$onViewDetachedFromWindow$0$InterstitialRichMediaAdPresenter$1 */
            public /* synthetic */ void mo67859x3865df61(RichMediaVisibilityTracker richMediaVisibilityTracker) {
            ...
            public /* synthetic */ void mo67860xaca517c0(RichMediaAdContentView richMediaAdContentView) {
    ...
    private final class RichMediaAdContentViewCallback implements RichMediaAdContentView.Callback {
        ...
        public void onUrlClicked(RichMediaAdContentView richMediaAdContentView, String str) {
            ...
            InterstitialRichMediaAdPresenter.this.adInteractor.handleClickUrl(str, new Runnable() {
                public final void run() {
                    InterstitialRichMediaAdPresenter.RichMediaAdContentViewCallback.this.mo67870x70c8568f();
                }
            }, new Runnable() {
                public final void run() {
        ...
        public /* synthetic */ void mo67870x70c8568f() {
        ...
        public void onUnloadView(RichMediaAdContentView richMediaAdContentView) {
            Threads.runOnUi(new Runnable() {
                public final void run() {
                    InterstitialRichMediaAdPresenter.RichMediaAdContentViewCallback.this.mo67869xf3de321d();
                }
            });
        }

        /* renamed from: lambda$onUnloadView$2$InterstitialRichMediaAdPresenter$RichMediaAdContentViewCallback */
        public /* synthetic */ void mo67869xf3de321d() {
            ...
            Objects.onNotNull(InterstitialRichMediaAdPresenter.this.listener, new Consumer() {
                public final void accept(Object obj) {
                    InterstitialRichMediaAdPresenter.RichMediaAdContentViewCallback.this.mo67868xa61eba1c((InterstitialAdPresenter.Listener) obj);
                }
            });
        }

        /* renamed from: lambda$onUnloadView$1$InterstitialRichMediaAdPresenter$RichMediaAdContentViewCallback */
        public /* synthetic */ void mo67868xa61eba1c(InterstitialAdPresenter.Listener listener) {
        ...
        public void onHidden(RichMediaAdContentView richMediaAdContentView) {
            ...
            Objects.onNotNull(InterstitialRichMediaAdPresenter.this.listener, new Consumer() {
                public final void accept(Object obj) {
                    InterstitialRichMediaAdPresenter.RichMediaAdContentViewCallback.this.mo67866x73b3e04((InterstitialAdPresenter.Listener) obj);
                }
            });
        }

        /* renamed from: lambda$onHidden$3$InterstitialRichMediaAdPresenter$RichMediaAdContentViewCallback */
        public /* synthetic */ void mo67866x73b3e04(InterstitialAdPresenter.Listener listener) {
        ...
        public void onRenderProcessGone(RichMediaAdContentView richMediaAdContentView) {
            ...
            Objects.onNotNull(InterstitialRichMediaAdPresenter.this.listener, new Consumer() {
                public final void accept(Object obj) {
                    InterstitialRichMediaAdPresenter.RichMediaAdContentViewCallback.this.mo67867x4ff7179b((InterstitialAdPresenter.Listener) obj);
                }
            });
        }

        /* renamed from: lambda$onRenderProcessGone$4$InterstitialRichMediaAdPresenter$RichMediaAdContentViewCallback */
        public /* synthetic */ void mo67867x4ff7179b(InterstitialAdPresenter.Listener listener) {
        ...
        public void handleResolveUrlError() {
            Threads.runOnUi(new Runnable() {
                public final void run() {
                    InterstitialRichMediaAdPresenter.RichMediaAdContentViewCallback.this.mo67865x3c8afe62();
                }
            });
        }

        /* renamed from: lambda$handleResolveUrlError$7$InterstitialRichMediaAdPresenter$RichMediaAdContentViewCallback */
        public /* synthetic */ void mo67865x3c8afe62() {
            InterstitialRichMediaAdPresenter.this.logger.error(LogDomain.AD, "The url seems to be invalid", new Object[0]);
            Objects.onNotNull((RichMediaAdContentView) InterstitialRichMediaAdPresenter.this.contentViewRef.get(), C11048x9d854644.INSTANCE);
            Objects.onNotNull(InterstitialRichMediaAdPresenter.this.listener, new Consumer() {
                public final void accept(Object obj) {
                    InterstitialRichMediaAdPresenter.RichMediaAdContentViewCallback.this.mo67864xeecb8661((InterstitialAdPresenter.Listener) obj);
                }
            });
        }

        /* renamed from: lambda$handleResolveUrlError$6$InterstitialRichMediaAdPresenter$RichMediaAdContentViewCallback */
        public /* synthetic */ void mo67864xeecb8661(InterstitialAdPresenter.Listener listener) {
            listener.onAdError(InterstitialRichMediaAdPresenter.this);
        }

        /* access modifiers changed from: private */
        public void handleResolveUrlSuccess() {
            Objects.onNotNull((RichMediaAdContentView) InterstitialRichMediaAdPresenter.this.contentViewRef.get(), C11047xb0037e7.INSTANCE);
        }
    }
