...
import com.smaato.sdk.richmedia.p389ad.BannerRichMediaAdPresenter;
...
class BannerRichMediaAdPresenter extends BaseAdPresenter implements BannerAdPresenter {
    ...
    static /* synthetic */ class C110772 {
        ...
        static {
            ...
            L_0x001d:
                ...
                com.smaato.sdk.core.ad.AdStateMachine$State r1 = com.smaato.sdk.core.p380ad.AdStateMachine.State.COMPLETE     // Catch:{ NoSuchFieldError -> 0x0028 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0028 }
                r2 = 3
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0028 }
            L_0x0028:
                int[] r0 = $SwitchMap$com$smaato$sdk$core$ad$AdStateMachine$State     // Catch:{ NoSuchFieldError -> 0x0033 }
                com.smaato.sdk.core.ad.AdStateMachine$State r1 = com.smaato.sdk.core.p380ad.AdStateMachine.State.ON_SCREEN     // Catch:{ NoSuchFieldError -> 0x0033 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0033 }
                r2 = 4
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0033 }
            L_0x0033:
                int[] r0 = $SwitchMap$com$smaato$sdk$core$ad$AdStateMachine$State     // Catch:{ NoSuchFieldError -> 0x003e }
                com.smaato.sdk.core.ad.AdStateMachine$State r1 = com.smaato.sdk.core.p380ad.AdStateMachine.State.IMPRESSED     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.smaato.sdk.richmedia.p389ad.BannerRichMediaAdPresenter.C110772.<clinit>():void");
        }
    }
    ...
    public /* synthetic */ void lambda$new$3$BannerRichMediaAdPresenter(OMWebViewViewabilityTracker oMWebViewViewabilityTracker, RichMediaAdInteractor richMediaAdInteractor, Logger logger2, AdStateMachine.State state, AdStateMachine.State state2, Metadata metadata) {
        switch (C110772.$SwitchMap$com$smaato$sdk$core$ad$AdStateMachine$State[state2.ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
    ...
    private final class RichMediaAdContentViewCallback implements RichMediaAdContentView.Callback {
        ...
        public void onUrlClicked(RichMediaAdContentView richMediaAdContentView, String str) {
            ...
            BannerRichMediaAdPresenter.this.adInteractor.handleClickUrl(str, new Runnable() {
                public final void run() {
                    BannerRichMediaAdPresenter.RichMediaAdContentViewCallback.this.mo67849xd0128b8f();
                }
            }, new Runnable() {
                public final void run() {
        ...
        public /* synthetic */ void mo67849xd0128b8f() {
        ...
        public void onAdExpanded(RichMediaAdContentView richMediaAdContentView) {
            if (BannerRichMediaAdPresenter.this.appBackgroundDetector.isAppInBackground()) {
                ...
                Objects.onNotNull((BannerAdPresenter.Listener) BannerRichMediaAdPresenter.this.listener.get(), new Consumer() {
                    public final void accept(Object obj) {
                        BannerRichMediaAdPresenter.RichMediaAdContentViewCallback.this.mo67845xe7190c94((BannerAdPresenter.Listener) obj);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo67845xe7190c94(BannerAdPresenter.Listener listener) {
        ...
        public /* synthetic */ void mo67847x615fa99d(BannerAdPresenter.Listener listener) {
        ...
        public /* synthetic */ void mo67848x7215765e() {
            Objects.onNotNull((BannerAdPresenter.Listener) BannerRichMediaAdPresenter.this.listener.get(), new Consumer() {
                public final void accept(Object obj) {
                    BannerRichMediaAdPresenter.RichMediaAdContentViewCallback.this.mo67847x615fa99d((BannerAdPresenter.Listener) obj);
                }
            });
        }
        ...
        public void onUnloadView(RichMediaAdContentView richMediaAdContentView) {
            Threads.runOnUi(new Runnable() {
                public final void run() {
                    BannerRichMediaAdPresenter.RichMediaAdContentViewCallback.this.mo67848x7215765e();
                }
            });
        }
        ...
        public /* synthetic */ void mo67846x657a059b(BannerAdPresenter.Listener listener) {
        ...
        public void onRenderProcessGone(RichMediaAdContentView richMediaAdContentView) {
            Objects.onNotNull((BannerAdPresenter.Listener) BannerRichMediaAdPresenter.this.listener.get(), new Consumer() {
                public final void accept(Object obj) {
                    BannerRichMediaAdPresenter.RichMediaAdContentViewCallback.this.mo67846x657a059b((BannerAdPresenter.Listener) obj);
                }
            });
        }
        ...
        public void handleResolveUrlError() {
            Threads.runOnUi(new Runnable() {
                public final void run() {
                    BannerRichMediaAdPresenter.RichMediaAdContentViewCallback.this.mo67844x2d984da2();
                }
            });
        }

        /* renamed from: lambda$handleResolveUrlError$7$BannerRichMediaAdPresenter$RichMediaAdContentViewCallback */
        public /* synthetic */ void mo67844x2d984da2() {
            BannerRichMediaAdPresenter.this.logger.error(LogDomain.AD, "The url seems to be invalid", new Object[0]);
            Objects.onNotNull((RichMediaAdContentView) BannerRichMediaAdPresenter.this.contentViewRef.get(), C11040xdda958a0.INSTANCE);
            Objects.onNotNull((BannerAdPresenter.Listener) BannerRichMediaAdPresenter.this.listener.get(), new Consumer() {
                public final void accept(Object obj) {
                    BannerRichMediaAdPresenter.RichMediaAdContentViewCallback.this.mo67843x1ce280e1((BannerAdPresenter.Listener) obj);
                }
            });
        }

        /* renamed from: lambda$handleResolveUrlError$6$BannerRichMediaAdPresenter$RichMediaAdContentViewCallback */
        public /* synthetic */ void mo67843x1ce280e1(BannerAdPresenter.Listener listener) {
            listener.onAdError(BannerRichMediaAdPresenter.this);
        }

        /* access modifiers changed from: private */
        public void handleResolveUrlSuccess() {
            Objects.onNotNull((RichMediaAdContentView) BannerRichMediaAdPresenter.this.contentViewRef.get(), C11033xc291f7c9.INSTANCE);
        }
    }
}
