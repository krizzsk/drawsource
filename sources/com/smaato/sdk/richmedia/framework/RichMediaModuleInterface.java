...
import com.smaato.sdk.core.p380ad.RequestInfoMapper;
import com.smaato.sdk.core.p380ad.RequestInfoProvider;
...
import com.smaato.sdk.richmedia.p389ad.DiRichMediaAdLayer;
import com.smaato.sdk.richmedia.p389ad.LoadedWebViewCache;
import com.smaato.sdk.richmedia.p389ad.RichMediaAdLoaderPlugin;
import com.smaato.sdk.richmedia.p389ad.RichMediaAdResponseParser;
import com.smaato.sdk.richmedia.p389ad.tracker.RichMediaVisibilityTrackerCreator;
import com.smaato.sdk.richmedia.p390di.DiNames;
...
public class RichMediaModuleInterface implements AdPresenterModuleInterface {
    ...
    private DiRegistry provideAudioVolumeObserver() {
        return DiRegistry.m30601of($$Lambda$RichMediaModuleInterface$MQUAcPPi2lO13tanQvncCVk5_6A.INSTANCE);
    }
    ...
    private DiRegistry provideOrientationChangeWatcher() {
        return DiRegistry.m30601of($$Lambda$RichMediaModuleInterface$NVZPFz9wL3epTscG9UqSOpE1Q.INSTANCE);
    }
    ...
    private DiRegistry provideRichMediaWebViewFactory() {
        return DiRegistry.m30601of(new Consumer() {
            public final void accept(Object obj) {
                RichMediaModuleInterface.this.mo67944x246b4372((DiRegistry) obj);
            }
        });
    }

    /* renamed from: lambda$provideRichMediaWebViewFactory$19$RichMediaModuleInterface */
    public /* synthetic */ void mo67944x246b4372(DiRegistry diRegistry) {
        diRegistry.registerFactory(RichMediaWebViewFactory.class, new ClassFactory() {
            public final Object get(DiConstructor diConstructor) {
                return RichMediaModuleInterface.this.mo67943x2291f053(diConstructor);
            }
        });
    }

    /* renamed from: lambda$provideRichMediaWebViewFactory$18$RichMediaModuleInterface */
    public /* synthetic */ RichMediaWebViewFactory mo67943x2291f053(DiConstructor diConstructor) {
    ...
    private DiRegistry provideMraidSupportsFeature() {
        return DiRegistry.m30601of($$Lambda$RichMediaModuleInterface$yB5MOCqlsmgT1xe5DnMsdokEZyI.INSTANCE);
    }
