...
public final class DeviceUtils {
    ...
    static /* synthetic */ class C110961 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f26410xecb9dd8b     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f26410xecb9dd8b     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.smaato.sdk.richmedia.util.DeviceUtils.C110961.<clinit>():void");
        }
    }

    public static int getActivityInfoOrientation(ScreenOrientation screenOrientation) {
        int i = C110961.f26410xecb9dd8b[screenOrientation.ordinal()];
        if (i != 1) {
            return i != 2 ? -1 : 0;
        }
        return 1;
