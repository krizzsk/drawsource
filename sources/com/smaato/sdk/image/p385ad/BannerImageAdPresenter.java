...
class BannerImageAdPresenter extends BaseAdPresenter implements BannerAdPresenter {
    ...
    static /* synthetic */ class C109232 {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.smaato.sdk.image.p385ad.BannerImageAdPresenter.C109232.<clinit>():void");
        }
    }
    ...
    public /* synthetic */ void lambda$new$3$BannerImageAdPresenter(ImageAdInteractor imageAdInteractor, Logger logger2, AdStateMachine.State state, AdStateMachine.State state2, Metadata metadata) {
        switch (C109232.$SwitchMap$com$smaato$sdk$core$ad$AdStateMachine$State[state2.ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
        ...
        try {
            ...
            if (list != null) {
                for (Extension extension : list) {
                    if (extension != null && extension.getName().equalsIgnoreCase(Extension.f26405OM)) {
