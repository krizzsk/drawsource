...
public final class BannerCsmAdPresenterImpl extends BaseAdPresenter implements BannerCsmAdPresenter {
    ...
    private final SMABannerNetworkEventListener bannerNetworkEventListener = new SMABannerNetworkEventListener() {
        public void onAdLoaded(View view) {
            ...
            Objects.onNotNull(BannerCsmAdPresenterImpl.this.adLoadedListener, new Consumer() {
                public final void accept(Object obj) {
                    BannerCsmAdPresenterImpl.C107631.this.lambda$onAdLoaded$0$BannerCsmAdPresenterImpl$1((CsmAdPresenter.Listener) obj);
                }
            });
        }
        ...
        public void onAdFailedToLoad() {
            Objects.onNotNull(BannerCsmAdPresenterImpl.this.adLoadedListener, new Consumer() {
                public final void accept(Object obj) {
                    BannerCsmAdPresenterImpl.C107631.this.lambda$onAdFailedToLoad$1$BannerCsmAdPresenterImpl$1((CsmAdPresenter.Listener) obj);
                }
            });
        }
        ...
        public void onAdTTLExpired() {
            ...
            Objects.onNotNull(BannerCsmAdPresenterImpl.this.bannerViewLoaderListener, new Consumer() {
                public final void accept(Object obj) {
                    BannerCsmAdPresenterImpl.C107631.this.lambda$onAdTTLExpired$2$BannerCsmAdPresenterImpl$1((AdPresenter.Listener) obj);
                }
            });
        }
    ...
    static /* synthetic */ class C107664 {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.smaato.sdk.banner.csm.BannerCsmAdPresenterImpl.C107664.<clinit>():void");
        }
    }
    ...
    public /* synthetic */ void lambda$new$3$BannerCsmAdPresenterImpl(CsmAdInteractor csmAdInteractor, Logger logger2, AdStateMachine.State state, AdStateMachine.State state2, Metadata metadata) {
        switch (C107664.$SwitchMap$com$smaato$sdk$core$ad$AdStateMachine$State[state2.ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
