...
public class InterstitialServerAdFormatResolvingFunction implements NullableFunction<Collection<AdFormat>, AdFormat> {
    private static final List<AdFormat> DISPLAY_AD_FORMATS = Lists.m30610of((T[]) new AdFormat[]{AdFormat.STATIC_IMAGE, AdFormat.RICH_MEDIA});
    private static final List<AdFormat> VIDEO_AD_FORMATS = Lists.m30610of((T[]) new AdFormat[]{AdFormat.STATIC_IMAGE, AdFormat.VIDEO});
