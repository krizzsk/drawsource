...
public abstract class SmaatoSplashActivity extends Activity {
    EventListener splashActivityEventListener = new EventListener() {
        public void onAdLoaded(InterstitialAd interstitialAd) {
            SmaatoSplashActivity.this.findViewById(C10941R.C10943id.smaato_sdk_interstitial_loading).setVisibility(8);
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(C10941R.layout.smaato_sdk_interstitial_splash_activity);
        findViewById(C10941R.C10943id.smaato_sdk_interstitial_loading).setVisibility(0);
