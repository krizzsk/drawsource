...
public final class RewardedCsmAdPresenterImpl extends BaseAdPresenter implements RewardedCsmAdPresenter {
    ...
    private final SMARewardedNetworkEventListener rewardedNetworkEventListener = new SMARewardedNetworkEventListener() {
        public void onAdLoaded() {
            Objects.onNotNull(RewardedCsmAdPresenterImpl.this.adLoadedListener, new Consumer() {
                public final void accept(Object obj) {
                    RewardedCsmAdPresenterImpl.C110151.this.lambda$onAdLoaded$0$RewardedCsmAdPresenterImpl$1((CsmAdPresenter.Listener) obj);
                }
            });
        }
        ...
        public void onAdFailedToLoad() {
            Objects.onNotNull(RewardedCsmAdPresenterImpl.this.adLoadedListener, new Consumer() {
                public final void accept(Object obj) {
                    RewardedCsmAdPresenterImpl.C110151.this.lambda$onAdFailedToLoad$1$RewardedCsmAdPresenterImpl$1((CsmAdPresenter.Listener) obj);
                }
            });
        }
        ...
        public void onAdError() {
            Objects.onNotNull(RewardedCsmAdPresenterImpl.this.rewardedAdListener, new Consumer() {
                public final void accept(Object obj) {
                    RewardedCsmAdPresenterImpl.C110151.this.lambda$onAdError$2$RewardedCsmAdPresenterImpl$1((RewardedCsmAdPresenter.Listener) obj);
                }
            });
        }
        ...
        public void onAdStarted() {
            ...
            Objects.onNotNull(RewardedCsmAdPresenterImpl.this.rewardedAdListener, new Consumer() {
                public final void accept(Object obj) {
                    RewardedCsmAdPresenterImpl.C110151.this.lambda$onAdStarted$3$RewardedCsmAdPresenterImpl$1((RewardedCsmAdPresenter.Listener) obj);
                }
            });
        }
        ...
        public void onAdClosed() {
            ...
            Objects.onNotNull(RewardedCsmAdPresenterImpl.this.rewardedAdListener, new Consumer() {
                public final void accept(Object obj) {
                    RewardedCsmAdPresenterImpl.C110151.this.lambda$onAdClosed$4$RewardedCsmAdPresenterImpl$1((RewardedCsmAdPresenter.Listener) obj);
                }
            });
        }
        ...
        public void onAdReward() {
            Objects.onNotNull(RewardedCsmAdPresenterImpl.this.rewardedAdListener, new Consumer() {
                public final void accept(Object obj) {
                    RewardedCsmAdPresenterImpl.C110151.this.lambda$onAdReward$5$RewardedCsmAdPresenterImpl$1((RewardedCsmAdPresenter.Listener) obj);
                }
            });
        }
        ...
        public void onAdTTLExpired() {
            ...
            Objects.onNotNull(RewardedCsmAdPresenterImpl.this.rewardedAdListener, new Consumer() {
                public final void accept(Object obj) {
                    RewardedCsmAdPresenterImpl.C110151.this.lambda$onAdTTLExpired$6$RewardedCsmAdPresenterImpl$1((RewardedCsmAdPresenter.Listener) obj);
                }
            });
        }
    ...
    static /* synthetic */ class C110162 {
        ...
        static {
            ...
            L_0x0033:
                ...
                com.smaato.sdk.core.ad.AdStateMachine$State r1 = com.smaato.sdk.core.p380ad.AdStateMachine.State.COMPLETE     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.smaato.sdk.rewarded.csm.RewardedCsmAdPresenterImpl.C110162.<clinit>():void");
        }
    }
    ...
    public /* synthetic */ void lambda$new$3$RewardedCsmAdPresenterImpl(CsmAdInteractor csmAdInteractor, Logger logger2, AdStateMachine.State state, AdStateMachine.State state2, Metadata metadata) {
        switch (C110162.$SwitchMap$com$smaato$sdk$core$ad$AdStateMachine$State[state2.ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
