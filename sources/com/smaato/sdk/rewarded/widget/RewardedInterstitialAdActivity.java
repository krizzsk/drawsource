...
import com.smaato.sdk.rewarded.C10999R;
...
public class RewardedInterstitialAdActivity extends Activity {
    ...
    private final RewardedAdPresenter.OnCloseEnabledListener onCloseEnabledListener = new RewardedAdPresenter.OnCloseEnabledListener() {
        public void onCloseEnabled(RewardedAdPresenter rewardedAdPresenter) {
            RewardedInterstitialAdActivity.this.findViewById(C10999R.C11001id.smaato_sdk_rewarded_ads_close).setVisibility(0);
    ...
    private void initView(AdContentView adContentView) {
        setContentView(C10999R.layout.smaato_sdk_rewarded_ads_activity);
        ((FrameLayout) findViewById(C10999R.C11001id.smaato_sdk_rewarded_ads_content)).addView(adContentView);
        View findViewById = findViewById(C10999R.C11001id.smaato_sdk_rewarded_ads_close);
