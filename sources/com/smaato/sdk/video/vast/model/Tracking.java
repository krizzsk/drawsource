...
public class Tracking {
    ...
    public static class Builder {
        ...
        private String getOffsetForQuarterEvent(VastEvent vastEvent2) {
            int i = C111321.$SwitchMap$com$smaato$sdk$video$vast$model$VastEvent[vastEvent2.ordinal()];
            if (i == 1) {
                return "75%";
            }
            if (i == 2) {
    ...
    static /* synthetic */ class C111321 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.smaato.sdk.video.vast.model.Tracking.C111321.<clinit>():void");
        }
    }
}
