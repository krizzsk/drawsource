...
public class ViewableImpression {
    ...
    /* renamed from: ID */
    public static final String f26442ID = "id";
    ...
    public static class Builder {
        ...
        public ViewableImpression build() {
            ...
            return new ViewableImpression(this.viewable, this.notViewable, immutableList, this.f26444id);
        }
    }
}
