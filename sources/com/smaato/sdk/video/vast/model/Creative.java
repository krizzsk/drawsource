...
public class Creative {
    ...
    /* renamed from: ID */
    public static final String f26428ID = "id";
    ...
    public static class Builder {
        ...
        public Creative build() {
            ...
            return new Creative(this.universalAdId, this.f26430id, this.adId, this.sequence, this.apiFramework, this.linear, this.companionAds);
        }
    }
}
