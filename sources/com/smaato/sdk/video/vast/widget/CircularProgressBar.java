...
public class CircularProgressBar extends View {
    ...
    private float backgroundStrokeWidth = getResources().getDimension(C11104R.dimen.smaato_sdk_video_default_stroke_width);
    ...
    private float strokeWidth = getResources().getDimension(C11104R.dimen.smaato_sdk_video_default_background_stroke_width);
    ...
    private void init(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C11104R.styleable.smaato_sdk_video_circular_progress_bar, 0, 0);
        try {
            this.strokeWidth = obtainStyledAttributes.getDimension(C11104R.styleable.f26417x5b5543a1, this.strokeWidth);
            this.backgroundStrokeWidth = obtainStyledAttributes.getDimension(C11104R.styleable.f26414x564d8d28, this.backgroundStrokeWidth);
            this.color = obtainStyledAttributes.getInt(C11104R.styleable.f26416x5a3e453e, this.color);
            this.backgroundColor = obtainStyledAttributes.getInt(C11104R.styleable.f26413x55368ec5, this.backgroundColor);
            this.labelSize = obtainStyledAttributes.getDimension(C11104R.styleable.f26415xbc78c3fa, this.labelSize);
