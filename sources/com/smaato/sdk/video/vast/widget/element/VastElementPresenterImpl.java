...
public class VastElementPresenterImpl implements VastElementPresenter {
    ...
    public /* synthetic */ void lambda$onContentLoaded$1$VastElementPresenterImpl(VastElementView vastElementView) {
        VisibilityTrackerCreator visibilityTrackerCreator2 = this.visibilityTrackerCreator;
        $$Lambda$VastElementPresenterImpl$A3ZfgxzYbKciGIHAopc0Ieo87fg r1 = new VisibilityTrackerListener() {
        ...
        this.visibilityTracker = visibilityTrackerCreator2.createTracker(vastElementView, r1, impressionCountingType2);
    }
