...
public abstract class VideoPlayerView extends FrameLayout {
    ...
    protected VideoPlayerView(Context context) {
        super(context);
        FrameLayout.inflate(context, C11104R.layout.smaato_sdk_video_player_view, this);
    ...
    public /* synthetic */ void lambda$changeMuteIcon$1$VideoPlayerView(boolean z) {
        this.muteButton.setImageResource(z ? C11104R.C11105drawable.smaato_sdk_video_muted : C11104R.C11105drawable.smaato_sdk_video_unmuted);
    }
    ...
    private View initSurfaceHolderView(Context context) {
        ...
        view.setId(C11104R.C11106id.smaato_sdk_video_surface_holder_view_id);
        ...
        ((FrameLayout) findViewById(C11104R.C11106id.smaato_sdk_video_player_surface_layout)).addView(view, new ViewGroup.LayoutParams(-1, -1));
        return view;
    }
    ...
    private CircularProgressBar initProgressView() {
        return (CircularProgressBar) findViewById(C11104R.C11106id.smaato_sdk_video_video_progress);
    }

    private ImageButton initSkipButton() {
        ImageButton imageButton = (ImageButton) findViewById(C11104R.C11106id.smaato_sdk_video_skip_button);
    ...
    private ImageButton initMuteButton() {
        ImageButton imageButton = (ImageButton) findViewById(C11104R.C11106id.smaato_sdk_video_mute_button);
        imageButton.setOnClickListener(new View.OnClickListener() {
            public final void onClick(View view) {
