...
import com.smaato.sdk.video.p391ad.DiVideoAdLayer;
import com.smaato.sdk.video.p391ad.MediaFileResourceLoaderListenerCreator;
import com.smaato.sdk.video.p391ad.VastErrorTrackerCreator;
import com.smaato.sdk.video.p391ad.VideoAdLoaderPlugin;
import com.smaato.sdk.video.p391ad.VideoStateMachineFactory;
...
public class VideoModuleInterface implements AdPresenterModuleInterface {
    ...
    private static DiRegistry buildDefaultConfigs() {
        return DiRegistry.m30601of($$Lambda$VideoModuleInterface$mH2WFDgHk7VKY8A587xvJdaIzMU.INSTANCE);
    }
    ...
    private DiRegistry buildVisibilityConfigBuilderRegistry() {
        return DiRegistry.m30601of(new Consumer() {
            public final void accept(Object obj) {
                VideoModuleInterface.this.mo68273x381fb9ce((DiRegistry) obj);
            }
        });
    }

    /* renamed from: lambda$buildVisibilityConfigBuilderRegistry$9$VideoModuleInterface */
    public /* synthetic */ void mo68273x381fb9ce(DiRegistry diRegistry) {
        ...
        diRegistry.registerFactory(moduleDiName(), VisibilityTrackerCreator.class, new ClassFactory() {
            public final Object get(DiConstructor diConstructor) {
                return VideoModuleInterface.this.mo68272xb199ff2f(diConstructor);
            }
        });
    }

    /* renamed from: lambda$buildVisibilityConfigBuilderRegistry$8$VideoModuleInterface */
    public /* synthetic */ VisibilityTrackerCreator mo68272xb199ff2f(DiConstructor diConstructor) {
    ...
    private DiRegistry buildVastMediaFilesMapperRegistry() {
        return DiRegistry.m30601of($$Lambda$VideoModuleInterface$UKWM78qihKH2xjSwZe2yZdg_LmE.INSTANCE);
    }
    ...
    private DiRegistry buildVastScenarioPickerRegistry() {
        return DiRegistry.m30601of($$Lambda$VideoModuleInterface$mqjWHr3E6_wvYcF10FbnYWIStmQ.INSTANCE);
    }
    ...
    private DiRegistry buildVastTreeResultBuilderRegistry() {
        return DiRegistry.m30601of(new Consumer() {
            public final void accept(Object obj) {
                VideoModuleInterface.this.mo68270x4baaa8d2((DiRegistry) obj);
            }
        });
    }

    /* renamed from: lambda$buildVastTreeResultBuilderRegistry$33$VideoModuleInterface */
    public /* synthetic */ void mo68270x4baaa8d2(DiRegistry diRegistry) {
    ...
    private DiRegistry buildWrapperResolverRegistry() {
        return DiRegistry.m30601of($$Lambda$VideoModuleInterface$DOrEv7C8O7XvYcZRlC7ZljmCrEg.INSTANCE);
    }
    ...
    private DiRegistry buildResourceLoaderRegistry() {
        return DiRegistry.m30601of($$Lambda$VideoModuleInterface$czwWuxukWXculiLTVlX3AjeSU.INSTANCE);
    }
