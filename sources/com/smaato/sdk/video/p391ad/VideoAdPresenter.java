...
import com.smaato.sdk.video.p391ad.VideoAdPresenter;
...
abstract class VideoAdPresenter extends BaseAdPresenter {
    ...
    VideoAdPresenter(VastVideoPlayer vastVideoPlayer2, VideoAdInteractor videoAdInteractor2, OMVideoViewabilityTracker oMVideoViewabilityTracker, VideoTimings videoTimings2, Map<String, List<ViewabilityVerificationResource>> map) {
        ...
        C111181 r0 = new VastVideoPlayer.EventListener() {
            ...
            public void onClose() {
                VideoAdPresenter.this.videoAdInteractor.addStateListener(new StateMachine.Listener() {
                    public final void onStateChanged(Object obj, Object obj2, Metadata metadata) {
                        VideoAdPresenter.C111181.this.lambda$onClose$0$VideoAdPresenter$1((AdStateMachine.State) obj, (AdStateMachine.State) obj2, metadata);
                    }
                });
            ...
            public void onAdError() {
                VideoAdPresenter.this.videoAdInteractor.addStateListener(new StateMachine.Listener() {
                    public final void onStateChanged(Object obj, Object obj2, Metadata metadata) {
                        VideoAdPresenter.C111181.this.lambda$onAdError$1$VideoAdPresenter$1((AdStateMachine.State) obj, (AdStateMachine.State) obj2, metadata);
                    }
                });
    ...
    static /* synthetic */ class C111203 {
        ...
        static {
            ...
            L_0x0028:
                ...
                com.smaato.sdk.core.ad.AdStateMachine$State r1 = com.smaato.sdk.core.p380ad.AdStateMachine.State.TO_BE_DELETED     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x003e:
                ...
                com.smaato.sdk.core.ad.AdStateMachine$State r1 = com.smaato.sdk.core.p380ad.AdStateMachine.State.IMPRESSED     // Catch:{ NoSuchFieldError -> 0x0049 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0049 }
                r2 = 6
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0049 }
            L_0x0049:
                int[] r0 = $SwitchMap$com$smaato$sdk$core$ad$AdStateMachine$State     // Catch:{ NoSuchFieldError -> 0x0054 }
                com.smaato.sdk.core.ad.AdStateMachine$State r1 = com.smaato.sdk.core.p380ad.AdStateMachine.State.CLICKED     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.smaato.sdk.video.p391ad.VideoAdPresenter.C111203.<clinit>():void");
        }
    }

    private void stateChanged(AdStateMachine.State state) {
        switch (C111203.$SwitchMap$com$smaato$sdk$core$ad$AdStateMachine$State[state.ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
