...
final class C11767h implements Thread.UncaughtExceptionHandler {

    /* renamed from: a */
    private volatile Thread.UncaughtExceptionHandler f28459a;
    ...
    /* renamed from: a */
    public final synchronized boolean mo70562a() {
        boolean z;
        Thread.UncaughtExceptionHandler defaultUncaughtExceptionHandler = Thread.getDefaultUncaughtExceptionHandler();
        if (defaultUncaughtExceptionHandler == this) {
            z = false;
        } else {
            this.f28459a = defaultUncaughtExceptionHandler;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:6:?, code lost:
        r7.f28459a.uncaughtException(r8, r9);
     */
    ...
    public final synchronized void uncaughtException(java.lang.Thread r8, java.lang.Throwable r9) {
        /*
            ...
            java.lang.Thread$UncaughtExceptionHandler r1 = r7.f28459a     // Catch:{ all -> 0x00a1 }
            r1.uncaughtException(r8, r0)     // Catch:{ all -> 0x00a1 }
            monitor-exit(r7)
            return
        L_0x00a1:
            java.lang.Thread$UncaughtExceptionHandler r0 = r7.f28459a     // Catch:{ all -> 0x00a8 }
        ...
        L_0x00a8:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.unity3d.player.C11767h.uncaughtException(java.lang.Thread, java.lang.Throwable):void");
    }
}
