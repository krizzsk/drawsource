...
class C0846g1 {
    ...
    /* renamed from: a */
    private static int f502a;

    /* renamed from: b */
    private static int f503b;

    /* renamed from: c */
    private static int f504c;

    /* renamed from: d */
    private static int f505d;

    /* renamed from: com.adcolony.sdk.g1$a */
    private static class C0847a {
        /* renamed from: a */
        static int m625a(WindowManager windowManager) {
    ...
    private static class C0848b {
        /* renamed from: a */
        static int m626a(WindowManager windowManager) {
            Point point = new Point();
            windowManager.getDefaultDisplay().getSize(point);
            return point.x;
        }
    ...
    static float m616a(android.view.View r9, android.content.Context r10, boolean r11, boolean r12, boolean r13, boolean r14) {
        /*
            r0 = 0
        ...
        L_0x0007:
            ...
            float r1 = m622b((android.view.View) r9)
        ...
        L_0x002c:
            ...
            int r7 = r7 + r8
            r6[r2] = r7
            int r7 = m619a((android.content.Context) r10)
            int r10 = m623b((android.content.Context) r10)
            r8 = r6[r1]
        ...
        L_0x0091:
            ...
            float r9 = m617a(r9, r3, r10, r1)     // Catch:{ Exception -> 0x00b0 }
        ...
        L_0x00be:
            ...
            r8 = r3[r2]
            r4.<init>(r5, r6, r7, r8)
            int r5 = m619a((android.content.Context) r10)
            int r10 = m623b((android.content.Context) r10)
            r6 = r3[r1]
        ...
        L_0x0117:
            ...
            float r9 = m617a(r9, r4, r10, r2)     // Catch:{ Exception -> 0x0132 }
        ...
        L_0x0140:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.adcolony.sdk.C0846g1.m616a(android.view.View, android.content.Context, boolean, boolean, boolean, boolean):float");
    }

    /* renamed from: b */
    private static float m622b(View view) {
        if (view == null) {
            return 0.0f;
        }
        if (m618a() < 11) {
    ...
    /* renamed from: c */
    private static boolean m624c(View view) {
        if (view == null) {
            return false;
        }
        if (view.getBackground() == null || (m618a() > 18 && view.getBackground().getAlpha() == 0)) {
            return true;
        }
        return false;
    }
    ...
    /* renamed from: b */
    private static int m623b(Context context) {
        int i;
        int i2;
        int i3;
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static float m617a(android.view.View r11, android.graphics.Rect r12, float r13, boolean r14) {
        /*
        ...
        L_0x0035:
            ...
            float r8 = m622b((android.view.View) r5)
        ...
        L_0x00a9:
            ...
            boolean r10 = m624c(r9)
            if (r10 != 0) goto L_0x00cc
            int r10 = r9.getVisibility()
            if (r10 != 0) goto L_0x00a9
            float r10 = m622b((android.view.View) r9)
            int r10 = (r10 > r7 ? 1 : (r10 == r7 ? 0 : -1))
            if (r10 == 0) goto L_0x00a9
            r3.addFirst(r9)
            goto L_0x00a9
        L_0x00cc:
            java.util.ArrayList r9 = m621a((android.view.View) r9)
        ...
        L_0x0171:
            ...
            android.graphics.Rect r8 = m620a(r1, r12, r3)
            int r9 = r8.height()
        ...
        L_0x01b6:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.adcolony.sdk.C0846g1.m617a(android.view.View, android.graphics.Rect, float, boolean):float");
    }

    /* renamed from: a */
    private static Rect m620a(Rect rect, Rect rect2, int i) {
        Rect rect3 = new Rect();
        switch (i) {
            case 1:
    ...
    /* renamed from: a */
    private static ArrayList<View> m621a(View view) {
        if ((view instanceof ViewGroup) && view.getVisibility() == 0 && m622b(view) != 0.0f) {
            ...
            while (listIterator.hasNext()) {
                ...
                for (int i = 0; i < childCount; i++) {
                    ...
                    if (childAt.getVisibility() == 0 && m622b(childAt) != 0.0f) {
    ...
    /* renamed from: a */
    private static int m619a(Context context) {
        int i;
        int i2;
        int i3;
        int i4 = context != null ? context.getResources().getConfiguration().orientation : -1;
