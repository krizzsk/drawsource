...
public abstract class C5393g<T extends MarketplaceFullscreenDisplayEventsListener> extends C5379a implements MarketplaceFullscreenAd<T>, InneractiveFullscreenAdEventsListener {
    ...
    public C5393g(String str, JSONObject jSONObject, Map<String, String> map, boolean z, MarketplaceAdLoadListener<MarketplaceFullscreenAd<T>> marketplaceAdLoadListener, MarketplaceAuctionParameters marketplaceAuctionParameters) {
