...
public class C5387d extends C5379a implements MarketplaceBannerAd, InneractiveAdViewEventsListener {
    ...
    public static class C5388a extends FrameLayout {
    ...
    public C5387d(String str, JSONObject jSONObject, Map<String, String> map, boolean z, MarketplaceAdLoadListener<MarketplaceBannerAd> marketplaceAdLoadListener, MarketplaceAuctionParameters marketplaceAuctionParameters) {
    ...
    public void internalOnAdLoaded(C5379a aVar, C5389e eVar) {
    ...
    public void showInView(ViewGroup viewGroup, MarketplaceBannerDisplayEventsListener marketplaceBannerDisplayEventsListener) {
        if (this.mController == null || this.adSpot == null) {
            IAlog.m16447b("Banner is not ready to be shown", new Object[0]);
            return;
        }
        this.mContainer = new C5388a(viewGroup.getContext());
