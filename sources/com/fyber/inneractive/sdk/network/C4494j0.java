...
public class C4494j0 extends C4482e0<C4495a> {
    ...
    public static class C4495a {
        ...
        /* renamed from: a */
        public Bitmap f11048a = null;

        /* renamed from: b */
        public String f11049b = null;

        public C4495a(Bitmap bitmap, String str) {
        }
    }

    public C4494j0(C4521u<C4495a> uVar, String str) {
    ...
    public com.fyber.inneractive.sdk.network.C4472a0 mo24638a(java.io.InputStream r18, java.util.Map<java.lang.String, java.util.List<java.lang.String>> r19, int r20) throws java.lang.Exception {
        /*
            r17 = this;
            r0 = r18
            r1 = r19
        ...
        L_0x0029:
            ...
            int r1 = com.fyber.inneractive.sdk.util.C5312s.m16530a((java.lang.String) r1, (int) r7)     // Catch:{ Exception -> 0x0023, OutOfMemoryError -> 0x001e }
            goto L_0x0038
        L_0x0037:
            r1 = r7
        L_0x0038:
        ...
        L_0x0074:
            ...
            goto L_0x0087
        L_0x0077:
            r3.f11048a = r4     // Catch:{ Exception -> 0x0023, OutOfMemoryError -> 0x001e }
            ...
            r4 = r17
            java.lang.String r7 = r4.f11047g     // Catch:{ Exception -> 0x0097, OutOfMemoryError -> 0x0095 }
            r1[r6] = r7     // Catch:{ Exception -> 0x0097, OutOfMemoryError -> 0x0095 }
            com.fyber.inneractive.sdk.util.IAlog.m16446a(r0, r1)     // Catch:{ Exception -> 0x0097, OutOfMemoryError -> 0x0095 }
            goto L_0x00d1
        L_0x0087:
            r4 = r17
            ...
            r3.f11049b = r0     // Catch:{ Exception -> 0x0097, OutOfMemoryError -> 0x0095 }
            goto L_0x00d1
        L_0x0095:
            r0 = move-exception
            goto L_0x0099
        ...
        L_0x0099:
            ...
            com.fyber.inneractive.sdk.util.IAlog.m16448c(r5, r1)
            android.graphics.Bitmap r1 = r3.f11048a
        ...
        L_0x00d1:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fyber.inneractive.sdk.network.C4494j0.mo24638a(java.io.InputStream, java.util.Map, int):com.fyber.inneractive.sdk.network.a0");
    }
}
