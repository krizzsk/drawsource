...
public enum InneractiveErrorCode {
    ...
    /* renamed from: b */
    public final Metricable f10629b;

    /* renamed from: c */
    public final Metricable f10630c;
    ...
    InneractiveErrorCode(String str, Metricable metricable, Metricable metricable2) {
        this.f10628a = str;
        this.f10629b = metricable;
        this.f10630c = metricable2;
    }
    ...
    public boolean shouldSendTimeMetric() {
        return this.f10630c == Metricable.INCLUDED_IN_FAILED_METRICS;
    }
