...
public class C4328c extends C4375s<C4112a, InneractiveFullscreenAdEventsListener> implements C4397c {

    /* renamed from: w */
    public C4397c.C4399b f10596w;
    ...
    public void mo24339a(C4397c.C4398a aVar, Activity activity) throws InneractiveUnitController.AdDisplayError {
        ...
        IAlog.m16450e("%sYou must pass activity in order to show rewarded", IAlog.m16443a((Object) this));
    ...
    public void mo24355d() {
        ...
        mo24525a(C4192a.CLICK, C4193b.REWARDED_VIDEO);
        mo24534z();
    }

    /* renamed from: i */
    public void mo24356i() {
        EventsListener eventslistener;
        if (!this.f10597x && (eventslistener = this.f10721c) != null) {
            this.f10597x = true;
    ...
    public void onReward() {
        C4397c.C4399b bVar = this.f10596w;
        if (bVar != null) {
            ((InneractiveFullscreenUnitController.C4333a) bVar).mo24454a();
            mo24523D();
        }
        mo24525a(C4192a.COMPLETION, C4193b.REWARDED_VIDEO);
    }
    ...
    /* renamed from: v */
    public void mo24358v() {
        AdContent adcontent = this.f10720b;
        if (adcontent != null) {
            mo24529b((C5233e) (C4305f) ((C4112a) adcontent).f10713b);
        }
        mo24525a(C4192a.IMPRESSION, C4193b.REWARDED_VIDEO);
        mo24520A();
    }
