...
public class C5332z {
    ...
    /* renamed from: b */
    public Location f14071b = null;

    /* renamed from: c */
    public C5284i.C5285a f14072c;

    /* renamed from: d */
    public Runnable f14073d;

    /* renamed from: e */
    public LocationListener f14074e;

    /* renamed from: f */
    public LocationListener f14075f;
    ...
    public static class C5333a {
        ...
        /* renamed from: a */
        public static C5332z f14077a = new C5332z();
    }
    ...
    public android.location.Location mo26418a() {
        /*
            r19 = this;
            r0 = r19
            java.lang.String r1 = "network"
            android.content.Context r2 = r0.f14070a
            r3 = 0
        ...
        L_0x0017:
            ...
            boolean r7 = com.fyber.inneractive.sdk.util.C5292l.m16510b((java.lang.String) r2)
            java.lang.String r8 = "android.permission.ACCESS_COARSE_LOCATION"
            if (r7 == 0) goto L_0x002c
            java.lang.Object[] r7 = new java.lang.Object[r6]
            r7[r5] = r4
            java.lang.String r9 = "%sgetBestLastKnownLocation: Found fine location permission"
            com.fyber.inneractive.sdk.util.IAlog.m16446a(r9, r7)
            r7 = r6
            goto L_0x003c
        L_0x002c:
            boolean r7 = com.fyber.inneractive.sdk.util.C5292l.m16510b((java.lang.String) r8)
            ...
            r7 = r5
        L_0x003c:
            android.content.Context r9 = r0.f14070a
            ...
            com.fyber.inneractive.sdk.util.IAlog.m16446a(r14, r15)     // Catch:{ all -> 0x0085 }
            ...
            com.fyber.inneractive.sdk.util.IAlog.m16446a(r11, r14)     // Catch:{ all -> 0x0085 }
            goto L_0x0086
        L_0x007c:
            ...
            r14[r5] = r4     // Catch:{ all -> 0x0085 }
            com.fyber.inneractive.sdk.util.IAlog.m16446a(r7, r14)     // Catch:{ all -> 0x0085 }
        L_0x0085:
            r7 = r3
        L_0x0086:
            ...
            com.fyber.inneractive.sdk.util.IAlog.m16446a(r14, r15)     // Catch:{ all -> 0x00be }
            ...
            com.fyber.inneractive.sdk.util.IAlog.m16446a(r11, r14)     // Catch:{ all -> 0x00be }
            goto L_0x00bf
        L_0x00b5:
            ...
            com.fyber.inneractive.sdk.util.IAlog.m16446a(r9, r11)     // Catch:{ all -> 0x00be }
        L_0x00be:
            r9 = r3
        L_0x00bf:
            android.location.Location r7 = r0.mo26419a((android.location.Location) r7, (android.location.Location) r9)     // Catch:{ all -> 0x00d5 }
            android.location.Location r9 = r0.f14071b     // Catch:{ all -> 0x00d5 }
            android.location.Location r7 = r0.mo26419a((android.location.Location) r7, (android.location.Location) r9)     // Catch:{ all -> 0x00d5 }
            ...
            com.fyber.inneractive.sdk.util.IAlog.m16446a(r9, r11)     // Catch:{ all -> 0x00d5 }
            r3 = r7
        L_0x00d5:
            android.content.Context r7 = r0.f14070a
            if (r7 == 0) goto L_0x00e0
            com.fyber.inneractive.sdk.util.i$a r9 = r0.f14072c
            if (r9 == 0) goto L_0x00e0
            com.fyber.inneractive.sdk.util.C5284i.m16485a(r7, r9)
        L_0x00e0:
            if (r3 == 0) goto L_0x00e8
            boolean r7 = r0.mo26422a((android.location.Location) r3)
        ...
        L_0x00f7:
            ...
            android.location.LocationListener r9 = r0.f14074e
            if (r9 != 0) goto L_0x0128
            boolean r8 = com.fyber.inneractive.sdk.util.C5292l.m16510b((java.lang.String) r8)
            if (r8 != 0) goto L_0x010d
            boolean r8 = com.fyber.inneractive.sdk.util.C5292l.m16510b((java.lang.String) r2)
        ...
        L_0x010d:
            ...
            r8.<init>(r0)
            r0.f14074e = r8
            r0.mo26421a((java.lang.String) r1, (android.location.LocationListener) r8)
            r1 = r6
            goto L_0x0132
        L_0x0128:
            java.lang.Object[] r1 = new java.lang.Object[r6]
            ...
            com.fyber.inneractive.sdk.util.IAlog.m16446a(r8, r1)
        L_0x0131:
            r1 = r5
        L_0x0132:
            android.location.LocationListener r8 = r0.f14075f
            if (r8 != 0) goto L_0x0156
            boolean r2 = com.fyber.inneractive.sdk.util.C5292l.m16510b((java.lang.String) r2)
            ...
            r1.<init>(r0)
            r0.f14075f = r1
            r0.mo26421a((java.lang.String) r12, (android.location.LocationListener) r1)
            goto L_0x0160
        L_0x0156:
            java.lang.Object[] r2 = new java.lang.Object[r6]
            r2[r5] = r4
            java.lang.String r4 = "%sgps location listener already registered"
            com.fyber.inneractive.sdk.util.IAlog.m16446a(r4, r2)
        L_0x015f:
            r6 = r1
        L_0x0160:
            ...
            r0.f14076g = r1
            java.lang.Runnable r1 = r0.f14073d
        ...
        L_0x0173:
            ...
            com.fyber.inneractive.sdk.config.IAConfigManager r4 = com.fyber.inneractive.sdk.config.IAConfigManager.f10324J
            com.fyber.inneractive.sdk.config.q r4 = r4.f10343i
            int r4 = r4.f10488i
            int r4 = r4 * 1000
            long r4 = (long) r4
        ...
        L_0x0186:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fyber.inneractive.sdk.util.C5332z.mo26418a():android.location.Location");
    }

    /* renamed from: a */
    public final boolean mo26422a(Location location) {
        int i = IAConfigManager.f10324J.f10343i.f10487h;
        IAlog.m16446a("%sisLastKnownLocationGoodEnough: maxTimeAccInMin = %d", "Location Manager: ", Integer.valueOf(i));
        long j = (long) (i * 60 * 1000);
        IAlog.m16446a("%sisLastKnownLocationGoodEnough: max time accuracy in msec = %d", "Location Manager: ", Long.valueOf(j));
        long abs = Math.abs(System.currentTimeMillis() - location.getTime());
        IAlog.m16446a("%sisLastKnownLocationGoodEnough: location: = %s tss = %d tssM = %d", "Location Manager: ", location, Long.valueOf(abs), Long.valueOf(abs / 60000));
        boolean z = abs <= j;
        IAlog.m16446a("%sisLastKnownLocationGoodEnough: returns - %s", "Location Manager: ", Boolean.valueOf(z));
        return z;
    }

    /* renamed from: a */
    public final void mo26420a(LocationListener locationListener) {
        if (locationListener != null) {
            IAlog.m16446a("%sunregistering location listener: %s", "Location Manager: ", locationListener);
            Context context = this.f14070a;
            if (context == null) {
                IAlog.m16446a("%sunregisterFromLocationUpdates called, but context is null!", "Location Manager: ");
                return;
            }
            try {
                ((LocationManager) context.getSystemService(FirebaseAnalytics.Param.LOCATION)).removeUpdates(locationListener);
            } catch (Exception unused) {
                IAlog.m16446a("%sError retrieved when trying to stop location updates - updates were already paused.", "Location Manager: ");
            }
        }
    }

    /* renamed from: a */
    public final void mo26421a(String str, LocationListener locationListener) {
        Context context = this.f14070a;
        if (context == null) {
            IAlog.m16446a("%sregisterForASingleLocationUpdate called, but context is null!", "Location Manager: ");
            return;
        }
        try {
            ((LocationManager) context.getSystemService(FirebaseAnalytics.Param.LOCATION)).requestLocationUpdates(str, 0, 0.0f, locationListener, this.f14070a.getMainLooper());
            IAlog.m16446a("%sSuccessfully registered for %s location update", "Location Manager: ", str);
        } catch (SecurityException unused) {
            IAlog.m16446a("%sError retrieved when trying to get the network location - access appears to be disabled.", "Location Manager: ");
        } catch (IllegalArgumentException unused2) {
            IAlog.m16446a("%sError retrieved when trying to get the network location - device has no network provider.", "Location Manager: ");
        } catch (NullPointerException unused3) {
            IAlog.m16446a("%sError retrieved when trying to get the network location - NPE.", "Location Manager: ");
        }
    }

    /* renamed from: a */
    public final Location mo26419a(Location location, Location location2) {
