...
import com.fyber.inneractive.sdk.player.C4606d;

/* renamed from: com.fyber.inneractive.sdk.util.q */
public class C5307q extends AsyncTask<Void, Void, Bitmap> {

    /* renamed from: a */
    public Context f14032a;

    /* renamed from: b */
    public C5308a f14033b;

    /* renamed from: c */
    public String f14034c;

    /* renamed from: d */
    public String f14035d = null;

    /* renamed from: e */
    public int f14036e;

    /* renamed from: com.fyber.inneractive.sdk.util.q$a */
    public interface C5308a {
    }

    public C5307q(Context context, C5308a aVar, String str, String str2, int i) {
    ...
    public java.lang.Object doInBackground(java.lang.Object[] r12) {
        /*
            ...
            android.content.Context r5 = r11.f14032a     // Catch:{ all -> 0x00b5 }
            java.io.File r5 = r5.getFilesDir()     // Catch:{ all -> 0x00b5 }
            java.lang.String r6 = r11.f14035d     // Catch:{ all -> 0x00b5 }
        ...
        L_0x0035:
            ...
            java.lang.String r7 = r11.f14034c     // Catch:{ all -> 0x00af }
            ...
            r8 = r2
        L_0x004f:
            int r9 = r11.f14036e     // Catch:{ all -> 0x00aa }
            int r9 = r9 - r12
        ...
        L_0x0091:
            ...
            java.lang.String r12 = com.fyber.inneractive.sdk.util.C5312s.m16534a((java.lang.Throwable) r12)     // Catch:{ all -> 0x008f }
            r1[r2] = r12     // Catch:{ all -> 0x008f }
            com.fyber.inneractive.sdk.util.IAlog.m16446a(r0, r1)     // Catch:{ all -> 0x008f }
        L_0x009f:
        ...
        L_0x00ba:
            ...
            java.lang.String r12 = com.fyber.inneractive.sdk.util.C5312s.m16534a((java.lang.Throwable) r12)     // Catch:{ all -> 0x00e0 }
            r1[r2] = r12     // Catch:{ all -> 0x00e0 }
            com.fyber.inneractive.sdk.util.IAlog.m16446a(r0, r1)     // Catch:{ all -> 0x00e0 }
        ...
        L_0x00f4:
            throw r12
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fyber.inneractive.sdk.util.C5307q.doInBackground(java.lang.Object[]):java.lang.Object");
    }

    public void onPostExecute(Object obj) {
        Bitmap bitmap = (Bitmap) obj;
        C5308a aVar = this.f14033b;
        if (aVar != null) {
            if (bitmap != null) {
                C4606d dVar = (C4606d) aVar;
                C4533c cVar = dVar.f11440a;
                if (cVar.f11217n != null) {
                    cVar.mo24714a(bitmap);
                    C4533c cVar2 = dVar.f11440a;
                    cVar2.f11216m = null;
                    cVar2.f11217n = null;
                }
                IAlog.m16446a("MediaPlayerController: fetching video frame success!", new Object[0]);
            } else {
                C4606d dVar2 = (C4606d) aVar;
                C4533c cVar3 = dVar2.f11440a;
                if (cVar3.f11217n != null) {
                    cVar3.mo24714a((Bitmap) null);
                    C4533c cVar4 = dVar2.f11440a;
                    cVar4.f11216m = null;
                    cVar4.f11217n = null;
                }
                IAlog.m16446a("MediaPlayerController: fetching video frame failed!", new Object[0]);
            }
            this.f14033b = null;
        }
    }
