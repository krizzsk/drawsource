...
import com.fyber.inneractive.sdk.util.C5282h0;
...
public class C5277g0 {
    ...
    static {
        ...
        f13987d = strArr3;
        C5277g0 g0Var = new C5277g0();
        f13989f = g0Var;
        g0Var.mo26377a(strArr);
        g0Var.mo26377a(strArr2);
        C5277g0 g0Var2 = new C5277g0();
        g0Var2.mo26377a(strArr);
        g0Var2.mo26377a(strArr3);
        C5277g0 g0Var3 = new C5277g0();
        f13990g = g0Var3;
        m16481a(g0Var3);
    }

    /* renamed from: a */
    public static void m16481a(C5277g0 g0Var) {
        g0Var.mo26377a(f13985b);
        g0Var.mo26377a(f13987d);
        g0Var.mo26377a(f13988e);
        g0Var.mo26377a(f13986c);
    }

    /* renamed from: a */
    public void mo26377a(String[][] strArr) {
        ...
        while (i < strArr2.length) {
            ...
            C5280c cVar = (C5280c) this.f13991a;
            cVar.f13992a.put(str, Integer.valueOf(parseInt));
            C5282h0 h0Var = cVar.f13993b;
            C5282h0.C5283a[] aVarArr = h0Var.f13995a;
            int i2 = Integer.MAX_VALUE;
            int i3 = parseInt & Integer.MAX_VALUE;
            int length = i3 % aVarArr.length;
            C5282h0.C5283a aVar = aVarArr[length];
            while (true) {
                if (aVar == null) {
                    if (h0Var.f13996b >= h0Var.f13997c) {
                        C5282h0.C5283a[] aVarArr2 = h0Var.f13995a;
                        int length2 = aVarArr2.length;
                        int i4 = (length2 * 2) + 1;
                        C5282h0.C5283a[] aVarArr3 = new C5282h0.C5283a[i4];
                        h0Var.f13997c = (int) (((float) i4) * 0.75f);
                        h0Var.f13995a = aVarArr3;
                        while (true) {
                            int i5 = length2 - 1;
                            if (length2 <= 0) {
                                break;
                            }
                            C5282h0.C5283a aVar2 = aVarArr2[i5];
                            while (aVar2 != null) {
                                C5282h0.C5283a aVar3 = aVar2.f14000c;
                                int i6 = (aVar2.f13998a & i2) % i4;
                                aVar2.f14000c = aVarArr3[i6];
                                aVarArr3[i6] = aVar2;
                                aVar2 = aVar3;
                        ...
                        aVarArr = h0Var.f13995a;
                        length = i3 % aVarArr.length;
                    }
                    aVarArr[length] = new C5282h0.C5283a(parseInt, parseInt, str, aVarArr[length]);
                    h0Var.f13996b++;
                } else if (aVar.f13998a == parseInt) {
                    aVar.f13999b = str;
                    break;
                } else {
                    aVar = aVar.f14000c;
    ...
    /* renamed from: a */
    public String mo26375a(String str) {
        ...
        try {
            mo26376a(stringWriter, str, indexOf);
    ...
    public final void mo26376a(java.io.Writer r11, java.lang.String r12, int r13) throws java.io.IOException {
        /*
            r10 = this;
            r0 = 0
        ...
        L_0x0066:
            ...
            goto L_0x0078
        L_0x006c:
            com.fyber.inneractive.sdk.util.g0$a r2 = r10.f13991a
            com.fyber.inneractive.sdk.util.g0$c r2 = (com.fyber.inneractive.sdk.util.C5277g0.C5280c) r2
            java.util.Map r2 = r2.f13992a
        ...
        L_0x0098:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fyber.inneractive.sdk.util.C5277g0.mo26376a(java.io.Writer, java.lang.String, int):void");
    }
}
