...
public class C4452h extends C4445b {
    public C4452h(Map<String, String> map, C5349d dVar, C5306p0 p0Var) {
        super(map, dVar, p0Var);
    }

    /* renamed from: a */
    public void mo24635a() {
        this.f10963c.mo26470a(C4450f.GET_DEFAULT_POSITION, "Unsupported action getDefaultPosition");
    }
