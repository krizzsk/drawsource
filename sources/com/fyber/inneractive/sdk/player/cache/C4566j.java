...
public final class C4566j extends C4539b {

    /* renamed from: b */
    public final boolean f11325b;

    public C4566j(boolean z) {
        this.f11325b = z;
    }
    ...
    public com.fyber.inneractive.sdk.player.cache.C4539b.C4540a mo24729a(com.fyber.inneractive.sdk.player.cache.C4538a r9, java.lang.String r10) {
        /*
            r8 = this;
            com.fyber.inneractive.sdk.player.cache.b$a r10 = com.fyber.inneractive.sdk.player.cache.C4539b.C4540a.INVALID
            android.media.MediaPlayer r0 = new android.media.MediaPlayer
            r0.<init>()
            java.io.File r1 = r9.f11229a
            r2 = 1
            r3 = 0
        ...
        L_0x0016:
            ...
            java.io.File r5 = r9.mo24728a()     // Catch:{ all -> 0x0074 }
            r4.<init>(r5)     // Catch:{ all -> 0x0074 }
            java.io.File r1 = r9.mo24728a()     // Catch:{ all -> 0x0072 }
            ...
            com.fyber.inneractive.sdk.player.cache.b$a r10 = com.fyber.inneractive.sdk.player.cache.C4539b.C4540a.OK     // Catch:{ all -> 0x0072 }
            ...
            java.util.Map<java.lang.String, java.lang.String> r6 = r8.f11235a     // Catch:{ all -> 0x0072 }
        ...
        L_0x0078:
            ...
            com.fyber.inneractive.sdk.util.IAlog.m16445a(r5, r1, r6)     // Catch:{ all -> 0x0089 }
            boolean r1 = r9.f11231c     // Catch:{ all -> 0x0089 }
            if (r1 == 0) goto L_0x0085
            com.fyber.inneractive.sdk.player.cache.b$a r10 = com.fyber.inneractive.sdk.player.cache.C4539b.C4540a.PARTIAL_CANNOT_VALIDATE     // Catch:{ all -> 0x0089 }
        L_0x0085:
            com.fyber.inneractive.sdk.player.cache.C4570m.m13882a((java.io.Closeable) r4)
            goto L_0x008e
        L_0x0089:
            r9 = move-exception
            com.fyber.inneractive.sdk.player.cache.C4570m.m13882a((java.io.Closeable) r4)
        ...
        L_0x009f:
            ...
            com.fyber.inneractive.sdk.player.cache.b$a r1 = com.fyber.inneractive.sdk.player.cache.C4539b.C4540a.OK
            if (r10 != r1) goto L_0x00d8
            android.media.MediaExtractor r1 = new android.media.MediaExtractor
            r1.<init>()
            java.io.File r4 = r9.mo24728a()     // Catch:{ all -> 0x00d3 }
        ...
        L_0x00d8:
            ...
            boolean r9 = r9.f11231c
            if (r9 == 0) goto L_0x00e5
            com.fyber.inneractive.sdk.player.cache.b$a r10 = com.fyber.inneractive.sdk.player.cache.C4539b.C4540a.PARTIAL_CANNOT_VALIDATE
            goto L_0x00e7
        L_0x00e5:
            com.fyber.inneractive.sdk.player.cache.b$a r10 = com.fyber.inneractive.sdk.player.cache.C4539b.C4540a.INVALID
        L_0x00e7:
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fyber.inneractive.sdk.player.cache.C4566j.mo24729a(com.fyber.inneractive.sdk.player.cache.a, java.lang.String):com.fyber.inneractive.sdk.player.cache.b$a");
    }
}
