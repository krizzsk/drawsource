...
public final class C4696d implements C4962y.C4963a<C4695c> {

    /* renamed from: a */
    public static final Pattern f11876a = Pattern.compile("AVERAGE-BANDWIDTH=(\\d+)\\b");

    /* renamed from: b */
    public static final Pattern f11877b = Pattern.compile("[^-]BANDWIDTH=(\\d+)\\b");

    /* renamed from: c */
    public static final Pattern f11878c = Pattern.compile("CODECS=\"(.+?)\"");

    /* renamed from: d */
    public static final Pattern f11879d = Pattern.compile("RESOLUTION=(\\d+x\\d+)");

    /* renamed from: e */
    public static final Pattern f11880e = Pattern.compile("#EXT-X-TARGETDURATION:(\\d+)\\b");

    /* renamed from: f */
    public static final Pattern f11881f = Pattern.compile("#EXT-X-VERSION:(\\d+)\\b");

    /* renamed from: g */
    public static final Pattern f11882g = Pattern.compile("#EXT-X-PLAYLIST-TYPE:(.+)\\b");

    /* renamed from: h */
    public static final Pattern f11883h = Pattern.compile("#EXT-X-MEDIA-SEQUENCE:(\\d+)\\b");

    /* renamed from: i */
    public static final Pattern f11884i = Pattern.compile("#EXTINF:([\\d\\.]+)\\b");

    /* renamed from: j */
    public static final Pattern f11885j = Pattern.compile("TIME-OFFSET=(-?[\\d\\.]+)\\b");

    /* renamed from: k */
    public static final Pattern f11886k = Pattern.compile("#EXT-X-BYTERANGE:(\\d+(?:@\\d+)?)\\b");

    /* renamed from: l */
    public static final Pattern f11887l = Pattern.compile("BYTERANGE=\"(\\d+(?:@\\d+)?)\\b\"");

    /* renamed from: m */
    public static final Pattern f11888m = Pattern.compile("METHOD=(NONE|AES-128)");

    /* renamed from: n */
    public static final Pattern f11889n = Pattern.compile("URI=\"(.+?)\"");

    /* renamed from: o */
    public static final Pattern f11890o = Pattern.compile("IV=([^,.*]+)");

    /* renamed from: p */
    public static final Pattern f11891p = Pattern.compile("TYPE=(AUDIO|VIDEO|SUBTITLES|CLOSED-CAPTIONS)");

    /* renamed from: q */
    public static final Pattern f11892q = Pattern.compile("LANGUAGE=\"(.+?)\"");

    /* renamed from: r */
    public static final Pattern f11893r = Pattern.compile("NAME=\"(.+?)\"");

    /* renamed from: s */
    public static final Pattern f11894s = Pattern.compile("INSTREAM-ID=\"((?:CC|SERVICE)\\d+)\"");

    /* renamed from: t */
    public static final Pattern f11895t = m14361a("AUTOSELECT");

    /* renamed from: u */
    public static final Pattern f11896u = m14361a("DEFAULT");

    /* renamed from: v */
    public static final Pattern f11897v = m14361a("FORCED");

    /* renamed from: com.fyber.inneractive.sdk.player.exoplayer2.extractor.hls.playlist.d$a */
    public static class C4697a {

        /* renamed from: a */
        public final BufferedReader f11898a;

        /* renamed from: b */
        public final Queue<String> f11899b;

        /* renamed from: c */
        public String f11900c;

        public C4697a(Queue<String> queue, BufferedReader bufferedReader) {
            this.f11899b = queue;
            this.f11898a = bufferedReader;
        }

        /* renamed from: a */
        public boolean mo25153a() throws IOException {
            String trim;
            if (this.f11900c != null) {
                return true;
            }
            if (!this.f11899b.isEmpty()) {
                this.f11900c = this.f11899b.poll();
                return true;
            }
            do {
                String readLine = this.f11898a.readLine();
                this.f11900c = readLine;
                if (readLine == null) {
                    return false;
                }
                trim = readLine.trim();
        ...
        /* renamed from: b */
        public String mo25154b() throws IOException {
            if (!mo25153a()) {
                return null;
            }
    ...
    public static com.fyber.inneractive.sdk.player.exoplayer2.extractor.hls.playlist.C4693b m14363b(com.fyber.inneractive.sdk.player.exoplayer2.extractor.hls.playlist.C4696d.C4697a r63, java.lang.String r64) throws java.io.IOException {
        /*
        ...
        L_0x0032:
            ...
            r46 = 0
        L_0x0036:
            boolean r27 = r63.mo25153a()
            if (r27 == 0) goto L_0x0309
            java.lang.String r5 = r63.mo25154b()
            java.lang.String r3 = "#EXT-X-PLAYLIST-TYPE"
            boolean r3 = r5.startsWith(r3)
            if (r3 == 0) goto L_0x0066
            java.util.regex.Pattern r3 = f11882g
            java.lang.String r3 = m14364b((java.lang.String) r5, (java.util.regex.Pattern) r3)
        ...
        L_0x0066:
            ...
            java.util.regex.Pattern r3 = f11885j
            java.lang.String r3 = m14364b((java.lang.String) r5, (java.util.regex.Pattern) r3)
        ...
        L_0x0081:
            ...
            java.util.regex.Pattern r3 = f11889n
            java.lang.String r50 = m14364b((java.lang.String) r5, (java.util.regex.Pattern) r3)
            java.util.regex.Pattern r3 = f11887l
            java.lang.String r3 = m14360a((java.lang.String) r5, (java.util.regex.Pattern) r3)
        ...
        L_0x00cc:
            ...
            java.util.regex.Pattern r3 = f11880e
            java.lang.String r3 = m14364b((java.lang.String) r5, (java.util.regex.Pattern) r3)
        ...
        L_0x00e6:
            ...
            java.util.regex.Pattern r3 = f11883h
            java.lang.String r3 = m14364b((java.lang.String) r5, (java.util.regex.Pattern) r3)
        ...
        L_0x00fc:
            ...
            java.util.regex.Pattern r3 = f11881f
            java.lang.String r3 = m14364b((java.lang.String) r5, (java.util.regex.Pattern) r3)
        ...
        L_0x0110:
            ...
            java.util.regex.Pattern r3 = f11884i
            java.lang.String r3 = m14364b((java.lang.String) r5, (java.util.regex.Pattern) r3)
            double r3 = java.lang.Double.parseDouble(r3)
            double r3 = r3 * r27
            long r3 = (long) r3
        ...
        L_0x0129:
            ...
            java.util.regex.Pattern r3 = f11888m
            java.lang.String r3 = m14364b((java.lang.String) r5, (java.util.regex.Pattern) r3)
            java.lang.String r4 = "AES-128"
            boolean r42 = r4.equals(r3)
            if (r42 == 0) goto L_0x0032
            java.util.regex.Pattern r3 = f11889n
            java.lang.String r46 = m14364b((java.lang.String) r5, (java.util.regex.Pattern) r3)
            java.util.regex.Pattern r3 = f11890o
            java.lang.String r43 = m14360a((java.lang.String) r5, (java.util.regex.Pattern) r3)
            goto L_0x0036
        L_0x014d:
            java.lang.String r3 = "#EXT-X-BYTERANGE"
            boolean r3 = r5.startsWith(r3)
            if (r3 == 0) goto L_0x0170
            java.util.regex.Pattern r3 = f11886k
            java.lang.String r3 = m14364b((java.lang.String) r5, (java.util.regex.Pattern) r3)
            java.lang.String[] r3 = r3.split(r4)
            r4 = r3[r8]
            long r40 = java.lang.Long.parseLong(r4)
        ...
        L_0x0197:
            ...
            int r3 = r3 + r9
            java.lang.String r3 = r5.substring(r3)
            java.util.regex.Pattern r4 = com.fyber.inneractive.sdk.player.exoplayer2.util.C4991u.f13275f
        ...
        L_0x0272:
            ...
            long r4 = r4 - r8
        L_0x027e:
            long r3 = com.fyber.inneractive.sdk.player.exoplayer2.C4637b.m14201a(r4)
            long r12 = r3 - r44
            goto L_0x0304
        L_0x0286:
        ...
        L_0x0314:
            ...
            return r24
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fyber.inneractive.sdk.player.exoplayer2.extractor.hls.playlist.C4696d.m14363b(com.fyber.inneractive.sdk.player.exoplayer2.extractor.hls.playlist.d$a, java.lang.String):com.fyber.inneractive.sdk.player.exoplayer2.extractor.hls.playlist.b");
    }

    /* JADX WARNING: Code restructure failed: missing block: B:55:0x00d7, code lost:
        r9.add(r1);
        r8 = m14363b(new com.fyber.inneractive.sdk.player.exoplayer2.extractor.hls.playlist.C4696d.C4697a(r9, r0), r8.toString());
     */
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public java.lang.Object mo25152a(android.net.Uri r8, java.io.InputStream r9) throws java.io.IOException {
        /*
            r7 = this;
        ...
        L_0x004f:
            ...
            if (r3 == 0) goto L_0x0062
            boolean r3 = com.fyber.inneractive.sdk.player.exoplayer2.util.C4991u.m15144b((int) r1)     // Catch:{ all -> 0x00fe }
            if (r3 != 0) goto L_0x0062
            int r1 = r0.read()     // Catch:{ all -> 0x00fe }
            goto L_0x004f
        L_0x0062:
        ...
        L_0x0079:
            ...
            com.fyber.inneractive.sdk.player.exoplayer2.extractor.hls.playlist.a r8 = m14359a((com.fyber.inneractive.sdk.player.exoplayer2.extractor.hls.playlist.C4696d.C4697a) r1, (java.lang.String) r8)     // Catch:{ all -> 0x00fe }
            goto L_0x00e7
        L_0x0092:
        ...
        L_0x00d7:
            ...
            r1.<init>(r9, r0)     // Catch:{ all -> 0x00fe }
            java.lang.String r8 = r8.toString()     // Catch:{ all -> 0x00fe }
            com.fyber.inneractive.sdk.player.exoplayer2.extractor.hls.playlist.b r8 = m14363b((com.fyber.inneractive.sdk.player.exoplayer2.extractor.hls.playlist.C4696d.C4697a) r1, (java.lang.String) r8)     // Catch:{ all -> 0x00fe }
        L_0x00e7:
            com.fyber.inneractive.sdk.player.exoplayer2.util.C4991u.m15138a((java.io.Closeable) r0)
            return r8
        L_0x00eb:
            com.fyber.inneractive.sdk.player.exoplayer2.util.C4991u.m15138a((java.io.Closeable) r0)
        ...
        L_0x00fe:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fyber.inneractive.sdk.player.exoplayer2.extractor.hls.playlist.C4696d.mo25152a(android.net.Uri, java.io.InputStream):java.lang.Object");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static com.fyber.inneractive.sdk.player.exoplayer2.extractor.hls.playlist.C4691a m14359a(com.fyber.inneractive.sdk.player.exoplayer2.extractor.hls.playlist.C4696d.C4697a r70, java.lang.String r71) throws java.io.IOException {
        /*
            ...
            r7 = r2
        L_0x0018:
            boolean r8 = r70.mo25153a()
            if (r8 == 0) goto L_0x01f5
            java.lang.String r8 = r70.mo25154b()
            java.lang.String r9 = "#EXT-X-MEDIA"
            boolean r9 = r8.startsWith(r9)
            r10 = 1
            if (r9 == 0) goto L_0x014b
            java.util.regex.Pattern r9 = f11896u
            boolean r9 = m14362a(r8, r9, r2)
            java.util.regex.Pattern r12 = f11897v
            boolean r12 = m14362a(r8, r12, r2)
            r13 = 2
        ...
        L_0x003d:
            r9 = r9 | r12
            java.util.regex.Pattern r12 = f11895t
            boolean r12 = m14362a(r8, r12, r2)
        ...
        L_0x0049:
            r9 = r9 | r12
            java.util.regex.Pattern r12 = f11889n
            java.lang.String r12 = m14360a((java.lang.String) r8, (java.util.regex.Pattern) r12)
            java.util.regex.Pattern r14 = f11893r
            java.lang.String r15 = m14364b((java.lang.String) r8, (java.util.regex.Pattern) r14)
            java.util.regex.Pattern r14 = f11892q
            java.lang.String r35 = m14360a((java.lang.String) r8, (java.util.regex.Pattern) r14)
            java.util.regex.Pattern r14 = f11891p
            java.lang.String r14 = m14364b((java.lang.String) r8, (java.util.regex.Pattern) r14)
            r14.getClass()
        ...
        L_0x00e1:
            ...
            goto L_0x01f1
        L_0x00eb:
            java.util.regex.Pattern r2 = f11894s
            java.lang.String r2 = m14364b((java.lang.String) r8, (java.util.regex.Pattern) r2)
        ...
        L_0x011a:
            ...
            r19 = r9
            r20 = r35
            com.fyber.inneractive.sdk.player.exoplayer2.i r2 = com.fyber.inneractive.sdk.player.exoplayer2.C4811i.m14727a(r14, r15, r16, r17, r18, r19, r20, r21)
            r1.add(r2)
            goto L_0x00de
        L_0x012d:
            r17 = 0
        ...
        L_0x014b:
            ...
            java.util.regex.Pattern r2 = f11877b
            java.lang.String r2 = m14364b((java.lang.String) r8, (java.util.regex.Pattern) r2)
            int r2 = java.lang.Integer.parseInt(r2)
            java.util.regex.Pattern r9 = f11876a
            java.lang.String r9 = m14360a((java.lang.String) r8, (java.util.regex.Pattern) r9)
            if (r9 == 0) goto L_0x0169
            int r2 = java.lang.Integer.parseInt(r9)
        L_0x0169:
            r47 = r2
            java.util.regex.Pattern r2 = f11878c
            java.lang.String r46 = m14360a((java.lang.String) r8, (java.util.regex.Pattern) r2)
            java.util.regex.Pattern r2 = f11879d
            java.lang.String r2 = m14360a((java.lang.String) r8, (java.util.regex.Pattern) r2)
        ...
        L_0x019e:
            ...
            r50 = -1
        L_0x01a2:
            java.lang.String r2 = r70.mo25154b()
        ...
        L_0x01fe:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fyber.inneractive.sdk.player.exoplayer2.extractor.hls.playlist.C4696d.m14359a(com.fyber.inneractive.sdk.player.exoplayer2.extractor.hls.playlist.d$a, java.lang.String):com.fyber.inneractive.sdk.player.exoplayer2.extractor.hls.playlist.a");
    }

    /* renamed from: b */
    public static String m14364b(String str, Pattern pattern) throws C4815l {
        Matcher matcher = pattern.matcher(str);
        if (matcher.find() && matcher.groupCount() == 1) {
            return matcher.group(1);
        }
        throw new C4815l("Couldn't match " + pattern.pattern() + " in " + str);
    }

    /* renamed from: a */
    public static String m14360a(String str, Pattern pattern) {
        Matcher matcher = pattern.matcher(str);
        if (matcher.find()) {
            return matcher.group(1);
        }
    ...
    /* renamed from: a */
    public static boolean m14362a(String str, Pattern pattern, boolean z) {
        Matcher matcher = pattern.matcher(str);
        return matcher.find() ? matcher.group(1).equals("YES") : z;
    }

    /* renamed from: a */
    public static Pattern m14361a(String str) {
