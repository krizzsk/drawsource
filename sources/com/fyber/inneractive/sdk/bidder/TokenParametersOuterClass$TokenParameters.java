...
import com.fyber.inneractive.sdk.protobuf.C5067c;
...
import com.fyber.inneractive.sdk.protobuf.C5192y;
...
public final class TokenParametersOuterClass$TokenParameters extends GeneratedMessageLite<TokenParametersOuterClass$TokenParameters, C4138b> implements C5153r0 {
    ...
    private static volatile C5193y0<TokenParametersOuterClass$TokenParameters> PARSER = null;
    ...
    private static final C5194z.C5202h.C5203a<Integer, C4147k> priorClicks_converter_ = new C4137a();
    ...
    private C5194z.C5205j<LastAdomain> lastAdomains_ = GeneratedMessageLite.emptyProtobufList();
    private C5194z.C5205j<LastAdvertisedBundle> lastAdvertisedBundles_ = GeneratedMessageLite.emptyProtobufList();
    ...
    private C5194z.C5205j<PriorVideoClickType> priorClickTypes_ = GeneratedMessageLite.emptyProtobufList();
    private int priorClicksMemoizedSerializedSize;
    private C5194z.C5201g priorClicks_ = GeneratedMessageLite.emptyIntList();
    ...
    private C5194z.C5205j<UserSession> userSessions_ = GeneratedMessageLite.emptyProtobufList();
    private NullableFloat verAccuracy_;
    private NullableString version_;
    private NullableString zipCode_;

    public static final class Experiment extends GeneratedMessageLite<Experiment, C4126a> implements C4139c {
        /* access modifiers changed from: private */
        ...
        public static final class C4126a extends GeneratedMessageLite.C5050a<Experiment, C4126a> implements C4139c {
            public C4126a() {
        ...
        public static C4126a newBuilder() {
            return (C4126a) DEFAULT_INSTANCE.createBuilder();
        }
        ...
        public static C4126a newBuilder(Experiment experiment) {
            return (C4126a) DEFAULT_INSTANCE.createBuilder(experiment);
        }
    ...
    public static final class LastAdomain extends GeneratedMessageLite<LastAdomain, C4127a> implements C4141e {
        public static final int ADOMAIN_FIELD_NUMBER = 2;
        /* access modifiers changed from: private */
        public static final LastAdomain DEFAULT_INSTANCE;
        private static volatile C5193y0<LastAdomain> PARSER = null;
        ...
        public static final class C4127a extends GeneratedMessageLite.C5050a<LastAdomain, C4127a> implements C4141e {
            public C4127a() {
        ...
        public static C4127a newBuilder() {
            return (C4127a) DEFAULT_INSTANCE.createBuilder();
        }
        ...
        public static LastAdomain parseFrom(ByteBuffer byteBuffer) throws C5061a0 {
            return (LastAdomain) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer);
        }

        public static C5193y0<LastAdomain> parser() {
            return DEFAULT_INSTANCE.getParserForType();
        }
        ...
        /* access modifiers changed from: private */
        public void setAdomainBytes(C5093i iVar) {
            C5058a.checkByteStringIsUtf8(iVar);
            this.adomain_ = iVar.mo25918i();
            this.bitField0_ |= 2;
        }

        /* access modifiers changed from: private */
        public void setType(C4147k kVar) {
            this.type_ = kVar.mo24014a();
            this.bitField0_ |= 1;
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.C5054e eVar, Object obj, Object obj2) {
            switch (eVar.ordinal()) {
                ...
                case 5:
                    return DEFAULT_INSTANCE;
                case 6:
                    C5193y0<LastAdomain> y0Var = PARSER;
                    if (y0Var == null) {
        ...
        public C5093i getAdomainBytes() {
            return C5093i.m15514a(this.adomain_);
        }

        public C4147k getType() {
            C4147k a = C4147k.m13111a(this.type_);
            return a == null ? C4147k.UNRECOGNIZED : a;
        }
        ...
        public static C4127a newBuilder(LastAdomain lastAdomain) {
            return (C4127a) DEFAULT_INSTANCE.createBuilder(lastAdomain);
        }

        public static LastAdomain parseDelimitedFrom(InputStream inputStream, C5147q qVar) throws IOException {
            return (LastAdomain) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, qVar);
        }

        public static LastAdomain parseFrom(ByteBuffer byteBuffer, C5147q qVar) throws C5061a0 {
            return (LastAdomain) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, qVar);
        }

        public static LastAdomain parseFrom(C5093i iVar) throws C5061a0 {
            return (LastAdomain) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, iVar);
        }

        public static LastAdomain parseFrom(C5093i iVar, C5147q qVar) throws C5061a0 {
            return (LastAdomain) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, iVar, qVar);
        }

        public static LastAdomain parseFrom(byte[] bArr) throws C5061a0 {
            return (LastAdomain) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr);
        }

        public static LastAdomain parseFrom(byte[] bArr, C5147q qVar) throws C5061a0 {
        ...
        public static LastAdomain parseFrom(InputStream inputStream, C5147q qVar) throws IOException {
            return (LastAdomain) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, qVar);
        }

        public static LastAdomain parseFrom(C5114j jVar) throws IOException {
            return (LastAdomain) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, jVar);
        }

        public static LastAdomain parseFrom(C5114j jVar, C5147q qVar) throws IOException {
            return (LastAdomain) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, jVar, qVar);
        }
    }

    public static final class LastAdvertisedBundle extends GeneratedMessageLite<LastAdvertisedBundle, C4128a> implements C4142f {
        /* access modifiers changed from: private */
        public static final LastAdvertisedBundle DEFAULT_INSTANCE;
        public static final int LASTBUNDLE_FIELD_NUMBER = 2;
        private static volatile C5193y0<LastAdvertisedBundle> PARSER = null;
        public static final int TYPE_FIELD_NUMBER = 1;
        private int bitField0_;
        ...
        public static final class C4128a extends GeneratedMessageLite.C5050a<LastAdvertisedBundle, C4128a> implements C4142f {
            public C4128a() {
        ...
        public static C4128a newBuilder() {
            return (C4128a) DEFAULT_INSTANCE.createBuilder();
        }
        ...
        public static LastAdvertisedBundle parseFrom(ByteBuffer byteBuffer) throws C5061a0 {
            return (LastAdvertisedBundle) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer);
        }

        public static C5193y0<LastAdvertisedBundle> parser() {
            return DEFAULT_INSTANCE.getParserForType();
        }
        ...
        /* access modifiers changed from: private */
        public void setLastBundleBytes(C5093i iVar) {
            C5058a.checkByteStringIsUtf8(iVar);
            this.lastBundle_ = iVar.mo25918i();
            this.bitField0_ |= 2;
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.C5054e eVar, Object obj, Object obj2) {
            switch (eVar.ordinal()) {
                ...
                case 5:
                    return DEFAULT_INSTANCE;
                case 6:
                    C5193y0<LastAdvertisedBundle> y0Var = PARSER;
                    if (y0Var == null) {
        ...
        public C5093i getLastBundleBytes() {
            return C5093i.m15514a(this.lastBundle_);
        }
        ...
        public static C4128a newBuilder(LastAdvertisedBundle lastAdvertisedBundle) {
            return (C4128a) DEFAULT_INSTANCE.createBuilder(lastAdvertisedBundle);
        }

        public static LastAdvertisedBundle parseDelimitedFrom(InputStream inputStream, C5147q qVar) throws IOException {
            return (LastAdvertisedBundle) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, qVar);
        }

        public static LastAdvertisedBundle parseFrom(ByteBuffer byteBuffer, C5147q qVar) throws C5061a0 {
            return (LastAdvertisedBundle) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, qVar);
        }

        public static LastAdvertisedBundle parseFrom(C5093i iVar) throws C5061a0 {
            return (LastAdvertisedBundle) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, iVar);
        }

        public static LastAdvertisedBundle parseFrom(C5093i iVar, C5147q qVar) throws C5061a0 {
            return (LastAdvertisedBundle) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, iVar, qVar);
        }

        public static LastAdvertisedBundle parseFrom(byte[] bArr) throws C5061a0 {
            return (LastAdvertisedBundle) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr);
        }

        public static LastAdvertisedBundle parseFrom(byte[] bArr, C5147q qVar) throws C5061a0 {
        ...
        public static LastAdvertisedBundle parseFrom(InputStream inputStream, C5147q qVar) throws IOException {
            return (LastAdvertisedBundle) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, qVar);
        }

        public static LastAdvertisedBundle parseFrom(C5114j jVar) throws IOException {
            return (LastAdvertisedBundle) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, jVar);
        }

        public static LastAdvertisedBundle parseFrom(C5114j jVar, C5147q qVar) throws IOException {
            return (LastAdvertisedBundle) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, jVar, qVar);
        }
    }

    public static final class NullableBool extends GeneratedMessageLite<NullableBool, C4129a> implements C5153r0 {
        public static final int DATA_FIELD_NUMBER = 1;
        /* access modifiers changed from: private */
        public static final NullableBool DEFAULT_INSTANCE;
        private static volatile C5193y0<NullableBool> PARSER;
        private int bitField0_;
        ...
        public static final class C4129a extends GeneratedMessageLite.C5050a<NullableBool, C4129a> implements C5153r0 {
            public C4129a() {
        ...
        public static C4129a newBuilder() {
            return (C4129a) DEFAULT_INSTANCE.createBuilder();
        }
        ...
        public static NullableBool parseFrom(ByteBuffer byteBuffer) throws C5061a0 {
            return (NullableBool) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer);
        }

        public static C5193y0<NullableBool> parser() {
            return DEFAULT_INSTANCE.getParserForType();
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.C5054e eVar, Object obj, Object obj2) {
            switch (eVar.ordinal()) {
                ...
                case 5:
                    return DEFAULT_INSTANCE;
                case 6:
                    C5193y0<NullableBool> y0Var = PARSER;
                    if (y0Var == null) {
        ...
        public static C4129a newBuilder(NullableBool nullableBool) {
            return (C4129a) DEFAULT_INSTANCE.createBuilder(nullableBool);
        }

        public static NullableBool parseDelimitedFrom(InputStream inputStream, C5147q qVar) throws IOException {
            return (NullableBool) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, qVar);
        }

        public static NullableBool parseFrom(ByteBuffer byteBuffer, C5147q qVar) throws C5061a0 {
            return (NullableBool) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, qVar);
        }

        public static NullableBool parseFrom(C5093i iVar) throws C5061a0 {
            return (NullableBool) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, iVar);
        }

        public static NullableBool parseFrom(C5093i iVar, C5147q qVar) throws C5061a0 {
            return (NullableBool) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, iVar, qVar);
        }

        public static NullableBool parseFrom(byte[] bArr) throws C5061a0 {
            return (NullableBool) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr);
        }

        public static NullableBool parseFrom(byte[] bArr, C5147q qVar) throws C5061a0 {
        ...
        public static NullableBool parseFrom(InputStream inputStream, C5147q qVar) throws IOException {
            return (NullableBool) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, qVar);
        }

        public static NullableBool parseFrom(C5114j jVar) throws IOException {
            return (NullableBool) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, jVar);
        }

        public static NullableBool parseFrom(C5114j jVar, C5147q qVar) throws IOException {
            return (NullableBool) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, jVar, qVar);
        }
    }

    public static final class NullableFloat extends GeneratedMessageLite<NullableFloat, C4130a> implements C5153r0 {
        public static final int DATA_FIELD_NUMBER = 1;
        /* access modifiers changed from: private */
        public static final NullableFloat DEFAULT_INSTANCE;
        private static volatile C5193y0<NullableFloat> PARSER;
        private int bitField0_;
        private float data_;

        /* renamed from: com.fyber.inneractive.sdk.bidder.TokenParametersOuterClass$TokenParameters$NullableFloat$a */
        public static final class C4130a extends GeneratedMessageLite.C5050a<NullableFloat, C4130a> implements C5153r0 {
            public C4130a() {
        ...
        public static C4130a newBuilder() {
            return (C4130a) DEFAULT_INSTANCE.createBuilder();
        }
        ...
        public static NullableFloat parseFrom(ByteBuffer byteBuffer) throws C5061a0 {
            return (NullableFloat) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer);
        }

        public static C5193y0<NullableFloat> parser() {
            return DEFAULT_INSTANCE.getParserForType();
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.C5054e eVar, Object obj, Object obj2) {
            switch (eVar.ordinal()) {
                ...
                case 5:
                    return DEFAULT_INSTANCE;
                case 6:
                    C5193y0<NullableFloat> y0Var = PARSER;
                    if (y0Var == null) {
        ...
        public static C4130a newBuilder(NullableFloat nullableFloat) {
            return (C4130a) DEFAULT_INSTANCE.createBuilder(nullableFloat);
        }

        public static NullableFloat parseDelimitedFrom(InputStream inputStream, C5147q qVar) throws IOException {
            return (NullableFloat) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, qVar);
        }

        public static NullableFloat parseFrom(ByteBuffer byteBuffer, C5147q qVar) throws C5061a0 {
            return (NullableFloat) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, qVar);
        }

        public static NullableFloat parseFrom(C5093i iVar) throws C5061a0 {
            return (NullableFloat) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, iVar);
        }

        public static NullableFloat parseFrom(C5093i iVar, C5147q qVar) throws C5061a0 {
            return (NullableFloat) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, iVar, qVar);
        }

        public static NullableFloat parseFrom(byte[] bArr) throws C5061a0 {
            return (NullableFloat) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr);
        }

        public static NullableFloat parseFrom(byte[] bArr, C5147q qVar) throws C5061a0 {
        ...
        public static NullableFloat parseFrom(InputStream inputStream, C5147q qVar) throws IOException {
            return (NullableFloat) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, qVar);
        }

        public static NullableFloat parseFrom(C5114j jVar) throws IOException {
            return (NullableFloat) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, jVar);
        }

        public static NullableFloat parseFrom(C5114j jVar, C5147q qVar) throws IOException {
            return (NullableFloat) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, jVar, qVar);
        }
    }

    public static final class NullableSInt32 extends GeneratedMessageLite<NullableSInt32, C4131a> implements C5153r0 {
        public static final int DATA_FIELD_NUMBER = 1;
        /* access modifiers changed from: private */
        public static final NullableSInt32 DEFAULT_INSTANCE;
        private static volatile C5193y0<NullableSInt32> PARSER;
        private int bitField0_;
        private int data_;

        /* renamed from: com.fyber.inneractive.sdk.bidder.TokenParametersOuterClass$TokenParameters$NullableSInt32$a */
        public static final class C4131a extends GeneratedMessageLite.C5050a<NullableSInt32, C4131a> implements C5153r0 {
            public C4131a() {
        ...
        public static C4131a newBuilder() {
            return (C4131a) DEFAULT_INSTANCE.createBuilder();
        }
        ...
        public static NullableSInt32 parseFrom(ByteBuffer byteBuffer) throws C5061a0 {
            return (NullableSInt32) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer);
        }

        public static C5193y0<NullableSInt32> parser() {
            return DEFAULT_INSTANCE.getParserForType();
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.C5054e eVar, Object obj, Object obj2) {
            switch (eVar.ordinal()) {
                ...
                case 5:
                    return DEFAULT_INSTANCE;
                case 6:
                    C5193y0<NullableSInt32> y0Var = PARSER;
                    if (y0Var == null) {
        ...
        public static C4131a newBuilder(NullableSInt32 nullableSInt32) {
            return (C4131a) DEFAULT_INSTANCE.createBuilder(nullableSInt32);
        }

        public static NullableSInt32 parseDelimitedFrom(InputStream inputStream, C5147q qVar) throws IOException {
            return (NullableSInt32) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, qVar);
        }

        public static NullableSInt32 parseFrom(ByteBuffer byteBuffer, C5147q qVar) throws C5061a0 {
            return (NullableSInt32) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, qVar);
        }

        public static NullableSInt32 parseFrom(C5093i iVar) throws C5061a0 {
            return (NullableSInt32) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, iVar);
        }

        public static NullableSInt32 parseFrom(C5093i iVar, C5147q qVar) throws C5061a0 {
            return (NullableSInt32) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, iVar, qVar);
        }

        public static NullableSInt32 parseFrom(byte[] bArr) throws C5061a0 {
            return (NullableSInt32) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr);
        }

        public static NullableSInt32 parseFrom(byte[] bArr, C5147q qVar) throws C5061a0 {
        ...
        public static NullableSInt32 parseFrom(InputStream inputStream, C5147q qVar) throws IOException {
            return (NullableSInt32) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, qVar);
        }

        public static NullableSInt32 parseFrom(C5114j jVar) throws IOException {
            return (NullableSInt32) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, jVar);
        }

        public static NullableSInt32 parseFrom(C5114j jVar, C5147q qVar) throws IOException {
            return (NullableSInt32) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, jVar, qVar);
        }
    }

    public static final class NullableString extends GeneratedMessageLite<NullableString, C4132a> implements C5153r0 {
        public static final int DATA_FIELD_NUMBER = 1;
        /* access modifiers changed from: private */
        public static final NullableString DEFAULT_INSTANCE;
        private static volatile C5193y0<NullableString> PARSER;
        private int bitField0_;
        private String data_ = "";

        /* renamed from: com.fyber.inneractive.sdk.bidder.TokenParametersOuterClass$TokenParameters$NullableString$a */
        public static final class C4132a extends GeneratedMessageLite.C5050a<NullableString, C4132a> implements C5153r0 {
            public C4132a() {
        ...
        public static C4132a newBuilder() {
            return (C4132a) DEFAULT_INSTANCE.createBuilder();
        }
        ...
        public static NullableString parseFrom(ByteBuffer byteBuffer) throws C5061a0 {
            return (NullableString) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer);
        }

        public static C5193y0<NullableString> parser() {
            return DEFAULT_INSTANCE.getParserForType();
        }
        ...
        /* access modifiers changed from: private */
        public void setDataBytes(C5093i iVar) {
            C5058a.checkByteStringIsUtf8(iVar);
            this.data_ = iVar.mo25918i();
            this.bitField0_ |= 1;
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.C5054e eVar, Object obj, Object obj2) {
            switch (eVar.ordinal()) {
                ...
                case 5:
                    return DEFAULT_INSTANCE;
                case 6:
                    C5193y0<NullableString> y0Var = PARSER;
                    if (y0Var == null) {
        ...
        public C5093i getDataBytes() {
            return C5093i.m15514a(this.data_);
        }
        ...
        public static C4132a newBuilder(NullableString nullableString) {
            return (C4132a) DEFAULT_INSTANCE.createBuilder(nullableString);
        }

        public static NullableString parseDelimitedFrom(InputStream inputStream, C5147q qVar) throws IOException {
            return (NullableString) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, qVar);
        }

        public static NullableString parseFrom(ByteBuffer byteBuffer, C5147q qVar) throws C5061a0 {
            return (NullableString) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, qVar);
        }

        public static NullableString parseFrom(C5093i iVar) throws C5061a0 {
            return (NullableString) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, iVar);
        }

        public static NullableString parseFrom(C5093i iVar, C5147q qVar) throws C5061a0 {
            return (NullableString) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, iVar, qVar);
        }

        public static NullableString parseFrom(byte[] bArr) throws C5061a0 {
            return (NullableString) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr);
        }

        public static NullableString parseFrom(byte[] bArr, C5147q qVar) throws C5061a0 {
        ...
        public static NullableString parseFrom(InputStream inputStream, C5147q qVar) throws IOException {
            return (NullableString) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, qVar);
        }

        public static NullableString parseFrom(C5114j jVar) throws IOException {
            return (NullableString) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, jVar);
        }

        public static NullableString parseFrom(C5114j jVar, C5147q qVar) throws IOException {
            return (NullableString) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, jVar, qVar);
        }
    }

    public static final class NullableUInt32 extends GeneratedMessageLite<NullableUInt32, C4133a> implements C5153r0 {
        public static final int DATA_FIELD_NUMBER = 1;
        /* access modifiers changed from: private */
        public static final NullableUInt32 DEFAULT_INSTANCE;
        private static volatile C5193y0<NullableUInt32> PARSER;
        private int bitField0_;
        private int data_;

        /* renamed from: com.fyber.inneractive.sdk.bidder.TokenParametersOuterClass$TokenParameters$NullableUInt32$a */
        public static final class C4133a extends GeneratedMessageLite.C5050a<NullableUInt32, C4133a> implements C5153r0 {
            public C4133a() {
                super(NullableUInt32.DEFAULT_INSTANCE);
            }

            /* renamed from: a */
            public C4133a mo23990a(int i) {
                mo25737c();
                ((NullableUInt32) this.f13487b).setData(i);
                return this;
            }
        }
        ...
        public static C4133a newBuilder() {
            return (C4133a) DEFAULT_INSTANCE.createBuilder();
        }
        ...
        public static NullableUInt32 parseFrom(ByteBuffer byteBuffer) throws C5061a0 {
            return (NullableUInt32) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer);
        }

        public static C5193y0<NullableUInt32> parser() {
            return DEFAULT_INSTANCE.getParserForType();
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.C5054e eVar, Object obj, Object obj2) {
            switch (eVar.ordinal()) {
                ...
                case 5:
                    return DEFAULT_INSTANCE;
                case 6:
                    C5193y0<NullableUInt32> y0Var = PARSER;
                    if (y0Var == null) {
        ...
        public static C4133a newBuilder(NullableUInt32 nullableUInt32) {
            return (C4133a) DEFAULT_INSTANCE.createBuilder(nullableUInt32);
        }

        public static NullableUInt32 parseDelimitedFrom(InputStream inputStream, C5147q qVar) throws IOException {
            return (NullableUInt32) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, qVar);
        }

        public static NullableUInt32 parseFrom(ByteBuffer byteBuffer, C5147q qVar) throws C5061a0 {
            return (NullableUInt32) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, qVar);
        }

        public static NullableUInt32 parseFrom(C5093i iVar) throws C5061a0 {
            return (NullableUInt32) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, iVar);
        }

        public static NullableUInt32 parseFrom(C5093i iVar, C5147q qVar) throws C5061a0 {
            return (NullableUInt32) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, iVar, qVar);
        }

        public static NullableUInt32 parseFrom(byte[] bArr) throws C5061a0 {
            return (NullableUInt32) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr);
        }

        public static NullableUInt32 parseFrom(byte[] bArr, C5147q qVar) throws C5061a0 {
        ...
        public static NullableUInt32 parseFrom(InputStream inputStream, C5147q qVar) throws IOException {
            return (NullableUInt32) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, qVar);
        }

        public static NullableUInt32 parseFrom(C5114j jVar) throws IOException {
            return (NullableUInt32) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, jVar);
        }

        public static NullableUInt32 parseFrom(C5114j jVar, C5147q qVar) throws IOException {
            return (NullableUInt32) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, jVar, qVar);
        }
    }

    public static final class PriorVideoClickType extends GeneratedMessageLite<PriorVideoClickType, C4134a> implements C4143g {
        public static final int CLICKTYPE_FIELD_NUMBER = 2;
        /* access modifiers changed from: private */
        public static final PriorVideoClickType DEFAULT_INSTANCE;
        private static volatile C5193y0<PriorVideoClickType> PARSER = null;
        public static final int TYPE_FIELD_NUMBER = 1;
        private int bitField0_;
        ...
        public static final class C4134a extends GeneratedMessageLite.C5050a<PriorVideoClickType, C4134a> implements C4143g {
            public C4134a() {
        ...
        public static C4134a newBuilder() {
            return (C4134a) DEFAULT_INSTANCE.createBuilder();
        }
        ...
        public static PriorVideoClickType parseFrom(ByteBuffer byteBuffer) throws C5061a0 {
            return (PriorVideoClickType) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer);
        }

        public static C5193y0<PriorVideoClickType> parser() {
            return DEFAULT_INSTANCE.getParserForType();
        }

        /* access modifiers changed from: private */
        public void setClickType(C4150n nVar) {
            this.clickType_ = nVar.mo24014a();
            this.bitField0_ |= 2;
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.C5054e eVar, Object obj, Object obj2) {
            switch (eVar.ordinal()) {
                ...
                case 5:
                    return DEFAULT_INSTANCE;
                case 6:
                    C5193y0<PriorVideoClickType> y0Var = PARSER;
                    if (y0Var == null) {
        ...
        public C4150n getClickType() {
            C4150n a = C4150n.m13115a(this.clickType_);
            return a == null ? C4150n.UNRECOGNIZED : a;
        }
        ...
        public static C4134a newBuilder(PriorVideoClickType priorVideoClickType) {
            return (C4134a) DEFAULT_INSTANCE.createBuilder(priorVideoClickType);
        }

        public static PriorVideoClickType parseDelimitedFrom(InputStream inputStream, C5147q qVar) throws IOException {
            return (PriorVideoClickType) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, qVar);
        }

        public static PriorVideoClickType parseFrom(ByteBuffer byteBuffer, C5147q qVar) throws C5061a0 {
            return (PriorVideoClickType) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, qVar);
        }

        public static PriorVideoClickType parseFrom(C5093i iVar) throws C5061a0 {
            return (PriorVideoClickType) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, iVar);
        }

        public static PriorVideoClickType parseFrom(C5093i iVar, C5147q qVar) throws C5061a0 {
            return (PriorVideoClickType) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, iVar, qVar);
        }

        public static PriorVideoClickType parseFrom(byte[] bArr) throws C5061a0 {
            return (PriorVideoClickType) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr);
        }

        public static PriorVideoClickType parseFrom(byte[] bArr, C5147q qVar) throws C5061a0 {
        ...
        public static PriorVideoClickType parseFrom(InputStream inputStream, C5147q qVar) throws IOException {
            return (PriorVideoClickType) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, qVar);
        }

        public static PriorVideoClickType parseFrom(C5114j jVar) throws IOException {
            return (PriorVideoClickType) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, jVar);
        }

        public static PriorVideoClickType parseFrom(C5114j jVar, C5147q qVar) throws IOException {
            return (PriorVideoClickType) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, jVar, qVar);
        }
    }

    public static final class SessionData extends GeneratedMessageLite<SessionData, C4135a> implements C4145i {
        ...
        private static volatile C5193y0<SessionData> PARSER;
        private int bitField0_;
        private int clicks_;
        ...
        public static final class C4135a extends GeneratedMessageLite.C5050a<SessionData, C4135a> implements C4145i {
            public C4135a() {
        ...
        public static C4135a newBuilder() {
            return (C4135a) DEFAULT_INSTANCE.createBuilder();
        }
        ...
        public static SessionData parseFrom(ByteBuffer byteBuffer) throws C5061a0 {
            return (SessionData) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer);
        }

        public static C5193y0<SessionData> parser() {
            return DEFAULT_INSTANCE.getParserForType();
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.C5054e eVar, Object obj, Object obj2) {
            switch (eVar.ordinal()) {
                ...
                case 5:
                    return DEFAULT_INSTANCE;
                case 6:
                    C5193y0<SessionData> y0Var = PARSER;
                    if (y0Var == null) {
        ...
        public static C4135a newBuilder(SessionData sessionData) {
            return (C4135a) DEFAULT_INSTANCE.createBuilder(sessionData);
        }

        public static SessionData parseDelimitedFrom(InputStream inputStream, C5147q qVar) throws IOException {
            return (SessionData) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, qVar);
        }

        public static SessionData parseFrom(ByteBuffer byteBuffer, C5147q qVar) throws C5061a0 {
            return (SessionData) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, qVar);
        }

        public static SessionData parseFrom(C5093i iVar) throws C5061a0 {
            return (SessionData) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, iVar);
        }

        public static SessionData parseFrom(C5093i iVar, C5147q qVar) throws C5061a0 {
            return (SessionData) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, iVar, qVar);
        }

        public static SessionData parseFrom(byte[] bArr) throws C5061a0 {
            return (SessionData) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr);
        }

        public static SessionData parseFrom(byte[] bArr, C5147q qVar) throws C5061a0 {
        ...
        public static SessionData parseFrom(InputStream inputStream, C5147q qVar) throws IOException {
            return (SessionData) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, qVar);
        }

        public static SessionData parseFrom(C5114j jVar) throws IOException {
            return (SessionData) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, jVar);
        }

        public static SessionData parseFrom(C5114j jVar, C5147q qVar) throws IOException {
            return (SessionData) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, jVar, qVar);
        }
    }

    public static final class UserSession extends GeneratedMessageLite<UserSession, C4136a> implements C4149m {
        /* access modifiers changed from: private */
        public static final UserSession DEFAULT_INSTANCE;
        private static volatile C5193y0<UserSession> PARSER = null;
        public static final int SESSIONDATAITEMS_FIELD_NUMBER = 3;
        public static final int SUBTYPE_FIELD_NUMBER = 2;
        public static final int TYPE_FIELD_NUMBER = 1;
        private int bitField0_;
        private C5194z.C5205j<SessionData> sessionDataItems_ = GeneratedMessageLite.emptyProtobufList();
        private int subType_;
        private int type_;

        /* renamed from: com.fyber.inneractive.sdk.bidder.TokenParametersOuterClass$TokenParameters$UserSession$a */
        public static final class C4136a extends GeneratedMessageLite.C5050a<UserSession, C4136a> implements C4149m {
            public C4136a() {
        ...
        public void addAllSessionDataItems(Iterable<? extends SessionData> iterable) {
            ...
            C5058a.addAll(iterable, this.sessionDataItems_);
        }
        ...
        private void ensureSessionDataItemsIsMutable() {
            C5194z.C5205j<SessionData> jVar = this.sessionDataItems_;
            if (!jVar.mo25768d()) {
        ...
        public static C4136a newBuilder() {
            return (C4136a) DEFAULT_INSTANCE.createBuilder();
        }
        ...
        public static UserSession parseFrom(ByteBuffer byteBuffer) throws C5061a0 {
            return (UserSession) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer);
        }

        public static C5193y0<UserSession> parser() {
            return DEFAULT_INSTANCE.getParserForType();
        }
        ...
        /* access modifiers changed from: private */
        public void setSubType(C4146j jVar) {
            this.subType_ = jVar.mo24014a();
            this.bitField0_ |= 2;
        }
        ...
        public final Object dynamicMethod(GeneratedMessageLite.C5054e eVar, Object obj, Object obj2) {
            switch (eVar.ordinal()) {
                ...
                case 5:
                    return DEFAULT_INSTANCE;
                case 6:
                    C5193y0<UserSession> y0Var = PARSER;
                    if (y0Var == null) {
        ...
        public C4145i getSessionDataItemsOrBuilder(int i) {
            return this.sessionDataItems_.get(i);
        }

        public List<? extends C4145i> getSessionDataItemsOrBuilderList() {
            return this.sessionDataItems_;
        }

        public C4146j getSubType() {
            C4146j a = C4146j.m13109a(this.subType_);
            return a == null ? C4146j.UNRECOGNIZED : a;
        }
        ...
        public static C4136a newBuilder(UserSession userSession) {
            return (C4136a) DEFAULT_INSTANCE.createBuilder(userSession);
        }

        public static UserSession parseDelimitedFrom(InputStream inputStream, C5147q qVar) throws IOException {
            return (UserSession) GeneratedMessageLite.parseDelimitedFrom(DEFAULT_INSTANCE, inputStream, qVar);
        }

        public static UserSession parseFrom(ByteBuffer byteBuffer, C5147q qVar) throws C5061a0 {
            return (UserSession) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, qVar);
        }

        public static UserSession parseFrom(C5093i iVar) throws C5061a0 {
        ...
        public static UserSession parseFrom(C5093i iVar, C5147q qVar) throws C5061a0 {
            return (UserSession) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, iVar, qVar);
        }

        public static UserSession parseFrom(byte[] bArr) throws C5061a0 {
            return (UserSession) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, bArr);
        }

        public static UserSession parseFrom(byte[] bArr, C5147q qVar) throws C5061a0 {
        ...
        public static UserSession parseFrom(InputStream inputStream, C5147q qVar) throws IOException {
            return (UserSession) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, qVar);
        }

        public static UserSession parseFrom(C5114j jVar) throws IOException {
            return (UserSession) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, jVar);
        }

        public static UserSession parseFrom(C5114j jVar, C5147q qVar) throws IOException {
    ...
    public class C4137a implements C5194z.C5202h.C5203a<Integer, C4147k> {
    }

    /* renamed from: com.fyber.inneractive.sdk.bidder.TokenParametersOuterClass$TokenParameters$b */
    public static final class C4138b extends GeneratedMessageLite.C5050a<TokenParametersOuterClass$TokenParameters, C4138b> implements C5153r0 {
        public C4138b() {
    ...
    public void addAllLastAdomains(Iterable<? extends LastAdomain> iterable) {
        ...
        C5058a.addAll(iterable, this.lastAdomains_);
    }
    ...
    public void addAllLastAdvertisedBundles(Iterable<? extends LastAdvertisedBundle> iterable) {
        ...
        C5058a.addAll(iterable, this.lastAdvertisedBundles_);
    }

    /* access modifiers changed from: private */
    public void addAllPriorClickTypes(Iterable<? extends PriorVideoClickType> iterable) {
        ensurePriorClickTypesIsMutable();
        C5058a.addAll(iterable, this.priorClickTypes_);
    }

    /* access modifiers changed from: private */
    public void addAllPriorClicks(Iterable<? extends C4147k> iterable) {
        ensurePriorClicksIsMutable();
        for (C4147k a : iterable) {
            ((C5192y) this.priorClicks_).mo26230c(a.mo24014a());
        }
    }
    ...
    public void addAllPriorClicksValue(Iterable<Integer> iterable) {
        ...
        for (Integer intValue : iterable) {
            ((C5192y) this.priorClicks_).mo26230c(intValue.intValue());
        }
    }
    ...
    public void addAllUserSessions(Iterable<? extends UserSession> iterable) {
        ...
        C5058a.addAll(iterable, this.userSessions_);
    }
    ...
    /* access modifiers changed from: private */
    public void addPriorClicks(C4147k kVar) {
        kVar.getClass();
        ensurePriorClicksIsMutable();
        ((C5192y) this.priorClicks_).mo26230c(kVar.mo24014a());
    }

    /* access modifiers changed from: private */
    public void addPriorClicksValue(int i) {
        ensurePriorClicksIsMutable();
        ((C5192y) this.priorClicks_).mo26230c(i);
    }
    ...
    private void ensureLastAdomainsIsMutable() {
        C5194z.C5205j<LastAdomain> jVar = this.lastAdomains_;
        if (!jVar.mo25768d()) {
    ...
    private void ensureLastAdvertisedBundlesIsMutable() {
        C5194z.C5205j<LastAdvertisedBundle> jVar = this.lastAdvertisedBundles_;
        if (!jVar.mo25768d()) {
    ...
    private void ensurePriorClickTypesIsMutable() {
        C5194z.C5205j<PriorVideoClickType> jVar = this.priorClickTypes_;
        if (!jVar.mo25768d()) {
    ...
    private void ensurePriorClicksIsMutable() {
        C5194z.C5201g gVar = this.priorClicks_;
        if (!((C5067c) gVar).f13527a) {
            this.priorClicks_ = GeneratedMessageLite.mutableCopy(gVar);
        }
    }

    private void ensureUserSessionsIsMutable() {
        C5194z.C5205j<UserSession> jVar = this.userSessions_;
        if (!jVar.mo25768d()) {
    ...
    public void mergeAaid(NullableString nullableString) {
        ...
        if (nullableString2 == null || nullableString2 == NullableString.getDefaultInstance()) {
            ...
            NullableString.C4132a newBuilder = NullableString.newBuilder(this.aaid_);
            newBuilder.mo25737c();
            newBuilder.mo25735a(newBuilder.f13487b, nullableString);
            this.aaid_ = (NullableString) newBuilder.mo25736b();
        }
    ...
    public void mergeAirplaneMode(NullableBool nullableBool) {
        ...
        if (nullableBool2 == null || nullableBool2 == NullableBool.getDefaultInstance()) {
            ...
            NullableBool.C4129a newBuilder = NullableBool.newBuilder(this.airplaneMode_);
            newBuilder.mo25737c();
            newBuilder.mo25735a(newBuilder.f13487b, nullableBool);
            this.airplaneMode_ = (NullableBool) newBuilder.mo25736b();
        }
        this.bitField0_ |= 512;
    }
    ...
    public void mergeAmazonId(NullableString nullableString) {
        ...
        if (nullableString2 == null || nullableString2 == NullableString.getDefaultInstance()) {
            ...
            NullableString.C4132a newBuilder = NullableString.newBuilder(this.amazonId_);
            newBuilder.mo25737c();
            newBuilder.mo25735a(newBuilder.f13487b, nullableString);
            this.amazonId_ = (NullableString) newBuilder.mo25736b();
        }
    ...
    public void mergeAppBuildVersion(NullableString nullableString) {
        ...
        if (nullableString2 == null || nullableString2 == NullableString.getDefaultInstance()) {
            ...
            NullableString.C4132a newBuilder = NullableString.newBuilder(this.appBuildVersion_);
            newBuilder.mo25737c();
            newBuilder.mo25735a(newBuilder.f13487b, nullableString);
            this.appBuildVersion_ = (NullableString) newBuilder.mo25736b();
        }
    ...
    public void mergeAppVersion(NullableString nullableString) {
        ...
        NullableString.C4132a newBuilder = NullableString.newBuilder(this.appVersion_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableString);
        this.appVersion_ = (NullableString) newBuilder.mo25736b();
    }
    ...
    public void mergeBatteryCharging(NullableBool nullableBool) {
        ...
        NullableBool.C4129a newBuilder = NullableBool.newBuilder(this.batteryCharging_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableBool);
        this.batteryCharging_ = (NullableBool) newBuilder.mo25736b();
    }
    ...
    public void mergeBatteryLevel(NullableUInt32 nullableUInt32) {
        ...
        NullableUInt32.C4133a newBuilder = NullableUInt32.newBuilder(this.batteryLevel_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableUInt32);
        this.batteryLevel_ = (NullableUInt32) newBuilder.mo25736b();
    }
    ...
    public void mergeBluetoothPlugged(NullableBool nullableBool) {
        ...
        if (nullableBool2 == null || nullableBool2 == NullableBool.getDefaultInstance()) {
            ...
            NullableBool.C4129a newBuilder = NullableBool.newBuilder(this.bluetoothPlugged_);
            newBuilder.mo25737c();
            newBuilder.mo25735a(newBuilder.f13487b, nullableBool);
            this.bluetoothPlugged_ = (NullableBool) newBuilder.mo25736b();
        }
        this.bitField0_ |= 128;
    }
    ...
    public void mergeBundleID(NullableString nullableString) {
        ...
        NullableString.C4132a newBuilder = NullableString.newBuilder(this.bundleID_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableString);
        this.bundleID_ = (NullableString) newBuilder.mo25736b();
    }
    ...
    public void mergeCarrierName(NullableString nullableString) {
        ...
        NullableString.C4132a newBuilder = NullableString.newBuilder(this.carrierName_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableString);
        this.carrierName_ = (NullableString) newBuilder.mo25736b();
    }
    ...
    public void mergeCcpaString(NullableString nullableString) {
        ...
        NullableString.C4132a newBuilder = NullableString.newBuilder(this.ccpaString_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableString);
        this.ccpaString_ = (NullableString) newBuilder.mo25736b();
    }
    ...
    public void mergeCountryCode(NullableString nullableString) {
        ...
        NullableString.C4132a newBuilder = NullableString.newBuilder(this.countryCode_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableString);
        this.countryCode_ = (NullableString) newBuilder.mo25736b();
    }
    ...
    public void mergeDeviceApi(NullableUInt32 nullableUInt32) {
        ...
        if (nullableUInt322 == null || nullableUInt322 == NullableUInt32.getDefaultInstance()) {
            ...
            NullableUInt32.C4133a newBuilder = NullableUInt32.newBuilder(this.deviceApi_);
            newBuilder.mo25737c();
            newBuilder.mo25735a(newBuilder.f13487b, nullableUInt32);
            this.deviceApi_ = (NullableUInt32) newBuilder.mo25736b();
        }
        this.bitField0_ |= 1;
    }
    ...
    public void mergeDeviceHeight(NullableUInt32 nullableUInt32) {
        ...
        NullableUInt32.C4133a newBuilder = NullableUInt32.newBuilder(this.deviceHeight_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableUInt32);
        this.deviceHeight_ = (NullableUInt32) newBuilder.mo25736b();
    }
    ...
    public void mergeDeviceLanguage(NullableString nullableString) {
        ...
        NullableString.C4132a newBuilder = NullableString.newBuilder(this.deviceLanguage_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableString);
        this.deviceLanguage_ = (NullableString) newBuilder.mo25736b();
    }
    ...
    public void mergeDeviceModel(NullableString nullableString) {
        ...
        NullableString.C4132a newBuilder = NullableString.newBuilder(this.deviceModel_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableString);
        this.deviceModel_ = (NullableString) newBuilder.mo25736b();
    }
    ...
    public void mergeDeviceOS(NullableString nullableString) {
        ...
        NullableString.C4132a newBuilder = NullableString.newBuilder(this.deviceOS_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableString);
        this.deviceOS_ = (NullableString) newBuilder.mo25736b();
    }
    ...
    public void mergeDeviceWidth(NullableUInt32 nullableUInt32) {
        ...
        NullableUInt32.C4133a newBuilder = NullableUInt32.newBuilder(this.deviceWidth_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableUInt32);
        this.deviceWidth_ = (NullableUInt32) newBuilder.mo25736b();
    }
    ...
    public void mergeDndMode(NullableBool nullableBool) {
        ...
        if (nullableBool2 == null || nullableBool2 == NullableBool.getDefaultInstance()) {
            ...
            NullableBool.C4129a newBuilder = NullableBool.newBuilder(this.dndMode_);
            newBuilder.mo25737c();
            newBuilder.mo25735a(newBuilder.f13487b, nullableBool);
            this.dndMode_ = (NullableBool) newBuilder.mo25736b();
        }
    ...
    public void mergeFreeSpace(NullableUInt32 nullableUInt32) {
        ...
        NullableUInt32.C4133a newBuilder = NullableUInt32.newBuilder(this.freeSpace_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableUInt32);
        this.freeSpace_ = (NullableUInt32) newBuilder.mo25736b();
    }
    ...
    public void mergeGdprConsent(NullableBool nullableBool) {
        ...
        NullableBool.C4129a newBuilder = NullableBool.newBuilder(this.gdprConsent_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableBool);
        this.gdprConsent_ = (NullableBool) newBuilder.mo25736b();
    }
    ...
    public void mergeGdprString(NullableString nullableString) {
        ...
        NullableString.C4132a newBuilder = NullableString.newBuilder(this.gdprString_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableString);
        this.gdprString_ = (NullableString) newBuilder.mo25736b();
    }
    ...
    public void mergeHeadsetPlugged(NullableBool nullableBool) {
        ...
        if (nullableBool2 == null || nullableBool2 == NullableBool.getDefaultInstance()) {
            ...
            NullableBool.C4129a newBuilder = NullableBool.newBuilder(this.headsetPlugged_);
            newBuilder.mo25737c();
            newBuilder.mo25735a(newBuilder.f13487b, nullableBool);
            this.headsetPlugged_ = (NullableBool) newBuilder.mo25736b();
        }
        this.bitField0_ |= 64;
    }
    ...
    public void mergeHorAccuracy(NullableFloat nullableFloat) {
        ...
        NullableFloat.C4130a newBuilder = NullableFloat.newBuilder(this.horAccuracy_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableFloat);
        this.horAccuracy_ = (NullableFloat) newBuilder.mo25736b();
    }
    ...
    public void mergeIdfa(NullableString nullableString) {
        ...
        if (nullableString2 == null || nullableString2 == NullableString.getDefaultInstance()) {
            ...
            NullableString.C4132a newBuilder = NullableString.newBuilder(this.idfa_);
            newBuilder.mo25737c();
            newBuilder.mo25735a(newBuilder.f13487b, nullableString);
            this.idfa_ = (NullableString) newBuilder.mo25736b();
        }
        this.bitField0_ |= 4;
    }
    ...
    public void mergeIdfv(NullableString nullableString) {
        ...
        if (nullableString2 == null || nullableString2 == NullableString.getDefaultInstance()) {
            ...
            NullableString.C4132a newBuilder = NullableString.newBuilder(this.idfv_);
            newBuilder.mo25737c();
            newBuilder.mo25735a(newBuilder.f13487b, nullableString);
            this.idfv_ = (NullableString) newBuilder.mo25736b();
        }
        this.bitField0_ |= 8;
    }
    ...
    public void mergeInputLanguages(NullableString nullableString) {
        ...
        NullableString.C4132a newBuilder = NullableString.newBuilder(this.inputLanguages_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableString);
        this.inputLanguages_ = (NullableString) newBuilder.mo25736b();
    }
    ...
    public void mergeIsRingMuted(NullableBool nullableBool) {
        ...
        if (nullableBool2 == null || nullableBool2 == NullableBool.getDefaultInstance()) {
            ...
            NullableBool.C4129a newBuilder = NullableBool.newBuilder(this.isRingMuted_);
            newBuilder.mo25737c();
            newBuilder.mo25735a(newBuilder.f13487b, nullableBool);
            this.isRingMuted_ = (NullableBool) newBuilder.mo25736b();
        }
    ...
    public void mergeKeywords(NullableString nullableString) {
        ...
        NullableString.C4132a newBuilder = NullableString.newBuilder(this.keywords_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableString);
        this.keywords_ = (NullableString) newBuilder.mo25736b();
    }
    ...
    public void mergeLatitude(NullableFloat nullableFloat) {
        ...
        NullableFloat.C4130a newBuilder = NullableFloat.newBuilder(this.latitude_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableFloat);
        this.latitude_ = (NullableFloat) newBuilder.mo25736b();
    }
    ...
    public void mergeLgpdConsent(NullableBool nullableBool) {
        ...
        NullableBool.C4129a newBuilder = NullableBool.newBuilder(this.lgpdConsent_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableBool);
        this.lgpdConsent_ = (NullableBool) newBuilder.mo25736b();
    }
    ...
    public void mergeLongitude(NullableFloat nullableFloat) {
        ...
        NullableFloat.C4130a newBuilder = NullableFloat.newBuilder(this.longitude_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableFloat);
        this.longitude_ = (NullableFloat) newBuilder.mo25736b();
    }
    ...
    public void mergeLowPowerMode(NullableBool nullableBool) {
        ...
        if (nullableBool2 == null || nullableBool2 == NullableBool.getDefaultInstance()) {
            ...
            NullableBool.C4129a newBuilder = NullableBool.newBuilder(this.lowPowerMode_);
            newBuilder.mo25737c();
            newBuilder.mo25735a(newBuilder.f13487b, nullableBool);
            this.lowPowerMode_ = (NullableBool) newBuilder.mo25736b();
        }
        this.bitField0_ |= 256;
    }
    ...
    public void mergeMediationType(NullableString nullableString) {
        ...
        NullableString.C4132a newBuilder = NullableString.newBuilder(this.mediationType_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableString);
        this.mediationType_ = (NullableString) newBuilder.mo25736b();
    }
    ...
    public void mergeMobileCountryCode(NullableString nullableString) {
        ...
        NullableString.C4132a newBuilder = NullableString.newBuilder(this.mobileCountryCode_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableString);
        this.mobileCountryCode_ = (NullableString) newBuilder.mo25736b();
    }
    ...
    public void mergeMobileNetworkCode(NullableString nullableString) {
        ...
        NullableString.C4132a newBuilder = NullableString.newBuilder(this.mobileNetworkCode_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableString);
        this.mobileNetworkCode_ = (NullableString) newBuilder.mo25736b();
    }
    ...
    public void mergeMockResponseId(NullableString nullableString) {
        ...
        if (nullableString2 == null || nullableString2 == NullableString.getDefaultInstance()) {
            ...
            NullableString.C4132a newBuilder = NullableString.newBuilder(this.mockResponseId_);
            newBuilder.mo25737c();
            newBuilder.mo25735a(newBuilder.f13487b, nullableString);
            this.mockResponseId_ = (NullableString) newBuilder.mo25736b();
        }
    ...
    public void mergeNetwork(NullableString nullableString) {
        ...
        NullableString.C4132a newBuilder = NullableString.newBuilder(this.network_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableString);
        this.network_ = (NullableString) newBuilder.mo25736b();
    }
    ...
    public void mergeOffsetFromGMT(NullableSInt32 nullableSInt32) {
        ...
        NullableSInt32.C4131a newBuilder = NullableSInt32.newBuilder(this.offsetFromGMT_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableSInt32);
        this.offsetFromGMT_ = (NullableSInt32) newBuilder.mo25736b();
    }
    ...
    public void mergeOsVersion(NullableString nullableString) {
        ...
        NullableString.C4132a newBuilder = NullableString.newBuilder(this.osVersion_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableString);
        this.osVersion_ = (NullableString) newBuilder.mo25736b();
    }
    ...
    public void mergePortal(NullableUInt32 nullableUInt32) {
        ...
        if (nullableUInt322 == null || nullableUInt322 == NullableUInt32.getDefaultInstance()) {
            ...
            NullableUInt32.C4133a newBuilder = NullableUInt32.newBuilder(this.portal_);
            newBuilder.mo25737c();
            newBuilder.mo25735a(newBuilder.f13487b, nullableUInt32);
            this.portal_ = (NullableUInt32) newBuilder.mo25736b();
        }
    ...
    public void mergePriorSkip(NullableBool nullableBool) {
        ...
        NullableBool.C4129a newBuilder = NullableBool.newBuilder(this.priorSkip_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableBool);
        this.priorSkip_ = (NullableBool) newBuilder.mo25736b();
    }
    ...
    public void mergePxRatio(NullableFloat nullableFloat) {
        ...
        if (nullableFloat2 == null || nullableFloat2 == NullableFloat.getDefaultInstance()) {
            ...
            NullableFloat.C4130a newBuilder = NullableFloat.newBuilder(this.pxRatio_);
            newBuilder.mo25737c();
            newBuilder.mo25735a(newBuilder.f13487b, nullableFloat);
            this.pxRatio_ = (NullableFloat) newBuilder.mo25736b();
        }
        this.bitField0_ |= 2;
    }
    ...
    public void mergeSdkVersion(NullableString nullableString) {
        ...
        NullableString.C4132a newBuilder = NullableString.newBuilder(this.sdkVersion_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableString);
        this.sdkVersion_ = (NullableString) newBuilder.mo25736b();
    }
    ...
    public void mergeSessionDuration(NullableUInt32 nullableUInt32) {
        ...
        NullableUInt32.C4133a newBuilder = NullableUInt32.newBuilder(this.sessionDuration_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableUInt32);
        this.sessionDuration_ = (NullableUInt32) newBuilder.mo25736b();
    }
    ...
    public void mergeTimeAccuracy(NullableFloat nullableFloat) {
        ...
        NullableFloat.C4130a newBuilder = NullableFloat.newBuilder(this.timeAccuracy_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableFloat);
        this.timeAccuracy_ = (NullableFloat) newBuilder.mo25736b();
    }
    ...
    public void mergeTotalSpace(NullableUInt32 nullableUInt32) {
        ...
        NullableUInt32.C4133a newBuilder = NullableUInt32.newBuilder(this.totalSpace_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableUInt32);
        this.totalSpace_ = (NullableUInt32) newBuilder.mo25736b();
    }
    ...
    public void mergeTrackingStatus(NullableUInt32 nullableUInt32) {
        ...
        if (nullableUInt322 == null || nullableUInt322 == NullableUInt32.getDefaultInstance()) {
            ...
            NullableUInt32.C4133a newBuilder = NullableUInt32.newBuilder(this.trackingStatus_);
            newBuilder.mo25737c();
            newBuilder.mo25735a(newBuilder.f13487b, nullableUInt32);
            this.trackingStatus_ = (NullableUInt32) newBuilder.mo25736b();
        }
        this.bitField0_ |= 32;
    }
    ...
    public void mergeUserAge(NullableUInt32 nullableUInt32) {
        ...
        NullableUInt32.C4133a newBuilder = NullableUInt32.newBuilder(this.userAge_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableUInt32);
        this.userAge_ = (NullableUInt32) newBuilder.mo25736b();
    }
    ...
    public void mergeUserAgent(NullableString nullableString) {
        ...
        NullableString.C4132a newBuilder = NullableString.newBuilder(this.userAgent_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableString);
        this.userAgent_ = (NullableString) newBuilder.mo25736b();
    }
    ...
    public void mergeUserID(NullableString nullableString) {
        ...
        NullableString.C4132a newBuilder = NullableString.newBuilder(this.userID_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableString);
        this.userID_ = (NullableString) newBuilder.mo25736b();
    }
    ...
    public void mergeVerAccuracy(NullableFloat nullableFloat) {
        ...
        NullableFloat.C4130a newBuilder = NullableFloat.newBuilder(this.verAccuracy_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableFloat);
        this.verAccuracy_ = (NullableFloat) newBuilder.mo25736b();
    }
    ...
    public void mergeVersion(NullableString nullableString) {
        ...
        NullableString.C4132a newBuilder = NullableString.newBuilder(this.version_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableString);
        this.version_ = (NullableString) newBuilder.mo25736b();
    }
    ...
    public void mergeZipCode(NullableString nullableString) {
        ...
        NullableString.C4132a newBuilder = NullableString.newBuilder(this.zipCode_);
        newBuilder.mo25737c();
        newBuilder.mo25735a(newBuilder.f13487b, nullableString);
        this.zipCode_ = (NullableString) newBuilder.mo25736b();
    }

    public static C4138b newBuilder() {
        return (C4138b) DEFAULT_INSTANCE.createBuilder();
    }
    ...
    public static TokenParametersOuterClass$TokenParameters parseFrom(ByteBuffer byteBuffer) throws C5061a0 {
        return (TokenParametersOuterClass$TokenParameters) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer);
    }

    public static C5193y0<TokenParametersOuterClass$TokenParameters> parser() {
        return DEFAULT_INSTANCE.getParserForType();
    }
    ...
    /* access modifiers changed from: private */
    public void setFrameworkName(C4140d dVar) {
        this.frameworkName_ = dVar.mo24014a();
    }
    ...
    /* access modifiers changed from: private */
    public void setPriorClicks(int i, C4147k kVar) {
        kVar.getClass();
        ensurePriorClicksIsMutable();
        C5194z.C5201g gVar = this.priorClicks_;
        int a = kVar.mo24014a();
    ...
    public void setPriorClicksValue(int i, int i2) {
        ensurePriorClicksIsMutable();
        C5192y yVar = (C5192y) this.priorClicks_;
        yVar.mo25769e();
        yVar.mo26232d(i);
        int[] iArr = yVar.f13760b;
        int i3 = iArr[i];
    ...
    /* access modifiers changed from: private */
    public void setSecureContent(C4144h hVar) {
        this.secureContent_ = hVar.mo24014a();
    }
    ...
    /* access modifiers changed from: private */
    public void setUserGender(C4148l lVar) {
        this.userGender_ = lVar.mo24014a();
    }
    ...
    public final Object dynamicMethod(GeneratedMessageLite.C5054e eVar, Object obj, Object obj2) {
        switch (eVar.ordinal()) {
            ...
            case 5:
                return DEFAULT_INSTANCE;
            case 6:
                C5193y0<TokenParametersOuterClass$TokenParameters> y0Var = PARSER;
                if (y0Var == null) {
    ...
    public C4139c getAbExperimentsOrBuilder(int i) {
        return this.abExperiments_.get(i);
    }

    public List<? extends C4139c> getAbExperimentsOrBuilderList() {
        return this.abExperiments_;
    }
    ...
    public C4140d getFrameworkName() {
        C4140d dVar;
        ...
        return dVar == null ? C4140d.UNRECOGNIZED : dVar;
    }
    ...
    public C4141e getLastAdomainsOrBuilder(int i) {
        return this.lastAdomains_.get(i);
    }

    public List<? extends C4141e> getLastAdomainsOrBuilderList() {
        return this.lastAdomains_;
    }
    ...
    public C4142f getLastAdvertisedBundlesOrBuilder(int i) {
        return this.lastAdvertisedBundles_.get(i);
    }

    public List<? extends C4142f> getLastAdvertisedBundlesOrBuilderList() {
        return this.lastAdvertisedBundles_;
    }
    ...
    public C4143g getPriorClickTypesOrBuilder(int i) {
        return this.priorClickTypes_.get(i);
    }

    public List<? extends C4143g> getPriorClickTypesOrBuilderList() {
        return this.priorClickTypes_;
    }

    public C4147k getPriorClicks(int i) {
        C5194z.C5202h.C5203a<Integer, C4147k> aVar = priorClicks_converter_;
        C5192y yVar = (C5192y) this.priorClicks_;
        yVar.mo26232d(i);
        Integer valueOf = Integer.valueOf(yVar.f13760b[i]);
        ((C4137a) aVar).getClass();
        C4147k a = C4147k.m13111a(valueOf.intValue());
        return a == null ? C4147k.UNRECOGNIZED : a;
    }

    public int getPriorClicksCount() {
        return ((C5192y) this.priorClicks_).size();
    }

    public List<C4147k> getPriorClicksList() {
        return new C5194z.C5202h(this.priorClicks_, priorClicks_converter_);
    }

    public int getPriorClicksValue(int i) {
        C5192y yVar = (C5192y) this.priorClicks_;
        yVar.mo26232d(i);
        return yVar.f13760b[i];
    }
    ...
    public C4144h getSecureContent() {
        C4144h a = C4144h.m13107a(this.secureContent_);
        return a == null ? C4144h.UNRECOGNIZED : a;
    }
    ...
    public C4148l getUserGender() {
        C4148l a = C4148l.m13113a(this.userGender_);
        return a == null ? C4148l.UNRECOGNIZED : a;
    }
    ...
    public C4149m getUserSessionsOrBuilder(int i) {
        return this.userSessions_.get(i);
    }

    public List<? extends C4149m> getUserSessionsOrBuilderList() {
        return this.userSessions_;
    }
    ...
    public static C4138b newBuilder(TokenParametersOuterClass$TokenParameters tokenParametersOuterClass$TokenParameters) {
        return (C4138b) DEFAULT_INSTANCE.createBuilder(tokenParametersOuterClass$TokenParameters);
    }

    public static TokenParametersOuterClass$TokenParameters parseDelimitedFrom(InputStream inputStream, C5147q qVar) throws IOException {
    ...
    public static TokenParametersOuterClass$TokenParameters parseFrom(ByteBuffer byteBuffer, C5147q qVar) throws C5061a0 {
        return (TokenParametersOuterClass$TokenParameters) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, byteBuffer, qVar);
    }

    public static TokenParametersOuterClass$TokenParameters parseFrom(C5093i iVar) throws C5061a0 {
    ...
    public static TokenParametersOuterClass$TokenParameters parseFrom(C5093i iVar, C5147q qVar) throws C5061a0 {
        return (TokenParametersOuterClass$TokenParameters) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, iVar, qVar);
    }

    public static TokenParametersOuterClass$TokenParameters parseFrom(byte[] bArr) throws C5061a0 {
    ...
    public enum C4144h implements C5194z.C5197c {
        UNSECURE(0),
        SECURE(1),
        PARTIALLYSECURE(2),
        UNRECOGNIZED(-1);
        ...
        /* renamed from: a */
        public static C4144h m13107a(int i) {
            if (i == 0) {
                return UNSECURE;
            }
            if (i == 1) {
    ...
    public enum C4146j implements C5194z.C5197c {
        ...
        /* renamed from: a */
        public static C4146j m13109a(int i) {
            if (i == 0) {
    ...
    public enum C4147k implements C5194z.C5197c {
        ...
        /* renamed from: a */
        public static C4147k m13111a(int i) {
            if (i == 0) {
    ...
    public enum C4148l implements C5194z.C5197c {
        UNKNOWN(0),
        MALE(1),
        FEMALE(2),
        OTHER(3),
        ...
        /* renamed from: a */
        public static C4148l m13113a(int i) {
            if (i == 0) {
                return UNKNOWN;
            }
            if (i == 1) {
    ...
    public enum C4150n implements C5194z.C5197c {
        NOCLICK(0),
        CTABUTTON(1),
        COMPANION(2),
        VIDEOVIEW(3),
        ...
        /* renamed from: a */
        public static C4150n m13115a(int i) {
            if (i == 0) {
                return NOCLICK;
            }
            if (i == 1) {
    ...
    public static TokenParametersOuterClass$TokenParameters parseFrom(byte[] bArr, C5147q qVar) throws C5061a0 {
    ...
    public static TokenParametersOuterClass$TokenParameters parseFrom(InputStream inputStream, C5147q qVar) throws IOException {
        return (TokenParametersOuterClass$TokenParameters) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, inputStream, qVar);
    }

    public static TokenParametersOuterClass$TokenParameters parseFrom(C5114j jVar) throws IOException {
        return (TokenParametersOuterClass$TokenParameters) GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, jVar);
    }

    public static TokenParametersOuterClass$TokenParameters parseFrom(C5114j jVar, C5147q qVar) throws IOException {
