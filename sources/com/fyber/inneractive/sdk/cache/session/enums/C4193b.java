...
public enum C4193b {
    ...
    /* renamed from: a */
    public UnitDisplayType f10319a;

    /* renamed from: b */
    public boolean f10320b;

    /* renamed from: com.fyber.inneractive.sdk.cache.session.enums.b$a */
    public static /* synthetic */ class C4194a {

        /* renamed from: a */
        public static final /* synthetic */ int[] f10321a = null;
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.fyber.inneractive.sdk.cache.session.enums.C4193b.C4194a.<clinit>():void");
        }
    }

    /* access modifiers changed from: public */
    C4193b(UnitDisplayType unitDisplayType, boolean z) {
        this.f10319a = unitDisplayType;
        this.f10320b = z;
    }

    /* renamed from: a */
    public static C4193b m13172a(String str, String str2) {
        int i = C4194a.f10321a[UnitDisplayType.fromValue(str).ordinal()];
        if (i == 1) {
