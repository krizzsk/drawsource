...
public abstract class C4372q<EventsListenerT extends InneractiveContentController.EventsListener> implements InneractiveContentController<EventsListenerT> {
    ...
    public InneractiveAdSpot getAdSpot() {
        return (InneractiveAdSpot) C5312s.m16531a(this.mAdSpot);
    }
