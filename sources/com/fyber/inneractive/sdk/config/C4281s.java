...
public class C4281s implements Runnable {

    /* renamed from: a */
    public final /* synthetic */ Context f10538a;

    /* renamed from: b */
    public final /* synthetic */ C4282t f10539b;

    public C4281s(Context context, C4282t tVar) {
    ...
    public void run() {
        /*
            ...
            android.content.Context r1 = r5.f10538a     // Catch:{ ClassNotFoundException -> 0x0040 }
            com.fyber.inneractive.sdk.config.t r2 = r5.f10539b     // Catch:{ ClassNotFoundException -> 0x0040 }
            com.fyber.inneractive.sdk.config.C4283u.m13313a(r1, r2)     // Catch:{ ClassNotFoundException -> 0x0040 }
            java.lang.String r1 = com.fyber.inneractive.sdk.config.C4257k.m13293a()
            boolean r1 = android.text.TextUtils.isEmpty(r1)
            if (r1 == 0) goto L_0x003f
            android.content.Context r1 = r5.f10538a
            com.fyber.inneractive.sdk.config.t r2 = r5.f10539b
        ...
        L_0x0029:
            ...
            com.fyber.inneractive.sdk.config.k r2 = (com.fyber.inneractive.sdk.config.C4257k) r2     // Catch:{ SettingNotFoundException -> 0x003f }
            monitor-enter(r2)     // Catch:{ SettingNotFoundException -> 0x003f }
            com.fyber.inneractive.sdk.config.k$c r3 = r2.f10466b     // Catch:{ all -> 0x003c }
            r3.f10468a = r1     // Catch:{ all -> 0x003c }
            r3.f10469b = r0     // Catch:{ all -> 0x003c }
            r3.f10470c = r4     // Catch:{ all -> 0x003c }
        ...
        L_0x0040:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fyber.inneractive.sdk.config.C4281s.run():void");
    }
}
