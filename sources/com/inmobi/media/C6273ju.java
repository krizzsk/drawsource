...
/* renamed from: com.inmobi.media.ju */
/* compiled from: UnifiedIDUtils */
public final class C6273ju {
    ...
    public static boolean m18661a(org.json.JSONObject r9) {
        /*
        ...
        L_0x003b:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.inmobi.media.C6273ju.m18661a(org.json.JSONObject):boolean");
    }

    /* renamed from: b */
    public static boolean m18663b(JSONObject jSONObject) {
        if (jSONObject == null) {
            return true;
        }
    ...
    public static C5872cl m18658a() {
        ...
        if (a != null) {
            try {
                if (a.has("ufids")) {
                    ...
                    if (z2) {
                        InMobiUnifiedIdService.m18959a((InMobiUnifiedIdInterface) null);
                    }
                    z = z3;
                }
        ...
        return new C5872cl(jSONArray2.toString(), z);
    }

    /* renamed from: b */
    public static boolean m18662b() {
    ...
    /* renamed from: c */
    public static boolean m18665c() {
        C6246jf.m18571a();
        boolean z = !C6246jf.m18574f().enabled;
        if (z) {
            InMobiUnifiedIdService.reset();
        }
        return z;
    ...
    /* renamed from: a */
    public static void m18660a(final InMobiUnifiedIdInterface inMobiUnifiedIdInterface, final JSONObject jSONObject, final Error error) {
        byte a = m18657a(error);
        if (a >= 0) {
            HashMap hashMap = new HashMap();
            hashMap.put(IronSourceConstants.EVENTS_ERROR_CODE, Byte.valueOf(a));
            C6168hl.m18270a().mo35377a("FetchCallbackFailure ", (Map<String, Object>) hashMap);
        }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static byte m18657a(java.lang.Error r4) {
        /*
            r0 = -1
        ...
        L_0x0037:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.inmobi.media.C6273ju.m18657a(java.lang.Error):byte");
    }

    /* renamed from: d */
    public static JSONArray m18666d() {
    ...
    /* renamed from: c */
    public static JSONObject m18664c(JSONObject jSONObject) {
        JSONObject jSONObject2 = new JSONObject();
        JSONArray jSONArray = new JSONArray();
        if (jSONObject != null) {
            try {
    ...
    /* renamed from: a */
    public static JSONObject m18659a(JSONObject jSONObject, JSONObject jSONObject2) {
        JSONArray jSONArray;
