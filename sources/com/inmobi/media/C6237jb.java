...
public final class C6237jb {

    /* renamed from: a */
    private static final String f15715a = C6237jb.class.getSimpleName();

    /* renamed from: a */
    public static boolean m18541a(Context context) {
        ...
        List<String> asList = Arrays.asList(new String[]{C6165hi.m18258a("carb_store"), C6165hi.m18258a("aes_key_store"), C6165hi.m18258a("mraid_js_store"), C6165hi.m18258a("omid_js_store"), C6165hi.m18258a("user_info_store"), C6165hi.m18258a("coppa_store"), C6165hi.m18258a("gesture_info_store"), C6165hi.m18258a("unified_id_info_store"), C6165hi.m18258a("app_bundle_store")});
    ...
    /* renamed from: a */
    private static boolean m18542a(Context context, String str) {
        File databasePath = context.getDatabasePath(str);
        return databasePath == null || !databasePath.exists() || context.deleteDatabase(str);
    }

    /* renamed from: b */
    public static List<String> m18543b(Context context) {
        ...
        if (databaseList != null && databaseList.length > 0) {
            for (String str : databaseList) {
                if (hashSet.contains(str) && !m18542a(context, str)) {
                    arrayList.add(str);
                } else if (str.matches("com\\.im_([0-9]+\\.){3}db") && !str.equals(C6163hg.f15558a) && !m18542a(context, str)) {
                    arrayList.add(str);
                }
            }
        }
    ...
    /* renamed from: a */
    public static void m18540a(File file) {
        try {
            if (file.exists()) {
    ...
    /* renamed from: a */
    public static long m18539a(String str) {
        try {
