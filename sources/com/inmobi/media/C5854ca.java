...
import com.inmobi.media.C5937dp;
...
public class C5854ca {

    /* renamed from: m */
    private static final String f14747m = C5854ca.class.getSimpleName();
    ...
    /* renamed from: d */
    public C5849by f14751d;

    /* renamed from: e */
    public JSONArray f14752e;

    /* renamed from: f */
    public C5854ca f14753f;

    /* renamed from: g */
    public Map<String, String> f14754g;

    /* renamed from: h */
    public C5949dv f14755h;

    /* renamed from: i */
    public C5855a f14756i;

    /* renamed from: j */
    public boolean f14757j;

    /* renamed from: k */
    public C5871ck f14758k;

    /* renamed from: l */
    HashMap<String, String> f14759l;

    /* renamed from: n */
    private JSONObject f14760n;

    /* renamed from: o */
    private JSONObject f14761o;

    /* renamed from: p */
    private Map<String, List<C5847bw>> f14762p;

    /* renamed from: q */
    private Map<String, C5847bw> f14763q;

    /* renamed from: r */
    private Map<String, String> f14764r;

    /* renamed from: s */
    private C6074ft f14765s;
    ...
    /* renamed from: com.inmobi.media.ca$a */
    /* compiled from: NativeDataModel */
    public class C5855a {

        /* renamed from: a */
        public JSONObject f14768a;

        /* renamed from: b */
        public C5856a f14769b = new C5856a();

        /* renamed from: c */
        public C5847bw f14770c;

        public C5855a() {
        }

        /* renamed from: com.inmobi.media.ca$a$a */
        /* compiled from: NativeDataModel */
        public class C5856a {
    ...
    public C5854ca(int i, JSONObject jSONObject, C6074ft ftVar, HashMap<String, String> hashMap, C5949dv dvVar) {
        this(i, jSONObject, (C5854ca) null, false, ftVar, hashMap, dvVar);
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public C5854ca(int i, JSONObject jSONObject, C5854ca caVar, boolean z, C6074ft ftVar) {
        this(i, jSONObject, caVar, z, ftVar, caVar == null ? null : caVar.f14759l, (C5949dv) null);
    }

    private C5854ca(int i, JSONObject jSONObject, C5854ca caVar, boolean z, C6074ft ftVar, HashMap<String, String> hashMap, C5949dv dvVar) {
        this.f14766t = i;
        this.f14753f = caVar;
        this.f14765s = ftVar;
        ...
        this.f14749b = false;
        this.f14755h = dvVar;
        this.f14763q = new HashMap();
        this.f14764r = new HashMap();
        this.f14762p = new HashMap();
        this.f14756i = new C5855a();
        this.f14767u = z;
        this.f14759l = hashMap;
        m17455i();
    }

    /* renamed from: a */
    public final HashMap<String, String> mo34843a() {
        HashMap<String, String> hashMap = this.f14759l;
        return hashMap == null ? new HashMap<>() : hashMap;
    }

    /* renamed from: b */
    public final JSONObject mo34845b() {
        try {
            return this.f14752e.getJSONObject(0);
    ...
    /* renamed from: f */
    private C5849by m17445f() {
        Iterator<C5847bw> it = this.f14751d.iterator();
        while (it.hasNext()) {
            C5847bw next = it.next();
            if (next.f14706d.equalsIgnoreCase("card_scrollable")) {
                return (C5849by) next;
            }
        }
        return null;
    ...
    /* renamed from: c */
    public final int mo34846c() {
        C5849by byVar = this.f14751d;
        if (byVar == null) {
            return 0;
        }
    ...
    /* renamed from: a */
    public final C5849by mo34842a(int i) {
        Iterator<C5847bw> it = this.f14751d.iterator();
        while (it.hasNext()) {
            C5847bw next = it.next();
            if (next.f14706d.equalsIgnoreCase("card_scrollable")) {
                C5849by byVar = (C5849by) next;
                if (i >= byVar.f14741C) {
                    return null;
                }
                return (C5849by) byVar.mo34834a(i);
            }
        }
        return null;
    }
    ...
    /* renamed from: a */
    public static C5849by m17427a(C5847bw bwVar) {
        if (bwVar instanceof C5849by) {
            C5849by byVar = (C5849by) bwVar;
            if (m17433a(byVar)) {
                return byVar;
            }
        }
        for (C5849by byVar2 = (C5849by) bwVar.f14722t; byVar2 != null; byVar2 = (C5849by) byVar2.f14722t) {
            if (m17433a(byVar2)) {
                return byVar2;
            }
        }
    ...
    /* renamed from: g */
    private void m17450g() {
        C5847bw a;
        List<C5937dp.C5938a> list;
        for (C5847bw next : mo34847c(ShareConstants.IMAGE_URL)) {
            if (!URLUtil.isValidUrl((String) next.f14707e) && (a = m17424a(this, next)) != null) {
                if (a.f14704b.equals(next.f14704b)) {
                    next.f14707e = a.f14707e;
                } else if (ShareConstants.VIDEO_URL.equals(a.f14704b) && 1 != a.f14715m && 2 == a.f14715m) {
                    C5869cj cjVar = (C5869cj) a;
                    C5950dw b = cjVar.mo34867b();
                    C5937dp a2 = C5936do.m17630a(cjVar, next);
                    C5937dp.C5938a aVar = null;
                    if (a2 == null) {
                        list = null;
                    } else {
                        list = a2.mo35045a(1);
                    ...
                    if (list != null) {
                        Iterator<C5937dp.C5938a> it = list.iterator();
                        while (true) {
                            if (!it.hasNext()) {
                                break;
                            }
                            C5937dp.C5938a next2 = it.next();
                            if (URLUtil.isValidUrl(next2.f15038b)) {
                                aVar = next2;
                                break;
                            }
                        }
                    ...
                    if (a2 != null && aVar != null) {
                        b.mo35060a(a2);
                        next.f14707e = aVar.f15038b;
                        next.mo34825a(a2.mo35046a("creativeView"));
                        for (C5868ci next3 : cjVar.f14723u) {
                            if ("error".equals(next3.f14815d)) {
                                next.f14723u.add(next3);
                            }
                        }
                    } else if (b.mo35064e().size() > 0) {
                        m17432a(cjVar);
                    }
                }
            }
    ...
    private void m17453h() {
        /*
            r12 = this;
            java.lang.String r0 = "WEBVIEW"
            java.util.List r0 = r12.mo34847c((java.lang.String) r0)
            java.util.Iterator r0 = r0.iterator()
        L_0x000a:
            boolean r1 = r0.hasNext()
            if (r1 == 0) goto L_0x0110
            java.lang.Object r1 = r0.next()
            com.inmobi.media.bw r1 = (com.inmobi.media.C5847bw) r1
            r2 = r1
            com.inmobi.media.ck r2 = (com.inmobi.media.C5871ck) r2
            java.lang.String r3 = r2.f14829z
            ...
            boolean r3 = r4.equals(r3)
            if (r3 != 0) goto L_0x000a
            com.inmobi.media.bw r3 = m17424a((com.inmobi.media.C5854ca) r12, (com.inmobi.media.C5847bw) r1)
            if (r3 == 0) goto L_0x000a
            java.lang.String r4 = r3.f14704b
            java.lang.String r5 = r1.f14704b
            boolean r4 = r4.equals(r5)
            if (r4 == 0) goto L_0x0042
            java.lang.Object r2 = r3.f14707e
            r1.f14707e = r2
            goto L_0x000a
        L_0x0042:
            java.lang.String r4 = r3.f14704b
            ...
            com.inmobi.media.cj r3 = (com.inmobi.media.C5869cj) r3
            com.inmobi.media.dw r4 = r3.mo34867b()
            com.inmobi.media.dp r6 = com.inmobi.media.C5936do.m17630a(r3, r1)
            java.lang.String r7 = "REF_HTML"
            java.lang.String r8 = "REF_IFRAME"
            if (r6 == 0) goto L_0x00d1
            java.lang.String r9 = r2.f14829z
            boolean r9 = r7.equals(r9)
            r10 = 3
            r11 = 0
            if (r9 == 0) goto L_0x0099
            java.util.List r5 = r6.mo35045a((int) r5)
            int r9 = r5.size()
            if (r9 <= 0) goto L_0x007e
            java.lang.Object r5 = r5.get(r11)
            com.inmobi.media.dp$a r5 = (com.inmobi.media.C5937dp.C5938a) r5
            java.lang.String r5 = r5.f15038b
            goto L_0x00d2
        L_0x007e:
            java.util.List r5 = r6.mo35045a((int) r10)
            int r9 = r5.size()
        ...
        L_0x0099:
            ...
            if (r9 == 0) goto L_0x00d1
            java.util.List r9 = r6.mo35045a((int) r10)
            int r10 = r9.size()
        ...
        L_0x00ed:
            ...
            java.util.List r2 = r6.mo35046a((java.lang.String) r2)
            r1.mo34825a((java.util.List<com.inmobi.media.C5868ci>) r2)
            goto L_0x000a
        L_0x00fd:
            java.util.List r1 = r4.mo35064e()
            int r1 = r1.size()
            if (r1 <= 0) goto L_0x010a
            m17432a((com.inmobi.media.C5869cj) r3)
        L_0x010a:
        ...
        L_0x0110:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.inmobi.media.C5854ca.m17453h():void");
    }
    ...
    private void m17455i() {
        /*
            ...
            org.json.JSONObject r10 = r1.f14760n     // Catch:{ JSONException -> 0x02ab }
            java.lang.String r11 = "styleRefs"
            org.json.JSONObject r10 = r10.optJSONObject(r11)     // Catch:{ JSONException -> 0x02ab }
            r1.f14761o = r10     // Catch:{ JSONException -> 0x02ab }
            org.json.JSONObject r10 = r1.f14760n     // Catch:{ JSONException -> 0x02ab }
        ...
        L_0x0077:
            ...
            com.inmobi.media.bw r9 = r1.m17425a((org.json.JSONObject) r9, (java.lang.String) r10, (java.lang.String) r11)     // Catch:{ JSONException -> 0x02ab }
            com.inmobi.media.by r9 = (com.inmobi.media.C5849by) r9     // Catch:{ JSONException -> 0x02ab }
            r1.f14751d = r9     // Catch:{ JSONException -> 0x02ab }
            org.json.JSONObject r9 = r1.f14760n     // Catch:{ JSONException -> 0x0180 }
            boolean r9 = r9.isNull(r8)     // Catch:{ JSONException -> 0x0180 }
            if (r9 != 0) goto L_0x00b3
            com.inmobi.media.ca$a r9 = r1.f14756i     // Catch:{ JSONException -> 0x0180 }
            org.json.JSONObject r10 = r1.f14760n     // Catch:{ JSONException -> 0x0180 }
            org.json.JSONObject r8 = r10.getJSONObject(r8)     // Catch:{ JSONException -> 0x0180 }
            r9.f14768a = r8     // Catch:{ JSONException -> 0x0180 }
        L_0x00b3:
            org.json.JSONObject r8 = r1.f14760n     // Catch:{ JSONException -> 0x0180 }
            ...
            com.inmobi.media.ca$a$a r8 = new com.inmobi.media.ca$a$a     // Catch:{ JSONException -> 0x0180 }
            com.inmobi.media.ca$a r9 = r1.f14756i     // Catch:{ JSONException -> 0x0180 }
            ...
            r8.f14772a = r9     // Catch:{ JSONException -> 0x0180 }
            java.lang.String r9 = "description"
            java.lang.String r9 = r7.optString(r9, r10)     // Catch:{ JSONException -> 0x0180 }
            r8.f14773b = r9     // Catch:{ JSONException -> 0x0180 }
            java.lang.String r9 = "ctaText"
            java.lang.String r9 = r7.optString(r9, r10)     // Catch:{ JSONException -> 0x0180 }
            r8.f14775d = r9     // Catch:{ JSONException -> 0x0180 }
            java.lang.String r9 = "iconUrl"
            java.lang.String r9 = r7.optString(r9, r10)     // Catch:{ JSONException -> 0x0180 }
            r8.f14774c = r9     // Catch:{ JSONException -> 0x0180 }
            ...
            r8.f14776e = r9     // Catch:{ JSONException -> 0x0180 }
            java.lang.String r9 = "landingPageUrl"
            java.lang.String r9 = r7.optString(r9, r10)     // Catch:{ JSONException -> 0x0180 }
            r8.f14777f = r9     // Catch:{ JSONException -> 0x0180 }
            java.lang.String r9 = "isApp"
            boolean r7 = r7.optBoolean(r9)     // Catch:{ JSONException -> 0x0180 }
            r8.f14778g = r7     // Catch:{ JSONException -> 0x0180 }
            com.inmobi.media.ca$a r7 = r1.f14756i     // Catch:{ JSONException -> 0x0180 }
            r7.f14769b = r8     // Catch:{ JSONException -> 0x0180 }
        L_0x010d:
            com.inmobi.media.bw r7 = new com.inmobi.media.bw     // Catch:{ JSONException -> 0x0180 }
        ...
        L_0x0130:
            ...
            r8 = 1
        L_0x013b:
            r7.mo34822a((java.lang.String) r5)     // Catch:{ JSONException -> 0x0151 }
            java.lang.String r2 = r6.optString(r0)     // Catch:{ JSONException -> 0x0151 }
            r7.mo34826b(r2)     // Catch:{ JSONException -> 0x0151 }
            r7.f14712j = r9     // Catch:{ JSONException -> 0x0151 }
            r7.f14710h = r8     // Catch:{ JSONException -> 0x0151 }
            java.lang.String r2 = "appBundleId"
            java.lang.String r2 = r6.optString(r2)     // Catch:{ JSONException -> 0x0151 }
            r7.f14725w = r2     // Catch:{ JSONException -> 0x0151 }
        L_0x0151:
            boolean r2 = r6.isNull(r4)     // Catch:{ JSONException -> 0x0180 }
            if (r2 != 0) goto L_0x0168
            java.lang.String r2 = r6.getString(r4)     // Catch:{ JSONException -> 0x0180 }
            byte r2 = m17441d((java.lang.String) r2)     // Catch:{ JSONException -> 0x0180 }
            r7.f14711i = r2     // Catch:{ JSONException -> 0x0180 }
            java.lang.String r0 = r6.optString(r0)     // Catch:{ JSONException -> 0x0180 }
            r7.mo34826b(r0)     // Catch:{ JSONException -> 0x0180 }
        L_0x0168:
            org.json.JSONObject r0 = r1.f14760n     // Catch:{ JSONException -> 0x0180 }
            java.lang.String r2 = "trackers"
            boolean r0 = r0.isNull(r2)     // Catch:{ JSONException -> 0x0180 }
            if (r0 != 0) goto L_0x017b
            org.json.JSONObject r0 = r1.f14760n     // Catch:{ JSONException -> 0x0180 }
            java.util.List r0 = m17438b((org.json.JSONObject) r0)     // Catch:{ JSONException -> 0x0180 }
            r7.mo34825a((java.util.List<com.inmobi.media.C5868ci>) r0)     // Catch:{ JSONException -> 0x0180 }
        L_0x017b:
            com.inmobi.media.ca$a r0 = r1.f14756i     // Catch:{ JSONException -> 0x0180 }
            r0.f14770c = r7     // Catch:{ JSONException -> 0x0180 }
            goto L_0x018d
        L_0x0180:
            r0 = move-exception
            com.inmobi.media.gj r2 = com.inmobi.media.C6130gj.m18161a()     // Catch:{ JSONException -> 0x02ab }
            com.inmobi.media.hk r4 = new com.inmobi.media.hk     // Catch:{ JSONException -> 0x02ab }
            r4.<init>(r0)     // Catch:{ JSONException -> 0x02ab }
            r2.mo35310a((com.inmobi.media.C6167hk) r4)     // Catch:{ JSONException -> 0x02ab }
        L_0x018d:
            r1.f14750c = r14     // Catch:{ JSONException -> 0x02ab }
            org.json.JSONObject r0 = r1.f14760n     // Catch:{ JSONException -> 0x02ab }
            ...
            r1.f14754g = r0     // Catch:{ JSONException -> 0x02ab }
        L_0x01a0:
            org.json.JSONObject r0 = r1.f14760n     // Catch:{ JSONException -> 0x02ab }
            java.util.Map r0 = com.inmobi.media.C5783aw.m17155b((org.json.JSONObject) r0)     // Catch:{ JSONException -> 0x02ab }
            if (r0 == 0) goto L_0x01ad
            java.util.Map<java.lang.String, java.lang.String> r2 = r1.f14754g     // Catch:{ JSONException -> 0x02ab }
            r2.putAll(r0)     // Catch:{ JSONException -> 0x02ab }
        L_0x01ad:
            r16.m17450g()     // Catch:{ JSONException -> 0x02ab }
            r16.m17453h()     // Catch:{ JSONException -> 0x02ab }
            java.util.Map<java.lang.String, java.lang.String> r0 = r1.f14764r     // Catch:{ JSONException -> 0x02ab }
        ...
        L_0x01bd:
            ...
            java.util.Map<java.lang.String, com.inmobi.media.bw> r5 = r1.f14763q     // Catch:{ JSONException -> 0x02ab }
            java.lang.Object r0 = r0.getKey()     // Catch:{ JSONException -> 0x02ab }
            java.lang.Object r0 = r5.get(r0)     // Catch:{ JSONException -> 0x02ab }
            r5 = r0
            com.inmobi.media.bw r5 = (com.inmobi.media.C5847bw) r5     // Catch:{ JSONException -> 0x02ab }
            if (r5 == 0) goto L_0x028d
            byte r0 = r5.f14716n     // Catch:{ JSONException -> 0x02ab }
            r6 = 4
            if (r6 != r0) goto L_0x028d
            int r0 = r5.f14717o     // Catch:{ JSONException -> 0x02ab }
            r7 = -1
            if (r0 != r7) goto L_0x01f1
            int r0 = r5.f14718p     // Catch:{ JSONException -> 0x02ab }
        ...
        L_0x01ed:
            ...
            goto L_0x01bd
        L_0x01f1:
            java.util.Map<java.lang.String, com.inmobi.media.bw> r0 = r1.f14763q     // Catch:{ JSONException -> 0x02ab }
            java.lang.Object r0 = r0.get(r4)     // Catch:{ JSONException -> 0x02ab }
            r4 = r0
            com.inmobi.media.bw r4 = (com.inmobi.media.C5847bw) r4     // Catch:{ JSONException -> 0x02ab }
            if (r4 == 0) goto L_0x028d
            java.lang.String r0 = "VIDEO"
            java.lang.String r7 = r4.f14704b     // Catch:{ JSONException -> 0x02ab }
            boolean r0 = r0.equals(r7)     // Catch:{ JSONException -> 0x02ab }
            if (r0 == 0) goto L_0x028d
            r0 = r4
            com.inmobi.media.cj r0 = (com.inmobi.media.C5869cj) r0     // Catch:{ JSONException -> 0x02ab }
            com.inmobi.media.dw r0 = r0.mo34867b()     // Catch:{ JSONException -> 0x02ab }
            com.inmobi.media.dv r0 = (com.inmobi.media.C5949dv) r0     // Catch:{ JSONException -> 0x02ab }
            java.lang.String r0 = r0.f15077b     // Catch:{ JSONException -> 0x02ab }
            java.lang.String r7 = ":"
        ...
        L_0x022b:
            ...
            r9 = 2
        L_0x022d:
            com.inmobi.media.gj r8 = com.inmobi.media.C6130gj.m18161a()     // Catch:{ JSONException -> 0x02ab }
            com.inmobi.media.hk r10 = new com.inmobi.media.hk     // Catch:{ JSONException -> 0x02ab }
            r10.<init>(r0)     // Catch:{ JSONException -> 0x02ab }
            r8.mo35310a((com.inmobi.media.C6167hk) r10)     // Catch:{ JSONException -> 0x02ab }
            r8 = r14
        L_0x023a:
            if (r8 != 0) goto L_0x0240
            r5.f14717o = r14     // Catch:{ JSONException -> 0x02ab }
            r13 = -1
            goto L_0x0284
        L_0x0240:
            int r0 = r5.f14717o     // Catch:{ JSONException -> 0x02ab }
            ...
            int r0 = r8 / 4
            r5.f14717o = r0     // Catch:{ JSONException -> 0x02ab }
            goto L_0x0265
        L_0x0258:
            r5.f14717o = r8     // Catch:{ JSONException -> 0x02ab }
            goto L_0x0265
        L_0x025b:
            int r0 = r8 * 3
            int r0 = r0 / r6
        ...
        L_0x0265:
            ...
            int r8 = r8 / 4
            r5.f14718p = r8     // Catch:{ JSONException -> 0x02ab }
            goto L_0x0284
        L_0x0277:
            r5.f14718p = r8     // Catch:{ JSONException -> 0x02ab }
            goto L_0x0284
        ...
        L_0x0280:
            ...
            r5.f14718p = r8     // Catch:{ JSONException -> 0x02ab }
        L_0x0284:
            com.inmobi.media.cj r4 = (com.inmobi.media.C5869cj) r4     // Catch:{ JSONException -> 0x02ab }
            java.util.List<com.inmobi.media.bw> r0 = r4.f14826z     // Catch:{ JSONException -> 0x02ab }
        ...
        L_0x0292:
            ...
            r0.<init>()     // Catch:{ JSONException -> 0x02ab }
            r1.f14752e = r0     // Catch:{ JSONException -> 0x02ab }
            return
        L_0x02a2:
            org.json.JSONObject r0 = r1.f14760n     // Catch:{ JSONException -> 0x02ab }
        ...
        L_0x02ab:
            r0 = move-exception
            com.inmobi.media.gj r2 = com.inmobi.media.C6130gj.m18161a()
            com.inmobi.media.hk r3 = new com.inmobi.media.hk
            r3.<init>(r0)
            r2.mo35310a((com.inmobi.media.C6167hk) r3)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.inmobi.media.C5854ca.m17455i():void");
    }

    /* JADX WARNING: Removed duplicated region for block: B:16:0x003f A[ADDED_TO_REGION] */
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static byte m17421a(java.lang.String r5) {
        /*
        ...
        L_0x0046:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.inmobi.media.C5854ca.m17421a(java.lang.String):byte");
    }

    /* renamed from: d */
    public final boolean mo34848d() {
    ...
    /* renamed from: j */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private boolean m17457j() {
        /*
            r5 = this;
            java.lang.String r0 = "VIDEO"
            java.util.List r0 = r5.mo34847c((java.lang.String) r0)
            r1 = 1
        ...
        L_0x0014:
            ...
            com.inmobi.media.bw r2 = (com.inmobi.media.C5847bw) r2
            java.lang.String r3 = r2.f14703a
            r3.length()
            com.inmobi.media.cj r2 = (com.inmobi.media.C5869cj) r2
            com.inmobi.media.dw r3 = r2.mo34867b()
            r4 = 0
            if (r3 != 0) goto L_0x002f
            return r4
        L_0x002f:
            com.inmobi.media.dw r3 = r2.mo34867b()
            java.util.List r3 = r3.mo35062c()
        ...
        L_0x0040:
            com.inmobi.media.dw r3 = r2.mo34867b()
            java.lang.String r3 = r3.mo35061b()
        ...
        L_0x0062:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.inmobi.media.C5854ca.m17457j():boolean");
    }

    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r21v0, resolved type: com.inmobi.media.by} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r21v1, resolved type: com.inmobi.media.by} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v15, resolved type: com.inmobi.media.by} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v18, resolved type: com.inmobi.media.by} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v25, resolved type: com.inmobi.media.cg} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r21v2, resolved type: com.inmobi.media.by} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v38, resolved type: com.inmobi.media.ck} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r21v3, resolved type: com.inmobi.media.by} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v40, resolved type: com.inmobi.media.cj} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v45, resolved type: com.inmobi.media.by} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v46, resolved type: com.inmobi.media.by} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v47, resolved type: com.inmobi.media.by} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v42, resolved type: com.inmobi.media.bz} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r21v4, resolved type: com.inmobi.media.by} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r21v5, resolved type: com.inmobi.media.by} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v89, resolved type: com.inmobi.media.by} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v90, resolved type: com.inmobi.media.by} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v92, resolved type: com.inmobi.media.cj} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r8v34, resolved type: com.inmobi.media.bz} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r8v35, resolved type: com.inmobi.media.bz} */
    /* JADX WARNING: type inference failed for: r2v21, types: [com.inmobi.media.bw, com.inmobi.media.ce] */
    /* JADX WARNING: type inference failed for: r1v20, types: [com.inmobi.media.bw, com.inmobi.media.cc] */
    /* JADX WARNING: type inference failed for: r0v48, types: [com.inmobi.media.bw] */
    /* JADX WARNING: type inference failed for: r2v55, types: [com.inmobi.media.bw] */
    /* JADX WARNING: type inference failed for: r2v57 */
    /* JADX WARNING: type inference failed for: r2v58, types: [com.inmobi.media.bw] */
    /* JADX WARNING: type inference failed for: r6v88, types: [com.inmobi.media.bw] */
    /* JADX WARNING: type inference failed for: r6v89, types: [com.inmobi.media.bw] */
    /* JADX WARNING: type inference failed for: r8v30, types: [com.inmobi.media.cb] */
    /* JADX WARNING: type inference failed for: r8v31, types: [com.inmobi.media.cd] */
    /* JADX WARNING: type inference failed for: r8v32, types: [com.inmobi.media.cb] */
    /* JADX WARNING: type inference failed for: r8v33, types: [com.inmobi.media.cd] */
    /* JADX WARNING: type inference failed for: r2v61 */
    /* JADX WARNING: Can't fix incorrect switch cases order */
    /* JADX WARNING: Code restructure failed: missing block: B:100:?, code lost:
        r1 = m17441d(r15.getJSONObject("assetOnclick").getString("openMode"));
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:113:?, code lost:
        r8 = new com.inmobi.media.C5851bz(r12, r10, r0, r27, r18, r14, r47);
        r15 = r1;
        r8 = r8;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:114:0x01d5, code lost:
        ...
        r6 = r24;
        r7 = r25;
        r8 = new com.inmobi.media.C5851bz(r4, r10, r0, r27, r1, r47);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:115:0x01eb, code lost:
        r3.f14709g = r5;
        m17431a((com.inmobi.media.C5847bw) r3, r15);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:131:?, code lost:
        r1.f14762p.get(r28);
        r33 = new com.inmobi.media.C5869cj.C5870a(r2.x, r2.y, r3.x, r3.y, r4.x, r4.y, r5.x, r5.y, m17466s(r8));
     */
    /* JADX WARNING: Code restructure failed: missing block: B:132:0x026a, code lost:
        if (r1.f14755h != null) goto L_0x027f;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:133:0x026c, code lost:
        r2 = r26;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:135:?, code lost:
        r0 = m17429a(r15, r27, (com.inmobi.media.C5847bw) r2);
        r2 = r2;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:147:0x02a8, code lost:
        if (((java.lang.Boolean) r2.f14724v.get("didRequestFullScreen")).booleanValue() != false) goto L_0x02bd;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:149:0x02ac, code lost:
        if (r1.f14767u == false) goto L_0x02af;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:171:0x0393, code lost:
        r8 = r8;
        r20 = r1.f14765s.rendering.enablePubMuteControl;
        r1 = r10;
        r26 = r13;
        r27 = r2;
        r23 = r3;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:173:?, code lost:
        r8 = new com.inmobi.media.C5869cj(r13, r17, r33, r12, r16, r14, r4, r5, r6, r18, r47, r20);
        r2.f14824G = new java.util.HashMap(r1);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:191:0x03f9, code lost:
        r9 = com.inmobi.media.C5871ck.m17491c(m17452h(r47));
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:198:?, code lost:
        r1 = new com.inmobi.media.C5871ck(r26, r17, m17426a(r2, r10, r4, r5, r8), r0, r15.optBoolean("isScrollable"));
        r1.f14829z = r9;
        r1.f14709g = r12;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:214:0x0485, code lost:
        r2 = m17441d(r15.getJSONObject("assetOnclick").getString("openMode"));
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:231:?, code lost:
        r8 = new com.inmobi.media.C5859cd(r26, r17, r1, m17440c(r47), r18, r14, r47);
        r8 = r8;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:232:0x04cc, code lost:
        ...
        r2 = r13;
        r5 = r15;
        r8 = new com.inmobi.media.C5857cb(r26, r17, r1, m17440c(r47), r18, r14, r47);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:235:0x04f0, code lost:
        r8 = new com.inmobi.media.C5859cd(r26, r17, r1, m17440c(r47), r14, r47);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:236:0x0503, code lost:
        r8 = new com.inmobi.media.C5857cb(r26, r17, r1, m17440c(r47), r14, r47);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:237:0x0515, code lost:
        r0.f14709g = r4;
        m17431a((com.inmobi.media.C5847bw) r0, r5);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:252:0x055e, code lost:
        r1 = r15.m17464q(r9.getJSONObject("startOffset"));
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:256:0x0573, code lost:
        r2 = r15.m17464q(r9.getJSONObject("timerDuration"));
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:261:?, code lost:
        r1 = new com.inmobi.media.C5864cg(r13, r17, r0, new com.inmobi.media.C5862cf(r1, r2));
        r1.f14794z = r3;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:285:0x05f4, code lost:
        ...
        r15 = r46;
        r10 = r3;
        r1 = new com.inmobi.media.C5858cc(r13, r6, m17426a(r2, r3, r4, r5, r8), m17440c(r47));
        r1.f14709g = r49;
        r1 = r1;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:286:0x0619, code lost:
        ...
        r14 = r10;
        r10 = r3;
        r2 = new com.inmobi.media.C5860ce(r13, r14, m17437b(r2, r3, r4, r5, r8), r27);
        r2.f14709g = r49;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:329:?, code lost:
        r8 = new com.inmobi.media.C5849by(r26, r16, r1, r12, r13, r47, r5);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:334:?, code lost:
        r2 = r49;
        r1 = new com.inmobi.media.C5849by(r26, r16, r1, r2, r47, r5);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:338:0x072f, code lost:
        m17431a((com.inmobi.media.C5847bw) r1, r7);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:341:0x073f, code lost:
        ...
        r9 = m17447f(r8).toLowerCase(java.util.Locale.US).trim();
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:390:0x080a, code lost:
        if (r1.f14741C >= 16) goto L_0x082d;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:392:0x0811, code lost:
        if (r1.f14741C != r1.f14740B.length) goto L_0x0823;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:393:0x0813, code lost:
        r7 = new com.inmobi.media.C5847bw[(r1.f14740B.length * 2)];
        java.lang.System.arraycopy(r1.f14740B, r15, r7, r15, r1.f14741C);
        r1.f14740B = r7;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:93:0x017b, code lost:
        if (m17463p(r47) != false) goto L_0x017e;
     */
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private com.inmobi.media.C5847bw m17425a(org.json.JSONObject r47, java.lang.String r48, java.lang.String r49) {
        /*
            r46 = this;
            r7 = r46
            r15 = r47
            r14 = r48
            r13 = r49
            java.lang.String r12 = m17442d((org.json.JSONObject) r47)
            java.lang.String r10 = m17444e((org.json.JSONObject) r47)
            org.json.JSONObject r8 = r46.m17454i(r47)
            boolean r0 = m17435a((org.json.JSONObject) r8, (java.lang.String) r14)
            r21 = 0
            if (r0 != 0) goto L_0x001d
            return r21
        L_0x001d:
            android.graphics.Point r2 = r46.m17456j(r47)
            android.graphics.Point r4 = r7.m17423a((org.json.JSONObject) r15, (android.graphics.Point) r2)
            android.graphics.Point r3 = r46.m17458k(r47)
            android.graphics.Point r5 = r7.m17436b(r15, r3)
            java.util.List r18 = m17438b((org.json.JSONObject) r47)
            byte r11 = m17459l(r47)
            r9 = 1
            int r6 = m17422a((org.json.JSONObject) r15, (boolean) r9)
            r1 = 0
            int r9 = m17422a((org.json.JSONObject) r15, (boolean) r1)
            java.lang.String r1 = m17460m(r47)
            java.lang.String r0 = m17449g((org.json.JSONObject) r47)
        ...
        L_0x007b:
            r0 = 1
        L_0x007c:
            org.json.JSONArray r1 = m17462o(r47)
        ...
        L_0x0094:
            ...
            com.inmobi.media.bw r6 = r7.mo34844b((java.lang.String) r1)     // Catch:{ JSONException -> 0x00ae }
            if (r6 != 0) goto L_0x00ac
            com.inmobi.media.ca r0 = r7.f14753f     // Catch:{ JSONException -> 0x00a8 }
            if (r0 == 0) goto L_0x00ac
            com.inmobi.media.ca r0 = r7.f14753f     // Catch:{ JSONException -> 0x00a8 }
            com.inmobi.media.bw r6 = r0.mo34844b((java.lang.String) r1)     // Catch:{ JSONException -> 0x00a8 }
            goto L_0x00ac
        L_0x00a8:
            r0 = move-exception
            goto L_0x00b6
        ...
        L_0x00b2:
            ...
            r6 = r1
        L_0x00b6:
            com.inmobi.media.gj r13 = com.inmobi.media.C6130gj.m18161a()
            r24 = r1
            com.inmobi.media.hk r1 = new com.inmobi.media.hk
            r1.<init>(r0)
            r13.mo35310a((com.inmobi.media.C6167hk) r1)
            r0 = r24
            goto L_0x00ca
        L_0x00c7:
            r0 = r21
        ...
        L_0x0173:
            ...
            goto L_0x084f
        L_0x0177:
            boolean r0 = m17463p(r47)     // Catch:{ JSONException -> 0x020e }
        ...
        L_0x017e:
            ...
            r31 = r20
            r6 = r8
            com.inmobi.media.ce$a r0 = r1.m17439c(r2, r3, r4, r5, r6)     // Catch:{ JSONException -> 0x020a }
            ...
            byte r1 = m17441d((java.lang.String) r1)     // Catch:{ JSONException -> 0x01a0 }
            goto L_0x01a9
        L_0x01a0:
            r0 = move-exception
            r6 = r46
        ...
        L_0x01a9:
            ...
            goto L_0x01d5
        L_0x01ba:
            com.inmobi.media.bz r3 = new com.inmobi.media.bz     // Catch:{ JSONException -> 0x020a }
            r8 = r3
            r7 = r25
            r9 = r12
            r6 = r24
        ...
        L_0x01d5:
            ...
            r6 = r24
            r7 = r25
            com.inmobi.media.bz r3 = new com.inmobi.media.bz     // Catch:{ JSONException -> 0x0201 }
            r8 = r3
            r9 = r4
            r11 = r0
            r12 = r27
        ...
        L_0x01eb:
            r3.f14709g = r5     // Catch:{ JSONException -> 0x0201 }
            m17431a((com.inmobi.media.C5847bw) r3, (org.json.JSONObject) r15)     // Catch:{ JSONException -> 0x0201 }
            if (r2 == 0) goto L_0x01f5
            r3.mo34826b(r2)     // Catch:{ JSONException -> 0x0201 }
        L_0x01f5:
            r21 = r3
            r26 = r4
            r44 = r6
        ...
        L_0x0229:
            ...
            r7 = r25
            r12 = r28
            java.util.Map<java.lang.String, java.util.List<com.inmobi.media.bw>> r0 = r1.f14762p     // Catch:{ JSONException -> 0x03df }
            r0.get(r12)     // Catch:{ JSONException -> 0x03df }
            com.inmobi.media.cf r42 = r1.m17466s(r8)     // Catch:{ JSONException -> 0x03df }
            com.inmobi.media.cj$a r11 = new com.inmobi.media.cj$a     // Catch:{ JSONException -> 0x03df }
            ...
            com.inmobi.media.dv r0 = r1.f14755h     // Catch:{ JSONException -> 0x03df }
            if (r0 != 0) goto L_0x027f
            r2 = r26
            r0 = r27
            com.inmobi.media.dw r0 = r1.m17429a((org.json.JSONObject) r15, (java.lang.String) r0, (com.inmobi.media.C5847bw) r2)     // Catch:{ JSONException -> 0x0275 }
            goto L_0x0283
        L_0x0275:
            r0 = move-exception
            r44 = r6
        ...
        L_0x0283:
            r12 = r0
            int r0 = r1.f14766t     // Catch:{ JSONException -> 0x03df }
            ...
            if (r2 == 0) goto L_0x02f1
            java.util.Map<java.lang.String, java.lang.Object> r0 = r2.f14724v     // Catch:{ JSONException -> 0x02ed }
            ...
            boolean r0 = r1.f14767u     // Catch:{ JSONException -> 0x02ed }
        ...
        L_0x02bd:
            ...
            r8 = r2
            com.inmobi.media.cj r8 = (com.inmobi.media.C5869cj) r8     // Catch:{ JSONException -> 0x02ed }
            int r8 = r8.f14822E     // Catch:{ JSONException -> 0x02ed }
            r17 = r3
            r16 = r4
            r3 = 0
        ...
        L_0x036f:
            ...
            goto L_0x036f
        L_0x038b:
            com.inmobi.media.cj r14 = new com.inmobi.media.cj     // Catch:{ JSONException -> 0x03d8 }
            com.inmobi.media.ft r8 = r1.f14765s     // Catch:{ JSONException -> 0x03d8 }
            com.inmobi.media.ft$i r8 = r8.rendering     // Catch:{ JSONException -> 0x03d8 }
            ...
            r2.f14824G = r4     // Catch:{ JSONException -> 0x0453 }
            if (r0 > 0) goto L_0x03c0
            r7 = r22
            goto L_0x03c1
        L_0x03c0:
            r7 = r0
        L_0x03c1:
            r2.f14822E = r7     // Catch:{ JSONException -> 0x0453 }
            r2.f14709g = r3     // Catch:{ JSONException -> 0x0453 }
            r6 = r27
            r2.f14727y = r6     // Catch:{ JSONException -> 0x0453 }
            if (r6 == 0) goto L_0x03cd
            r6.f14727y = r2     // Catch:{ JSONException -> 0x0453 }
        L_0x03cd:
            if (r23 == 0) goto L_0x03d3
            r3 = r23
            r2.f14823F = r3     // Catch:{ JSONException -> 0x0453 }
        L_0x03d3:
            r6 = r46
            r1 = r2
            goto L_0x0223
        ...
        L_0x03e8:
            ...
            return r21
        L_0x03f9:
            java.lang.String r1 = m17452h((org.json.JSONObject) r47)     // Catch:{ JSONException -> 0x0453 }
            java.lang.String r9 = com.inmobi.media.C5871ck.m17491c(r1)     // Catch:{ JSONException -> 0x0453 }
        ...
        L_0x0410:
            ...
            r7 = r24
            r6 = r8
            com.inmobi.media.bx r4 = r1.m17426a(r2, r3, r4, r5, r6)     // Catch:{ JSONException -> 0x044d }
            com.inmobi.media.ck r8 = new com.inmobi.media.ck     // Catch:{ JSONException -> 0x044d }
            ...
            r8.f14829z = r9     // Catch:{ JSONException -> 0x044d }
            r8.f14709g = r12     // Catch:{ JSONException -> 0x044d }
            java.lang.String r0 = "preload"
            boolean r0 = r15.optBoolean(r0, r14)     // Catch:{ JSONException -> 0x044d }
            if (r0 == 0) goto L_0x0446
            r1 = 1
            r8.f14827A = r1     // Catch:{ JSONException -> 0x044d }
            r13.f14758k = r8     // Catch:{ JSONException -> 0x044d }
            r44 = r7
            r1 = r8
            r6 = r13
            goto L_0x0225
        ...
        L_0x0458:
            ...
            r10 = r6
            r6 = r8
            com.inmobi.media.bx r1 = r1.m17426a(r2, r3, r4, r5, r6)     // Catch:{ JSONException -> 0x0532 }
            boolean r2 = m17463p(r47)     // Catch:{ JSONException -> 0x0532 }
            ...
            byte r2 = m17441d((java.lang.String) r2)     // Catch:{ JSONException -> 0x049d }
            goto L_0x0493
        L_0x0492:
            r2 = 2
        L_0x0493:
        ...
        L_0x04ab:
            ...
            com.inmobi.media.cd r0 = new com.inmobi.media.cd     // Catch:{ JSONException -> 0x049d }
            java.lang.String r2 = m17440c((org.json.JSONObject) r47)     // Catch:{ JSONException -> 0x049d }
            r8 = r0
            r9 = r26
            r6 = r10
            r10 = r17
        ...
        L_0x04cc:
            ...
            r2 = r13
            r5 = r15
            com.inmobi.media.cb r0 = new com.inmobi.media.cb     // Catch:{ JSONException -> 0x052c }
            java.lang.String r12 = m17440c((org.json.JSONObject) r47)     // Catch:{ JSONException -> 0x052c }
            r8 = r0
            r9 = r26
            r10 = r17
            r11 = r1
        ...
        L_0x04e4:
            ...
            com.inmobi.media.cd r0 = new com.inmobi.media.cd     // Catch:{ JSONException -> 0x052c }
            java.lang.String r12 = m17440c((org.json.JSONObject) r47)     // Catch:{ JSONException -> 0x052c }
            r8 = r0
            r9 = r26
            r10 = r17
        ...
        L_0x0503:
            ...
            r8.<init>(r9, r10, r11, r12, r13, r14)     // Catch:{ JSONException -> 0x052c }
        L_0x0515:
            r0.f14709g = r4     // Catch:{ JSONException -> 0x052c }
            m17431a((com.inmobi.media.C5847bw) r0, (org.json.JSONObject) r5)     // Catch:{ JSONException -> 0x052c }
            if (r3 == 0) goto L_0x0525
            r0.mo34826b(r3)     // Catch:{ JSONException -> 0x052c }
            r1 = r0
            r44 = r6
            r6 = r2
            goto L_0x0851
        ...
        L_0x053a:
            ...
            r12 = r6
            r6 = r8
            com.inmobi.media.bx r0 = r1.m17426a(r2, r3, r4, r5, r6)     // Catch:{ JSONException -> 0x05ef }
            ...
            com.inmobi.media.cf$a r1 = r15.m17464q(r1)     // Catch:{ JSONException -> 0x05ef }
            goto L_0x056b
        L_0x0569:
            r1 = r21
        L_0x056b:
            ...
            com.inmobi.media.cf$a r2 = r15.m17464q(r2)     // Catch:{ JSONException -> 0x05ef }
            goto L_0x0580
        L_0x057e:
            r2 = r21
        L_0x0580:
            ...
            com.inmobi.media.cf r5 = new com.inmobi.media.cf     // Catch:{ JSONException -> 0x05ef }
            r5.<init>(r1, r2)     // Catch:{ JSONException -> 0x05ef }
            com.inmobi.media.cg r1 = new com.inmobi.media.cg     // Catch:{ JSONException -> 0x05ef }
            r6 = r17
            r13 = r26
            r1.<init>(r13, r6, r0, r5)     // Catch:{ JSONException -> 0x0641 }
            r1.f14794z = r3     // Catch:{ JSONException -> 0x0641 }
        ...
        L_0x05e9:
            r9 = r4
        L_0x05ea:
            r1.f14713k = r9     // Catch:{ JSONException -> 0x0641 }
        L_0x05ec:
            r1.f14709g = r11     // Catch:{ JSONException -> 0x0641 }
            goto L_0x063a
        L_0x05ef:
            r0 = move-exception
            r44 = r12
        ...
        L_0x05f4:
            ...
            r14 = r6
            r6 = r8
            com.inmobi.media.bx r0 = r1.m17426a(r2, r3, r4, r5, r6)     // Catch:{ JSONException -> 0x0641 }
            com.inmobi.media.cc r1 = new com.inmobi.media.cc     // Catch:{ JSONException -> 0x0641 }
            java.lang.String r2 = m17440c((org.json.JSONObject) r47)     // Catch:{ JSONException -> 0x0641 }
        ...
        L_0x0619:
            ...
            r1 = r46
            r6 = r8
            com.inmobi.media.ce$a r1 = r1.m17437b(r2, r3, r4, r5, r6)     // Catch:{ JSONException -> 0x0641 }
            com.inmobi.media.ce r2 = new com.inmobi.media.ce     // Catch:{ JSONException -> 0x0641 }
            r2.<init>(r13, r14, r1, r0)     // Catch:{ JSONException -> 0x0641 }
            r2.f14709g = r11     // Catch:{ JSONException -> 0x0641 }
            r1 = r2
        L_0x063a:
            r44 = r12
            r26 = r13
        ...
        L_0x0649:
            ...
            r19 = r6
            r6 = r8
            com.inmobi.media.bx r1 = r1.m17426a(r2, r3, r4, r5, r6)     // Catch:{ JSONException -> 0x0833 }
            boolean r2 = m17463p(r47)     // Catch:{ JSONException -> 0x0833 }
            ...
            byte r2 = m17441d((java.lang.String) r2)     // Catch:{ JSONException -> 0x0833 }
            goto L_0x0687
        L_0x0686:
            r2 = 2
        L_0x0687:
        ...
        L_0x06d5:
            ...
            goto L_0x0707
        L_0x06de:
            com.inmobi.media.by r6 = new com.inmobi.media.by     // Catch:{ JSONException -> 0x0833 }
            r8 = r6
            r7 = r17
            r17 = r29
            r9 = r26
        ...
        L_0x0707:
            ...
            r20 = r30
            r15 = r14
            com.inmobi.media.by r25 = new com.inmobi.media.by     // Catch:{ JSONException -> 0x0831 }
            r8 = r25
            r9 = r26
            r10 = r16
            r11 = r1
            ...
            r1 = r25
        L_0x0728:
            r1.f14709g = r2     // Catch:{ JSONException -> 0x0831 }
            if (r3 == 0) goto L_0x072f
            r1.mo34826b(r3)     // Catch:{ JSONException -> 0x0831 }
        L_0x072f:
            m17431a((com.inmobi.media.C5847bw) r1, (org.json.JSONObject) r7)     // Catch:{ JSONException -> 0x0831 }
        ...
        L_0x0739:
            ...
            java.lang.String r9 = m17447f((org.json.JSONObject) r8)     // Catch:{ JSONException -> 0x0831 }
        ...
        L_0x07fa:
            r13 = r19
        L_0x07fc:
            com.inmobi.media.bw r8 = r6.m17425a((org.json.JSONObject) r8, (java.lang.String) r13, (java.lang.String) r7)     // Catch:{ JSONException -> 0x0831 }
            if (r8 == 0) goto L_0x082d
            r8.f14709g = r7     // Catch:{ JSONException -> 0x0831 }
            r8.f14722t = r1     // Catch:{ JSONException -> 0x0831 }
            int r7 = r1.f14741C     // Catch:{ JSONException -> 0x0831 }
            r9 = 16
            if (r7 >= r9) goto L_0x082d
            int r7 = r1.f14741C     // Catch:{ JSONException -> 0x0831 }
            com.inmobi.media.bw[] r9 = r1.f14740B     // Catch:{ JSONException -> 0x0831 }
            int r9 = r9.length     // Catch:{ JSONException -> 0x0831 }
            if (r7 != r9) goto L_0x0823
            com.inmobi.media.bw[] r7 = r1.f14740B     // Catch:{ JSONException -> 0x0831 }
            int r7 = r7.length     // Catch:{ JSONException -> 0x0831 }
            int r7 = r7 * 2
            com.inmobi.media.bw[] r7 = new com.inmobi.media.C5847bw[r7]     // Catch:{ JSONException -> 0x0831 }
            com.inmobi.media.bw[] r9 = r1.f14740B     // Catch:{ JSONException -> 0x0831 }
            int r10 = r1.f14741C     // Catch:{ JSONException -> 0x0831 }
            java.lang.System.arraycopy(r9, r15, r7, r15, r10)     // Catch:{ JSONException -> 0x0831 }
            r1.f14740B = r7     // Catch:{ JSONException -> 0x0831 }
        L_0x0823:
            com.inmobi.media.bw[] r7 = r1.f14740B     // Catch:{ JSONException -> 0x0831 }
            int r9 = r1.f14741C     // Catch:{ JSONException -> 0x0831 }
            int r10 = r9 + 1
            r1.f14741C = r10     // Catch:{ JSONException -> 0x0831 }
        ...
        L_0x0851:
            ...
            java.util.Map<java.lang.String, java.lang.String> r0 = r6.f14764r
            r3 = r26
            r0.put(r3, r2)
            goto L_0x0875
        L_0x0873:
        ...
        L_0x0875:
            ...
            java.util.Map<java.lang.String, com.inmobi.media.bw> r0 = r6.f14763q
            boolean r0 = r0.containsKey(r3)
            if (r0 != 0) goto L_0x0888
            java.util.Map<java.lang.String, com.inmobi.media.bw> r0 = r6.f14763q
            r0.put(r3, r1)
        L_0x0888:
            java.util.Map<java.lang.String, java.util.List<com.inmobi.media.bw>> r0 = r6.f14762p
            r2 = r48
        ...
        L_0x089e:
            ...
            r0.<init>()
            r0.add(r1)
            java.util.Map<java.lang.String, java.util.List<com.inmobi.media.bw>> r3 = r6.f14762p
            r3.put(r2, r0)
        L_0x08ab:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.inmobi.media.C5854ca.m17425a(org.json.JSONObject, java.lang.String, java.lang.String):com.inmobi.media.bw");
    }

    /* renamed from: a */
    private static void m17431a(C5847bw bwVar, JSONObject jSONObject) throws JSONException {
        String str;
        boolean z;
        String str2;
        boolean z2 = true;
        String str3 = "";
        if (m17463p(jSONObject)) {
    ...
    /* renamed from: b */
    public final C5847bw mo34844b(String str) {
        if (!(str == null || str.length() == 0)) {
            if (this.f14763q.get(str) != null) {
                return this.f14763q.get(str);
            }
            C5854ca caVar = this.f14753f;
            if (caVar != null) {
                return caVar.f14763q.get(str);
            }
        }
        return null;
    }
    ...
    /* renamed from: e */
    public final List<String> mo34849e() {
        return new ArrayList(this.f14762p.keySet());
    }

    /* renamed from: c */
    public final List<C5847bw> mo34847c(String str) {
        if (this.f14762p.containsKey(str)) {
            return this.f14762p.get(str);
        }
        return Collections.emptyList();
    }

    /* renamed from: a */
    private static boolean m17435a(JSONObject jSONObject, String str) {
        if (jSONObject.isNull("geometry")) {
            return false;
        }
        try {
            if (!m17434a(jSONObject.getJSONArray("geometry"))) {
                return false;
            }
            char c = 65535;
            switch (str.hashCode()) {
    ...
    /* renamed from: a */
    private static boolean m17434a(JSONArray jSONArray) {
        try {
    ...
    /* renamed from: a */
    private static C5868ci m17428a(int i, String str, JSONObject jSONObject) throws JSONException {
        ...
        if ("VideoImpression".equals(str)) {
            ...
            if (optJSONArray != null) {
                for (int i2 = 0; i2 < optJSONArray.length(); i2++) {
                    String a = C5868ci.m17487a(optJSONArray.getString(i2));
        ...
        C5868ci ciVar = new C5868ci(trim, i, str, hashMap2);
        ciVar.f14817f = new HashMap(hashMap);
        return ciVar;
    }

    /* renamed from: a */
    private static List<C5868ci> m17430a(JSONObject jSONObject) {
        ...
        try {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (!jSONObject3.isNull("url")) {
                    linkedList.add(new C5985ep(jSONObject3.optString(Verification.VENDOR), jSONObject3.optString("verificationParams"), jSONObject3.getString("url"), "OMID_VIEWABILITY", hashMap));
                }
            }
            if (linkedList.isEmpty()) {
                linkedList.add(new C5868ci("", 0, "OMID_VIEWABILITY", hashMap));
            }
        } catch (Exception e) {
            C6130gj.m18161a().mo35310a(new C6167hk(e));
        }
    ...
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static java.util.List<com.inmobi.media.C5868ci> m17438b(org.json.JSONObject r17) {
        /*
            r0 = r17
        ...
        L_0x016a:
            ...
            com.inmobi.media.ci r5 = m17428a((int) r8, (java.lang.String) r15, (org.json.JSONObject) r7)     // Catch:{ JSONException -> 0x018d }
            if (r5 == 0) goto L_0x0187
            r4.add(r5)     // Catch:{ JSONException -> 0x018d }
            goto L_0x0187
        L_0x0180:
            java.util.List r5 = m17430a((org.json.JSONObject) r7)     // Catch:{ JSONException -> 0x018d }
        ...
        L_0x018d:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.inmobi.media.C5854ca.m17438b(org.json.JSONObject):java.util.List");
    }

    /* renamed from: a */
    private C5950dw m17429a(JSONObject jSONObject, String str, C5847bw bwVar) {
        if (m17447f(jSONObject).equalsIgnoreCase(ShareConstants.VIDEO_URL)) {
            try {
                JSONArray jSONArray = jSONObject.getJSONArray("assetValue");
                if (jSONArray != null) {
                    if (jSONArray.length() != 0) {
                        if (bwVar instanceof C5869cj) {
                            return (C5950dw) bwVar.f14707e;
                        }
                        return new C5943ds(this.f14765s.vastVideo).mo35055a(str);
                    }
                }
                return null;
            } catch (JSONException e) {
    ...
    /* renamed from: c */
    private static String m17440c(JSONObject jSONObject) {
        try {
            if ((m17447f(jSONObject).equalsIgnoreCase("ICON") || m17447f(jSONObject).equalsIgnoreCase(ShareConstants.IMAGE_URL) || m17447f(jSONObject).equalsIgnoreCase("GIF")) && jSONObject.getJSONArray("assetValue").getString(0).length() != 0) {
    ...
    /* renamed from: d */
    private static String m17442d(JSONObject jSONObject) {
        try {
    ...
    /* renamed from: e */
    private static String m17444e(JSONObject jSONObject) {
        try {
    ...
    /* renamed from: f */
    private static String m17447f(JSONObject jSONObject) {
        try {
    ...
    /* renamed from: g */
    private static String m17449g(JSONObject jSONObject) {
        try {
    ...
    /* renamed from: h */
    private static String m17452h(JSONObject jSONObject) {
        try {
    ...
    /* renamed from: i */
    private JSONObject m17454i(JSONObject jSONObject) {
        ...
        try {
            ...
            if (this.f14761o == null) {
                ...
                jSONObject3 = this.f14761o.getJSONObject(string);
            }
            return jSONObject3;
        } catch (JSONException e) {
            C6130gj.m18161a().mo35310a(new C6167hk(e));
    ...
    /* renamed from: j */
    private Point m17456j(JSONObject jSONObject) {
        Point point = new Point();
        try {
            JSONObject i = m17454i(jSONObject);
            if (i.isNull("geometry")) {
                return point;
            }
            JSONArray jSONArray = i.getJSONArray("geometry");
            point.x = C6215il.m18443a(jSONArray.getInt(0));
            point.y = C6215il.m18443a(jSONArray.getInt(1));
            return point;
        } catch (JSONException e) {
            C6130gj.m18161a().mo35310a(new C6167hk(e));
        }
    ...
    /* renamed from: a */
    private Point m17423a(JSONObject jSONObject, Point point) {
        try {
            JSONObject i = m17454i(jSONObject);
            ...
            point2.x = C6215il.m18443a(jSONArray.getInt(0));
            point2.y = C6215il.m18443a(jSONArray.getInt(1));
            return point2;
    ...
    /* renamed from: k */
    private Point m17458k(JSONObject jSONObject) {
        Point point = new Point();
        try {
            JSONObject i = m17454i(jSONObject);
            if (i.isNull("geometry")) {
            ...
            JSONArray jSONArray = i.getJSONArray("geometry");
            point.x = C6215il.m18443a(jSONArray.getInt(2));
            point.y = C6215il.m18443a(jSONArray.getInt(3));
            return point;
        } catch (JSONException e) {
            C6130gj.m18161a().mo35310a(new C6167hk(e));
        }
    ...
    /* renamed from: b */
    private Point m17436b(JSONObject jSONObject, Point point) {
        try {
            JSONObject i = m17454i(jSONObject);
            if (i.isNull("finalGeometry")) {
                return point;
            ...
            Point point2 = new Point();
            JSONArray jSONArray = i.getJSONArray("finalGeometry");
            point2.x = C6215il.m18443a(jSONArray.getInt(2));
            point2.y = C6215il.m18443a(jSONArray.getInt(3));
            return point2;
        } catch (JSONException unused) {
            return point;
        }
    ...
    /* renamed from: l */
    private static byte m17459l(JSONObject jSONObject) {
        try {
            JSONObject n = m17461n(jSONObject);
            if (n.isNull("type")) {
                return 2;
            }
    ...
    /* renamed from: a */
    private static int m17422a(JSONObject jSONObject, boolean z) {
        try {
            JSONObject n = m17461n(jSONObject);
            ...
            int i = n.getInt(str);
            if (3 == m17459l(jSONObject)) {
                return i;
            }
            if (4 == m17459l(jSONObject)) {
                if (i == 0) {
                    return i;
                }
                if (i > 0 && i <= 100) {
    ...
    /* renamed from: m */
    private static String m17460m(JSONObject jSONObject) {
        try {
            JSONObject n = m17461n(jSONObject);
    ...
    /* renamed from: n */
    private static JSONObject m17461n(JSONObject jSONObject) {
    ...
    /* renamed from: o */
    private static JSONArray m17462o(JSONObject jSONObject) {
        try {
    ...
    /* renamed from: p */
    private static boolean m17463p(JSONObject jSONObject) {
    ...
    /* renamed from: d */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static byte m17441d(java.lang.String r5) {
        /*
            java.util.Locale r0 = java.util.Locale.US
        ...
        L_0x0048:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.inmobi.media.C5854ca.m17441d(java.lang.String):byte");
    }

    /* JADX WARNING: Can't fix incorrect switch cases order */
    /* renamed from: e */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static java.lang.String m17443e(java.lang.String r10) {
        /*
            java.util.Locale r0 = java.util.Locale.US
        ...
        L_0x0055:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.inmobi.media.C5854ca.m17443e(java.lang.String):java.lang.String");
    }
    ...
    /* renamed from: f */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static java.lang.String m17446f(java.lang.String r5) {
        /*
            java.util.Locale r0 = java.util.Locale.US
            java.lang.String r5 = r5.toLowerCase(r0)
            java.lang.String r5 = r5.trim()
        ...
        L_0x0032:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.inmobi.media.C5854ca.m17446f(java.lang.String):java.lang.String");
    }
    ...
    /* renamed from: g */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static java.lang.String m17448g(java.lang.String r5) {
        /*
            java.util.Locale r0 = java.util.Locale.US
            java.lang.String r5 = r5.toLowerCase(r0)
            java.lang.String r5 = r5.trim()
        ...
        L_0x0032:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.inmobi.media.C5854ca.m17448g(java.lang.String):java.lang.String");
    }

    /* JADX WARNING: Can't fix incorrect switch cases order */
    /* renamed from: h */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static java.lang.String m17451h(java.lang.String r8) {
        /*
        ...
        L_0x0041:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.inmobi.media.C5854ca.m17451h(java.lang.String):java.lang.String");
    }

    /* renamed from: q */
    private C5862cf.C5863a m17464q(JSONObject jSONObject) {
        return new C5862cf.C5863a(jSONObject.optLong(Constants.PATH_TYPE_ABSOLUTE), jSONObject.optLong("percentage"), jSONObject.optString("reference"), this);
    }

    /* renamed from: r */
    private C5862cf.C5863a m17465r(JSONObject jSONObject) {
        if (jSONObject == null) {
            return null;
        }
        return new C5862cf.C5863a(jSONObject.optLong(Constants.PATH_TYPE_ABSOLUTE), jSONObject.optLong("percentage"), jSONObject.optString("reference"), this);
    ...
    /* renamed from: a */
    private C5848bx m17426a(Point point, Point point2, Point point3, Point point4, JSONObject jSONObject) throws JSONException {
        String str;
        Point point5 = point;
        Point point6 = point2;
        Point point7 = point3;
        ...
        if (!jSONObject2.isNull("border")) {
            ...
            if (!jSONObject3.isNull("style")) {
                str2 = m17446f(jSONObject3.getString("style"));
                if (!jSONObject3.isNull("corner")) {
                    str4 = m17448g(jSONObject3.getString("corner"));
                }
        ...
        String str8 = str;
        return new C5848bx(point5.x, point5.y, point6.x, point6.y, point7.x, point7.y, point8.x, point8.y, !jSONObject2.isNull("contentMode") ? m17451h(jSONObject2.getString("contentMode")) : "fill", str5, str7, str6, str8, m17466s(jSONObject2));
    }

    /* renamed from: s */
    private C5862cf m17466s(JSONObject jSONObject) throws JSONException {
        C5862cf.C5863a aVar = null;
        C5862cf.C5863a r = !jSONObject.isNull("startOffset") ? m17465r(jSONObject.optJSONObject("startOffset")) : null;
        if (!jSONObject.isNull("timerDuration")) {
            aVar = m17465r(jSONObject.optJSONObject("timerDuration"));
        }
        return new C5862cf(r, aVar);
    }
    ...
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private com.inmobi.media.C5860ce.C5861a m17437b(android.graphics.Point r32, android.graphics.Point r33, android.graphics.Point r34, android.graphics.Point r35, org.json.JSONObject r36) throws org.json.JSONException {
        /*
            r31 = this;
            r0 = r32
            r1 = r33
        ...
        L_0x002e:
            ...
            java.lang.String r6 = m17446f((java.lang.String) r6)
        ...
        L_0x003f:
            ...
            java.lang.String r7 = m17448g((java.lang.String) r7)
        L_0x0047:
        ...
        L_0x00cf:
            ...
            java.lang.String r12 = m17443e((java.lang.String) r12)
            r9[r10] = r12
            int r10 = r10 + 1
            goto L_0x00cf
        L_0x00e2:
        ...
        L_0x0131:
            r5 = r31
            r26 = r8
            com.inmobi.media.cf r30 = r5.m17466s(r4)
            com.inmobi.media.ce$a r4 = new com.inmobi.media.ce$a
            r12 = r4
            int r13 = r0.x
            int r14 = r0.y
            int r15 = r1.x
        ...
        L_0x015c:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.inmobi.media.C5854ca.m17437b(android.graphics.Point, android.graphics.Point, android.graphics.Point, android.graphics.Point, org.json.JSONObject):com.inmobi.media.ce$a");
    }
    ...
    /* renamed from: c */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private com.inmobi.media.C5860ce.C5861a m17439c(android.graphics.Point r30, android.graphics.Point r31, android.graphics.Point r32, android.graphics.Point r33, org.json.JSONObject r34) throws org.json.JSONException {
        /*
            r29 = this;
            r0 = r30
            r1 = r31
        ...
        L_0x00ba:
            ...
            java.lang.String r10 = m17443e((java.lang.String) r10)
            r8[r9] = r10
            int r9 = r9 + 1
            goto L_0x00ba
        L_0x00cd:
            ...
            r27 = r8
        L_0x00d1:
            com.inmobi.media.cf r28 = r5.m17466s(r4)
            com.inmobi.media.bz$a r4 = new com.inmobi.media.bz$a
            r12 = r4
            int r13 = r0.x
            int r14 = r0.y
            int r15 = r1.x
        ...
        L_0x00f8:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.inmobi.media.C5854ca.m17439c(android.graphics.Point, android.graphics.Point, android.graphics.Point, android.graphics.Point, org.json.JSONObject):com.inmobi.media.ce$a");
    }

    /* renamed from: a */
    private static boolean m17433a(C5849by byVar) {
        return "card_scrollable".equalsIgnoreCase(byVar.f14706d);
    }

    /* renamed from: a */
    private static void m17432a(C5869cj cjVar) {
        cjVar.f14726x = 8;
        HashMap hashMap = new HashMap();
        hashMap.put("[ERRORCODE]", "601");
        cjVar.mo34823a("error", hashMap);
    }

    /* renamed from: a */
    private static C5847bw m17424a(C5854ca caVar, C5847bw bwVar) {
        do {
