...
public class C5868ci {

    /* renamed from: g */
    private static final String f14811g = C5868ci.class.getSimpleName();

    /* renamed from: a */
    protected String f14812a;

    /* renamed from: b */
    public String f14813b;

    /* renamed from: c */
    protected int f14814c;

    /* renamed from: d */
    public String f14815d;

    /* renamed from: e */
    public Map<String, String> f14816e;

    /* renamed from: f */
    public Map<String, Object> f14817f;

    public C5868ci(String str, int i, String str2, Map<String, String> map) {
        this("url_ping", str, i, str2, map);
    }

    private C5868ci(String str, String str2, int i, String str3, Map<String, String> map) {
        this.f14816e = new HashMap();
        this.f14812a = str;
        this.f14813b = str2.trim();
        this.f14814c = i;
        this.f14815d = str3;
        this.f14816e = map;
    }
    ...
    public static java.lang.String m17487a(java.lang.String r24) {
        /*
            r0 = r24
        ...
        L_0x01c0:
            ...
            return r16
        */
        throw new UnsupportedOperationException("Method not decompiled: com.inmobi.media.C5868ci.m17487a(java.lang.String):java.lang.String");
    }
    ...
    public String toString() {
        ...
        try {
            ...
            jSONObject.put("extras", C6196id.m18384a((Map<String, String>) this.f14816e == null ? new HashMap() : this.f14816e, ","));
