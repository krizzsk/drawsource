...
public class C6225is<T> {

    /* renamed from: a */
    private static final String f15701a = C6225is.class.getSimpleName();

    /* renamed from: b */
    private static boolean f15702b;

    /* renamed from: c */
    private Map<C6230ix, C6229iw> f15703c = new HashMap();

    /* renamed from: a */
    public static void m18505a(boolean z) {
        f15702b = z;
    }

    /* renamed from: a */
    public static void m18504a(Object obj, Object obj2) {
    ...
    /* renamed from: b */
    private static boolean m18509b(Object obj, Object obj2) {
    ...
    /* renamed from: a */
    private static boolean m18507a(JSONArray jSONArray, JSONArray jSONArray2) {
        ...
        while (i < jSONArray.length()) {
            try {
                ...
                if (!(obj instanceof JSONObject) || !(obj2 instanceof JSONObject)) {
                    ...
                    } else if (!m18507a((JSONArray) obj, (JSONArray) obj2)) {
                        return false;
                    }
                } else if (!m18508a((JSONObject) obj, (JSONObject) obj2)) {
                    return false;
                }
                i++;
    ...
    /* renamed from: a */
    public static boolean m18508a(JSONObject jSONObject, JSONObject jSONObject2) {
    ...
    /* renamed from: a */
    public C6225is<T> mo35433a(C6230ix ixVar, C6229iw iwVar) {
        this.f15703c.put(ixVar, iwVar);
        return this;
    }

    /* renamed from: a */
    private static boolean m18506a(Class<?> cls) {
    ...
    /* renamed from: a */
    private JSONObject m18503a(Object obj, Class<?> cls) {
        ...
        try {
            ...
            if (superclass == null || Object.class == superclass) {
                ...
                jSONObject = m18503a(obj, (Class<?>) superclass2);
            }
            if (jSONObject == null) {
            ...
            for (Field field : cls.getDeclaredFields()) {
                ...
                if (field.get(obj) == null) {
                    ...
                    if (!Modifier.isStatic(field.getModifiers()) && !field.isAnnotationPresent(C6224ir.class)) {
                                                                            ...
                                                                            if (!(String.class == type || JSONObject.class == type)) {
                                                                                if (JSONArray.class != type) {
                                                                                    if (Map.class.isAssignableFrom(type)) {
                                                                                        if (this.f15703c.get(new C6230ix(name, cls)) instanceof C6228iv) {
                                                                                            ...
                                                                                            if (obj3 != null) {
                                                                                                ...
                                                                                                for (Object next : map.keySet()) {
                                                                                                    ...
                                                                                                    if (obj4 != null) {
                                                                                                        if (!m18506a(obj4.getClass())) {
                                                                                                            obj4 = m18503a(obj4, obj4.getClass());
                                                                                                        }
                                                                                        ...
                                                                                        if (obj5 != null) {
                                                                                            jSONObject.put(name, m18503a(obj5, obj5.getClass()));
                                                                                        } else {
                                                                                            type.getSimpleName();
                                                                                        }
                                                                                    } else if (this.f15703c.get(new C6230ix(name, cls)) instanceof C6227iu) {
                                                                                        JSONArray jSONArray = new JSONArray();
                                                                                        Object obj6 = field.get(obj);
                                                                                        if (obj6 != null) {
                                                                                            for (Object next2 : (List) obj6) {
                                                                                                if (next2 != null) {
                                                                                                    if (m18506a(next2.getClass())) {
                                                                                                        obj2 = next2;
                                                                                                    } else {
                                                                                                        obj2 = m18503a(next2, next2.getClass());
                                                                                                    }
                                                                                                    if (obj2 == null) {
                                                                                                        next2.getClass();
                                                                                                    } else {
    ...
    /* renamed from: a */
    public JSONObject mo35435a(T t) {
        return m18503a((Object) t, t.getClass());
    }

    /* renamed from: a */
    public T mo35434a(JSONObject jSONObject, Class<T> cls) {
        return cls.cast(m18502a(jSONObject, cls, (Object) null, (Object) null));
    }
    ...
    private java.lang.Object m18502a(org.json.JSONObject r19, java.lang.Class<?> r20, java.lang.Object r21, java.lang.Object r22) {
        /*
            r18 = this;
            r0 = r18
            r1 = r19
        ...
        L_0x0070:
            ...
            r8 = r21
            java.lang.Object r6 = r0.m18502a(r1, r7, r8, r6)     // Catch:{ Exception -> 0x0328 }
        L_0x0083:
        ...
        L_0x0089:
            ...
            goto L_0x031a
        L_0x00a6:
            java.lang.Class<com.inmobi.media.ir> r12 = com.inmobi.media.C6224ir.class
        ...
        L_0x0197:
            ...
            java.util.Map<com.inmobi.media.ix, com.inmobi.media.iw> r13 = r0.f15703c     // Catch:{ Exception -> 0x0328 }
            com.inmobi.media.ix r14 = new com.inmobi.media.ix     // Catch:{ Exception -> 0x0328 }
            r14.<init>(r11, r2)     // Catch:{ Exception -> 0x0328 }
            java.lang.Object r13 = r13.get(r14)     // Catch:{ Exception -> 0x0328 }
            com.inmobi.media.iw r13 = (com.inmobi.media.C6229iw) r13     // Catch:{ Exception -> 0x0328 }
            boolean r14 = r13 instanceof com.inmobi.media.C6228iv     // Catch:{ Exception -> 0x0328 }
            if (r14 == 0) goto L_0x0252
            org.json.JSONObject r11 = r1.optJSONObject(r11)     // Catch:{ Exception -> 0x0328 }
            if (r11 == 0) goto L_0x031a
            com.inmobi.media.iv r13 = (com.inmobi.media.C6228iv) r13     // Catch:{ Exception -> 0x0328 }
            com.inmobi.commons.utils.json.Constructor r12 = r13.f15706b     // Catch:{ Exception -> 0x0328 }
        ...
        L_0x01c4:
            ...
            java.lang.Class<V> r4 = r13.f15705a     // Catch:{ Exception -> 0x0328 }
            boolean r4 = m18506a((java.lang.Class<?>) r4)     // Catch:{ Exception -> 0x0328 }
            if (r4 == 0) goto L_0x0232
            java.lang.Class<V> r4 = r13.f15705a     // Catch:{ Exception -> 0x0328 }
            java.lang.Class<V> r5 = r13.f15705a     // Catch:{ Exception -> 0x0328 }
        ...
        L_0x0232:
            ...
            java.lang.Class<V> r5 = r13.f15705a     // Catch:{ Exception -> 0x0318 }
            java.lang.Object r4 = r0.mo35434a((org.json.JSONObject) r4, r5)     // Catch:{ Exception -> 0x0318 }
        L_0x023f:
        ...
        L_0x025a:
            ...
            java.util.Map<com.inmobi.media.ix, com.inmobi.media.iw> r4 = r0.f15703c     // Catch:{ Exception -> 0x0318 }
            com.inmobi.media.ix r5 = new com.inmobi.media.ix     // Catch:{ Exception -> 0x0318 }
            r5.<init>(r11, r2)     // Catch:{ Exception -> 0x0318 }
            java.lang.Object r4 = r4.get(r5)     // Catch:{ Exception -> 0x0318 }
            com.inmobi.media.iw r4 = (com.inmobi.media.C6229iw) r4     // Catch:{ Exception -> 0x0318 }
            boolean r5 = r4 instanceof com.inmobi.media.C6227iu     // Catch:{ Exception -> 0x0318 }
            if (r5 == 0) goto L_0x02ff
            org.json.JSONArray r5 = r1.optJSONArray(r11)     // Catch:{ Exception -> 0x0318 }
            if (r5 == 0) goto L_0x031d
            com.inmobi.media.iu r4 = (com.inmobi.media.C6227iu) r4     // Catch:{ Exception -> 0x0318 }
            java.util.List r7 = r4.mo35436a()     // Catch:{ Exception -> 0x0318 }
            r8 = 0
        L_0x0283:
            int r11 = r5.length()     // Catch:{ Exception -> 0x0318 }
            if (r8 >= r11) goto L_0x02fb
            java.lang.Class r11 = r4.mo35437b()     // Catch:{ Exception -> 0x0318 }
        ...
        L_0x02d4:
            ...
            boolean r12 = m18506a((java.lang.Class<?>) r12)     // Catch:{ Exception -> 0x0318 }
            if (r12 == 0) goto L_0x02e7
            java.lang.Class r12 = r4.mo35437b()     // Catch:{ Exception -> 0x0318 }
        ...
        L_0x02e7:
            ...
            java.lang.Class r12 = r4.mo35437b()     // Catch:{ Exception -> 0x0318 }
            java.lang.Object r11 = r0.mo35434a((org.json.JSONObject) r11, r12)     // Catch:{ Exception -> 0x0318 }
        L_0x02f3:
        ...
        L_0x0303:
            ...
            r5 = 0
            java.lang.Object r4 = r0.m18502a(r4, r12, r6, r5)     // Catch:{ Exception -> 0x0312 }
        ...
        L_0x0329:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.inmobi.media.C6225is.m18502a(org.json.JSONObject, java.lang.Class, java.lang.Object, java.lang.Object):java.lang.Object");
    }
}
