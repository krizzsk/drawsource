...
public final class InMobiAdRequestStatus {
    ...
    /* renamed from: a */
    private static final String f19540a = InMobiAdRequestStatus.class.getSimpleName();

    /* renamed from: b */
    private StatusCode f19541b;
    ...
    public InMobiAdRequestStatus(StatusCode statusCode) {
        this.f19541b = statusCode;
        switch (C80831.f19543a[this.f19541b.ordinal()]) {
            case 1:
                this.f19542c = "The InMobi SDK encountered an internal error.";
                return;
            case 2:
                this.f19542c = "The Internet is unreachable. Please check your Internet connection.";
                return;
            case 3:
                this.f19542c = "An invalid ad request was sent and was rejected by the Ad Network. Please validate the ad request and try again";
                return;
            case 4:
                this.f19542c = "The SDK is pending response to a previous ad request. Please wait for the previous ad request to complete before requesting for another ad.";
                return;
            case 5:
                this.f19542c = "The Ad Request timed out waiting for a response from the network. This can be caused due to a bad network connection. Please try again after a few minutes.";
                return;
            case 6:
                this.f19542c = "The Ad Server encountered an error when processing the ad request. This may be a transient issue. Please try again in a few minutes";
                return;
            case 7:
                this.f19542c = "Ad request successful but no ad served.";
                return;
            case 8:
                this.f19542c = "The Ad Request could not be submitted as the user is viewing another Ad.";
                return;
            case 9:
                this.f19542c = "The Ad Request cannot be done so frequently. Please wait for some time before loading another ad.";
                return;
            case 10:
                this.f19542c = "An ad is no longer available. Please call load() to fetch a fresh ad.";
                return;
            case 11:
                this.f19542c = "The SDK rejected the ad request as one or more required dependencies could not be found. Please ensure you have included the required dependencies.";
                return;
            case 12:
                this.f19542c = "The SDK rejected the ad load request. Multiple load() call on the same object is not allowed if the previous ad request was successful.";
                return;
            case 13:
                this.f19542c = "Network Request dropped as current request is not GDPR compliant.";
                return;
            case 14:
                this.f19542c = "An ad load is already in progress, getSignals() call in this state is not allowed.";
                return;
            case 15:
                this.f19542c = "An ad load is already in progress, load(response) call in this state is not allowed.";
                return;
            case 16:
                this.f19542c = "Null or empty response as parameter is not allowed in load(response).";
                return;
            case 17:
                this.f19542c = "The Ad Request is terminated because monetization is disabled.";
                return;
            case 18:
                this.f19542c = "An API call is made from non-ui thread.";
                return;
            case 19:
                this.f19542c = "InMobi Ad Object is not configured properly Please check if setBannerSize(int widthInDp, int heightInDp) or setLayoutParams(<Layout_Params>) have been configured correctly";
                return;
            case 20:
                this.f19542c = "The app is running low on memory, hence resulting in failure";
                return;
            default:
                return;
        }
    ...
    static /* synthetic */ class C80831 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f19543a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f19543a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f19543a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f19543a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f19543a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f19543a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                int[] r0 = f19543a     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f19543a     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x006c:
                int[] r0 = f19543a     // Catch:{ NoSuchFieldError -> 0x0078 }
            ...
            L_0x0078:
                int[] r0 = f19543a     // Catch:{ NoSuchFieldError -> 0x0084 }
            ...
            L_0x0084:
                int[] r0 = f19543a     // Catch:{ NoSuchFieldError -> 0x0090 }
            ...
            L_0x0090:
                int[] r0 = f19543a     // Catch:{ NoSuchFieldError -> 0x009c }
            ...
            L_0x009c:
                int[] r0 = f19543a     // Catch:{ NoSuchFieldError -> 0x00a8 }
            ...
            L_0x00a8:
                int[] r0 = f19543a     // Catch:{ NoSuchFieldError -> 0x00b4 }
            ...
            L_0x00b4:
                int[] r0 = f19543a     // Catch:{ NoSuchFieldError -> 0x00c0 }
            ...
            L_0x00c0:
                int[] r0 = f19543a     // Catch:{ NoSuchFieldError -> 0x00cc }
            ...
            L_0x00cc:
                int[] r0 = f19543a     // Catch:{ NoSuchFieldError -> 0x00d8 }
            ...
            L_0x00d8:
                int[] r0 = f19543a     // Catch:{ NoSuchFieldError -> 0x00e4 }
            ...
            L_0x00e4:
                int[] r0 = f19543a     // Catch:{ NoSuchFieldError -> 0x00f0 }
            ...
            L_0x00f0:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.inmobi.ads.InMobiAdRequestStatus.C80831.<clinit>():void");
        }
    }
