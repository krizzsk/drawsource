...
public class C2925y {
    /* renamed from: a */
    public static List<File> m8190a(String str, String str2) throws IOException {
        return m8191a(str, str2, (String) null);
    }

    /* renamed from: a */
    public static List<File> m8191a(String str, String str2, String str3) throws IOException {
        return m8189a(m8188a(str), m8188a(str2), str3);
    }
    ...
    public static java.util.List<java.io.File> m8189a(java.io.File r9, java.io.File r10, java.lang.String r11) throws java.io.IOException {
        /*
        ...
        L_0x0006:
            ...
            boolean r2 = m8195b((java.lang.String) r11)     // Catch:{ all -> 0x0098 }
        ...
        L_0x0022:
            ...
            com.bytedance.sdk.component.utils.C2905l.m8117d(r5, r11)     // Catch:{ all -> 0x0098 }
            goto L_0x0022
        L_0x004e:
            boolean r11 = m8193a(r10, r0, r1, r11, r2)     // Catch:{ all -> 0x0098 }
        ...
        L_0x0058:
            ...
            com.bytedance.sdk.component.utils.C2905l.m8117d(r5, r2)     // Catch:{ all -> 0x0098 }
            goto L_0x0058
        L_0x0084:
            boolean r8 = r7.contains(r11)     // Catch:{ all -> 0x0098 }
            if (r8 == 0) goto L_0x0058
            boolean r2 = m8193a(r10, r0, r1, r2, r7)     // Catch:{ all -> 0x0098 }
            if (r2 != 0) goto L_0x0058
            r1.close()
            return r0
        L_0x0094:
        ...
        L_0x009d:
            ...
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.sdk.component.utils.C2925y.m8189a(java.io.File, java.io.File, java.lang.String):java.util.List");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static boolean m8193a(java.io.File r2, java.util.List<java.io.File> r3, java.util.zip.ZipFile r4, java.util.zip.ZipEntry r5, java.lang.String r6) throws java.io.IOException {
        /*
            ...
            boolean r2 = m8192a((java.io.File) r0)
            return r2
        L_0x0013:
            boolean r2 = m8194b((java.io.File) r0)
            r3 = 0
        ...
        L_0x0066:
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.sdk.component.utils.C2925y.m8193a(java.io.File, java.util.List, java.util.zip.ZipFile, java.util.zip.ZipEntry, java.lang.String):boolean");
    }

    /* renamed from: a */
    private static boolean m8192a(File file) {
        return file != null && (!file.exists() ? file.mkdirs() : file.isDirectory());
    }

    /* renamed from: b */
    private static boolean m8194b(File file) {
        if (file == null) {
            return false;
        }
        if (file.exists()) {
    ...
    /* renamed from: a */
    private static File m8188a(String str) {
        if (m8195b(str)) {
            return null;
        }
        return new File(str);
    ...
    /* renamed from: b */
    private static boolean m8195b(String str) {
        if (str == null) {
            return true;
        }
