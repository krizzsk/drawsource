...
public interface TTAdNative {
    ...
    public interface AppOpenAdListener extends C3159b {
    ...
    @Deprecated
    public interface BannerAdListener extends C3159b {
        void onBannerAdLoad(TTBannerAd tTBannerAd);

        void onError(int i, String str);
    }

    public interface FeedAdListener extends C3159b {
        void onError(int i, String str);

        void onFeedAdLoad(List<TTFeedAd> list);
    }

    public interface FullScreenVideoAdListener extends C3159b {
        void onError(int i, String str);
    ...
    @Deprecated
    public interface InteractionAdListener extends C3159b {
        void onError(int i, String str);
    ...
    @Deprecated
    public interface NativeAdListener extends C3159b {
        void onError(int i, String str);

        void onNativeAdLoad(List<TTNativeAd> list);
    }

    public interface NativeExpressAdListener extends C3159b {
        void onError(int i, String str);

        void onNativeExpressAdLoad(List<TTNativeExpressAd> list);
    }

    public interface RewardVideoAdListener extends C3159b {
        void onError(int i, String str);
