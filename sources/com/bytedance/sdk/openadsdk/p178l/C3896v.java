...
/* renamed from: com.bytedance.sdk.openadsdk.l.v */
...
public class C3896v {
    ...
    public static java.lang.String m12740a(java.lang.String r7) {
        /*
        ...
        L_0x008e:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.sdk.openadsdk.p178l.C3896v.m12740a(java.lang.String):java.lang.String");
    }

    /* renamed from: a */
    public static boolean m12741a() {
        if (C2905l.m8116c() && C3457h.m10580d().mo19779s() && C3457h.m10580d().mo19780t()) {
            return true;
        }
        return false;
    }
    ...
    /* renamed from: b */
    public static String m12743b(String str) {
        try {
            if (!m12741a()) {
                return str;
            }
            String u = C3457h.m10580d().mo19781u();
            if (TextUtils.isEmpty(u)) {
                return str;
            }
            Log.d("TestHelperUtils", "AnyDoorId=" + u);
            return Uri.parse(str).buildUpon().appendQueryParameter(m12742b(), u).appendQueryParameter("aid", "5001121").toString();
    ...
    /* renamed from: b */
    public static String m12742b() {
        if (TextUtils.isEmpty(f9963a)) {
            f9963a = new String(Base64.decode("ZGV2aWNlX2lk", 0));
        }
        return f9963a;
    }
}
