...
public interface IAppOpenAdInteractionListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAppOpenAdInteractionListener {
        ...
        private static class C2933a implements IAppOpenAdInteractionListener {

            /* renamed from: a */
            public static IAppOpenAdInteractionListener f6629a;

            /* renamed from: b */
            private IBinder f6630b;

            C2933a(IBinder iBinder) {
                this.f6630b = iBinder;
            }
            ...
            public void onDestroy() throws RemoteException {
                ...
                try {
                    ...
                    if (this.f6630b.transact(1, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
            ...
            public void onAdShow() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.bytedance.sdk.openadsdk.IAppOpenAdInteractionListener");
                    if (this.f6630b.transact(2, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
            ...
            public void onAdClicked() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.bytedance.sdk.openadsdk.IAppOpenAdInteractionListener");
                    if (this.f6630b.transact(3, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
            ...
            public void onAdSkip() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.bytedance.sdk.openadsdk.IAppOpenAdInteractionListener");
                    if (this.f6630b.transact(4, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
            ...
            public void onAdTimeOver() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.bytedance.sdk.openadsdk.IAppOpenAdInteractionListener");
                    if (this.f6630b.transact(5, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
        ...
        public static boolean setDefaultImpl(IAppOpenAdInteractionListener iAppOpenAdInteractionListener) {
            if (C2933a.f6629a != null || iAppOpenAdInteractionListener == null) {
                return false;
            }
            C2933a.f6629a = iAppOpenAdInteractionListener;
            return true;
        }

        public static IAppOpenAdInteractionListener getDefaultImpl() {
            return C2933a.f6629a;
        }
    }
}
