...
public class C3116s implements C3093f<C3775c.C3778a> {

    /* renamed from: a */
    protected final C3388c f7328a = C3388c.m10078a(mo18717e());
    ...
    public C3116s(Context context) {
        this.f7329b = context;
    }

    /* renamed from: e */
    public Context mo18717e() {
    ...
    public java.util.List<com.bytedance.sdk.openadsdk.p170h.p173c.C3775c.C3778a> mo18661a(int r11, java.lang.String r12) {
        /*
            r10 = this;
        ...
        L_0x001e:
            ...
            android.content.Context r0 = r10.mo18717e()
            java.lang.String r1 = r10.mo18714c()
            ...
            r5 = 0
            r6 = 0
            java.util.Map r0 = com.bytedance.sdk.openadsdk.multipro.p179a.C3909a.m12910a(r0, r1, r2, r3, r4, r5, r6, r7)
            r12.<init>(r0)
        L_0x0041:
        ...
        L_0x0075:
            ...
            throw r11
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.sdk.openadsdk.p128b.C3116s.mo18661a(int, java.lang.String):java.util.List");
    }

    /* renamed from: a */
    public synchronized void mo18664a(C3775c.C3778a aVar) {
        ContentValues contentValues = new ContentValues();
        contentValues.put("id", aVar.f9743a);
        contentValues.put("value", aVar.f9744b.toString());
        contentValues.put("gen_time", Long.valueOf(System.currentTimeMillis()));
        contentValues.put(TapjoyConstants.TJC_RETRY, 0);
        C3909a.m12912a(mo18717e(), mo18714c(), contentValues);
    }

    /* renamed from: a */
    public synchronized void mo18665a(List<C3775c.C3778a> list) {
        if (!C2900j.m8097a(list)) {
            LinkedList linkedList = new LinkedList();
            for (C3775c.C3778a aVar : list) {
                linkedList.add(aVar.f9743a);
            }
            C3909a.m12911a(mo18717e(), "DELETE FROM " + mo18714c() + " WHERE " + m9046a("id", linkedList, 1000, true));
        }
    }
    ...
    /* renamed from: b */
    private synchronized void m9047b(int i, long j) {
        long currentTimeMillis = System.currentTimeMillis() - j;
        Context e = mo18717e();
        String c = mo18714c();
        C3909a.m12907a(e, c, "gen_time <? AND retry >?", new String[]{currentTimeMillis + "", i + ""});
    }

    /* renamed from: a */
    public synchronized void mo18666a(List<C3775c.C3778a> list, int i, long j) {
        if (!C2900j.m8097a(list)) {
            try {
                m9048b(list);
                m9047b(i, j);
    ...
    /* renamed from: b */
    private synchronized void m9048b(List<C3775c.C3778a> list) {
        LinkedList linkedList = new LinkedList();
        for (C3775c.C3778a aVar : list) {
            linkedList.add(aVar.f9743a);
        }
        C3909a.m12911a(mo18717e(), "UPDATE " + mo18714c() + " SET " + TapjoyConstants.TJC_RETRY + " = " + TapjoyConstants.TJC_RETRY + "+1" + " WHERE " + m9046a("id", linkedList, 1000, true));
    }

    /* renamed from: a */
    public void mo18667a(boolean z) {
        this.f7328a.mo19367a("stats_serverbusy_flag", z);
    }

    /* renamed from: a */
    public boolean mo18668a() {
        return this.f7328a.mo19371b("stats_serverbusy_flag", false);
    }
    ...
    /* renamed from: a */
    private static String m9046a(String str, List<?> list, int i, boolean z) {
        int i2;
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            int i4 = i3 * min;
            String a = m9045a(TextUtils.join("','", list.subList(i4, Math.min(i4 + min, size))), "");
            if (i3 != 0) {
                sb.append(str3);
            }
            sb.append(str);
        ...
        return m9045a(sb2, str + str2 + "('')");
    }

    /* renamed from: a */
    private static String m9045a(String str, String str2) {
