...
public abstract class TTDislikeDialogAbstract extends Dialog {
    ...
    /* renamed from: a */
    private void m8282a() {
        if (this.f6703b != null && this.f6702a != null) {
            ...
            int i = 0;
            while (i < length) {
                View findViewById = this.f6702a.findViewById(tTDislikeListViewIds[i]);
                if (findViewById == null) {
                    ...
                    ((TTDislikeListView) findViewById).setMaterialMeta(this.f6703b);
                    i++;
                } else {
                    throw new IllegalArgumentException("getTTDislikeListViewIds can not find view by Id , please check");
                }
