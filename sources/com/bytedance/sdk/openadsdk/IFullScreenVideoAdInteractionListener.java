...
public interface IFullScreenVideoAdInteractionListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IFullScreenVideoAdInteractionListener {
        ...
        private static class C2938a implements IFullScreenVideoAdInteractionListener {

            /* renamed from: a */
            public static IFullScreenVideoAdInteractionListener f6639a;

            /* renamed from: b */
            private IBinder f6640b;

            C2938a(IBinder iBinder) {
                this.f6640b = iBinder;
            }
            ...
            public void onDestroy() throws RemoteException {
                ...
                try {
                    ...
                    if (this.f6640b.transact(1, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
            ...
            public void onAdShow() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.bytedance.sdk.openadsdk.IFullScreenVideoAdInteractionListener");
                    if (this.f6640b.transact(2, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
            ...
            public void onAdVideoBarClick() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.bytedance.sdk.openadsdk.IFullScreenVideoAdInteractionListener");
                    if (this.f6640b.transact(3, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
            ...
            public void onAdClose() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.bytedance.sdk.openadsdk.IFullScreenVideoAdInteractionListener");
                    if (this.f6640b.transact(4, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
            ...
            public void onVideoComplete() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.bytedance.sdk.openadsdk.IFullScreenVideoAdInteractionListener");
                    if (this.f6640b.transact(5, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
            ...
            public void onSkippedVideo() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.bytedance.sdk.openadsdk.IFullScreenVideoAdInteractionListener");
                    if (this.f6640b.transact(6, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
        ...
        public static boolean setDefaultImpl(IFullScreenVideoAdInteractionListener iFullScreenVideoAdInteractionListener) {
            if (C2938a.f6639a != null || iFullScreenVideoAdInteractionListener == null) {
                return false;
            }
            C2938a.f6639a = iFullScreenVideoAdInteractionListener;
            return true;
        }

        public static IFullScreenVideoAdInteractionListener getDefaultImpl() {
            return C2938a.f6639a;
        }
    }
}
