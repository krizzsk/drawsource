...
public interface ICommonPermissionListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICommonPermissionListener {
        ...
        private static class C2936a implements ICommonPermissionListener {

            /* renamed from: a */
            public static ICommonPermissionListener f6635a;

            /* renamed from: b */
            private IBinder f6636b;

            C2936a(IBinder iBinder) {
                this.f6636b = iBinder;
            }
            ...
            public void onGranted() throws RemoteException {
                ...
                try {
                    ...
                    if (this.f6636b.transact(1, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
            ...
            public void onDenied(String str) throws RemoteException {
                ...
                try {
                    ...
                    if (this.f6636b.transact(2, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
        ...
        public static boolean setDefaultImpl(ICommonPermissionListener iCommonPermissionListener) {
            if (C2936a.f6635a != null || iCommonPermissionListener == null) {
                return false;
            }
            C2936a.f6635a = iCommonPermissionListener;
            return true;
        }

        public static ICommonPermissionListener getDefaultImpl() {
            return C2936a.f6635a;
        }
    }
}
