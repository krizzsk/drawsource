...
public class C3838h {
    /* renamed from: b */
    private static void m12531b(WebView webView) {
        try {
            webView.removeJavascriptInterface("searchBoxJavaBridge_");
            webView.removeJavascriptInterface("accessibility");
            webView.removeJavascriptInterface("accessibilityTraversal");
        } catch (Throwable th) {
            C3826f.m12457a("WebViewSettings", "removeJavascriptInterfacesSafe error", th);
        }
    }

    /* renamed from: a */
    private static void m12529a(WebSettings webSettings) {
        try {
            if (Build.VERSION.SDK_INT >= 17) {
                webSettings.setMediaPlaybackRequiresUserGesture(false);
            }
        } catch (Throwable th) {
            C3826f.m12457a("WebViewSettings", "allowMediaPlayWithoutUserGesture error", th);
        }
    }
    ...
    public static void m12530a(android.webkit.WebView r7) {
        /*
            java.lang.String r0 = "WebViewSettings"
            m12531b(r7)
            android.webkit.WebSettings r1 = r7.getSettings()
            m12529a((android.webkit.WebSettings) r1)
        ...
        L_0x0014:
            ...
            com.bytedance.sdk.openadsdk.p176j.C3826f.m12457a(r0, r4, r3)
        L_0x001a:
            r3 = 0
        ...
        L_0x001f:
            ...
            com.bytedance.sdk.openadsdk.p176j.C3826f.m12457a(r0, r5, r4)
        L_0x0025:
        ...
        L_0x0066:
            ...
            com.bytedance.sdk.openadsdk.p176j.C3826f.m12457a(r0, r2, r1)
        L_0x006c:
        ...
        L_0x0079:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.sdk.openadsdk.p176j.C3838h.m12530a(android.webkit.WebView):void");
    }
}
