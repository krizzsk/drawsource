...
class C3250b {
    ...
    /* renamed from: a */
    private static volatile C3250b f7701a;

    /* renamed from: b */
    private final Context f7702b;

    /* renamed from: c */
    private final C3301j f7703c;

    /* renamed from: d */
    private Map<C3431n, Long> f7704d = Collections.synchronizedMap(new HashMap());

    /* renamed from: com.bytedance.sdk.openadsdk.component.reward.b$a */
    /* compiled from: FullScreenVideoCache */
    interface C3254a<T> {
        /* renamed from: a */
        void mo19078a(boolean z, T t);
    }

    /* renamed from: a */
    public void mo19071a(String str) {
        this.f7703c.mo19143d(str);
    }
    ...
    public void mo19067a() {
        /*
            ...
            android.content.Context r4 = r9.f7702b     // Catch:{ all -> 0x0075 }
            java.io.File r4 = r4.getDataDir()     // Catch:{ all -> 0x0075 }
            r1.<init>(r4, r2)     // Catch:{ all -> 0x0075 }
            goto L_0x002b
        L_0x0015:
            android.content.Context r1 = r9.f7702b     // Catch:{ all -> 0x0075 }
        ...
        L_0x0044:
            ...
            android.content.Context r5 = r9.f7702b     // Catch:{ all -> 0x0072 }
            r5.deleteSharedPreferences(r6)     // Catch:{ all -> 0x0072 }
            goto L_0x0072
        L_0x005e:
            android.content.Context r7 = r9.f7702b     // Catch:{ all -> 0x0072 }
        ...
        L_0x0072:
            ...
            goto L_0x0044
        L_0x0075:
            android.content.Context r1 = r9.f7702b     // Catch:{ all -> 0x00a2 }
        ...
        L_0x00a2:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.sdk.openadsdk.component.reward.C3250b.mo19067a():void");
    }

    /* renamed from: a */
    public void mo19069a(AdSlot adSlot, C3431n nVar) {
        mo19068a(adSlot);
        if (nVar != null) {
            try {
                this.f7703c.mo19139a(adSlot.getCodeId(), nVar.mo19584ar().toString());
    ...
    /* renamed from: b */
    public AdSlot mo19073b(String str) {
        return this.f7703c.mo19144e(str);
    }

    /* renamed from: a */
    public void mo19068a(AdSlot adSlot) {
        this.f7703c.mo19138a(adSlot);
    }

    /* renamed from: b */
    public void mo19074b(AdSlot adSlot) {
        this.f7703c.mo19141b(adSlot);
    }

    /* renamed from: b */
    public AdSlot mo19072b() {
        return this.f7703c.mo19136a();
    }

    /* renamed from: a */
    public static C3250b m9568a(Context context) {
        if (f7701a == null) {
            synchronized (C3250b.class) {
                if (f7701a == null) {
                    f7701a = new C3250b(context);
                }
            }
        }
        return f7701a;
    ...
    private C3250b(Context context) {
        this.f7702b = context == null ? C3513m.m10963a() : context.getApplicationContext();
        this.f7703c = new C3301j(this.f7702b, "sp_full_screen_video");
    }

    /* renamed from: a */
    public String mo19065a(C3431n nVar) {
        if (nVar == null || nVar.mo19517J() == null || TextUtils.isEmpty(nVar.mo19517J().mo15953i())) {
            return null;
        }
        return mo19066a(nVar.mo19517J().mo15953i(), nVar.mo19517J().mo15957l(), nVar.mo19560aD());
    }

    /* renamed from: a */
    public String mo19066a(String str, String str2, int i) {
    ...
    /* renamed from: c */
    public C3431n mo19075c(String str) {
        C3431n a;
        long b = this.f7703c.mo19140b(str);
        boolean c = this.f7703c.mo19142c(str);
        if (!(System.currentTimeMillis() - b < 10500000) || c) {
            return null;
        }
        try {
            String a2 = this.f7703c.mo19137a(str);
            ...
            if (Build.VERSION.SDK_INT >= 23 || !TextUtils.isEmpty(mo19066a(J.mo15953i(), J.mo15957l(), a.mo19560aD()))) {
                return a;
            }
            return null;
    ...
    /* renamed from: a */
    public void m9571a(boolean z, C3431n nVar, long j, String str) {
        long j2;
        Long remove = this.f7704d.remove(nVar);
        if (remove == null) {
            j2 = 0;
        } else {
            j2 = SystemClock.elapsedRealtime() - remove.longValue();
        }
        C3090e.m8896a(this.f7702b, nVar, "fullscreen_interstitial_ad", z ? "load_video_success" : "load_video_error", C3898x.m12758a(z, nVar, j2, j, (z || str == null) ? null : str));
    }

    /* renamed from: a */
    public void mo19070a(final C3431n nVar, final C3254a<Object> aVar) {
        this.f7704d.put(nVar, Long.valueOf(SystemClock.elapsedRealtime()));
        if (nVar == null || nVar.mo19517J() == null || TextUtils.isEmpty(nVar.mo19517J().mo15953i())) {
            if (aVar != null) {
                aVar.mo19078a(false, null);
            }
            m9571a(false, nVar, -1, (String) null);
            return;
        }
        String i = nVar.mo19517J().mo15953i();
        File a = m9569a(nVar.mo19517J().mo15957l(), nVar.mo19560aD());
        ...
        d.mo17705a((C2842a) new C2842a() {
            ...
            public void mo17693a(C2848c cVar, C2843b bVar) {
                if (!bVar.mo17701f() || bVar.mo17700e() == null || !bVar.mo17700e().exists()) {
                    ...
                    C2905l.m8114c("FullScreenVideoCache", "onResponse: FullScreenVideo preload Fail ");
                    C3250b.this.m9571a(false, nVar, (long) bVar.mo17695a(), bVar.mo17697b());
                    return;
                }
                C3254a aVar2 = aVar;
                if (aVar2 != null) {
                    aVar2.mo19078a(true, null);
                }
                C2905l.m8114c("FullScreenVideoCache", "onResponse: FullScreenVideo preload success ");
                C3250b.this.m9571a(true, nVar, (long) bVar.mo17695a(), bVar.mo17697b());
            }
            ...
            public void mo17694a(C2848c cVar, IOException iOException) {
                ...
                C2905l.m8114c("FullScreenVideoCache", "onFailure: FullScreenVideo preload fail ");
                C3250b.this.m9571a(false, nVar, -2, iOException.getMessage());
            }
        });
    }

    /* renamed from: a */
    private File m9569a(String str, int i) {
