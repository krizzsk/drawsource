...
public class C3276e {
    ...
    public static void m9670a(String str, int i, String str2, String str3, String str4) {
        try {
            ...
            if (a != null) {
                if (a.mo19517J() != null) {
                    a.mo19517J().mo15942d(str5);
                }
                if (a.mo19567aa() != null) {
                    if (!TextUtils.isEmpty(str2)) {
                        a.mo19567aa().mo19403a(str2);
                        a.mo19567aa().mo19406b("Test the downloaded app");
                    } else {
                        a.mo19567aa().mo19403a((String) null);
                        a.mo19567aa().mo19406b("");
                    }
                    if (!TextUtils.isEmpty(str2)) {
                        a.mo19567aa().mo19408c(str3);
                    } else {
                        str2 = str4;
                    }
                    if (!TextUtils.isEmpty(str2)) {
                        if (a.mo19568ab() != null) {
                            a.mo19568ab().mo19445a(str2);
                        } else {
                ...
                if (a.mo19520M() != null) {
                    a.mo19520M().mo19470a("https://p0.ipstatp.com/origin/ad-site-i18n-sg/202011255d0d219920adb0fd474eac28");
                }
                if (i == 1) {
                    a.mo19655s(15);
                } else {
            ...
            C3302k kVar = new C3302k(C3513m.m10963a(), a, new AdSlot.Builder().build());
            kVar.mo19146a(true);
