...
public class C3960d {
    ...
    public static void m13014a(android.content.Context r2) {
        /*
            if (r2 != 0) goto L_0x0003
            return
        L_0x0003:
            android.content.Context r0 = r2.getApplicationContext()
            com.bytedance.sdk.openadsdk.multipro.p184d.C3961a.m13022a((android.content.Context) r0)
            int r0 = android.os.Build.VERSION.SDK_INT     // Catch:{ all -> 0x0044 }
            r1 = 28
            if (r0 < r1) goto L_0x004c
            boolean r0 = com.bytedance.sdk.component.utils.C2912r.m8145a(r2)     // Catch:{ all -> 0x0044 }
            if (r0 == 0) goto L_0x001a
            m13018b(r2)     // Catch:{ all -> 0x0044 }
            goto L_0x004c
        L_0x001a:
            java.lang.String r0 = com.bytedance.sdk.component.utils.C2912r.m8147b(r2)     // Catch:{ all -> 0x0044 }
        ...
        L_0x003c:
            ...
            goto L_0x004c
        L_0x0040:
            m13017a((java.lang.String) r0)     // Catch:{ all -> 0x0044 }
            goto L_0x004c
        L_0x0044:
            r2 = move-exception
            java.lang.String r2 = r2.getMessage()
            com.bytedance.sdk.component.utils.C2905l.m8110b(r2)
        L_0x004c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.sdk.openadsdk.multipro.C3960d.m13014a(android.content.Context):void");
    }

    /* renamed from: a */
    private static void m13017a(String str) {
        try {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:57:0x00df, code lost:
        com.bytedance.sdk.component.utils.C2905l.m8104a("checkWebViewDataLock try close exclusiveFileChannel : " + r2.getMessage());
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:62:0x00fc, code lost:
        com.bytedance.sdk.component.utils.C2905l.m8104a("checkWebViewDataLock try close accessFile : " + r1.getMessage());
     */
    ...
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static void m13018b(android.content.Context r7) {
        /*
        ...
        L_0x0022:
            ...
            com.bytedance.sdk.component.utils.C2905l.m8114c(r3, r7)
        ...
        L_0x005a:
            ...
            goto L_0x0069
        L_0x0066:
            m13015a((java.io.File) r2)     // Catch:{ Exception -> 0x0058, all -> 0x0055 }
        L_0x0069:
        ...
        L_0x006f:
            ...
            com.bytedance.sdk.component.utils.C2905l.m8104a((java.lang.String) r7)
        L_0x0086:
        ...
        L_0x0096:
            r3 = r7
        L_0x0097:
            m13015a((java.io.File) r2)     // Catch:{ all -> 0x00d5 }
        ...
        L_0x00de:
            ...
            com.bytedance.sdk.component.utils.C2905l.m8104a((java.lang.String) r1)
        L_0x00f5:
        ...
        L_0x00fb:
            ...
            com.bytedance.sdk.component.utils.C2905l.m8104a((java.lang.String) r0)
        L_0x0112:
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.sdk.openadsdk.multipro.C3960d.m13018b(android.content.Context):void");
    }

    /* renamed from: a */
    private static void m13015a(File file) {
        m13016a(file, file.exists() ? file.delete() : false);
    }

    /* renamed from: a */
    private static void m13016a(File file, boolean z) {
        if (z && !file.exists()) {
            try {
                file.createNewFile();
            } catch (IOException e) {
