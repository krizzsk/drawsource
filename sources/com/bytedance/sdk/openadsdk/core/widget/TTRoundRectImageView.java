...
public class TTRoundRectImageView extends ImageView {
    ...
    public TTRoundRectImageView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f9494a.setFilterBitmap(true);
        this.f9497d = new Matrix();
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (drawable != null) {
            ...
            if (a != null) {
                ...
                this.f9497d.setScale(f, f);
                bitmapShader.setLocalMatrix(this.f9497d);
                this.f9494a.setShader(bitmapShader);
                canvas.drawRoundRect(new RectF(0.0f, 0.0f, (float) getWidth(), (float) getHeight()), (float) this.f9495b, (float) this.f9496c, this.f9494a);
                return;
            }
            super.onDraw(canvas);
            return;
    ...
    /* renamed from: a */
    private Bitmap m12023a(Drawable drawable) {
        if (drawable == null) {
            return null;
        }
