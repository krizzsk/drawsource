...
public class RoundImageView extends ImageView {
        ...
        if (drawable != null && getWidth() != 0 && getHeight() != 0) {
            ...
            if (drawable.getClass() != NinePatchDrawable.class) {
                ...
                if (bitmap3 != null) {
                    ...
                    if (this.f9446a == 0) {
                        this.f9446a = getWidth();
                    }
                    if (this.f9447b == 0) {
                        this.f9447b = getHeight();
                    }
                    int i = this.f9446a;
                    int i2 = this.f9447b;
                    if (i >= i2) {
                    ...
                    if (bitmap2 == null) {
                        ...
                        canvas.drawBitmap(bitmap2, (float) ((this.f9446a / 2) - i3), (float) ((this.f9447b / 2) - i3), (Paint) null);
                    }
                }
            }
        }
    ...
    /* renamed from: a */
    private Bitmap m12008a(Bitmap bitmap, int i) {
        Bitmap bitmap2;
        int i2 = i * 2;
