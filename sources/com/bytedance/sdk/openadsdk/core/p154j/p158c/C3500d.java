...
public class C3500d {
    ...
    /* renamed from: a */
    public static final List<String> f8745a = Arrays.asList(new String[]{"video/mp4", "video/3gpp"});

    /* renamed from: a */
    public static double m10879a(int i, double d, int i2, int i3, int i4, String str) {
        double a = m10878a(i, d, i2, i3);
        return m10880a(str) * (1.0d / ((a + 1.0d) + m10877a(i4)));
    }

    /* renamed from: a */
    private static double m10878a(int i, double d, int i2, int i3) {
        double d2 = 0.0d;
    ...
    /* renamed from: a */
    private static double m10877a(int i) {
    ...
    /* renamed from: a */
    private static double m10880a(String str) {
        if (str == null) {
            str = "";
        }
        char c = 65535;
