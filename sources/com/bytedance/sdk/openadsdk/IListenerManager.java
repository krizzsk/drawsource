...
public interface IListenerManager extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IListenerManager {
        ...
        private static class C2939a implements IListenerManager {

            /* renamed from: a */
            public static IListenerManager f6641a;

            /* renamed from: b */
            private IBinder f6642b;

            C2939a(IBinder iBinder) {
                this.f6642b = iBinder;
            }
            ...
            public void registerRewardVideoListener(String str, IRewardAdInteractionListener iRewardAdInteractionListener) throws RemoteException {
                ...
                try {
                    ...
                    if (this.f6642b.transact(1, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
            ...
            public void executeRewardVideoCallback(String str, String str2, boolean z, int i, String str3, int i2, String str4) throws RemoteException {
                ...
                try {
                    ...
                    try {
                        if (this.f6642b.transact(2, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                            obtain2.readException();
                            obtain2.recycle();
                            obtain.recycle();
                            return;
            ...
            public void registerFullVideoListener(String str, IFullScreenVideoAdInteractionListener iFullScreenVideoAdInteractionListener) throws RemoteException {
                ...
                try {
                    ...
                    if (this.f6642b.transact(3, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
            ...
            public void executeFullVideoCallback(String str, String str2) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeString(str);
                    obtain.writeString(str2);
                    if (this.f6642b.transact(4, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
            ...
            public void registerDialogListener(String str, ICommonDialogListener iCommonDialogListener) throws RemoteException {
                ...
                try {
                    ...
                    if (this.f6642b.transact(5, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
            ...
            public void broadcastDialogListener(String str, int i) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeString(str);
                    obtain.writeInt(i);
                    if (this.f6642b.transact(6, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
            ...
            public void registerPermissionListener(String str, ICommonPermissionListener iCommonPermissionListener) throws RemoteException {
                ...
                try {
                    ...
                    if (this.f6642b.transact(7, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
            ...
            public void broadcastPermissionListener(String str, String str2) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeString(str);
                    obtain.writeString(str2);
                    if (this.f6642b.transact(8, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
            ...
            public void registerDisLikeClosedListener(String str, IDislikeClosedListener iDislikeClosedListener) throws RemoteException {
                ...
                try {
                    ...
                    if (this.f6642b.transact(9, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
            ...
            public void unregisterDisLikeClosedListener(String str) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.bytedance.sdk.openadsdk.IListenerManager");
                    obtain.writeString(str);
                    if (this.f6642b.transact(10, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
            ...
            public void executeDisLikeClosedCallback(String str, String str2) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeString(str);
                    obtain.writeString(str2);
                    if (this.f6642b.transact(11, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
            ...
            public void registerAppOpenAdListener(String str, IAppOpenAdInteractionListener iAppOpenAdInteractionListener) throws RemoteException {
                ...
                try {
                    ...
                    if (this.f6642b.transact(12, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
            ...
            public void executeAppOpenAdCallback(String str, String str2) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeString(str);
                    obtain.writeString(str2);
                    if (this.f6642b.transact(13, obtain, obtain2, 0) || Stub.getDefaultImpl() == null) {
                        obtain2.readException();
                        obtain2.recycle();
                        obtain.recycle();
                        return;
            ...
            public Map query(Uri uri, String[] strArr, String str, String[] strArr2, String str2) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeString(str2);
                    if (!this.f6642b.transact(14, obtain, obtain2, 0) && Stub.getDefaultImpl() != null) {
            ...
            public String getType(Uri uri) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.f6642b.transact(15, obtain, obtain2, 0) && Stub.getDefaultImpl() != null) {
            ...
            public String insert(Uri uri, ContentValues contentValues) throws RemoteException {
                ...
                try {
                    ...
                    if (!this.f6642b.transact(16, obtain, obtain2, 0) && Stub.getDefaultImpl() != null) {
            ...
            public int delete(Uri uri, String str, String[] strArr) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeString(str);
                    obtain.writeStringArray(strArr);
                    if (!this.f6642b.transact(17, obtain, obtain2, 0) && Stub.getDefaultImpl() != null) {
            ...
            public int update(Uri uri, ContentValues contentValues, String str, String[] strArr) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeString(str);
                    obtain.writeStringArray(strArr);
                    if (!this.f6642b.transact(18, obtain, obtain2, 0) && Stub.getDefaultImpl() != null) {
        ...
        public static boolean setDefaultImpl(IListenerManager iListenerManager) {
            if (C2939a.f6641a != null || iListenerManager == null) {
                return false;
            }
            C2939a.f6641a = iListenerManager;
            return true;
        }

        public static IListenerManager getDefaultImpl() {
            return C2939a.f6641a;
        }
    }
}
