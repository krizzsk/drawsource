...
public class NetworkProvider {
    ...
    /* renamed from: cm */
    private final ConnectivityManager f29779cm;
    ...
    private NetworkProvider(Context context) {
        ...
        this.f29779cm = (ConnectivityManager) applicationContext.getSystemService("connectivity");
    ...
    private synchronized void setEnableNetworkListener(boolean z) {
        if (this.enabled != z) {
            this.enabled = z;
            if (this.f29779cm != null) {
                if (z) {
                    try {
                        NetworkRequest.Builder builder = new NetworkRequest.Builder();
                        builder.addCapability(12);
                        this.f29779cm.registerNetworkCallback(builder.build(), getNetworkCallback());
                    } catch (Exception e) {
                        Log.e(TAG, e.getMessage());
                    }
                } else {
                    this.f29779cm.unregisterNetworkCallback(getNetworkCallback());
                }
            }
        } else {
            return;
    ...
    private ConnectivityManager.NetworkCallback getNetworkCallback() {
        ...
        C124531 r0 = new ConnectivityManager.NetworkCallback() {
    ...
    public int getCurrentNetworkType() {
        int i = -1;
        if (this.f29779cm == null || PermissionChecker.checkCallingOrSelfPermission(this.ctx, "android.permission.ACCESS_NETWORK_STATE") != 0) {
            this.currentNetwork.set(-1);
            return -1;
        }
        NetworkInfo activeNetworkInfo = this.f29779cm.getActiveNetworkInfo();
