...
public class AnalyticsJob implements Job {
    ...
    public @interface Action {
        ...
        /* renamed from: RI */
        public static final int f29778RI = 0;
    ...
    public int onRunJob(Bundle bundle, JobRunner jobRunner) {
        ...
        if (i == 0) {
            this.adAnalytics.mo71737ri(((JsonElement) new Gson().fromJson(bundle.getString(EXTRA_BODY), JsonElement.class)).getAsJsonObject());
            return 0;
        } else if (i == 1) {
