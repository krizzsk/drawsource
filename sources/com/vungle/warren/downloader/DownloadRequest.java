...
public class DownloadRequest {
    ...
    public String toString() {
        return "DownloadRequest{networkType=" + this.networkType + ", priority=" + this.priority + ", url='" + this.url + '\'' + ", path='" + this.path + '\'' + ", pauseOnConnectionLost=" + this.pauseOnConnectionLost + ", id='" + this.f29776id + '\'' + ", cookieString='" + this.cookieString + '\'' + ", cancelled=" + this.cancelled + ", advertisementId=" + this.advertisementId + '}';
    }
    ...
    public DownloadRequest(int i, AssetPriority assetPriority, String str, String str2, boolean z, String str3, String str4) {
        ...
        this.url = str;
        this.path = str2;
        this.f29776id = UUID.nameUUIDFromBytes((str2 + "_" + str).getBytes()).toString();
