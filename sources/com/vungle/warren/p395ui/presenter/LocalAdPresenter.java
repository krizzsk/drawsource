package com.vungle.warren.p395ui.presenter;
...
import com.vungle.warren.p395ui.DurationRecorder;
import com.vungle.warren.p395ui.PresenterAdOpenCallback;
import com.vungle.warren.p395ui.PresenterAppLeftCallback;
import com.vungle.warren.p395ui.contract.AdContract;
import com.vungle.warren.p395ui.contract.LocalAdContract;
import com.vungle.warren.p395ui.state.OptionsState;
import com.vungle.warren.p395ui.view.WebViewAPI;
...
public class LocalAdPresenter implements LocalAdContract.LocalPresenter, WebViewAPI.WebClientErrorHandler {
    ...
    public void reportAction(String str, String str2) {
        ...
        if (hashCode != -840405966) {
            if (hashCode != 3363353) {
                if (hashCode == 1370606900 && str.equals(AnalyticsEvent.C12333Ad.videoClose)) {
                    c = 2;
                }
        ...
        this.fileExistenceOperation = AsyncFileUtils.isFileExistAsync(file2, new AsyncFileUtils.FileExistCallback() {
            public void status(boolean z) {
                if (z) {
                    ...
                    LocalAdPresenter.this.analytics.ping(LocalAdPresenter.this.advertisement.getTpatUrls(AnalyticsEvent.C12333Ad.postrollView));
    ...
    private void showGDPR(final Cookie cookie) {
        C124013 r5 = new DialogInterface.OnClickListener() {
    ...
    public boolean handleExit() {
        if (this.inPost) {
            ...
            if (!this.placement.isIncentivized() || this.progress > 75) {
                reportAction(AnalyticsEvent.C12333Ad.videoClose, (String) null);
    ...
    private void showIncetivizedDialog() {
        ...
        showDialog(str, str2, str3, str4, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialogInterface, int i) {
                if (i == -2) {
                    LocalAdPresenter.this.reportAction(AnalyticsEvent.C12333Ad.videoClose, (String) null);
    ...
    public void onProgressUpdate(int i, float f) {
        ...
        if (this.placement.isIncentivized() && this.progress > 75 && cookie != null && cookie.getBoolean("isReportIncentivizedEnabled").booleanValue() && !this.sendReportIncentivized.getAndSet(true)) {
            ...
            this.analytics.mo71737ri(jsonObject);
        }
    }
    ...
    public void onMraidAction(java.lang.String r5) {
        ...
        L_0x003c:
            ...
            r0.<init>()
            java.lang.Class<com.vungle.warren.ui.presenter.LocalAdPresenter> r1 = com.vungle.warren.p395ui.presenter.LocalAdPresenter.class
        ...
        L_0x0079:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.vungle.warren.p395ui.presenter.LocalAdPresenter.onMraidAction(java.lang.String):void");
    }
    ...
    private void download() {
        ...
        L_0x00aa:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.vungle.warren.p395ui.presenter.LocalAdPresenter.download():void");
    }
