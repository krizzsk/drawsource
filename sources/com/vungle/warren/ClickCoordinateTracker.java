...
public class ClickCoordinateTracker {
        ...
        if (this.adAnalytics != null && (tpatUrls = this.advertisement.getTpatUrls(Advertisement.TPAT_CLICK_COORDINATES_URLS)) != null && tpatUrls.length != 0) {
            ...
            for (int i = 0; i < tpatUrls.length; i++) {
                ...
                if (!TextUtils.isEmpty(str)) {
                    tpatUrls[i] = str.replaceAll(MACRO_REQ_WIDTH, Integer.toString(requestWidth)).replaceAll(MACRO_REQ_HEIGHT, Integer.toString(requestHeight)).replaceAll(MACRO_WIDTH, Integer.toString(requestWidth2)).replaceAll(MACRO_HEIGHT, Integer.toString(requestHeight2)).replaceAll(MACRO_DOWN_X, Integer.toString(this.currentClick.downCoordinate.f29772x)).replaceAll(MACRO_DOWN_Y, Integer.toString(this.currentClick.downCoordinate.f29773y)).replaceAll(MACRO_UP_X, Integer.toString(this.currentClick.upCoordinate.f29772x)).replaceAll(MACRO_UP_Y, Integer.toString(this.currentClick.upCoordinate.f29773y));
                }
            }
    ...
    static class ClickCoordinate {
        ...
        public boolean ready() {
            return (this.downCoordinate.f29772x == Integer.MIN_VALUE || this.downCoordinate.f29773y == Integer.MIN_VALUE || this.upCoordinate.f29772x == Integer.MIN_VALUE || this.upCoordinate.f29773y == Integer.MIN_VALUE) ? false : true;
        }
    }
    ...
    public static class DeviceScreenInfo {
        ...
        /* renamed from: dm */
        private final DisplayMetrics f29774dm = new DisplayMetrics();

        private DeviceScreenInfo(Context context2) {
            this.context = context2.getApplicationContext();
            ((WindowManager) this.context.getSystemService("window")).getDefaultDisplay().getMetrics(this.f29774dm);
        }
        ...
        public int getDeviceWidth() {
            return this.f29774dm.widthPixels;
        }

        public int getDeviceHeight() {
            return this.f29774dm.heightPixels;
        }
    }
}
