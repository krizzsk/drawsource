...
public final class ViewIndexer {
            ...
            try {
                ...
                FacebookSdk.getExecutor().execute(new Runnable(viewIndexer$schedule$indexingTask$1) {
                    ...
                    public final void run() {
                        ViewIndexer.m33631schedule$lambda0(ViewIndexer.this, this.f$1);
                    }
                });
    ...
    public static final void m33631schedule$lambda0(ViewIndexer viewIndexer, TimerTask timerTask) {
        Class<ViewIndexer> cls = ViewIndexer.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
        ...
        if (!CrashShieldHandler.isObjectCrashing(this)) {
            try {
                ...
                FacebookSdk.getExecutor().execute(new Runnable(str, this) {
                    ...
                    public final void run() {
                        ViewIndexer.m33632sendToServer$lambda1(this.f$0, this.f$1);
                    }
                });
            } catch (Throwable th) {
                CrashShieldHandler.handleThrowable(th, this);
    ...
    public static final void m33632sendToServer$lambda1(String str, ViewIndexer viewIndexer) {
        Class<ViewIndexer> cls = ViewIndexer.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
    ...
    @Metadata(mo72582d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0002\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u000f\b\u0000\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0002\u0010\u0005J\b\u0010\u0007\u001a\u00020\u0002H\u0016R\u0014\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00040\u0006X\u0004¢\u0006\u0002\n\u0000¨\u0006\b"}, mo72583d2 = {"Lcom/facebook/appevents/codeless/ViewIndexer$ScreenshotTaker;", "Ljava/util/concurrent/Callable;", "", "rootView", "Landroid/view/View;", "(Landroid/view/View;)V", "Ljava/lang/ref/WeakReference;", "call", "facebook-core_release"}, mo72584k = 1, mo72585mv = {1, 5, 1}, mo72587xi = 48)
    /* compiled from: ViewIndexer.kt */
    ...
    public static final class Companion {
        ...
        public static final void m33633buildAppIndexingRequest$lambda0(GraphResponse graphResponse) {
