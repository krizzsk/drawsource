...
public final class CodelessManager {
                        ...
                        if (sensorManager2 != null) {
                            ...
                            viewIndexingTrigger.setOnShakeListener(new ViewIndexingTrigger.OnShakeListener(applicationId) {
                                ...
                                public final void onShake() {
                                    CodelessManager.m33628onActivityResumed$lambda0(FetchedAppSettings.this, this.f$1);
                                }
                            });
    ...
    public static final void m33628onActivityResumed$lambda0(FetchedAppSettings fetchedAppSettings, String str) {
        Class<CodelessManager> cls = CodelessManager.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                ...
                if (!isCheckingSession) {
                    ...
                    FacebookSdk.getExecutor().execute(new Runnable(str) {
                        ...
                        public final void run() {
                            CodelessManager.m33627checkCodelessSession$lambda1(this.f$0);
                        }
                    });
                }
            } catch (Throwable th) {
    ...
    public static final void m33627checkCodelessSession$lambda1(String str) {
        String str2;
        String str3 = "0";
        Class<CodelessManager> cls = CodelessManager.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
