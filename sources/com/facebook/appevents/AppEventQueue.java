...
public final class AppEventQueue {
    ...
    public static final void m33601flushRunnable$lambda0() {
    ...
    public static final void m33603persistToDisk$lambda1() {
        Class<AppEventQueue> cls = AppEventQueue.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
            ...
            try {
                ...
                singleThreadExecutor.execute(new Runnable() {
                    public final void run() {
                        AppEventQueue.m33600flush$lambda2(FlushReason.this);
                    }
                });
            } catch (Throwable th) {
                CrashShieldHandler.handleThrowable(th, cls);
    ...
    public static final void m33600flush$lambda2(FlushReason flushReason) {
        Class<AppEventQueue> cls = AppEventQueue.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
        ...
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                ...
                singleThreadExecutor.execute(new Runnable(appEvent) {
                    ...
                    public final void run() {
                        AppEventQueue.m33598add$lambda3(AccessTokenAppIdPair.this, this.f$1);
                    }
                });
            } catch (Throwable th) {
                CrashShieldHandler.handleThrowable(th, cls);
    ...
    public static final void m33598add$lambda3(AccessTokenAppIdPair accessTokenAppIdPair, AppEvent appEvent) {
        Class<AppEventQueue> cls = AppEventQueue.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                Intrinsics.checkNotNullParameter(accessTokenAppIdPair, "$accessTokenAppId");
        ...
        try {
            ...
            newPostRequest.setCallback(new GraphRequest.Callback(newPostRequest, sessionEventsState, flushStatistics) {
                ...
                public final void onCompleted(GraphResponse graphResponse) {
                    AppEventQueue.m33599buildRequestForSession$lambda4(AccessTokenAppIdPair.this, this.f$1, this.f$2, this.f$3, graphResponse);
                }
            });
    ...
    public static final void m33599buildRequestForSession$lambda4(AccessTokenAppIdPair accessTokenAppIdPair, GraphRequest graphRequest, SessionEventsState sessionEventsState, FlushStatistics flushStatistics, GraphResponse graphResponse) {
        Class<AppEventQueue> cls = AppEventQueue.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                Intrinsics.checkNotNullParameter(accessTokenAppIdPair, "$accessTokenAppId");
            ...
            try {
                ...
                if (flushResult == FlushResult.NO_CONNECTIVITY) {
                    ...
                    FacebookSdk.getExecutor().execute(new Runnable(sessionEventsState2) {
                        ...
                        public final void run() {
                            AppEventQueue.m33602handleResponse$lambda5(AccessTokenAppIdPair.this, this.f$1);
                        }
                    });
                }
    ...
    public static final void m33602handleResponse$lambda5(AccessTokenAppIdPair accessTokenAppIdPair, SessionEventsState sessionEventsState) {
        Class<AppEventQueue> cls = AppEventQueue.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                Intrinsics.checkNotNullParameter(accessTokenAppIdPair, "$accessTokenAppId");
