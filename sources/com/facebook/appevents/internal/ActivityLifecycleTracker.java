...
public final class ActivityLifecycleTracker {
    ...
    public static final void m33645startTracking$lambda0(boolean z) {
        if (z) {
    ...
    public static final void m33641onActivityCreated$lambda1() {
    ...
    public static final void onActivityResumed(Activity activity) {
        ...
        singleThreadExecutor.execute(new Runnable(currentTimeMillis, activityName, activity.getApplicationContext()) {
            ...
            public final void run() {
                ActivityLifecycleTracker.m33644onActivityResumed$lambda2(this.f$0, this.f$1, this.f$2);
            }
        });
    }
    ...
    public static final void m33644onActivityResumed$lambda2(long j, String str, Context context) {
        SessionInfo sessionInfo;
    ...
    public final void onActivityPaused(Activity activity) {
        ...
        singleThreadExecutor.execute(new Runnable(currentTimeMillis, activityName) {
            ...
            public final void run() {
                ActivityLifecycleTracker.m33642onActivityPaused$lambda6(this.f$0, this.f$1);
            }
        });
    }
    ...
    public static final void m33642onActivityPaused$lambda6(long j, String str) {
        Intrinsics.checkNotNullParameter(str, "$activityName");
        if (currentSession == null) {
            currentSession = new SessionInfo(Long.valueOf(j), (Long) null, (UUID) null, 4, (DefaultConstructorMarker) null);
        }
        ...
        if (foregroundActivityCount.get() <= 0) {
            $$Lambda$ActivityLifecycleTracker$3_sU20C6cin3z58vx2KmrQAdBZ8 r0 = new Runnable(j, str) {
                ...
                public final void run() {
                    ActivityLifecycleTracker.m33643onActivityPaused$lambda6$lambda4(this.f$0, this.f$1);
                }
            };
    ...
    public static final void m33643onActivityPaused$lambda6$lambda4(long j, String str) {
        Intrinsics.checkNotNullParameter(str, "$activityName");
        if (currentSession == null) {
            currentSession = new SessionInfo(Long.valueOf(j), (Long) null, (UUID) null, 4, (DefaultConstructorMarker) null);
        }
