...
public final class OnDeviceProcessingManager {
                ...
                if (applicationContext != null && str != null && str2 != null) {
                    ...
                    FacebookSdk.getExecutor().execute(new Runnable(applicationContext, str2, str) {
                        ...
                        public final void run() {
                            OnDeviceProcessingManager.m33652sendInstallEventAsync$lambda0(this.f$0, this.f$1, this.f$2);
                        }
                    });
                }
            } catch (Throwable th) {
    ...
    public static final void m33652sendInstallEventAsync$lambda0(Context context, String str, String str2) {
        Class<OnDeviceProcessingManager> cls = OnDeviceProcessingManager.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
            ...
            try {
                ...
                if (INSTANCE.isEventEligibleForOnDeviceProcessing(appEvent)) {
                    ...
                    FacebookSdk.getExecutor().execute(new Runnable(str, appEvent) {
                        ...
                        public final void run() {
                            OnDeviceProcessingManager.m33651sendCustomEventAsync$lambda1(this.f$0, this.f$1);
                        }
                    });
                }
            } catch (Throwable th) {
    ...
    public static final void m33651sendCustomEventAsync$lambda1(String str, AppEvent appEvent) {
        Class<OnDeviceProcessingManager> cls = OnDeviceProcessingManager.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                Intrinsics.checkNotNullParameter(str, "$applicationId");
