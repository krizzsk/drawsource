...
public final class AppEventsConversionsAPITransformerWebRequests {
    ...
    private static final HashSet<Integer> RETRY_EVENTS_HTTP_RESPONSE = SetsKt.hashSetOf(503, Integer.valueOf(C12600c.COLLECT_MODE_TIKTOK_GUEST), 429);
    ...
    public static final void transformGraphRequestAndSendToCAPIGEndPoint(GraphRequest graphRequest) {
        ...
        Utility.runOnNonUiThread(new Runnable() {
            public final void run() {
                AppEventsConversionsAPITransformerWebRequests.m33622transformGraphRequestAndSendToCAPIGEndPoint$lambda0(GraphRequest.this);
            }
        });
    }
    ...
    public static final void m33622transformGraphRequestAndSendToCAPIGEndPoint$lambda0(GraphRequest graphRequest) {
        Intrinsics.checkNotNullParameter(graphRequest, "$request");
        ...
        try {
            ...
            if (transformAppEventRequestForCAPIG != null) {
                ...
                INSTANCE.makeHttpRequest$facebook_core_release(str, ShareTarget.METHOD_POST, jSONObject.toString(), MapsKt.mapOf(TuplesKt.m33378to("Content-Type", "application/json")), 60000, new C3995xf719cce4(slice));
            }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:38:?, code lost:
        kotlin.p403io.CloseableKt.closeFinally(r10, r8);
     */
    ...
    public final void makeHttpRequest$facebook_core_release(java.lang.String r8, java.lang.String r9, java.lang.String r10, java.util.Map<java.lang.String, java.lang.String> r11, int r12, kotlin.jvm.functions.Function2<? super java.lang.String, ? super java.lang.Integer, kotlin.Unit> r13) {
        ...
        L_0x00c3:
            ...
            kotlin.p403io.CloseableKt.closeFinally(r10, r11)     // Catch:{ UnknownHostException -> 0x011a, IOException -> 0x0107 }
            goto L_0x00d0
        L_0x00c9:
            r8 = move-exception
        ...
        L_0x00cb:
            r9 = move-exception
            kotlin.p403io.CloseableKt.closeFinally(r10, r8)     // Catch:{ UnknownHostException -> 0x011a, IOException -> 0x0107 }
