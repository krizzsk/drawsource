...
@Metadata(mo72582d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\u0010\u0000\u001a\u00020\u00012\b\u0010\u0002\u001a\u0004\u0018\u00010\u00032\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005H\n"}, mo72583d2 = {"<anonymous>", "", "<anonymous parameter 0>", "", "responseCode", ""}, mo72584k = 3, mo72585mv = {1, 5, 1}, mo72587xi = 48)
...
final class C3995xf719cce4 extends Lambda implements Function2<String, Integer, Unit> {
    final /* synthetic */ List<Map<String, Object>> $processedEvents;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    C3995xf719cce4(List<? extends Map<String, ? extends Object>> list) {
        super(2);
    ...
    public final void invoke(String str, Integer num) {
        ...
        Utility.runOnNonUiThread(new Runnable(num, this.$processedEvents) {
            ...
            public final void run() {
                C3995xf719cce4.m33623invoke$lambda0(this.f$0, this.f$1);
            }
        });
    }
    ...
    public static final void m33623invoke$lambda0(Integer num, List list) {
