    ...
    public static final void initialize(File file) {
        ...
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                ...
                try {
                    languageInfo = MapsKt.mapOf(TuplesKt.m33378to(ViewHierarchyConstants.ENGLISH, "1"), TuplesKt.m33378to(ViewHierarchyConstants.GERMAN, "2"), TuplesKt.m33378to(ViewHierarchyConstants.SPANISH, "3"), TuplesKt.m33378to(ViewHierarchyConstants.JAPANESE, MBridgeConstans.DYNAMIC_VIEW_TYPE_ALTER_NATIVE_STR_4));
                    eventInfo = MapsKt.mapOf(TuplesKt.m33378to(ViewHierarchyConstants.VIEW_CONTENT, "0"), TuplesKt.m33378to(ViewHierarchyConstants.SEARCH, "1"), TuplesKt.m33378to(ViewHierarchyConstants.ADD_TO_CART, "2"), TuplesKt.m33378to(ViewHierarchyConstants.ADD_TO_WISHLIST, "3"), TuplesKt.m33378to(ViewHierarchyConstants.INITIATE_CHECKOUT, MBridgeConstans.DYNAMIC_VIEW_TYPE_ALTER_NATIVE_STR_4), TuplesKt.m33378to(ViewHierarchyConstants.ADD_PAYMENT_INFO, "5"), TuplesKt.m33378to(ViewHierarchyConstants.PURCHASE, "6"), TuplesKt.m33378to(ViewHierarchyConstants.LEAD, "7"), TuplesKt.m33378to(ViewHierarchyConstants.COMPLETE_REGISTRATION, "8"));
                    textTypeInfo = MapsKt.mapOf(TuplesKt.m33378to(ViewHierarchyConstants.BUTTON_TEXT, "1"), TuplesKt.m33378to(ViewHierarchyConstants.PAGE_TITLE, "2"), TuplesKt.m33378to(ViewHierarchyConstants.RESOLVED_DOCUMENT_LINK, "3"), TuplesKt.m33378to(ViewHierarchyConstants.BUTTON_ID, MBridgeConstans.DYNAMIC_VIEW_TYPE_ALTER_NATIVE_STR_4));
                    initialized = true;
                } catch (Throwable th) {
                    CrashShieldHandler.handleThrowable(th, cls);
                }
