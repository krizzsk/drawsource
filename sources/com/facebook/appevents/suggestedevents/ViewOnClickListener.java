...
public final class ViewOnClickListener implements View.OnClickListener {
            ...
            try {
                ...
                Utility.runOnNonUiThread(new Runnable(jSONObject, str2, this, str) {
                    ...
                    public final void run() {
                        ViewOnClickListener.m33656predictAndProcess$lambda0(this.f$0, this.f$1, this.f$2, this.f$3);
                    }
                });
            } catch (Throwable th) {
                CrashShieldHandler.handleThrowable(th, this);
    ...
    public static final void m33656predictAndProcess$lambda0(JSONObject jSONObject, String str, ViewOnClickListener viewOnClickListener, String str2) {
        Class<ViewOnClickListener> cls = ViewOnClickListener.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
    ...
    public static final class Companion {
        ...
        public final boolean queryHistoryAndProcess(String str, String str2) {
            ...
            Utility.runOnNonUiThread(new Runnable(queryEvent, str2) {
                ...
                public final void run() {
                    ViewOnClickListener.Companion.m33657queryHistoryAndProcess$lambda0(this.f$0, this.f$1);
                }
            });
            return true;
        }
        ...
        public static final void m33657queryHistoryAndProcess$lambda0(String str, String str2) {
