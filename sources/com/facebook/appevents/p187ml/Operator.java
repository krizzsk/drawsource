...
public final class Operator {
    ...
    public static final void addmv(MTensor mTensor, MTensor mTensor2) {
        ...
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                ...
                Intrinsics.checkNotNullParameter(mTensor2, DownloadCommon.DOWNLOAD_REPORT_FIND_FILE_RESULT_VALUE_B);
    ...
    public static final MTensor dense(MTensor mTensor, MTensor mTensor2, MTensor mTensor3) {
        ...
        try {
            ...
            Intrinsics.checkNotNullParameter(mTensor3, DownloadCommon.DOWNLOAD_REPORT_FIND_FILE_RESULT_VALUE_B);
            int shape = mTensor.getShape(0);
