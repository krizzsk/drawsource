...
@Metadata(mo72582d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\bÇ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\b\u0010\u0005\u001a\u00020\u0006H\u0002J\u0010\u0010\u0007\u001a\u00020\u00062\u0006\u0010\b\u001a\u00020\tH\u0007R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\n"}, mo72583d2 = {"Lcom/facebook/appevents/iap/InAppPurchaseAutoLogger;", "", "()V", "BILLING_CLIENT_PURCHASE_NAME", "", "logPurchase", "", "startIapLogging", "context", "Landroid/content/Context;", "facebook-core_release"}, mo72584k = 1, mo72585mv = {1, 5, 1}, mo72587xi = 48)
...
public final class InAppPurchaseAutoLogger {
            ...
            try {
                ...
                if (InAppPurchaseUtils.getClass(BILLING_CLIENT_PURCHASE_NAME) != null && (orCreateInstance = InAppPurchaseBillingClientWrapper.Companion.getOrCreateInstance(context)) != null && InAppPurchaseBillingClientWrapper.Companion.isServiceConnected().get()) {
                    ...
                    if (InAppPurchaseLoggerManager.eligibleQueryPurchaseHistory()) {
                        orCreateInstance.queryPurchaseHistory(BillingClient.SkuType.INAPP, $$Lambda$InAppPurchaseAutoLogger$687IX7AaP5K7d5ER9XfsPCHYVU.INSTANCE);
                    } else {
                        orCreateInstance.queryPurchase(BillingClient.SkuType.INAPP, $$Lambda$InAppPurchaseAutoLogger$Wwi5DeOus3p2VMp5XwmTDyqKUU8.INSTANCE);
                    }
                }
            } catch (Throwable th) {
    ...
    public static final void m33637startIapLogging$lambda0() {
        Class<InAppPurchaseAutoLogger> cls = InAppPurchaseAutoLogger.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
    ...
    public static final void m33638startIapLogging$lambda1() {
        Class<InAppPurchaseAutoLogger> cls = InAppPurchaseAutoLogger.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                INSTANCE.logPurchase();
