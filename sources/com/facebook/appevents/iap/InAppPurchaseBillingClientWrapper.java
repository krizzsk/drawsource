...
public final class InAppPurchaseBillingClientWrapper {
            ...
            try {
                ...
                queryPurchaseHistoryAsync(str, new Runnable(runnable) {
                    ...
                    public final void run() {
                        InAppPurchaseBillingClientWrapper.m33640queryPurchaseHistory$lambda0(InAppPurchaseBillingClientWrapper.this, this.f$1);
                    }
                });
            } catch (Throwable th) {
    ...
    public static final void m33640queryPurchaseHistory$lambda0(InAppPurchaseBillingClientWrapper inAppPurchaseBillingClientWrapper, Runnable runnable) {
        Class<InAppPurchaseBillingClientWrapper> cls = InAppPurchaseBillingClientWrapper.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
