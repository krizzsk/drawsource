...
public class GameRequestDialog extends FacebookDialogBase<GameRequestContent, Result> {
    ...
    public static final class Result {
        ...
        /* renamed from: to */
        List<String> f10099to;

        private Result(Bundle bundle) {
            this.requestId = bundle.getString("request");
            this.f10099to = new ArrayList();
            while (true) {
                if (bundle.containsKey(String.format(ShareConstants.WEB_DIALOG_RESULT_PARAM_TO_ARRAY_MEMBER, new Object[]{Integer.valueOf(this.f10099to.size())}))) {
                    List<String> list = this.f10099to;
        ...
        private Result(GraphResponse graphResponse) {
            try {
                ...
                for (int i = 0; i < jSONArray.length(); i++) {
                    this.f10099to.add(jSONArray.getString(i));
                }
    ...
    private void showForCloud(GameRequestContent gameRequestContent, Object obj) {
        ...
        C40353 r1 = new DaemonRequest.Callback() {
