...
public abstract class FacebookButtonBase extends Button {
    ...
    protected FacebookButtonBase(Context context, AttributeSet attributeSet, int i, int i2, String str, String str2) {
        ...
        configureButton(context, attributeSet, i, i2 == 0 ? C4014R.style.com_facebook_button : i2);
            ...
            try {
                if (!isInEditMode()) {
                    ...
                    if (obtainStyledAttributes.hasValue(0)) {
                        ...
                        setBackgroundColor(ContextCompat.getColor(context, C4014R.color.com_facebook_blue));
                    }
            ...
            try {
                super.setOnClickListener(new View.OnClickListener() {
                    public final void onClick(View view) {
                        FacebookButtonBase.m33571setupOnClickListener$lambda0(FacebookButtonBase.this, view);
                    }
                });
            } catch (Throwable th) {
                CrashShieldHandler.handleThrowable(th, this);
    ...
    public static final void m33571setupOnClickListener$lambda0(FacebookButtonBase facebookButtonBase, View view) {
