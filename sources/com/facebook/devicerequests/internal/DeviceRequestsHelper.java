    ...
    private final boolean startAdvertisementServiceImpl(String str) {
        ...
        try {
            ...
            if (systemService != null) {
                NsdManager.RegistrationListener deviceRequestsHelper$startAdvertisementServiceImpl$nsdRegistrationListener$1 = new C4021x8b27078b(str2, str);
