...
public class GameRequestDialog extends FacebookDialogBase<GameRequestContent, Result> {
    ...
    public static final class Result {
        ...
        /* renamed from: to */
        List<String> f10108to;

        private Result(Bundle bundle) {
            this.requestId = bundle.getString("request");
            this.f10108to = new ArrayList();
            while (true) {
                if (bundle.containsKey(String.format(ShareConstants.WEB_DIALOG_RESULT_PARAM_TO_ARRAY_MEMBER, new Object[]{Integer.valueOf(this.f10108to.size())}))) {
                    List<String> list = this.f10108to;
