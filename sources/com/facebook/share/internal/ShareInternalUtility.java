...
public final class ShareInternalUtility {
    ...
    public static final void registerStaticShareCallback(int i) {
        CallbackManagerImpl.Companion.registerStaticCallback(i, new CallbackManagerImpl.Callback(i) {
            ...
            public final boolean onActivityResult(int i, Intent intent) {
                return ShareInternalUtility.m33760registerStaticShareCallback$lambda0(this.f$0, i, intent);
            }
        });
    }
    ...
    public static final boolean m33760registerStaticShareCallback$lambda0(int i, int i2, Intent intent) {
    ...
    public static final void registerSharerCallback(int i, CallbackManager callbackManager, FacebookCallback<Sharer.Result> facebookCallback) {
        if (callbackManager instanceof CallbackManagerImpl) {
            ((CallbackManagerImpl) callbackManager).registerCallback(i, new CallbackManagerImpl.Callback(i, facebookCallback) {
                ...
                public final boolean onActivityResult(int i, Intent intent) {
                    return ShareInternalUtility.m33759registerSharerCallback$lambda1(this.f$0, this.f$1, i, intent);
                }
            });
            return;
        }
    ...
    public static final boolean m33759registerSharerCallback$lambda1(int i, FacebookCallback facebookCallback, int i2, Intent intent) {
