...
public abstract class NativeAppLoginMethodHandler extends LoginMethodHandler {
            ...
            if (!Utility.isNullOrEmpty(bundle.getString("code"))) {
                ...
                FacebookSdk.getExecutor().execute(new Runnable(request, bundle) {
                    ...
                    public final void run() {
                        NativeAppLoginMethodHandler.m33756processSuccessResponse$lambda0(NativeAppLoginMethodHandler.this, this.f$1, this.f$2);
                    }
                });
                return;
            }
    ...
    public static final void m33756processSuccessResponse$lambda0(NativeAppLoginMethodHandler nativeAppLoginMethodHandler, LoginClient.Request request, Bundle bundle) {
