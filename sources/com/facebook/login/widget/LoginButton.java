...
import com.facebook.login.C4068R;
...
public class LoginButton extends FacebookButtonBase {
    ...
    public int getLoginButtonContinueLabel() {
        return C4068R.string.com_facebook_loginview_log_in_button_continue;
    }
    ...
    static /* synthetic */ class C40774 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.login.widget.LoginButton.C40774.<clinit>():void");
        }
    }
    ...
    private void checkToolTipSettings() {
        if (!CrashShieldHandler.isObjectCrashing(this)) {
            try {
                int i = C40774.$SwitchMap$com$facebook$login$widget$LoginButton$ToolTipMode[this.toolTipMode.ordinal()];
                if (i == 1) {
                    ...
                    displayToolTip(getResources().getString(C4068R.string.com_facebook_tooltip_default));
                }
            } catch (Throwable th) {
                CrashShieldHandler.handleThrowable(th, this);
            }
    ...
    public void configureButton(Context context, AttributeSet attributeSet, int i, int i2) {
        if (!CrashShieldHandler.isObjectCrashing(this)) {
            try {
                ...
                if (isInEditMode()) {
                    setBackgroundColor(getResources().getColor(C4014R.color.com_facebook_blue));
    ...
    public int getDefaultStyleResource() {
        return C4068R.style.com_facebook_loginview_default_style;
    }
    ...
    public void parseLoginButtonAttributes(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        if (!CrashShieldHandler.isObjectCrashing(this)) {
            try {
                ...
                obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C4068R.styleable.com_facebook_login_view, i, i2);
                this.confirmLogout = obtainStyledAttributes.getBoolean(C4068R.styleable.com_facebook_login_view_com_facebook_confirm_logout, true);
                this.loginText = obtainStyledAttributes.getString(C4068R.styleable.com_facebook_login_view_com_facebook_login_text);
                this.logoutText = obtainStyledAttributes.getString(C4068R.styleable.com_facebook_login_view_com_facebook_logout_text);
                this.toolTipMode = ToolTipMode.fromInt(obtainStyledAttributes.getInt(C4068R.styleable.com_facebook_login_view_com_facebook_tooltip_mode, ToolTipMode.DEFAULT.getValue()));
                if (obtainStyledAttributes.hasValue(C4068R.styleable.com_facebook_login_view_com_facebook_login_button_radius)) {
                    this.customButtonRadius = Float.valueOf(obtainStyledAttributes.getDimension(C4068R.styleable.com_facebook_login_view_com_facebook_login_button_radius, 0.0f));
                }
                int integer = obtainStyledAttributes.getInteger(C4068R.styleable.com_facebook_login_view_com_facebook_login_button_transparency, 255);
    ...
    public void onMeasure(int i, int i2) {
        if (!CrashShieldHandler.isObjectCrashing(this)) {
            try {
                ...
                if (str == null) {
                    str = resources.getString(C4068R.string.com_facebook_loginview_log_out_button);
                }
    ...
    public int getLoginButtonWidth(int i) {
        ...
        try {
            ...
            if (str == null) {
                str = resources.getString(C4068R.string.com_facebook_loginview_log_in_button_continue);
                int measureButtonWidth = measureButtonWidth(str);
                if (resolveSize(measureButtonWidth, i) < measureButtonWidth) {
                    str = resources.getString(C4068R.string.com_facebook_loginview_log_in_button);
                }
            }
            ...
            try {
                ...
                if (!isInEditMode() && AccessToken.isCurrentAccessTokenActive()) {
                    ...
                    if (width != 0 && measureButtonWidth(string) > width) {
                        string = resources.getString(C4068R.string.com_facebook_loginview_log_in_button);
                    }
                    setText(string);
                }
            } catch (Throwable th) {
            ...
            if (!CrashShieldHandler.isObjectCrashing(this)) {
                try {
                    ...
                    if (LoginButton.this.confirmLogout) {
                        String string = LoginButton.this.getResources().getString(C4068R.string.com_facebook_loginview_log_out_action);
                        String string2 = LoginButton.this.getResources().getString(C4068R.string.com_facebook_loginview_cancel_action);
                        Profile currentProfile = Profile.getCurrentProfile();
                        if (currentProfile == null || currentProfile.getName() == null) {
                            str = LoginButton.this.getResources().getString(C4068R.string.com_facebook_loginview_logged_in_using_facebook);
                        } else {
                            str = String.format(LoginButton.this.getResources().getString(C4068R.string.com_facebook_loginview_logged_in_as), new Object[]{currentProfile.getName()});
                        }
