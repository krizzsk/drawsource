...
public class ProfilePictureView extends FrameLayout {
    ...
    private void parseAttributes(AttributeSet attributeSet) {
        if (!CrashShieldHandler.isObjectCrashing(this)) {
            try {
                TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C4068R.styleable.com_facebook_profile_picture_view);
                setPresetSize(obtainStyledAttributes.getInt(C4068R.styleable.com_facebook_profile_picture_view_com_facebook_preset_size, -1));
                this.isCropped = obtainStyledAttributes.getBoolean(C4068R.styleable.com_facebook_profile_picture_view_com_facebook_is_cropped, true);
        ...
        if (!CrashShieldHandler.isObjectCrashing(this)) {
            try {
                ...
                if (this.customizedDefaultProfilePicture == null) {
                    setImageBitmap(BitmapFactory.decodeResource(getResources(), isCropped() ? C4068R.C4069drawable.com_facebook_profile_picture_blank_square : C4068R.C4069drawable.com_facebook_profile_picture_blank_portrait));
                    return;
                }
    ...
    private int getPresetSizeInPixels(boolean z) {
        ...
        try {
            ...
            if (i2 == -4) {
                i = C4068R.dimen.com_facebook_profilepictureview_preset_size_large;
            } else if (i2 == -3) {
                i = C4068R.dimen.com_facebook_profilepictureview_preset_size_normal;
            } else if (i2 == -2) {
                i = C4068R.dimen.com_facebook_profilepictureview_preset_size_small;
            } else if (i2 != -1 || !z) {
                return 0;
            } else {
                i = C4068R.dimen.com_facebook_profilepictureview_preset_size_normal;
