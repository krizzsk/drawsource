...
public class DeviceAuthDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        Dialog deviceAuthDialog$onCreateDialog$dialog$1 = new DeviceAuthDialog$onCreateDialog$dialog$1(this, requireActivity(), C4014R.style.com_facebook_auth_dialog);
    ...
    public void startLogin(LoginClient.Request request2) {
        ...
        GraphRequest.Companion.newPostRequestWithBundle((AccessToken) null, DEVICE_LOGIN_ENDPOINT, bundle, new GraphRequest.Callback() {
            public final void onCompleted(GraphResponse graphResponse) {
                DeviceAuthDialog.m33744startLogin$lambda1(DeviceAuthDialog.this, graphResponse);
            }
        }).executeAsync();
    }
    ...
    public static final void m33744startLogin$lambda1(DeviceAuthDialog deviceAuthDialog, GraphResponse graphResponse) {
    ...
    public View initializeContentView(boolean z) {
        ...
        View findViewById = inflate.findViewById(C4014R.C4016id.progress_bar);
        Intrinsics.checkNotNullExpressionValue(findViewById, "view.findViewById(R.id.progress_bar)");
        this.progressBar = findViewById;
        View findViewById2 = inflate.findViewById(C4014R.C4016id.confirmation_code);
        if (findViewById2 != null) {
            this.confirmationCode = (TextView) findViewById2;
            View findViewById3 = inflate.findViewById(C4014R.C4016id.cancel_button);
            if (findViewById3 != null) {
                ((Button) findViewById3).setOnClickListener(new View.OnClickListener() {
                    public final void onClick(View view) {
                        DeviceAuthDialog.m33737initializeContentView$lambda2(DeviceAuthDialog.this, view);
                    }
                });
                View findViewById4 = inflate.findViewById(C4014R.C4016id.com_facebook_device_auth_instructions);
                if (findViewById4 != null) {
                    TextView textView = (TextView) findViewById4;
                    this.instructions = textView;
                    if (textView != null) {
                        textView.setText(Html.fromHtml(getString(C4014R.string.com_facebook_device_auth_instructions)));
                        return inflate;
                    }
                    Intrinsics.throwUninitializedPropertyAccessException("instructions");
                    throw null;
    ...
    public static final void m33737initializeContentView$lambda2(DeviceAuthDialog deviceAuthDialog, View view) {
        Intrinsics.checkNotNullParameter(deviceAuthDialog, "this$0");
    ...
    public int getLayoutResId(boolean z) {
        if (z) {
            return C4014R.layout.com_facebook_smart_device_dialog_fragment;
        }
        return C4014R.layout.com_facebook_device_auth_dialog_fragment;
    }
        ...
        if (valueOf != null) {
            this.scheduledPoll = DeviceAuthMethodHandler.Companion.getBackgroundExecutor().schedule(new Runnable() {
                public final void run() {
                    DeviceAuthDialog.m33743schedulePoll$lambda3(DeviceAuthDialog.this);
                }
    ...
    public static final void m33743schedulePoll$lambda3(DeviceAuthDialog deviceAuthDialog) {
        Intrinsics.checkNotNullParameter(deviceAuthDialog, "this$0");
    ...
    private final GraphRequest getPollRequest() {
        ...
        return GraphRequest.Companion.newPostRequestWithBundle((AccessToken) null, DEVICE_LOGIN_STATUS_ENDPOINT, bundle, new GraphRequest.Callback() {
            public final void onCompleted(GraphResponse graphResponse) {
                DeviceAuthDialog.m33736_get_pollRequest_$lambda5(DeviceAuthDialog.this, graphResponse);
            }
        });
    }
    ...
    public static final void m33736_get_pollRequest_$lambda5(DeviceAuthDialog deviceAuthDialog, GraphResponse graphResponse) {
        Intrinsics.checkNotNullParameter(deviceAuthDialog, "this$0");
        Intrinsics.checkNotNullParameter(graphResponse, "response");
    ...
    private final void presentConfirmation(String str, PermissionsLists permissionsLists, String str2, String str3, Date date, Date date2) {
        String string = getResources().getString(C4014R.string.com_facebook_smart_login_confirmation_title);
        Intrinsics.checkNotNullExpressionValue(string, "resources.getString(R.string.com_facebook_smart_login_confirmation_title)");
        String string2 = getResources().getString(C4014R.string.com_facebook_smart_login_confirmation_continue_as);
        ...
        String string3 = getResources().getString(C4014R.string.com_facebook_smart_login_confirmation_cancel);
        ...
        builder.setMessage(string).setCancelable(true).setNegativeButton(format, new DialogInterface.OnClickListener(str, permissionsLists, str2, date, date2) {
            ...
            public final void onClick(DialogInterface dialogInterface, int i) {
                DeviceAuthDialog.m33741presentConfirmation$lambda6(DeviceAuthDialog.this, this.f$1, this.f$2, this.f$3, this.f$4, this.f$5, dialogInterface, i);
            }
        }).setPositiveButton(string3, new DialogInterface.OnClickListener() {
            public final void onClick(DialogInterface dialogInterface, int i) {
                DeviceAuthDialog.m33742presentConfirmation$lambda8(DeviceAuthDialog.this, dialogInterface, i);
            }
        });
        builder.create().show();
    }
    ...
    public static final void m33741presentConfirmation$lambda6(DeviceAuthDialog deviceAuthDialog, String str, PermissionsLists permissionsLists, String str2, Date date, Date date2, DialogInterface dialogInterface, int i) {
        Intrinsics.checkNotNullParameter(deviceAuthDialog, "this$0");
    ...
    public static final void m33742presentConfirmation$lambda8(DeviceAuthDialog deviceAuthDialog, DialogInterface dialogInterface, int i) {
        Intrinsics.checkNotNullParameter(deviceAuthDialog, "this$0");
    ...
    private final void onSuccess(String str, long j, Long l) {
        ...
        GraphRequest newGraphPathRequest = GraphRequest.Companion.newGraphPathRequest(new AccessToken(str, FacebookSdk.getApplicationId(), "0", (Collection) null, (Collection) null, (Collection) null, (AccessTokenSource) null, date2, (Date) null, date, (String) null, 1024, (DefaultConstructorMarker) null), TournamentShareDialogURIBuilder.f10102me, new GraphRequest.Callback(str, date2, date) {
            public final /* synthetic */ String f$1;
            ...
            public final void onCompleted(GraphResponse graphResponse) {
                DeviceAuthDialog.m33740onSuccess$lambda10(DeviceAuthDialog.this, this.f$1, this.f$2, this.f$3, graphResponse);
            }
        });
    ...
    public static final void m33740onSuccess$lambda10(DeviceAuthDialog deviceAuthDialog, String str, Date date, Date date2, GraphResponse graphResponse) {
    ...
    private static final class RequestState implements Parcelable {
        ...
        @Metadata(mo72582d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0016\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u00048\u0006X\u0004¢\u0006\u0002\n\u0000¨\u0006\u0006"}, mo72583d2 = {"Lcom/facebook/login/DeviceAuthDialog$RequestState$Companion;", "", "()V", "CREATOR", "Landroid/os/Parcelable$Creator;", "Lcom/facebook/login/DeviceAuthDialog$RequestState;", "facebook-common_release"}, mo72584k = 1, mo72585mv = {1, 5, 1}, mo72587xi = 48)
        /* compiled from: DeviceAuthDialog.kt */
    ...
    public static final class Companion {
        ...
        public final int mo22969xe18b7be4() {
    ...
    @Metadata(mo72582d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010 \n\u0002\u0010\u000e\n\u0002\b\f\b\u0002\u0018\u00002\u00020\u0001B/\u0012\f\u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003\u0012\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003\u0012\f\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003¢\u0006\u0002\u0010\u0007R \u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003X\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\b\u0010\t\"\u0004\b\n\u0010\u000bR \u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003X\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\f\u0010\t\"\u0004\b\r\u0010\u000bR \u0010\u0002\u001a\b\u0012\u0004\u0012\u00020\u00040\u0003X\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u000e\u0010\t\"\u0004\b\u000f\u0010\u000b¨\u0006\u0010"}, mo72583d2 = {"Lcom/facebook/login/DeviceAuthDialog$PermissionsLists;", "", "grantedPermissions", "", "", "declinedPermissions", "expiredPermissions", "(Ljava/util/List;Ljava/util/List;Ljava/util/List;)V", "getDeclinedPermissions", "()Ljava/util/List;", "setDeclinedPermissions", "(Ljava/util/List;)V", "getExpiredPermissions", "setExpiredPermissions", "getGrantedPermissions", "setGrantedPermissions", "facebook-common_release"}, mo72584k = 1, mo72585mv = {1, 5, 1}, mo72587xi = 48)
    /* compiled from: DeviceAuthDialog.kt */
