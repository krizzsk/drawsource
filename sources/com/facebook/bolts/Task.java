...
public final class Task<TResult> {
    ...
    @Metadata(mo72582d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bæ\u0001\u0018\u00002\u00020\u0001J\u001c\u0010\u0002\u001a\u00020\u00032\n\u0010\u0004\u001a\u0006\u0012\u0002\b\u00030\u00052\u0006\u0010\u0006\u001a\u00020\u0007H&¨\u0006\b"}, mo72583d2 = {"Lcom/facebook/bolts/Task$UnobservedExceptionHandler;", "", "unobservedException", "", "t", "Lcom/facebook/bolts/Task;", "e", "Lcom/facebook/bolts/UnobservedTaskException;", "facebook-bolts_release"}, mo72584k = 1, mo72585mv = {1, 5, 1}, mo72587xi = 48)
    /* compiled from: Task.kt */
    ...
    public static final Task m33664makeVoid$lambda8(Task task) {
                ...
                if (list != null) {
                    list.add(new Continuation(continuation, executor, cancellationToken) {
                        ...
                        public final Object then(Task task) {
                            return Task.m33659continueWith$lambda10$lambda9(TaskCompletionSource.this, this.f$1, this.f$2, this.f$3, task);
                        }
                    });
                }
            }
    ...
    public static final Void m33659continueWith$lambda10$lambda9(TaskCompletionSource taskCompletionSource, Continuation continuation, Executor executor, CancellationToken cancellationToken, Task task) {
            ...
            if (!isCompleted) {
                ...
                if (list != null) {
                    list.add(new Continuation(continuation, executor, cancellationToken) {
                        ...
                        public final Object then(Task task) {
                            return Task.m33660continueWithTask$lambda12$lambda11(TaskCompletionSource.this, this.f$1, this.f$2, this.f$3, task);
                        }
                    });
                }
            }
    ...
    public static final Void m33660continueWithTask$lambda12$lambda11(TaskCompletionSource taskCompletionSource, Continuation continuation, Executor executor, CancellationToken cancellationToken, Task task) {
        Intrinsics.checkNotNullParameter(taskCompletionSource, "$tcs");
        Intrinsics.checkNotNullParameter(continuation, "$continuation");
        Intrinsics.checkNotNullParameter(executor, "$executor");
        Intrinsics.checkNotNullParameter(task, "task");
    ...
    public final <TContinuationResult> Task<TContinuationResult> onSuccess(Continuation<TResult, TContinuationResult> continuation, Executor executor, CancellationToken cancellationToken) {
        ...
        return continueWithTask(new Continuation(continuation) {
            ...
            public final Object then(Task task) {
                return Task.m33665onSuccess$lambda13(CancellationToken.this, this.f$1, task);
            }
        }, executor);
    }
    ...
    public static final Task m33665onSuccess$lambda13(CancellationToken cancellationToken, Continuation continuation, Task task) {
        Intrinsics.checkNotNullParameter(continuation, "$continuation");
        Intrinsics.checkNotNullParameter(task, "task");
    ...
    public final <TContinuationResult> Task<TContinuationResult> onSuccessTask(Continuation<TResult, Task<TContinuationResult>> continuation, Executor executor, CancellationToken cancellationToken) {
        ...
        return continueWithTask(new Continuation(continuation) {
            ...
            public final Object then(Task task) {
                return Task.m33666onSuccessTask$lambda14(CancellationToken.this, this.f$1, task);
            }
        }, executor);
    }
    ...
    public static final Task m33666onSuccessTask$lambda14(CancellationToken cancellationToken, Continuation continuation, Task task) {
        Intrinsics.checkNotNullParameter(continuation, "$continuation");
        Intrinsics.checkNotNullParameter(task, "task");
        if (cancellationToken != null && cancellationToken.isCancellationRequested()) {
            return Companion.cancelled();
    ...
    @Metadata(mo72582d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0004\u0018\u00002\b\u0012\u0004\u0012\u00028\u00000\u0001B\u0007\b\u0000¢\u0006\u0002\u0010\u0002¨\u0006\u0003"}, mo72583d2 = {"Lcom/facebook/bolts/Task$TaskCompletionSource;", "Lcom/facebook/bolts/TaskCompletionSource;", "(Lcom/facebook/bolts/Task;)V", "facebook-bolts_release"}, mo72584k = 1, mo72585mv = {1, 5, 1}, mo72587xi = 48)
    ...
    public static final class Companion {
        ...
        public final Task<Void> delay$facebook_bolts_release(long j, ScheduledExecutorService scheduledExecutorService, CancellationToken cancellationToken) {
            ...
            ScheduledFuture<?> schedule = scheduledExecutorService.schedule(new Runnable() {
                public final void run() {
                    Task.Companion.m33671delay$lambda0(TaskCompletionSource.this);
                }
            ...
            if (cancellationToken != null) {
                cancellationToken.register(new Runnable(schedule, taskCompletionSource) {
                    ...
                    public final void run() {
                        Task.Companion.m33672delay$lambda1(this.f$0, this.f$1);
                    }
                });
            }
            return taskCompletionSource.getTask();
        ...
        public static final void m33671delay$lambda0(TaskCompletionSource taskCompletionSource) {
            Intrinsics.checkNotNullParameter(taskCompletionSource, "$tcs");
        ...
        public static final void m33672delay$lambda1(ScheduledFuture scheduledFuture, TaskCompletionSource taskCompletionSource) {
            Intrinsics.checkNotNullParameter(taskCompletionSource, "$tcs");
        ...
        public final <TResult> Task<TResult> call(Callable<TResult> callable, Executor executor, CancellationToken cancellationToken) {
            ...
            try {
                executor.execute(new Runnable(taskCompletionSource, callable) {
                    ...
                    public final void run() {
                        Task.Companion.m33667call$lambda2(CancellationToken.this, this.f$1, this.f$2);
                    }
                });
            } catch (Exception e) {
        ...
        public static final void m33667call$lambda2(CancellationToken cancellationToken, TaskCompletionSource taskCompletionSource, Callable callable) {
            Intrinsics.checkNotNullParameter(taskCompletionSource, "$tcs");
            Intrinsics.checkNotNullParameter(callable, "$callable");
            if (cancellationToken == null || !cancellationToken.isCancellationRequested()) {
                try {
        ...
        public final <TResult> Task<Task<TResult>> whenAnyResult(Collection<Task<TResult>> collection) {
            ...
            for (Task<TResult> continueWith : collection) {
                continueWith.continueWith(new Continuation(atomicBoolean, taskCompletionSource) {
                    ...
                    public final Object then(Task task) {
                        return Task.Companion.m33676whenAnyResult$lambda3(this.f$0, this.f$1, task);
                    }
                });
            }
            return taskCompletionSource.getTask();
        ...
        public static final Void m33676whenAnyResult$lambda3(AtomicBoolean atomicBoolean, TaskCompletionSource taskCompletionSource, Task task) {
        ...
        public final Task<Task<?>> whenAny(Collection<? extends Task<?>> collection) {
            ...
            for (Task continueWith : collection) {
                continueWith.continueWith(new Continuation(atomicBoolean, taskCompletionSource) {
                    ...
                    public final Object then(Task task) {
                        return Task.Companion.m33675whenAny$lambda4(this.f$0, this.f$1, task);
                    }
                });
            }
            return taskCompletionSource.getTask();
        ...
        public static final Void m33675whenAny$lambda4(AtomicBoolean atomicBoolean, TaskCompletionSource taskCompletionSource, Task task) {
            Intrinsics.checkNotNullParameter(atomicBoolean, "$isAnyTaskComplete");
            Intrinsics.checkNotNullParameter(taskCompletionSource, "$firstCompleted");
            Intrinsics.checkNotNullParameter(task, "it");
            if (atomicBoolean.compareAndSet(false, true)) {
        ...
        public final <TContinuationResult, TResult> void completeImmediately(TaskCompletionSource<TContinuationResult> taskCompletionSource, Continuation<TResult, TContinuationResult> continuation, Task<TResult> task, Executor executor, CancellationToken cancellationToken) {
            try {
                executor.execute(new Runnable(taskCompletionSource, continuation, task) {
                    ...
                    public final void run() {
                        Task.Companion.m33670completeImmediately$lambda5(CancellationToken.this, this.f$1, this.f$2, this.f$3);
                    }
                });
            } catch (Exception e) {
                taskCompletionSource.setError(new ExecutorException(e));
        ...
        public static final void m33670completeImmediately$lambda5(CancellationToken cancellationToken, TaskCompletionSource taskCompletionSource, Continuation continuation, Task task) {
            Intrinsics.checkNotNullParameter(taskCompletionSource, "$tcs");
            Intrinsics.checkNotNullParameter(continuation, "$continuation");
            Intrinsics.checkNotNullParameter(task, "$task");
            if (cancellationToken == null || !cancellationToken.isCancellationRequested()) {
        ...
        public final <TContinuationResult, TResult> void completeAfterTask(TaskCompletionSource<TContinuationResult> taskCompletionSource, Continuation<TResult, Task<TContinuationResult>> continuation, Task<TResult> task, Executor executor, CancellationToken cancellationToken) {
            try {
                executor.execute(new Runnable(taskCompletionSource, continuation, task) {
                    ...
                    public final void run() {
                        Task.Companion.m33668completeAfterTask$lambda7(CancellationToken.this, this.f$1, this.f$2, this.f$3);
                    }
                });
            } catch (Exception e) {
                taskCompletionSource.setError(new ExecutorException(e));
        ...
        public static final void m33668completeAfterTask$lambda7(CancellationToken cancellationToken, TaskCompletionSource taskCompletionSource, Continuation continuation, Task task) {
            Intrinsics.checkNotNullParameter(taskCompletionSource, "$tcs");
            Intrinsics.checkNotNullParameter(continuation, "$continuation");
            Intrinsics.checkNotNullParameter(task, "$task");
            if (cancellationToken == null || !cancellationToken.isCancellationRequested()) {
                try {
                    ...
                    if (task2 == null) {
                        ...
                        task2.continueWith(new Continuation(taskCompletionSource) {
                            ...
                            public final Object then(Task task) {
                                return Task.Companion.m33669completeAfterTask$lambda7$lambda6(CancellationToken.this, this.f$1, task);
                            }
                        });
                    }
                } catch (CancellationException unused) {
        ...
        public static final Void m33669completeAfterTask$lambda7$lambda6(CancellationToken cancellationToken, TaskCompletionSource taskCompletionSource, Task task) {
            Intrinsics.checkNotNullParameter(taskCompletionSource, "$tcs");
            Intrinsics.checkNotNullParameter(task, "task");
            if (cancellationToken == null || !cancellationToken.isCancellationRequested()) {
                if (task.isCancelled()) {
