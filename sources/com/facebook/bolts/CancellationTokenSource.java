...
public final class CancellationTokenSource implements Closeable {
                    ...
                    if (i != 0) {
                        this.scheduledCancellation = this.executor.schedule(new Runnable() {
                            public final void run() {
                                CancellationTokenSource.m33658cancelAfter$lambda6$lambda5(CancellationTokenSource.this);
                            }
                        }, j, timeUnit);
                    }
                    Unit unit = Unit.INSTANCE;
    ...
    public static final void m33658cancelAfter$lambda6$lambda5(CancellationTokenSource cancellationTokenSource) {
