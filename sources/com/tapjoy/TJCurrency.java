...
public class TJCurrency {
    ...
    /* renamed from: d */
    private static TJGetCurrencyBalanceListener f26643d;

    /* renamed from: e */
    private static TJSpendCurrencyListener f26644e;

    /* renamed from: f */
    private static TJAwardCurrencyListener f26645f;

    /* renamed from: g */
    private static TJEarnedCurrencyListener f26646g;
    ...
    public void saveCurrencyBalance(int i) {
        SharedPreferences.Editor edit = this.f26649c.getSharedPreferences(TapjoyConstants.TJC_PREFERENCE, 0).edit();
        edit.putInt(TapjoyConstants.PREF_LAST_CURRENCY_BALANCE, i);
        edit.apply();
    }

    public int getLocalCurrencyBalance() {
        return this.f26649c.getSharedPreferences(TapjoyConstants.TJC_PREFERENCE, 0).getInt(TapjoyConstants.PREF_LAST_CURRENCY_BALANCE, -9999);
    }

    public void getCurrencyBalance(TJGetCurrencyBalanceListener tJGetCurrencyBalanceListener) {
        f26643d = tJGetCurrencyBalanceListener;
        ...
        new Thread(new Runnable() {
            public final void run() {
                ...
                TJCurrency.this.m30738a(tapjoyURLConnection.getResponseFromURL(TapjoyConnectCore.getHostURL() + TapjoyConstants.TJC_GET_CURRENCY_BALANCE_URL_PATH, (Map<String, String>) uRLParams));
            }
        }).start();
    }
    ...
    public void spendCurrency(int i, TJSpendCurrencyListener tJSpendCurrencyListener) {
        if (i < 0) {
            TapjoyLog.m30840e("TJCurrency", new TapjoyErrorMessage(TapjoyErrorMessage.ErrorType.INTEGRATION_ERROR, "Amount must be a positive number for the spendCurrency API"));
            return;
        }
        this.f26647a = String.valueOf(i);
        f26644e = tJSpendCurrencyListener;
        final Map<String, String> uRLParams = TapjoyConnectCore.getURLParams();
        TapjoyUtil.safePut(uRLParams, TapjoyConstants.TJC_CURRENCY, this.f26647a, true);
        new Thread(new Runnable() {
            public final void run() {
                TapjoyURLConnection tapjoyURLConnection = new TapjoyURLConnection();
                TJCurrency.this.m30740b(tapjoyURLConnection.getResponseFromURL(TapjoyConnectCore.getHostURL() + TapjoyConstants.TJC_SPEND_CURRENCY_URL_PATH, (Map<String, String>) uRLParams));
            }
        }).start();
    }
    ...
    public void awardCurrency(int i, TJAwardCurrencyListener tJAwardCurrencyListener) {
        if (i < 0) {
            TapjoyLog.m30840e("TJCurrency", new TapjoyErrorMessage(TapjoyErrorMessage.ErrorType.INTEGRATION_ERROR, "Amount must be a positive number for the awardCurrency API"));
            return;
        }
        this.f26648b = i;
        f26645f = tJAwardCurrencyListener;
        String uuid = UUID.randomUUID().toString();
        long currentTimeMillis = System.currentTimeMillis() / 1000;
        final Map<String, String> genericURLParams = TapjoyConnectCore.getGenericURLParams();
        TapjoyUtil.safePut(genericURLParams, TapjoyConstants.TJC_CURRENCY, String.valueOf(this.f26648b), true);
        ...
        TapjoyUtil.safePut(genericURLParams, TapjoyConstants.TJC_VERIFIER, TapjoyConnectCore.getAwardCurrencyVerifier(currentTimeMillis, this.f26648b, uuid), true);
        new Thread(new Runnable() {
            public final void run() {
                TapjoyURLConnection tapjoyURLConnection = new TapjoyURLConnection();
                TJCurrency.this.m30742c(tapjoyURLConnection.getResponseFromURL(TapjoyConnectCore.getHostURL() + TapjoyConstants.TJC_AWARD_CURRENCY_URL_PATH, (Map<String, String>) genericURLParams));
            }
        }).start();
    }

    public void setEarnedCurrencyListener(TJEarnedCurrencyListener tJEarnedCurrencyListener) {
        f26646g = tJEarnedCurrencyListener;
    }
    ...
    public synchronized void m30738a(com.tapjoy.TapjoyHttpURLResponse r6) {
        /*
            r5 = this;
            monitor-enter(r5)
            ...
            com.tapjoy.TJEarnedCurrencyListener r2 = f26646g     // Catch:{ Exception -> 0x0073 }
            ...
            com.tapjoy.TapjoyLog.m30842i(r2, r3)     // Catch:{ Exception -> 0x0073 }
            com.tapjoy.TJEarnedCurrencyListener r2 = f26646g     // Catch:{ Exception -> 0x0073 }
            r2.onEarnedCurrency(r6, r1)     // Catch:{ Exception -> 0x0073 }
        L_0x0065:
            r5.saveCurrencyBalance(r0)     // Catch:{ Exception -> 0x0073 }
            com.tapjoy.TJGetCurrencyBalanceListener r1 = f26643d     // Catch:{ Exception -> 0x0073 }
        ...
        L_0x0073:
            ...
            com.tapjoy.TapjoyLog.m30840e((java.lang.String) r0, (com.tapjoy.TapjoyErrorMessage) r1)     // Catch:{ all -> 0x00cc }
            goto L_0x00bf
        L_0x0093:
            ...
            com.tapjoy.TapjoyLog.m30840e((java.lang.String) r6, (com.tapjoy.TapjoyErrorMessage) r0)     // Catch:{ all -> 0x00cc }
            goto L_0x00bf
        L_0x00a2:
            java.lang.String r6 = "TJCurrency"
            com.tapjoy.TapjoyErrorMessage r0 = new com.tapjoy.TapjoyErrorMessage     // Catch:{ all -> 0x00cc }
        ...
        L_0x00b1:
            ...
            com.tapjoy.TapjoyLog.m30840e((java.lang.String) r6, (com.tapjoy.TapjoyErrorMessage) r0)     // Catch:{ all -> 0x00cc }
        L_0x00bf:
            com.tapjoy.TJGetCurrencyBalanceListener r6 = f26643d     // Catch:{ all -> 0x00cc }
        ...
        L_0x00cc:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tapjoy.TJCurrency.m30738a(com.tapjoy.TapjoyHttpURLResponse):void");
    }
    ...
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public synchronized void m30740b(com.tapjoy.TapjoyHttpURLResponse r5) {
        /*
            r4 = this;
            monitor-enter(r4)
            ...
            com.tapjoy.TJSpendCurrencyListener r1 = f26644e     // Catch:{ all -> 0x00b3 }
        ...
        L_0x004d:
            ...
            com.tapjoy.TapjoyLog.m30840e((java.lang.String) r5, (com.tapjoy.TapjoyErrorMessage) r1)     // Catch:{ all -> 0x00b3 }
            goto L_0x00a8
        L_0x005c:
            ...
            com.tapjoy.TapjoyLog.m30842i(r1, r0)     // Catch:{ all -> 0x00b3 }
            ...
            if (r5 == 0) goto L_0x00a8
            com.tapjoy.internal.C11489ft.m31463a()     // Catch:{ all -> 0x00b3 }
            goto L_0x00a8
        L_0x008b:
            java.lang.String r5 = "TJCurrency"
            com.tapjoy.TapjoyErrorMessage r1 = new com.tapjoy.TapjoyErrorMessage     // Catch:{ all -> 0x00b3 }
        ...
        L_0x009a:
            ...
            com.tapjoy.TapjoyLog.m30840e((java.lang.String) r5, (com.tapjoy.TapjoyErrorMessage) r1)     // Catch:{ all -> 0x00b3 }
        L_0x00a8:
            com.tapjoy.TJSpendCurrencyListener r5 = f26644e     // Catch:{ all -> 0x00b3 }
        ...
        L_0x00b3:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tapjoy.TJCurrency.m30740b(com.tapjoy.TapjoyHttpURLResponse):void");
    }
    ...
    /* renamed from: c */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public synchronized void m30742c(com.tapjoy.TapjoyHttpURLResponse r5) {
        /*
            r4 = this;
            monitor-enter(r4)
            ...
            com.tapjoy.TJAwardCurrencyListener r1 = f26645f     // Catch:{ all -> 0x009e }
            if (r1 == 0) goto L_0x004b
            com.tapjoy.TJAwardCurrencyListener r1 = f26645f     // Catch:{ all -> 0x009e }
        ...
        L_0x004d:
            ...
            com.tapjoy.TapjoyLog.m30840e((java.lang.String) r5, (com.tapjoy.TapjoyErrorMessage) r1)     // Catch:{ all -> 0x009e }
            goto L_0x0093
        L_0x005c:
            ...
            java.lang.String r5 = "TJCurrency"
            com.tapjoy.TapjoyLog.m30842i(r5, r0)     // Catch:{ all -> 0x009e }
            goto L_0x0093
        L_0x0076:
            java.lang.String r5 = "TJCurrency"
            com.tapjoy.TapjoyErrorMessage r1 = new com.tapjoy.TapjoyErrorMessage     // Catch:{ all -> 0x009e }
        ...
        L_0x0085:
            ...
            com.tapjoy.TapjoyLog.m30840e((java.lang.String) r5, (com.tapjoy.TapjoyErrorMessage) r1)     // Catch:{ all -> 0x009e }
        L_0x0093:
            com.tapjoy.TJAwardCurrencyListener r5 = f26645f     // Catch:{ all -> 0x009e }
        ...
        L_0x009e:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tapjoy.TJCurrency.m30742c(com.tapjoy.TapjoyHttpURLResponse):void");
    }
}
