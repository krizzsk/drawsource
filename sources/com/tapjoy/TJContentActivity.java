...
public class TJContentActivity extends Activity {
    ...
    /* renamed from: a */
    private static volatile ContentProducer f26599a;

    /* renamed from: b */
    private ContentProducer f26600b;
    ...
    public void onDestroy() {
        ContentProducer contentProducer = this.f26600b;
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        this.f26600b.onActivityResult(this, i, i2, intent);
    }
    ...
    private boolean m30701a(android.content.Intent r5) {
        /*
            r4 = this;
        ...
        L_0x000a:
            ...
            monitor-enter(r2)
            com.tapjoy.TJContentActivity$ContentProducer r3 = f26599a     // Catch:{ all -> 0x003f }
            if (r3 == 0) goto L_0x003d
            com.tapjoy.TJContentActivity$ContentProducer r3 = f26599a     // Catch:{ all -> 0x003f }
            java.lang.String r3 = toIdentityString(r3)     // Catch:{ all -> 0x003f }
            boolean r0 = r0.equals(r3)     // Catch:{ all -> 0x003f }
            if (r0 == 0) goto L_0x003d
            com.tapjoy.TJContentActivity$ContentProducer r0 = f26599a     // Catch:{ all -> 0x003f }
            r4.f26600b = r0     // Catch:{ all -> 0x003f }
            r0 = 0
            f26599a = r0     // Catch:{ all -> 0x003f }
            ...
            r5.setFlags(r0, r0)
        L_0x0036:
            com.tapjoy.TJContentActivity$ContentProducer r5 = r4.f26600b
            r5.show(r4)
            r5 = 1
            return r5
        L_0x003d:
        ...
        L_0x003f:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tapjoy.TJContentActivity.m30701a(android.content.Intent):boolean");
    }
