...
public class TJPlacementListenerNative implements TJPlacementListener {
    ...
    public void onRequestSuccess(TJPlacement tJPlacement) {
        onRequestSuccessNative(this.f26911a, tJPlacement, tJPlacement.getName());
    }

    public void onRequestFailure(TJPlacement tJPlacement, TJError tJError) {
        onRequestFailureNative(this.f26911a, tJPlacement, tJPlacement.getName(), tJError.code, tJError.message);
    }

    public void onContentReady(TJPlacement tJPlacement) {
        onContentReadyNative(this.f26911a, tJPlacement, tJPlacement.getName());
    }

    public void onContentShow(TJPlacement tJPlacement) {
        onContentShowNative(this.f26911a, tJPlacement, tJPlacement.getName());
    }

    public void onContentDismiss(TJPlacement tJPlacement) {
        onContentDismissNative(this.f26911a, tJPlacement, tJPlacement.getName());
    }

    public void onPurchaseRequest(TJPlacement tJPlacement, TJActionRequest tJActionRequest, String str) {
        onPurchaseRequestNative(this.f26911a, tJPlacement, tJPlacement.getName(), tJActionRequest, tJActionRequest.getRequestId(), tJActionRequest.getToken(), str);
    }

    public void onRewardRequest(TJPlacement tJPlacement, TJActionRequest tJActionRequest, String str, int i) {
        onRewardRequestNative(this.f26911a, tJPlacement, tJPlacement.getName(), tJActionRequest, tJActionRequest.getRequestId(), tJActionRequest.getToken(), str, i);
    }

    public void onClick(TJPlacement tJPlacement) {
        onClickNative(this.f26911a, tJPlacement, tJPlacement.getName());
    }
