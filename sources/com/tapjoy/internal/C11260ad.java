...
public class C11260ad extends C11261ae {

    /* renamed from: a */
    private int f26919a = 0;

    /* renamed from: b */
    private final Matrix f26920b = new Matrix();

    /* renamed from: c */
    private final float[] f26921c = new float[2];

    public C11260ad(Context context) {
        super(context);
    }
    ...
    public void dispatchDraw(android.graphics.Canvas r9) {
        ...
        L_0x0077:
            ...
            r9.translate(r5, r2)
        L_0x007c:
            android.graphics.Matrix r2 = r8.f26920b
            int r7 = r8.f26919a
            int r7 = r7 * -90
            float r7 = (float) r7
            r2.setRotate(r7)
            ...
            android.graphics.Matrix r0 = r8.f26920b
            int r1 = r1 - r6
            float r1 = (float) r1
        ...
        L_0x009c:
            ...
            goto L_0x00ad
        L_0x00a6:
            android.graphics.Matrix r1 = r8.f26920b
            int r0 = r0 - r6
            float r0 = (float) r0
        ...
        L_0x00ad:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tapjoy.internal.C11260ad.dispatchDraw(android.graphics.Canvas):void");
    }
