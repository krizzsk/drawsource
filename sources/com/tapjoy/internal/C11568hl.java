...
public final class C11568hl extends C11677o {

    /* renamed from: c */
    private static C11568hl f27780c;

    /* renamed from: a */
    public static synchronized C11568hl m31691a(Context context) {
        C11568hl hlVar;
        synchronized (C11568hl.class) {
            if (f27780c == null) {
                f27780c = new C11568hl(context);
            }
            hlVar = f27780c;
        }
        return hlVar;
    ...
    private C11568hl(Context context) {
        super(context, new C11679q() {
            /* renamed from: a */
            public final String mo70137a(Context context) {
                return C11581ht.m31750a(context).f27827b.getString("gcm.regId", "");
            }

            /* renamed from: b */
            public final void mo70139b(Context context) {
                C11581ht.m31750a(context).mo70167a(true);
            }

            /* renamed from: a */
            public final void mo70138a(Context context, long j) {
                SharedPreferences.Editor edit = C11581ht.m31750a(context).f27827b.edit();
    ...
    /* renamed from: a */
    public static boolean m31692a(Object obj) {
        return Boolean.TRUE.equals(obj) || "true".equals(obj);
    }

    /* renamed from: b */
    public static int m31693b(Object obj) {
    ...
    /* renamed from: a */
    private static int m31689a(Bundle bundle, String str, Context context) {
        if (bundle != null) {
            ...
            if (obj != null) {
                Object[] objArr = {str};
                if (C11554hg.f27724a) {
                    C11689w.m32059a(4, "Tapjoy", "meta-data of {} invalid", objArr);
                }
            }
        }
        return 0;
    ...
    public static android.app.Notification m31690a(android.content.Context r6, java.lang.String r7, java.lang.String r8, java.lang.String r9, boolean r10, boolean r11, java.lang.String r12, java.lang.String r13, int r14, java.lang.String r15) {
        /*
        ...
        L_0x010a:
            ...
            r13.<init>(r6, r4)
            android.app.Notification r6 = r13.f28131M
            r6.icon = r10
            com.tapjoy.internal.js$c r6 = r13.mo70303c(r8)
            com.tapjoy.internal.js$c r6 = r6.mo70301a((java.lang.CharSequence) r8)
            com.tapjoy.internal.js$c r6 = r6.mo70302b(r9)
            r6.f28137e = r7
            android.app.Notification r7 = r6.f28131M
            int r10 = r7.flags
            r10 = r10 | 16
            r7.flags = r10
            r6.f28143k = r1
            ...
            r7.<init>()
            com.tapjoy.internal.js$b r7 = r7.mo70297a((java.lang.CharSequence) r8)
            com.tapjoy.internal.js$b r7 = r7.mo70299b(r9)
            com.tapjoy.internal.js$c r6 = r6.mo70300a((com.tapjoy.internal.C11665js.C11669d) r7)
        ...
        L_0x0147:
            ...
            r7.<init>(r6)
            android.app.Notification r6 = r7.mo70305b()
            return r6
        L_0x0151:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tapjoy.internal.C11568hl.m31690a(android.content.Context, java.lang.String, java.lang.String, java.lang.String, boolean, boolean, java.lang.String, java.lang.String, int, java.lang.String):android.app.Notification");
    }
}
