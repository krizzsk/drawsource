...
public final class C11536gu {
    ...
    public final boolean mo70081a(java.lang.String r20, int r21) {
        /*
            r19 = this;
            r1 = r19
            r0 = 0
            ...
            long r7 = r7 + r9
            r0 = 24
            long r13 = m31578b(r5, r0)     // Catch:{ Exception -> 0x00d5, all -> 0x00d1 }
            r0 = 32
            long r15 = m31578b(r5, r0)     // Catch:{ Exception -> 0x00d5, all -> 0x00d1 }
            long r4 = m31578b(r5, r12)     // Catch:{ Exception -> 0x00d5, all -> 0x00d1 }
            long r17 = r4 - r15
            long r9 = r9 - r17
            long r15 = r15 - r13
            long r4 = r4 - r7
            ...
            long r7 = r7 + r15
            r4 = r19
            r4.f27697a = r7     // Catch:{ Exception -> 0x00ef, all -> 0x00cf }
            r4.f27698b = r2     // Catch:{ Exception -> 0x00ef, all -> 0x00cf }
            r4.f27699c = r9     // Catch:{ Exception -> 0x00ef, all -> 0x00cf }
            r1.close()
            r0 = 1
            return r0
        L_0x00cf:
        ...
        L_0x00ff:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tapjoy.internal.C11536gu.mo70081a(java.lang.String, int):boolean");
    }

    /* renamed from: a */
    private static long m31577a(byte[] bArr, int i) {
        byte b = bArr[i];
        byte b2 = bArr[i + 1];
        byte b3 = bArr[i + 2];
        byte b4 = bArr[i + 3];
    ...
    /* renamed from: b */
    private static long m31578b(byte[] bArr, int i) {
        return ((m31577a(bArr, i) - 2208988800L) * 1000) + ((m31577a(bArr, i + 4) * 1000) / 4294967296L);
    }
}
