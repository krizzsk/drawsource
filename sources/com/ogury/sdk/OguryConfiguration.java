...
public final class OguryConfiguration {
    ...
    public /* synthetic */ OguryConfiguration(Builder builder, C10362l lVar) {
        this(builder);
    }
    ...
    public static final class Builder {
        ...
        public Builder(Context context2, String str) {
            C10363m.m30060b(context2, "context");
            C10363m.m30060b(str, "assetKey");
        ...
        public final Builder putMonitoringInfo(String str, String str2) {
            C10363m.m30060b(str, SDKConstants.PARAM_KEY);
            C10363m.m30060b(str2, "value");
            this.monitoringInfoList.put(str, str2);
            return this;
        }

        public final OguryConfiguration build() {
            return new OguryConfiguration(this, (C10362l) null);
        }
    }
}
