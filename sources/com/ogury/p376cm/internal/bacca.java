...
public final class bacca {
    ...
    /* renamed from: a */
    public static final bacbc f24523a;
    ...
    static {
        ...
        if (a >= 65544) {
            try {
                ...
                bbabc.m28049a((Object) newInstance2, "Class.forName(\"kotlin.in…entations\").newInstance()");
                ...
                bbabc.m28049a((Object) initCause, "ClassCastException(\"Inst…baseTypeCL\").initCause(e)");
                throw initCause;
            } catch (ClassNotFoundException unused) {
                try {
                    Object newInstance3 = Class.forName("kotlin.internal.JRE8PlatformImplementations").newInstance();
                    bbabc.m28049a((Object) newInstance3, "Class.forName(\"kotlin.in…entations\").newInstance()");
                    if (newInstance3 != null) {
                        try {
                            ...
                            bbabc.m28049a((Object) initCause2, "ClassCastException(\"Inst…baseTypeCL\").initCause(e)");
                            throw initCause2;
                        }
                    } else {
                        throw new babca("null cannot be cast to non-null type kotlin.internal.PlatformImplementations");
        ...
        if (a >= 65543) {
            try {
                ...
                bbabc.m28049a(newInstance, "Class.forName(\"kotlin.in…entations\").newInstance()");
                if (newInstance != null) {
                ...
                bbabc.m28049a((Object) initCause3, "ClassCastException(\"Inst…baseTypeCL\").initCause(e)");
                throw initCause3;
            } catch (ClassNotFoundException unused3) {
                try {
                    Object newInstance4 = Class.forName("kotlin.internal.JRE7PlatformImplementations").newInstance();
                    bbabc.m28049a(newInstance4, "Class.forName(\"kotlin.in…entations\").newInstance()");
                    if (newInstance4 != null) {
                        try {
                            ...
                            bbabc.m28049a((Object) initCause4, "ClassCastException(\"Inst…baseTypeCL\").initCause(e)");
                            throw initCause4;
                        }
                    } else {
                        throw new babca("null cannot be cast to non-null type kotlin.internal.PlatformImplementations");
    ...
    private static final int m28037a() {
        ...
        if (a < 0) {
            ...
            int i = a + 1;
            int a2 = bbcbc.m28091a(charSequence, '.', i, false, 4, (Object) null);
            if (a2 < 0) {
                a2 = property.length();
            }
            if (property != null) {
                ...
                if (property != null) {
                    ...
                    bbabc.m28049a((Object) substring2, "(this as java.lang.Strin…ing(startIndex, endIndex)");
                    try {
