...
public final class acccc {
    ...
    /* renamed from: a */
    public static final acccc f24473a = new acccc();

    /* renamed from: b */
    private static baaab f24474b;

    /* renamed from: c */
    private static BillingClient f24475c;

    /* renamed from: d */
    private static boolean f24476d;

    private acccc() {
    }

    /* renamed from: a */
    public static void m27986a() {
        f24474b = new baaca();
    }

    /* renamed from: a */
    private static void m27987a(Context context, String str) {
    ...
    /* renamed from: b */
    public static baabc m27988b(Context context) {
        ...
        bbabc.m28049a((Object) sharedPreferences, "context.applicationConte…ME, Context.MODE_PRIVATE)");
        baabc.m28008a(sharedPreferences);
        return baabc;
    }

    /* renamed from: c */
    private static String m27989c(Context context) {
        bbabc.m28052b(context, "context");
        try {
            ...
            bbabc.m28049a((Object) string, "bundle.getString(\"com.go…y.billingclient.version\")");
            return string;
    ...
    /* renamed from: a */
    public final synchronized BillingClient mo63927a(Context context, PurchasesUpdatedListener purchasesUpdatedListener) {
        BillingClient billingClient;
        bbabc.m28052b(context, "context");
        bbabc.m28052b(purchasesUpdatedListener, ServiceSpecificExtraArgs.CastExtraArgs.LISTENER);
        if (!f24476d) {
            BillingClient build = BillingClient.newBuilder(context).enablePendingPurchases().setListener(purchasesUpdatedListener).build();
            bbabc.m28049a((Object) build, "BillingClient.newBuilder…istener(listener).build()");
            f24475c = build;
        }
        billingClient = f24475c;
        if (billingClient == null) {
            bbabc.m28050a("billingClient");
        }
    ...
    public final synchronized com.ogury.p376cm.internal.baaab mo63928a(android.content.Context r11) {
        /*
            r10 = this;
            monitor-enter(r10)
            java.lang.String r0 = "context"
            com.ogury.p376cm.internal.bbabc.m28052b(r11, r0)     // Catch:{ all -> 0x0118 }
            com.ogury.cm.internal.baaab r0 = f24474b     // Catch:{ all -> 0x0118 }
            r1 = 1
            r2 = 0
        ...
        L_0x000f:
            ...
            java.lang.String r0 = m27989c(r11)     // Catch:{ Exception -> 0x00f9, all -> 0x00e2 }
            r3 = r0
        ...
        L_0x0021:
            ...
            com.ogury.cm.internal.abaaa$aaaaa r3 = com.ogury.p376cm.internal.abaaa.f24290a     // Catch:{ Exception -> 0x00f9, all -> 0x00e2 }
            java.lang.String r3 = "versionName"
            com.ogury.p376cm.internal.bbabc.m28052b(r0, r3)     // Catch:{ Exception -> 0x00f9, all -> 0x00e2 }
            r4 = r0
            ...
            r8 = 6
            r9 = 0
            java.util.List r0 = com.ogury.p376cm.internal.bbcbc.m28097a((java.lang.CharSequence) r4, (java.lang.String[]) r5, (boolean) r6, (int) r7, (int) r8, (java.lang.Object) r9)     // Catch:{ Exception -> 0x00f9, all -> 0x00e2 }
            r3 = r0
        ...
        L_0x00bd:
            m27987a((android.content.Context) r11, (java.lang.String) r0)     // Catch:{ Exception -> 0x00f9, all -> 0x00e2 }
            goto L_0x010d
        L_0x00c1:
        ...
        L_0x00d5:
            ...
            com.ogury.cm.internal.baaab r0 = (com.ogury.p376cm.internal.baaab) r0     // Catch:{ Exception -> 0x00f9, all -> 0x00e2 }
            f24474b = r0     // Catch:{ Exception -> 0x00f9, all -> 0x00e2 }
            goto L_0x010d
        L_0x00df:
        ...
        L_0x00f5:
            m27987a((android.content.Context) r11, (java.lang.String) r0)     // Catch:{ all -> 0x0118 }
            goto L_0x010d
        L_0x00f9:
            r0 = move-exception
            java.lang.StringBuilder r1 = new java.lang.StringBuilder     // Catch:{ all -> 0x0118 }
            ...
            goto L_0x00f5
        L_0x010d:
            com.ogury.cm.internal.baaab r11 = f24474b     // Catch:{ all -> 0x0118 }
            if (r11 != 0) goto L_0x0116
            java.lang.String r0 = "billingLibrary"
            com.ogury.p376cm.internal.bbabc.m28050a((java.lang.String) r0)     // Catch:{ all -> 0x0118 }
        L_0x0116:
            monitor-exit(r10)
            return r11
        L_0x0118:
            ...
            throw r11
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ogury.p376cm.internal.acccc.mo63928a(android.content.Context):com.ogury.cm.internal.baaab");
    }
}
