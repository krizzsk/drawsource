...
@Metadata(mo72582d1 = {"\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\b\u0012\u0004\u0012\u00020\u00020\u0001\"\u0004\b\u0000\u0010\u0003*\u00020\u0004H@"}, mo72583d2 = {"<anonymous>", "Lkotlinx/coroutines/channels/ChannelResult;", "", "E", "Lkotlinx/coroutines/CoroutineScope;"}, mo72584k = 3, mo72585mv = {1, 6, 0}, mo72587xi = 48)
@DebugMetadata(mo73296c = "kotlinx.coroutines.channels.ChannelsKt__ChannelsKt$trySendBlocking$2", mo73297f = "Channels.kt", mo73298i = {}, mo73299l = {39}, mo73300m = "invokeSuspend", mo73301n = {}, mo73302s = {})
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                ...
                obj2 = Result.m33832constructorimpl(ResultKt.createFailure(th));
            }
        } else {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        obj2 = Result.m33832constructorimpl(Unit.INSTANCE);
        if (Result.m33839isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m35342successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m35340closedJP2dKIU(Result.m33835exceptionOrNullimpl(obj2));
        }
        return ChannelResult.m35327boximpl(obj3);
    }
}
