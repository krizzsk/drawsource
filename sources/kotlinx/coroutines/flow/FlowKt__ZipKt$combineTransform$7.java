...
@DebugMetadata(mo73296c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7", mo73297f = "Zip.kt", mo73298i = {}, mo73299l = {308}, mo73300m = "invokeSuspend", mo73301n = {}, mo73302s = {})
...
public final class FlowKt__ZipKt$combineTransform$7 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(mo73296c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$2", mo73297f = "Zip.kt", mo73298i = {}, mo73299l = {308}, mo73300m = "invokeSuspend", mo73301n = {}, mo73302s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7$2 */
    /* compiled from: Zip.kt */
    public static final class C125782 extends SuspendLambda implements Function3<FlowCollector<? super R>, T[], Continuation<? super Unit>, Object> {
        private /* synthetic */ Object L$0;
        /* synthetic */ Object L$1;
        int label;

        public final Object invoke(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super Unit> continuation) {
            C125782 r0 = new C125782(r3, continuation);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            }, new C125782((Continuation<? super C125782>) null), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else if (i == 1) {
            ResultKt.throwOnFailure(obj);
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        ...
        }, new C125782((Continuation<? super C125782>) null), this);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
