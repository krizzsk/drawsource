...
@DebugMetadata(mo73296c = "kotlinx.coroutines.flow.FlowKt__LimitKt$transformWhile$1", mo73297f = "Limit.kt", mo73298i = {0}, mo73299l = {152}, mo73300m = "invokeSuspend", mo73301n = {"collector$iv"}, mo73302s = {"L$0"})
...
final class FlowKt__LimitKt$transformWhile$1 extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        C12528xdf1aa1b6 flowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = this.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            Flow<T> flow = this.$this_transformWhile;
            C12528xdf1aa1b6 flowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$12 = new C12528xdf1aa1b6(this.$transform, (FlowCollector) this.L$0);
            try {
            ...
            flowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1 = (C12528xdf1aa1b6) this.L$0;
            try {
                ResultKt.throwOnFailure(obj);
