...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m35355debounceHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.debounce(flow, DelayKt.m35309toDelayMillisLRDsOJo(j));
    }
    ...
    public static final <T> Flow<T> m35356sampleHG0u8IE(Flow<? extends T> flow, long j) {
        return FlowKt.sample(flow, DelayKt.m35309toDelayMillisLRDsOJo(j));
    }
}
