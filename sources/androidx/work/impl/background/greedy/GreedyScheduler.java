        ...
        for (WorkSpec workSpec : workSpecArr) {
            ...
            if (workSpec.state == WorkInfo.State.ENQUEUED) {
                if (currentTimeMillis < calculateNextRunTime) {
                    ...
                    Logger.get().debug(TAG, String.format("Starting work for %s", new Object[]{workSpec.f40id}), new Throwable[0]);
                    this.mWorkManagerImpl.startWork(workSpec.f40id);
