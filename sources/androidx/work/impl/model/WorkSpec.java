...
public final class WorkSpec {
    ...
    public int hashCode() {
        int hashCode = ((((this.f40id.hashCode() * 31) + this.state.hashCode()) * 31) + this.workerClassName.hashCode()) * 31;
        String str = this.inputMergerClassName;
    ...
    public static class IdAndState {
        ...
        public boolean equals(Object obj) {
            ...
            return this.f41id.equals(idAndState.f41id);
        }

        public int hashCode() {
            return (this.f41id.hashCode() * 31) + this.state.hashCode();
        }
    }
    ...
    public static class WorkInfoPojo {
        ...
        public WorkInfo toWorkInfo() {
            ...
            return new WorkInfo(UUID.fromString(this.f42id), this.state, this.output, this.tags, data, this.runAttemptCount);
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (str == null ? workInfoPojo.f42id != null : !str.equals(workInfoPojo.f42id)) {
                return false;
            }
