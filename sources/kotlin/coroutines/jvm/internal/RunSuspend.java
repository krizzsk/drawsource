...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m35039getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object obj) {
        synchronized (this) {
            this.result = Result.m33831boximpl(obj);
        ...
        synchronized (this) {
            while (true) {
                ...
                if (result2 == null) {
                    ...
                    ResultKt.throwOnFailure(result2.m33841unboximpl());
                }
            }
        }
    }
