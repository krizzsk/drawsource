...
class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    /* renamed from: ln */
    private static final double m33390ln(double d) {
        return Math.log(d);
    }
    ...
    /* renamed from: ln */
    private static final float m33391ln(float f) {
