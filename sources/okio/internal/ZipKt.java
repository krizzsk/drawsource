...
@Metadata(mo72582d1 = {"\u0000j\n\u0000\n\u0002\u0010\b\n\u0002\b\t\n\u0002\u0010\t\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0010$\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\u001a\"\u0010\u0012\u001a\u000e\u0012\u0004\u0012\u00020\u0014\u0012\u0004\u0012\u00020\u00150\u00132\f\u0010\u0016\u001a\b\u0012\u0004\u0012\u00020\u00150\u0017H\u0002\u001a\u001f\u0010\u0018\u001a\u0004\u0018\u00010\u000b2\u0006\u0010\u0019\u001a\u00020\u00012\u0006\u0010\u001a\u001a\u00020\u0001H\u0002¢\u0006\u0002\u0010\u001b\u001a.\u0010\u001c\u001a\u00020\u001d2\u0006\u0010\u001e\u001a\u00020\u00142\u0006\u0010\u001f\u001a\u00020 2\u0014\b\u0002\u0010!\u001a\u000e\u0012\u0004\u0012\u00020\u0015\u0012\u0004\u0012\u00020#0\"H\u0000\u001a\f\u0010$\u001a\u00020\u0015*\u00020%H\u0000\u001a\f\u0010&\u001a\u00020'*\u00020%H\u0002\u001a.\u0010(\u001a\u00020)*\u00020%2\u0006\u0010*\u001a\u00020\u00012\u0018\u0010+\u001a\u0014\u0012\u0004\u0012\u00020\u0001\u0012\u0004\u0012\u00020\u000b\u0012\u0004\u0012\u00020)0,H\u0002\u001a\u0014\u0010-\u001a\u00020.*\u00020%2\u0006\u0010/\u001a\u00020.H\u0000\u001a\u0018\u00100\u001a\u0004\u0018\u00010.*\u00020%2\b\u0010/\u001a\u0004\u0018\u00010.H\u0002\u001a\u0014\u00101\u001a\u00020'*\u00020%2\u0006\u00102\u001a\u00020'H\u0002\u001a\f\u00103\u001a\u00020)*\u00020%H\u0000\"\u000e\u0010\u0000\u001a\u00020\u0001XT¢\u0006\u0002\n\u0000\"\u000e\u0010\u0002\u001a\u00020\u0001XT¢\u0006\u0002\n\u0000\"\u000e\u0010\u0003\u001a\u00020\u0001XT¢\u0006\u0002\n\u0000\"\u000e\u0010\u0004\u001a\u00020\u0001XT¢\u0006\u0002\n\u0000\"\u000e\u0010\u0005\u001a\u00020\u0001XT¢\u0006\u0002\n\u0000\"\u000e\u0010\u0006\u001a\u00020\u0001XT¢\u0006\u0002\n\u0000\"\u000e\u0010\u0007\u001a\u00020\u0001XT¢\u0006\u0002\n\u0000\"\u000e\u0010\b\u001a\u00020\u0001XT¢\u0006\u0002\n\u0000\"\u000e\u0010\t\u001a\u00020\u0001XT¢\u0006\u0002\n\u0000\"\u000e\u0010\n\u001a\u00020\u000bXT¢\u0006\u0002\n\u0000\"\u000e\u0010\f\u001a\u00020\u0001XT¢\u0006\u0002\n\u0000\"\u000e\u0010\r\u001a\u00020\u0001XT¢\u0006\u0002\n\u0000\"\u0018\u0010\u000e\u001a\u00020\u000f*\u00020\u00018BX\u0004¢\u0006\u0006\u001a\u0004\b\u0010\u0010\u0011¨\u00064"}, mo72583d2 = {"BIT_FLAG_ENCRYPTED", "", "BIT_FLAG_UNSUPPORTED_MASK", "CENTRAL_FILE_HEADER_SIGNATURE", "COMPRESSION_METHOD_DEFLATED", "COMPRESSION_METHOD_STORED", "END_OF_CENTRAL_DIRECTORY_SIGNATURE", "HEADER_ID_EXTENDED_TIMESTAMP", "HEADER_ID_ZIP64_EXTENDED_INFO", "LOCAL_FILE_HEADER_SIGNATURE", "MAX_ZIP_ENTRY_AND_ARCHIVE_SIZE", "", "ZIP64_EOCD_RECORD_SIGNATURE", "ZIP64_LOCATOR_SIGNATURE", "hex", "", "getHex", "(I)Ljava/lang/String;", "buildIndex", "", "Lokio/Path;", "Lokio/internal/ZipEntry;", "entries", "", "dosDateTimeToEpochMillis", "date", "time", "(II)Ljava/lang/Long;", "openZip", "Lokio/ZipFileSystem;", "zipPath", "fileSystem", "Lokio/FileSystem;", "predicate", "Lkotlin/Function1;", "", "readEntry", "Lokio/BufferedSource;", "readEocdRecord", "Lokio/internal/EocdRecord;", "readExtra", "", "extraSize", "block", "Lkotlin/Function2;", "readLocalHeader", "Lokio/FileMetadata;", "basicMetadata", "readOrSkipLocalHeader", "readZip64EocdRecord", "regularRecord", "skipLocalHeader", "okio"}, mo72584k = 2, mo72585mv = {1, 6, 0}, mo72587xi = 48)
...
public final class ZipKt {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:28:?, code lost:
        kotlin.p403io.CloseableKt.closeFinally(r6, (java.lang.Throwable) null);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:39:?, code lost:
        kotlin.p403io.CloseableKt.closeFinally(r6, r1);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:45:?, code lost:
        kotlin.p403io.CloseableKt.closeFinally(r5, (java.lang.Throwable) null);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:53:?, code lost:
        kotlin.p403io.CloseableKt.closeFinally(r5, r1);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:62:0x011b, code lost:
        if (r11.getOffset() >= r9.getCentralDirectoryOffset()) goto L_0x0133;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:64:0x0127, code lost:
        if (r2.invoke(r11).booleanValue() == false) goto L_0x012f;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:71:?, code lost:
        kotlin.p403io.CloseableKt.closeFinally(r4, (java.lang.Throwable) null);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:72:0x0149, code lost:
        kotlin.p403io.CloseableKt.closeFinally(r3, (java.lang.Throwable) null);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:81:?, code lost:
        kotlin.p403io.CloseableKt.closeFinally(r4, r1);
     */
    ...
    public static final okio.ZipFileSystem openZip(okio.Path r19, okio.FileSystem r20, kotlin.jvm.functions.Function1<? super okio.internal.ZipEntry, java.lang.Boolean> r21) throws java.io.IOException {
        ...
        L_0x0035:
            ...
            int r11 = r6.readIntLe()     // Catch:{ all -> 0x00e4 }
            ...
            r11 = r6
            okio.BufferedSource r11 = (okio.BufferedSource) r11     // Catch:{ all -> 0x00cd }
            int r13 = r11.readIntLe()     // Catch:{ all -> 0x00cd }
            r14 = 101075792(0x6064b50, float:2.525793E-35)
            if (r13 != r14) goto L_0x00a6
            okio.internal.EocdRecord r9 = readZip64EocdRecord(r11, r9)     // Catch:{ all -> 0x00cd }
            kotlin.Unit r11 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x00cd }
            kotlin.p403io.CloseableKt.closeFinally(r6, r12)     // Catch:{ all -> 0x00e4 }
            goto L_0x00de
        L_0x00a6:
        ...
        L_0x00d0:
            r0 = move-exception
            r2 = r0
            kotlin.p403io.CloseableKt.closeFinally(r6, r1)     // Catch:{ all -> 0x00e4 }
        ...
        L_0x00de:
            ...
            kotlin.p403io.CloseableKt.closeFinally(r5, r12)     // Catch:{ all -> 0x018a }
            goto L_0x00ed
        L_0x00e4:
            r0 = move-exception
            r1 = r0
        ...
        L_0x00e7:
            r0 = move-exception
            r2 = r0
            kotlin.p403io.CloseableKt.closeFinally(r5, r1)     // Catch:{ all -> 0x018a }
        ...
        L_0x00ed:
            ...
            long r13 = r9.getCentralDirectoryOffset()     // Catch:{ all -> 0x018a }
            okio.Source r4 = r4.source(r13)     // Catch:{ all -> 0x018a }
            ...
            long r13 = r9.getEntryCount()     // Catch:{ all -> 0x014d }
        L_0x0109:
            int r11 = (r7 > r13 ? 1 : (r7 == r13 ? 0 : -1))
            if (r11 >= 0) goto L_0x013b
            okio.internal.ZipEntry r11 = readEntry(r6)     // Catch:{ all -> 0x014d }
            long r15 = r11.getOffset()     // Catch:{ all -> 0x014d }
            long r17 = r9.getCentralDirectoryOffset()     // Catch:{ all -> 0x014d }
            int r15 = (r15 > r17 ? 1 : (r15 == r17 ? 0 : -1))
            if (r15 >= 0) goto L_0x0133
            java.lang.Object r15 = r2.invoke(r11)     // Catch:{ all -> 0x014d }
        ...
        L_0x013b:
            ...
            kotlin.p403io.CloseableKt.closeFinally(r4, r12)     // Catch:{ all -> 0x018a }
            ...
            kotlin.p403io.CloseableKt.closeFinally(r3, r12)
            return r4
        L_0x014d:
            r0 = move-exception
            r1 = r0
        ...
        L_0x0150:
            r0 = move-exception
            r2 = r0
            kotlin.p403io.CloseableKt.closeFinally(r4, r1)     // Catch:{ all -> 0x018a }
            throw r2     // Catch:{ all -> 0x018a }
        L_0x0156:
            r11.close()     // Catch:{ all -> 0x018a }
            r11 = -1
        ...
        L_0x018d:
            r0 = move-exception
            r2 = r0
            kotlin.p403io.CloseableKt.closeFinally(r3, r1)
            throw r2
        */
    ...
    private static final Map<Path, ZipEntry> buildIndex(List<ZipEntry> list) {
        ...
        Map<Path, ZipEntry> mutableMapOf = MapsKt.mutableMapOf(TuplesKt.m33378to(path, new ZipEntry(path, true, (String) null, 0, 0, 0, 0, (Long) null, 0, IronSourceError.ERROR_CODE_INIT_FAILED, (DefaultConstructorMarker) null)));
        for (ZipEntry zipEntry : CollectionsKt.sortedWith(list, new ZipKt$buildIndex$$inlined$sortedBy$1())) {
            if (mutableMapOf.put(zipEntry.getCanonicalPath(), zipEntry) == null) {
                while (true) {
                    ...
                    ZipEntry zipEntry4 = new ZipEntry(parent, true, (String) null, 0, 0, 0, 0, (Long) null, 0, IronSourceError.ERROR_CODE_INIT_FAILED, (DefaultConstructorMarker) null);
