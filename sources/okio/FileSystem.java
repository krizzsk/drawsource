...
public abstract class FileSystem {
    ...
    public final FileHandle openReadWrite(Path path) throws IOException {
        Intrinsics.checkNotNullParameter(path, ShareInternalUtility.STAGING_PARAM);
        return openReadWrite(path, false, false);
    }

    /* renamed from: -read  reason: not valid java name */
    public final <T> T m35533read(Path path, Function1<? super BufferedSource, ? extends T> function1) throws IOException {
        T t;
        Intrinsics.checkNotNullParameter(path, ShareInternalUtility.STAGING_PARAM);
    ...
    public static /* synthetic */ Object m35532write$default(FileSystem fileSystem, Path path, boolean z, Function1 function1, int i, Object obj) throws IOException {
        Object obj2;
        if (obj == null) {
            if ((i & 2) != 0) {
                z = false;
    ...
    public final <T> T m35534write(Path path, boolean z, Function1<? super BufferedSink, ? extends T> function1) throws IOException {
        T t;
        Intrinsics.checkNotNullParameter(path, ShareInternalUtility.STAGING_PARAM);
        Intrinsics.checkNotNullParameter(function1, "writerAction");
    ...
    @Metadata(mo72582d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0010\u0010\u0003\u001a\u00020\u00048\u0006X\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\u0005\u001a\u00020\u00048\u0006X\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\u0006\u001a\u00020\u00078\u0006X\u0004¢\u0006\u0002\n\u0000¨\u0006\b"}, mo72583d2 = {"Lokio/FileSystem$Companion;", "", "()V", "RESOURCES", "Lokio/FileSystem;", "SYSTEM", "SYSTEM_TEMPORARY_DIRECTORY", "Lokio/Path;", "okio"}, mo72584k = 1, mo72585mv = {1, 6, 0}, mo72587xi = 48)
    /* compiled from: FileSystem.kt */
