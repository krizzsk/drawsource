...
import p010by.saygames.SayEndpoint;
...
public class SayEndpointCache {
    ...
    private static class C0672DB extends SQLiteOpenHelper {
        ...
        public C0672DB(Context context, String str) {
    ...
    private void newDbInstance() {
        try {
            this._db = new C0672DB(this._context, this._name);
        } catch (Exception e) {
    ...
    public java.util.List<p010by.saygames.SayEndpoint.StringRequestData> open() {
        /*
            r9 = this;
        ...
        L_0x0069:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p010by.saygames.SayEndpointCache.open():java.util.List");
    }
