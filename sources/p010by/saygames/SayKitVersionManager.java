...
public class SayKitVersionManager {
    public static void trackSDKVersions() {
        try {
            ...
            SayKitEvents.track("sdk_admob", 0, 0, "21.1.0");
            SayKitEvents.track("sdk_facebook", 0, 0, BuildConfig.VERSION_NAME);
            ...
            SayKitEvents.track("sdk_saypromo", 0, 0, SayPromo.getVersion());
